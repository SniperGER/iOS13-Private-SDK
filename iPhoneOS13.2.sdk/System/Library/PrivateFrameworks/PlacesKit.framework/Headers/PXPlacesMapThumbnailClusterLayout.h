...
@property(nonatomic) NSUInteger currentChangeType; // @synthesize currentChangeType=_currentChangeType;
...
- (NSUInteger)_viewPortChangeTypeFrom:(id)arg1 to:(id)arg2;
