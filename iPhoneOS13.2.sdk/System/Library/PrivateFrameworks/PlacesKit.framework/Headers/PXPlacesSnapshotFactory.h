...
- (void)requestAssetCountWithForcedRefresh:(_Bool)arg1 completion:(id /* block */)arg2;
- (long long)assetCountWithForcedRefresh:(_Bool)arg1;
- (void)_requestPlacesSnapshotWithSnapshotOptions:(id)arg1 visibleRegion:(CDStruct_26e8d939)arg2 andCompletion:(id /* block */)arg3;
