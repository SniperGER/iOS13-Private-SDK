...
@property(copy, nonatomic) id /* block */ timeTravelYAdjustmentProviderBlock; // @synthesize timeTravelYAdjustmentProviderBlock=_timeTravelYAdjustmentProviderBlock;
@property(copy, nonatomic) id /* block */ shadowColorProviderBlock; // @synthesize shadowColorProviderBlock=_shadowColorProviderBlock;
