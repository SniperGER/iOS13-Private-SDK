...
@property(copy, nonatomic) id /* block */ rampBrightnessWithDurationBlock; // @synthesize rampBrightnessWithDurationBlock=_rampBrightnessWithDurationBlock;
...
- (void)endScrubbingAnimated:(_Bool)arg1 withCompletion:(id /* block */)arg2;
...
- (void)startScrubbingAnimated:(_Bool)arg1 withCompletion:(id /* block */)arg2;
