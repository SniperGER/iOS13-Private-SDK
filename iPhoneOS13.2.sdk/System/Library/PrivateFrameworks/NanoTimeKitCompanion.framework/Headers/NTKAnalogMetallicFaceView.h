...
@interface NTKAnalogMetallicFaceView : NTKAnalogVideoFaceView
{
    ...
    NSUInteger _currentMetallicColor;
    NSUInteger _currentDialShape;
    NSDictionary *_dataSources;
}

+ (id)_swatchImageForColorOption:(id)arg1 forDevice:(id)arg2;
+ (id)_nameForMetallicColor:(NSUInteger)arg1;
...
@property(nonatomic) NSUInteger currentMetallicColor; // @synthesize currentMetallicColor=_currentMetallicColor;
// - (void).cxx_destruct;
- (id)_swatchImageForMetallicColor:(NSUInteger)arg1 andDialShape:(NSUInteger)arg2;
