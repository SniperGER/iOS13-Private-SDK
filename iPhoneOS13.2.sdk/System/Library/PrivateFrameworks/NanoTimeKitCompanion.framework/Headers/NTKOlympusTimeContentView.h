...
@class CLKDevice, CLKTimeFormatter, NTKOlympusColorPalette, NTKVictoryLabel, NTKVictoryTimeLabel, UIButton, UIColor;
@protocol NTKOlympusContentViewDelegate;

@interface NTKOlympusTimeContentView : UIView <NTKTimeView>
{
    BOOL frozen;
...
@property(nonatomic) CGSize logoImageSizeForCircularDial; // @synthesize logoImageSizeForCircularDial=_logoImageSizeForCircularDial;
...
- (void)setViewsVisibilityForDial:(NSUInteger)arg1 style:(NSUInteger)arg2;
- (void)updateStylesFraction:(double)arg1 fromStyle:(NSUInteger)arg2 toStyle:(NSUInteger)arg3;
...
- (id)createTimeLabelWithFont:(id)arg1 option:(NSUInteger)arg2;
...
- (id)initWithDevice:(id)arg1 dial:(NSUInteger)arg2 style:(NSUInteger)arg3 color:(NSUInteger)arg4;
