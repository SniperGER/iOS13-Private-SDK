...
- (void)_configureLayout:(id)arg1 withNormalSize:(CGSize)arg2 editingSize:(CGSize)arg3 variant:(BOOL)arg4 addCircleOverrides:(BOOL)arg5 makeRuleBlock:(CDUnknownBlockType)arg6;
