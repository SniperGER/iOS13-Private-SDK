...
@interface NTKCalendarEntryModel : NTKTimelineEntryModel
{
    ...
    NSUInteger _overlappingEventCount;
    NSUInteger _eventsInDayCount;
    NSURL *_launchURL;
...
+ (id)_swapPlaceholderString:(id)arg1 withTimeStringForDate:(id)arg2 inString:(id)arg3 usingBaseFont:(id)arg4 smallCapsBaseFont:(id)arg5 timeZone:(id)arg6 options:(NSUInteger)arg7;
...
@property(nonatomic) NSUInteger eventsInDayCount; // @synthesize eventsInDayCount=_eventsInDayCount;
@property(nonatomic) BOOL overlappingDates; // @synthesize overlappingDates=_overlappingDates;
@property(nonatomic) NSUInteger overlappingEventCount; // @synthesize overlappingEventCount=_overlappingEventCount;
