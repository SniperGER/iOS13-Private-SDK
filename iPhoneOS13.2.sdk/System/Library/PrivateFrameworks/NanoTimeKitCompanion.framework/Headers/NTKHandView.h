...
@class CALayer, CLKDevice, NTKColoringImageView, UIColor, UIImage, UIImageView;
@protocol CLKMonochromeFilterProvider;

@interface NTKHandView : UIView
{
...
@property(nonatomic) UIEdgeInsets shadowInsets; // @synthesize shadowInsets=_shadowInsets;
@property(nonatomic) BOOL shadowsHidden; // @synthesize shadowsHidden=_shadowsHidden;
@property(nonatomic) UIEdgeInsets inlayInsets; // @synthesize inlayInsets=_inlayInsets;
...
- (void)layoutSubviews;
- (id)initWithImage:(id)arg1 style:(NSUInteger)arg2 forDevice:(id)arg3;
