...
@property(copy, nonatomic) id /* block */ alphaProviderBlock; // @synthesize alphaProviderBlock=_alphaProviderBlock;
@property(copy, nonatomic) id /* block */ platterColorProviderBlock; // @synthesize platterColorProviderBlock=_platterColorProviderBlock;
@property(copy, nonatomic) id /* block */ foregroundColorProviderBlock; // @synthesize foregroundColorProviderBlock=_foregroundColorProviderBlock;
