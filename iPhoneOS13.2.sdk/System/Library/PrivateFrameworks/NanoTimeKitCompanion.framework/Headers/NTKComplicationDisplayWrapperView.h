...
@property(copy, nonatomic) id /* block */ needsResizeHandler; // @synthesize needsResizeHandler=_needsResizeHandler;
...
@property(copy, nonatomic) id /* block */ touchUpInsideHandler; // @synthesize touchUpInsideHandler=_touchUpInsideHandler;
@property(copy, nonatomic) id /* block */ touchDownHandler; // @synthesize touchDownHandler=_touchDownHandler;
...
@property(copy, nonatomic) id /* block */ displayConfigurationHandler; // @synthesize displayConfigurationHandler=_displayConfigurationHandler;
