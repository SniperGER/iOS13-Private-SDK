...
- (void)layoutNodes:(id)arg1 forDevice:(id)arg2 offset:(NSUInteger)arg3 center:(CGPoint)arg4 radius:(double)arg5 angleMultiplier:(double)arg6 scale:(double)arg7 rotate:(BOOL)arg8 round:(BOOL)arg9;
...
- (id)ticks:(unsigned int)arg1 forDevice:(id)arg2 center:(CGPoint)arg3 radius:(double)arg4 color1:(id)arg5 color2:(id)arg6 smallSize:(CGSize)arg7 largeSize:(CGSize)arg8 smallFilterWidth:(double)arg9 largeFilterWidth:(double)arg10 l1mod:(unsigned int)arg11 l2mod:(unsigned int)arg12;
