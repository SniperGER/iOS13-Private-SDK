...
- (void)getWellnessEntriesBeforeDate:(id)arg1 limit:(NSUInteger)arg2 handler:(CDUnknownBlockType)arg3;
- (void)getWellnessEntriesAfterDate:(id)arg1 limit:(NSUInteger)arg2 handler:(CDUnknownBlockType)arg3;
