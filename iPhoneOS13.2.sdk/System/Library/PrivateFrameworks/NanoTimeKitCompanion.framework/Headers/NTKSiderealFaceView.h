...
@interface NTKSiderealFaceView : NTKFaceView <NTKTimeView, NTKSiderealDataSourceDelegate>
{
...
- (void)_setViewMode:(NSUInteger)arg1 animated:(BOOL)arg2 completion:(CDUnknownBlockType)arg3;
