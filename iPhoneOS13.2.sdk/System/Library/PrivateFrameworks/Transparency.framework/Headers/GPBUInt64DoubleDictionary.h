...
- (void)removeAll;
- (void)removeDoubleForKey:(NSUInteger)arg1;
- (void)setDouble:(double)arg1 forKey:(NSUInteger)arg2;
- (void)addEntriesFromDictionary:(id)arg1;
- (BOOL)getDouble:(double )arg1 forKey:(NSUInteger)arg2;
...
- (id)initWithDoubles:(const double )arg1 forKeys:(const NSUInteger )arg2 count:(NSUInteger)arg3;
- (id)init;
