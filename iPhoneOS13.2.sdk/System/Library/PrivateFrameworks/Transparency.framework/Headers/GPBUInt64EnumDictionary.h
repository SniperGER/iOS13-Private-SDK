...
- (void)setEnum:(int)arg1 forKey:(NSUInteger)arg2;
- (void)removeAll;
- (void)removeEnumForKey:(NSUInteger)arg1;
- (void)setRawValue:(int)arg1 forKey:(NSUInteger)arg2;
- (void)addRawEntriesFromDictionary:(id)arg1;
- (void)enumerateKeysAndEnumsUsingBlock:(CDUnknownBlockType)arg1;
- (BOOL)getRawValue:(int )arg1 forKey:(NSUInteger)arg2;
- (BOOL)getEnum:(int )arg1 forKey:(NSUInteger)arg2;
...
- (id)initWithValidationFunction:(/* void * CDUnknownFunctionPointerType */)arg1 rawValues:(const int )arg2 forKeys:(const NSUInteger )arg3 count:(NSUInteger)arg4;
