...
- (void)replaceValueAtIndex:(NSUInteger)arg1 withValue:(float)arg2;
- (void)insertValue:(float)arg1 atIndex:(NSUInteger)arg2;
- (void)addValues:(const float )arg1 count:(NSUInteger)arg2;
...
- (id)initWithValues:(const float )arg1 count:(NSUInteger)arg2;
