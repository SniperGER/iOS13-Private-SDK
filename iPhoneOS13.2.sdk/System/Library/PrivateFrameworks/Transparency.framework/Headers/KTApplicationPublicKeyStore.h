...
@interface KTApplicationPublicKeyStore : NSObject
{
    ...
    NSUInteger _patLogBeginningMs;
    NSUInteger _tltLogBeginningMs;
...
@property NSUInteger tltLogBeginningMs; // @synthesize tltLogBeginningMs=_tltLogBeginningMs;
@property NSUInteger patLogBeginningMs; // @synthesize patLogBeginningMs=_patLogBeginningMs;
...
- (BOOL)detectEpochChangeAndResetData:(NSUInteger)arg1 patLogBeginningMs:(NSUInteger)arg2 error:(id )arg3;
