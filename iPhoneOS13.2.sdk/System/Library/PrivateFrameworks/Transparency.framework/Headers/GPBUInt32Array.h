...
- (void)replaceValueAtIndex:(NSUInteger)arg1 withValue:(unsigned int)arg2;
- (void)insertValue:(unsigned int)arg1 atIndex:(NSUInteger)arg2;
- (void)addValues:(const unsigned int )arg1 count:(NSUInteger)arg2;
- (void)addValue:(unsigned int)arg1;
- (void)internalResizeToCapacity:(NSUInteger)arg1;
- (unsigned int)valueAtIndex:(NSUInteger)arg1;
...
- (id)initWithValues:(const unsigned int )arg1 count:(NSUInteger)arg2;
