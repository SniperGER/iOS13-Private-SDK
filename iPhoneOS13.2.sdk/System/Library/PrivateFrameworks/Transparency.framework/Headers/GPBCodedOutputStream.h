...
- (void)writeRawVarintSizeTAs32:(NSUInteger)arg1;
- (void)writeRawVarint32:(int)arg1;
- (void)writeTag:(unsigned int)arg1 format:(int)arg2;
- (void)writeRawPtr:(const void *)arg1 offset:(NSUInteger)arg2 length:(NSUInteger)arg3;
...
- (void)writeFixed64:(int)arg1 value:(NSUInteger)arg2;
- (void)writeFixed64NoTag:(NSUInteger)arg1;
...
- (void)writeUInt64:(int)arg1 value:(NSUInteger)arg2;
- (void)writeUInt64NoTag:(NSUInteger)arg1;
