...
- (void)setUInt64:(NSUInteger)arg1 forKey:(long long)arg2;
- (void)addEntriesFromDictionary:(id)arg1;
- (BOOL)getUInt64:(NSUInteger )arg1 forKey:(long long)arg2;
...
- (id)initWithUInt64s:(const NSUInteger )arg1 forKeys:(const long long )arg2 count:(NSUInteger)arg3;
- (id)init;
