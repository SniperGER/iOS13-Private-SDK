...
- (void)contextForApplication:(id)arg1 logClient:(id)arg2 fetchState:(_Bool)arg3 completionHandler:(id /* block */)arg4;
- (void)createContextForApplication:(id)arg1 dataStore:(id)arg2 logClient:(id)arg3 completionHandler:(id /* block */)arg4;
- (void)configureWithClient:(id)arg1 force:(_Bool)arg2 completionHandler:(id /* block */)arg3;
- (void)configureWithClient:(id)arg1 completionHandler:(id /* block */)arg2;
- (void)configure:(id /* block */)arg1;
- (void)forcedConfigure:(_Bool)arg1 logClient:(id)arg2 completionHandler:(id /* block */)arg3;
