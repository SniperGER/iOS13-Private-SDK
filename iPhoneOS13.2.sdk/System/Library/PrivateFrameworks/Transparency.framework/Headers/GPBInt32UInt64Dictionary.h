...
- (void)setUInt64:(NSUInteger)arg1 forKey:(int)arg2;
- (void)addEntriesFromDictionary:(id)arg1;
- (BOOL)getUInt64:(NSUInteger )arg1 forKey:(int)arg2;
...
- (id)initWithUInt64s:(const NSUInteger )arg1 forKeys:(const int )arg2 count:(NSUInteger)arg3;
- (id)init;
