...
- (void)removeAll;
- (void)removeBoolForKey:(NSUInteger)arg1;
- (void)setBool:(BOOL)arg1 forKey:(NSUInteger)arg2;
- (void)addEntriesFromDictionary:(id)arg1;
- (BOOL)getBool:(BOOL )arg1 forKey:(NSUInteger)arg2;
...
- (id)initWithBools:(const BOOL )arg1 forKeys:(const NSUInteger )arg2 count:(NSUInteger)arg3;
- (id)init;
