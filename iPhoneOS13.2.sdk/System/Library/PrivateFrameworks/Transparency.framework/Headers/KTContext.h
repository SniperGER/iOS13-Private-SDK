...
- (NSUInteger)handleKTRequest:(id)arg1 queryResponse:(id)arg2 error:(id )arg3;
- (void)validateKTSMTsMerged:(id)arg1 uri:(id)arg2 uuid:(id)arg3 accountId:(id)arg4;
- (void)clearState:(CDUnknownBlockType)arg1;
- (NSUInteger)validateEnrollmentWithAnalytics:(id)arg1 transparentData:(id )arg2 error:(id )arg3;
- (NSUInteger)validateEnrollment:(id)arg1 transparentData:(id )arg2 error:(id )arg3;
- (NSUInteger)validateEnrollment:(id)arg1 queryResponse:(id)arg2 transparentData:(id )arg3 error:(id )arg4;
- (id)analyticsForRequestValidation:(id)arg1 initialResult:(NSUInteger)arg2 result:(NSUInteger)arg3;
- (NSUInteger)handleVerifyInsertResponse:(id)arg1 request:(id)arg2 transparentData:(id )arg3 error:(id )arg4;
- (NSUInteger)writeFailureForRequest:(id)arg1 proof:(id)arg2 error:(id )arg3;
- (NSUInteger)validateSelfWithAnalytics:(id)arg1 transparentData:(id )arg2 error:(id )arg3;
- (NSUInteger)validateSelf:(id)arg1 transparentData:(id )arg2 error:(id )arg3;
- (NSUInteger)validateSelf:(id)arg1 queryResponse:(id)arg2 transparentData:(id )arg3 error:(id )arg4;
- (NSUInteger)handleVerifySelfResponse:(id)arg1 request:(id)arg2 transparentData:(id )arg3 error:(id )arg4;
- (NSUInteger)validatePeerWithAnalytics:(id)arg1 transparentData:(id )arg2 error:(id )arg3;
- (NSUInteger)validatePeer:(id)arg1 transparentData:(id )arg2 error:(id )arg3;
- (NSUInteger)validatePeer:(id)arg1 queryResponse:(id)arg2 transparentData:(id )arg3 error:(id )arg4;
- (void)fetchQueryForKTRequest:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (NSUInteger)handleVerifyPeerResponse:(id)arg1 request:(id)arg2 transparentData:(id )arg3 error:(id )arg4;
- (NSUInteger)verifyDeviceWitnesses:(id)arg1 request:(id)arg2 loggableDatas:(id)arg3 uriVRFOutput:(id)arg4 error:(id )arg5;
- (BOOL)ready:(id )arg1;
