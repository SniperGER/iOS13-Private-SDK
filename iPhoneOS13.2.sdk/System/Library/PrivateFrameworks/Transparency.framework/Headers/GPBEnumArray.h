...
+ (id)arrayWithValidationFunction:(/* void * CDUnknownFunctionPointerType */)arg1 capacity:(NSUInteger)arg2;
+ (id)arrayWithValueArray:(id)arg1;
+ (id)arrayWithValidationFunction:(/* void * CDUnknownFunctionPointerType */)arg1 rawValue:(int)arg2;
+ (id)arrayWithValidationFunction:(/* void * CDUnknownFunctionPointerType */)arg1;
+ (id)array;
...
- (void)enumerateRawValuesWithOptions:(NSUInteger)arg1 usingBlock:(CDUnknownBlockType)arg2;
...
- (id)initWithValidationFunction:(/* void * CDUnknownFunctionPointerType */)arg1 capacity:(NSUInteger)arg2;
- (id)initWithValidationFunction:(/* void * CDUnknownFunctionPointerType */)arg1 rawValues:(const int )arg2 count:(NSUInteger)arg3;
- (id)initWithValidationFunction:(/* void * CDUnknownFunctionPointerType */)arg1;
