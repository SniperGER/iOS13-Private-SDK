...
- (void)removeAll;
- (void)removeUInt32ForKey:(NSUInteger)arg1;
- (void)setUInt32:(unsigned int)arg1 forKey:(NSUInteger)arg2;
- (void)addEntriesFromDictionary:(id)arg1;
- (BOOL)getUInt32:(unsigned int )arg1 forKey:(NSUInteger)arg2;
...
- (id)initWithUInt32s:(const unsigned int )arg1 forKeys:(const NSUInteger )arg2 count:(NSUInteger)arg3;
- (id)init;
