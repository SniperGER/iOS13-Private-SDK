...
- (void)removeAll;
- (void)removeInt64ForKey:(NSUInteger)arg1;
- (void)setInt64:(long long)arg1 forKey:(NSUInteger)arg2;
- (void)addEntriesFromDictionary:(id)arg1;
- (BOOL)getInt64:(long long )arg1 forKey:(NSUInteger)arg2;
...
- (id)initWithInt64s:(const long long )arg1 forKeys:(const NSUInteger )arg2 count:(NSUInteger)arg3;
- (id)init;
