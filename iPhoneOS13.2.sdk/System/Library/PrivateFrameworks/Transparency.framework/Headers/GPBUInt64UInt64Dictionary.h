...
- (void)removeAll;
- (void)removeUInt64ForKey:(NSUInteger)arg1;
- (void)setUInt64:(NSUInteger)arg1 forKey:(NSUInteger)arg2;
- (void)addEntriesFromDictionary:(id)arg1;
- (BOOL)getUInt64:(NSUInteger )arg1 forKey:(NSUInteger)arg2;
...
- (id)initWithUInt64s:(const NSUInteger )arg1 forKeys:(const NSUInteger )arg2 count:(NSUInteger)arg3;
- (id)init;
