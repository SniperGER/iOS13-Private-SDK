...
- (void)setUInt64:(NSUInteger)arg1 forKey:(BOOL)arg2;
...
- (BOOL)getUInt64:(NSUInteger )arg1 forKey:(BOOL)arg2;
...
- (id)initWithUInt64s:(const NSUInteger )arg1 forKeys:(const BOOL )arg2 count:(NSUInteger)arg3;
- (id)init;
