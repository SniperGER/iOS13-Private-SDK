...
- (void)removeAll;
- (void)removeFloatForKey:(NSUInteger)arg1;
- (void)setFloat:(float)arg1 forKey:(NSUInteger)arg2;
- (void)addEntriesFromDictionary:(id)arg1;
- (BOOL)getFloat:(float )arg1 forKey:(NSUInteger)arg2;
...
- (id)initWithFloats:(const float )arg1 forKeys:(const NSUInteger )arg2 count:(NSUInteger)arg3;
- (id)init;
