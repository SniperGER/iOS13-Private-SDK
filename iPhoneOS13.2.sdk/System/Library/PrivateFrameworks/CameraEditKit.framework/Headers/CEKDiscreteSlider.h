...
- (void)_setSelectedIndex:(unsigned long long)arg1 shouldDelegate:(_Bool)arg2 shouldEmitFeedback:(_Bool)arg3 shouldScroll:(_Bool)arg4 scrollDuration:(double)arg5 scrollCurve:(id)arg6 scrollCompletion:(id /* block */)arg7;
- (void)_updateFonts;
