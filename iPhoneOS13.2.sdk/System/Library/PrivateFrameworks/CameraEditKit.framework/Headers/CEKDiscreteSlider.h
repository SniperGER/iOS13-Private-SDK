...
- (void)_setSelectedIndex:(NSUInteger)arg1 shouldDelegate:(BOOL)arg2 shouldEmitFeedback:(BOOL)arg3 shouldScroll:(BOOL)arg4 scrollDuration:(double)arg5 scrollCurve:(id)arg6 scrollCompletion:(CDUnknownBlockType)arg7;
- (void)_updateFonts;
...
- (void)setSelectedIndex:(NSUInteger)arg1 animatedDuration:(double)arg2 animatedCurve:(id)arg3 completion:(CDUnknownBlockType)arg4;
