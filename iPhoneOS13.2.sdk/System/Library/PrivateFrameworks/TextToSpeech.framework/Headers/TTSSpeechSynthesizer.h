...
@interface TTSSpeechSynthesizer : NSObject <TTSSpeechConnectionDelegate>
{
    ...
    NSUInteger _requestClientIdentifier;
...
+ (id)synthesizerForSynthesizerID:(NSUInteger)arg1;
...
@property(nonatomic) NSUInteger requestClientIdentifier; // @synthesize requestClientIdentifier=_requestClientIdentifier;
