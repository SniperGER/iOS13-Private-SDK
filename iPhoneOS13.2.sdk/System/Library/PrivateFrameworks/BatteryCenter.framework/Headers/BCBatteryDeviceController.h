...
//     struct __CFRunLoopSource _accessoriesLimitedPowerRunLoopSource;
    ...
    NSUInteger _numFakeDevices;
    BOOL _chargeChangeHandlingDisabled;
    NSArray *_sortedDevices;
}

+ (id)_glyphForBatteryDevice:(id)arg1;
+ (id)_glyphForBatteryDeviceWithTransport:(long long)arg1 accessoryCategory:(NSUInteger)arg2 vendor:(long long)arg3 productIdentifier:(long long)arg4 parts:(NSUInteger)arg5 modelNumber:(id)arg6;
+ (id)_internalBatteryDeviceGlyph;
+ (id)sharedInstance;
@property(nonatomic, getter=_chargeChangeHandlingDisabled, setter=_setChargeChangeHandlingDisabled:) BOOL chargeChangeHandlingDisabled; // @synthesize chargeChangeHandlingDisabled=_chargeChangeHandlingDisabled;
...
- (long long)_lowBatteryLevelForVendor:(long long)arg1 accessoryCategory:(NSUInteger)arg2 transportType:(long long)arg3;
- (id)_nameForVendor:(long long)arg1 accessoryCategory:(NSUInteger)arg2 name:(id)arg3 partName:(id)arg4;
- (CGSize)_largestBatteryDeviceGlyphSize;
- (NSUInteger)_partFromPowerSourcePartIdentifier:(id)arg1;
- (NSUInteger)_accessoryCategoryFromPowerSourceAccessoryCategory:(id)arg1 partType:(NSUInteger)arg2 transportType:(long long)arg3 vendor:(long long)arg4 productIdentifier:(long long)arg5;
