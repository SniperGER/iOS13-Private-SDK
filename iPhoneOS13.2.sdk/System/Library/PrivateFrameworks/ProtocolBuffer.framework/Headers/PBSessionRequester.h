...
@interface PBSessionRequester : NSObject <NSURLSessionDataDelegate>
{
    ...
    NSUInteger _downloadPayloadSize;
    ...
    NSUInteger _nwActivityDomain;
    NSUInteger _nwActivityLabel;
    struct {
...
@property(nonatomic) NSUInteger nwActivityLabel; // @synthesize nwActivityLabel=_nwActivityLabel;
@property(nonatomic) NSUInteger nwActivityDomain; // @synthesize nwActivityDomain=_nwActivityDomain;
...
@property(readonly, nonatomic) NSUInteger downloadPayloadSize; // @synthesize downloadPayloadSize=_downloadPayloadSize;
@property(readonly, nonatomic) NSUInteger uploadPayloadSize; // @synthesize uploadPayloadSize=_uploadPayloadSize;
