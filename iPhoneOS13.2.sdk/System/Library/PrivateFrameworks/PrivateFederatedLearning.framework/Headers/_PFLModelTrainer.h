...
- (void)trainNumberModel:(id)arg1 epoch:(NSUInteger)arg2 dataSource:(id)arg3 completion:(CDUnknownBlockType)arg4;
- (void)trainImageModel:(id)arg1 epoch:(NSUInteger)arg2 imageDirectory:(id)arg3 completion:(CDUnknownBlockType)arg4;
- (id)init;
