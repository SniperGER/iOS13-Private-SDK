...
- (_Bool)copyWeightsAndBiasesForLayerNamed:(id)arg1 combinedWeightBiasesOut:(float **)arg2 weightCountOut:(unsigned long long *)arg3 biasCountOut:(unsigned long long *)arg4;
- (id)sdpWithInitVector:(id)arg1 currentVector:(id)arg2 gamma:(double)arg3 nu:(double)arg4;
- (id)sdpWithInitWeights:(id)arg1 currentWeights:(id)arg2 initBiases:(id)arg3 currentBiases:(id)arg4 diffOnly:(_Bool)arg5 gamma:(double)arg6 nu:(double)arg7;
