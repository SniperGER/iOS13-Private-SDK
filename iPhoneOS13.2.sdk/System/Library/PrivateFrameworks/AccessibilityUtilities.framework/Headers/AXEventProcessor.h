...
@property(copy, nonatomic) id /* block */ systemEventHandler; // @synthesize systemEventHandler=_systemEventHandler;
...
@property(copy, nonatomic) id /* block */ HIDEventHandler; // @synthesize HIDEventHandler=_HIDEventHandler;
