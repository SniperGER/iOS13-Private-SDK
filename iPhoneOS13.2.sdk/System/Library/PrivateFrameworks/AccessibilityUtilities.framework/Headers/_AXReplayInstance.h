...
+ (id)replayBlock:(id /* block */)arg1 name:(id)arg2 attempts:(long long)arg3 interval:(double)arg4 async:(_Bool)arg5 queue:(id)arg6 completion:(id /* block */)arg7;
...
@property(copy, nonatomic) id /* block */ replayBlock; // @synthesize replayBlock=_replayBlock;
