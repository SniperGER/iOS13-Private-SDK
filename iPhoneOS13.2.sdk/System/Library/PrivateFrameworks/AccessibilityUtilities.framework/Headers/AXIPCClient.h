...
@property(copy, nonatomic) id /* block */ portDeathHandler; // @synthesize portDeathHandler=_portDeathHandler;
...
- (_Bool)sendAsyncMessage:(id)arg1 replyOnQueue:(id)arg2 replyHandler:(id /* block */)arg3;
- (_Bool)sendAsyncMessage:(id)arg1 withReplyHandler:(id /* block */)arg2;
...
- (_Bool)_prepareToSendMessage:(id)arg1 withError:(id *)arg2 prepSuccessHandler:(id /* block */)arg3;
