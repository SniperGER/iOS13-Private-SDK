...
+ (id)sharedManager;
@property(copy, nonatomic) id /* block */ installationEventRepPost; // @synthesize installationEventRepPost=_installationEventRepPost;
@property(copy, nonatomic) id /* block */ installationHIDCallback; // @synthesize installationHIDCallback=_installationHIDCallback;
@property(copy, nonatomic) id /* block */ installationGSCallback; // @synthesize installationGSCallback=_installationGSCallback;
...
- (id)installEventTap:(id /* block */)arg1 identifier:(id)arg2 type:(int)arg3 skipDeviceMatching:(_Bool)arg4 wantsDigitizerEvents:(_Bool)arg5 wantsKeyboardEvents:(_Bool)arg6 wantsATVRemoteEvents:(_Bool)arg7 wantsLisaEvents:(_Bool)arg8 wantsMouseEvents:(_Bool)arg9 matchingServiceHandler:(id /* block */)arg10;
- (id)installEventTap:(id /* block */)arg1 identifier:(id)arg2 type:(int)arg3 skipDeviceMatching:(_Bool)arg4 wantsDigitizerEvents:(_Bool)arg5 wantsKeyboardEvents:(_Bool)arg6 wantsATVRemoteEvents:(_Bool)arg7 wantsLisaEvents:(_Bool)arg8 wantsMouseEvents:(_Bool)arg9;
