...
+ (id)touchRepresentationWithHandType:(unsigned int)arg1 location:(CGPoint)arg2;
...
+ (id)representationWithType:(unsigned int)arg1 subtype:(int)arg2 time:(NSUInteger)arg3 location:(CGPoint)arg4 windowLocation:(CGPoint)arg5 handInfo:(id)arg6;
...
@property(nonatomic) NSUInteger additionalFlags; // @synthesize additionalFlags=_additionalFlags;
...
@property(nonatomic) NSUInteger HIDTime; // @synthesize HIDTime=_HIDTime;
...
@property(nonatomic) NSUInteger senderID; // @synthesize senderID=_senderID;
@property(nonatomic) int flags; // @synthesize flags=_flags;
@property(nonatomic) NSUInteger time; // @synthesize time=_time;
@property(nonatomic) CGPoint windowLocation; // @synthesize windowLocation=_windowLocation;
