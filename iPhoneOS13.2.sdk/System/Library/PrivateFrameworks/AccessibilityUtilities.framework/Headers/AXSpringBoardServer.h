...
@property(copy, nonatomic) id /* block */ currentAlertHandler; // @synthesize currentAlertHandler=_currentAlertHandler;
...
- (void)_isSystemAppFrontmostExcludingSiri:(_Bool)arg1 completion:(id /* block */)arg2;
