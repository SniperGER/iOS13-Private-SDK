...
- (id)description;
- (_Bool)_transactionWithExclusivity:(_Bool)arg1 transaction:(id /* block */)arg2;
- (void)_txnEnd;
- (void)_txnRollback;
...
- (_Bool)prepQuery:(id)arg1 onPrep:(id /* block */)arg2 onError:(id /* block */)arg3;
- (void)_logQueryPlanForQuery:(id)arg1;
- (_Bool)runQuery:(id)arg1 onRow:(id /* block */)arg2;
