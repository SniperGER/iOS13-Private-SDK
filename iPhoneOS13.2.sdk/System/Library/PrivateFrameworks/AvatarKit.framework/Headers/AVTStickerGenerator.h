...
+ (void)addProps:(id)arg1 toScene:(id)arg2 forAvatar:(id)arg3 withCamera:(id)arg4 forExport:(_Bool)arg5 async:(_Bool)arg6 workQueue:(id)arg7 callbackQueue:(id)arg8 completion:(id /* block */)arg9;
+ (void)applyConfiguration:(id)arg1 toScene:(id)arg2 withAvatar:(id)arg3 defaultCamera:(id)arg4 forExport:(_Bool)arg5 async:(_Bool)arg6 workQueue:(id)arg7 callbackQueue:(id)arg8 completion:(id /* block */)arg9;
+ (void)applyConfiguration:(id)arg1 toScene:(id)arg2 withAvatar:(id)arg3 defaultCamera:(id)arg4 forExport:(_Bool)arg5 completion:(id /* block */)arg6 async:(_Bool)arg7;
...
- (void)stickerImageWithConfiguration:(id)arg1 correctClipping:(_Bool)arg2 completionHandler:(id /* block */)arg3;
