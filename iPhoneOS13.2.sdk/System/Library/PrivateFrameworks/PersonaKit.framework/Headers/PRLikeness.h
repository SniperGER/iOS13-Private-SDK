...
+ (id)_photoWithScope:(NSUInteger)arg1 image:(CGImageRef)arg2 cropRectForTopLeftOrigin:(CGRect)arg3;
+ (id)photoWithScope:(NSUInteger)arg1 image:(CGImageRef)arg2;
...
+ (id)monogramWithScope:(NSUInteger)arg1 recipe:(id)arg2 staticRepresentation:(CGImageRef)arg3;
