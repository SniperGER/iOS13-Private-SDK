...
- (void)handleAppleIDEvent:(NSUInteger)arg1 account:(id)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)likenessForEmailAddress:(id)arg1 desiredFreshness:(NSUInteger)arg2 completion:(CDUnknownBlockType)arg3;
- (void)likenessForEmailAddress:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (void)likenessForPhoneNumber:(id)arg1 desiredFreshness:(NSUInteger)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)currentLikenessForPrimaryiCloudAccountWithDesiredFreshness:(NSUInteger)arg1 completion:(CDUnknownBlockType)arg2;
