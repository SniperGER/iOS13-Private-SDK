...
@class CCUIContentModuleContext, CCUIMenuModuleItemView, MTMaterialView, MTVisualStylingProvider, NSMutableArray, NSMutableDictionary, NSString, UIActivityIndicatorView, UILabel, UILongPressGestureRecognizer, UIScrollView, UISelectionFeedbackGenerator, UIStackView, UIView;
...
@property(nonatomic) NSUInteger minimumMenuItems; // @synthesize minimumMenuItems=_minimumMenuItems;
// - (void).cxx_destruct;
...
- (id)_menuItemFromPlaceholderIndex:(NSUInteger)arg1;
