...
- (id)makeOptOutRequest:(id)arg1 status:(_Bool)arg2 timestamp:(double)arg3 withCompletion:(id /* block */)arg4;
- (id)makeSegmentRequest:(id)arg1 forceSegments:(_Bool)arg2 withCompletion:(id /* block */)arg3;
