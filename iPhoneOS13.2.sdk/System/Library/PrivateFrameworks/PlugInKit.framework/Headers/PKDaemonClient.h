...
+ (id)convertToXPC:(id)arg1 version:(NSUInteger)arg2;
...
- (void)releaseHold:(id)arg1 flags:(NSUInteger)arg2 reply:(CDUnknownBlockType)arg3;
- (void)holdPlugins:(id)arg1 flags:(NSUInteger)arg2 reply:(CDUnknownBlockType)arg3;
...
- (void)matchPlugIns:(id)arg1 flags:(NSUInteger)arg2 uuid:(id)arg3 reply:(CDUnknownBlockType)arg4;
...
- (void)accessPlugIns:(id)arg1 synchronously:(BOOL)arg2 flags:(NSUInteger)arg3 reply:(CDUnknownBlockType)arg4;
- (void)readyPlugIns:(id)arg1 synchronously:(BOOL)arg2 flags:(NSUInteger)arg3 environment:(id)arg4 reply:(CDUnknownBlockType)arg5;
- (void)bulkPlugins:(NSUInteger)arg1 reply:(CDUnknownBlockType)arg2;
