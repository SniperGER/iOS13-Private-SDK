...
- (void)sendSynchronously:(_Bool)arg1 request:(id)arg2 reply:(id /* block */)arg3;
...
- (void)accessPlugIns:(id)arg1 synchronously:(_Bool)arg2 flags:(unsigned long long)arg3 reply:(id /* block */)arg4;
- (void)readyPlugIns:(id)arg1 synchronously:(_Bool)arg2 flags:(unsigned long long)arg3 environment:(id)arg4 reply:(id /* block */)arg5;
