...
- (void)loadSessionsForModel:(id)arg1 excludeItemIdsUsedWithin:(double)arg2 limit:(NSUInteger)arg3 onlyAppleInternal:(BOOL)arg4 block:(CDUnknownBlockType)arg5;
- (void)_loadSessionsForModel:(id)arg1 privacyBudgetRefreshPeriod:(double)arg2 labelAndStartRows:(id)arg3 batchSize:(NSUInteger)arg4 supportPerLabel:(NSUInteger)arg5 block:(CDUnknownBlockType)arg6;
- (void)_loadSessionsForModel:(id)arg1 positiveRowId:(NSUInteger)arg2 negativeRowId:(NSUInteger)arg3 excludeItemIdsUsedWithin:(double)arg4 limit:(NSUInteger)arg5 onlyAppleInternal:(BOOL)arg6 positiveLabel:(NSUInteger)arg7 skew:(double)arg8 block:(CDUnknownBlockType)arg9;
- (void)_loadSessionsFromLabelAndTuples:(id)arg1 model:(id)arg2 numberOfRows:(NSUInteger)arg3 numberOfColumns:(NSUInteger)arg4 lastUsedMax:(double)arg5 block:(CDUnknownBlockType)arg6;
- (id)sessionDimensionsForModel:(id)arg1 startingRowId:(NSUInteger)arg2 onlyAppleInternal:(BOOL)arg3 labelFilter:(id)arg4;
- (void)loadSessionsForModel:(id)arg1 privacyBudgetRefreshPeriod:(double)arg2 labels:(id)arg3 batchSize:(NSUInteger)arg4 supportPerLabel:(NSUInteger)arg5 block:(CDUnknownBlockType)arg6;
