...
@interface HFItemManager : NSObject <HFStateDumpBuildable, HFHomeManagerObserver, HFHomeObserver, HFAccessoryObserver, HFResidentDeviceObserver, HFCameraObserver, HFMediaSessionObserver, HFMediaObjectObserver, HFAudioControlObserver, HFNetworkConfigurationObserver, HFNetworkRouterObserver, HFSoftwareUpdateControllerObserver, HFSoftwareUpdateObserver, HFSymptomsHandlerObserver, HFUserObserver, HFTelevisionObserver, HFHomeKitSettingsObserver, HFSymptomFixSessionObserver, HFTemperatureUnitObserver, HFItemUpdating>
{
    ...
    NSUInteger _overallLoadingState;
...
@property(nonatomic) NSUInteger overallLoadingState; // @synthesize overallLoadingState=_overallLoadingState;
...
- (NSUInteger)_sectionForItem:(id)arg1 assertOnNotFound:(BOOL)arg2;
- (NSUInteger)_sectionForItem:(id)arg1;
...
- (NSUInteger)_loadingStateForItem:(id)arg1;
...
- (id)displayedSectionIdentifierForSectionIndex:(NSUInteger)arg1;
- (NSUInteger)sectionIndexForDisplayedSectionIdentifier:(id)arg1;
- (id)displayedItemsInSectionWithIdentifier:(id)arg1;
- (id)displayedItemsInSection:(NSUInteger)arg1;
- (id)attributedFooterTitleForSection:(NSUInteger)arg1;
- (id)footerTitleForSection:(NSUInteger)arg1;
...
- (void)residentDevice:(id)arg1 didUpdateStatus:(NSUInteger)arg2;
- (void)residentDevice:(id)arg1 didUpdateEnabled:(BOOL)arg2;
- (void)residentDevice:(id)arg1 didUpdateCapabilities:(NSUInteger)arg2;
...
- (void)home:(id)arg1 remoteAccessStateDidChange:(NSUInteger)arg2;
...
- (void)homeManager:(id)arg1 residentProvisioningStatusChanged:(NSUInteger)arg2;
