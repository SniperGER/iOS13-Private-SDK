...
@class HFHomeKitSettingsAdapterManager, HFHomeKitSettingsValueManager, HFUserNameFormatter, HMHome, HMSettings, HMUser, NSSet, NSUUID;
...
@interface HFUserItem : HFItem <HFHomeKitItemProtocol, HFHomeKitSettingsVendor, NSCopying>
{
    ...
    HMHome *_home;
    HMUser *_user;
    NSUInteger _numberOfItemsContainedWithinGroup;
...
@property(readonly, nonatomic) NSUInteger numberOfItemsContainedWithinGroup; // @synthesize numberOfItemsContainedWithinGroup=_numberOfItemsContainedWithinGroup;
...
- (id)_setBoolSettingsValueForKeyPath:(id)arg1 newValue:(BOOL)arg2 settingsType:(NSUInteger)arg3;
- (BOOL)_getBoolSettingsValueForKeyPath:(id)arg1 defaultValue:(BOOL)arg2 settingsType:(NSUInteger)arg3;
...
- (id)initWithHome:(id)arg1 user:(id)arg2 nameStyle:(NSUInteger)arg3;
- (id)init;
