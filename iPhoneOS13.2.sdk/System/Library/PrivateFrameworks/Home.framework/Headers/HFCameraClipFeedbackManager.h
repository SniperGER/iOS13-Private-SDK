...
@interface HFCameraClipFeedbackManager : NSObject <NSURLSessionDelegate>
{
    ...
    id /* CDUnknownBlockType */ _sessionCompletionHandler;
...
@property(nonatomic) NSUInteger apiVersion; // @synthesize apiVersion=_apiVersion;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ sessionCompletionHandler; // @synthesize sessionCompletionHandler=_sessionCompletionHandler;
// - (void).cxx_destruct;
