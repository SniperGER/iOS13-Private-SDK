...
@property(nonatomic) _Bool disableCertificatePinning; // @synthesize disableCertificatePinning=_disableCertificatePinning;
...
@property(copy, nonatomic) id /* block */ sessionCompletionHandler; // @synthesize sessionCompletionHandler=_sessionCompletionHandler;
