...
- (void)enumerateCorrectionEntriesForWord:(id)arg1 maxCorrections:(NSUInteger)arg2 withBlock:(CDUnknownBlockType)arg3;
- (void)enumerateCompletionEntriesForPrefix:(id)arg1 maxCompletions:(NSUInteger)arg2 withBlock:(CDUnknownBlockType)arg3;
- (void)enumerateCompletionsForPrefix:(id)arg1 maxCompletions:(NSUInteger)arg2 withBlock:(CDUnknownBlockType)arg3;
