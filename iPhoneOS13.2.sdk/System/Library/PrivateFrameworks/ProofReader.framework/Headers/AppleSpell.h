...
- (id)spellServer:(id)arg1 generateCandidatesForSelectedRange:(NSRange *)arg2 inString:(id)arg3 offset:(NSUInteger)arg4 types:(NSUInteger)arg5 options:(id)arg6 orthography:(id)arg7;
...
- (NSRange *)spellServer:(id)arg1 checkGrammarInString:(id)arg2 range:(NSRange *)arg3 language:(id)arg4 orthography:(id)arg5 mutableResults:(id)arg6 offset:(NSUInteger)arg7 details:(id )arg8;
//  (BOOL)_checkGrammarInString:(id)arg1 range:(NSRange *)arg2 language:(id)arg3 connection:(struct _PR_DB_IO )arg4 sender:(id)arg5 bufIO:(struct _PR_BUF_IO )arg6 errorRange:(NSRange * )arg7 details:(id )arg8;
- (id)linguisticTaggerForLanguage:(id)arg1 string:(id)arg2 range:(NSRange *)arg3 taggerIndex:(NSUInteger )arg4;
...
- (BOOL)_useAlternateLanguageForRange:(NSRange *)arg1 ofString:(id)arg2 language:(id)arg3 tagger:(id)arg4 taggerIndex:(NSUInteger)arg5 alternateLanguage:(id)arg6 alternateTagger:(id)arg7 alternateTaggerIndex:(NSUInteger)arg8 appIdentifier:(id)arg9;
...
- (id)_rankedCandidatesForRange:(NSRange *)arg1 candidates:(id)arg2 language:(id)arg3 tagger:(id)arg4 taggerIndex:(NSUInteger)arg5 appIdentifier:(id)arg6 scoreDictionary:(id)arg7;
- (BOOL)_getUnigramProbabilityForString:(id)arg1 languageModel:(id)arg2 probability:(double )arg3;
//  (BOOL)_addLanguageModelCompletionsForPartialWordRange:(NSRange *)arg1 language:(id)arg2 connection:(struct _PR_DB_IO )arg3 sender:(id)arg4 encoding:(unsigned int)arg5 tagger:(id)arg6 taggerIndex:(NSUInteger)arg7 appIdentifier:(id)arg8 waitForLanguageModel:(BOOL)arg9 candidates:(id)arg10;
...
- (NSUInteger)_contextLengthForRange:(NSRange *)arg1 language:(id)arg2 tagger:(id)arg3 taggerIndex:(NSUInteger)arg4 languageModel:(id)arg5 maxContextLength:(NSUInteger)arg6 context:(unsigned int )arg7 cleanOffset:(NSUInteger )arg8;
...
- (id)spellServer:(id)arg1 candidatesForSelectedRange:(NSRange *)arg2 inString:(id)arg3 offset:(NSUInteger)arg4 types:(NSUInteger)arg5 options:(id)arg6 orthography:(id)arg7;
...
- (id)_accentCorrectionResultForString:(id)arg1 range:(NSRange *)arg2 inString:(id)arg3 offset:(NSUInteger)arg4 language:(id)arg5 onlyAtInsertionPoint:(BOOL)arg6 keyEventArray:(id)arg7 selectedRangeValue:(id)arg8;
- (id)_phraseCapitalizationResultForString:(id)arg1 range:(NSRange *)arg2 currentWordRange:(NSRange *)arg3 inString:(id)arg4 offset:(NSUInteger)arg5 language:(id)arg6 onlyAtInsertionPoint:(BOOL)arg7 keyEventArray:(id)arg8 selectedRangeValue:(id)arg9;
- (id)_capitalizationResultForString:(id)arg1 range:(NSRange *)arg2 inString:(id)arg3 offset:(NSUInteger)arg4 language:(id)arg5 onlyAtInsertionPoint:(BOOL)arg6 keyEventArray:(id)arg7 selectedRangeValue:(id)arg8;
- (BOOL)findMatchingRangesForRange:(NSRange *)arg1 inString:(id)arg2 keyEventArray:(id)arg3 selectedRangeValue:(id)arg4 matchingStringRange:(NSRange * )arg5 correctableStringRange:(NSRange * )arg6 matchingKeyEventRange:(NSRange * )arg7 firstMisspelledKeyEventIndex:(NSUInteger )arg8 lastMisspelledKeyEventIndex:(NSUInteger )arg9 previousBackspaceCount:(NSUInteger )arg10;
- (BOOL)_findMatchingRangesForRange:(NSRange *)arg1 inString:(id)arg2 keyEventArray:(id)arg3 endingAtIndex:(NSUInteger)arg4 matchingStringRange:(NSRange * )arg5 correctableStringRange:(NSRange * )arg6 matchingKeyEventRange:(NSRange * )arg7 firstMisspelledKeyEventIndex:(NSUInteger )arg8 lastMisspelledKeyEventIndex:(NSUInteger )arg9 previousBackspaceCount:(NSUInteger )arg10;
...
- (void)enumerateCorrectionEntriesForWord:(id)arg1 maxCorrections:(NSUInteger)arg2 inLexiconForLanguage:(id)arg3 withBlock:(CDUnknownBlockType)arg4;
...
- (NSRange *)spellServer:(id)arg1 findMisspelledWordInString:(id)arg2 range:(NSRange *)arg3 languages:(id)arg4 topLanguages:(id)arg5 orthography:(id)arg6 checkOrthography:(BOOL)arg7 mutableResults:(id)arg8 offset:(NSUInteger)arg9 autocorrect:(BOOL)arg10 onlyAtInsertionPoint:(BOOL)arg11 initialCapitalize:(BOOL)arg12 autocapitalize:(BOOL)arg13 keyEventArray:(id)arg14 appIdentifier:(id)arg15 selectedRangeValue:(id)arg16 wordCount:(long long )arg17 countOnly:(BOOL)arg18 correction:(id )arg19;
...
//  (BOOL)_checkEnglishGrammarInString:(id)arg1 range:(NSRange *)arg2 indexIntoBuffer:(NSUInteger)arg3 bufferLength:(NSUInteger)arg4 language:(id)arg5 connection:(struct _PR_DB_IO )arg6 sender:(id)arg7 bufIO:(struct _PR_BUF_IO )arg8 retval:(int )arg9 errorRange:(NSRange * )arg10 details:(id )arg11;
...
- (id)_spellServer:(id)arg1 suggestGuessesForWordRange:(NSRange *)arg2 inString:(id)arg3 inLanguage:(id)arg4 options:(id)arg5 tagger:(id)arg6 taggerIndex:(NSUInteger)arg7 errorModel:(id)arg8 guessesDictionaries:(id)arg9;
...
- (id)_correctionResultForKoreanString:(id)arg1 range:(NSRange *)arg2 inString:(id)arg3 offset:(NSUInteger)arg4 tagger:(id)arg5 taggerIndex:(NSUInteger)arg6 appIdentifier:(id)arg7 dictionary:(id)arg8 keyEventArray:(id)arg9;
