...
@interface CNAutocompleteResult : NSObject
{
    ...
    id /* CDUnknownBlockType */ _membersProvider;
    id /* CDUnknownBlockType */ _contactProvider;
    NSArray *_diagnosticLogs;
    id /* CDUnknownBlockType */ _ignoreResultBlock;
    long long _resultType;
    NSNumber *_recentsIdentifier;
}

+ (BOOL)isSourceTypeConsideredSuggestion:(NSUInteger)arg1;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ ignoreResultBlock; // @synthesize ignoreResultBlock=_ignoreResultBlock;
@property(copy) NSDictionary *userInfo; // @synthesize userInfo=_userInfo;
@property(copy, nonatomic) NSArray *diagnosticLogs; // @synthesize diagnosticLogs=_diagnosticLogs;
@property(copy, nonatomic) id /* CDUnknownBlockType */ contactProvider; // @synthesize contactProvider=_contactProvider;
@property(copy, nonatomic) id /* CDUnknownBlockType */ membersProvider; // @synthesize membersProvider=_membersProvider;
...
@property NSUInteger sourceType; // @synthesize sourceType=_sourceType;
