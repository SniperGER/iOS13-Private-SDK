...
@property(copy, nonatomic) id /* block */ ignoreResultBlock; // @synthesize ignoreResultBlock=_ignoreResultBlock;
@property(copy) NSDictionary *userInfo; // @synthesize userInfo=_userInfo;
@property(copy, nonatomic) NSArray *diagnosticLogs; // @synthesize diagnosticLogs=_diagnosticLogs;
@property(copy, nonatomic) id /* block */ contactProvider; // @synthesize contactProvider=_contactProvider;
@property(copy, nonatomic) id /* block */ membersProvider; // @synthesize membersProvider=_membersProvider;
