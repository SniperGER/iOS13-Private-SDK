...
@class CNAutocompleteFetchRequest, CNAutocompleteQueryResponsePreparer, CNAutocompleteUserSession, CNCancelationToken;
...
@interface CNAutocompleteDelegateWrapper : NSObject <CNAutocompleteFetchDelegate, CNCancelable>
{
    ...
    NSUInteger _openNetworkActivityCalls;
...
@property(nonatomic) NSUInteger openNetworkActivityCalls; // @synthesize openNetworkActivityCalls=_openNetworkActivityCalls;
