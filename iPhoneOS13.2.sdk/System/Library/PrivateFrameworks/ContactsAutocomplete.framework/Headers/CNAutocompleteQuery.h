...
@class CNAutocompleteDelegateWrapper, CNAutocompleteFetchRequest, CNAutocompleteUserSession, CNCancelationToken;
...
+ (BOOL)searchTypeSupportsSuppressionOfAlreadyChosenAddresses:(NSUInteger)arg1;
