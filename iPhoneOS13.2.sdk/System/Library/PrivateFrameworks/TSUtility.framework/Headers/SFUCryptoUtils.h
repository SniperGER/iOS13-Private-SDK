...
+ (id)saltForSageFiles;
+ (id)saltFromVerifier:(id)arg1 saltLength:(NSUInteger)arg2;
...
+ (id)generateRandomSaltWithLength:(NSUInteger)arg1;
+ (id)generateRandomSalt;
+ (BOOL)generateRandomDataInBuffer:(char )arg1 length:(NSUInteger)arg2;
