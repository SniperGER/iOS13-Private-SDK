...
- (void)audioVideoProxyPropertyListForAsset:(id)arg1 performExport:(_Bool)arg2 atEnd:(id /* block */)arg3;
...
- (void)setAudioVideoAttributesForAVAsset:(id)arg1 path:(id)arg2 fullMetadata:(_Bool)arg3 readyHandler:(id /* block */)arg4;
...
- (void)setAudioVideoAttributesForURL:(id)arg1 fullMetadata:(_Bool)arg2 readyHandler:(id /* block */)arg3;
