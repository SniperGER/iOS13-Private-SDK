...
+ (CGImageSource )newImageSourceForURL:(id)arg1 options:(id)arg2;
+ (CGImageSource )newImageSourceForData:(id)arg1 uti:(id)arg2 options:(id)arg3;
...
@property(nonatomic) CGSize originalUnrotatedSize; // @synthesize originalUnrotatedSize=_originalUnrotatedSize;
...
- (id)encodedDataReduceIfLargerThan:(NSUInteger)arg1;
- (id)encodedData;
...
- (id)initWithPath:(id)arg1 fileData:(id)arg2 imageSource:(CGImageSource )arg3 cgImageProperties:(id)arg4 options:(id)arg5 loadMinMetadata:(BOOL)arg6 loadXmpData:(BOOL)arg7 xmpSidecarPath:(id)arg8;
- (id)initWithPath:(id)arg1 cgImageProperties:(id)arg2;
- (id)initWithPath:(id)arg1 imageSource:(CGImageSource )arg2 options:(id)arg3 loadXmpData:(BOOL)arg4 xmpSidecarPath:(id)arg5;
