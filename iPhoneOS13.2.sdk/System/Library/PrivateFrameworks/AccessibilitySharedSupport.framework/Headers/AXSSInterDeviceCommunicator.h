...
@class AXSSInterDeviceSecurityHelper, IDSService, MCNearbyServiceAdvertiser, MCNearbyServiceBrowser, MCPeerID, MCSession, NSArray, NSMutableArray, NSMutableDictionary, NSTimer;
...
@interface AXSSInterDeviceCommunicator : NSObject <IDSServiceDelegate, MCSessionDelegate, MCNearbyServiceBrowserDelegate, MCNearbyServiceAdvertiserDelegate>
{
    ...
    MCPeerID *_slave;
    MCPeerID *_master;
    NSUInteger _switchEventIndex;
    NSTimer *_dummyPacketTimer;
    NSUInteger _numberOfBurstPacketsRemaining;
...
@property(nonatomic) NSUInteger numberOfBurstPacketsRemaining; // @synthesize numberOfBurstPacketsRemaining=_numberOfBurstPacketsRemaining;
@property(retain, nonatomic) NSTimer *dummyPacketTimer; // @synthesize dummyPacketTimer=_dummyPacketTimer;
@property(nonatomic) NSUInteger switchEventIndex; // @synthesize switchEventIndex=_switchEventIndex;
...
- (id)_messageForSwitchEvent:(id)arg1 index:(NSUInteger)arg2;
