...
- (void)commonInitWithText:(id)arg1 selectedRange:(NSRange *)arg2 customURLParser:(CDUnknownBlockType)arg3 lookup:(BOOL)arg4;
- (id)initWithText:(id)arg1 selectedRange:(NSRange *)arg2 customURLParser:(CDUnknownBlockType)arg3;
