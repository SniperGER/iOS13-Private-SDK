...
- (void)normalizeWithParser:(id /* block */)arg1 lookupOnly:(_Bool)arg2;
- (void)normalize;
...
- (void)commonInitWithText:(id)arg1 selectedRange:(struct _NSRange)arg2 customURLParser:(id /* block */)arg3 lookup:(_Bool)arg4;
- (id)initWithText:(id)arg1 selectedRange:(struct _NSRange)arg2 customURLParser:(id /* block */)arg3;
