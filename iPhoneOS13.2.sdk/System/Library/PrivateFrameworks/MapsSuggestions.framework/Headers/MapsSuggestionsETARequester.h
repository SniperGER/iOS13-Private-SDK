...
// - (void).cxx_destruct;
- (BOOL)_timeball_requestETAsToEntries:(NSArray *)arg1 completion:(CDUnknownBlockType)arg2;
- (void)forceTransportType:(int)arg1;
- (BOOL)_old_requestETAsToEntries:(NSArray *)arg1 completion:(CDUnknownBlockType)arg2;
- (BOOL)_requestETAsToEntries:(NSArray *)arg1 completion:(CDUnknownBlockType)arg2;
...
- (BOOL)ETAsFromLocation:(id)arg1 toEntries:(NSArray *)arg2 completion:(CDUnknownBlockType)arg3;
