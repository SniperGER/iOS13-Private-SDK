...
- (_Bool)_timeball_requestETAsToEntries:(struct NSArray *)arg1 completion:(id /* block */)arg2;
- (void)forceTransportType:(int)arg1;
- (_Bool)_old_requestETAsToEntries:(struct NSArray *)arg1 completion:(id /* block */)arg2;
- (_Bool)_requestETAsToEntries:(struct NSArray *)arg1 completion:(id /* block */)arg2;
- (_Bool)_determineTransportTypeFromOrigin:(id)arg1 toEntry:(id)arg2 completion:(id /* block */)arg3;
...
- (_Bool)ETAsFromLocation:(id)arg1 toEntries:(struct NSArray *)arg2 completion:(id /* block */)arg3;
