...
- (_Bool)predictedTransportModeForDestinationMapItem:(struct GEOMapItemStorage *)arg1 originCoordinate:(struct CLLocationCoordinate2D)arg2 handler:(id /* block */)arg3;
- (void)storeSignalPack:(id)arg1 forMapItem:(struct GEOMapItemStorage *)arg2;
- (_Bool)predictedTransportModeForDestinationEntry:(id)arg1 originCoordinate:(struct CLLocationCoordinate2D)arg2 handler:(id /* block */)arg3;
- (void)dealloc;
- (id)init;
