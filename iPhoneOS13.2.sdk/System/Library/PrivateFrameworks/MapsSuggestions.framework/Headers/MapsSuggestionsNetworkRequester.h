...
- (BOOL)ETAsFromHereWaypoint:(id)arg1 destinationWaypoints:(NSArray *)arg2 transportType:(int)arg3 automobileOptions:(id)arg4 completion:(CDUnknownBlockType)arg5;
...
- (BOOL)resolveMapItemHandleData:(NSData )arg1 completion:(CDUnknownBlockType)arg2;
