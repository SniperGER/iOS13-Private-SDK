...
- (BOOL)_createEntriesWithinPeriod:(NSDateInterval )arg1 location:(id)arg2 handler:(CDUnknownBlockType)arg3;
- (BOOL)suggestionsEntriesAtLocation:(id)arg1 period:(NSDateInterval )arg2 handler:(CDUnknownBlockType)arg3;
