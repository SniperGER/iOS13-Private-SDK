...
- (_Bool)signalPackForHereWithHandler:(id /* block */)arg1;
- (_Bool)signalPackForDestinationEntry:(id)arg1 originCoordinate:(struct CLLocationCoordinate2D)arg2 handler:(id /* block */)arg3;
- (_Bool)signalPackForDestinationMapItem:(struct GEOMapItemStorage *)arg1 originCoordinate:(struct CLLocationCoordinate2D)arg2 handler:(id /* block */)arg3;
- (void)preload;
