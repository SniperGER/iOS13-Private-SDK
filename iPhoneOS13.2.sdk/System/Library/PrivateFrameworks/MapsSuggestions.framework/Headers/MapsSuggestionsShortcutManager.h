...
- (BOOL)moveShortcut:(id)arg1 toIndex:(long long)arg2 withSnapshot:(NSArray *)arg3 handler:(CDUnknownBlockType)arg4;
- (BOOL)removeShortcuts:(NSArray *)arg1 handler:(CDUnknownBlockType)arg2;
- (BOOL)addOrUpdateShortcuts:(NSArray *)arg1 handler:(CDUnknownBlockType)arg2;
