...
- (_Bool)proposeAdditionalShortcutsOfType:(long long)arg1 handler:(id /* block */)arg2;
...
- (_Bool)moveShortcut:(id)arg1 toIndex:(long long)arg2 withSnapshot:(struct NSArray *)arg3 handler:(id /* block */)arg4;
...
- (_Bool)_loadCorrectedMeCardWithHandler:(id /* block */)arg1;
- (_Bool)__loadCorrectedMeCardWithHandler:(id /* block */)arg1;
- (_Bool)_mergeShortcutsToMeCardAndCallHandler:(id /* block */)arg1;
