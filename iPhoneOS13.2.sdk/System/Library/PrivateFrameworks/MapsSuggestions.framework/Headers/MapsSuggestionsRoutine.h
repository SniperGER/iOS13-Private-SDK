...
- (BOOL)fetchEntriesForLocation:(id)arg1 period:(NSDateInterval )arg2 handler:(CDUnknownBlockType)arg3;
- (void)_resolveMapItemsAndAddEntries:(NSArray *)arg1 handler:(CDUnknownBlockType)arg2;
