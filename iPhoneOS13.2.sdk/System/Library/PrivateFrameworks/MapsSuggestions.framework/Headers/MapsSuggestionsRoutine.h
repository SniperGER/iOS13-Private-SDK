...
- (_Bool)fetchLocationsSinceDate:(id)arg1 handler:(id /* block */)arg2;
- (_Bool)touristBitForLocation:(id)arg1 handler:(id /* block */)arg2;
- (double)distanceToNearest:(long long)arg1;
- (void)removeParkedCarsAllowingFeature:(_Bool)arg1 handler:(id /* block */)arg2;
- (void)stopParkedCarEvents;
- (_Bool)startParkedCarEventsWithHandler:(id /* block */)arg1;
- (unsigned long long)countWorkLOIs;
- (unsigned long long)countHomeLOIs;
- (void)updateFixedLOIs;
- (_Bool)fetchSuggestedShortcutsForType:(long long)arg1 handler:(id /* block */)arg2;
- (_Bool)_addMapItemToShortcut:(id)arg1 fromLOI:(id)arg2 group:(id)arg3;
- (_Bool)fetchEntriesForLocation:(id)arg1 period:(struct NSDateInterval *)arg2 handler:(id /* block */)arg3;
- (void)_resolveMapItemsAndAddEntries:(struct NSArray *)arg1 handler:(id /* block */)arg2;
