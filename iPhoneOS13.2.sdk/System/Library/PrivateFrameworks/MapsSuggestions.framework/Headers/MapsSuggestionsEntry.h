...
- (NSUInteger)uint64ForKey:(id)arg1;
...
- (void)mergeSpecificsFromSuggestionEntry:(id)arg1 behavior:(NSUInteger)arg2;
- (void)mergeFromSuggestionEntry:(id)arg1 behavior:(NSUInteger)arg2 protectTitles:(BOOL)arg3 protectTitleDecorations:(BOOL)arg4 protectMapItem:(BOOL)arg5 protectWeight:(BOOL)arg6 protectExpiration:(BOOL)arg7 protectIcon:(BOOL)arg8;
- (void)mergeFromSuggestionEntry:(id)arg1 behavior:(NSUInteger)arg2;
