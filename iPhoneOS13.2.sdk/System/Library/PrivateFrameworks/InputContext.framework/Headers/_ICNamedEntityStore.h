...
@interface _ICNamedEntityStore : NSObject
{
    ...
    NSArray *_lexicons;
    id /* CDUnknownBlockType */ _wordFilteringBlock;
    id /* CDUnknownBlockType */ _filteringBlock;
}

+ (id)tokenize:(id)arg1;
+ (id)lexiconViews;
@property(retain, nonatomic) NSArray *lexicons; // @synthesize lexicons=_lexicons;
@property(copy, nonatomic) id /* CDUnknownBlockType */ filteringBlock; // @synthesize filteringBlock=_filteringBlock;
// - (void).cxx_destruct;
