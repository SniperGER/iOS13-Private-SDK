...
- (void)sl_openGoogleAuthenticationSheetForAccount:(id)arg1 shouldConfirm:(_Bool)arg2 delegateClassName:(id)arg3 completion:(id /* block */)arg4;
...
- (void)sl_openGoogleAuthenticationSheetForAccount:(id)arg1 shouldConfirm:(_Bool)arg2 completion:(id /* block */)arg3;
