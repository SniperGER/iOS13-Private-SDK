...
- (id)initWithAccount:(id)arg1 accountStore:(id)arg2 authURI:(id)arg3 accountType:(NSUInteger)arg4 userName:(id)arg5 accountDescription:(id)arg6 isFirstTimeSetup:(BOOL)arg7 presentationBlock:(CDUnknownBlockType)arg8;
