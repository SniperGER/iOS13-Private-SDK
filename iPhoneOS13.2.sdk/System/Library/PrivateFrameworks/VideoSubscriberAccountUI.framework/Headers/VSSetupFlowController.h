...
@property(copy, nonatomic) id /* block */ goingBackActivationCompletionBlock; // @synthesize goingBackActivationCompletionBlock=_goingBackActivationCompletionBlock;
...
- (void)startSilentSigningInForSTBFromActivation:(_Bool)arg1 withCompletion:(id /* block */)arg2;
