...
- (void)setProgress:(double)arg1 animated:(_Bool)arg2 completion:(id /* block */)arg3;
- (void)_setProgress:(double)arg1 animated:(_Bool)arg2 completion:(id /* block */)arg3;
- (void)_updateStatusPropertiesAnimated:(_Bool)arg1 completion:(id /* block */)arg2;
