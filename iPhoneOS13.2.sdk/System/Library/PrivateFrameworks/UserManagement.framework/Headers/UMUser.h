...
@property(nonatomic) NSUInteger dataUsed; // @synthesize dataUsed=_dataUsed;
@property(nonatomic) NSUInteger dataQuota; // @synthesize dataQuota=_dataQuota;
...
@property(nonatomic) NSUInteger passcodeLockGracePeriod; // @synthesize passcodeLockGracePeriod=_passcodeLockGracePeriod;
...
@property(nonatomic) NSUInteger passcodeType; // @synthesize passcodeType=_passcodeType;
