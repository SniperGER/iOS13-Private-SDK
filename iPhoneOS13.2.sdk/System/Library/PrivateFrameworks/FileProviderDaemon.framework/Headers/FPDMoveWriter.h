...
- (void)performMoveOfFolder:(id)arg1 to:(id)arg2 as:(id)arg3 sourceMaterializeOption:(NSUInteger)arg4 targetMaterializeOption:(NSUInteger)arg5 atomically:(BOOL)arg6 useDiskWriter:(BOOL)arg7 completion:(CDUnknownBlockType)arg8;
- (void)performMoveOfItem:(id)arg1 to:(id)arg2 as:(id)arg3 sourceMaterializeOption:(NSUInteger)arg4 targetMaterializeOption:(NSUInteger)arg5 useDiskWriter:(BOOL)arg6 completion:(CDUnknownBlockType)arg7;
- (void)performCopyOfItem:(id)arg1 to:(id)arg2 as:(id)arg3 sourceMaterializeOption:(NSUInteger)arg4 targetMaterializeOption:(NSUInteger)arg5 useDiskWriter:(BOOL)arg6 completion:(CDUnknownBlockType)arg7;
