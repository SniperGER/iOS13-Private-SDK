...
@property(copy, nonatomic) id /* block */ startDownloadBlock; // @synthesize startDownloadBlock=_startDownloadBlock;
@property(copy, nonatomic) id /* block */ preflightCompletionBlock; // @synthesize preflightCompletionBlock=_preflightCompletionBlock;
@property(copy, nonatomic) id /* block */ rootPreflightCompletionBlock; // @synthesize rootPreflightCompletionBlock=_rootPreflightCompletionBlock;
