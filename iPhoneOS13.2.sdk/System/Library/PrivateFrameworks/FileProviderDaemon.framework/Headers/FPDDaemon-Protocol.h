...
- (void)ingestFromCacheItemWithID:(FPItemID *)arg1 requestedFields:(NSUInteger)arg2 completionHandler:(void (^)(NSError *))arg3;
...
- (void)removeDomain:(NSFileProviderDomain *)arg1 forProviderIdentifier:(NSString *)arg2 options:(NSUInteger)arg3 completionHandler:(void (^)(NSError *))arg4;
...
- (void)startOperation:(id <FPOperationClient>)arg1 toFetchIconsForAppBundleIDs:(NSArray *)arg2 requestedSize:(CGSize)arg3 scale:(double)arg4 completionHandler:(void (^)(NSError *))arg5;
...
- (void)createItemBasedOnTemplate:(FPItem *)arg1 fields:(NSUInteger)arg2 urlWrapper:(FPSandboxingURLWrapper *)arg3 options:(NSUInteger)arg4 bounceOnCollision:(BOOL)arg5 completionHandler:(void (^)(FPItem *, NSError *))arg6;
...
- (void)setDownloadPolicy:(NSUInteger)arg1 forItemWithID:(FPItemID *)arg2 completionHandler:(void (^)(NSError *))arg3;
