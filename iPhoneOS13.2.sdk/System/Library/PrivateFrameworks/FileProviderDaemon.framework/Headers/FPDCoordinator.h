...
- (void)coordinateAtURL:(id)arg1 recursively:(_Bool)arg2 handler:(id /* block */)arg3;
- (void)resolveItemOrURL:(id)arg1 recursively:(_Bool)arg2 coordinateIfExport:(_Bool)arg3 handler:(id /* block */)arg4;
- (void)resolveItemOrURL:(id)arg1 recursively:(_Bool)arg2 andCoordinateWithHandler:(id /* block */)arg3;
- (void)resolveItem:(id)arg1 completion:(id /* block */)arg2;
- (void)resolveItem:(id)arg1 recursively:(_Bool)arg2 andCoordinateWithHandler:(id /* block */)arg3;
