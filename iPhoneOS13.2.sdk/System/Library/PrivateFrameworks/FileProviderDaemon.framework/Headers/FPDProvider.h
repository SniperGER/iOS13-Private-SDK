...
- (void)setEjectable:(_Bool)arg1 forDomainIdentifier:(id)arg2 completionHandler:(id /* block */)arg3;
- (void)enableAllDomainsIfNoUserElection;
- (void)setEnabled:(_Bool)arg1 forDomainIdentifier:(id)arg2 request:(id)arg3 completionHandler:(id /* block */)arg4;
@property(readonly, nonatomic) NSDictionary *nsDomainsByID;
@property(readonly, nonatomic) NSDictionary *relevantDomainsByID;
- (void)reloadDomain:(id)arg1 unableToStartup:(_Bool)arg2 completionHandler:(id /* block */)arg3;
...
- (void)addDomain:(id)arg1 byImportingDirectoryAtURL:(id)arg2 unableToStartup:(_Bool)arg3 reloadDomain:(_Bool)arg4 request:(id)arg5 completionHandler:(id /* block */)arg6;
