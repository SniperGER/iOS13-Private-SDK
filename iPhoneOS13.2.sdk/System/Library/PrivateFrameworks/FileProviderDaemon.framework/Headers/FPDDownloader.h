...
- (void)downloadItem:(id)arg1 recursively:(_Bool)arg2 request:(id)arg3 withCompletion:(id /* block */)arg4;
- (void)downloadURL:(id)arg1 recursively:(_Bool)arg2 request:(id)arg3 withCompletion:(id /* block */)arg4;
