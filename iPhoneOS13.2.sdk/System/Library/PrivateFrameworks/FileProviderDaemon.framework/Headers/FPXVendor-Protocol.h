...
- (void)changeItem:(FPItem *)arg1 baseVersion:(NSFileProviderItemVersion *)arg2 changedFields:(NSUInteger)arg3 contents:(FPSandboxingURLWrapper *)arg4 options:(NSUInteger)arg5 completionHandler:(void (^)(FPItem *, NSError *))arg6;
...
- (void)startProvidingItemAtURL:(NSURL *)arg1 readingOptions:(NSUInteger)arg2 completionHandler:(void (^)(NSError *))arg3;
