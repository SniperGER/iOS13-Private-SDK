...
@interface PXPhotosDataSource : NSObject <PXPhotoLibraryUIChangeObserver>
{
    ...
    NSUInteger __previousCollectionsCount;
...
@property(nonatomic, setter=_setPreviousCollectionsCount:) NSUInteger _previousCollectionsCount; // @synthesize _previousCollectionsCount=__previousCollectionsCount;
...
@property(readonly, nonatomic) NSUInteger versionIdentifier; // @synthesize versionIdentifier=_versionIdentifier;
...
- (NSUInteger)sectionForAssetCollection:(id)arg1;
...
- (id)_sectionCache;
- (NSUInteger)_cachedSectionForAssetCollection:(id)arg1;
...
- (void)_getFetchLimit:(NSUInteger )arg1 fetchWithReverseSortOrder:(BOOL )arg2 forAssetCollection:(id)arg3 isLimitedInitialFetch:(BOOL)arg4;
...
- (NSUInteger)_assetCollectionFetchStatus:(id)arg1;
...
- (id)initWithPhotosDataSource:(id)arg1 options:(NSUInteger)arg2;
