...
- (id)initWithIncrementalChanges:(id)arg1 assetCollectionChangeDetails:(id)arg2 sectionsWithKeyAssetChanges:(id)arg3 previousCollectionsCount:(long long)arg4 assetCollectionToSectionCache:(id)arg5 originatingPhotoLibraryChange:(id)arg6 fromIdentifier:(NSUInteger)arg7 toIdentifier:(NSUInteger)arg8;
- (id)initWithFromIdentifier:(NSUInteger)arg1 toIdentifier:(NSUInteger)arg2;
