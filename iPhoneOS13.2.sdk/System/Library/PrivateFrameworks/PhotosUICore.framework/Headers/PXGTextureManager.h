...
- (void)textureProvider:(id)arg1 didProvideCGImage:(CGImageRef)arg2 orientation:(unsigned int)arg3 forRequestID:(int)arg4;
...
//  (void)_processPixelBuffer:(struct __CVBuffer )arg1 orientationTransform:(CGAffineTransform)arg2 fromTextureProvider:(id)arg3 withTextureConverter:(id)arg4 forRequestID:(int)arg5 deliveryOrder:(unsigned int)arg6;
- (id)_createTextureForCGImage:(CGImageRef)arg1 orientation:(unsigned int)arg2 fromTextureProvider:(id)arg3 withTextureConverter:(id)arg4;
- (void)_processCGImage:(CGImageRef)arg1 orientation:(unsigned int)arg2 fromTextureProvider:(id)arg3 withTextureConverter:(id)arg4 requestID:(int)arg5 deliveryOrder:(unsigned int)arg6;
...
- (CGImageRef)textureSnapshotForSpriteIndex:(unsigned int)arg1;
...
// - (void)_blockOnThumbnailsIfNeededWithGeometries:(CDStruct_3ab912e1 )arg1 visibleRect:(CGRect)arg2 interactionState:(CDStruct_93894d6c)arg3 fences:(id)arg4;
