...
- (void)enumerateHeroSpritesInRect:(struct CGRect)arg1 usingBlock:(id /* block */)arg2;
...
- (void)enumerateAssetsSectionSublayoutsInRect:(struct CGRect)arg1 usingBlock:(id /* block */)arg2;
