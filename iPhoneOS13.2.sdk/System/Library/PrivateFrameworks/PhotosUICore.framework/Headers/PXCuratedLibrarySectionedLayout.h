...
- (void)enumerateScrollablePagesWithOptions:(NSUInteger)arg1 usingBlock:(CDUnknownBlockType)arg2;
- (void)enumerateSectionBoundariesWithOptions:(NSUInteger)arg1 usingBlock:(CDUnknownBlockType)arg2;
- (void)enumerateAssetsSectionSublayoutsInRect:(CGRect)arg1 usingBlock:(CDUnknownBlockType)arg2;
...
- (CDUnknownBlockType)locationNamesFutureForContentInRect:(CGRect)arg1;
- (CDUnknownBlockType)dateIntervalFutureForContentInRect:(CGRect)arg1;
