...
- (void)applyToArray:(void )arg1 elementSize:(NSUInteger)arg2 countAfterChanges:(NSUInteger)arg3 insertionHandler:(CDUnknownBlockType)arg4 modifiedHandler:(CDUnknownBlockType)arg5;
