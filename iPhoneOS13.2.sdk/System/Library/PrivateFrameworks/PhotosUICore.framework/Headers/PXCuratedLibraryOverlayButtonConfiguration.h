...
@property(nonatomic) UIEdgeInsets hitTestOutsets; // @synthesize hitTestOutsets=_hitTestOutsets;
@property(nonatomic) UIEdgeInsets imageEdgeInsets; // @synthesize imageEdgeInsets=_imageEdgeInsets;
