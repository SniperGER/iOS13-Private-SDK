...
@property(readonly, nonatomic) _Bool allowsAspectFit; // @synthesize allowsAspectFit=_allowsAspectFit;
...
@property(readonly, nonatomic) _Bool preferAspectFitContentMode; // @synthesize preferAspectFitContentMode=_preferAspectFitContentMode;
