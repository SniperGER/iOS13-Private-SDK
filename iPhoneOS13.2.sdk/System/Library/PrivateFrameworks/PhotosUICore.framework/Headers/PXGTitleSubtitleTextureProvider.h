...
- (void)_requestTextureForTitle:(id)arg1 subtitle:(id)arg2 spec:(id)arg3 targetSize:(CGSize)arg4 screenScale:(double)arg5 requestID:(int)arg6 renderCompletionHandler:(CDUnknownBlockType)arg7;
