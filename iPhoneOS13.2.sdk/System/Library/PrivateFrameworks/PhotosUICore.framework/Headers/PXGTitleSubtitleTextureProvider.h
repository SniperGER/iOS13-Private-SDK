...
- (void)_requestTextureForTitle:(id)arg1 subtitle:(id)arg2 spec:(id)arg3 targetSize:(struct CGSize)arg4 screenScale:(double)arg5 requestID:(int)arg6 renderCompletionHandler:(id /* block */)arg7;
