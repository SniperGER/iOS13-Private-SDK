...
@class NSArray, PXDisplayLink, PXGAccessibilityContentInfoManager, PXGAccessibilityRenderer, PXGAnimator, PXGChangeDetails, PXGLayout, PXGMetalRenderer, PXGSpriteDataStore, PXGSpriteMetadataStore, PXGTextureManager, PXGViewEnvironment, PXGViewRenderer, PXScrollViewController, PXScrollViewSpeedometer;
...
//     CDStruct_93894d6c _previousInteractionState;
    ...
    id /* CDUnknownBlockType */ _animationRenderingCompletionHandler;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ animationRenderingCompletionHandler; // @synthesize animationRenderingCompletionHandler=_animationRenderingCompletionHandler;
...
- (void)_updateScrollStateWithReason:(NSUInteger)arg1;
...
- (void)_forceInvalidate:(NSUInteger)arg1;
- (void)_deferredInvalidate:(NSUInteger)arg1;
- (void)_invalidateOrDefer:(NSUInteger)arg1;
