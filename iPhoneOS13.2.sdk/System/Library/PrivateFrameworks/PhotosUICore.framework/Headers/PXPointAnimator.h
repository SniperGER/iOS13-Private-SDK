...
- (void)performChangesUsingSpringAnimationWithStiffness:(double)arg1 dampingRatio:(double)arg2 initialVelocity:(CGPoint)arg3 changes:(CDUnknownBlockType)arg4;
- (void)performChangesUsingDefaultSpringAnimationWithInitialVelocity:(CGPoint)arg1 changes:(CDUnknownBlockType)arg2;
