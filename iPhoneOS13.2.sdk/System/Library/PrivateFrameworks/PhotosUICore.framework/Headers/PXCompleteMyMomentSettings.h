...
@interface PXCompleteMyMomentSettings : PXSettings <PXCMMWorkflowCoordinatorDelegate>
{
    ...
    NSUInteger _shareSheetLinkTotalFileSizeThresholdMB;
    long long _invitationsDataSourceType;
    long long _suggestionsDataSourceType;
    NSUInteger _suggestionsMatchingStrategy;
...
@property(nonatomic) NSUInteger suggestionsMatchingStrategy; // @synthesize suggestionsMatchingStrategy=_suggestionsMatchingStrategy;
...
@property(nonatomic) NSUInteger shareSheetLinkTotalFileSizeThresholdMB; // @synthesize shareSheetLinkTotalFileSizeThresholdMB=_shareSheetLinkTotalFileSizeThresholdMB;
