...
@property(copy) id /* block */ fastDisplayBlock; // @synthesize fastDisplayBlock=_fastDisplayBlock;
@property(copy) id /* block */ faceImageLoadingCompletionBlock; // @synthesize faceImageLoadingCompletionBlock=_faceImageLoadingCompletionBlock;
