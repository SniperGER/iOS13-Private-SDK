...
- (void)cancel;
- (void)start;
- (id)initWithRenderQueue:(id)arg1 asset:(id)arg2 targetSize:(CGSize)arg3 contentMode:(long long)arg4 imageManager:(id)arg5 options:(id)arg6 resultHandler:(CDUnknownBlockType)arg7;
