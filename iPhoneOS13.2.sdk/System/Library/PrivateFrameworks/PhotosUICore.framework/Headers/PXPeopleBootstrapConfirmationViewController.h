...
@class NSArray, NSTimer, PXPeopleBootstrapContext, PXPeopleSuggestionManager, PXPeopleSwipeSelectionManager;
...
- (void)_toggleConfirmedForCollectionViewCell:(id)arg1 atIndex:(NSUInteger)arg2;
...
- (void)_updateViewWithViewState:(NSUInteger)arg1;
