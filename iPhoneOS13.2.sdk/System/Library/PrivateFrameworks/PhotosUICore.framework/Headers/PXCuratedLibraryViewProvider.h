...
//  (struct PXSimpleIndexPath)selectableIndexPathClosestToIndexPath:(struct PXSimpleIndexPath)arg1 fromDataSource:(id)arg2 inDirection:(NSUInteger)arg3;
//  (BOOL)canSelectObjectAtIndexPath:(struct PXSimpleIndexPath)arg1 inDataSource:(id)arg2;
//  (struct PXSimpleIndexPath)_indexPathClosestToIndexPath:(struct PXSimpleIndexPath)arg1 fromDataSource:(id)arg2 inDirection:(NSUInteger)arg3;
- (id)_itemsGeometryForDataSource:(id)arg1;
- (id)hitTestResultControlsForCurrentZoomLevel;
- (void)scrollLibraryViewToObjectReference:(id)arg1 scrollPosition:(NSUInteger)arg2 padding:(UIEdgeInsets)arg3 completionHandler:(CDUnknownBlockType)arg4;
- (void)scrollLibraryViewToAssetReference:(id)arg1 scrollPosition:(NSUInteger)arg2 completionHandler:(CDUnknownBlockType)arg3;
