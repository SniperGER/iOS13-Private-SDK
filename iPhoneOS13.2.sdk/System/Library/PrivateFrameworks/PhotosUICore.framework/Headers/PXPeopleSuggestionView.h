...
- (void)_updateSuggestionImageWithAnimatedSpotlight:(_Bool)arg1 withCompletion:(id /* block */)arg2;
- (void)setSuggestion:(id)arg1 animated:(_Bool)arg2 withCompletion:(id /* block */)arg3;
