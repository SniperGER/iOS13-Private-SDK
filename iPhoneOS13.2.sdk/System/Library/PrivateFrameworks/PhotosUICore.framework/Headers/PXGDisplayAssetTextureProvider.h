...
- (void)_workQueue_provideCGImage:(CGImageRef)arg1 orientation:(unsigned int)arg2 forRequestID:(int)arg3;
- (void)_workQueue_handleCGImageResult:(CGImageRef)arg1 orientation:(unsigned int)arg2 info:(id)arg3 shouldCache:(BOOL)arg4 textureRequestID:(int)arg5;
...
- (void)_workQueue_performDeferredImageRequest:(id)arg1 targetSize:(CGSize)arg2 contentMode:(long long)arg3 options:(id)arg4 resultHandler:(CDUnknownBlockType)arg5 textureRequestID:(int)arg6;
...
@property(readonly, nonatomic) CGImageRef placeholderImage;
