...
// - (id)_snapIndicatorInfosForTimes:(id)arg1 currentTime:(CDStruct_1b6d18a9)arg2 suggestedTime:(CDStruct_1b6d18a9)arg3 style:(NSUInteger)arg4 skipSingleIndicatorWithCurrentTime:(BOOL)arg5;
// - (id)_snapIndicatorInfosForTimes:(id)arg1 currentTime:(CDStruct_1b6d18a9)arg2 style:(NSUInteger)arg3 skipSingleIndicatorWithCurrentTime:(BOOL)arg4;
