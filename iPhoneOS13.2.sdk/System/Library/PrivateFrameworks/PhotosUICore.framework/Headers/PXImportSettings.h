...
@interface PXImportSettings : PXSettings
{
    ...
    NSUInteger _assetEnumerationBatchSize;
}

+ (id)sharedInstance;
@property(nonatomic) BOOL showProgressTitles; // @synthesize showProgressTitles=_showProgressTitles;
@property(nonatomic) NSUInteger assetEnumerationBatchSize; // @synthesize assetEnumerationBatchSize=_assetEnumerationBatchSize;
