...
- (_Bool)_navigateToGadget:(id)arg1 animated:(_Bool)arg2 navigationBlock:(id /* block */)arg3;
- (void)invalidateAnyPendingNavigation;
- (void)startPendingNavigationTimer;
- (void)navigateIfNeeded;
- (_Bool)navigateToGadgetDeferIfNeeded:(id)arg1 animated:(_Bool)arg2 nestedNavigationBlock:(id /* block */)arg3;
- (_Bool)navigateToGadgetWithIdDeferIfNeeded:(id)arg1 animated:(_Bool)arg2 nestedNavigationBlock:(id /* block */)arg3;
- (_Bool)navigateToFirstGadgetWithTypeDeferIfNeeded:(unsigned long long)arg1 animated:(_Bool)arg2 nestedNavigationBlock:(id /* block */)arg3;
