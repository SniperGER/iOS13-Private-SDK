...
//  (struct PXSimpleIndexPath)_indexPathForMemoryInScrollViewAtPoint:(CGPoint)arg1;
//  (struct PXSimpleIndexPath)_indexPathForMemoryAtPoint:(CGPoint)arg1;
- (id)_createNewLayout;
...
- (void)viewDidLoad;
- (id)initWithDataSourceManager:(id)arg1 style:(NSUInteger)arg2;
