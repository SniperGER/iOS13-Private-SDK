...
@property(copy, nonatomic, setter=_ppt_setVariationsWidgetLoadingCompleteHandler:) id /* block */ _ppt_variationsWidgetLoadingCompleteHandler; // @synthesize _ppt_variationsWidgetLoadingCompleteHandler=__ppt_variationsWidgetLoadingCompleteHandler;
@property(copy, nonatomic, setter=_ppt_setAllWidgetLoadingCompleteHandler:) id /* block */ _ppt_allWidgetLoadingCompleteHandler; // @synthesize _ppt_allWidgetLoadingCompleteHandler=__ppt_allWidgetLoadingCompleteHandler;
...
@property(readonly, copy, nonatomic) id /* block */ _unlockHandler; // @synthesize _unlockHandler=__unlockHandler;
@property(readonly, copy, nonatomic) id /* block */ _unlockStatus; // @synthesize _unlockStatus=__unlockStatus;
