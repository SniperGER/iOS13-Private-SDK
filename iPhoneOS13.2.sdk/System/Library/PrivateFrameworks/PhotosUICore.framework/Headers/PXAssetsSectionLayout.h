...
@property(nonatomic) CGRect showAllButtonFrame; // @synthesize showAllButtonFrame=_showAllButtonFrame;
...
- (void)enumerateRowsWithOptions:(NSUInteger)arg1 usingBlock:(CDUnknownBlockType)arg2;
...
//  (struct PXSimpleIndexPath)_dataSourceIndexPathForObjectReference:(id)arg1 options:(NSUInteger)arg2 updatedObjectReference:(out id )arg3;
