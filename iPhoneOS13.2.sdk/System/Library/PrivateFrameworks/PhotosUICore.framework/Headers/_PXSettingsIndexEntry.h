...
- (void)_revealInTopOfSettingsController:(id)arg1 drillIn:(_Bool)arg2 withCompletionHandler:(id /* block */)arg3;
- (void)_revealInSettingsController:(id)arg1 drillIn:(_Bool)arg2 withCompletionHandler:(id /* block */)arg3;
