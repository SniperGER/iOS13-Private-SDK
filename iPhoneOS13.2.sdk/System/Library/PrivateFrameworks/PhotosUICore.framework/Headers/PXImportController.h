...
@class NSArray, NSMutableDictionary, NSMutableSet, NSObject, NSProgress, NSTimer, PHAssetCollection, PHImportSource, PHPhotoLibrary, PXImportAssetsDataSourceManager, PXImportDeleteAction, PXImportMediaLoadingCoordinator, PXImportMediaProvider, PXImportSessionInfo, PXPowerController, PXSectionedSelectionManager, PXSelectionSnapshot;
...
@interface PXImportController : PXObservable <PXImportAssetsDataSourceManagerDelegate, PXMutableImportController, PHImportServiceImporterDelegate, PHImportSourceObserver, PXChangeObserver>
{
    ...
    id /* CDUnknownBlockType */ _importCompletionHandler;
    id /* CDUnknownBlockType */ _deleteCompletionHandler;
    PXSelectionSnapshot *_lastSelectionSnapshot;
    PXImportMediaLoadingCoordinator *_mediaLoadingCoordinator;
}

+ (void)unregisterPXImportControllerNotificationsReceiver:(NSObject )arg1;
+ (void)registerPXImportControllerNotificationsReceiver:(NSObject )arg1;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ deleteCompletionHandler; // @synthesize deleteCompletionHandler=_deleteCompletionHandler;
@property(copy, nonatomic) id /* CDUnknownBlockType */ importCompletionHandler; // @synthesize importCompletionHandler=_importCompletionHandler;
