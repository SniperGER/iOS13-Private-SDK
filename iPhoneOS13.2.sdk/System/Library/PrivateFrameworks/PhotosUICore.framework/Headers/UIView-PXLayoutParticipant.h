...
//  (void)_px_animateView:(id)arg1 toCenter:(CGPoint)arg2 bounds:(CGRect)arg3 transform:(CGAffineTransform)arg4 withInitialVelocity:(struct PXDisplayVelocity)arg5 usingSpringAnimation:(CDUnknownBlockType)arg6 completion:(CDUnknownBlockType)arg7;
//  (void)px_animateView:(id)arg1 toCenter:(CGPoint)arg2 bounds:(CGRect)arg3 transform:(CGAffineTransform)arg4 usingDefaultDampedSpringWithDelay:(double)arg5 initialVelocity:(struct PXDisplayVelocity)arg6 options:(NSUInteger)arg7 completion:(CDUnknownBlockType)arg8;
//  (void)px_animateView:(id)arg1 toCenter:(CGPoint)arg2 bounds:(CGRect)arg3 transform:(CGAffineTransform)arg4 withDuration:(double)arg5 delay:(double)arg6 usingSpringWithDamping:(double)arg7 initialVelocity:(struct PXDisplayVelocity)arg8 options:(NSUInteger)arg9 completion:(CDUnknownBlockType)arg10;
