...
- (id)hitTestResultsInRect:(CGRect)arg1 passingTest:(CDUnknownBlockType)arg2;
- (id)hitTestResultsAtPoint:(CGPoint)arg1 padding:(UIEdgeInsets)arg2 passingTest:(CDUnknownBlockType)arg3;
- (id)hitTestResultsAtPoint:(CGPoint)arg1;
- (id)hitTestResultAtPoint:(CGPoint)arg1 padding:(UIEdgeInsets)arg2 passingTest:(CDUnknownBlockType)arg3;
...
- (void)enumerateCuratedLibraryHitTestResultsInRect:(CGRect)arg1 usingBlock:(CDUnknownBlockType)arg2;
- (void)enumerateCuratedLibraryHitTestResultsInDirection:(NSUInteger)arg1 fromSpriteReference:(id)arg2 usingBlock:(CDUnknownBlockType)arg3;
- (id)firstCuratedLibraryHitTestResultsAtPoint:(CGPoint)arg1 withControl:(long long)arg2;
- (void)enumerateCuratedLibraryHitTestResultsAtPoint:(CGPoint)arg1 withControls:(id)arg2 usingBlock:(CDUnknownBlockType)arg3;
- (void)enumerateCuratedLibraryHitTestResultsAtPoint:(CGPoint)arg1 usingBlock:(CDUnknownBlockType)arg2;
...
- (id)regionOfInterestForAssetReference:(id)arg1 image:(CGImageRef)arg2 fallbackMediaProvider:(id)arg3;
