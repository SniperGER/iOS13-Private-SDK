...
- (void)_enumerateScrollablePagesWithOptions:(NSUInteger)arg1 usingBlock:(CDUnknownBlockType)arg2;
- (void)_enumerateHeroSpritesInRect:(CGRect)arg1 usingBlock:(CDUnknownBlockType)arg2;
