...
- (void)_enumerateScrollablePagesWithOptions:(unsigned long long)arg1 usingBlock:(id /* block */)arg2;
- (void)_enumerateHeroSpritesInRect:(struct CGRect)arg1 usingBlock:(id /* block */)arg2;
