...
@class NSArray, PXArrayChangeDetails, PXDataSection;
...
@interface PXDataSectionManager : PXObservable <PXDataSectionManagerChangeObserver>
{
    ...
    NSUInteger _previousDataSectionIdentifier;
}

@property(readonly, nonatomic) NSUInteger previousDataSectionIdentifier; // @synthesize previousDataSectionIdentifier=_previousDataSectionIdentifier;
