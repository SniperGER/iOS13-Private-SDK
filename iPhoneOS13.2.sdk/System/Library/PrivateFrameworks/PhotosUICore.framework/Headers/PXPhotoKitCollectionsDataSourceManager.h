...
@class NSArray, NSMutableDictionary, NSMutableSet, NSObject, NSOperationQueue, PHCollectionList, PHFetchResult, PHPhotoLibrary, PXPhotoKitCollectionsDataSourceManagerConfiguration;
@protocol OS_os_log;
...
- (BOOL)_isEmpty;
- (NSUInteger)_fixedOrderPriorityForVirtualCollection:(id)arg1;
