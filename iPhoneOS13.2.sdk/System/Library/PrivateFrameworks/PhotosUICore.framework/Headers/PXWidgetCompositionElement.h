...
@class NSHashTable, PXScrollViewController, PXTilingController, PXWidgetBar, PXWidgetCompositionSpec;
...
@property(nonatomic) CGSize widgetContentSize; // @synthesize widgetContentSize=_widgetContentSize;
