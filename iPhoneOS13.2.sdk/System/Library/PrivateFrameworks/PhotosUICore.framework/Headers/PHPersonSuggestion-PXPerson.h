...
- (void)requestFaceTileImageWithTargetSize:(CGSize)arg1 cropFactor:(NSUInteger)arg2 style:(NSUInteger)arg3 cacheResult:(BOOL)arg4 boundFaceRect:(BOOL)arg5 completionBlock:(CDUnknownBlockType)arg6;
@end
