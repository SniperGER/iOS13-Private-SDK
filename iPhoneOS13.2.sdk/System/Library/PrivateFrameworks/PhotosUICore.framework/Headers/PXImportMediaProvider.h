...
- (long long)requestImageForImportItem:(id)arg1 ofSize:(NSUInteger)arg2 priority:(unsigned char)arg3 completion:(CDUnknownBlockType)arg4;
- (long long)requestImageForImportItem:(id)arg1 ofSize:(NSUInteger)arg2 completion:(CDUnknownBlockType)arg3;
- (long long)imageOfSize:(NSUInteger)arg1 forModel:(id)arg2 localCacheOnly:(BOOL)arg3 priority:(unsigned char)arg4 completion:(CDUnknownBlockType)arg5;
...
- (long long)requestLivePhotoForAsset:(id)arg1 targetSize:(CGSize)arg2 contentMode:(long long)arg3 options:(id)arg4 resultHandler:(CDUnknownBlockType)arg5;
...
- (long long)requestCGImageForAsset:(id)arg1 targetSize:(CGSize)arg2 contentMode:(long long)arg3 options:(id)arg4 resultHandler:(CDUnknownBlockType)arg5;
