...
@class PXCMMViewController, UINavigationController;
...
// - (void).cxx_destruct;
- (id)_alertControllerForSession:(id)arg1 withSuccess:(BOOL)arg2 error:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;
...
- (void)_didFinishSession:(id)arg1 withState:(NSUInteger)arg2 avoidDismissal:(BOOL)arg3;
- (void)_didFinishSession:(id)arg1 withState:(NSUInteger)arg2;
