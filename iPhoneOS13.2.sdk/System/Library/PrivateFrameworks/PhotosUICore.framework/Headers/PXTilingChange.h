...
@property(readonly, nonatomic) CGSize initialReferenceSize; // @synthesize initialReferenceSize=_initialRef erenceSize;
...
@property(readonly, nonatomic) CGSize toRef erenceSize;
@property(readonly, nonatomic) CGSize fromRef erenceSize;
