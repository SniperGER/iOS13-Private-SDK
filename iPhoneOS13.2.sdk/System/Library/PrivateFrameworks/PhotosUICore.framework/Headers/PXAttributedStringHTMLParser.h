...
@interface PXAttributedStringHTMLParser : NSObject
{
    ...
    id /* CDUnknownBlockType */ _parsedAttributedStringBlock;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ parsedAttributedStringBlock; // @synthesize parsedAttributedStringBlock=_parsedAttributedStringBlock;
