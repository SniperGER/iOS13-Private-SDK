...
@property(copy, nonatomic) id /* block */ reloadBlock; // @synthesize reloadBlock=_reloadBlock;
...
@property(copy, nonatomic) id /* block */ sortComparator; // @synthesize sortComparator=_sortComparator;
...
- (void)_asyncLoadImageForItem:(id)arg1 targetSize:(struct CGSize)arg2 withCompletionBlock:(id /* block */)arg3 fastDisplayBlock:(id /* block */)arg4;
...
- (void)imageAtIndex:(unsigned long long)arg1 targetSize:(struct CGSize)arg2 withCompletionBlock:(id /* block */)arg3 fastDisplayBlock:(id /* block */)arg4;
...
- (id)initWithName:(id)arg1 objectsReloadBlock:(id /* block */)arg2 asynchronousLoad:(_Bool)arg3 callbackDelegate:(id)arg4;
