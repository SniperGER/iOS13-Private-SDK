...
- (void)imageAtIndex:(NSUInteger)arg1 targetSize:(CGSize)arg2 withCompletionBlock:(CDUnknownBlockType)arg3;
- (void)imageAtIndex:(NSUInteger)arg1 targetSize:(CGSize)arg2 withCompletionBlock:(CDUnknownBlockType)arg3 fastDisplayBlock:(CDUnknownBlockType)arg4;
