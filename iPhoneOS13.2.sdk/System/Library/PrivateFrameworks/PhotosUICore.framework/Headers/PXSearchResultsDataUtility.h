...
+ (id)_macOSImageNameForSearchUserCategory:(NSUInteger)arg1 useSearchFieldStyle:(BOOL)arg2;
+ (UIImage )imageForSearchUserCategory:(NSUInteger)arg1 useSearchFieldStyle:(BOOL)arg2;
+ (void)suggestionsDisplayDataFromToken:(id)arg1 searchText:(id)arg2 matchedColor:(UIColor )arg3 remainingColor:(UIColor )arg4 isTextCompletion:(BOOL)arg5 completion:(CDUnknownBlockType)arg6;
