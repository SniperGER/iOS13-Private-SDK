...
+ (void)suggestionsDisplayDataFromToken:(id)arg1 searchText:(id)arg2 matchedColor:(struct UIColor *)arg3 remainingColor:(struct UIColor *)arg4 isTextCompletion:(_Bool)arg5 completion:(id /* block */)arg6;
