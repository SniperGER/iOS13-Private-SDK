...
@interface PXSectionedDataSourceChangeDetails : NSObject <PXSectionedLayoutDataSourceChangeDetails>
{
    ...
    NSUInteger _toDataSourceIdentifier;
...
+ (id)changeDetailsWithNoChangesFromDataSourceIdentifier:(NSUInteger)arg1 toDataSourceIdentifier:(NSUInteger)arg2;
+ (id)changeDetailsWithoutIncrementalChangesFromDataSourceIdentifier:(NSUInteger)arg1 toDataSourceIdentifier:(NSUInteger)arg2;
...
@property(readonly, nonatomic) NSUInteger toDataSourceIdentifier; // @synthesize toDataSourceIdentifier=_toDataSourceIdentifier;
@property(readonly, nonatomic) NSUInteger fromDataSourceIdentifier; // @synthesize fromDataSourceIdentifier=_fromDataSourceIdentifier;
// - (void).cxx_destruct;
...
- (id)initWithFromDataSourceIdentifier:(NSUInteger)arg1 toDataSourceIdentifier:(NSUInteger)arg2 sectionChanges:(id)arg3 itemChangeDetailsBySection:(id)arg4 subitemChangeDetailsByItemBySection:(id)arg5;
- (id)init;
