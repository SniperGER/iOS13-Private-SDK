...
@class NSObject, PXAssetsDataSource, PXAssetsDataSourceManager, PXCuratedLibraryInlineHeadersDataSource, PXUpdater;
...
- (void)_resizeStorageIfNeededForNumberOfSections:(long long)arg1 level:(NSUInteger)arg2;
// - (CDStruct_68723fc0 )_addSectionInfoForLevel:(NSUInteger)arg1;
- (void)_resetSectionInfos;
- (id)_createDataSourceForLevel:(NSUInteger)arg1;
- (void)_updateLevel:(NSUInteger)arg1 withDataSourceBeforeChanges:(id)arg2 afterChanges:(id)arg3 changeDetails:(id)arg4;
...
- (id)dataSourceForLevel:(NSUInteger)arg1;
- (void)dealloc;
