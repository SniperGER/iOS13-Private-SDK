...
@property(copy, nonatomic) id /* block */ viewControllerDismisser; // @synthesize viewControllerDismisser=_viewControllerDismisser;
@property(copy, nonatomic) id /* block */ viewControllerPresenter; // @synthesize viewControllerPresenter=_viewControllerPresenter;
...
- (_Bool)dismissViewController:(struct NSObject *)arg1 completionHandler:(id /* block */)arg2;
