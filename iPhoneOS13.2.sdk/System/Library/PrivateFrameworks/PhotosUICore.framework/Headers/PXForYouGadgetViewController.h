...
- (void)ppt_navigateToFirstInvitationCMM:(_Bool)arg1 withCompleteHandler:(id /* block */)arg2;
- (void)ppt_navigateToFirstSuggestedCMMComposeRecipientViewAfterOneSecondWithCompleteHandler:(id /* block */)arg1;
- (void)ppt_navigateToFirstSuggestedCMMAnimated:(_Bool)arg1 completionHandler:(id /* block */)arg2;
- (void)navigateToSharedAlbumActivityFeedAnimated:(_Bool)arg1 configuration:(id /* block */)arg2 completion:(id /* block */)arg3;
