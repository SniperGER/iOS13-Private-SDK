...
@interface PXRegionOfInterest : PXCoordinatedRect <NSCopying>
{
    ...
    id /* CDUnknownBlockType */ _placeholderViewFactory;
    CGRect _imageContentsRect;
}

@property(copy, nonatomic) id /* CDUnknownBlockType */ placeholderViewFactory; // @synthesize placeholderViewFactory=_placeholderViewFactory;
