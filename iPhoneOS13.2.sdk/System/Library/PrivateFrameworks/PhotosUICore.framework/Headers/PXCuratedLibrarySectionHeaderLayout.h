...
@class NSArray, NSObject, NSSet, NSString, PXAssetCollectionReference, PXCuratedLibraryActionPerformer, PXCuratedLibraryEllipsisButtonActionPerformer, PXCuratedLibraryFilterActionPerformer, PXCuratedLibrarySectionHeaderLayoutSpec, PXTitleSubtitleLabelSpec;
...
@property(readonly, nonatomic) CGRect titleSubtitleFrame; // @synthesize titleSubtitleFrame=_titleSubtitleFrame;
...
- (id)_configurationForButton:(NSUInteger)arg1;
- (void)_discardAllCachedButtonSizes;
- (CGSize)_sizeOfButton:(NSUInteger)arg1;
