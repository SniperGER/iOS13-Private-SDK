...
@class NSMutableArray, PXAssetBadgeManager, PXAssetsDataSource, PXAssetsDataSourceManager, PXAssetsTilingLayout, PXMediaProvider, PXReusableObjectPool, PXScrollViewSpeedometer, PXSectionedSelectionManager, PXTilingController;
...
@interface PXAssetsScene : NSObject <PXReusableObjectPoolDelegate, PXAssetsDataSourceManagerObserver, PXChangeObserver, PXTileSource, PXTilingControllerScrollDelegate, PXTilingControllerTransitionDelegate>
{
   ...
   struct {
    ...
    NSUInteger _autoplayBehavior;
}

@property(nonatomic) BOOL autoplayTilesWaitForInput; // @synthesize autoplayTilesWaitForInput=_autoplayTilesWaitForInput;
@property(nonatomic) NSUInteger autoplayBehavior; // @synthesize autoplayBehavior=_autoplayBehavior;
