...
- (void)requestNewMemoriesForReason:(NSUInteger)arg1 withCompletion:(CDUnknownBlockType)arg2;
...
- (void)prepare;
- (id)initWithScrollViewController:(id)arg1 photoLibrary:(id)arg2 traitCollection:(id)arg3 memoriesStyle:(NSUInteger)arg4 tilingControllerConfigurationBlock:(CDUnknownBlockType)arg5;
