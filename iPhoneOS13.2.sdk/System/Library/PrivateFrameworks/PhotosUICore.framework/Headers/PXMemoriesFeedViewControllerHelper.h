...
@property(copy, nonatomic, setter=_setNewMemoriesRequestCompletion:) id /* block */ _newMemoriesRequestCompletion; // @synthesize _newMemoriesRequestCompletion=__newMemoriesRequestCompletion;
