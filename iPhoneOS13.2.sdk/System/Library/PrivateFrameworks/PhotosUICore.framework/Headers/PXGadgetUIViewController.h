...
- (void)dismissGadgetViewController:(NSObject )arg1 animated:(BOOL)arg2 completion:(CDUnknownBlockType)arg3;
- (void)presentGadgetViewController:(NSObject )arg1 animated:(BOOL)arg2 completion:(CDUnknownBlockType)arg3;
- (BOOL)gadget:(id)arg1 transitionToViewController:(NSObject )arg2 animated:(BOOL)arg3 completion:(CDUnknownBlockType)arg4;
