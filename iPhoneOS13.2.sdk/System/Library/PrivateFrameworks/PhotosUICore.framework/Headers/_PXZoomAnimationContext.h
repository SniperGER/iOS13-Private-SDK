...
@property(copy, nonatomic, setter=_setAllAnimationsCompletionHandler:) id /* block */ _allAnimationsCompletionHandler; // @synthesize _allAnimationsCompletionHandler=__allAnimationsCompletionHandler;
