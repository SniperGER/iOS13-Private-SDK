...
- (void)_enumerateSpritesInRect:(struct CGRect)arg1 transform:(CDStruct_3fe57b01)arg2 usingBlock:(id /* block */)arg3;
- (void)enumerateSpritesInRect:(struct CGRect)arg1 usingBlock:(id /* block */)arg2;
...
- (void)_enumerateSpritesInRange:(struct _PXGSpriteIndexRange)arg1 transform:(CDStruct_3fe57b01)arg2 spriteOffset:(unsigned int)arg3 stop:(_Bool *)arg4 usingBlock:(id /* block */)arg5;
- (void)enumerateSpritesInRange:(struct _PXGSpriteIndexRange)arg1 options:(unsigned long long)arg2 usingBlock:(id /* block */)arg3;
- (void)enumerateSpritesInRange:(struct _PXGSpriteIndexRange)arg1 usingBlock:(id /* block */)arg2;
- (void)copyLayoutForSpritesInRange:(struct _PXGSpriteIndexRange)arg1 applySpriteTransforms:(_Bool)arg2 parentTransform:(CDStruct_3fe57b01)arg3 parentSublayoutOrigin:(struct CGPoint)arg4 geometries:(CDStruct_ac168a83 *)arg5 styles:(CDStruct_506f5052 *)arg6 infos:(CDStruct_9d1ebe49 *)arg7;
- (void)copyLayoutForSpritesInRange:(struct _PXGSpriteIndexRange)arg1 applySpriteTransforms:(_Bool)arg2 geometries:(CDStruct_ac168a83 *)arg3 styles:(CDStruct_506f5052 *)arg4 infos:(CDStruct_9d1ebe49 *)arg5;
...
- (void)modifySpritesInRange:(struct _PXGSpriteIndexRange)arg1 state:(id /* block */)arg2;
...
- (void)addSpritesInRange:(struct _PXGSpriteIndexRange)arg1 initialState:(id /* block */)arg2;
- (struct _PXGSpriteIndexRange)addSpriteCount:(unsigned int)arg1 withInitialState:(id /* block */)arg2;
...
- (void)enumerateLayoutsForSpritesInRange:(struct _PXGSpriteIndexRange)arg1 options:(unsigned long long)arg2 usingBlock:(id /* block */)arg3;
...
- (id)createAnchorForScrollingSpriteForSpriteReference:(id)arg1 toScrollPosition:(unsigned long long)arg2 padding:(struct UIEdgeInsets)arg3 customOffset:(id /* block */)arg4;
