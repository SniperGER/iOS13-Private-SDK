...
@property(nonatomic) NSUInteger inlineHeaderStyle; // @synthesize inlineHeaderStyle=_inlineHeaderStyle;
...
@property(nonatomic) UIEdgeInsets titlePadding; // @synthesize titlePadding=_titlePadding;
@property(nonatomic) UIEdgeInsets contentPadding; // @synthesize contentPadding=_contentPadding;
