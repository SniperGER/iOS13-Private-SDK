...
+ (id)sendBackContextTimeLocationMatching:(id)arg1 sourceType:(NSUInteger)arg2;
+ (id)sendBackContextOverlappingTimeFromStartDate:(id)arg1 endDate:(id)arg2 sourceType:(NSUInteger)arg3;
+ (id)new;
...
- (id)sendBackContextPhotosGraphBasedWithSourceType:(NSUInteger)arg1;
...
- (void)startLoading;
- (id)initWithAssetsDataSource:(id)arg1 sourceType:(NSUInteger)arg2 originatingMomentShare:(id)arg3;
- (id)init;
