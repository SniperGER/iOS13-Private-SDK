...
- (void)enumerateFramesForSectionsInRect:(struct CGRect)arg1 usingBlock:(id /* block */)arg2;
- (void)enumerateGeometriesForItemsInRect:(struct CGRect)arg1 usingBlock:(id /* block */)arg2;
