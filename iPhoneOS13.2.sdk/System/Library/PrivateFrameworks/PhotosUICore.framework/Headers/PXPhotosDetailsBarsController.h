...
@class NSMutableDictionary, PXActionPerformer, PXAssetActionManager, PXAssetCollectionActionManager, PXBarAppearance, PXExtendedTraitCollection, PXPhotoDetailsActionMenuController, PXPhotosDataSource, PXPhotosDetailsContext, PXPhotosDetailsViewModel, PXSectionedSelectionManager, UIView;
...
- (id)_barButtonItemForBarItem:(id)arg1 placement:(NSUInteger)arg2;
- (id)_flexibleSpaceBarButtonItem;
- (id)_barButtonItemsForBarItems:(id)arg1 placement:(NSUInteger)arg2;
