...
- (_Bool)_enumerateKey:(id)arg1 updatedAfter:(id)arg2 fromTable:(id)arg3 usingBlock:(id /* block */)arg4 error:(id *)arg5;
- (_Bool)enumerateSentItemsOfKey:(id)arg1 updatedAfter:(id)arg2 error:(id *)arg3 usingBlock:(id /* block */)arg4;
- (_Bool)enumerateRemovalsOfKey:(id)arg1 updatedAfter:(id)arg2 error:(id *)arg3 usingBlock:(id /* block */)arg4;
- (_Bool)enumerateItemsOfKey:(id)arg1 updatedAfter:(id)arg2 error:(id *)arg3 usingBlock:(id /* block */)arg4;
...
- (_Bool)succeedOrRollbackOnFail:(id)arg1 error:(id *)arg2 whileExecuting:(id /* block */)arg3;
