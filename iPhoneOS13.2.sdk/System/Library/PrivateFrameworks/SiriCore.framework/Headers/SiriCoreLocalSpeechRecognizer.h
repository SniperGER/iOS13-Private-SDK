...
- (void)_readProfileAndUserDataWithLanguage:(id)arg1 allowOverride:(_Bool)arg2 completion:(id /* block */)arg3;
...
- (void)getOfflineDictationStatusIgnoringCache:(_Bool)arg1 withCompletion:(id /* block */)arg2;
