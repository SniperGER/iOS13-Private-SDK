...
- (void)setConnectionMetricsFromNWConnectionForDirect:(id)arg1 isMPTCP:(_Bool)arg2 attemptedEndpoints:(id)arg3 withCompletion:(id /* block */)arg4;
- (void)setConnectionMetricsFromConnection:(id)arg1 isPop:(_Bool)arg2 isMPTCP:(_Bool)arg3 attemptedEndpoints:(id)arg4 completion:(id /* block */)arg5;
...
- (void)setConnectionMetricsFromStream:(id)arg1 isPop:(_Bool)arg2 withCompletion:(id /* block */)arg3;
