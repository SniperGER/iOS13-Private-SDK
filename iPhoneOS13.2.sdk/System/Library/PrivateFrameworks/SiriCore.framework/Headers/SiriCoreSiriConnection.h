...
- (void)getConnectionMetricsSynchronously:(_Bool)arg1 completion:(id /* block */)arg2;
- (void)getAnalysisInfo:(id /* block */)arg1;
- (id)analysisInfo;
- (void)cancelSynchronously:(_Bool)arg1 onQueue:(_Bool)arg2 completion:(id /* block */)arg3;
