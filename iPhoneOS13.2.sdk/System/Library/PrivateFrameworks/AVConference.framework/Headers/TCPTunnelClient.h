...
@property(copy) id /* block */ terminationHandler; // @synthesize terminationHandler=_terminationHandler;
@property(copy) id /* block */ destroyHandler; // @synthesize destroyHandler=_destroyHandler;
@property(copy) id /* block */ bindingResponseHandler; // @synthesize bindingResponseHandler=_bindingResponseHandler;
@property(copy) id /* block */ allocationResponseHandler; // @synthesize allocationResponseHandler=_allocationResponseHandler;
@property(copy) id /* block */ receiveHandler; // @synthesize receiveHandler=_handler;
