...
@interface AVCMediaStreamConfig : NSObject
{
    ...
    NSUInteger _txPayloadType;
    NSUInteger _rxPayloadType;
...
@property(nonatomic) NSUInteger rxPayloadType; // @synthesize rxPayloadType=_rxPayloadType;
@property(nonatomic) NSUInteger txPayloadType; // @synthesize txPayloadType=_txPayloadType;
