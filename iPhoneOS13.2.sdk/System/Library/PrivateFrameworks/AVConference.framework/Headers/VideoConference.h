...
- (CGSize)remoteFrameSizeForCallID:(unsigned int)arg1;
...
- (void)inviteDataForParticipantID:(id)arg1 callID:(unsigned int)arg2 remoteInviteData:(id)arg3 nonCellularCandidateTimeout:(NSUInteger)arg4 block:(CDUnknownBlockType)arg5 queue:(id)arg6 caller:(id)arg7;
- (void)cleanupQueues;
...
- (void)setConferenceVisualRectangle:(CGRect)arg1 forCallID:(unsigned int)arg2;
