...
@property(copy, nonatomic) id /* block */ errorReponseCallback; // @synthesize errorReponseCallback=_errorReponseCallback;
@property(copy, nonatomic) id /* block */ peerPublishedStreamCallback; // @synthesize peerPublishedStreamCallback=_peerPublishedStreamCallback;
@property(copy, nonatomic) id /* block */ peerSubscribedStreamCallback; // @synthesize peerSubscribedStreamCallback=_peerSubscribedStreamCallback;
