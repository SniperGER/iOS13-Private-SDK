...
@class AVCRateController, NSArray, NSNumber, NSObject, VCRedundancyControllerVideo, VCVideoCaptureConverter, VCVideoReceiverBase, VCVideoRule, VCVideoTransmitterBase;
