...
@class NSMutableArray, VCConnectionHealthMonitor, VCStatsRecorder, VCWifiAssistManager;
...
//     struct opaqueRTCReporting _reportingAgent;
    ...
    NSUInteger _mediaCellularTxBytes;
    NSUInteger _mediaCellularRxBytes;
    NSUInteger _mediaWifiTxBytes;
    NSUInteger _mediaWifiRxBytes;
    id _delegate;
    NSObject<OS_dispatch_queue> *_delegateQueue;
    int _duplicationType;
    /* void * CDUnknownFunctionPointerType _duplicationCallback */;
...
//     CDStruct_50492349 _remoteConnectionStats;
    ...
    /* void * CDUnknownFunctionPointerType _wrmStatusUpdateCallback */;
    /* void * CDUnknownFunctionPointerType _wrmRequestNotificationCallback */;
...
@property(readonly) NSUInteger mediaWifiRxBytes; // @synthesize mediaWifiRxBytes=_mediaWifiRxBytes;
@property(readonly) NSUInteger mediaWifiTxBytes; // @synthesize mediaWifiTxBytes=_mediaWifiTxBytes;
@property(readonly) NSUInteger mediaCellularRxBytes; // @synthesize mediaCellularRxBytes=_mediaCellularRxBytes;
@property(readonly) NSUInteger mediaCellularTxBytes; // @synthesize mediaCellularTxBytes=_mediaCellularTxBytes;
...
- (int)setWRMUpdateCallback:(/* void * CDUnknownFunctionPointerType */)arg1 requestNotificationCallback:(/* void * CDUnknownFunctionPointerType */)arg2 withContext:(void )arg3;
...
- (void)setDuplicationCallback:(/* void * CDUnknownFunctionPointerType */)arg1 withContext:(void )arg2;
