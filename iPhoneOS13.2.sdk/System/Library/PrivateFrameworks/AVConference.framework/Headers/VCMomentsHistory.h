...
// - (void)setupWriterWithTransactionID:(id)arg1 filePath:(id)arg2 stillImageTime:(CDStruct_1b6d18a9)arg3 visibleRect:(CGRect)arg4 cameraStatusBit:(unsigned char)arg5;
...
// - (CDStruct_1b6d18a9)setupStillImageWithTimestamp:(unsigned int)arg1 transactionID:(id)arg2 visibleRect:(CGRect )arg3 cameraStatusBit:(char )arg4 imageType:(int)arg5;
