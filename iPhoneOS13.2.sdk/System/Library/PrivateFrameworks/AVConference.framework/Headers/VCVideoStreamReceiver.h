...
@class NSObject, VCMediaStreamStats, VCMediaStreamSynchronizer, VCVideoStreamRateAdaptation, VideoAttributes;
...
- (void)setEnableCVO:(BOOL)arg1 cvoExtensionID:(NSUInteger)arg2;
- (void)dealloc;
