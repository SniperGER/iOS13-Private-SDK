...
- (int)transmitEncodedVideoFrame:(char )arg1 size:(NSUInteger)arg2 timestamp:(unsigned int)arg3 hostTime:(double)arg4 cameraStatusBits:(unsigned char)arg5;
...
- (BOOL)prependSPSPPS:(NSUInteger )arg1 dataPointer:(char )arg2;
