...
//     struct _VCMediaStreamTransportSetupInfo _transportSetupInfo;
    ...
    /* void * CDUnknownFunctionPointerType _vcMediaCallback */;
//     struct tagVCMediaQueue _mediaQueue;
    VCMasterKeyIndex *_lastReceivedMKI;
    VCCallInfoBlob *_remoteEndpointInfo;
    /* void * CDUnknownFunctionPointerType _notificationHandler */;
    /* void * CDUnknownFunctionPointerType _packetEventHandler */;
...
- (void)resetTimeoutHeartbeatTimer:(NSUInteger)arg1;
...
- (void)resetRTCPSendHeartbeatTimer:(NSUInteger)arg1;
