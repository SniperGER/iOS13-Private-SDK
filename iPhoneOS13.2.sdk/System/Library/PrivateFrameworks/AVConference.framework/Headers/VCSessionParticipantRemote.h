...
@class NSArray, NSNumber, TimingCollection, VCSessionBandwidthAllocationTable, VCSessionParticipantMediaStreamInfo, VCVideoQualityInfo;
...
- (void)dealloc;
- (id)initWithIDSDestination:(id)arg1 idsParticipantID:(NSUInteger)arg2 mediaNegotiator:(id)arg3 opaqueData:(id)arg4 delegate:(id)arg5 processId:(int)arg6 transportSessionID:(unsigned int)arg7 sessionUUID:(id)arg8 config:(id)arg9;
