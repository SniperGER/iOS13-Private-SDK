...
// - (BOOL)session:(VCCallSession *)arg1 receivedRemoteFrame:(struct __CVBuffer )arg2 atTime:(CDStruct_1b6d18a9)arg3 withScreenAttributes:(VideoAttributes *)arg4 videoAttributes:(VideoAttributes *)arg5 isFirstFrame:(BOOL)arg6 isVideoPaused:(BOOL)arg7;
