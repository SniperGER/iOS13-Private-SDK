...
struct _VCAudioEndpointData {
    ...
    id delegate;
    /* void * CDUnknownFunctionPointerType clientCallback */;
    void clientContext;
};

struct _VCAudioIOControllerClientIO {
    void processSamplesContext;
    /* void * CDUnknownFunctionPointerType processSamples */;
    NSObject *runLock;
};
...
struct _VCAudioPowerSpectrumRealtimeContext {
    ...
    void sinkContext;
    /* void * CDUnknownFunctionPointerType sinkCallback */;
};
...
struct _VCSingleLinkedList {
    ...
    BOOL initialized;
    /* void * CDUnknownFunctionPointerType compare */;
};
...
struct tagVCAudioReceiver {
    ...
    void _field2;
    void _field3;
    struct opaqueVCJitterBuffer _field4;
    BOOL _field5;
...
struct tagVCAudioReceiverConfig {
    unsigned int _field1;
    struct tagVCAudioReceiverStream _field2[3];
    void _field3;
    void _field4;
    unsigned int _field5;
    int _field6;
    int _field7;
    BOOL _field8;
    struct opaqueRTCReporting _field9;
    int _field10;
    BOOL _field11;
...
struct tagVCVideoReceiverConfig {
    ...
    /* void * CDUnknownFunctionPointerType remoteFrameCallback */;
    /* void * CDUnknownFunctionPointerType streamSwitchCallback */;
    /* void * CDUnknownFunctionPointerType keyFrameGenerationCallback */;
    NSUInteger idsParticipantID;
...
struct tagWRMMetricsInfo {
    ...
    NSUInteger callId;
    NSUInteger nominalJitterBufferDelay;
    NSUInteger targetJitterQueueSize;
    int nFraction;
    /* void * CDUnknownFunctionPointerType reportWRMMetricsCallback */;
    struct {
        void info;
...
typedef struct {
    ...
    union {
        ...
        struct {
            ...
            NSUInteger averageThroughputBps;
