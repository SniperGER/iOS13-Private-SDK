...
@class NSArray, NSMutableArray, NSMutableDictionary, NSMutableSet, NSSet, VCAudioPowerSpectrumSource, VCMoments, VCSessionUplinkBandwidthAllocator, VCSessionUplinkVideoStreamController, VCVideoRule;
