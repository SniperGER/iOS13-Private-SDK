...
- (void)removeActiveParticipant:(NSUInteger)arg1;
- (void)addActiveParticipant:(NSUInteger)arg1;
...
- (BOOL)sendReliableMessage:(id)arg1 participantID:(NSUInteger)arg2 timeout:(unsigned int)arg3 completion:(CDUnknownBlockType)arg4;
- (BOOL)sendReliableMessageAndWait:(id)arg1 participantID:(NSUInteger)arg2 timeout:(id)arg3;
