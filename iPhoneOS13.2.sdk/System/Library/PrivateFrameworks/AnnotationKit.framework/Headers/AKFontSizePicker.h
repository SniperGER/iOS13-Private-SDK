...
@property(copy, nonatomic) id /* block */ didEndTrackingUpdates; // @synthesize didEndTrackingUpdates=_didEndTrackingUpdates;
@property(copy, nonatomic) id /* block */ willBeginTrackingUpdates; // @synthesize willBeginTrackingUpdates=_willBeginTrackingUpdates;
