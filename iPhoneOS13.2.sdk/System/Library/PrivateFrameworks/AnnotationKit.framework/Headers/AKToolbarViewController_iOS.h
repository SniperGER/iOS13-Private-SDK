...
@class AKColorPickerViewController, AKFloatingAttributePickerViewController, AKLineStylesViewController, AKSignaturesViewController_iOS, AKTextAttributesViewController, NSArray, NSLayoutConstraint, UIAlertController, UIBarButtonItem, UIColor, UIView;
...
- (void)showAttributeToolbarForSelectedAnnotations:(id)arg1 andToolMode:(NSUInteger)arg2;
...
- (id)_barButtonForToolbarType:(NSUInteger)arg1;
