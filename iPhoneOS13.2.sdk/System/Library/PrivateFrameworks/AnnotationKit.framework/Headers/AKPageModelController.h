...
@property CGRect appliedCropRect; // @synthesize appliedCropRect=_appliedCropRect;
...
- (void)replaceObjectInAnnotationsAtIndex:(NSUInteger)arg1 withObject:(id)arg2;
- (void)removeAnnotationsAtIndexes:(id)arg1;
- (void)removeObjectFromAnnotationsAtIndex:(NSUInteger)arg1;
- (void)removeAllAnnotations;
- (void)_enableEditObservationForAnnotationIfNew:(id)arg1;
- (void)insertAnnotations:(id)arg1 atIndexes:(id)arg2;
- (void)insertObject:(id)arg1 inAnnotationsAtIndex:(NSUInteger)arg2;
