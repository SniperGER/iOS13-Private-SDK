...
+ (CGContextRef )_newBitmapFromCGPDFDocument:(CGPDFDocument )arg1;
...
// - (BOOL)_floatPixelBufferForCGContextRef:(CGContextRef )arg1 imageBuffer:(struct vImage_Buffer )arg2;
