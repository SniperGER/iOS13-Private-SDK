...
- (void)enqueueCompletionBlock:(id /* block */)arg1 forRequest:(id)arg2 isDuplicateRequest:(_Bool *)arg3;
- (void)_enqueueCompletionBlock:(id /* block */)arg1 forRequestHash:(id)arg2 inCompletionPool:(id)arg3 isDuplicateRequest:(_Bool *)arg4;
