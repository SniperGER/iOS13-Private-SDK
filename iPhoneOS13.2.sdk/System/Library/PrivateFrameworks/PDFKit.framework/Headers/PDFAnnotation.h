...
- (void)drawAppearance:(CGPDFForm )arg1 withBox:(long long)arg2 inContext:(CGContextRef )arg3 inRect:(CGRect)arg4 scaleProportional:(BOOL)arg5;
- (void)drawAppearance:(CGPDFForm )arg1 withBox:(long long)arg2 inContext:(CGContextRef )arg3 scaleProportional:(BOOL)arg4;
- (void)drawAppearance:(CGPDFForm )arg1 withBox:(long long)arg2 inContext:(CGContextRef )arg3;
...
- (void)setCGPathArray:(CGPathRef)arg1;
- (CGPathRef)cgPathArray;
