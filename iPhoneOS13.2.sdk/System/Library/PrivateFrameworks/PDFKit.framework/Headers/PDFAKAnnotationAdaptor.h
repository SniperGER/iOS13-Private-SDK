...
+ (id)annotationAdaptorWithPDFAnnotation:(id)arg1 andCGPDFAnnotation:(CGPDFAnnotation )arg2 andPDFDictionary:(CGPDFDictionary )arg3;
// - (void).cxx_destruct;
...
- (void)_syncWidgetMaxLen:(NSUInteger)arg1;
- (void)_syncWidgetAppearance:(id)arg1;
- (void)_syncWidgetFieldFlags:(NSUInteger)arg1;
...
- (void)_syncFlags:(NSUInteger)arg1;
