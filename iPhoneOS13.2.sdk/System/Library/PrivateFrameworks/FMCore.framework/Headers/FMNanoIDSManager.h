...
- (id)_sendMessageWithProtobuf:(id)arg1 inResponseToRequest:(id)arg2 withPriority:(long long)arg3 timeout:(double)arg4 bypassingDuet:(_Bool)arg5 deviceID:(id)arg6 responseHandler:(id /* block */)arg7;
- (void)sendMessageWithProtobuf:(id)arg1 inResponseToRequest:(id)arg2 withPriority:(long long)arg3 timeout:(double)arg4 bypassingDuet:(_Bool)arg5 deviceID:(id)arg6 requestAcceptedHandler:(id /* block */)arg7 responseHandler:(id /* block */)arg8;
- (void)sendMessageWithProtobuf:(id)arg1 inResponseToRequest:(id)arg2 withPriority:(long long)arg3 timeout:(double)arg4 bypassingDuet:(_Bool)arg5 requestAcceptedHandler:(id /* block */)arg6 responseHandler:(id /* block */)arg7;
