...
- (void)setValueSimulateDeviceOutOfSpace:(_Bool)arg1 withReply:(id /* block */)arg2;
- (void)resetAllCrashSimulationOverridesWithReply:(id /* block */)arg1;
- (void)getCrashSimulationOverrideValuesWithReply:(id /* block */)arg1;
- (void)setValueSimulateCrashAtInstallDuringFinish:(_Bool)arg1 withReply:(id /* block */)arg2;
- (void)setValueSimulateCrashAtInstallDuringUnzip:(_Bool)arg1 withReply:(id /* block */)arg2;
- (void)setValueSimulateCrashAtInstallDuringDecrypt:(_Bool)arg1 withReply:(id /* block */)arg2;
- (void)setValueSimulateCrashAtInstallStart:(_Bool)arg1 withReply:(id /* block */)arg2;
- (void)requestDownloadsWithMetadata:(id)arg1 areRestore:(_Bool)arg2 reply:(id /* block */)arg3;
- (void)requestDownloadWithMetadata:(id)arg1 isRestore:(_Bool)arg2 reply:(id /* block */)arg3;
