...
+ (id)canvasWithSizer:(id)arg1 options:(struct NULayoutOptions)arg2 inNode:(id)arg3 componentsBlock:(id /* block */)arg4;
+ (id)canvasWithSizer:(id)arg1 options:(struct NULayoutOptions)arg2 componentsBlock:(id /* block */)arg3;
...
- (id)resolveView;
- (id)initWithNode:(id)arg1 sizer:(id)arg2 options:(struct NULayoutOptions)arg3 componentsBlock:(id /* block */)arg4;
