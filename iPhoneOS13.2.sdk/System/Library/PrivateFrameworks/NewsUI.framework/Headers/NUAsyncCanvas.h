...
- (void)layoutInBounds:(struct CGRect)arg1 traitCollection:(id)arg2 callbackQueue:(id)arg3 completion:(id /* block */)arg4;
- (void)layoutInBounds:(struct CGRect)arg1 traitCollection:(id)arg2 completion:(id /* block */)arg3;
