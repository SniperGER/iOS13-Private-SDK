...
@interface NUNewsAnalyticsVideoPlayerEventTrackerConfiguration : NSObject <NSCopying>
{
    ...
    int _parentFeedType;
    NSUInteger _supplementalEventOptions;
...
@property(readonly, nonatomic) NSUInteger supplementalEventOptions; // @synthesize supplementalEventOptions=_supplementalEventOptions;
...
- (id)initWithAdType:(int)arg1 adLocation:(int)arg2 newsProductType:(int)arg3 mediaEngagePlayLocation:(int)arg4 mediaEngageCompletePlayLocation:(int)arg5 articleHostViewType:(int)arg6 supplementalEventOptions:(NSUInteger)arg7 groupType:(int)arg8 groupViewExposureID:(id)arg9 linkTapLocationType:(int)arg10 articleViewPresentationReason:(int)arg11 autoPlayArticleViewPresentationReason:(int)arg12 widgetEngagement:(id)arg13 referringURLString:(id)arg14 referringSourceApplication:(id)arg15 leadingVideoItemSessionID:(id)arg16 parentFeedType:(int)arg17;
- (id)init;
