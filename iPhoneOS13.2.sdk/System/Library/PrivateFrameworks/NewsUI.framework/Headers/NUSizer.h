...
@property(readonly, copy, nonatomic) id /* block */ sizerBlock; // @synthesize sizerBlock=_sizerBlock;
...
- (id)initWithDescription:(id)arg1 flexible:(_Bool)arg2 sizerBlock:(id /* block */)arg3;
