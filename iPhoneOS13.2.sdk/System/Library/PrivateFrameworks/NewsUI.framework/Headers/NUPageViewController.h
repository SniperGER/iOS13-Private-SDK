...
@class NSMutableArray, NSObject, NUPageViewControllerScrollView;
...
@property(readonly, nonatomic) CGSize transitioningSize; // @synthesize transitioningSize=_transitioningSize;
...
- (CGPoint)centerForIndex:(NSUInteger)arg1;
