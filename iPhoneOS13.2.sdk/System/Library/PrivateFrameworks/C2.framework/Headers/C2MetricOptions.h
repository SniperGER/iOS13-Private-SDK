...
@property(copy, nonatomic) id /* block */ testBehavior_reportMetric; // @synthesize testBehavior_reportMetric=_testBehavior_reportMetric;
...
@property(copy, nonatomic) id /* block */ didCompleteWithError; // @synthesize didCompleteWithError=_didCompleteWithError;
