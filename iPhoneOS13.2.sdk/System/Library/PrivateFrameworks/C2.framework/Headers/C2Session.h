...
@interface C2Session : NSObject <NSURLSessionDelegate, NSURLSessionTaskDelegate, NSURLSessionTaskDelegatePrivate, NSURLSessionDataDelegate, NSURLSessionDataDelegatePrivate, C2RequestDelegate, C2SessionTaskDelegate>
{
    ...
    id /* CDUnknownBlockType */ _testBehavior_sessionInvalidated_cfnetwork;
    id /* CDUnknownBlockType */ _testBehavior_sessionInvalidated_shouldInvalidate;
    id /* CDUnknownBlockType */ _testBehavior_cleanupRetainCycle;
}

+ (id)portFromURL:(id)arg1;
@property(copy, nonatomic) id /* CDUnknownBlockType */ testBehavior_cleanupRetainCycle; // @synthesize testBehavior_cleanupRetainCycle=_testBehavior_cleanupRetainCycle;
@property(copy, nonatomic) id /* CDUnknownBlockType */ testBehavior_sessionInvalidated_shouldInvalidate; // @synthesize testBehavior_sessionInvalidated_shouldInvalidate=_testBehavior_sessionInvalidated_shouldInvalidate;
@property(copy, nonatomic) id /* CDUnknownBlockType */ testBehavior_sessionInvalidated_cfnetwork; // @synthesize testBehavior_sessionInvalidated_cfnetwork=_testBehavior_sessionInvalidated_cfnetwork;
