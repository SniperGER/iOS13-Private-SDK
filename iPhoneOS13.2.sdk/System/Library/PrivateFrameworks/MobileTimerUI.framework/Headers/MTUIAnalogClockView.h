...
+ (id)imageForType:(int)arg1 dayTime:(_Bool)arg2 generation:(id /* block */)arg3 ignoreCache:(_Bool)arg4;
+ (id)imageForType:(int)arg1 dayTime:(_Bool)arg2 generation:(id /* block */)arg3;
