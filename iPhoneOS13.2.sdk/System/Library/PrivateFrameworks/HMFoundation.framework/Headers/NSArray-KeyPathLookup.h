...
- (id)hmf_objectsWithOptions:(NSUInteger)arg1 passingTest:(CDUnknownBlockType)arg2;
- (id)hmf_objectsPassingTest:(CDUnknownBlockType)arg1;
- (id)hmf_objectWithOptions:(NSUInteger)arg1 passingTest:(CDUnknownBlockType)arg2;
