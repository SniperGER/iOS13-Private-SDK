...
+ (void)initialize;
+ (id)bundleIdentifier;
+ (void)activityWithName:(id)arg1 parent:(id)arg2 options:(NSUInteger)arg3 block:(CDUnknownBlockType)arg4;
+ (void)activityWithName:(id)arg1 parent:(id)arg2 assertions:(NSUInteger)arg3 block:(CDUnknownBlockType)arg4;
