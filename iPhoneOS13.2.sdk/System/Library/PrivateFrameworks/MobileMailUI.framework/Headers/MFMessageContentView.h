...
- (void)_addHasMoreContentBannerWithRemainingBytes:(NSUInteger)arg1;
...
- (void)_webView:(id)arg1 dataInteraction:(id)arg2 session:(id)arg3 didEndWithOperation:(NSUInteger)arg4;
...
- (id)_libraryMessage;
- (void)endResizing;
- (void)prepareContentViewForResizingWithSnapshotRect:(CGRect)arg1;
