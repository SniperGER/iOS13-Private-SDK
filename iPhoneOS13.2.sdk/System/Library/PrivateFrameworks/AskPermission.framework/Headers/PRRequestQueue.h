...
- (void)_attemptLocalApprovalForStorePurchaseRequestWithAdamID:(NSUInteger)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (void)_attemptLocalApprovalForStorePurchaseRequestWithItemIdentifier:(NSUInteger)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (void)_pendingStorePurchaseRequestForItemIdentifier:(NSUInteger)arg1 replyBlock:(CDUnknownBlockType)arg2;
