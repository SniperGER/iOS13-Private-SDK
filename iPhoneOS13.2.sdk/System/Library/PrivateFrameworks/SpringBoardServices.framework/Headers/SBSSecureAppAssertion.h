...
+ (id)acquireSecureAppAssertionWithType:(NSUInteger)arg1 supportedOrientations:(NSUInteger)arg2 errorHandler:(CDUnknownBlockType)arg3;
+ (id)acquireSecureAppAssertionWithType:(NSUInteger)arg1 errorHandler:(CDUnknownBlockType)arg2;
