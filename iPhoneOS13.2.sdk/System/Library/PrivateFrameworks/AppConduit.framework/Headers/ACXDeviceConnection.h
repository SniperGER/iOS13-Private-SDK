...
- (void)_fetchLocallyAvailableApplicationWithBundleID:(id)arg1 forDeviceWithPairingID:(id)arg2 options:(NSUInteger)arg3 completion:(CDUnknownBlockType)arg4;
...
- (void)enumerateLocallyAvailableApplicationsForDeviceWithPairingID:(id)arg1 options:(NSUInteger)arg2 withBlock:(CDUnknownBlockType)arg3;
- (void)enumerateLocallyAvailableApplicationsForPairedDevice:(id)arg1 options:(NSUInteger)arg2 withBlock:(CDUnknownBlockType)arg3;
...
- (void)updatePreferencesForApplicationWithIdentifier:(id)arg1 preferences:(id)arg2 writingToPreferencesLocation:(NSUInteger)arg3 forPairedDevice:(id)arg4 options:(NSUInteger)arg5 completion:(CDUnknownBlockType)arg6;
