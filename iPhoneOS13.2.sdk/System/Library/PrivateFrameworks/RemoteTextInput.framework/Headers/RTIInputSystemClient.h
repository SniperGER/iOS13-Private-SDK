...
- (void)_modifyTextEditingAllowedForReason:(id)arg1 notify:(_Bool)arg2 block:(id /* block */)arg3;
...
- (void)enumerateServices:(id)arg1 force:(_Bool)arg2 withBlock:(id /* block */)arg3;
