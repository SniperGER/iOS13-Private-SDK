...
@interface ADAdActionPublicAttributes : NSObject <NSSecureCoding>
{
    ...
    int _action;
    int _transitionType;
    NSUInteger _actionViewControllerPresentationOrientationMask;
...
@property(nonatomic) NSUInteger actionViewControllerPresentationOrientationMask; // @synthesize actionViewControllerPresentationOrientationMask=_actionViewControllerPresentationOrientationMask;
