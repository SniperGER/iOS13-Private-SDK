...
- (id)laneWidthAtIndex:(NSUInteger)arg1;
- (NSUInteger)laneWidthsCount;
...
- (id)roadComplexityAtIndex:(NSUInteger)arg1;
- (NSUInteger)roadComplexitysCount;
...
- (id)endingRouteInstructionAtIndex:(NSUInteger)arg1;
- (NSUInteger)endingRouteInstructionsCount;
...
- (id)startingRouteInstructionAtIndex:(NSUInteger)arg1;
- (NSUInteger)startingRouteInstructionsCount;
...
- (id)routeDescriptionAtIndex:(NSUInteger)arg1;
- (NSUInteger)routeDescriptionsCount;
...
- (void)setIncidentEndOffsetsInRoutes:(unsigned int )arg1 count:(NSUInteger)arg2;
- (unsigned int)incidentEndOffsetsInRouteAtIndex:(NSUInteger)arg1;
...
- (void)setIncidentIndices:(unsigned int )arg1 count:(NSUInteger)arg2;
- (unsigned int)incidentIndicesAtIndex:(NSUInteger)arg1;
...
- (id)enrouteNoticeAtIndex:(NSUInteger)arg1;
- (NSUInteger)enrouteNoticesCount;
...
- (void)setAdvisorys:(int )arg1 count:(NSUInteger)arg2;
- (int)advisoryAtIndex:(NSUInteger)arg1;
- (void)_addNoFlagsAdvisory:(int)arg1;
- (void)addAdvisory:(int)arg1;
- (void)clearAdvisorys;
@property(readonly, nonatomic) int advisorys;
@property(readonly, nonatomic) NSUInteger advisorysCount;
- (void)_readAdvisorys;
@property(nonatomic) BOOL hasHistoricTravelTime;
@property(nonatomic) unsigned int historicTravelTime;
- (id)routeNameAtIndex:(NSUInteger)arg1;
- (NSUInteger)routeNamesCount;
...
- (id)advisoryNoticeAtIndex:(NSUInteger)arg1;
- (NSUInteger)advisoryNoticesCount;
...
- (id)newETARouteFromStepIndex:(NSUInteger)arg1 stepPercentRemaining:(double)arg2;
- (id)newETARoute;
- (id)convertToFullRoute:(id)arg1 includeDepartureRoutes:(BOOL)arg2 uniquePointRange:(NSRange * )arg3;
- (NSUInteger)indexForStepID:(NSUInteger)arg1;
- (id)simplifiedDescription;
- (id)debugDescription;
- (NSUInteger)stepIndexForPointIndex:(unsigned int)arg1;
- (NSUInteger)distanceFromStepIndex:(NSUInteger)arg1 toStepIndex:(NSUInteger)arg2;
