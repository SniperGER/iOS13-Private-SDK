...
- (_Bool)executeInTransaction:(id /* block */)arg1;
- (_Bool)vacuum;
- (_Bool)executeStatement:(id)arg1 statementBlock:(id /* block */)arg2;
...
- (_Bool)_bindParameter:(const char *)arg1 inStatement:(struct sqlite3_stmt *)arg2 error:(id *)arg3 withBinder:(id /* block */)arg4;
- (_Bool)statementForKey:(id)arg1 statementBlock:(id /* block */)arg2;
