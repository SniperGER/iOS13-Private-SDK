...
- (id)description;
- (void)setExcludeCategoryFilters:(unsigned int )arg1 count:(NSUInteger)arg2;
- (unsigned int)excludeCategoryFilterAtIndex:(NSUInteger)arg1;
...
@property(readonly, nonatomic) NSUInteger excludeCategoryFiltersCount;
- (void)_readExcludeCategoryFilters;
- (void)setIncludeCategoryFilters:(unsigned int )arg1 count:(NSUInteger)arg2;
- (unsigned int)includeCategoryFilterAtIndex:(NSUInteger)arg1;
...
@property(readonly, nonatomic) NSUInteger includeCategoryFiltersCount;
