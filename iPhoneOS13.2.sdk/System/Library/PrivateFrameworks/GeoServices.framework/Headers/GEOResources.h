...
- (id)urlInfoSetAtIndex:(NSUInteger)arg1;
- (NSUInteger)urlInfoSetsCount;
...
- (id)muninVersionAtIndex:(NSUInteger)arg1;
- (NSUInteger)muninVersionsCount;
...
- (id)dataSetURLOverrideAtIndex:(NSUInteger)arg1;
- (NSUInteger)dataSetURLOverridesCount;
...
- (void)_readTileSets;
- (id)tileGroupAtIndex:(NSUInteger)arg1;
- (NSUInteger)tileGroupsCount;
