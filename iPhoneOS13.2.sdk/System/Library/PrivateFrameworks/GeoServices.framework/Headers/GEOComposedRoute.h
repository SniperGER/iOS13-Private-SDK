...
@interface GEOComposedRoute : NSObject <NSSecureCoding, GEOMapAccessRestrictions>
{
    ...
    NSUInteger _currentDisplayStep;
    ...
    NSUInteger _indexOfSuggestedRoute;
...
@property(readonly, nonatomic) NSUInteger indexOfSuggestedRoute; // @synthesize indexOfSuggestedRoute=_indexOfSuggestedRoute;
...
@property(nonatomic) NSUInteger currentDisplayStep; // @synthesize currentDisplayStep=_currentDisplayStep;
...
- (void)selectRide:(NSUInteger)arg1 forBoardStep:(id)arg2;
- (void)selectRide:(NSUInteger)arg1 forTripLeg:(id)arg2;
- (id)boardStepForSection:(id)arg1;
- (id)sectionOptionForTripLeg:(id)arg1;
- (id)sectionOptionForTripIndex:(NSUInteger)arg1;
- (NSUInteger)_tripIndexForTripLeg:(id)arg1;
- (void)_updateSectionOptions;
- (void)initRideSelections;
- (id)_nextOptionForOption:(id)arg1 rideIndex:(NSUInteger)arg2;
...
// - (id)getSnappedPathsForVisibleRect:(CDStruct_90e2a262)arg1 rectsToSnap:(CDStruct_90e2a262 )arg2 rectsToSnapCount:(NSUInteger)arg3 observer:(id)arg4;
...
// - (void)_addSnappedPolylinePathsForSection:(id)arg1 toPaths:(id)arg2 rects:(CDStruct_90e2a262 )arg3 rectsCount:(NSUInteger)arg4;
...
- (double)remainingDistanceAlongRouteFromStepIndex:(NSUInteger)arg1 currentStepRemainingDistance:(double)arg2;
- (double)remainingTimeAlongRouteFromStepIndex:(NSUInteger)arg1 currentStepRemainingDistance:(double)arg2;
...
- (id)zilchDataFromStepIndex:(NSUInteger)arg1;
...
- (id)legForStepIndex:(NSUInteger)arg1;
- (NSUInteger)legIndexForStepIndex:(NSUInteger)arg1;
- (NSUInteger)legIndexForPointIndex:(NSUInteger)arg1;
- (NSUInteger)stepIndexForPointIndex:(NSUInteger)arg1;
...
- (double)distanceFromPointIndex:(NSUInteger)arg1 toPointIndex:(NSUInteger)arg2;
...
// - (struct PolylineCoordinate)coordinateAtOffset:(double)arg1 fromRoutePoint:(NSUInteger)arg2;
...
// - (CDStruct_39925896)pointAt:(NSUInteger)arg1;
