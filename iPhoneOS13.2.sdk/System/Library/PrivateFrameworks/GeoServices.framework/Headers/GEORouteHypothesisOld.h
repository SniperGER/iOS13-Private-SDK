...
@property(readonly, nonatomic) NSUInteger travelState; // @synthesize travelState=_travelState;
...
@property(readonly, nonatomic) NSUInteger historicTrafficDensity; // @synthesize historicTrafficDensity=_historicTrafficDensity;
