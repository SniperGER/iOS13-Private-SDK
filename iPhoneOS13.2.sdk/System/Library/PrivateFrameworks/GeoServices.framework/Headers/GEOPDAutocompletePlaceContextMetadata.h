...
- (void)setClientizationFeatures:(int )arg1 count:(NSUInteger)arg2;
- (int)clientizationFeatureAtIndex:(NSUInteger)arg1;
...
@property(readonly, nonatomic) NSUInteger clientizationFeaturesCount;
