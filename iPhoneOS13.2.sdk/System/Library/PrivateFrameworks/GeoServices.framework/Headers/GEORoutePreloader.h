...
@property(readonly, copy, nonatomic) id /* block */ tileKeyIsDownloadedPredicate; // @synthesize tileKeyIsDownloadedPredicate=_tileKeyIsDownloadedPredicate;
@property(copy, nonatomic) id /* block */ batteryHandler; // @synthesize batteryHandler=_batteryHandler;
...
- (void)dealloc;
- (void)tearDown;
- (id)initWithRoute:(id)arg1 auditToken:(id)arg2 loggingEnabled:(_Bool)arg3 minimalDebugging:(_Bool)arg4 fullDebugging:(_Bool)arg5 batteryHandler:(id /* block */)arg6;
- (id)initWithRoute:(id)arg1 loggingEnabled:(_Bool)arg2 minimalDebugging:(_Bool)arg3 fullDebugging:(_Bool)arg4 batteryHandler:(id /* block */)arg5;
- (id)init;
