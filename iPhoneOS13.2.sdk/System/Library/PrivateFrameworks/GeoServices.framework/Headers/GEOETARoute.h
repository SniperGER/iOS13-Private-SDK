...
- (void)setIncidentEndOffsetsInETARoutes:(unsigned int )arg1 count:(NSUInteger)arg2;
- (unsigned int)incidentEndOffsetsInETARouteAtIndex:(NSUInteger)arg1;
...
- (id)incidentsOffReRoutesAtIndex:(NSUInteger)arg1;
- (NSUInteger)incidentsOffReRoutesCount;
...
- (id)incidentsOnReRoutesAtIndex:(NSUInteger)arg1;
- (NSUInteger)incidentsOnReRoutesCount;
...
- (id)incidentsOnETARouteAtIndex:(NSUInteger)arg1;
- (NSUInteger)incidentsOnETARoutesCount;
...
- (id)invalidSectionZilchPointsAtIndex:(NSUInteger)arg1;
- (NSUInteger)invalidSectionZilchPointsCount;
...
- (id)reroutedRouteAtIndex:(NSUInteger)arg1;
- (NSUInteger)reroutedRoutesCount;
...
- (id)bannerTitle;
- (NSUInteger)stepIndexOfStepWithID:(unsigned int)arg1;
