...
+ (id)createRequestedComponentsForReason:(NSUInteger)arg1 traits:(id)arg2 count:(unsigned int)arg3;
...
- (id)requestedComponentAtIndex:(NSUInteger)arg1;
- (NSUInteger)requestedComponentsCount;
...
- (id)spokenLanguageAtIndex:(NSUInteger)arg1;
- (NSUInteger)spokenLanguagesCount;
...
- (id)initForWifiFingerprintLookupWithLocations:(id)arg1 wifiAccessPoints:(id)arg2 maxLabels:(unsigned int)arg3 entryTime:(NSUInteger)arg4 exitTime:(NSUInteger)arg5 traits:(id)arg6;
...
- (id)initWithTransitDeparturesAtStation:(NSUInteger)arg1 line:(NSUInteger)arg2 referenceTripId:(NSUInteger)arg3 traits:(id)arg4;
- (id)initWithTransitTripDetailsAtStation:(NSUInteger)arg1 line:(NSUInteger)arg2 referenceTripId:(NSUInteger)arg3 traits:(id)arg4;
- (id)initWithUpdatedTransitScheduleDetailsAtStation:(NSUInteger)arg1 line:(NSUInteger)arg2 referenceTripId:(NSUInteger)arg3 traits:(id)arg4;
- (id)initWithTransitScheduleAtStation:(NSUInteger)arg1 line:(NSUInteger)arg2 referenceTripId:(NSUInteger)arg3 traits:(id)arg4;
- (id)_initWithTransitScheduleRequestForStation:(NSUInteger)arg1 line:(NSUInteger)arg2 referenceTripId:(NSUInteger)arg3 traits:(id)arg4;
- (id)initWithCollectionIdentifier:(id)arg1 traits:(id)arg2;
- (id)initWithBrandMUID:(NSUInteger)arg1 traits:(id)arg2;
...
- (void)addRequestedComponentsForReason:(NSUInteger)arg1 traits:(id)arg2 count:(unsigned int)arg3;
