...
- (id)formatStyleAtIndex:(NSUInteger)arg1;
- (NSUInteger)formatStylesCount;
...
- (id)separatorAtIndex:(NSUInteger)arg1;
- (NSUInteger)separatorsCount;
...
- (id)formatArgumentAtIndex:(NSUInteger)arg1;
- (NSUInteger)formatArgumentsCount;
...
- (id)formatStringAtIndex:(NSUInteger)arg1;
- (NSUInteger)formatStringsCount;
