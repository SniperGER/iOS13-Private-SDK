...
- (void)_evict;
- (void)shrinkBySize:(NSUInteger)arg1 callback:(CDUnknownBlockType)arg2 onQueue:(id)arg3;
- (void)shrinkToSize:(NSUInteger)arg1 finished:(CDUnknownBlockType)arg2 onQueue:(id)arg3;
