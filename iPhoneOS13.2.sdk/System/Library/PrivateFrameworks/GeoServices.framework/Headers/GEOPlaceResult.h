...
- (id)description;
- (id)namedFieldAtIndex:(NSUInteger)arg1;
- (NSUInteger)namedFieldsCount;
...
- (id)matchedTokenAtIndex:(NSUInteger)arg1;
- (NSUInteger)matchedTokensCount;
...
- (id)unmatchedStringAtIndex:(NSUInteger)arg1;
- (NSUInteger)unmatchedStringsCount;
...
- (id)additionalPlaceAtIndex:(NSUInteger)arg1;
- (NSUInteger)additionalPlacesCount;
