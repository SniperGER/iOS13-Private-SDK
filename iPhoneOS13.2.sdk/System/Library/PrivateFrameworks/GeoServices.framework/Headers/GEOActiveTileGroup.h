...
- (id)muninBucketAtIndex:(NSUInteger)arg1;
- (NSUInteger)muninBucketsCount;
...
- (void)_readDataSet;
- (id)staleResourceAtIndex:(NSUInteger)arg1;
- (NSUInteger)staleResourcesCount;
...
- (void)setActiveScenarios:(int )arg1 count:(NSUInteger)arg2;
- (int)activeScenarioAtIndex:(NSUInteger)arg1;
...
- (void)setActiveScales:(int )arg1 count:(NSUInteger)arg2;
- (int)activeScaleAtIndex:(NSUInteger)arg1;
...
- (id)regionalResourceAtIndex:(NSUInteger)arg1;
- (NSUInteger)regionalResourcesCount;
...
- (id)activeResourceAtIndex:(NSUInteger)arg1;
- (NSUInteger)activeResourcesCount;
...
- (id)locationShiftEnabledRegionAtIndex:(NSUInteger)arg1;
- (NSUInteger)locationShiftEnabledRegionsCount;
...
- (id)xmlChecksumAtIndex:(NSUInteger)arg1;
- (NSUInteger)xmlChecksumsCount;
...
- (id)xmlAtIndex:(NSUInteger)arg1;
- (NSUInteger)xmlsCount;
...
- (void)_readIcons;
- (id)fontChecksumAtIndex:(NSUInteger)arg1;
- (NSUInteger)fontChecksumsCount;
...
- (NSUInteger)fontsCount;
- (void)_addNoFlagsFont:(id)arg1;
- (void)addFont:(id)arg1;
- (void)clearFonts;
@property(retain, nonatomic) NSMutableArray *fonts;
- (void)_readFonts;
- (id)textureChecksumAtIndex:(NSUInteger)arg1;
- (NSUInteger)textureChecksumsCount;
...
- (id)textureAtIndex:(NSUInteger)arg1;
...
- (void)_readTextures;
- (id)styleSheetChecksumAtIndex:(NSUInteger)arg1;
- (NSUInteger)styleSheetChecksumsCount;
...
- (id)styleSheetAtIndex:(NSUInteger)arg1;
- (NSUInteger)styleSheetsCount;
...
- (id)announcementsSupportedLanguagesAtIndex:(NSUInteger)arg1;
- (NSUInteger)announcementsSupportedLanguagesCount;
...
- (id)regionalResourceRegionAtIndex:(NSUInteger)arg1;
- (NSUInteger)regionalResourceRegionsCount;
...
- (id)regionalResourceTileAtIndex:(NSUInteger)arg1;
- (NSUInteger)regionalResourceTilesCount;
...
- (void)_readResources;
- (id)tileSetAtIndex:(NSUInteger)arg1;
- (NSUInteger)tileSetsCount;
