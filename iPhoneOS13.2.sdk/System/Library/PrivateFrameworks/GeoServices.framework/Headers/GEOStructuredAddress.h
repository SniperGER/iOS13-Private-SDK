...
- (long long)geoIdAtIndex:(NSUInteger)arg1;
...
- (id)subPremiseAtIndex:(NSUInteger)arg1;
- (NSUInteger)subPremisesCount;
...
- (id)dependentLocalityAtIndex:(NSUInteger)arg1;
- (NSUInteger)dependentLocalitysCount;
...
- (id)areaOfInterestAtIndex:(NSUInteger)arg1;
- (NSUInteger)areaOfInterestsCount;
