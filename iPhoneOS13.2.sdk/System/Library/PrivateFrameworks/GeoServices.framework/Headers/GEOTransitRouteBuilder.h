...
// - (id)_sectionForRoute:(id)arg1 pointRange:(NSRange *)arg2 stepIndex:(NSUInteger)arg3 bounds:(CDStruct_953f3dc7)arg4 currentTransitLineColor:(id)arg5 startDistance:(double)arg6;
- (double)_buildPointSectionsForRoute:(id)arg1 pointRange:(NSRange *)arg2 stepIndex:(NSUInteger)arg3 currentTransitLineColor:(id)arg4 startDistance:(double)arg5;
- (void)buildPointSectionsForRoute:(id)arg1;
- (id)_walkingStepForStepInfoIndex:(NSUInteger)arg1 route:(id)arg2 validPointRange:(NSRange *)arg3;
- (NSRange *)_validPointRangeForStepInfoIndex:(NSUInteger)arg1;
