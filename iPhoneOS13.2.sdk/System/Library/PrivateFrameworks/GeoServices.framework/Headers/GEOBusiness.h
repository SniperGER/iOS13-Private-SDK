...
- (id)description;
- (id)placeDataAmendmentAtIndex:(NSUInteger)arg1;
- (NSUInteger)placeDataAmendmentsCount;
...
- (id)starRatingAtIndex:(NSUInteger)arg1;
- (NSUInteger)starRatingsCount;
...
- (id)sourceAtIndex:(NSUInteger)arg1;
...
- (id)localizedCategoriesAtIndex:(NSUInteger)arg1;
- (NSUInteger)localizedCategoriesCount;
...
- (void)_readCenter;
- (id)openHoursAtIndex:(NSUInteger)arg1;
- (NSUInteger)openHoursCount;
- (void)_addNoFlagsOpenHours:(id)arg1;
- (void)addOpenHours:(id)arg1;
- (void)clearOpenHours;
@property(retain, nonatomic) NSMutableArray *openHours;
- (void)_readOpenHours;
- (id)attributeKeyValueAtIndex:(NSUInteger)arg1;
- (NSUInteger)attributeKeyValuesCount;
...
- (id)photoAtIndex:(NSUInteger)arg1;
...
- (void)_readCategorys;
- (id)ratingAtIndex:(NSUInteger)arg1;
...
- (id)initWithBusinessURL:(id)arg1 phoneNumber:(id)arg2 muid:(NSUInteger)arg3 attributionID:(id)arg4 sampleSizeForUserRatingScore:(unsigned int)arg5 normalizedUserRatingScore:(float)arg6;
