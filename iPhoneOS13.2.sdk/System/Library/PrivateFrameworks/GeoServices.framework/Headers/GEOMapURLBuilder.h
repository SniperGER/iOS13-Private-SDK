...
+ (id)URLForTransitLine:(NSUInteger)arg1 withName:(id)arg2 mapRegion:(id)arg3;
+ (id)URLForExternalBusiness:(id)arg1 id:(id)arg2 ofContentProvider:(id)arg3;
// + (id)URLForInternalBusiness:(id)arg1 id:(NSUInteger)arg2 provider:(int)arg3 coordinate:(CDStruct_c3b9c2ee)arg4 address:(id)arg5 extraStorage:(id)arg6 useWebPlaceCard:(BOOL)arg7 muninViewState:(id)arg8;
// + (id)URLForInternalBusiness:(id)arg1 id:(NSUInteger)arg2 provider:(int)arg3 coordinate:(CDStruct_c3b9c2ee)arg4 address:(id)arg5 extraStorage:(id)arg6 useWebPlaceCard:(BOOL)arg7;
// + (id)URLForInternalBusiness:(id)arg1 id:(NSUInteger)arg2 provider:(int)arg3 coordinate:(CDStruct_c3b9c2ee)arg4 address:(id)arg5 extraStorage:(id)arg6;
// + (id)URLForInternalBusiness:(id)arg1 id:(NSUInteger)arg2 provider:(int)arg3 coordinate:(CDStruct_c3b9c2ee)arg4 address:(id)arg5;
+ (id)URLForInternalBusiness:(id)arg1 id:(NSUInteger)arg2 provider:(int)arg3;
...
+ (id)URLForDirectionsFromHereTo:(id)arg1 label:(id)arg2 muid:(NSUInteger)arg3 provider:(int)arg4 transport:(int)arg5;
...
- (id)initForTransitLine:(NSUInteger)arg1 withName:(id)arg2 mapRegion:(id)arg3;
...
- (id)initForInternalBusiness:(id)arg1 id:(NSUInteger)arg2 provider:(int)arg3;
...
- (void)setDestinationMUID:(NSUInteger)arg1 provider:(int)arg2;
