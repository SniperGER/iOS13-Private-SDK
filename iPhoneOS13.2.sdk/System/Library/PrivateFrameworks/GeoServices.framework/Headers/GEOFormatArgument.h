...
- (id)timestampDataAtIndex:(NSUInteger)arg1;
- (NSUInteger)timestampDatasCount;
...
- (void)_readValString;
- (void)setValInt3s:(unsigned int )arg1 count:(NSUInteger)arg2;
- (unsigned int)valInt3AtIndex:(NSUInteger)arg1;
