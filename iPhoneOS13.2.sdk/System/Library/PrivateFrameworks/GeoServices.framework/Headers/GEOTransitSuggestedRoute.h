...
- (void)_readSections;
- (id)sectionOptionAtIndex:(NSUInteger)arg1;
- (NSUInteger)sectionOptionsCount;
...
- (void)setRouteBadges:(int )arg1 count:(NSUInteger)arg2;
- (int)routeBadgeAtIndex:(NSUInteger)arg1;
...
- (id)routePlanningArtworkAtIndex:(NSUInteger)arg1;
- (NSUInteger)routePlanningArtworksCount;
...
- (id)stepsAtIndex:(NSUInteger)arg1;
