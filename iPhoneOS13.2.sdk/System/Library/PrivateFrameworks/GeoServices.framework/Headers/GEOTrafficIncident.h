...
- (id)laneMessagesAtIndex:(NSUInteger)arg1;
- (NSUInteger)laneMessagesCount;
...
- (void)setAlertCCodes:(unsigned int )arg1 count:(NSUInteger)arg2;
- (unsigned int)alertCCodeAtIndex:(NSUInteger)arg1;
...
@property(readonly, nonatomic) NSUInteger alertCCodesCount;
...
@property(nonatomic) NSUInteger durationSeconds;
...
- (id)incidentDescriptionAtIndex:(NSUInteger)arg1;
- (NSUInteger)incidentDescriptionsCount;
...
- (void)setTypes:(int )arg1 count:(NSUInteger)arg2;
- (int)typeAtIndex:(NSUInteger)arg1;
- (void)_addNoFlagsType:(int)arg1;
- (void)addType:(int)arg1;
- (void)clearTypes;
@property(readonly, nonatomic) int types;
@property(readonly, nonatomic) NSUInteger typesCount;
- (void)_readTypes;
