...
- (id)description;
- (void)setGeoIds:(NSUInteger )arg1 count:(NSUInteger)arg2;
- (NSUInteger)geoIdAtIndex:(NSUInteger)arg1;
- (void)_addNoFlagsGeoId:(NSUInteger)arg1;
- (void)addGeoId:(NSUInteger)arg1;
- (void)clearGeoIds;
@property(readonly, nonatomic) NSUInteger geoIds;
