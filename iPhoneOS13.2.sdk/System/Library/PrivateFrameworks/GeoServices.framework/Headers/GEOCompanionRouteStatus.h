...
- (void)setSelectedRideIndexs:(unsigned int )arg1 count:(NSUInteger)arg2;
- (unsigned int)selectedRideIndexAtIndex:(NSUInteger)arg1;
...
- (void)updateFeedbackWithNavigationState:(int)arg1 locationUnreliable:(BOOL)arg2 announcementStage:(NSUInteger)arg3 nextAnnouncementStage:(NSUInteger)arg4 nextAnnouncementTime:(double)arg5;
