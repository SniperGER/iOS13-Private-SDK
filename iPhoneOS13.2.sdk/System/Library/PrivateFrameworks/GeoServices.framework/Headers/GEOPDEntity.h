...
- (void)setPlaceLookupCategorys:(int )arg1 count:(NSUInteger)arg2;
- (int)placeLookupCategoryAtIndex:(NSUInteger)arg1;
...
- (id)localizedCategoryAtIndex:(NSUInteger)arg1;
- (NSUInteger)localizedCategorysCount;
...
- (id)spokenNameAtIndex:(NSUInteger)arg1;
- (NSUInteger)spokenNamesCount;
...
- (id)altUrlAtIndex:(NSUInteger)arg1;
- (NSUInteger)altUrlsCount;
...
- (void)_readUrl;
- (id)altFaxAtIndex:(NSUInteger)arg1;
- (NSUInteger)altFaxsCount;
...
- (void)_readFax;
- (id)altTelephoneAtIndex:(NSUInteger)arg1;
- (NSUInteger)altTelephonesCount;
