...
- (void)setComponentTypes:(int )arg1 count:(NSUInteger)arg2;
- (int)componentTypeAtIndex:(NSUInteger)arg1;
- (void)addComponentType:(int)arg1;
- (void)clearComponentTypes;
@property(readonly, nonatomic) int componentTypes;
@property(readonly, nonatomic) NSUInteger componentTypesCount;
- (void)dealloc;
