...
// - (id)_findTransitPointWithID:(NSUInteger)arg1 near:(CDStruct_c3b9c2ee)arg2 type:(NSUInteger)arg3 pointHandler:(CDUnknownBlockType)arg4 completionHandler:(CDUnknownBlockType)arg5;
// - (id)_findTransitPointsWithin:(double)arg1 of:(CDStruct_c3b9c2ee)arg2 type:(NSUInteger)arg3 pointHandler:(CDUnknownBlockType)arg4 completionHandler:(CDUnknownBlockType)arg5;
...
// - (id)findTransitPointWithParentID:(NSUInteger)arg1 near:(CDStruct_c3b9c2ee)arg2 type:(NSUInteger)arg3 pointHandler:(CDUnknownBlockType)arg4 completionHandler:(CDUnknownBlockType)arg5;
// - (id)findTransitHallWithID:(NSUInteger)arg1 near:(CDStruct_c3b9c2ee)arg2 hallHandler:(CDUnknownBlockType)arg3 completionHandler:(CDUnknownBlockType)arg4;
// - (id)findTransitStopWithID:(NSUInteger)arg1 near:(CDStruct_c3b9c2ee)arg2 stopHandler:(CDUnknownBlockType)arg3 completionHandler:(CDUnknownBlockType)arg4;
// - (id)findTransitStationWithID:(NSUInteger)arg1 near:(CDStruct_c3b9c2ee)arg2 stationHandler:(CDUnknownBlockType)arg3 completionHandler:(CDUnknownBlockType)arg4;
// - (id)findTransitNodeWithID:(NSUInteger)arg1 near:(CDStruct_c3b9c2ee)arg2 nodeHandler:(CDUnknownBlockType)arg3 completionHandler:(CDUnknownBlockType)arg4;
// - (id)findTransitPointWithID:(NSUInteger)arg1 near:(CDStruct_c3b9c2ee)arg2 pointHandler:(CDUnknownBlockType)arg3 completionHandler:(CDUnknownBlockType)arg4;
