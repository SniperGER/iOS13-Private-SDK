...
- (id)suggestionsDisplayedresultsAtIndex:(NSUInteger)arg1;
- (NSUInteger)suggestionsDisplayedresultsCount;
...
- (id)mapsServerMetadataSuggestionEntryDisplayedAtIndex:(NSUInteger)arg1;
- (NSUInteger)mapsServerMetadataSuggestionEntryDisplayedsCount;
...
- (void)setPlaceCardUnactionableuielements:(int )arg1 count:(NSUInteger)arg2;
- (int)placeCardUnactionableuielementsAtIndex:(NSUInteger)arg1;
...
- (void)setPlaceCardPossibleactions:(int )arg1 count:(NSUInteger)arg2;
- (int)placeCardPossibleactionsAtIndex:(NSUInteger)arg1;
