...
- (void)setUiContexts:(int )arg1 count:(NSUInteger)arg2;
- (int)uiContextAtIndex:(NSUInteger)arg1;
...
- (void)setAdditionalTransportTypes:(int )arg1 count:(NSUInteger)arg2;
- (int)additionalTransportTypeAtIndex:(NSUInteger)arg1;
