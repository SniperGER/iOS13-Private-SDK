...
- (void)_readGeoIds;
- (void)setLongitudeCoordinates:(float )arg1 count:(NSUInteger)arg2;
- (float)longitudeCoordinatesAtIndex:(NSUInteger)arg1;
...
@property(readonly, nonatomic) NSUInteger longitudeCoordinatesCount;
- (void)_readLongitudeCoordinates;
- (void)setLatitudeCoordinates:(float )arg1 count:(NSUInteger)arg2;
- (float)latitudeCoordinatesAtIndex:(NSUInteger)arg1;
...
@property(readonly, nonatomic) NSUInteger latitudeCoordinatesCount;
