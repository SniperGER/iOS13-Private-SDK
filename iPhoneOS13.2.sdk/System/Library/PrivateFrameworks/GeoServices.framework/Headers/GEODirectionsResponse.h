...
- (id)suggestedRouteAtIndex:(NSUInteger)arg1;
- (NSUInteger)suggestedRoutesCount;
...
- (id)trafficCameraAtIndex:(NSUInteger)arg1;
- (NSUInteger)trafficCamerasCount;
...
- (id)serviceGapAtIndex:(NSUInteger)arg1;
- (NSUInteger)serviceGapsCount;
...
- (void)setSupportedTransportTypes:(int )arg1 count:(NSUInteger)arg2;
- (int)supportedTransportTypeAtIndex:(NSUInteger)arg1;
...
- (id)incidentsOffRoutesAtIndex:(NSUInteger)arg1;
- (NSUInteger)incidentsOffRoutesCount;
...
- (id)incidentsOnRoutesAtIndex:(NSUInteger)arg1;
- (NSUInteger)incidentsOnRoutesCount;
...
- (id)placeSearchResponseAtIndex:(NSUInteger)arg1;
- (NSUInteger)placeSearchResponsesCount;
