...
@property(readonly, nonatomic) NSUInteger lineMUID; // @synthesize lineMUID=_lineMUID;
...
@property(readonly, nonatomic) NSUInteger searchUID; // @synthesize searchUID=_searchUID;
