...
- (id)searchSubstringDescriptorAtIndex:(NSUInteger)arg1;
- (NSUInteger)searchSubstringDescriptorsCount;
...
- (id)businessCategoryFilterAtIndex:(NSUInteger)arg1;
- (NSUInteger)businessCategoryFiltersCount;
