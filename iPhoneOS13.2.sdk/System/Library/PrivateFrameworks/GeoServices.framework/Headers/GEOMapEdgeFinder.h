...
@property(copy, nonatomic) id /* block */ edgeHandler; // @synthesize edgeHandler=_edgeHandler;
- (_Bool)_checkEdgeForDuplicates:(const shared_ptr_035a2da2 *)arg1;
- (void)_buildersInTile:(id)arg1 localPoint:(const Matrix_8746f91e *)arg2 localRadiusSqr:(float)arg3 localSearch:(const Box_3fb92e00 *)arg4 handler:(id /* block */)arg5;
