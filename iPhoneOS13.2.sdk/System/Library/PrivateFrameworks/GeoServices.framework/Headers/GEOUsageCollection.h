...
//     struct GEOTileUsage _tileUsages;
    NSUInteger _tileUsagesCount;
    NSUInteger _tileUsagesSpace;
...
- (void)_readHwMachine;
// - (void)setTileUsages:(struct GEOTileUsage )arg1 count:(NSUInteger)arg2;
// - (struct GEOTileUsage)tileUsageAtIndex:(NSUInteger)arg1;
...
@property(readonly, nonatomic) NSUInteger tileUsagesCount;
