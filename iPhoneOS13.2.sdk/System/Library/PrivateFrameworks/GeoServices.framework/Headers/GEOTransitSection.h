...
- (id)description;
- (id)ticketingSegmentAtIndex:(NSUInteger)arg1;
- (NSUInteger)ticketingSegmentsCount;
...
- (void)setRouteDetailsArtworkIndexs:(unsigned int )arg1 count:(NSUInteger)arg2;
- (unsigned int)routeDetailsArtworkIndexAtIndex:(NSUInteger)arg1;
...
- (void)setActionSheetArtworkIndexs:(unsigned int )arg1 count:(NSUInteger)arg2;
- (unsigned int)actionSheetArtworkIndexAtIndex:(NSUInteger)arg1;
...
- (void)setStepIndexs:(unsigned int )arg1 count:(NSUInteger)arg2;
- (unsigned int)stepIndexAtIndex:(NSUInteger)arg1;
