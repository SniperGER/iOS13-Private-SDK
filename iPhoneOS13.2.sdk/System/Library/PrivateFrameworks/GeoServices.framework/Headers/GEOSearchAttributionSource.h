...
- (id)supportedComponentActionsAtIndex:(NSUInteger)arg1;
- (NSUInteger)supportedComponentActionsCount;
...
- (id)attributionAppsAtIndex:(NSUInteger)arg1;
- (NSUInteger)attributionAppsCount;
...
- (void)setAttributionRequirements:(int )arg1 count:(NSUInteger)arg2;
- (int)attributionRequirementsAtIndex:(NSUInteger)arg1;
...
@property(readonly, nonatomic) NSUInteger attributionRequirementsCount;
- (void)_readAttributionRequirements;
- (id)localizedAttributionAtIndex:(NSUInteger)arg1;
- (NSUInteger)localizedAttributionsCount;
