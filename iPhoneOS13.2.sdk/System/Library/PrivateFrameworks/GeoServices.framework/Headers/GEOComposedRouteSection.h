...
//     CDStruct_869f9c67 _points;
    ...
    NSUInteger _composedRouteLegIndex;
//     CDStruct_953f3dc7 _bounds;
//     CDStruct_02837cd9 _overlayBounds;
    NSUInteger _finalStepIndex;
...
@property(readonly, nonatomic) NSUInteger finalStepIndex; // @synthesize finalStepIndex=_finalStepIndex;
// @property(readonly, nonatomic) CDStruct_953f3dc7 bounds; // @synthesize bounds=_bounds;
@property(readonly, nonatomic) NSUInteger composedRouteLegIndex; // @synthesize composedRouteLegIndex=_composedRouteLegIndex;
...
- (void)dealloc;
// - (id)initWithRoute:(id)arg1 startPoint:(unsigned int)arg2 pointCount:(unsigned int)arg3 transportType:(int)arg4 finalStepIndex:(NSUInteger)arg5 fallbackStartCoordinate:(CDStruct_c3b9c2ee)arg6 fallbackEndCoordinate:(CDStruct_c3b9c2ee)arg7 startDistance:(double)arg8 lengthScaleFactor:(double)arg9;
// - (id)initWithRoute:(id)arg1 startPoint:(unsigned int)arg2 pointCount:(unsigned int)arg3 bounds:(CDStruct_953f3dc7)arg4 transportType:(int)arg5 finalStepIndex:(NSUInteger)arg6 startDistance:(double)arg7 lengthScaleFactor:(double)arg8;
