...
- (id)description;
- (id)trafficSnapshotsAtIndex:(NSUInteger)arg1;
- (NSUInteger)trafficSnapshotsCount;
...
- (id)incidentSnapshotsAtIndex:(NSUInteger)arg1;
- (NSUInteger)incidentSnapshotsCount;
...
- (id)speedSnapshotsAtIndex:(NSUInteger)arg1;
- (NSUInteger)speedSnapshotsCount;
