...
- (void)setSupportedTransitFeatures:(int )arg1 count:(NSUInteger)arg2;
- (int)supportedTransitFeatureAtIndex:(NSUInteger)arg1;
...
- (id)displayLanguagesAtIndex:(NSUInteger)arg1;
