...
- (_Bool)_updateManifestIfNecessary:(id /* block */)arg1;
- (id)_manifestURL;
...
- (void)_changeActiveTileGroup:(id)arg1 activeScales:(id)arg2 activeScenarios:(id)arg3 dataSet:(id)arg4 migrationTasks:(id)arg5 flushTileCache:(_Bool)arg6 completionHandler:(id /* block */)arg7;
