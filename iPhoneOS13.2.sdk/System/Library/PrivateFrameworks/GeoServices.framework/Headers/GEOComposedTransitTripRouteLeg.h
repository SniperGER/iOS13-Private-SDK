...
- (BOOL)_needsStepData;
- (void)_cacheStepData;
- (id)initWithComposedRoute:(id)arg1 decoderData:(id)arg2 tripIndex:(NSUInteger)arg3 stepRange:(NSRange *)arg4 transitStepRange:(NSRange *)arg5 pointRange:(NSRange *)arg6;
