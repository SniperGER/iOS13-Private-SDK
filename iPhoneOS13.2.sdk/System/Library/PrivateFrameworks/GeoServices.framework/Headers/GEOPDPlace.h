...
- (void)enumerateComponentValuesOfType:(int)arg1 enumerationOptions:(NSUInteger)arg2 usingBlock:(CDUnknownBlockType)arg3;
...
- (void)enumerateComponentOfType:(int)arg1 enumerationOptions:(NSUInteger)arg2 usingBlock:(CDUnknownBlockType)arg3;
- (void)enumerateValidComponentsWithValuesUsingBlock:(CDUnknownBlockType)arg1;
- (void)enumerateComponentsWithOptions:(NSUInteger)arg1 usingBlock:(CDUnknownBlockType)arg2;
