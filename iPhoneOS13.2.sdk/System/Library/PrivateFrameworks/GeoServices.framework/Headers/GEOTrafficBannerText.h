...
- (id)localizedIncidentSpokenTextAtIndex:(NSUInteger)arg1;
- (NSUInteger)localizedIncidentSpokenTextsCount;
...
- (id)localizedIncidentSubBannerAtIndex:(NSUInteger)arg1;
- (NSUInteger)localizedIncidentSubBannersCount;
...
- (id)localizedIncidentBannerAtIndex:(NSUInteger)arg1;
- (NSUInteger)localizedIncidentBannersCount;
