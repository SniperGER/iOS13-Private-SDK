...
//     struct GEOSessionID _shortSessionID;
    ...
    NSUInteger _shortSessionMachTimeBasis;
...
// - (void)_overrideShortSessionId:(struct GEOSessionID)arg1 sessionMachBasisTime:(NSUInteger)arg2 sessionStartTime:(double)arg3;
