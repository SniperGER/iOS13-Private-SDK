...
- (id)businessChatPreflightIdentifierAtIndex:(NSUInteger)arg1;
- (NSUInteger)businessChatPreflightIdentifiersCount;
...
- (void)setKnownClientResolvedTypeDeprecateds:(int )arg1 count:(NSUInteger)arg2;
- (int)knownClientResolvedTypeDeprecatedAtIndex:(NSUInteger)arg1;
