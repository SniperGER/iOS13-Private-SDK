...
- (void)setSupportedAutocompleteResultCellTypes:(int )arg1 count:(NSUInteger)arg2;
- (int)supportedAutocompleteResultCellTypeAtIndex:(NSUInteger)arg1;
...
- (void)setSupportedAutocompleteListTypes:(int )arg1 count:(NSUInteger)arg2;
- (int)supportedAutocompleteListTypeAtIndex:(NSUInteger)arg1;
...
- (void)setKnownClientResolvedTypes:(int )arg1 count:(NSUInteger)arg2;
- (int)knownClientResolvedTypeAtIndex:(NSUInteger)arg1;
...
- (void)setEngineTypes:(int )arg1 count:(NSUInteger)arg2;
- (int)engineTypeAtIndex:(NSUInteger)arg1;
...
- (id)historicalLocationsAtIndex:(NSUInteger)arg1;
- (NSUInteger)historicalLocationsCount;
...
- (id)reviewUserPhotoSizesAtIndex:(NSUInteger)arg1;
- (NSUInteger)reviewUserPhotoSizesCount;
...
- (id)photoSizesAtIndex:(NSUInteger)arg1;
- (NSUInteger)photoSizesCount;
...
- (id)deviceDisplayLanguageAtIndex:(NSUInteger)arg1;
- (NSUInteger)deviceDisplayLanguagesCount;
...
- (void)setTransportTypes:(int )arg1 count:(NSUInteger)arg2;
- (int)transportTypeAtIndex:(NSUInteger)arg1;
