...
@property(copy, nonatomic) id /* block */ tileHandler; // @synthesize tileHandler=_tileHandler;
...
- (void)findTilesAdjacentToTile:(const struct _GEOTileKey *)arg1 containingPoint:(const Matrix_8746f91e *)arg2 tileHandler:(id /* block */)arg3;
- (void)findTiles:(id /* block */)arg1 excludingKey:(const struct _GEOTileKey *)arg2;
