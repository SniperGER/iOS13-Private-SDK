...
- (void)setUnactionableUiElements:(int )arg1 count:(NSUInteger)arg2;
- (int)unactionableUiElementAtIndex:(NSUInteger)arg1;
...
- (void)setPossibleActions:(int )arg1 count:(NSUInteger)arg2;
- (int)possibleActionAtIndex:(NSUInteger)arg1;
