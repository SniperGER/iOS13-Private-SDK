...
- (void)getStaleTileKeysUsedSince:(double)arg1 fromTileSets:(id)arg2 maxCount:(NSUInteger)arg3 maxTotalSize:(NSUInteger)arg4 queue:(id)arg5 callback:(CDUnknownBlockType)arg6;
...
- (void)shrinkBySize:(NSUInteger)arg1 queue:(id)arg2 callback:(CDUnknownBlockType)arg3;
- (void)shrinkToSize:(NSUInteger)arg1 queue:(id)arg2 finished:(CDUnknownBlockType)arg3;
