...
- (void)enumerateAllKeysIncludingData:(_Bool)arg1 onQueue:(id)arg2 group:(id)arg3 dataHandler:(id /* block */)arg4;
- (void)_enumerateAllKeysOnQueueIncludingData:(_Bool)arg1 dataHandler:(id /* block */)arg2 callbackQueue:(id)arg3;
...
- (void)getLastAccessTimestampForKey:(const struct _GEOTileKey *)arg1 callbackQueue:(id)arg2 callback:(id /* block */)arg3;
...
- (_Bool)_dataForKeyOnDBQueue:(const struct _GEOTileKey *)arg1 reason:(unsigned char)arg2 callbackQueue:(id)arg3 dataHandler:(id /* block */)arg4;
