...
- (void)_cacheKeysForHash:(NSUInteger)arg1 withHandler:(CDUnknownBlockType)arg2;
- (void)_cacheEntriesForHash:(NSUInteger)arg1 withHandler:(CDUnknownBlockType)arg2;
