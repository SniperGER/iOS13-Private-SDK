...
@property(readonly, nonatomic) NSRange * maneuverPointRange; // @synthesize maneuverPointRange=_maneuverPointRange;
...
- (id)initWithComposedRoute:(id)arg1 GEOStep:(id)arg2 routeLegType:(long long)arg3 stepIndex:(NSUInteger)arg4 pointRange:(NSRange *)arg5 maneuverPointRange:(NSRange *)arg6;
- (id)initWithComposedRoute:(id)arg1 routeLegType:(long long)arg2 stepIndex:(NSUInteger)arg3 pointRange:(NSRange *)arg4;
