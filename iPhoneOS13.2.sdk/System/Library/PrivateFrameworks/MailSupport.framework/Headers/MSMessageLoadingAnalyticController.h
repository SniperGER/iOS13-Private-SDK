...
@property(copy, nonatomic) id /* block */ endedRecordingHandler; // @synthesize endedRecordingHandler=_endedRecordingHandler;
@property(copy, nonatomic) id /* block */ startedRecordingHandler; // @synthesize startedRecordingHandler=_startedRecordingHandler;
