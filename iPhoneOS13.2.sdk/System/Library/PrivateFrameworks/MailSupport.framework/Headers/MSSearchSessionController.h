...
{
    int _emailProvider;
    NSUInteger _numberOfMessagesLeftToIndex;
...
@property(readonly, nonatomic) NSUInteger percentOfMessagesIndexed; // @synthesize percentOfMessagesIndexed=_percentOfMessagesIndexed;
@property(readonly, nonatomic) NSUInteger numberOfMessagesLeftToIndex; // @synthesize numberOfMessagesLeftToIndex=_numberOfMessagesLeftToIndex;
// - (void).cxx_destruct;
...
- (void)updateLastEngagementSearchResultCount:(NSUInteger)arg1;
