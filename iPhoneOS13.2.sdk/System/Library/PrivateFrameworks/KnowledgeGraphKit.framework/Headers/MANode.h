...
- (void)_enumerateEdgesOfType:(NSUInteger)arg1 usingBlock:(CDUnknownBlockType)arg2;
...
- (void)enumerateEdgesOfType:(NSUInteger)arg1 usingBlock:(CDUnknownBlockType)arg2;
