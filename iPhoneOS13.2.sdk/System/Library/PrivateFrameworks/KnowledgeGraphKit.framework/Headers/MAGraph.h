...
- (id)addUniqueNodeWithLabel:(id)arg1 domain:(unsigned short)arg2 weight:(float)arg3 properties:(id)arg4 identifyingPropertyKeys:(id)arg5 didCreate:(_Bool *)arg6;
...
- (_Bool)hasFullElementCache;
- (_Bool)hasPartialElementCache;
- (_Bool)hasAnyElementCache;
...
- (void)breadthFirstSearchFromNode:(id)arg1 directed:(_Bool)arg2 usingBlock:(id /* block */)arg3;
- (void)depthFirstSearchFromNode:(id)arg1 directed:(_Bool)arg2 usingBlock:(id /* block */)arg3;
