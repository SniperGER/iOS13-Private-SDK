...
+ (long long)formattingContextFromIUDisplayNameContext:(NSUInteger)arg1;
...
+ (int)UDisplayContextForIUDisplayNameContext:(NSUInteger)arg1;
...
// - (void).cxx_destruct;
- (id)displayNameForRegion:(id)arg1 displayLanguage:(id)arg2 capitalization:(NSUInteger)arg3 short:(BOOL)arg4;
- (id)displayNameForRegion:(id)arg1 displayLanguage:(id)arg2 capitalization:(NSUInteger)arg3;
- (id)displayNameForNormalizedLanguage:(id)arg1 context:(NSUInteger)arg2 displayLanguage:(id)arg3;
- (id)displayNameForLanguage:(id)arg1 context:(NSUInteger)arg2 displayLanguage:(id)arg3;
- (id)localizedLanguageForLanguage:(id)arg1;
- (id)localizedNameForScript:(short)arg1;
- (BOOL)canRenderLanguage:(id)arg1;
- (id)displayNameForLocale:(id)arg1 displayLanguage:(id)arg2 capitalization:(NSUInteger)arg3 short:(BOOL)arg4;
//  (id)ICUdisplayNameForLanguage:(id)arg1 capitalization:(struct ULocaleDisplayNames )arg2;
- (id)displayNameForDialect:(id)arg1 context:(NSUInteger)arg2 displayLanguage:(id)arg3;
- (id)languageList;
