...
@interface IDSSimulatorLocalPairingState : NSObject
{
    ...
    id /* block */ _didSwitchActivePairedDeviceCallback;
...
@property(copy, nonatomic) id /* block */ didSwitchActivePairedDeviceCallback; // @synthesize didSwitchActivePairedDeviceCallback=_didSwitchActivePairedDeviceCallback;
