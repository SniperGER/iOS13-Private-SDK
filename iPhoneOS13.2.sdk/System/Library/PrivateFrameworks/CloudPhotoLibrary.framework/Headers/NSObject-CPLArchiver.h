...
- (_Bool)cplProperties:(id)arg1 areEqualToPropertiesOf:(id)arg2 withEqualityBlock:(id /* block */)arg3;
- (_Bool)cplProperties:(id)arg1 areEqualToPropertiesOf:(id)arg2 differingProperty:(id *)arg3 withEqualityBlock:(id /* block */)arg4;
- (_Bool)cplIsEqual:(id)arg1 withEqualityBlock:(id /* block */)arg2;
