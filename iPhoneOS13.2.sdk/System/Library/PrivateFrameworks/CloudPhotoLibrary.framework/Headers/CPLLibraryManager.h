...
- (void)resetCacheWithOption:(NSUInteger)arg1 reason:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;
- (void)resetCacheWithOption:(NSUInteger)arg1 completionHandler:(CDUnknownBlockType)arg2;
...
- (void)getStreamingURLForResource:(id)arg1 intent:(NSUInteger)arg2 hints:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;
