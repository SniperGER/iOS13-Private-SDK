...
- (_Bool)openWithRecoveryHandler:(id /* block */)arg1 error:(id *)arg2;
- (_Bool)_recoverFromCrashWithRecoveryHandler:(id /* block */)arg1 error:(id *)arg2;
- (_Bool)doWrite:(id /* block */)arg1 error:(id *)arg2;
