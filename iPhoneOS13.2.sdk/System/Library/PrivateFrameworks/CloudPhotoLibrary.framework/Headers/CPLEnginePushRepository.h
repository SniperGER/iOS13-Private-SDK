...
@class CPLBatchExtractionStrategy, NSDate, NSMutableDictionary, NSObject, NSString;
...
- (void)updateTimingStatisticForKey:(id)arg1 duration:(double)arg2 recordCount:(NSUInteger)arg3 error:(BOOL)arg4 cancelled:(BOOL)arg5;
...
- (id)allChangesWithClass:(Class)arg1 scopeIdentifier:(id)arg2 changeType:(NSUInteger)arg3;
- (NSUInteger)effectiveResourceSizeToUploadForUploadIdentifier:(id)arg1;
...
- (NSUInteger)countOfChangesInScopeWithIdentifier:(id)arg1;
