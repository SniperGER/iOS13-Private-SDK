...
- (id)fetchScopeListChangesForScopeListSyncAnchor:(struct NSData *)arg1 progressHandler:(id /* block */)arg2 completionHandler:(id /* block */)arg3;
- (id)downloadBatchTaskForSyncAnchor:(struct NSData *)arg1 transportScope:(id)arg2 scope:(id)arg3 currentLibraryInfo:(id)arg4 progressHandler:(id /* block */)arg5 completionHandler:(id /* block */)arg6;
...
- (id)setupTaskUpdateDisabledFeatures:(_Bool)arg1 completionHandler:(id /* block */)arg2;
