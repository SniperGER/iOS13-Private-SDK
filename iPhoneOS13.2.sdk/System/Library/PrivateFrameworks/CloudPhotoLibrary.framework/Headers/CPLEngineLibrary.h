...
- (void)_performBlockWithLibrary:(_Bool)arg1 enumerateAttachedObjects:(id /* block */)arg2;
...
- (void)_closeNextComponent:(id)arg1 deactivate:(_Bool)arg2 lastError:(id)arg3 completionHandler:(id /* block */)arg4;
