...
@interface CPLPushSessionTracker : NSObject
{
    ...
    NSUInteger _ignoredRecordCount;
    NSDate *_now;
}
...
@property(readonly, nonatomic) NSUInteger ignoredRecordCount; // @synthesize ignoredRecordCount=_ignoredRecordCount;
...
- (id)_realChangeFromChange:(id)arg1 comparedToStoredRecord:(id)arg2 changeType:(NSUInteger)arg3;
