...
@interface CPLAssetChange : CPLItemChange
{
    ...
    NSUInteger _videoComplementVisibilityState;
    NSUInteger _assetSubtype;
    NSUInteger _assetHDRType;
    CPLAdjustments *_adjustments;
    NSUInteger _originalChoice;
...
@property(nonatomic) NSUInteger originalChoice; // @synthesize originalChoice=_originalChoice;
@property(retain, nonatomic) CPLAdjustments *adjustments; // @synthesize adjustments=_adjustments;
@property(nonatomic) NSUInteger assetHDRType; // @synthesize assetHDRType=_assetHDRType;
@property(nonatomic) NSUInteger assetSubtype; // @synthesize assetSubtype=_assetSubtype;
@property(nonatomic) NSUInteger videoComplementVisibilityState; // @synthesize videoComplementVisibilityState=_videoComplementVisibilityState;
...
@property(nonatomic) NSUInteger burstFlags; // @synthesize burstFlags=_burstFlags;
