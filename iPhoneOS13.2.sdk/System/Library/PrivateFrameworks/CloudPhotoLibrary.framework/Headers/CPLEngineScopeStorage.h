...
@class NSMutableSet, _CPLEngineScopeCache;
...
- (BOOL)upgradeScopesWithNewLibraryOption:(NSUInteger)arg1 error:(id )arg2;
- (NSUInteger)estimatedAssetCountForScope:(id)arg1;
- (NSUInteger)estimatedSizeForScope:(id)arg1;
- (BOOL)storeEstimatedSize:(NSUInteger)arg1 estimatedAssetCount:(NSUInteger)arg2 forScope:(id)arg3 error:(id )arg4;
- (BOOL)supportedFeatureVersionIsMostRecentForScope:(id)arg1;
- (BOOL)storeSupportedFeatureVersionInLastSync:(NSUInteger)arg1 forScope:(id)arg2 error:(id )arg3;
- (NSUInteger)supportedFeatureVersionInLastSyncForScope:(id)arg1;
...
- (NSUInteger)_indexOfCurrentClassForInitialQueriesForScope:(id)arg1;
...
- (BOOL)updateInitialSyncTransportGroupEstimatedSize:(NSUInteger)arg1 assetCount:(NSUInteger)arg2 forScope:(id)arg3 error:(id )arg4;
...
- (id)scopeChangesNeedingToBePulledByClientWithMaximumCount:(NSUInteger)arg1;
