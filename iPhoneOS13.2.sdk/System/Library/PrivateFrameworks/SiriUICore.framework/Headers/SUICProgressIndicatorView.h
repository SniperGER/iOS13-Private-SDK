...
- (void)setDarkened:(_Bool)arg1 animated:(_Bool)arg2 completion:(id /* block */)arg3;
@property(nonatomic, getter=isDarkened) _Bool darkened;
- (void)setCheckmarkVisible:(_Bool)arg1 animated:(_Bool)arg2 completion:(id /* block */)arg3;
@property(nonatomic, getter=isCheckmarkVisible) _Bool checkmarkVisible;
@property(nonatomic, getter=isSpinning) _Bool spinning;
- (void)setArrowVisible:(_Bool)arg1 delay:(double)arg2 animated:(_Bool)arg3 completion:(id /* block */)arg4;
@property(nonatomic, getter=isArrowVisible) _Bool arrowVisible;
- (void)setProgressValue:(double)arg1 animated:(_Bool)arg2 completion:(id /* block */)arg3;
