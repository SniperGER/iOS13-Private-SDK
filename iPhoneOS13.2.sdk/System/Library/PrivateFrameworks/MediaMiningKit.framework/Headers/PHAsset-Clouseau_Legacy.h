...
+ (void)prefetchOnAssets:(id)arg1 options:(NSUInteger)arg2;
+ (id)clsAllAssetsFromFetchResult:(id)arg1 prefetchOptions:(NSUInteger)arg2;
...
+ (NSUInteger)clsPrefetchOptionsForIsUtility;
...
+ (BOOL)isJunkWithJunkIdentifier:(unsigned int)arg1 confidence:(double)arg2 isReliable:(BOOL )arg3;
- (CGImageRef)createThumbnailWithResolution:(NSUInteger)arg1 fillMode:(BOOL)arg2 networkAllowed:(BOOL)arg3;
...
- (void)clsSetNumberOfFaces:(NSUInteger)arg1 numberOfFacesOfVerifiedPersons:(NSUInteger)arg2 numberOfGoodFaces:(NSUInteger)arg3 numberOfGoodFacesOfVerifiedPersons:(NSUInteger)arg4 averageFaceQuality:(double)arg5 averageFaceQualityOfVerifiedPersons:(double)arg6;
