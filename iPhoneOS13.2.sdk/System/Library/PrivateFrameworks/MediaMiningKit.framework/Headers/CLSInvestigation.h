...
- (id)_traceStringForType:(NSUInteger)arg1;
- (void)addTraceFromObject:(id)arg1 feature:(id)arg2 type:(NSUInteger)arg3 context:(id)arg4 withDescriptionFormat:(id)arg5;
- (id)itemThumbnailAtIndex:(NSUInteger)arg1 withResolution:(NSUInteger)arg2;
- (id)sampleOfItems;
