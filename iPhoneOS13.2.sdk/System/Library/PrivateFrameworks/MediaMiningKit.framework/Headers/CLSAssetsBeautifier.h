...
- (id)_clustersBySplittingZeroDiameterClustersInClusters:(id)arg1 targetingNumberOfClusters:(NSUInteger)arg2;
...
- (id)performWithItems:(id)arg1 maximumNumberOfItemsToChoose:(NSUInteger)arg2 debugInfo:(id)arg3 progressBlock:(CDUnknownBlockType)arg4;
- (id)performWithItems:(id)arg1 maximumNumberOfItemsToChoose:(NSUInteger)arg2 progressBlock:(CDUnknownBlockType)arg3;
- (id)sampledItemsInSortedItems:(id)arg1 maximumNumberOfItemsToChoose:(NSUInteger)arg2 debugInfo:(id)arg3 progressBlock:(CDUnknownBlockType)arg4;
- (id)init;
