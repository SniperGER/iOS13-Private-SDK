...
- (id)description;
- (void)sanitize;
- (void)enumerateAddressesOfType:(NSUInteger)arg1 asPlacemarkWithBlock:(CDUnknownBlockType)arg2;
- (void)enumerateAddressesOfType:(NSUInteger)arg1 asCLLocationsWithBlock:(CDUnknownBlockType)arg2;
