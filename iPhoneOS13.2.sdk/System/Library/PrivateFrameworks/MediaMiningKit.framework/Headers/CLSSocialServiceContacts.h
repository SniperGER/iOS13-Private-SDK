...
@class CLSContactCache, CLSPerson, CNContact, CNContactStore, NSMutableArray, NSMutableDictionary, NSMutableSet;
...
- (NSUInteger)_ageCategoryFromFaceAgeType:(unsigned short)arg1;
- (NSUInteger)_genderFromFaceGender:(unsigned short)arg1;
...
- (id)_allPersons;
- (NSUInteger)_relationshipForContact:(id)arg1;
...
- (id)initWithProxyAtURL:(id)arg1 andIntent:(NSUInteger)arg2;
