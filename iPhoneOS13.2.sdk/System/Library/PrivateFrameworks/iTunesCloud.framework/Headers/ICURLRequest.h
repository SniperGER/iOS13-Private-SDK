...
@property(nonatomic) NSUInteger redirectCount; // @synthesize redirectCount=_redirectCount;
...
@property(nonatomic) NSUInteger maxRetryCount; // @synthesize maxRetryCount=_maxRetryCount;
