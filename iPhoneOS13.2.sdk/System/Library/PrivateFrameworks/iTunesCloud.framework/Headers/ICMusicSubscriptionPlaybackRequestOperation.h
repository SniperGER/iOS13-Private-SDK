...
@interface ICMusicSubscriptionPlaybackRequestOperation : ICAsyncOperation
{
    ...
    id /* CDUnknownBlockType */ _willBeginExecutionHandler;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ willBeginExecutionHandler; // @synthesize willBeginExecutionHandler=_willBeginExecutionHandler;
