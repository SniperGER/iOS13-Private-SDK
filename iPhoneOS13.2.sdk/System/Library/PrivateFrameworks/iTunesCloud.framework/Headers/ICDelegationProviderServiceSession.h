...
@class ICDelegationProviderNetService, ICDelegationProviderServiceProtocolHandler, ICDelegationServiceConnection, ICRequestContext, ICUserIdentityStore, NSArray, NSMutableDictionary;
