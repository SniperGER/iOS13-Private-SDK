...
- (void)_updateShouldDownloadResources:(_Bool)arg1 onMessageWithIdentifier:(id)arg2 bundleIdentifier:(id)arg3 completion:(id /* block */)arg4;
...
- (void)reportEventForMessageIdentifier:(id)arg1 withParams:(id)arg2 flushImmediately:(_Bool)arg3 completion:(id /* block */)arg4;
