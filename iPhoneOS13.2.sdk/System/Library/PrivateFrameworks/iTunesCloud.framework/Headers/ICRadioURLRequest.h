...
@interface ICRadioURLRequest : ICStoreURLRequest
{
    ...
    id /* CDUnknownBlockType */ _radioContentDictionaryCreationBlock;
}

@property(copy, nonatomic) id /* CDUnknownBlockType */ radioContentDictionaryCreationBlock; // @synthesize radioContentDictionaryCreationBlock=_radioContentDictionaryCreationBlock;
