...
- (void)_deauthenticateAndDisableActiveLockerAccountWithCompletionHandler:(id /* block */)arg1;
...
- (void)_enableCloudLibraryWithPolicy:(long long)arg1 startinitialImport:(_Bool)arg2 isExplicitUserAction:(_Bool)arg3 completionHandler:(id /* block */)arg4;
- (void)enableCloudLibraryWithPolicy:(long long)arg1 startInitialImport:(_Bool)arg2 completionHandler:(id /* block */)arg3;
