...
@property(copy, nonatomic) id /* block */ extractValuesBlock; // @synthesize extractValuesBlock=_extractValuesBlock;
@property(copy, nonatomic) id /* block */ loadDataBlock; // @synthesize loadDataBlock=_loadDataBlock;
