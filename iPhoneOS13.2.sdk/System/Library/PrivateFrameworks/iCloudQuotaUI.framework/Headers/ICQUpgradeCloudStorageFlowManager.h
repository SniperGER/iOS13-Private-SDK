...
@property(copy, nonatomic) id /* block */ purchaseCompletionHandler; // @synthesize purchaseCompletionHandler=_purchaseCompletionHandler;
...
- (void)_buyProductShouldUseToken:(_Bool)arg1 completionHandler:(id /* block */)arg2;
