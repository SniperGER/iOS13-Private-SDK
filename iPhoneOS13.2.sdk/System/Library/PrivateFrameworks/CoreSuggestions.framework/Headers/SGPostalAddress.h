...
+ (id)postalAddress:(id)arg1 components:(id)arg2 label:(id)arg3 extractionType:(NSUInteger)arg4 recordId:(id)arg5;
+ (id)postalAddress:(id)arg1 components:(id)arg2 label:(id)arg3 extractionType:(NSUInteger)arg4 recordId:(id)arg5 origin:(id)arg6;
