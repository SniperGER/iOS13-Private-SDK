...
- (void)fullDownloadRequestBatch:(NSUInteger)arg1 withCompletion:(CDUnknownBlockType)arg2;
- (id)fullDownloadRequestBatch:(NSUInteger)arg1 error:(id )arg2;
- (void)updateMessages:(id)arg1 state:(NSUInteger)arg2 withCompletion:(CDUnknownBlockType)arg3;
- (BOOL)updateMessages:(id)arg1 state:(NSUInteger)arg2 error:(id )arg3;
...
- (void)namesForDetail:(id)arg1 limitTo:(NSUInteger)arg2 prependMaybe:(BOOL)arg3 onlySignificant:(BOOL)arg4 withCompletion:(CDUnknownBlockType)arg5;
- (id)namesForDetail:(id)arg1 limitTo:(NSUInteger)arg2 prependMaybe:(BOOL)arg3 onlySignificant:(BOOL)arg4 error:(id )arg5;
- (void)namesForDetail:(id)arg1 limitTo:(NSUInteger)arg2 prependMaybe:(BOOL)arg3 withCompletion:(CDUnknownBlockType)arg4;
- (id)namesForDetail:(id)arg1 limitTo:(NSUInteger)arg2 prependMaybe:(BOOL)arg3 error:(id )arg4;
...
- (void)harvestedSuggestionsFromSearchableItem:(id)arg1 options:(NSUInteger)arg2 withCompletion:(CDUnknownBlockType)arg3;
- (id)harvestedSuggestionsFromSearchableItem:(id)arg1 options:(NSUInteger)arg2 error:(id )arg3;
- (void)suggestionsFromSearchableItem:(id)arg1 options:(NSUInteger)arg2 withCompletion:(CDUnknownBlockType)arg3;
- (id)suggestionsFromSearchableItem:(id)arg1 options:(NSUInteger)arg2 error:(id )arg3;
- (void)suggestionsFromEmailContent:(id)arg1 headers:(id)arg2 source:(id)arg3 options:(NSUInteger)arg4 withCompletion:(CDUnknownBlockType)arg5;
- (id)suggestionsFromEmailContent:(id)arg1 headers:(id)arg2 source:(id)arg3 options:(NSUInteger)arg4 error:(id )arg5;
...
- (void)allRemindersLimitedTo:(NSUInteger)arg1 withCompletion:(CDUnknownBlockType)arg2;
- (id)allRemindersLimitedTo:(NSUInteger)arg1 error:(id )arg2;
...
- (void)allEventsLimitedTo:(NSUInteger)arg1 withCompletion:(CDUnknownBlockType)arg2;
- (id)allEventsLimitedTo:(NSUInteger)arg1 error:(id )arg2;
- (void)suggestEventsInFutureLimitTo:(NSUInteger)arg1 withCompletion:(CDUnknownBlockType)arg2;
- (id)suggestEventsInFutureLimitTo:(NSUInteger)arg1 error:(id )arg2;
- (void)suggestEventsStartingAt:(id)arg1 endingAt:(id)arg2 prefix:(id)arg3 limitTo:(NSUInteger)arg4 withCompletion:(CDUnknownBlockType)arg5;
- (id)suggestEventsStartingAt:(id)arg1 endingAt:(id)arg2 prefix:(id)arg3 limitTo:(NSUInteger)arg4 error:(id )arg5;
- (void)suggestEventsStartingAt:(id)arg1 endingAt:(id)arg2 limitTo:(NSUInteger)arg3 withCompletion:(CDUnknownBlockType)arg4;
- (id)suggestEventsStartingAt:(id)arg1 endingAt:(id)arg2 limitTo:(NSUInteger)arg3 error:(id )arg4;
- (void)suggestEventsInFutureLimitTo:(NSUInteger)arg1 options:(unsigned int)arg2 withCompletion:(CDUnknownBlockType)arg3;
- (id)suggestEventsInFutureLimitTo:(NSUInteger)arg1 options:(unsigned int)arg2 error:(id )arg3;
- (void)suggestEventsStartingAt:(id)arg1 endingAt:(id)arg2 prefix:(id)arg3 limitTo:(NSUInteger)arg4 options:(unsigned int)arg5 withCompletion:(CDUnknownBlockType)arg6;
- (id)suggestEventsStartingAt:(id)arg1 endingAt:(id)arg2 prefix:(id)arg3 limitTo:(NSUInteger)arg4 options:(unsigned int)arg5 error:(id )arg6;
- (void)suggestEventsStartingAt:(id)arg1 endingAt:(id)arg2 limitTo:(NSUInteger)arg3 options:(unsigned int)arg4 withCompletion:(CDUnknownBlockType)arg5;
- (id)suggestEventsStartingAt:(id)arg1 endingAt:(id)arg2 limitTo:(NSUInteger)arg3 options:(unsigned int)arg4 error:(id )arg5;
...
- (void)allContactsLimitedTo:(NSUInteger)arg1 withCompletion:(CDUnknownBlockType)arg2;
- (id)allContactsLimitedTo:(NSUInteger)arg1 error:(id )arg2;
- (void)suggestContactMatchesWithMessagingPrefix:(id)arg1 limitTo:(NSUInteger)arg2 withCompletion:(CDUnknownBlockType)arg3;
- (id)suggestContactMatchesWithMessagingPrefix:(id)arg1 limitTo:(NSUInteger)arg2 error:(id )arg3;
- (void)suggestContactMatchesWithFullTextSearch:(id)arg1 limitTo:(NSUInteger)arg2 withCompletion:(CDUnknownBlockType)arg3;
- (id)suggestContactMatchesWithFullTextSearch:(id)arg1 limitTo:(NSUInteger)arg2 error:(id )arg3;
- (void)contactMatchesWithContactIdentifiers:(id)arg1 limitTo:(NSUInteger)arg2 withCompletion:(CDUnknownBlockType)arg3;
- (id)contactMatchesWithContactIdentifiers:(id)arg1 limitTo:(NSUInteger)arg2 error:(id )arg3;
- (void)contactMatchesWithContactIdentifier:(id)arg1 limitTo:(NSUInteger)arg2 withCompletion:(CDUnknownBlockType)arg3;
- (id)contactMatchesWithContactIdentifier:(id)arg1 limitTo:(NSUInteger)arg2 error:(id )arg3;
- (void)contactMatchesWithContact:(id)arg1 limitTo:(NSUInteger)arg2 withCompletion:(CDUnknownBlockType)arg3;
- (id)contactMatchesWithContact:(id)arg1 limitTo:(NSUInteger)arg2 error:(id )arg3;
- (void)suggestionsFromRFC822Data:(id)arg1 source:(id)arg2 options:(NSUInteger)arg3 withCompletion:(CDUnknownBlockType)arg4;
- (id)suggestionsFromRFC822Data:(id)arg1 source:(id)arg2 options:(NSUInteger)arg3 error:(id )arg4;
