...
- (void)suggestionsFromEmailContent:(NSString *)arg1 headers:(NSData *)arg2 source:(NSString *)arg3 options:(NSUInteger)arg4 withCompletion:(void (^)(NSArray *, NSError *))arg5;
...
- (void)suggestionsFromRFC822Data:(NSData *)arg1 source:(NSString *)arg2 options:(NSUInteger)arg3 withCompletion:(void (^)(NSArray *, NSError *))arg4;
- (NSArray *)suggestionsFromRFC822Data:(NSData *)arg1 source:(NSString *)arg2 options:(NSUInteger)arg3 error:(id )arg4;
...
- (void)suggestEventsInFutureLimitTo:(NSUInteger)arg1 withCompletion:(void (^)(NSArray *, NSError *))arg2;
- (void)suggestEventsInFutureLimitTo:(NSUInteger)arg1 options:(unsigned int)arg2 withCompletion:(void (^)(NSArray *, NSError *))arg3;
- (void)suggestEventsStartingAt:(NSDate *)arg1 endingAt:(NSDate *)arg2 prefix:(NSString *)arg3 limitTo:(NSUInteger)arg4 withCompletion:(void (^)(NSArray *, NSError *))arg5;
- (void)suggestEventsStartingAt:(NSDate *)arg1 endingAt:(NSDate *)arg2 limitTo:(NSUInteger)arg3 withCompletion:(void (^)(NSArray *, NSError *))arg4;
- (void)suggestEventsStartingAt:(NSDate *)arg1 endingAt:(NSDate *)arg2 prefix:(NSString *)arg3 limitTo:(NSUInteger)arg4 options:(unsigned int)arg5 withCompletion:(void (^)(NSArray *, NSError *))arg6;
- (void)suggestEventsStartingAt:(NSDate *)arg1 endingAt:(NSDate *)arg2 limitTo:(NSUInteger)arg3 options:(unsigned int)arg4 withCompletion:(void (^)(NSArray *, NSError *))arg5;
