...
@interface SGEvent : SGObject <SGEventForGeocode>
{
    ...
    NSUInteger _naturalLanguageEventAttributes;
    NSArray *_schemaOrg;
}
...
@property(readonly, nonatomic) NSUInteger naturalLanguageEventAttributes; // @synthesize naturalLanguageEventAttributes=_naturalLanguageEventAttributes;
...
- (id)firstLocationForType:(NSUInteger)arg1;
...
- (id)initWithRecordId:(id)arg1 origin:(id)arg2 uniqueKey:(id)arg3 opaqueKey:(id)arg4 title:(id)arg5 notes:(id)arg6 start:(id)arg7 startTimeZone:(id)arg8 end:(id)arg9 endTimeZone:(id)arg10 isAllDay:(BOOL)arg11 creationDate:(id)arg12 lastModifiedDate:(id)arg13 locations:(id)arg14 tagStrings:(id)arg15 URL:(id)arg16 naturalLanguageEventIdentifier:(id)arg17 naturalLanguageEventAttributes:(NSUInteger)arg18 schemaOrg:(id)arg19;
