...
@property(readonly, nonatomic) NSUInteger locationType; // @synthesize locationType=_locationType;
// - (void).cxx_destruct;
...
- (id)initWithId:(id)arg1 origin:(id)arg2 type:(NSUInteger)arg3 label:(id)arg4 address:(id)arg5 airportCode:(id)arg6 latitude:(double)arg7 longitude:(double)arg8 accuracy:(double)arg9 quality:(double)arg10 handle:(id)arg11;
- (id)initWithLocation:(id)arg1 latitude:(double)arg2 longitude:(double)arg3 accuracy:(double)arg4 handle:(id)arg5;
- (id)initWithId:(id)arg1 origin:(id)arg2 type:(NSUInteger)arg3 label:(id)arg4 airportCode:(id)arg5 latitude:(double)arg6 longitude:(double)arg7 accuracy:(double)arg8 quality:(double)arg9;
- (id)initWithId:(id)arg1 origin:(id)arg2 type:(NSUInteger)arg3 label:(id)arg4 address:(id)arg5 airportCode:(id)arg6 accuracy:(double)arg7 quality:(double)arg8;
