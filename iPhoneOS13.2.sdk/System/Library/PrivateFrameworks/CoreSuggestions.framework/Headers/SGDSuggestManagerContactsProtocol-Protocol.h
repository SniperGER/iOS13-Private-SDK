...
- (void)allContactsLimitedTo:(NSUInteger)arg1 withCompletion:(void (^)(SGXPCResponse1 *))arg2;
...
- (void)namesForDetail:(NSString *)arg1 limitTo:(NSUInteger)arg2 prependMaybe:(BOOL)arg3 onlySignificant:(BOOL)arg4 withCompletion:(void (^)(SGXPCResponse1 *))arg5;
...
- (void)contactMatchesWithMessagingPrefix:(NSString *)arg1 limitTo:(NSUInteger)arg2 withCompletion:(void (^)(SGXPCResponse1 *))arg3;
- (void)contactMatchesWithFullTextSearch:(NSString *)arg1 limitTo:(NSUInteger)arg2 withCompletion:(void (^)(SGXPCResponse1 *))arg3;
- (void)emailAddressIsSignificant:(NSString *)arg1 withCompletion:(void (^)(SGXPCResponse1 *))arg2;
- (void)contactMatchesWithContactIdentifiers:(NSArray *)arg1 limitTo:(NSUInteger)arg2 withCompletion:(void (^)(SGXPCResponse1 *))arg3;
- (void)contactMatchesWithContactIdentifier:(NSString *)arg1 limitTo:(NSUInteger)arg2 withCompletion:(void (^)(SGXPCResponse1 *))arg3;
- (void)contactMatchesWithContact:(CNContact *)arg1 limitTo:(NSUInteger)arg2 withCompletion:(void (^)(SGXPCResponse1 *))arg3;
@end
