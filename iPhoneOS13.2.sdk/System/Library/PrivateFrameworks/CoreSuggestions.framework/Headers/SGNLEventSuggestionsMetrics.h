...
+ (void)recordUserInteraction:(NSUInteger)arg1 withLinkInApplication:(long long)arg2 eventPrefillMode:(NSUInteger)arg3 eventTypeClassification:(id)arg4 proposedEvent:(id)arg5 confirmedEvent:(id)arg6;
