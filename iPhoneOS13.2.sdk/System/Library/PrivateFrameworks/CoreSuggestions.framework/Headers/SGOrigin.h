...
+ (id)originWithType:(NSUInteger)arg1 sourceKey:(id)arg2 externalKey:(id)arg3 fromForwardedMessage:(BOOL)arg4;
+ (id)originWithType:(NSUInteger)arg1 sourceKey:(id)arg2 externalKey:(id)arg3 bundleId:(id)arg4 fromForwardedMessage:(BOOL)arg5;
...
// - (void).cxx_destruct;
@property(readonly, nonatomic) NSRange * contextSnippetRange;
...
- (id)initWithType:(NSUInteger)arg1 sourceKey:(id)arg2 externalKey:(id)arg3 bundleId:(id)arg4 fromForwardedMessage:(BOOL)arg5;
- (id)init;
