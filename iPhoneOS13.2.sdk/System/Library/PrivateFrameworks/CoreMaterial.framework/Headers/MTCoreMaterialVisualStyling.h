...
- (void)_getFilterType:(id )arg1 vibrantColor:(CGColorRef)arg2 tintColor:(CGColorRef)arg3 inputReversed:(BOOL )arg4;
- (void)_getCompositingFilter:(id )arg1 tintColor:(CGColorRef)arg2;
