...
@interface MTMaterialLayer : CABackdropLayer
{
    ...
    BOOL _blurEnabled;
    BOOL _zoomEnabled;
    id /* CDUnknownBlockType */ _backdropScaleAdjustment;
    id /* CDUnknownBlockType */ _defaultBackdropScaleAdjustment;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ defaultBackdropScaleAdjustment; // @synthesize defaultBackdropScaleAdjustment=_defaultBackdropScaleAdjustment;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ blurRadiusTransformer;
