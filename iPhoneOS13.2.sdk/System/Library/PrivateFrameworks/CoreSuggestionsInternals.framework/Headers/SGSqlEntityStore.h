...
+ (CDUnknownBlockType)binderForCNContactMatch:(id)arg1 floorEntityID:(long long)arg2 max:(NSUInteger)arg3;
...
// - (id)suggestEventsStartingAt:(struct SGUnixTimestamp_)arg1 endingAt:(struct SGUnixTimestamp_)arg2 limitTo:(NSUInteger)arg3 additionalWhereClause:(id)arg4 options:(unsigned int)arg5 onPrep:(CDUnknownBlockType)arg6;
...
- (id)suggestContactsByMasterEntityQuery:(id)arg1 limit:(NSUInteger)arg2 bindings:(CDUnknownBlockType)arg3;
...
// - (void)pruneEntitiesOlderThan:(struct SGUnixTimestamp_)arg1 suspensionHandler:(CDUnknownBlockType)arg2 batchSize:(NSUInteger)arg3;
...
- (id)loadContactDetailsWithWhereClause:(id)arg1 onPrep:(CDUnknownBlockType)arg2 type:(NSUInteger)arg3 dedupeAgainst:(id)arg4;
...
- (void)reindexSearchableItemsWithMinimumEntityId:(NSUInteger)arg1 searchableIndex:(id)arg2 acknowledgementHandler:(CDUnknownBlockType)arg3 reindexCount:(int)arg4;
