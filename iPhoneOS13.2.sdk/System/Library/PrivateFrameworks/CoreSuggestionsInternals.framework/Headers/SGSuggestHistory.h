...
- (_Bool)isValidNewReminder:(id)arg1;
...
- (id)hashesForCuratedContactDetail:(id)arg1 fromContact:(id)arg2 forMatching:(_Bool)arg3;
- (id)hashesForContactDetail:(id)arg1 fromContact:(id)arg2 forMatching:(_Bool)arg3;
- (id)hashesForStorageContact:(id)arg1 forMatching:(_Bool)arg2;
- (id)hashesForContact:(id)arg1 forMatching:(_Bool)arg2;
- (id)hashesForStrings:(id)arg1 forMatching:(_Bool)arg2;
- (id)modernHashesForClassicHashes:(id)arg1 forMatching:(_Bool)arg2;
- (id)_canaryHash;
