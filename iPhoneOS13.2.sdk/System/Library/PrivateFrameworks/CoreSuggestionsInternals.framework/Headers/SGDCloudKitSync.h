...
- (id)addWriteOperationForRecordGetter:(CDUnknownBlockType)arg1 deleteGetter:(CDUnknownBlockType)arg2 withRetries:(NSUInteger)arg3 isFirstTry:(BOOL)arg4;
- (id)addWriteOperationForRecordGetter:(CDUnknownBlockType)arg1 deleteGetter:(CDUnknownBlockType)arg2 withRetries:(NSUInteger)arg3;
