...
- (void)suggestionsFromEmailContent:(NSString *)arg1 headers:(NSData *)arg2 source:(NSString *)arg3 options:(NSUInteger)arg4 withCompletion:(void (^)(SGXPCResponse1 *))arg5;
...
- (void)suggestionsFromRFC822Data:(NSData *)arg1 source:(NSString *)arg2 options:(NSUInteger)arg3 withCompletion:(void (^)(SGXPCResponse1 *))arg4;
...
- (void)eventsInFutureLimitTo:(NSUInteger)arg1 options:(unsigned int)arg2 withCompletion:(void (^)(SGXPCResponse1 *))arg3;
- (void)eventsStartingAt:(NSDate *)arg1 endingAt:(NSDate *)arg2 prefix:(NSString *)arg3 limitTo:(NSUInteger)arg4 options:(unsigned int)arg5 withCompletion:(void (^)(SGXPCResponse1 *))arg6;
- (void)eventsStartingAt:(NSDate *)arg1 endingAt:(NSDate *)arg2 limitTo:(NSUInteger)arg3 options:(unsigned int)arg4 withCompletion:(void (^)(SGXPCResponse1 *))arg5;
