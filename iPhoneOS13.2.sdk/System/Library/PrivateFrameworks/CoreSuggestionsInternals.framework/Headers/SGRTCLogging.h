...
+ (NSUInteger)launchCountForApp:(id)arg1 afterDate:(id)arg2 lowerBucket:(NSUInteger)arg3 bucketSize:(NSUInteger)arg4 bucketLimit:(NSUInteger)arg5;
+ (NSUInteger)numberOfDaysBetweenDate:(id)arg1 andDate:(id)arg2;
+ (double)round:(double)arg1 toSignificantFigures:(long long)arg2;
+ (NSUInteger)bucketizeInteger:(NSUInteger)arg1 withBucketSize:(NSUInteger)arg2 limit:(NSUInteger)arg3;
...
- (void)logEventExtractionForTemplateName:(id)arg1 extractionStatus:(unsigned short)arg2 outputExceptions:(id)arg3 outputInfos:(id)arg4 jsMessageLogs:(id)arg5 jsOutputLogs:(id)arg6 timingProcessing:(NSUInteger)arg7;
- (id)_eventExtractionDictionaryLogForTemplateName:(id)arg1 extractionStatus:(unsigned short)arg2 outputExceptions:(id)arg3 outputInfos:(id)arg4 jsMessageLogs:(id)arg5 jsOutputLogs:(id)arg6 timingProcessing:(NSUInteger)arg7;
