...
@property(readonly, nonatomic) NSRange * valueRange; // @synthesize valueRange=_valueRange;
@property(readonly, nonatomic) NSRange * labelRange; // @synthesize labelRange=_labelRange;
...
- (id)description;
- (id)initWithDetectedDate:(id)arg1 detectedTimeZone:(id)arg2 matchType:(unsigned int)arg3 range:(NSRange *)arg4 labelRange:(NSRange *)arg5 labelString:(id)arg6 valueRange:(NSRange *)arg7 valueString:(id)arg8 allDay:(BOOL)arg9;
...
- (id)initWithMatchType:(unsigned int)arg1 range:(NSRange *)arg2 labelRange:(NSRange *)arg3 labelString:(id)arg4 valueRange:(NSRange *)arg5 valueString:(id)arg6;
