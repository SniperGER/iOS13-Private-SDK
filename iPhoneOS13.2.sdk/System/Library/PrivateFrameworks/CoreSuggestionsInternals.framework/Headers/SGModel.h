...
+ (id)trainingFeaturesOf:(id)arg1 inLanguage:(id)arg2 withObjective:(NSUInteger)arg3;
+ (id)trainingFeaturesOf:(id)arg1 inLanguage:(id)arg2;
+ (Class)modelClassForObjective:(NSUInteger)arg1;
+ (id)transformerInstanceForLanguage:(id)arg1 withObjective:(NSUInteger)arg2;
