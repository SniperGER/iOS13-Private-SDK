...
- (id)outputFromPackedJSEntity:(id)arg1 documentType:(NSUInteger)arg2 isDownloaded:(BOOL)arg3 forEntity:(id)arg4;
- (void)addEnrichmentsToEntityForOutputItems:(id)arg1 exceptions:(id)arg2 jsMessageLogs:(id)arg3 entity:(id)arg4 startTime:(NSUInteger)arg5;
- (void)dissectInternal:(id)arg1 inContext:(id)arg2;
- (id)eventsFromSchemaOrgItems:(id)arg1;
- (id)outputFromSchemaOrgPackedEntityItems:(id)arg1;
- (BOOL)exceedsMaxHTMLContentLength:(NSUInteger)arg1;
