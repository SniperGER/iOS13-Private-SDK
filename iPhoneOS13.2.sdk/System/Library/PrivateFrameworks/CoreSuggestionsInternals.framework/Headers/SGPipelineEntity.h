...
@property(readonly, nonatomic) NSUInteger htmlOffsets; // @synthesize htmlOffsets=_htmlOffsets;
...
@property(nonatomic) NSRange * plainTextSigRange; // @synthesize plainTextSigRange=_plainTextSigRange;
...
- (void)chopOffContentAfterIndex:(NSUInteger)arg1;
- (void)chopOffContentBeforeIndex:(NSUInteger)arg1;
...
- (id)contactDetailsWithType:(NSUInteger)arg1;
...
- (void)dealloc;
- (id)initWithContactDetailWithKey:(id)arg1 type:(NSUInteger)arg2 extractionInfo:(id)arg3 curated:(BOOL)arg4 parent:(id)arg5 value:(id)arg6 context:(id)arg7 contextRangeOfInterest:(NSRange *)arg8;
