...
- (void)updateMessages:(id)arg1 state:(NSUInteger)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)_suggestionsFromSearchableItem:(id)arg1 options:(NSUInteger)arg2 dissectIfNecessary:(BOOL)arg3 withCompletion:(CDUnknownBlockType)arg4;
- (void)harvestedSuggestionsFromMessage:(id)arg1 bundleIdentifier:(id)arg2 options:(NSUInteger)arg3 completionHandler:(CDUnknownBlockType)arg4;
- (void)harvestedSuggestionsFromMessages:(id)arg1 bundleIdentifier:(id)arg2 options:(NSUInteger)arg3 completionHandler:(CDUnknownBlockType)arg4;
- (id)filterRealtimeEvents:(id)arg1;
- (void)suggestionsFromMessage:(id)arg1 options:(NSUInteger)arg2 fullCompletionHandler:(CDUnknownBlockType)arg3;
- (void)suggestionsFromMessage:(id)arg1 options:(NSUInteger)arg2 completionHandler:(CDUnknownBlockType)arg3;
- (void)suggestionsFromMessage:(id)arg1 options:(NSUInteger)arg2 completionDelivery:(NSUInteger)arg3 completionHandler:(CDUnknownBlockType)arg4 fullCompletionHandler:(CDUnknownBlockType)arg5;
- (void)_sendChatChangedNotificationWithDomainIdentifier:(id)arg1;
- (void)_suggestionsFromMessage:(id)arg1 options:(NSUInteger)arg2 dissectIfNecessary:(BOOL)arg3 completionDelivery:(NSUInteger)arg4 completionHandler:(CDUnknownBlockType)arg5;
...
- (void)_suggestionsFromMessageWithIdentifier:(id)arg1 source:(id)arg2 options:(NSUInteger)arg3 completion:(CDUnknownBlockType)arg4 completionDelivery:(NSUInteger)arg5 providedBy:(CDUnknownBlockType)arg6 dissectIfNecessary:(BOOL)arg7;
...
- (void)eventsInFutureLimitTo:(NSUInteger)arg1 options:(unsigned int)arg2 withCompletion:(CDUnknownBlockType)arg3;
- (void)eventsStartingAt:(id)arg1 endingAt:(id)arg2 prefix:(id)arg3 limitTo:(NSUInteger)arg4 options:(unsigned int)arg5 withCompletion:(CDUnknownBlockType)arg6;
- (void)eventFromRecordId:(id)arg1 withCompletion:(CDUnknownBlockType)arg2;
- (void)eventsStartingAt:(id)arg1 endingAt:(id)arg2 limitTo:(NSUInteger)arg3 options:(unsigned int)arg4 withCompletion:(CDUnknownBlockType)arg5;
- (id)_mapToPseudoEvents:(id)arg1;
- (void)allContactsLimitedTo:(NSUInteger)arg1 withCompletion:(CDUnknownBlockType)arg2;
- (void)contactMatchesWithMessagingPrefix:(id)arg1 limitTo:(NSUInteger)arg2 withCompletion:(CDUnknownBlockType)arg3;
- (void)contactMatchesWithFullTextSearch:(id)arg1 limitTo:(NSUInteger)arg2 withCompletion:(CDUnknownBlockType)arg3;
