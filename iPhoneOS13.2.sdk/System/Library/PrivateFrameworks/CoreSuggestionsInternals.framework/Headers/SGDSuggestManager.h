...
- (void)_performAction:(id)arg1 onRecord:(id)arg2 completion:(id /* block */)arg3 withParentConfirmation:(_Bool)arg4;
...
- (void)launchInfoForSuggestedEventWithUniqueIdentifier:(id)arg1 sourceURL:(id)arg2 clientLocale:(id)arg3 ignoreUserActivitySupport:(_Bool)arg4 completion:(id /* block */)arg5;
...
- (void)namesForDetail:(id)arg1 limitTo:(unsigned long long)arg2 prependMaybe:(_Bool)arg3 onlySignificant:(_Bool)arg4 withCompletion:(id /* block */)arg5;
...
- (void)_suggestionsFromSearchableItem:(id)arg1 options:(unsigned long long)arg2 dissectIfNecessary:(_Bool)arg3 withCompletion:(id /* block */)arg4;
...
- (void)_suggestionsFromMessage:(id)arg1 options:(unsigned long long)arg2 dissectIfNecessary:(_Bool)arg3 completionDelivery:(unsigned long long)arg4 completionHandler:(id /* block */)arg5;
...
- (void)_suggestionsFromMessageWithIdentifier:(id)arg1 source:(id)arg2 options:(unsigned long long)arg3 completion:(id /* block */)arg4 completionDelivery:(unsigned long long)arg5 providedBy:(id /* block */)arg6 dissectIfNecessary:(_Bool)arg7;
...
- (void)clearCachesFully:(_Bool)arg1 withCompletion:(id /* block */)arg2;
