...
// + (void)_recordExtractionOutcome:(struct SGMContactDetailExtractionOutcome_)arg1 detailType:(struct SGMContactDetailType_)arg2 fromEntity:(id)arg3 foundInSignature:(BOOL)arg4 detailType:(NSUInteger)arg5 detailValue:(id)arg6 modelVersion:(id)arg7 isUnlikelyPhone:(BOOL)arg8;
