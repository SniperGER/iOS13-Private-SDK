...
+ (void)animateWithSettings:(id)arg1 options:(NSUInteger)arg2 actions:(CDUnknownBlockType)arg3 completion:(CDUnknownBlockType)arg4;
+ (void)animateWithSettings:(id)arg1 options:(NSUInteger)arg2 actions:(CDUnknownBlockType)arg3;
...
+ (void)animateWithFactory:(id)arg1 additionalDelay:(double)arg2 options:(NSUInteger)arg3 actions:(CDUnknownBlockType)arg4 completion:(CDUnknownBlockType)arg5;
+ (void)animateWithFactory:(id)arg1 additionalDelay:(double)arg2 options:(NSUInteger)arg3 actions:(CDUnknownBlockType)arg4;
...
+ (void)animateWithFactory:(id)arg1 options:(NSUInteger)arg2 actions:(CDUnknownBlockType)arg3 completion:(CDUnknownBlockType)arg4;
+ (void)animateWithFactory:(id)arg1 options:(NSUInteger)arg2 actions:(CDUnknownBlockType)arg3;
