...
- (_Bool)bs_removeChildViewController:(id)arg1 animated:(_Bool)arg2 transitionBlock:(id /* block */)arg3;
- (_Bool)bs_removeChildViewController:(id)arg1;
- (_Bool)bs_addChildViewController:(id)arg1 withSuperview:(id)arg2 animated:(_Bool)arg3 transitionBlock:(id /* block */)arg4;
- (_Bool)bs_addChildViewController:(id)arg1 withSuperview:(id)arg2;
- (_Bool)bs_addChildViewController:(id)arg1 animated:(_Bool)arg2 transitionBlock:(id /* block */)arg3;
