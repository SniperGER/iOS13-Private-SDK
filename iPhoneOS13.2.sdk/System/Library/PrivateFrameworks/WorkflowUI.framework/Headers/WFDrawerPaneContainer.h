...
- (void)transitionToVisibility:(NSUInteger)arg1 withDimming:(NSUInteger)arg2 animated:(BOOL)arg3 interruptible:(BOOL)arg4 completion:(CDUnknownBlockType)arg5;
- (void)transitionWithPushedAnimationToVisibility:(NSUInteger)arg1 withDimming:(NSUInteger)arg2 animated:(BOOL)arg3 interruptible:(BOOL)arg4 completion:(CDUnknownBlockType)arg5;
