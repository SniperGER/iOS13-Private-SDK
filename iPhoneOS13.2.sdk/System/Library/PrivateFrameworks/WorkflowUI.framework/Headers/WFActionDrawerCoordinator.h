...
@class NSHashTable, UINavigationController, UIViewController, WFActionDrawerAppsViewController, WFActionDrawerResults, WFActionDrawerResultsController, WFActionDrawerSiriSuggestionsViewController, WFActionDrawerState, WFActionDrawerViewController, WFComposeViewController, WFDrawerController, WFWorkflow;
...
- (id)presentDescriptionForAction:(id)arg1 fromViewController:(id)arg2 view:(id)arg3 arrowDirections:(NSUInteger)arg4 animated:(BOOL)arg5;
- (void)presentResultsViewController:(id)arg1 visibility:(NSUInteger)arg2 animated:(BOOL)arg3;
- (id)presentResultsViewControllerWithTitle:(id)arg1 results:(id)arg2 visibility:(NSUInteger)arg3 animated:(BOOL)arg4;
