...
+ (id)newWithAttributes:(const struct WFTagFieldAttributes *)arg1 updateBlock:(id /* block */)arg2 variableBlock:(id /* block */)arg3 navigationContext:(id)arg4 size:(const struct CKComponentSize *)arg5;
