...
@property(copy, nonatomic) id /* block */ collectionSupplementaryConfigureBlock; // @synthesize collectionSupplementaryConfigureBlock=_collectionSupplementaryConfigureBlock;
@property(copy, nonatomic) id /* block */ collectionSupplementaryCreationBlock; // @synthesize collectionSupplementaryCreationBlock=_collectionSupplementaryCreationBlock;
...
@property(copy, nonatomic) id /* block */ tableMoveBlock; // @synthesize tableMoveBlock=_tableMoveBlock;
@property(copy, nonatomic) id /* block */ tableDeletionBlock; // @synthesize tableDeletionBlock=_tableDeletionBlock;
@property(copy, nonatomic) id /* block */ tableActionBlock; // @synthesize tableActionBlock=_tableActionBlock;
@property(nonatomic) long long rowAnimation; // @synthesize rowAnimation=_rowAnimation;
@property(nonatomic) __weak UITableView *tableView; // @synthesize tableView=_tableView;
@property(retain, nonatomic) UIView *emptyView; // @synthesize emptyView=_emptyView;
@property(copy, nonatomic) id /* block */ cellCreationBlock; // @synthesize cellCreationBlock=_cellCreationBlock;
