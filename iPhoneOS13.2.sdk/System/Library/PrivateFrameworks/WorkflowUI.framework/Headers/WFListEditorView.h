...
- (void)configureCell:(id)arg1 atIndex:(NSUInteger)arg2;
- (void)configureCell:(id)arg1 withItem:(id)arg2 atIndex:(NSUInteger)arg3;
- (void)insertNewItemOfType:(long long)arg1;
- (void)updateCells;
- (void)beginEditingWithContext:(id)arg1;
- (void)appendNewItem;
- (void)deleteItemAtIndex:(NSUInteger)arg1;
- (void)movedItemAtIndex:(NSUInteger)arg1 toIndex:(NSUInteger)arg2;
- (void)insertItem:(id)arg1 atIndex:(NSUInteger)arg2;
- (void)updatedItem:(id)arg1 atIndex:(NSUInteger)arg2;
