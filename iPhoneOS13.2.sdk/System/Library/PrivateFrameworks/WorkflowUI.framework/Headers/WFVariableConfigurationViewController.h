...
@class NSArray, NSOrderedSet, UITableView, WFCoercionVariableAggrandizement, WFDateFormatVariableAggrandizement, WFDictionaryValueVariableAggrandizement, WFPropertyVariableAggrandizement, WFUnitVariableAggrandizement, WFVariable, WFVariableConfigurationHeaderView, WFVariableConfigurationInfoView;
...
+ (id)defaultPropertyForContentClass:(Class)arg1 resultType:(NSUInteger)arg2;
