...
@class CLLocation, CLLocationManager, HULocationTriggerEditorMapDragRadiusView, MKLocalSearch, MKMapView, NSArray, NSIndexPath, NSLayoutConstraint, UISearchBar, UITableView, UIView, WFLocationValue;
...
@interface WFLocationPickerViewController : UIViewController <UISearchBarDelegate, UITableViewDelegate, UITableViewDataSource, MKMapViewDelegate, MKMapViewDelegatePrivate, HULocationTriggerEditorMapDragRadiusViewDelegate, CLLocationManagerDelegate>
{
    ...
    NSUInteger _pickerType;
    WFLocationValue *_value;
    NSUInteger _regionCondition;
...
@property(nonatomic) NSUInteger regionCondition; // @synthesize regionCondition=_regionCondition;
...
@property(readonly, nonatomic) NSUInteger pickerType; // @synthesize pickerType=_pickerType;
...
- (void)loadView;
- (id)initWithPickerType:(NSUInteger)arg1 value:(id)arg2;
