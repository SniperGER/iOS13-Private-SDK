...
- (void)enumerateEnclosingRectsForGlyphRange:(struct _NSRange)arg1 insetForBackground:(_Bool)arg2 usingBlock:(id /* block */)arg3;
- (void)enumerateInsetEnclosingRectsForGlyphRange:(struct _NSRange)arg1 usingBlock:(id /* block */)arg2;
- (void)enumerateEnclosingRectsForSlot:(id)arg1 includeInsideSpacing:(_Bool)arg2 insetForBackground:(_Bool)arg3 usingBlock:(id /* block */)arg4;
