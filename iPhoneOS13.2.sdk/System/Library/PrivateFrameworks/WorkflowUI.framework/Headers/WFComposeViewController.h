...
- (void)popEditingState:(NSUInteger)arg1 animated:(BOOL)arg2 completionHandler:(CDUnknownBlockType)arg3;
- (void)pushEditingState:(NSUInteger)arg1 animated:(BOOL)arg2 completionHandler:(CDUnknownBlockType)arg3;
