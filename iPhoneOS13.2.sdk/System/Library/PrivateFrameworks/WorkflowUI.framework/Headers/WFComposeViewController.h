...
- (void)workflowViewControllerDidRun:(id)arg1 withOutput:(id)arg2 error:(id)arg3 cancelled:(_Bool)arg4 continueHandler:(id /* block */)arg5;
...
- (void)setActionsHidden:(_Bool)arg1 animated:(_Bool)arg2 completionHandler:(id /* block */)arg3;
...
- (void)setEditingState:(unsigned long long)arg1 animated:(_Bool)arg2 completionHandler:(id /* block */)arg3;
- (void)updateEditingStateAnimated:(_Bool)arg1 completionHandler:(id /* block */)arg2;
- (void)popEditingState:(unsigned long long)arg1 animated:(_Bool)arg2 completionHandler:(id /* block */)arg3;
- (void)pushEditingState:(unsigned long long)arg1 animated:(_Bool)arg2 completionHandler:(id /* block */)arg3;
...
- (void)finishEditingAndDismissForTutorial:(_Bool)arg1 completionHandler:(id /* block */)arg2;
- (void)finishEditing;
- (void)beginEditing;
- (void)didTapDone;
- (void)didTapNext;
