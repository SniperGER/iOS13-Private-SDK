...
@property(copy, nonatomic) id /* block */ actionOutputCompletionHandler; // @synthesize actionOutputCompletionHandler=_actionOutputCompletionHandler;
...
@property(nonatomic) _Bool alwaysBounceCollectionViewVertically; // @synthesize alwaysBounceCollectionViewVertically=_alwaysBounceCollectionViewVertically;
