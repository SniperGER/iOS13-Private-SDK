...
+ (id)newWithKeyValuePairs:(id)arg1 variableProvider:(id)arg2 variableUIDelegate:(id)arg3 navigationContext:(id)arg4 localizedNewItemTypeName:(id)arg5 variablesDisabled:(_Bool)arg6 allowedValueTypes:(id)arg7 allowedVariableTypes:(id)arg8 editable:(_Bool)arg9 updateBlock:(id /* block */)arg10 size:(const struct CKComponentSize *)arg11;
