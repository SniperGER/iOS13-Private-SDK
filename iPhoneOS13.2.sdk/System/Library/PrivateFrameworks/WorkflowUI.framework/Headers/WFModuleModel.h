...
@property(readonly, nonatomic) NSUInteger runningActionIndex; // @synthesize runningActionIndex=_runningActionIndex;
...
@property(readonly, nonatomic) NSUInteger parameterCollapsingBehavior; // @synthesize parameterCollapsingBehavior=_parameterCollapsingBehavior;
...
@property(readonly, nonatomic) NSUInteger indentationLevel; // @synthesize indentationLevel=_indentationLevel;
...
@property(readonly, nonatomic) NSUInteger headerTextStyle; // @synthesize headerTextStyle=_headerTextStyle;
