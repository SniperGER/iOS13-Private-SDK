...
@property(copy, nonatomic) id /* block */ endRevealScrolledAwayHandler; // @synthesize endRevealScrolledAwayHandler=_endRevealScrolledAwayHandler;
@property(copy, nonatomic) id /* block */ endRevealGoBackHandler; // @synthesize endRevealGoBackHandler=_endRevealGoBackHandler;
...
- (_Bool)dragController:(id)arg1 shouldAcceptViewWithCompletion:(id /* block */)arg2;
...
- (void)updateEmptyStateViewVisibilityAnimated:(_Bool)arg1 completionHandler:(id /* block */)arg2;
