...
+ (id)newWithLabel:(id)arg1 labelsToAlignTo:(id)arg2 parameter:(id)arg3 variable:(id)arg4 updateBlock:(id /* block */)arg5 options:(struct WFParameterComponentOptions)arg6 chooserCanClear:(_Bool)arg7 variableProvider:(id)arg8 variableUIDelegate:(id)arg9 navigationContext:(id)arg10 controlResistance:(const struct WFCompressionResistance *)arg11 controlComponent:(id)arg12;
