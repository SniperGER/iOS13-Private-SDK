...
+ (id)newWithAttributes:(const struct WFDatePickerAttributes *)arg1 updateBlock:(id /* block */)arg2 variableBlock:(id /* block */)arg3 size:(const struct CKComponentSize *)arg4;
