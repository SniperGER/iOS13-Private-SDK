...
- (void)cancel;
- (void)finish;
- (void)buildViewControllerForHomeTriggerChooserStepWithBackButtonAction:(NSUInteger)arg1 hostingViewController:(id)arg2 completion:(CDUnknownBlockType)arg3;
- (void)buildViewControllerForPersonalTriggerChooserStepWithBackButtonAction:(NSUInteger)arg1 completion:(CDUnknownBlockType)arg2;
- (void)buildViewControllerForAutomationTypeChooserStepWithCompletion:(CDUnknownBlockType)arg1;
- (void)startAtStep:(NSUInteger)arg1 hostingViewController:(id)arg2 completion:(CDUnknownBlockType)arg3;
