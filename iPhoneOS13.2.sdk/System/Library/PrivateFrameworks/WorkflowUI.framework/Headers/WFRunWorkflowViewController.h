...
@property(copy, nonatomic) id /* block */ prepareToRunCompletion; // @synthesize prepareToRunCompletion=_prepareToRunCompletion;
...
@property(copy, nonatomic) id /* block */ parameterInputHandler; // @synthesize parameterInputHandler=_parameterInputHandler;
...
- (_Bool)workflowController:(id)arg1 handleUnsupportedUserInterfaceForAction:(id)arg2 currentState:(id)arg3 completionHandler:(id /* block */)arg4;
- (_Bool)workflowController:(id)arg1 handleUnsupportedEnvironmentForAction:(id)arg2 currentState:(id)arg3 completionHandler:(id /* block */)arg4;
