...
@class NSIndexPath, WFAction, WFContentCollection, WFDatabase, WFModulesQuickLookView, WFRunWorkflowFooterView, WFRunWorkflowToolbar, WFWorkflow, WFWorkflowController, WFWorkflowRunEvent, WFWorkflowViewController;
...
@interface WFRunWorkflowViewController : UIViewController <WFModuleModelProvider, WFWorkflowControllerDelegate, WFParameterInputViewControllerDelegate, WFActionParameterInputProvider, WFModulesSupplementaryViewDataSource, WFModulesQuickLookViewDelegate, QLPreviewControllerDelegate, UIScrollViewDelegate, UIDropInteractionDelegate, WFRunWorkflowFooterViewDelegate, WFRunWorkflowToolbarDelegate>
{
    ...
    id /* CDUnknownBlockType */ _prepareToRunCompletion;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ prepareToRunCompletion; // @synthesize prepareToRunCompletion=_prepareToRunCompletion;
...
@property(readonly, nonatomic) NSUInteger editingState; // @synthesize editingState=_editingState;
