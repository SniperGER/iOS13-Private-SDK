...
+ (id)newWithAttributes:(const struct WFTextInputAttributes *)arg1 updateBlock:(id /* block */)arg2 beginAction:(CKTypedComponentAction_789af415)arg3 doneAction:(CKTypedComponentAction_789af415)arg4 size:(const struct CKComponentSize *)arg5;
