...
@class NSArray, UIView, WFCreateAutomationCoordinator, WFDatabase, WFDatabaseResult, WFEditAutomationCoordinator, WFHomeManager, WFTriggerManager;
...
- (void)startCreateNewAutomationFlowAtStep:(NSUInteger)arg1;
