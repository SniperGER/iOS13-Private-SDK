...
//  (id)newWithState:(id)arg1 rowIndex:(NSUInteger)arg2 updateBlock:(CDUnknownBlockType)arg3 deleteAction:(CKTypedComponentAction_0d80aa58)arg4 tappedAction:(CKTypedComponentAction_789af415)arg5 options:(struct WFRowTemplateParameterComponentOptions)arg6 style:(const struct WFWrappingStackLayoutComponentStyle )arg7 size:(const struct CKComponentSize )arg8 variableProvider:(id)arg9 variableUIDelegate:(id)arg10 navigationContext:(id)arg11;
+ (id)numberFormatter;
+ (id)itemFont;
- (id).cxx_construct;
// - (void).cxx_destruct;
