...
- (void)retriveAssetForFeature:(long long)arg1 language:(id)arg2 useWorldwide:(_Bool)arg3 completion:(id /* block */)arg4;
...
- (void)retrieveMovieForFeature:(long long)arg1 language:(id)arg2 useWorldwide:(_Bool)arg3 completion:(id /* block */)arg4;
