...
@interface EMFEmojiPreferences : NSObject <EMFEmojiPreferenceActions>
{
    ...
    NSUInteger _maximumRecentsCount;
}
...
+ (id)_cacheDomain;
+ (id)defaultsDomain;
@property(nonatomic) NSUInteger maximumRecentsCount; // @synthesize maximumRecentsCount=_maximumRecentsCount;
// - (void).cxx_destruct;
- (id)typingNameForEmoji:(id)arg1;
- (NSUInteger)previouslyUsedIndexInCategory:(id)arg1;
