...
- (void)enumerateCoordinatesInChartRect:(CGRect)arg1 xAxis:(id)arg2 zoomScale:(double)arg3 contentOffset:(CGPoint)arg4 xAxisTransform:(CGAffineTransform)arg5 roundToViewScale:(BOOL)arg6 exclusionOptions:(long long)arg7 block:(CDUnknownBlockType)arg8;
...
- (void)autoscaleYAxisWithYAxisRange:(id)arg1 chartRect:(CGRect)arg2 animated:(BOOL)arg3 completion:(CDUnknownBlockType)arg4;
- (void)autoscaleYAxisWithValueRange:(id)arg1 yAxisRange:(id)arg2 xAxis:(id)arg3 dateZoom:(long long)arg4 chartRect:(CGRect)arg5 animated:(BOOL)arg6 completion:(CDUnknownBlockType)arg7;
