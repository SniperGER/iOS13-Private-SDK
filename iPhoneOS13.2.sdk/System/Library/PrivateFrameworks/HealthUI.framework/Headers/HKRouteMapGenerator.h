...
- (void)snapshotWithSize:(struct CGSize)arg1 lineWidth:(double)arg2 traitCollection:(id)arg3 completion:(id /* block */)arg4;
...
- (void)drawLinesWithPolyline:(id)arg1 lineWidth:(double)arg2 mapRect:(CDStruct_90e2a262)arg3 context:(struct CGContext *)arg4 pointFromMapPoint:(id /* block */)arg5;
- (id)init;
