...
// - (void).cxx_destruct;
// - (void)_overlayAnnotationView:(id)arg1 point:(CDStruct_c3b9c2ee)arg2 onSnapshot:(id)arg3 context:(CGContextRef )arg4;
// - (id)_imageWithPolyline:(id)arg1 lineWidth:(double)arg2 mapRect:(CDStruct_90e2a262)arg3 onSnapshot:(id)arg4;
- (void)snapshotWithSize:(CGSize)arg1 lineWidth:(double)arg2 traitCollection:(id)arg3 completion:(CDUnknownBlockType)arg4;
...
// - (void)drawLinesWithPolyline:(id)arg1 lineWidth:(double)arg2 mapRect:(CDStruct_90e2a262)arg3 context:(CGContextRef )arg4 pointFromMapPoint:(CDUnknownBlockType)arg5;
- (id)init;
