...
@property(copy, nonatomic) id /* block */ xAxisStringForLocation; // @synthesize xAxisStringForLocation=_xAxisStringForLocation;
@property(copy, nonatomic) id /* block */ dataBlockBuilder; // @synthesize dataBlockBuilder=_dataBlockBuilder;
