...
@property(copy, nonatomic, setter=_unitTesting_setReminderRegistryCompletion:) id /* block */ _unitTesting_reminderRegistryCompletion; // @synthesize _unitTesting_reminderRegistryCompletion=__unitTesting_reminderRegistryCompletion;
