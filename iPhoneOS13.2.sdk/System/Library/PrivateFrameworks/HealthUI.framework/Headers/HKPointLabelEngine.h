...
@property(readonly, copy, nonatomic) id /* block */ sizeForValue; // @synthesize sizeForValue=_sizeForValue;
...
- (id)initWithBoundingRegion:(struct CGRect)arg1 isLabelShiftingEnabled:(_Bool)arg2 labelSizeBlock:(id /* block */)arg3;
