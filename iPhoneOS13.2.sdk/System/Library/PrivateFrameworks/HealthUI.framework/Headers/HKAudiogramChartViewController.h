...
@class HKAxis, HKDisplayTypeSectionedContextView, HKLollipopController, HKSampleTypeUpdateController, HKScalarGraphCollectionViewController, HKUnitPreferenceController, NSArray, NSLayoutConstraint, NSMutableArray, UIButton, UIStackView, _HKAudiogramAnnotationViewDataSource, _HKAudiogramHeader;
