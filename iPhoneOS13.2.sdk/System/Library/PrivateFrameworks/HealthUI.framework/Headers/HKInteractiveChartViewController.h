...
@interface HKInteractiveChartViewController : HKViewController <HKGraphViewDelegate, HKSampleTypeDateRangeControllerObserver, HKCurrentTimeViewDelegate, HKInteractiveChartCurrentValueViewDelegate, UIGestureRecognizerDelegate, HKMonthViewControllerDelegate, HKLollipopDelegate, HKInteractiveChartCurrentValueViewHandler, HKInteractiveChartCurrentValueViewCallbacks, HKCurrentValueViewDataSourceValueRangeFormatter>
{
    ...
    id /* CDUnknownBlockType */ _startupReportingBlock;
...
+ (id)_timeScopesWithOptions:(NSUInteger)arg1;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ startupReportingBlock; // @synthesize startupReportingBlock=_startupReportingBlock;
...
- (id)initWithDisplayTypes:(id)arg1 healthStore:(id)arg2 unitPreferenceController:(id)arg3 dateCache:(id)arg4 chartDataCacheController:(id)arg5 selectedTimeScopeController:(id)arg6 initialXValue:(id)arg7 options:(NSUInteger)arg8 fixedRange:(id)arg9;
...
- (id)initWithStackedDisplayTypes:(id)arg1 healthStore:(id)arg2 unitPreferenceController:(id)arg3 dateCache:(id)arg4 chartDataCacheController:(id)arg5 selectedTimeScopeController:(id)arg6 initialXValue:(id)arg7 options:(NSUInteger)arg8;
