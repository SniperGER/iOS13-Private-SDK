...
@class HKActivitySummary, HKDateCache, HKDisplayTypeController, HKFetchOperation, HKHealthStore, HKQuery, HKUnitPreferenceController, NSCache, NSCalendar, NSHashTable;
