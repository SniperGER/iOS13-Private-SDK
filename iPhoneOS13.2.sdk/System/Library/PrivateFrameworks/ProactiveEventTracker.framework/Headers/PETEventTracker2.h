...
- (void)enumerateAggregatedMessagesWithBlock:(id /* block */)arg1 clearStore:(_Bool)arg2;
- (double)_roundToSigFigs:(double)arg1 forRawMessage:(id)arg2;
- (void)enumerateMessagesWithBlock:(id /* block */)arg1 messageGroup:(id)arg2 clearStore:(_Bool)arg3;
- (void)enumerateMessagesWithBlock:(id /* block */)arg1 clearStore:(_Bool)arg2;
