...
@property(readonly) NSUInteger version; // @synthesize version=_version;
// - (void).cxx_destruct;
- (BOOL)isAggregatedForMessageName:(id)arg1;
- (NSUInteger)sigFigsForMessageName:(id)arg1;
...
- (NSUInteger)samplingLimitForMessageGroup:(id)arg1;
