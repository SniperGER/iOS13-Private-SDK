...
+ (void)createMapsLinkWithPlacemark:(id)arg1 location:(id)arg2 streetAddress:(id)arg3 shiftingLocationIfNecessary:(_Bool)arg4 completionHandler:(id /* block */)arg5;
+ (void)processLocation:(id)arg1 shiftingIfNecessary:(_Bool)arg2 completionHandler:(id /* block */)arg3;
