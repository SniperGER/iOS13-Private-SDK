...
@property(copy, nonatomic) id /* block */ possibleValuesGetter; // @synthesize possibleValuesGetter=_possibleValuesGetter;
...
- (id)initWithKeyPath:(id)arg1 block:(id /* block */)arg2 name:(id)arg3 propertyClass:(Class)arg4 multipleValues:(_Bool)arg5 filterable:(_Bool)arg6 sortable:(_Bool)arg7 gettable:(_Bool)arg8 primary:(_Bool)arg9 allowedOperators:(id)arg10 userInfo:(id)arg11 possibleValues:(id)arg12 possibleValuesGetter:(id /* block */)arg13 caseInsensitive:(_Bool)arg14 negativeName:(id)arg15 singularItemName:(id)arg16 irrational:(_Bool)arg17 tense:(unsigned long long)arg18 timeUnits:(unsigned long long)arg19 comparableUnits:(unsigned long long)arg20 measurementUnitType:(id)arg21 displayName:(id)arg22;
