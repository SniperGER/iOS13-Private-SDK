...
+ (id)sortDescriptorWithProperty:(id)arg1 ascending:(_Bool)arg2 comparator:(id /* block */)arg3;
@property(readonly, nonatomic) _Bool ascending; // @synthesize ascending=_ascending;
@property(readonly, copy, nonatomic) id /* block */ comparator; // @synthesize comparator=_comparator;
...
- (id)description;
- (id)initWithProperty:(id)arg1 ascending:(_Bool)arg2 comparator:(id /* block */)arg3;
