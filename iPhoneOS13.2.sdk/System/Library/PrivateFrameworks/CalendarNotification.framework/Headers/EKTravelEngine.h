...
@class CLLocationManager, EKTimedEventStorePurger, NSMutableDictionary, PCPersistentTimer;
...
@interface EKTravelEngine : NSObject <CLLocationManagerDelegate>
{
    ...
    id /* CDUnknownBlockType */ _adviceBlock;
    id /* CDUnknownBlockType */ _authorizationChangedBlock;
    id /* CDUnknownBlockType */ _eventSignificantlyChangedBlock;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ eventSignificantlyChangedBlock; // @synthesize eventSignificantlyChangedBlock=_eventSignificantlyChangedBlock;
@property(copy, nonatomic) id /* CDUnknownBlockType */ authorizationChangedBlock; // @synthesize authorizationChangedBlock=_authorizationChangedBlock;
@property(copy, nonatomic) id /* CDUnknownBlockType */ adviceBlock; // @synthesize adviceBlock=_adviceBlock;
// - (void).cxx_destruct;
