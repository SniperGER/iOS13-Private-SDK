...
@property(copy, nonatomic) id /* block */ eventSignificantlyChangedBlock; // @synthesize eventSignificantlyChangedBlock=_eventSignificantlyChangedBlock;
@property(copy, nonatomic) id /* block */ authorizationChangedBlock; // @synthesize authorizationChangedBlock=_authorizationChangedBlock;
@property(copy, nonatomic) id /* block */ adviceBlock; // @synthesize adviceBlock=_adviceBlock;
