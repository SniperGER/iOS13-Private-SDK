...
@interface EKTravelEngineAgendaEntry : NSObject
{
    ...
    id /* CDUnknownBlockType */ _entrySignificantlyChangedBlock;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ entrySignificantlyChangedBlock; // @synthesize entrySignificantlyChangedBlock=_entrySignificantlyChangedBlock;
...
- (void)_sendFeedbackToHypothesizerForPostingNotification:(NSUInteger)arg1;
