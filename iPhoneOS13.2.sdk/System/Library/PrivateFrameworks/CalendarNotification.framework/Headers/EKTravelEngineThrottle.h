...
@property(copy, nonatomic) id /* block */ emissionBlock; // @synthesize emissionBlock=_emissionBlock;
@property(copy, nonatomic) id /* block */ cancelHypothesisRequestRefreshBlock; // @synthesize cancelHypothesisRequestRefreshBlock=_cancelHypothesisRequestRefreshBlock;
@property(copy, nonatomic) id /* block */ requestHypothesisRefreshBlock; // @synthesize requestHypothesisRefreshBlock=_requestHypothesisRefreshBlock;
