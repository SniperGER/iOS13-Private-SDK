...
@interface EKTravelEngineThrottle : NSObject
{
    ...
    id /* CDUnknownBlockType */ _requestHypothesisRefreshBlock;
    id /* CDUnknownBlockType */ _cancelHypothesisRequestRefreshBlock;
    id /* CDUnknownBlockType */ _emissionBlock;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ emissionBlock; // @synthesize emissionBlock=_emissionBlock;
@property(copy, nonatomic) id /* CDUnknownBlockType */ cancelHypothesisRequestRefreshBlock; // @synthesize cancelHypothesisRequestRefreshBlock=_cancelHypothesisRequestRefreshBlock;
@property(copy, nonatomic) id /* CDUnknownBlockType */ requestHypothesisRefreshBlock; // @synthesize requestHypothesisRefreshBlock=_requestHypothesisRefreshBlock;
