...
@interface CALNTriggeredEventNotificationSourceNotificationInfo : NSObject
{
    ...
    NSUInteger _travelAdvisoryTimelinessPeriod;
}
...
@property(readonly, nonatomic) NSUInteger travelAdvisoryTimelinessPeriod; // @synthesize travelAdvisoryTimelinessPeriod=_travelAdvisoryTimelinessPeriod;
...
@property(readonly, nonatomic) BOOL isLocationEvent; // @synthesize isLocationEvent=_isLocationEvent;
