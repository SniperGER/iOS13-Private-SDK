...
- (id)threadDescriptionStringForBacktrace:(id)arg1 returnedAddress:(NSUInteger )arg2;
- (id)dispatchQueueNameForSerialNumber:(NSUInteger)arg1;
- (id)dispatchQueueNameForSerialNumber:(NSUInteger)arg1 returnedConcurrentFlag:(BOOL )arg2 returnedThreadId:(NSUInteger )arg3;
- (id)threadNameForThread:(unsigned int)arg1;
- (id)threadNameForThread:(unsigned int)arg1 returnedThreadId:(NSUInteger )arg2 returnedDispatchQueueSerialNum:(NSUInteger )arg3;
...
- (NSUInteger)recordSampleTo:(id)arg1 beginTime:(double)arg2 endTime:(double)arg3 thread:(unsigned int)arg4 recordFramePointers:(BOOL)arg5 clearMemoryCache:(BOOL)arg6;
...
- (id)initWithPID:(int)arg1 options:(NSUInteger)arg2;
- (id)initWithTask:(unsigned int)arg1;
- (id)initWithPID:(int)arg1;
- (id)initWithPID:(int)arg1 orTask:(unsigned int)arg2 options:(NSUInteger)arg3;
- (id)initWithPID:(int)arg1 task:(unsigned int)arg2 processName:(id)arg3 is64Bit:(BOOL)arg4 options:(NSUInteger)arg5;
