...
//    struct _VMUBlockNode _internalizedNodes;
    ...
    id /* CDUnknownBlockType */ _nodeProvider;
...
- (unsigned int)addEdgeFromNode:(unsigned int)arg1 sourceOffset:(NSUInteger)arg2 withScanType:(unsigned int)arg3 toNode:(unsigned int)arg4 destinationOffset:(NSUInteger)arg5;
