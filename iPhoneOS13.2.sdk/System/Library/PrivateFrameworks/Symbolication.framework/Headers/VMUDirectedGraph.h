...
+ (id)_unarchivedObject:(id)arg1 ofClass:(Class)arg2 options:(NSUInteger)arg3;
+ (id)_archivedObject:(id)arg1 options:(NSUInteger)arg2;
+ (void )_copyUnarchived:(id)arg1 length:(NSUInteger )arg2 options:(NSUInteger)arg3;
+ (id)_archivedBytes:(const void *)arg1 length:(NSUInteger)arg2 options:(NSUInteger)arg3;
...
- (void)dealloc;
- (id)plistRepresentationWithOptions:(NSUInteger)arg1;
