...
@property(readonly, nonatomic) id /* block */ memoryReader; // @synthesize memoryReader=_memoryReader;
...
- (id)labelForMallocBlock:(struct _VMURange)arg1 usingHandlerBlock:(id /* block */)arg2;
