...
- (void)enumerateExternalValuesFromObject:(NSUInteger)arg1 withSize:(unsigned int)arg2 block:(CDUnknownBlockType)arg3;
- (void)enumerateStoredEntriesForObject:(NSUInteger)arg1 ofSize:(unsigned int)arg2 externalValues:(id)arg3 block:(CDUnknownBlockType)arg4;
- (id)instanceSpecificInfoForObject:(NSUInteger)arg1 ofSize:(unsigned int)arg2 withScanner:(id)arg3 memoryReader:(CDUnknownBlockType)arg4;
- (id)instanceSpecificInfoForObject:(NSUInteger)arg1 ofSize:(unsigned int)arg2 memoryReader:(CDUnknownBlockType)arg3;
...
- (void)_identifyObjCClassStructureBlocksForIsa:(NSUInteger)arg1 isMetaclass:(BOOL)arg2 withScanner:(id)arg3 addressIdentifierBlock:(CDUnknownBlockType)arg4;
- (id)mutableCopy;
- (void)dealloc;
- (void)_freeLocalIvarList;
- (id)initWithRealizedClass:(NSUInteger)arg1 type:(unsigned int)arg2 infoMap:(id)arg3 objectIdentifier:(id)arg4 reader:(CDUnknownBlockType)arg5;
- (id)initWithClass:(NSUInteger)arg1 type:(unsigned int)arg2 infoMap:(id)arg3 objectIdentifier:(id)arg4 reader:(CDUnknownBlockType)arg5;
- (id)_initWithClass:(NSUInteger)arg1 type:(unsigned int)arg2 realizedOnly:(BOOL)arg3 infoMap:(id)arg4 objectIdentifier:(id)arg5 reader:(CDUnknownBlockType)arg6;
