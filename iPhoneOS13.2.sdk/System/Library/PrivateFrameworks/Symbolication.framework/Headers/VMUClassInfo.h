...
- (void)_logDescriptionWithSuperclasses:(_Bool)arg1 indentation:(int)arg2 toLogger:(id /* block */)arg3;
...
- (void)_identifyObjCClassStructureBlocksForIsa:(unsigned long long)arg1 isMetaclass:(_Bool)arg2 withScanner:(id)arg3 addressIdentifierBlock:(id /* block */)arg4;
- (id)mutableCopy;
- (void)dealloc;
...
- (id)_initWithClass:(unsigned long long)arg1 type:(unsigned int)arg2 realizedOnly:(_Bool)arg3 infoMap:(id)arg4 objectIdentifier:(id)arg5 reader:(id /* block */)arg6;
