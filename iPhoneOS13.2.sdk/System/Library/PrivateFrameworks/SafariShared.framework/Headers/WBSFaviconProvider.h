...
- (void)_saveImageData:(id)arg1 iconURL:(id)arg2 pageURL:(id)arg3 originalPageURL:(id)arg4 size:(CGSize)arg5 isPrivate:(BOOL)arg6 completionHandler:(CDUnknownBlockType)arg7;
- (void)_confirmImageDataShouldBeSaved:(id)arg1 size:(CGSize)arg2 pageURL:(id)arg3 iconURL:(id)arg4 includingPrivateData:(BOOL)arg5 completionHandler:(CDUnknownBlockType)arg6;
- (void)_atomicallySaveImageData:(id)arg1 iconURL:(id)arg2 pageURL:(id)arg3 originalPageURL:(id)arg4 size:(CGSize)arg5 isPrivate:(BOOL)arg6 completionHandler:(CDUnknownBlockType)arg7;
- (void)saveFaviconImageData:(id)arg1 iconURL:(id)arg2 pageURL:(id)arg3 originalPageURL:(id)arg4 size:(CGSize)arg5 isPrivate:(BOOL)arg6 completionHandler:(CDUnknownBlockType)arg7;
...
- (void)shouldIconDataBeSavedForIconWithPageURL:(id)arg1 originalPageURL:(id)arg2 iconURL:(id)arg3 size:(CGSize)arg4 isPrivate:(BOOL)arg5 completionHandler:(CDUnknownBlockType)arg6;
...
- (void)dealloc;
- (id)initWithPersistenceBaseURL:(id)arg1 persistenceName:(id)arg2 preferredIconSize:(CGSize)arg3 atScale:(double)arg4 allScales:(id)arg5 isReadOnly:(BOOL)arg6 shouldCheckIntegrityWhenOpeningDatabaseBlock:(CDUnknownBlockType)arg7;
- (id)initWithPersistenceBaseURL:(id)arg1 persistenceName:(id)arg2 preferredIconSize:(CGSize)arg3 atScale:(double)arg4 allScales:(id)arg5 shouldCheckIntegrityWhenOpeningDatabaseBlock:(CDUnknownBlockType)arg6;
- (id)init;
