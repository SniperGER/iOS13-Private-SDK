...
- (void)setLastSeenDate:(NSDate *)arg1 forCloudClientVersion:(NSUInteger)arg2;
- (NSDate *)lastSeenDateForCloudClientVersion:(NSUInteger)arg1;
...
- (void)fetchTopicsFromStartDate:(NSDate *)arg1 toEndDate:(NSDate *)arg2 limit:(NSUInteger)arg3 minimumItemCount:(NSUInteger)arg4 sortOrder:(long long)arg5 completionHandler:(void (^)(NSArray *, NSError *))arg6;
...
- (void)tagsWithIdentifiers:(NSArray *)arg1 type:(NSUInteger)arg2 level:(long long)arg3 creatingIfNecessary:(BOOL)arg4 withTitles:(NSArray *)arg5 completionHandler:(void (^)(NSArray *, NSArray *, NSError *))arg6;
