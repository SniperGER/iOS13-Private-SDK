...
@property(nonatomic) NSUInteger selectionLength; // @dynamic selectionLength;
@property(nonatomic) NSUInteger selectionStart; // @dynamic selectionStart;
@property(nonatomic) NSUInteger minLength; // @dynamic minLength;
@property(nonatomic) NSUInteger maxLength; // @dynamic maxLength;
@property(nonatomic) NSUInteger size; // @dynamic size;
