...
- (void)fetchAndMergeChangesBypassingThrottler:(_Bool)arg1 completionHandler:(id /* block */)arg2;
...
- (void)_saveVisits:(id)arg1 tombstones:(id)arg2 toCloudHistoryBypassingThrottler:(_Bool)arg3 longLivedOperationPersistenceCompletion:(id /* block */)arg4 withCallback:(id /* block */)arg5;
...
- (void)saveChangesBypassingThrottler:(_Bool)arg1 completionHandler:(id /* block */)arg2;
