...
@class NSMutableArray, NSMutableDictionary, WBSCloudHistoryConfiguration, WBSCloudHistoryPushAgentProxy, WBSCloudKitThrottler, WBSHistory, WBSOneShotTimer;
...
//    struct unique_ptr<SafariShared::SuddenTerminationDisabler, std::__1::default_delete<SafariShared::SuddenTerminationDisabler>> _replayLongLivedSaveOperationSuddenTerminationDisabler;
    ...
    NSUInteger _numberOfDevicesInSyncCircle;
...
@property(nonatomic) NSUInteger numberOfDevicesInSyncCircle; // @synthesize numberOfDevicesInSyncCircle=_numberOfDevicesInSyncCircle;
...
- (void)_setCachedNumberOfDevicesInSyncCircle:(NSUInteger)arg1;
