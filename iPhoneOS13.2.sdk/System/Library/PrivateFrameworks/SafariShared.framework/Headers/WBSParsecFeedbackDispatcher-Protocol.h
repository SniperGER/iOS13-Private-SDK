...
@optional
- (void)userTypedGoToSearch:(NSString *)arg1 endpoint:(NSUInteger)arg2 forQueryID:(NSUInteger)arg3;
- (void)didBeginSearchOfType:(long long)arg1 withQuery:(WBSCompletionQuery *)arg2 urlString:(NSString *)arg3 headers:(NSDictionary *)arg4 endpoint:(NSUInteger)arg5;
- (void)didBeginSearchOfType:(long long)arg1 withQuery:(WBSCompletionQuery *)arg2 endpoint:(NSUInteger)arg3;
...
- (void)userDidEngageWithCompletionListItem:(id <WBSCompletionListItem>)arg1 atPosition:(NSUInteger)arg2 withEngagementActionDictionary:(NSDictionary *)arg3;
- (void)userDidEngageWithCompletionListItem:(id <WBSCompletionListItem>)arg1 withCardActionDictionary:(NSDictionary *)arg2;
- (void)userDidSelectCompletionListItem:(id <WBSCompletionListItem>)arg1 atPosition:(NSUInteger)arg2;
