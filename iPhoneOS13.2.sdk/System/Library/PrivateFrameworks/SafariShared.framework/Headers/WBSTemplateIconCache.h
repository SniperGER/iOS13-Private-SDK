...
@class NSCache, NSMutableDictionary, NSMutableSet, NSURL, WBSSiteMetadataImageCache;
...
@property(nonatomic) CGSize defaultIconSize; // @synthesize defaultIconSize=_defaultIconSize;
