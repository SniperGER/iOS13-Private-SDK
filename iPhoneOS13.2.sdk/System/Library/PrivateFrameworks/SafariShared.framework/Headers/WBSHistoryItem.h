...
@property(readonly, nonatomic) NSUInteger visitCountScore; // @synthesize visitCountScore=_visitCountScore;
...
- (void)scoreOfVisit:(id)arg1 wasUpdatedFrom:(NSUInteger)arg2 to:(NSUInteger)arg3;
...
@property(readonly, nonatomic) NSUInteger visitCount;
