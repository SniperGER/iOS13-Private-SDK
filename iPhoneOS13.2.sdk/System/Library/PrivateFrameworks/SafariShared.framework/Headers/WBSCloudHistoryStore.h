...
- (void)_fetchRecordsWithServerChangeToken:(id)arg1 numberOfFetchRecordsOperationsPerformedSoFar:(NSUInteger)arg2 result:(id)arg3 completion:(CDUnknownBlockType)arg4;
