...
+ (id)sharedStore;
- (_Bool)_tryToPerformTransactionInBlock:(id /* block */)arg1;
- (void)_closeDatabase;
...
- (void)setValue:(id)arg1 ofPreference:(long long)arg2 forDomain:(id)arg3 includeTimestamp:(_Bool)arg4 completionHandler:(id /* block */)arg5;
