...
@class MKMapItem, NSString, NSURL, SFSearchResult, WBSParsecActionButton, WBSParsecImageRepresentation;
...
@property(readonly, nonatomic) NSUInteger minimumRankOfTopHitToSuppressResult; // @synthesize minimumRankOfTopHitToSuppressResult=_minimumRankOfTopHitToSuppressResult;
@property(readonly, nonatomic) NSUInteger legacyType; // @synthesize legacyType=_legacyType;
