...
@interface WBSCloudHistoryConfiguration : NSObject
{
    ...
    NSUInteger _maximumRequestCharacterCount;
    double _syncWindow;
}
...
@property NSUInteger maximumRequestCharacterCount; // @synthesize maximumRequestCharacterCount=_maximumRequestCharacterCount;
