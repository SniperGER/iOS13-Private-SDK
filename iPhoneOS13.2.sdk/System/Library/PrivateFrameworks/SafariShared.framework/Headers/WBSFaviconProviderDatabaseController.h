...
- (void)linkAndUpdateTimestampForIconWithPageURLString:(id)arg1 iconURLString:(id)arg2 iconSize:(CGSize)arg3 iconHasGeneratedResolutions:(BOOL)arg4 completionHandler:(CDUnknownBlockType)arg5;
