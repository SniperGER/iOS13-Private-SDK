...
@class NSArray, NSCountedSet, NSData, NSDate, NSMapTable, NSMutableDictionary, NSMutableSet, NSTimer, NSURL, WBSHistoryCrypto, WBSHistoryTagDatabaseController, WBSPeriodicActivityScheduler, WBSSQLiteDatabase, WBSSQLiteStatementCache;
...
- (id)_lastSeenDateForCloudClientVersionOnDatabaseQueue:(NSUInteger)arg1;
...
- (NSUInteger)_cachedNumberOfDevicesInSyncCircleOnDatabaseQueue;
...
- (void)fetchTopicsFromStartDate:(id)arg1 toEndDate:(id)arg2 limit:(NSUInteger)arg3 minimumItemCount:(NSUInteger)arg4 sortOrder:(long long)arg5 completionHandler:(CDUnknownBlockType)arg6;
...
- (Class)_classForHistoryTagType:(NSUInteger)arg1;
- (id)_createHistoryTagsWithIdentifiers:(id)arg1 titles:(id)arg2 type:(NSUInteger)arg3 level:(long long)arg4 error:(id )arg5;
...
- (id)_tagsWithIdentifiers:(id)arg1 titles:(id)arg2 ofType:(NSUInteger)arg3 level:(long long)arg4 creatingIfNeeded:(BOOL)arg5 createdTags:(id )arg6 error:(id )arg7;
- (void)tagsWithIdentifiers:(id)arg1 type:(NSUInteger)arg2 level:(long long)arg3 creatingIfNecessary:(BOOL)arg4 withTitles:(id)arg5 completionHandler:(CDUnknownBlockType)arg6;
...
- (void)_setLastSyncedGeneration:(NSUInteger)arg1;
- (long long)_lastSyncedGeneration;
...
- (void)dealloc;
- (id)initWithURL:(id)arg1 itemCountLimit:(NSUInteger)arg2 historyAgeLimit:(double)arg3 historyItemClass:(Class)arg4;
