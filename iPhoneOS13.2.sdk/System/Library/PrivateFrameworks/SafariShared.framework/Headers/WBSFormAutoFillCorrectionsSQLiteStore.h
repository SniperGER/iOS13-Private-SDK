...
- (_Bool)_setDomain:(id)arg1 isWhitelistedForFeedback:(_Bool)arg2;
- (_Bool)_replaceDomainWhitelistWithDomains:(id)arg1 retrievalURLString:(id)arg2;
- (_Bool)_tryToPerformTransactionOnDatabase:(id)arg1 inBlock:(id /* block */)arg2;
...
- (void)setDomain:(id)arg1 isWhitelistedForFeedback:(_Bool)arg2 completionHandler:(id /* block */)arg3;
