...
@class NSArray, NSDate, NSDictionary, NSError, NSMutableArray, NSMutableDictionary, WBSCloudTabDevice;
...
- (NSUInteger)_indexOfDevice:(id)arg1 inSyncedCloudTabDevices:(id)arg2;
