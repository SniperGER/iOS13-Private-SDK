...
@class NSObject, RTIInputSystemSourceSession;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ hiliteModeCallback; // @synthesize hiliteModeCallback=_hiliteModeCallback;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ rtiCallback; // @synthesize rtiCallback=_rtiCallback;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ textInputCallback; // @synthesize textInputCallback=_textInputCallback;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ recordingStateCallback; // @synthesize recordingStateCallback=_recordingStateCallback;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ gameControllerPropertiesCallback; // @synthesize gameControllerPropertiesCallback=_gameControllerPropertiesCallback;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ gameControllerInputModeCallback; // @synthesize gameControllerInputModeCallback=_gameControllerInputModeCallback;
...
- (void)_callClientGameControllerPropertiesCallback:(id)arg1 controller:(NSUInteger)arg2;
- (void)_callClientGameControllerInputModeCallback;
- (void)_sendTextInputMessageWithActionType:(NSUInteger)arg1 text:(id)arg2;
- (void)wake;
- (void)exitHiliteMode;
...
- (void)sendGameControllerEvent:(id)arg1 controllerID:(NSUInteger)arg2;
- (void)unregisterGameController:(NSUInteger)arg1;
...
//  (void)sendTouchEvent:(struct _MRHIDTouchEvent)arg1 toVirtualDeviceWithID:(NSUInteger)arg2;
