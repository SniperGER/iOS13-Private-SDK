...
@property(copy, nonatomic) id /* block */ hiliteModeCallback; // @synthesize hiliteModeCallback=_hiliteModeCallback;
...
@property(copy, nonatomic) id /* block */ rtiCallback; // @synthesize rtiCallback=_rtiCallback;
...
@property(copy, nonatomic) id /* block */ textInputCallback; // @synthesize textInputCallback=_textInputCallback;
...
@property(copy, nonatomic) id /* block */ recordingStateCallback; // @synthesize recordingStateCallback=_recordingStateCallback;
...
@property(copy, nonatomic) id /* block */ gameControllerPropertiesCallback; // @synthesize gameControllerPropertiesCallback=_gameControllerPropertiesCallback;
...
@property(copy, nonatomic) id /* block */ gameControllerInputModeCallback; // @synthesize gameControllerInputModeCallback=_gameControllerInputModeCallback;
