...
- (void)sendMessageWithType:(NSUInteger)arg1 queue:(id)arg2 reply:(CDUnknownBlockType)arg3;
- (void)removeCustomXPCHandler:(NSUInteger)arg1;
- (void)addCustomXPCHandler:(CDUnknownBlockType)arg1 forKey:(NSUInteger)arg2;
