...
- (id)currentLanguageOptionsAtIndex:(NSUInteger)arg1;
- (NSUInteger)currentLanguageOptionsCount;
- (void)addCurrentLanguageOptions:(id)arg1;
- (void)clearCurrentLanguageOptions;
- (id)availableLanguageOptionsAtIndex:(NSUInteger)arg1;
- (NSUInteger)availableLanguageOptionsCount;
