...
- (void)_suspendStreamWithCompletionBlockSynchronously:(_Bool)arg1 completion:(id /* block */)arg2;
...
- (void)_prepareForExtractionSynchronously:(_Bool)arg1 withCompletionBlock:(id /* block */)arg2;
- (void)_prepareForLocalExtraction:(id /* block */)arg1;
- (void)_prepareForRemoteExtractionSynchronously:(_Bool)arg1 withCompletionBlock:(id /* block */)arg2;
