...
@property(copy, nonatomic) id /* block */ encryptHandler; // @synthesize encryptHandler=_encryptHandler;
@property(copy, nonatomic) id /* block */ decryptHandler; // @synthesize decryptHandler=_decryptHandler;
