...
//    struct LogCategory _ucat;
    ...
    id /* CDUnknownBlockType */ _signDataHandler;
    id /* CDUnknownBlockType */ _verifySignatureHandler;
}

@property(copy, nonatomic) id /* CDUnknownBlockType */ verifySignatureHandler; // @synthesize verifySignatureHandler=_verifySignatureHandler;
@property(copy, nonatomic) id /* CDUnknownBlockType */ signDataHandler; // @synthesize signDataHandler=_signDataHandler;
@property(copy, nonatomic) id /* CDUnknownBlockType */ sendDataHandler; // @synthesize sendDataHandler=_sendDataHandler;
...
@property(nonatomic) NSUInteger selfAppFlags; // @synthesize selfAppFlags=_selfAppFlags;
...
// - (void).cxx_destruct;
- (int)deriveKeyWithSaltPtr:(const void *)arg1 saltLen:(NSUInteger)arg2 infoPtr:(const void *)arg3 infoLen:(NSUInteger)arg4 keyLen:(NSUInteger)arg5 outputKeyPtr:(void )arg6;
