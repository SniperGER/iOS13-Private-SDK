...
@property(copy, nonatomic) id /* block */ verifySignatureHandler; // @synthesize verifySignatureHandler=_verifySignatureHandler;
@property(copy, nonatomic) id /* block */ signDataHandler; // @synthesize signDataHandler=_signDataHandler;
@property(copy, nonatomic) id /* block */ sendDataHandler; // @synthesize sendDataHandler=_sendDataHandler;
