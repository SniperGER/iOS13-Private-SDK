...
- (void)_getPairingIdentityCompleted:(id)arg1 options:(NSUInteger)arg2 error:(id)arg3 label:(id)arg4 completion:(CDUnknownBlockType)arg5;
- (void)_getPairingIdentityForUserWithOptions:(NSUInteger)arg1 completion:(CDUnknownBlockType)arg2;
- (void)_getPairingIdentityForAccessoryWithOptions:(NSUInteger)arg1 completion:(CDUnknownBlockType)arg2;
