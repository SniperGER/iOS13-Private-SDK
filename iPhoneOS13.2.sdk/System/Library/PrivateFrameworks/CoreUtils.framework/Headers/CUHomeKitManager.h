...
@property(copy, nonatomic) id /* block */ selfAccessorySiriAccessUpdatedHandler; // @synthesize selfAccessorySiriAccessUpdatedHandler=_selfAccessorySiriAccessUpdatedHandler;
@property(readonly, nonatomic) _Bool selfAccessorySiriEnabled; // @synthesize selfAccessorySiriEnabled=_selfAccessorySiriEnabled;
@property(copy, nonatomic) id /* block */ selfAccessoryMediaSystemUpdatedHandler; // @synthesize selfAccessoryMediaSystemUpdatedHandler=_selfAccessoryMediaSystemUpdatedHandler;
...
@property(copy, nonatomic) id /* block */ selfAccessoryMediaAccessUpdatedHandler; // @synthesize selfAccessoryMediaAccessUpdatedHandler=_selfAccessoryMediaAccessUpdatedHandler;
...
@property(copy, nonatomic) id /* block */ selfAccessoryUpdatedHandler; // @synthesize selfAccessoryUpdatedHandler=_selfAccessoryUpdatedHandler;
@property(copy, nonatomic) id /* block */ selfAccessoryAppDataChangedHandler; // @synthesize selfAccessoryAppDataChangedHandler=_selfAccessoryAppDataChangedHandler;
...
@property(copy, nonatomic) id /* block */ resolvableAccessoriesChangedHandler; // @synthesize resolvableAccessoriesChangedHandler=_resolvableAccessoriesChangedHandler;
