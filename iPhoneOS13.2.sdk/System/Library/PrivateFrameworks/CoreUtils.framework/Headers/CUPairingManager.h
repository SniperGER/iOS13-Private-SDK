...
@property(copy, nonatomic) id /* block */ pairedPeerChangedHandler; // @synthesize pairedPeerChangedHandler=_pairedPeerChangedHandler;
@property(copy, nonatomic) id /* block */ pairedPeerRemovedHandler; // @synthesize pairedPeerRemovedHandler=_pairedPeerRemovedHandler;
@property(copy, nonatomic) id /* block */ pairedPeerAddedHandler; // @synthesize pairedPeerAddedHandler=_pairedPeerAddedHandler;
...
@property(copy, nonatomic) id /* block */ identityDeletedHandler; // @synthesize identityDeletedHandler=_identityDeletedHandler;
@property(copy, nonatomic) id /* block */ identityCreatedHandler; // @synthesize identityCreatedHandler=_identityCreatedHandler;
