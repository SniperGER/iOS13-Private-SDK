...
@class HKClinicalAccount, HKCloudSyncObserver, HKConcept, HKViewTableViewCell, HRContentStatusCell, HRContentStatusView, HROverlayRoomViewController, HRProfile, NSHashTable, NSPredicate, NSSet, NSTimer, NSUUID, UIButton, UISearchController, WDMedicalRecordCategory, WDMedicalRecordDisplayItemProvider;
...
@property(nonatomic) NSUInteger indexManagerState; // @synthesize indexManagerState=_indexManagerState;
