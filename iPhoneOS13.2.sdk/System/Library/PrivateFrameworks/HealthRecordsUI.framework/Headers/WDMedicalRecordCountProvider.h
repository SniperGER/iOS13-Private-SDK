...
@property(copy, nonatomic) id /* block */ unitTesting_allObserversReadyCallback; // @synthesize unitTesting_allObserversReadyCallback=_unitTesting_allObserversReadyCallback;
