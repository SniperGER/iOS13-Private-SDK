...
@interface WDMedicalRecordCategorySummary : NSObject <WDMedicalRecordSummarizable>
{
    ...
    NSUInteger _truncationDisplayItemOffset;
...
@property(nonatomic) NSUInteger truncationDisplayItemOffset; // @synthesize truncationDisplayItemOffset=_truncationDisplayItemOffset;
