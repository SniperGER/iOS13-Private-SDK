...
@class HAMenstrualAlgorithmsAnalysis, HDProfile, HKMCAnalysis, HKMCSettingsManager, HKObserverSet, NSArray, _HKDelayedOperation;
...
- (id)_analysisWithAlgorithmsAnalysis:(id)arg1 algorithmsCycles:(id)arg2 recentSymptoms:(NSUInteger)arg3 recentBasalBodyTemperature:(id)arg4 lastLoggedDayIndex:(id)arg5 lastMenstrualFlowDayIndex:(id)arg6;
