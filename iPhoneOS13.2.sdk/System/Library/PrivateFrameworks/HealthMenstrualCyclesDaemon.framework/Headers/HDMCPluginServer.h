...
- (void)remote_saveLastMenstrualPeriodWithDayIndexRange:(CDStruct_ef5fcbe6)arg1 completion:(id /* block */)arg2;
- (void)remote_saveMenstrualFlowByDayIndex:(id)arg1 completion:(id /* block */)arg2;
- (void)remote_saveMenstrualFlow:(long long)arg1 dayIndex:(long long)arg2 updateAdjacentDays:(_Bool)arg3 completion:(id /* block */)arg4;
