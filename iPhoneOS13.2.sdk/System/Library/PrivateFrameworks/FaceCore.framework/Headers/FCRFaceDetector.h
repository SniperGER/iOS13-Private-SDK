...
//  (CGPoint)makeYFlippedPointFromCoord:(struct coord )arg1 image:(id)arg2;
//  (struct coord)makeYFlippedCoordFromPoint:(CGPoint)arg1 image:(id)arg2;
...
- (id)extractDetailsForFaces:(id)arg1 inData:(id)arg2 width:(NSUInteger)arg3 height:(NSUInteger)arg4 bytesPerRow:(NSUInteger)arg5 options:(id)arg6 error:(id )arg7;
...
- (id)detectFacesInData:(id)arg1 width:(NSUInteger)arg2 height:(NSUInteger)arg3 bytesPerRow:(NSUInteger)arg4 options:(id)arg5 error:(id )arg6;
- (id)version;
- (void)dealloc;
