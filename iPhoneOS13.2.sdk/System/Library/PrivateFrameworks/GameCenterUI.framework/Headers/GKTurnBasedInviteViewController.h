...
- (void)removeCurrentMatchAndSetFlagIfNotLoaded:(_Bool)arg1 withHandler:(id /* block */)arg2;
...
- (void)createGameWithPlayersToInvite:(id)arg1 forSharing:(_Bool)arg2 handler:(id /* block */)arg3;
