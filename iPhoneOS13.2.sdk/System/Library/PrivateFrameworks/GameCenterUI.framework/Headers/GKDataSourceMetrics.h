...
@property(nonatomic) NSRange * localSectionRange; // @synthesize localSectionRange=_localSectionRange;
@property(nonatomic) NSRange * globalSectionRange; // @synthesize globalSectionRange=_globalSectionRange;
