...
- (void)clearInterstitialViewAnimated:(_Bool)arg1 completion:(id /* block */)arg2;
- (void)showInterstitialViewAnimated:(_Bool)arg1 completion:(id /* block */)arg2;
- (void)_updateViewAlpha:(double)arg1 animated:(_Bool)arg2 completion:(id /* block */)arg3;
- (void)popAllModalViewControllersAnimated:(_Bool)arg1 completion:(id /* block */)arg2;
