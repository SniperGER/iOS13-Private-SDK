...
@property(copy, nonatomic) id /* block */ dismissCompletionHandler; // @synthesize dismissCompletionHandler=_dismissCompletionHandler;
...
@property(copy, nonatomic) id /* block */ remoteViewReadyHandler; // @synthesize remoteViewReadyHandler=_remoteViewReadyHandler;
