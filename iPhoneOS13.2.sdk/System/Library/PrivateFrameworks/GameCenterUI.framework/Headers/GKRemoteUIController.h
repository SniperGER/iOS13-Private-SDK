...
@property(copy, nonatomic) id /* block */ loadHandler; // @synthesize loadHandler=_loadHandler;
...
- (void)updateAccountAndMarkComplete:(_Bool)arg1 completionHandler:(id /* block */)arg2;
