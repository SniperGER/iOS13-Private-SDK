...
@interface GKDashboardMultiplayerPickerDataSource : GKCollectionDataSource
{
    ...
    id /* CDUnknownBlockType */ _nearbyPlayersChangedHandler;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ nearbyPlayersChangedHandler; // @synthesize nearbyPlayersChangedHandler=_nearbyPlayersChangedHandler;
...
- (BOOL)cellSelectableStateAtIndexPath:(id)arg1 playerState:(NSUInteger)arg2;
- (void)clearSelection;
