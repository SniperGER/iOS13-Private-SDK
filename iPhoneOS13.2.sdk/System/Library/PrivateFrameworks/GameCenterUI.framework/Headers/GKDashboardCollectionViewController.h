...
@class GKCollectionDataSource, GKNoContentView, NSLayoutConstraint, NSMutableIndexSet, UICollectionView, UIView;
...
@property(nonatomic) UIEdgeInsets scrollInsetsBeforeKeyboard; // @synthesize scrollInsetsBeforeKeyboard=_scrollInsetsBeforeKeyboard;
