...
@property(nonatomic) NSUInteger sectionCount; // @synthesize sectionCount=_sectionCount;
...
- (id)dataSourceForSection:(NSUInteger)arg1;
- (NSUInteger)sectionForDataSource:(id)arg1;
- (void)updateMappings;
