...
- (void)privateDownloadCloudPhotoLibraryAsset:(id)arg1 resourceType:(unsigned long long)arg2 highPriority:(_Bool)arg3 completionHandler:(id /* block */)arg4;
...
- (void)setSearchIndexPaused:(_Bool)arg1 reason:(id)arg2 completionHandler:(id /* block */)arg3;
