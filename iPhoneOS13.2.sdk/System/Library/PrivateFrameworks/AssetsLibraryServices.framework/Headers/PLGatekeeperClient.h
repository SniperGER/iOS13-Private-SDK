...
+ (id)sharedInstance;
// - (void).cxx_destruct;
- (void)rampingRequestForResourceType:(NSUInteger)arg1 numRequested:(NSUInteger)arg2 withCompletionHandler:(CDUnknownBlockType)arg3;
...
- (void)requestVideoURLForAsset:(id)arg1 format:(int)arg2 intent:(NSUInteger)arg3 networkAccessAllowed:(BOOL)arg4 streamingAllowed:(BOOL)arg5 restrictToPlayable:(BOOL)arg6 trackCPLDownload:(BOOL)arg7 handler:(CDUnknownBlockType)arg8;
