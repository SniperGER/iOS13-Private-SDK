...
- (void)downloadCloudSharedAsset:(id)arg1 withCloudPlaceholderKind:(NSUInteger)arg2 shouldPrioritize:(BOOL)arg3 shouldExtendTimer:(BOOL)arg4 completionHandler:(CDUnknownBlockType)arg5;
...
- (void)videoURLForAsset:(id)arg1 format:(int)arg2 intent:(NSUInteger)arg3 networkAccessAllowed:(BOOL)arg4 streamingAllowed:(BOOL)arg5 restrictToPlayable:(BOOL)arg6 trackCPLDownload:(BOOL)arg7 completionHandler:(CDUnknownBlockType)arg8;
