...
- (void)downloadCloudSharedAsset:(id)arg1 withCloudPlaceholderKind:(unsigned long long)arg2 shouldPrioritize:(_Bool)arg3 shouldExtendTimer:(_Bool)arg4 completionHandler:(id /* block */)arg5;
...
- (void)adjustmentDataForAsset:(id)arg1 withDataBlob:(_Bool)arg2 networkAccessAllowed:(_Bool)arg3 trackCPLDownload:(_Bool)arg4 completionHandler:(id /* block */)arg5;
- (void)videoURLForAsset:(id)arg1 format:(int)arg2 networkAccessAllowed:(_Bool)arg3 streamingAllowed:(_Bool)arg4 restrictToPlayable:(_Bool)arg5 trackCPLDownload:(_Bool)arg6 completionHandler:(id /* block */)arg7;
- (void)videoURLForAsset:(id)arg1 format:(int)arg2 intent:(unsigned long long)arg3 networkAccessAllowed:(_Bool)arg4 streamingAllowed:(_Bool)arg5 restrictToPlayable:(_Bool)arg6 trackCPLDownload:(_Bool)arg7 completionHandler:(id /* block */)arg8;
...
- (void)imageDataForAsset:(id)arg1 format:(int)arg2 allowPlaceholder:(_Bool)arg3 wantURLOnly:(_Bool)arg4 networkAccessAllowed:(_Bool)arg5 trackCPLDownload:(_Bool)arg6 completionHandler:(id /* block */)arg7;
