...
- (_Bool)isPhotosAccessAllowedWithScope:(long long)arg1 promptIfNeededWithHandler:(id /* block */)arg2;
- (void)isPhotosAccessAllowedWithScope:(long long)arg1 handler:(id /* block */)arg2;
- (_Bool)_isPhotosAccessAllowedWithScope:(long long)arg1 forceHandler:(_Bool)arg2 accessAllowedHandler:(id /* block */)arg3;
