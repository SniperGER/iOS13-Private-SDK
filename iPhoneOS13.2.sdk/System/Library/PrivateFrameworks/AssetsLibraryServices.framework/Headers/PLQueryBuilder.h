...
- (void)addKeywordQuery:(id)arg1 exclude:(_Bool)arg2;
...
- (void)addHasLocationQuery:(_Bool)arg1;
...
- (_Bool)_isValidNumericComparator:(int)arg1;
- (void)addIsEmptyQueryForKey:(int)arg1 isEmpty:(_Bool)arg2;
- (_Bool)_validIsEmptyQueryKey:(int)arg1;
...
- (_Bool)_isValidStringComparator:(int)arg1;
...
- (void)_addDateUnitQueryForKey:(int)arg1 withValue:(id)arg2 withType:(int)arg3 withUnit:(int)arg4 exclude:(_Bool)arg5;
- (void)addInTheLastSecondsQueryKey:(int)arg1 withCount:(long long)arg2 exclude:(_Bool)arg3;
- (void)addInTheLastYearsQueryKey:(int)arg1 withCount:(long long)arg2 exclude:(_Bool)arg3;
- (void)addInTheLastMonthsQueryKey:(int)arg1 withCount:(long long)arg2 exclude:(_Bool)arg3;
- (void)addInTheLastWeeksQueryKey:(int)arg1 withCount:(long long)arg2 exclude:(_Bool)arg3;
- (void)addInTheLastDaysQueryKey:(int)arg1 withCount:(long long)arg2 exclude:(_Bool)arg3;
- (void)addIsBeforeDateQueryKey:(int)arg1 withDate:(id)arg2;
- (void)addIsAfterDateQueryKey:(int)arg1 withDate:(id)arg2;
- (void)addIsDateQueryKey:(int)arg1 withDate:(id)arg2 exclude:(_Bool)arg3;
- (_Bool)_isValidDateKey:(int)arg1;
- (void)addIsReferencedMediaQuery:(_Bool)arg1;
- (void)addIsInAnyAlbumQuery;
- (void)addIsInAlbumQuery:(id)arg1;
- (void)addAssetTypeQuery:(int)arg1 exclude:(_Bool)arg2;
- (void)addIsRawQuery:(_Bool)arg1;
- (void)addIsAdjustedQuery:(_Bool)arg1;
- (void)addIsHiddenQuery:(_Bool)arg1;
- (void)addIsFavoriteQuery:(_Bool)arg1;
