...
- (_Bool)setImageForEntry:(PLImageContainer *)arg1 withIdentifier:(NSString *)arg2 orIndex:(unsigned long long)arg3 photoUUID:(NSString *)arg4 options:(NSDictionary *)arg5;
@end
