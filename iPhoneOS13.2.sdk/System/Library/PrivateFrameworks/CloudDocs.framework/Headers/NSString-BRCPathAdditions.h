...
+ (id)br_pathForDirectory:(NSUInteger)arg1;
...
+ (id)br_pathWithDeviceID:(int)arg1 fileID:(NSUInteger)arg2;
+ (id)br_pathWithFileSystemRepresentation:(const char )arg1;
- (id)br_pathRelativeToDirectory:(NSUInteger)arg1;
- (id)br_stringByDeletingPathBounceNo:(NSUInteger )arg1;
- (id)br_stringByDeletingPathBounceNo:(NSUInteger )arg1 andPathExtension:(id )arg2;
