...
- (void)br_bookmarkableStringWithEtag:(_Bool)arg1 onlyAllowItemKnowByServer:(_Bool)arg2 completion:(id /* block */)arg3;
- (void)br_bookmarkableStringWithEtag:(_Bool)arg1 completion:(id /* block */)arg2;
