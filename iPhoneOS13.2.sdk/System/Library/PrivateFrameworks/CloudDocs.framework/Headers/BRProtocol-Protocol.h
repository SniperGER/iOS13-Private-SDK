...
- (void)overwriteAccessTimeForItemAtURL:(NSURL *)arg1 atime:(NSUInteger)arg2 reply:(void (^)(NSError *))arg3;
...
- (void)enumerateWorkingSetChangesFromChangeToken:(NSData *)arg1 limit:(NSUInteger)arg2 completion:(void (^)(NSArray *, NSArray *, NSData *, NSError *))arg3;
- (void)enumerateAllFoldersWithSortOrder:(unsigned char)arg1 offset:(NSUInteger)arg2 limit:(NSUInteger)arg3 completion:(void (^)(NSArray *, NSUInteger, NSError *))arg4;
- (void)enumerateItemsInFolder:(BRFileObjectID *)arg1 sortOrder:(unsigned char)arg2 offset:(NSUInteger)arg3 limit:(NSUInteger)arg4 completion:(void (^)(NSArray *, NSUInteger, NSError *))arg5;
- (void)currentNotifRankWithReply:(void (^)(NSUInteger, NSError *))arg1;
...
- (void)getPublishedURLForItemAtURL:(NSURL *)arg1 forStreaming:(BOOL)arg2 requestedTTL:(NSUInteger)arg3 reply:(void (^)(NSURL *, NSDate *, NSError *))arg4;
...
- (void)getEvictableSpaceWithReply:(void (^)(NSUInteger, NSError *))arg1;
...
- (void)evictItemAtURL:(NSURL *)arg1 options:(NSUInteger)arg2 reply:(void (^)(NSError *))arg3;
- (void)startOperation:(NSObject<BROperationClient> *)arg1 toDownloadItemAtURL:(NSURL *)arg2 readingOptions:(NSUInteger)arg3 wantsCurrentVersion:(BOOL)arg4 reply:(void (^)(NSError *))arg5;
- (void)startDownloadItemsAtURLs:(NSArray *)arg1 options:(NSUInteger)arg2 reply:(void (^)(NSError *))arg3;
...
- (void)forceSyncZoneHealthWithBarrierWithTimeout:(NSUInteger)arg1 reply:(void (^)(NSError *))arg2;
- (void)forceSyncWithBarrierContainerID:(NSString *)arg1 timeout:(NSUInteger)arg2 reply:(void (^)(NSError *))arg3;
