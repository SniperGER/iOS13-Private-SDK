...
@interface MetalRANSACDispatcher : NSObject
{
    ...
    NSUInteger _m_numThreadsPerGroup;
    NSUInteger _m_maxCorrespondences;
    id <MTLBuffer> _m_mX;
...
@property(nonatomic) NSUInteger m_maxCorrespondences; // @synthesize m_maxCorrespondences=_m_maxCorrespondences;
@property(nonatomic) NSUInteger m_numThreadsPerGroup; // @synthesize m_numThreadsPerGroup=_m_numThreadsPerGroup;
@property(nonatomic) CGSize frameSize; // @synthesize frameSize;
...
// - (void).cxx_destruct;
- (void)assureSizeAndCopyToMetalBuffer:(id )arg1 fromData:(const void *)arg2 dataSize:(NSUInteger)arg3 metalResourceOptions:(NSUInteger)arg4;
...
- (id)initWithMaxCorrespondences:(NSUInteger)arg1;
