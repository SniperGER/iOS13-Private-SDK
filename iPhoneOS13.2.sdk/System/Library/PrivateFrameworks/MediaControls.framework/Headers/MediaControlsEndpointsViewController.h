...
@property(copy, nonatomic) id /* block */ homeGestureDismissalAllowedBlock; // @synthesize homeGestureDismissalAllowedBlock=_homeGestureDismissalAllowedBlock;
@property(copy, nonatomic) id /* block */ routingCornerViewTappedBlock; // @synthesize routingCornerViewTappedBlock=_routingCornerViewTappedBlock;
...
- (void)dismissPresentedContentAnimated:(_Bool)arg1 completion:(id /* block */)arg2;
