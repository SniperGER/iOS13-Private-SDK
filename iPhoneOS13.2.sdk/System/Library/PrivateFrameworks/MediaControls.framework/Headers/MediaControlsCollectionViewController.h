...
@property(copy, nonatomic) id /* block */ dismissalBlock; // @synthesize dismissalBlock=_dismissalBlock;
...
- (void)_transitionTopAndBottomViewControllersToVisible:(_Bool)arg1 completion:(id /* block */)arg2;
