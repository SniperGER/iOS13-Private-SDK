...
@interface CUIShapeEffectStack : NSObject
{
    ...
    NSUInteger _hueSaturationCount;
//     CDStruct_2844c7c7 _hueSaturation;
    NSUInteger _colorOverlayCount;
//     CDStruct_073a3662 _colorOverlay;
    NSUInteger _innerGradientCount;
//     CDStruct_bdea167c _innerGradient;
    NSUInteger _innerGlowCount;
//     CDStruct_3d979a67 _innerGlow;
    NSUInteger _innerShadowCount;
//     CDStruct_a5d4af33 _innerShadow;
    NSUInteger _outerGlowCount;
//     CDStruct_265c7ca9 _outerGlow;
    NSUInteger _engraveShadowCount;
//     CDStruct_ca46f23f _engraveShadow;
    NSUInteger _extraShadowCount;
//     CDStruct_ca46f23f _extraShadow;
    NSUInteger _bevelEmbossCount;
...
+ (id)outerShadowFrom:(id)arg1 withOffset:(CGPoint)arg2 size:(unsigned int)arg3 spread:(unsigned int)arg4 red:(float)arg5 green:(float)arg6 blue:(float)arg7 opacity:(float)arg8;
...
// + (id)gradientWithParameters:(CDStruct_bdea167c )arg1 inRect:(CGRect)arg2;
...
@property(readonly, nonatomic) NSUInteger bevelEmbossCount; // @synthesize bevelEmbossCount=_bevelEmbossCount;
// @property(readonly, nonatomic) CDStruct_ca46f23f extraShadow; // @synthesize extraShadow=_extraShadow;
@property(readonly, nonatomic) NSUInteger extraShadowCount; // @synthesize extraShadowCount=_extraShadowCount;
// @property(readonly, nonatomic) CDStruct_ca46f23f engraveShadow; // @synthesize engraveShadow=_engraveShadow;
@property(nonatomic) NSUInteger engraveShadowCount; // @synthesize engraveShadowCount=_engraveShadowCount;
// @property(readonly, nonatomic) CDStruct_265c7ca9 outerGlow; // @synthesize outerGlow=_outerGlow;
@property(readonly, nonatomic) NSUInteger outerGlowCount; // @synthesize outerGlowCount=_outerGlowCount;
// @property(readonly, nonatomic) CDStruct_a5d4af33 innerShadow; // @synthesize innerShadow=_innerShadow;
@property(nonatomic) NSUInteger innerShadowCount; // @synthesize innerShadowCount=_innerShadowCount;
// @property(readonly, nonatomic) CDStruct_3d979a67 innerGlow; // @synthesize innerGlow=_innerGlow;
@property(nonatomic) NSUInteger innerGlowCount; // @synthesize innerGlowCount=_innerGlowCount;
// @property(readonly, nonatomic) CDStruct_bdea167c innerGradient; // @synthesize innerGradient=_innerGradient;
@property(nonatomic) NSUInteger innerGradientCount; // @synthesize innerGradientCount=_innerGradientCount;
// @property(readonly, nonatomic) CDStruct_073a3662 colorOverlay; // @synthesize colorOverlay=_colorOverlay;
@property(nonatomic) NSUInteger colorOverlayCount; // @synthesize colorOverlayCount=_colorOverlayCount;
// @property(readonly, nonatomic) CDStruct_2844c7c7 hueSaturation; // @synthesize hueSaturation=_hueSaturation;
@property(readonly, nonatomic) NSUInteger hueSaturationCount; // @synthesize hueSaturationCount=_hueSaturationCount;
...
- (void)_setHueSaturationAtIndex:(NSUInteger)arg1 fromPreset:(id)arg2 index:(unsigned int)arg3;
- (BOOL)hasEffects;
- (BOOL)hasBevelEmboss;
- (void)_setBevelEmbossAtIndex:(NSUInteger)arg1 fromPreset:(id)arg2 index:(unsigned int)arg3;
- (BOOL)hasExtraShadow;
- (void)_setExtraShadowAtIndex:(NSUInteger)arg1 fromPreset:(id)arg2 index:(unsigned int)arg3;
- (BOOL)hasEngraveShadow;
- (void)_setEngraveShadowAtIndex:(NSUInteger)arg1 fromPreset:(id)arg2 index:(unsigned int)arg3;
- (BOOL)hasOuterGlow;
- (void)_setOuterGlowAtIndex:(NSUInteger)arg1 fromPreset:(id)arg2 index:(unsigned int)arg3;
- (BOOL)hasInnerShadow;
- (void)_setInnerShadowAtIndex:(NSUInteger)arg1 fromPreset:(id)arg2 index:(unsigned int)arg3;
- (BOOL)hasInnerGlow;
- (void)_setInnerGlowAtIndex:(NSUInteger)arg1 fromPreset:(id)arg2 index:(unsigned int)arg3;
- (float)innerGradientOpacity;
- (BOOL)hasInnerGradient;
- (void)_setInteriorGradientAtIndex:(NSUInteger)arg1 fromPreset:(id)arg2 index:(unsigned int)arg3;
- (float)colorOverlayOpacity;
- (BOOL)hasColorOverlay;
- (void)_setColorFillAtIndex:(NSUInteger)arg1 FromPreset:(id)arg2 index:(unsigned int)arg3;
