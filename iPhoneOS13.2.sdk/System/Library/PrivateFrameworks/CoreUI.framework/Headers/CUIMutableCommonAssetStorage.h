...
// - (void)setRenditionKey:(const struct _renditionkeytoken )arg1 hotSpot:(CGPoint)arg2 forName:(const char )arg3;
- (BOOL)removeAssetNameKey:(const void *)arg1 withLength:(NSUInteger)arg2;
- (BOOL)removeAssetName:(id)arg1;
- (void)removeAssetForKey:(const void *)arg1 withLength:(NSUInteger)arg2;
...
- (BOOL)setAsset:(id)arg1 forKey:(const void *)arg2 withLength:(NSUInteger)arg3;
