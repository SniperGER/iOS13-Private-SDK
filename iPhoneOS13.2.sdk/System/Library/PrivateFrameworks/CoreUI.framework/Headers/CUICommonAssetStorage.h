...
+ (BOOL)isValidAssetStorageWithBytes:(const void *)arg1 length:(NSUInteger)arg2;
...
// - (const struct _renditionkeytoken )renditionKeyForName:(const char )arg1 hotSpot:(CGPoint )arg2;
...
- (BOOL)assetExistsForKeyData:(const void *)arg1 length:(NSUInteger)arg2;
