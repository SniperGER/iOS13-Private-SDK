...
- (CGImageRef)_copyCGImageAtAbsoluteIndex:(unsigned int)arg1;
...
- (CGRect)_boundsAtAbsoluteIndex:(unsigned int)arg1;
...
// - (CDStruct_1ba92a5e)metricsInMask:(id)arg1 forRect:(CGRect)arg2;
// - (CDStruct_1ba92a5e)metricsInAlphaChannel:(long long)arg1 forRect:(CGRect)arg2;
...
- (CGRect)boundsForSlice:(unsigned int)arg1;
- (CGRect)boundsAtLayer:(unsigned int)arg1;
...
- (CGImageRef)createCGImageAtLayer:(unsigned int)arg1;
