...
- (void)drawUsingQuartz:(id /* block */)arg1 inContext:(struct CGContext *)arg2 inBounds:(struct CGRect)arg3 atScale:(double)arg4;
- (void)_drawShadow:(CDStruct_ca46f23f)arg1 usingQuartz:(id /* block */)arg2 inContext:(struct CGContext *)arg3;
