...
@interface CSIGenerator : NSObject
{
    ...
    NSSet *_externalTags;
    CGRect _externalRef erenceFrame;
...
@property(nonatomic) CGSize physicalSizeInMeters; // @synthesize physicalSizeInMeters=_physicalSizeInMeters;
...
- (NSUInteger)writeRecognitionObjectToData:(id)arg1;
- (NSUInteger)writeTextureToData:(id)arg1;
- (NSUInteger)writeExternalLinkToData:(id)arg1;
- (NSUInteger)writeRawDataToData:(id)arg1;
- (NSUInteger)writeMultisizeImageSetToData:(id)arg1;
- (NSUInteger)writeTextStyleToData:(id)arg1;
- (NSUInteger)writeColorToData:(id)arg1;
- (NSUInteger)writeGradientToData:(id)arg1;
// - (void)_addNodes:(id)arg1 toNodeList:(struct _csigradientdatanode )arg2;
- (NSUInteger)writeBitmap:(id)arg1 toData:(id)arg2 compress:(BOOL)arg3;
- (NSUInteger)writeResourcesToData:(id)arg1;
...
- (id)initWithColorNamed:(id)arg1 colorSpaceID:(NSUInteger)arg2 components:(id)arg3 linkedToSystemColorWithName:(id)arg4;
- (id)initWithColorNamed:(id)arg1 colorSpaceID:(NSUInteger)arg2 components:(id)arg3;
...
- (id)initWithCanvasSize:(CGSize)arg1 sliceCount:(unsigned int)arg2 layout:(short)arg3;
