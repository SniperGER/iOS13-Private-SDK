...
- (void)_configureWithRequestedCard:(id)arg1 animated:(_Bool)arg2 completion:(id /* block */)arg3;
- (void)_fullyConfigureWithRequestedCard:(id)arg1 animated:(_Bool)arg2 completion:(id /* block */)arg3;
...
- (void)setConfiguration:(id)arg1 animated:(_Bool)arg2 completion:(id /* block */)arg3;
- (id)init;
