...
// - (void).cxx_destruct;
- (id)_stackLayerWithImages:(id)arg1 filters:(id)arg2 size:(CGSize)arg3 contentsScale:(double)arg4 insets:(UIEdgeInsets )arg5 path:(const CGPathRef)arg6;
- (id)newOperationWithImages:(id)arg1 filters:(id)arg2 size:(CGSize)arg3 contentsScale:(double)arg4 completion:(CDUnknownBlockType)arg5;
