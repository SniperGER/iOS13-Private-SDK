...
// - (void)processMetadataForDatagram:(char )arg1 size:(NSUInteger)arg2 datagramInfo:(CDStruct_54fea20c )arg3 options:(CDStruct_6bf83f29 )arg4;
...
- (void)_logReceivingStats:(NSUInteger)arg1;
- (void)_logSendingStats:(NSUInteger)arg1;
- (id)description;
- (void)dealloc;
- (id)cachedMetadata;
