...
@property(readonly, nonatomic) NSUInteger initialLinkType; // @synthesize initialLinkType=_initialLinkType;
...
- (NSUInteger)MTUForAddressFamily:(NSUInteger)arg1;
...
- (id)_initWithAccount:(id)arg1 destinations:(id)arg2 transportType:(long long)arg3 connectionCountHint:(NSUInteger)arg4 needsToWaitForPreConnectionData:(BOOL)arg5 uniqueID:(id)arg6 delegateContext:(id)arg7;
- (id)daemonController;
- (id)daemonListener;
