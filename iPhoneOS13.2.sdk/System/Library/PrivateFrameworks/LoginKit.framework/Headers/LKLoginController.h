...
- (id)recentUsers;
- (void)checkInWithCurrentEnvironment:(NSUInteger)arg1 completionHandler:(CDUnknownBlockType)arg2;
...
- (void)logoutWithLogoutType:(NSUInteger)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (id)proxy;
- (id)init;
