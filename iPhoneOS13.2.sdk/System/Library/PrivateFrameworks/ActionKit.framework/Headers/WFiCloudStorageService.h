...
- (void)appendText:(id)arg1 toPath:(id)arg2 options:(NSUInteger)arg3 completionHandler:(CDUnknownBlockType)arg4;
...
- (id)saveFiles:(id)arg1 withUserInterface:(id)arg2 options:(NSUInteger)arg3 progress:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;
- (id)saveFiles:(id)arg1 toPath:(id)arg2 options:(NSUInteger)arg3 progress:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;
- (void)retrieveFilesWithUserInterface:(id)arg1 initialDirectoryPath:(id)arg2 options:(NSUInteger)arg3 progress:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;
- (void)retrieveFilesAtPath:(id)arg1 options:(NSUInteger)arg2 progress:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;
