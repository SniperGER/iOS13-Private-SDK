...
- (_Bool)copyContentsOfPath:(id)arg1 toFileAtPath:(id)arg2 progress:(id /* block */)arg3;
- (_Bool)writeStream:(id)arg1 toSFTPHandle:(struct _LIBSSH2_SFTP_HANDLE *)arg2 progress:(id /* block */)arg3;
...
- (_Bool)writeStream:(id)arg1 toFileAtPath:(id)arg2 progress:(id /* block */)arg3;
- (_Bool)writeStream:(id)arg1 toFileAtPath:(id)arg2;
- (_Bool)writeFileAtPath:(id)arg1 toFileAtPath:(id)arg2 progress:(id /* block */)arg3;
- (_Bool)writeFileAtPath:(id)arg1 toFileAtPath:(id)arg2;
- (_Bool)writeContents:(id)arg1 toFileAtPath:(id)arg2 progress:(id /* block */)arg3;
