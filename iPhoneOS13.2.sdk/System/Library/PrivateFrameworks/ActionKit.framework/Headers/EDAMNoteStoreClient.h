...
- (id)getNotebookSharesEmailAddresses:(id)arg1 notebookGuid:(id)arg2 identities:(id)arg3 skipUnknownUserIdentities:(_Bool)arg4;
- (void)unpublishNotebook:(id)arg1 notebookGuid:(id)arg2 convertGroupSharesToIndividual:(_Bool)arg3;
