...
+ (id)HTMLDocumentWithString:(id)arg1 encoding:(NSUInteger)arg2 error:(id )arg3;
+ (id)XMLDocumentWithData:(id)arg1 error:(id )arg2;
+ (id)XMLDocumentWithString:(id)arg1 encoding:(NSUInteger)arg2 error:(id )arg3;
...
@property(nonatomic) NSUInteger stringEncoding; // @synthesize stringEncoding=_stringEncoding;
