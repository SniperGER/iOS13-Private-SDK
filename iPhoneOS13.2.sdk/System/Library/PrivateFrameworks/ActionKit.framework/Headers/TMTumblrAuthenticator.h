...
@property(copy, nonatomic) id /* block */ threeLeggedOAuthCallback; // @synthesize threeLeggedOAuthCallback=_threeLeggedOAuthCallback;
...
- (void)authenticate:(id)arg1 webView:(id)arg2 callback:(id /* block */)arg3;
