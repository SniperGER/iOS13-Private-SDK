...
@property(readonly, nonatomic) NSUInteger condition; // @synthesize condition=_condition;
...
- (NSUInteger)weatherConditionForConditionCode:(NSUInteger)arg1;
