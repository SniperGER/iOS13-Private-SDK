...
//     struct _LIBSSH2_AGENT _agent;
    id /* CDUnknownBlockType */ _kbAuthenticationBlock;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ kbAuthenticationBlock; // @synthesize kbAuthenticationBlock=_kbAuthenticationBlock;
