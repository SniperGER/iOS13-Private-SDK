...
@property(copy, nonatomic) id /* block */ kbAuthenticationBlock; // @synthesize kbAuthenticationBlock=_kbAuthenticationBlock;
...
- (_Bool)authenticateByKeyboardInteractiveUsingBlock:(id /* block */)arg1;
