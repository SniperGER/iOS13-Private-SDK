...
- (NSArray *)listBusinessInvitations:(NSString *)arg1 includeRequestedInvitations:(_Bool)arg2;
...
- (EDAMAuthenticationResult *)authenticateOpenID:(EDAMOpenIdCredential *)arg1 consumerKey:(NSString *)arg2 consumerSecret:(NSString *)arg3 deviceIdentifier:(NSString *)arg4 deviceDescription:(NSString *)arg5 authLongSession:(_Bool)arg6 supportsTwoFactor:(_Bool)arg7;
