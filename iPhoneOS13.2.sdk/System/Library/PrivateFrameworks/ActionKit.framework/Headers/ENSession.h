...
@interface ENSession : NSObject <ENLinkedNoteStoreClientDelegate, ENBusinessNoteStoreClientDelegate, ENAuthenticatorDelegate>
{
    ...
    id /* CDUnknownBlockType */ _authenticationCompletion;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ authenticationCompletion; // @synthesize authenticationCompletion=_authenticationCompletion;
...
- (void)downloadThumbnailForNote:(id)arg1 maxDimension:(NSUInteger)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)findNotesWithSearch:(id)arg1 inNotebook:(id)arg2 orScope:(NSUInteger)arg3 sortOrder:(NSUInteger)arg4 maxResults:(NSUInteger)arg5 completion:(CDUnknownBlockType)arg6;
