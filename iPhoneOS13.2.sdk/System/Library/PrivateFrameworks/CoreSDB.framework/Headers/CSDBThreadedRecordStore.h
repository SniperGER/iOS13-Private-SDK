...
- (void)performBlock:(id /* block */)arg1 waitUntilDone:(_Bool)arg2;
...
- (void)setupDatabaseWithAllowLocalMigration:(_Bool)arg1 pathBlock:(id /* block */)arg2 setupStoreHandler:(CDUnknownFunctionPointerType)arg3 connectionInitializer:(CDUnknownFunctionPointerType)arg4 versionChecker:(CDUnknownFunctionPointerType)arg5 migrationHandler:(CDUnknownFunctionPointerType)arg6 schemaVersion:(int)arg7 dataProtectionClass:(unsigned int)arg8 registerBlock:(id /* block */)arg9;
- (void)setupDatabaseWithAllowLocalMigration:(_Bool)arg1 pathBlock:(id /* block */)arg2 setupStoreHandler:(CDUnknownFunctionPointerType)arg3 connectionInitializer:(CDUnknownFunctionPointerType)arg4 versionChecker:(CDUnknownFunctionPointerType)arg5 migrationHandler:(CDUnknownFunctionPointerType)arg6 schemaVersion:(int)arg7 dataProtectionClass:(unsigned int)arg8 registerBlock:(id /* block */)arg9 exclusiveOwnership:(_Bool)arg10;
- (void)dealloc;
