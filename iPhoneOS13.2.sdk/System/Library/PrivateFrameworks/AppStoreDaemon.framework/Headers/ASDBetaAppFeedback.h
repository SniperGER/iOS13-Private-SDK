...
@interface ASDBetaAppFeedback : NSObject <NSSecureCoding>
{
    ...
    NSUInteger _diskAvailable;
    NSUInteger _diskTotal;
    NSString *_locale;
...
@property NSUInteger diskTotal; // @synthesize diskTotal=_diskTotal;
@property NSUInteger diskAvailable; // @synthesize diskAvailable=_diskAvailable;
...
@property NSUInteger appUptime; // @synthesize appUptime=_appUptime;
@property NSUInteger timestamp; // @synthesize timestamp=_timestamp;
