...
+ (id)sharedInstance;
// - (void).cxx_destruct;
- (void)updateWithContext:(NSUInteger)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;
- (void)updateWithCompletionHandler:(CDUnknownBlockType)arg1;
- (void)updateForAccountID:(long long)arg1 withContext:(NSUInteger)arg2 withCompletionHandler:(CDUnknownBlockType)arg3;
