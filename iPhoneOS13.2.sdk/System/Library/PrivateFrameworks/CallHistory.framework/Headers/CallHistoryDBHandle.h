...
- (id)fetchManagedCallsWithPredicate:(id)arg1 sortDescriptors:(id)arg2 limit:(NSUInteger)arg3 offset:(NSUInteger)arg4 batchSize:(NSUInteger)arg5;
- (NSUInteger)fetchManagedCallCountWithPredicate:(id)arg1 sortDescriptors:(id)arg2;
