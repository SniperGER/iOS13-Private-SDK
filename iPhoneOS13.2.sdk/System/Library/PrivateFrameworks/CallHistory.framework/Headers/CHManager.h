...
- (id)coalescedCallsWithPredicate:(id)arg1 limit:(NSUInteger)arg2 offset:(NSUInteger)arg3 batchSize:(NSUInteger)arg4;
- (NSUInteger)coalescedCallCountWithPredicate:(id)arg1;
- (id)callsWithPredicate:(id)arg1 limit:(NSUInteger)arg2 offset:(NSUInteger)arg3 batchSize:(NSUInteger)arg4;
- (NSUInteger)callCountWithPredicate:(id)arg1;
...
- (void)deleteCallAtIndex:(NSUInteger)arg1;
...
- (NSUInteger)fetchUnreadCallsCount;
- (NSUInteger)countCallsWithPredicate:(id)arg1;
- (NSUInteger)countCallsWithPredicateSync:(id)arg1;
