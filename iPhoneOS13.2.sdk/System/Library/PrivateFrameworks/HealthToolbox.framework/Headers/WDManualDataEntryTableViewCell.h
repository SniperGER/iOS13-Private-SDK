...
@property(nonatomic) BOOL shouldHighlightWhenEditing; // @synthesize shouldHighlightWhenEditing=_shouldHighlightWhenEditing;
...
- (id)initWithDisplayName:(id)arg1 unitName:(id)arg2 dataEntryType:(NSUInteger)arg3;
