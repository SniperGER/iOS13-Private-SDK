...
@class HKSampleCountQuery, NSMutableDictionary, WDProfile;
...
+ (id)_atrialFibrillationClassificationPredicateWithValue:(NSUInteger)arg1;
...
- (id)_filterSamples:(id)arg1 matchingAtrialFibrillationClassification:(NSUInteger)arg2;
