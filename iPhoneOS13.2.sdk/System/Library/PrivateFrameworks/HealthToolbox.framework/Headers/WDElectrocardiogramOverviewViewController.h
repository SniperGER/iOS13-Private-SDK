...
@class HKDisplayType, HKHeartRhythmAvailability, HROnboardingManager, UITapGestureRecognizer, WDElectrocardiogramFilterDataProvider, WDElectrocardiogramListDataProvider, WDProfile;
