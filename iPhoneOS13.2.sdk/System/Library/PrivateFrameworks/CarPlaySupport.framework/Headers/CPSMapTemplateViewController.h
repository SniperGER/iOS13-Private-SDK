...
- (void)_setNavigationAlertView:(id)arg1 visible:(_Bool)arg2 animated:(_Bool)arg3 completion:(id /* block */)arg4;
- (void)updateNavigationAlert:(id)arg1;
- (void)_performAlertSizingForAlert:(id)arg1 animated:(_Bool)arg2;
- (void)dismissNavigationAlertAnimated:(_Bool)arg1 completion:(id /* block */)arg2;
