...
- (void)pushSearchTemplate:(id)arg1 withProxyDelegate:(id)arg2 animated:(id)arg3 presentationStyle:(NSUInteger)arg4 reply:(CDUnknownBlockType)arg5;
- (void)pushListTemplate:(id)arg1 withProxyDelegate:(id)arg2 animated:(id)arg3 presentationStyle:(NSUInteger)arg4 reply:(CDUnknownBlockType)arg5;
- (void)pushMapTemplate:(id)arg1 withProxyDelegate:(id)arg2 animated:(id)arg3 presentationStyle:(NSUInteger)arg4 reply:(CDUnknownBlockType)arg5;
- (void)pushGridTemplate:(id)arg1 withProxyDelegate:(id)arg2 animated:(id)arg3 presentationStyle:(NSUInteger)arg4 reply:(CDUnknownBlockType)arg5;
