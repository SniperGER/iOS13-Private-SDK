...
- (id)initWithResults:(id)arg1 cardSection:(id)arg2 queryId:(NSUInteger)arg3;
- (id)initWithResults:(id)arg1;
- (id)initWithCardSection:(id)arg1 queryId:(NSUInteger)arg2;
- (id)initWithResult:(id)arg1 cardSection:(id)arg2 queryId:(NSUInteger)arg3;
