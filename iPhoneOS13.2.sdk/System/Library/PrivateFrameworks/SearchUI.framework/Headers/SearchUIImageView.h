...
- (void)layoutSubviews;
- (void)updateWithImage:(id)arg1 needsOverlayButton:(_Bool)arg2 preventImageScaling:(_Bool)arg3 useMinimumWidthIfPossible:(_Bool)arg4 completionHandler:(id /* block */)arg5;
