...
@property(copy, nonatomic) id /* block */ cellWillDisplayHandler; // @synthesize cellWillDisplayHandler;
@property(copy, nonatomic) id /* block */ tableViewDidUpdateHandler; // @synthesize tableViewDidUpdateHandler;
@property(copy, nonatomic) id /* block */ tableViewWillUpdateHandler; // @synthesize tableViewWillUpdateHandler;
