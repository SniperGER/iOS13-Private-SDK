...
@property(copy, nonatomic) id /* block */ streamDidBecomeReadyToTransferRecords; // @synthesize streamDidBecomeReadyToTransferRecords=_streamDidBecomeReadyToTransferRecords;
- (void)suspend;
- (void)close;
- (void)cancel;
- (void)resume;
