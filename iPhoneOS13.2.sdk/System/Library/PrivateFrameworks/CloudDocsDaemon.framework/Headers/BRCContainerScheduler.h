...
- (void)finishedZoneHealthSyncDownWithRequestID:(NSUInteger)arg1 error:(id)arg2;
- (void)receivedUpdatedZoneHealthServerChangeToken:(id)arg1 requestID:(NSUInteger)arg2;
