...
- (void)_collectTombstoneForRank:(NSUInteger)arg1;
- (NSUInteger)didSyncDownRequestID:(NSUInteger)arg1 serverChangeToken:(id)arg2 editedRecords:(id)arg3 deletedRecordIDs:(id)arg4 deletedShareRecordIDs:(id)arg5 movedZoneNames:(id)arg6 allocRankZones:(id )arg7 syncStatus:(long long)arg8;
- (void)handleBrokenStructure;
- (BOOL)allocateRanks;
- (BOOL)fixupLocalSharingOptions;
- (long long)_fixupSharingOptions:(NSUInteger)arg1 underParentID:(id)arg2;
...
- (BOOL)_saveItemID:(id)arg1 version:(id)arg2 record:(id)arg3 iWorkSharingOptions:(NSUInteger)arg4;
