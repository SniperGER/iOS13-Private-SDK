...
//  (struct PQLResultSet )itemsEnumeratorChildOf:(id)arg1 rankMin:(NSUInteger)arg2 rankMax:(NSUInteger)arg3 count:(NSUInteger)arg4 db:(id)arg5;
//  (struct PQLResultSet )itemsEnumeratorWithRankMin:(NSUInteger)arg1 rankMax:(NSUInteger)arg2 namePrefix:(id)arg3 shouldIncludeFolders:(BOOL)arg4 shouldIncludeOnlyFolders:(BOOL)arg5 shouldIncludeDocumentsScope:(BOOL)arg6 shouldIncludeDataScope:(BOOL)arg7 shouldIncludeExternalScope:(BOOL)arg8 shouldIncludeTrashScope:(BOOL)arg9 count:(NSUInteger)arg10 db:(id)arg11;
