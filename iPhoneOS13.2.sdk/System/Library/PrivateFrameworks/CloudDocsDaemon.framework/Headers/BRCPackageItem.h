...
//  (struct PQLResultSet )packageItemsForItem:(id)arg1 order:(NSUInteger)arg2;
//  (struct PQLResultSet )packageItemsForDocumentID:(unsigned int)arg1 order:(NSUInteger)arg2 session:(id)arg3;
...
@property(readonly, nonatomic) NSUInteger fileID; // @synthesize fileID=_fileID;
@property(readonly, nonatomic) NSUInteger packageDocumentID; // @synthesize packageDocumentID=_packageID;
