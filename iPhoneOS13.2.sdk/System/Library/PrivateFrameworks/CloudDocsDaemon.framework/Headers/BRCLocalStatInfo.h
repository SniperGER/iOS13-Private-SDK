...
- (NSUInteger)diffAgainstLocalInfo:(id)arg1;
- (void)_clearBouncedName;
- (void)_bouncePhysicalNameToRepresentableName;
- (void)_migrateTmpBouncedNameToLocalName;
- (void)_generatedBouncedLogicalFilenameWithBounceNumber:(NSUInteger)arg1;
...
- (void)updateItemModeFromSharingOptions:(NSUInteger)arg1;
