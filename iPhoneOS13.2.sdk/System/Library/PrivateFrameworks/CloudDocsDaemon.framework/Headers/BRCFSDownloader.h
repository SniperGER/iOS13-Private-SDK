...
@class BRCDeadlineScheduler, BRCFairScheduler, NSDate, NSMutableDictionary, brc_task_tracker;
...
// - (void).cxx_destruct;
- (void)transferStreamOfSyncContext:(id)arg1 didBecomeReadyWithMaxRecordsCount:(NSUInteger)arg2 sizeHint:(NSUInteger)arg3 priority:(long long)arg4 completionBlock:(CDUnknownBlockType)arg5;
- (void)_transferStreamOfSyncContext:(id)arg1 didBecomeReadyWithMaxRecordsCount:(NSUInteger)arg2 sizeHint:(NSUInteger)arg3 priority:(long long)arg4;
- (void)_sendLosersBatch:(id)arg1 sizeHint:(long long)arg2 maxRecordsCount:(NSUInteger)arg3;
- (void)_postponeLoserForWinner:(long long)arg1 etag:(id)arg2;
- (void)_sendContentsBatch:(id)arg1 sizeHint:(long long)arg2 maxRecordsCount:(NSUInteger)arg3;
- (NSUInteger)inFlightSize;
- (void)_sendThumbnailsBatch:(id)arg1 sizeHint:(long long)arg2 maxRecordsCount:(NSUInteger)arg3;
- (void)schedule;
...
- (void)rescheduleJobsForPendingDiskSpaceWithAvailableSpace:(NSUInteger)arg1;
