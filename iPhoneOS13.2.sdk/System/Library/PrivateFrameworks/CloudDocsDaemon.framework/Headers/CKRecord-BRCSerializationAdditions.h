...
- (void)serializeVersion:(id)arg1 diffs:(NSUInteger)arg2 deadInServerTruth:(BOOL)arg3;
- (void)serializeStatInfo:(id)arg1 diffs:(NSUInteger)arg2 stageID:(id)arg3 deadInServerTruth:(BOOL)arg4 pcsChaining:(BOOL)arg5;
...
- (void)deserializeFolderSharingOptions:(NSUInteger )arg1;
- (BOOL)deserializeiWorkSharingOptions:(NSUInteger )arg1 error:(id )arg2;
- (void)_deserializeRootSharingOptions:(NSUInteger )arg1;
