...
@interface BRCServerChangeState : NSObject <NSSecureCoding, NSCopying>
{
    ...
    NSUInteger _clientRequestID;
}

+ (BOOL)supportsSecureCoding;
@property(nonatomic) NSUInteger clientRequestID; // @synthesize clientRequestID=_clientRequestID;
...
- (BOOL)updateWithServerChangeToken:(id)arg1 clientRequestID:(NSUInteger)arg2 syncDownStatus:(long long)arg3;
