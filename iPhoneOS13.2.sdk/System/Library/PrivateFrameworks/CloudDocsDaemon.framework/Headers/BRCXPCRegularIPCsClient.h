...
- (void)_t_migrateAllZonesToClouddocsWithReset:(_Bool)arg1 onlyPrepare:(_Bool)arg2 reply:(id /* block */)arg3;
...
- (void)_t_resetZoneForContainerID:(id)arg1 waitUntilIdle:(_Bool)arg2 includingSharedZones:(_Bool)arg3 reply:(id /* block */)arg4;
- (void)_t_setFSEventProcessingState:(_Bool)arg1 reply:(id /* block */)arg2;
...
- (void)startOperation:(id)arg1 toModifyRecordAccessAtURL:(id)arg2 allowAccess:(_Bool)arg3 reply:(id /* block */)arg4;
- (void)startOperation:(id)arg1 toLookupShareParticipants:(id)arg2 reply:(id /* block */)arg3;
- (void)startOperation:(id)arg1 toUnshareShare:(id)arg2 forceDelete:(_Bool)arg3 reply:(id /* block */)arg4;
...
- (void)startOperation:(id)arg1 toCopyDocumentURLForRecordID:(id)arg2 syncIfNeeded:(_Bool)arg3 reply:(id /* block */)arg4;
...
- (void)setiWorkPublishingInfoAtURL:(id)arg1 publish:(_Bool)arg2 readonly:(_Bool)arg3 reply:(id /* block */)arg4;
- (void)forceConflictForURL:(id)arg1 bookmarkData:(id)arg2 forcedEtag:(id)arg3 reply:(id /* block */)arg4;
- (void)getPublishedURLForItemAtURL:(id)arg1 forStreaming:(_Bool)arg2 requestedTTL:(unsigned long long)arg3 reply:(id /* block */)arg4;
...
- (_Bool)_enumerateFoldersWithParent:(id)arg1 depth:(unsigned long long)arg2 session:(id)arg3 db:(id)arg4 handler:(id /* block */)arg5;
...
- (void)getApplicationStatusForProcess:(CDStruct_4c969caf)arg1 reply:(id /* block */)arg2;
...
- (void)getBookmarkDataForURL:(id)arg1 onlyAllowItemKnowByServer:(_Bool)arg2 allowAccessByBundleID:(id)arg3 reply:(id /* block */)arg4;
- (void)getMigrationStatusForPrimaryiCloudAccount:(id /* block */)arg1;
- (void)setMigrationStatus:(BOOL)arg1 forDSID:(id)arg2 shouldUpdateAccount:(_Bool)arg3 reply:(id /* block */)arg4;
...
- (void)iWorkForceSyncContainerID:(id)arg1 ownedByMe:(_Bool)arg2 reply:(id /* block */)arg3;
...
- (void)simulateHealthIssueWithContainer:(id)arg1 status:(id)arg2 brokenStructure:(_Bool)arg3 reply:(id /* block */)arg4;
- (void)gatherInformationForPath:(id)arg1 reply:(id /* block */)arg2;
- (void)dumpCoordinationInfoTo:(id)arg1 reply:(id /* block */)arg2;
- (void)dumpDatabaseTo:(id)arg1 containerID:(id)arg2 includeAllItems:(_Bool)arg3 reply:(id /* block */)arg4;
...
- (void)setStorageOpimizationEnabled:(_Bool)arg1 reply:(id /* block */)arg2;
...
- (void)getNonLocalVersionSenderWithReceiver:(id)arg1 documentURL:(id)arg2 includeCachedVersions:(_Bool)arg3 reply:(id /* block */)arg4;
...
- (void)startOperation:(id)arg1 toDownloadItemAtURL:(id)arg2 readingOptions:(unsigned long long)arg3 wantsCurrentVersion:(_Bool)arg4 reply:(id /* block */)arg5;
...
- (void)deleteAllContentsOfContainerID:(id)arg1 onClient:(_Bool)arg2 onServer:(_Bool)arg3 wait:(_Bool)arg4 reply:(id /* block */)arg5;
- (oneway void)updateContainerMetadataForID:(id)arg1;
- (void)getContainerURLForID:(id)arg1 forProcess:(CDStruct_4c969caf)arg2 reply:(id /* block */)arg3;
- (void)presyncContainerWithID:(id)arg1 reply:(id /* block */)arg2;
- (void)getContainerURLForID:(id)arg1 reply:(id /* block */)arg2;
- (void)getContainerURLForID:(id)arg1 recreateDocumentsIfNeeded:(_Bool)arg2 reply:(id /* block */)arg3;
