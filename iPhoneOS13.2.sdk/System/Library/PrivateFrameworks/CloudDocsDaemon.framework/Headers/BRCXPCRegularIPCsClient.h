...
- (void)overwriteAccessTimeForItemAtURL:(id)arg1 atime:(NSUInteger)arg2 reply:(CDUnknownBlockType)arg3;
...
- (void)getPublishedURLForItemAtURL:(id)arg1 forStreaming:(BOOL)arg2 requestedTTL:(NSUInteger)arg3 reply:(CDUnknownBlockType)arg4;
- (void)enumerateWorkingSetChangesFromChangeToken:(id)arg1 limit:(NSUInteger)arg2 completion:(CDUnknownBlockType)arg3;
- (void)enumerateAllFoldersWithSortOrder:(unsigned char)arg1 offset:(NSUInteger)arg2 limit:(NSUInteger)arg3 completion:(CDUnknownBlockType)arg4;
- (BOOL)_enumerateFoldersWithParent:(id)arg1 depth:(NSUInteger)arg2 session:(id)arg3 db:(id)arg4 handler:(CDUnknownBlockType)arg5;
- (void)enumerateItemsInFolder:(id)arg1 sortOrder:(unsigned char)arg2 offset:(NSUInteger)arg3 limit:(NSUInteger)arg4 completion:(CDUnknownBlockType)arg5;
...
- (void)forceSyncWithBarrierContainerID:(id)arg1 timeout:(NSUInteger)arg2 reply:(CDUnknownBlockType)arg3;
- (void)forceSyncZoneHealthWithBarrierWithTimeout:(NSUInteger)arg1 reply:(CDUnknownBlockType)arg2;
...
- (void)evictItemAtURL:(id)arg1 options:(NSUInteger)arg2 reply:(CDUnknownBlockType)arg3;
- (void)startOperation:(id)arg1 toDownloadItemAtURL:(id)arg2 readingOptions:(NSUInteger)arg3 wantsCurrentVersion:(BOOL)arg4 reply:(CDUnknownBlockType)arg5;
- (void)startDownloadItemsAtURLs:(id)arg1 options:(NSUInteger)arg2 reply:(CDUnknownBlockType)arg3;
