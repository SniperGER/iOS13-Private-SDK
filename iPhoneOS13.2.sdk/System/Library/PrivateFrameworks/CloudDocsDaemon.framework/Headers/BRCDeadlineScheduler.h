...
@interface BRCDeadlineScheduler : NSObject <BRCLifeCycle, BRCSuspendable>
{
    ...
    BOOL _isCancelled;
    id /* CDUnknownBlockType */ _computeNextAdmissibleDateForScheduling;
}
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ computeNextAdmissibleDateForScheduling; // @synthesize computeNextAdmissibleDateForScheduling=_computeNextAdmissibleDateForScheduling;
