...
@interface BRCNotificationPipe : NSObject <BRItemNotificationSending>
{
    ...
    id /* CDUnknownBlockType */ _boostReply;
...
- (void)processUpdates:(id)arg1 withRank:(NSUInteger)arg2;
- (void)_addIntraContainerUpdatesFromInterContainerUpdate:(id)arg1 toArray:(id)arg2;
- (int)_isInterestingUpdate:(id)arg1;
@property(readonly, copy) NSString *description;
- (id)initWithReceiver:(id)arg1 manager:(id)arg2 startingRank:(NSUInteger)arg3;
- (id)initWithXPCReceiver:(id)arg1 client:(id)arg2 manager:(id)arg3 startingRank:(NSUInteger)arg4;
- (id)_initWithManager:(id)arg1 startingRank:(NSUInteger)arg2;
