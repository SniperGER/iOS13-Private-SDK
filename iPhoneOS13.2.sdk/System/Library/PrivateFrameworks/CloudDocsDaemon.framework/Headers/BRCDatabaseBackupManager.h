...
- (void)cleanOnDisk;
- (_Bool)enumerateURL:(id)arg1 rootURL:(id)arg2 usingBlock:(id /* block */)arg3 error:(id *)arg4;
- (_Bool)enumerateRootURL:(id)arg1 usingBlock:(id /* block */)arg2 error:(id *)arg3;
