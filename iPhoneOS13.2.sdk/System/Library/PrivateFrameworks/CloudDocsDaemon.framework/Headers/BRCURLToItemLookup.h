...
@property(readonly, nonatomic) NSUInteger faultedDiffs; // @synthesize faultedDiffs=_faultedDiffs;
...
- (void)clearByIDItem;
@property(readonly, nonatomic) NSUInteger byIDDiffs; // @synthesize byIDDiffs=_byIDDiffs;
...
@property(readonly, nonatomic) NSUInteger byPathDiffs; // @synthesize byPathDiffs=_byPathDiffs;
