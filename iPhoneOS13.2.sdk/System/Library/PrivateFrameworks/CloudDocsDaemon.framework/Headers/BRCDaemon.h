...
@interface BRCDaemon : NSObject <BRCReachabilityDelegate, NSXPCListenerDelegate, BRCAccountHandlerDelegate>
{
    ...
    NSUInteger _forceIsGreedyState;
    NSDate *_startupDate;
}
...
@property(nonatomic) NSUInteger forceIsGreedyState; // @synthesize forceIsGreedyState=_forceIsGreedyState;
...
- (void)setDirPath:(id)arg1 forSyncedFolderType:(NSUInteger)arg2;
...
- (NSUInteger)nonPurgeableSizeGivenPurgeableSize:(NSUInteger)arg1;
- (NSUInteger)totalSize;
- (NSUInteger)recursivelySizeDirectoryAtPath:(id)arg1;
