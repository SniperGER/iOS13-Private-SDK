...
@interface BRCLocalItem : NSObject <BRCJobsMatching, BRCSyncThrottleItemProtocol, BRCItem>
{
    ...
    BRCLocalItem *_orig;
    NSUInteger _localDiffs;
    NSNumber *_minimumSupportedOSRowID;
    BOOL _isUserVisible;
    NSUInteger _dbRowID;
    NSUInteger _notifsRank;
...
@property(readonly, nonatomic) NSUInteger notifsRank; // @synthesize notifsRank=_notifsRank;
@property(readonly, nonatomic) NSUInteger localDiffs; // @synthesize localDiffs=_localDiffs;
...
@property(readonly, nonatomic) NSUInteger dbRowID; // @synthesize dbRowID=_dbRowID;
// - (void).cxx_destruct;
...
- (void)bounceReservedItemWithBounceNumber:(NSUInteger)arg1;
- (void)markBounceFailed;
- (void)markBounceFinished;
- (void)beginBounceAndSaveToDBWithBounceNumber:(NSUInteger)arg1;
...
- (void)clearFromStage;
- (void)markStagedWithFileID:(NSUInteger)arg1 generationID:(unsigned int)arg2 documentID:(unsigned int)arg3;
- (void)markStagedWithFileID:(NSUInteger)arg1 generationID:(unsigned int)arg2;
...
- (NSUInteger)diffAgainstOriginalItem;
...
- (void)_sendNotificationIfNeededWithDiffs:(NSUInteger)arg1 regather:(BOOL)arg2;
...
- (BOOL)_isInterestingUpdateForNotifsWithDiffs:(NSUInteger)arg1;
...
- (void)wasMarkedDead;
- (void)_updateSharedZoneBoostingWithDiffs:(NSUInteger)arg1;
- (void)_updateSyncUpSchedulerWithDiffs:(NSUInteger)arg1;
- (id)_syncZones;
- (id)unsaltedBookmarkData;
- (void)createSyncUpJob;
- (NSUInteger)maskForDiffsToSyncUpForZone:(id)arg1;
- (NSUInteger)metadataSyncUpMask;
...
- (NSUInteger)diffAgainstServerAliasItem:(id)arg1;
...
- (void)applyMetadataOnFileID:(NSUInteger)arg1 liveFD:(NSUInteger)arg2 sharingOptions:(NSUInteger)arg3;
