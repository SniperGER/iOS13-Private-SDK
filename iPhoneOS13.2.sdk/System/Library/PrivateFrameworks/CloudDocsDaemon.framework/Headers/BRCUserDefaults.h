...
@property(readonly, nonatomic) NSUInteger optimisticallyFillChainBatchSpace;
...
- (NSUInteger)unsignedLongLongForKey:(id)arg1 min:(NSUInteger)arg2 max:(NSUInteger)arg3 byDefault:(NSUInteger)arg4;
