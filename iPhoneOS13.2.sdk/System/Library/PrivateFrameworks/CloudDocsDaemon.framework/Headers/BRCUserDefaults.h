...
- (id)objectForKey:(id)arg1 inheritFromGlobal:(_Bool)arg2 validateWithBlock:(id /* block */)arg3;
- (id)_serverDefaultForKey:(id)arg1;
- (id)_loadObjectForKey:(id)arg1 inheritFromGlobal:(_Bool)arg2 validateWithBlock:(id /* block */)arg3;
