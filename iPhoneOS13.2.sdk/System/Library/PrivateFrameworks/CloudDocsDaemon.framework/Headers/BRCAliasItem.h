...
+ (void)fillStructureRecord:(id)arg1 inZone:(id)arg2 itemID:(id)arg3 ckInfo:(id)arg4 parentID:(id)arg5 targetItemID:(id)arg6 targetZone:(id)arg7 diffs:(NSUInteger)arg8 isFolderShare:(BOOL)arg9 beingDeadInServerTruth:(BOOL)arg10 pcsChained:(BOOL)arg11;
