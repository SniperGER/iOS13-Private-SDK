...
@interface _BRCOperation : NSOperation
{
    ...
    id /* CDUnknownBlockType */ _mainBlock;
    id /* CDUnknownBlockType */ _finishBlock;
    NSUInteger _logSections;
...
@property(readonly, nonatomic) NSUInteger logSections; // @synthesize logSections=_logSections;
@property(copy, nonatomic) id /* CDUnknownBlockType */ finishBlock; // @synthesize finishBlock=_finishBlock;
@property(copy, nonatomic) id /* CDUnknownBlockType */ mainBlock; // @synthesize mainBlock=_mainBlock;
