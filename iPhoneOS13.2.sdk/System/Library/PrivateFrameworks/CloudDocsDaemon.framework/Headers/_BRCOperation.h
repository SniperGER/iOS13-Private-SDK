...
@property(copy, nonatomic) id /* block */ finishBlock; // @synthesize finishBlock=_finishBlock;
@property(copy, nonatomic) id /* block */ mainBlock; // @synthesize mainBlock=_mainBlock;
