...
@class BRCAppLibrary, BRCItemGlobalID, BRFileObjectID, NSMutableSet, NSSet, NSString;
...
@property(readonly, nonatomic) NSUInteger oldParentFileID; // @synthesize oldParentFileID=_oldParentFileID;
...
- (id)initWithAliasItem:(id)arg1 itemDiffs:(NSUInteger)arg2;
- (void)_addAliasDecoration:(id)arg1;
- (void)setNumberAttribute:(id)arg1 forKey:(id)arg2;
- (id)initWithLocalItem:(id)arg1 itemDiffs:(NSUInteger)arg2;
