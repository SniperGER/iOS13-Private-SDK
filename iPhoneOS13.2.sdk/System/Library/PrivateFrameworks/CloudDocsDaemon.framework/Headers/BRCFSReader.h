...
@class BRCAsyncDirectoryEnumerator, BRCCountedSet, BRCFairSource, NSMutableSet, NSObject, brc_task_tracker;
...
- (void)_didResolvedDocumentID:(unsigned int)arg1 fileID:(NSUInteger)arg2 zone:(id)arg3;
...
- (NSUInteger)_backoffBeforeProcessingLostItemWithStamp:(NSUInteger)arg1 appLibrary:(id)arg2;
- (void)fseventOnURL:(id)arg1 dbFlags:(unsigned int)arg2;
- (void)fseventOnDocument:(id)arg1 flags:(unsigned int)arg2 options:(NSUInteger)arg3 lookup:(id)arg4 unresolvedLastPathComponent:(id)arg5;
- (void)fseventOnDocument:(id)arg1 flags:(unsigned int)arg2 options:(NSUInteger)arg3 lookup:(id)arg4;
- (void)fseventOnDocument:(id)arg1 flags:(unsigned int)arg2 lookup:(id)arg3;
- (void)_fseventOnDocument:(id)arg1 flags:(unsigned int)arg2 options:(NSUInteger)arg3 item:(id)arg4 lookup:(id)arg5 unresolvedLastPathComponent:(id)arg6;
...
- (void)fseventAtPath:(id)arg1 flags:(unsigned int)arg2 options:(NSUInteger)arg3 unresolvedLastPathComponent:(id)arg4;
