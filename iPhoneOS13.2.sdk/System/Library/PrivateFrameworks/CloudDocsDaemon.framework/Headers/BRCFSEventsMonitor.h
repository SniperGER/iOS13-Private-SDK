...
- (void)fseventOnRootWithEventID:(NSUInteger)arg1 andReason:(id)arg2;
- (void)fseventAtPath:(id)arg1 withFlags:(unsigned int)arg2 andID:(NSUInteger)arg3 eventIndex:(unsigned int)arg4 eventCount:(unsigned int)arg5 initialScan:(BOOL)arg6;
...
- (void)didProcessEventID:(NSUInteger)arg1;
