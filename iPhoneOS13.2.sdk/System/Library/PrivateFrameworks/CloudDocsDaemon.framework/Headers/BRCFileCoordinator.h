...
- (void)scheduleRenameOfItemAtURL:(id)arg1 toItemAtURL:(id)arg2 contentUpdate:(_Bool)arg3 queue:(id)arg4 taskTracker:(id)arg5 accessor:(id /* block */)arg6;
...
- (void)cancel;
- (id)initWithSession:(id)arg1 forRead:(_Bool)arg2 doneHandler:(id /* block */)arg3;
