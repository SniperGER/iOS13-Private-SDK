...
@property(readonly, nonatomic) NSUInteger currentRequestID; // @synthesize currentRequestID=_requestID;
...
- (void)_dumpRecursivePropertiesOfItemByRowID:(NSUInteger)arg1 context:(id)arg2 depth:(int)arg3;
...
- (id)directoryOrRootItemIDByFileID:(NSUInteger)arg1 db:(id)arg2;
- (id)directoryOrRootItemIDByFileID:(NSUInteger)arg1;
...
- (id)serverItemByRowID:(NSUInteger)arg1 db:(id)arg2;
- (id)serverItemByRowID:(NSUInteger)arg1;
...
- (void)didSyncDownRequestID:(NSUInteger)arg1 maxApplyRank:(long long)arg2 caughtUpWithServer:(BOOL)arg3 syncDownDate:(id)arg4;
...
//  (struct PQLResultSet )_faultsEnumeratorFromRow:(NSUInteger)arg1 batchSize:(NSUInteger)arg2;
- (void)_enumerateFaultsWithBlock:(CDUnknownBlockType)arg1 rowID:(NSUInteger)arg2 batchSize:(NSUInteger)arg3;
- (void)enumerateFaultsAsyncWithBlock:(CDUnknownBlockType)arg1 batchSize:(NSUInteger)arg2;
...
- (id)itemByFileID:(NSUInteger)arg1 db:(id)arg2;
- (id)itemByFileID:(NSUInteger)arg1;
...
- (id)ownerName;
- (void)_finishedReset:(NSUInteger)arg1 completionHandler:(CDUnknownBlockType)arg2;
...
- (void)_reset:(NSUInteger)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (void)scheduleReset:(NSUInteger)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (void)scheduleReset:(NSUInteger)arg1;
- (void)cancelReset;
