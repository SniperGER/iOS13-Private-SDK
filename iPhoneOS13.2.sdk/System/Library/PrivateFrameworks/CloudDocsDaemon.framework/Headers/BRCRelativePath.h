...
+ (int)locateByFileID:(NSUInteger)arg1 session:(id)arg2;
...
- (id)initWithFileID:(NSUInteger)arg1 root:(id)arg2 session:(id)arg3;
- (id)initWithFileID:(NSUInteger)arg1 session:(id)arg2;
