...
- (void)_t_resetAllZones:(id)arg1 waitUntilIdle:(_Bool)arg2 reply:(id /* block */)arg3;
...
- (void)_setupAppLibraryAndZoneWithID:(id)arg1 recreateDocumentsIfNeeded:(_Bool)arg2 reply:(id /* block */)arg3;
...
- (void)_addExternalDocumentReferenceTo:(id)arg1 underParent:(id)arg2 forceReparent:(_Bool)arg3 reply:(id /* block */)arg4;
...
- (void)accessLogicalOrPhysicalURL:(id)arg1 accessKind:(long long)arg2 dbAccessKind:(long long)arg3 asynchronously:(_Bool)arg4 handler:(id /* block */)arg5;
