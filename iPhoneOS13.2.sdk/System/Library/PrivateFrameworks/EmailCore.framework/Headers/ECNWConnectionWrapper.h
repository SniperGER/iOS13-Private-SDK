...
//     struct os_unfair_lock_s _lock;
    ...
    id /* CDUnknownBlockType */ _networkActivityChangeBlock;
    NSArray *_serverCertificates;
    id /* CDUnknownBlockType */ _serverTrustHandler;
    NSString *_sourceApplicationBundleIdentifier;
    id /* CDUnknownBlockType */ _bytesAvailableHandler;
}

+ (id)log;
@property(copy) id /* CDUnknownBlockType */ bytesAvailableHandler; // @synthesize bytesAvailableHandler=_bytesAvailableHandler;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ serverTrustHandler; // @synthesize serverTrustHandler=_serverTrustHandler;
@property(readonly, copy, nonatomic) NSArray *serverCertificates; // @synthesize serverCertificates=_serverCertificates;
@property(copy, nonatomic) id /* CDUnknownBlockType */ networkActivityChangeBlock; // @synthesize networkActivityChangeBlock=_networkActivityChangeBlock;
