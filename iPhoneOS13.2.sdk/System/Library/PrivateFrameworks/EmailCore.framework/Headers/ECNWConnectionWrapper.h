...
+ (id)log;
@property(copy) id /* block */ bytesAvailableHandler; // @synthesize bytesAvailableHandler=_bytesAvailableHandler;
...
@property(copy, nonatomic) id /* block */ serverTrustHandler; // @synthesize serverTrustHandler=_serverTrustHandler;
@property(readonly, copy, nonatomic) NSArray *serverCertificates; // @synthesize serverCertificates=_serverCertificates;
@property(copy, nonatomic) id /* block */ networkActivityChangeBlock; // @synthesize networkActivityChangeBlock=_networkActivityChangeBlock;
