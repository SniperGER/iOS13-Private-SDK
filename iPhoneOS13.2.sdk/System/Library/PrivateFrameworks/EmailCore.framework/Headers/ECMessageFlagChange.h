...
@interface ECMessageFlagChange : NSObject <ECMessageFlagChangeBuilder, EFPubliclyDescribable, NSCopying, NSSecureCoding>
{
    ...
    NSUInteger _junkLevel;
    NSUInteger _flagColor;
    long long _reason;
}
...
@property(nonatomic) NSUInteger flagColor; // @synthesize flagColor=_flagColor;
@property(nonatomic) NSUInteger junkLevel; // @synthesize junkLevel=_junkLevel;
