...
@class NSDictionary, NSSet, NSXPCConnection, UAPasteboardGeneration;
...
@interface UASharedPasteboardManager : NSObject <UASharedPasteboardManagerResponseProtocol>
{
    ...
    int _disableCount;
    id /* CDUnknownBlockType */ _localPasteboardWasFetched;
...
+ (id)sharedManager;
+ (void)initialize;
@property id /* CDUnknownBlockType */ completionBlock; // @synthesize completionBlock=_completionBlock;
...
@property(copy) id /* CDUnknownBlockType */ localPasteboardWasFetched; // @synthesize localPasteboardWasFetched=_localPasteboardWasFetched;
// - (void).cxx_destruct;
...
- (BOOL)addData:(id)arg1 toItemAtIndex:(NSUInteger)arg2 generation:(NSUInteger)arg3;
