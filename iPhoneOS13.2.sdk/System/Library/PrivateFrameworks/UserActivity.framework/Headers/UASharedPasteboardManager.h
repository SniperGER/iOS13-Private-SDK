...
+ (id)sharedManager;
+ (void)initialize;
@property id /* block */ completionBlock; // @synthesize completionBlock=_completionBlock;
...
@property(copy) id /* block */ localPasteboardWasFetched; // @synthesize localPasteboardWasFetched=_localPasteboardWasFetched;
