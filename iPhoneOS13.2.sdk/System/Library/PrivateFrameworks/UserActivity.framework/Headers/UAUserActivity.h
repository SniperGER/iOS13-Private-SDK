...
+ (_Bool)determineIfUserActivityIsCurrent:(id)arg1 completionHandler:(id /* block */)arg2;
+ (_Bool)currentUserActivityUUIDWithOptions:(id)arg1 completionHandler:(id /* block */)arg2;
...
+ (_Bool)registerAsProxyForApplication:(int)arg1 options:(id)arg2 completionBlock:(id /* block */)arg3;
...
- (_Bool)encodeUserInfo:(id)arg1 completionHandler:(id /* block */)arg2;
- (id)unarchiver:(id)arg1 didDecodeObject:(id)arg2;
- (id)archiver:(id)arg1 willEncodeObject:(id)arg2;
- (id)unarchiveURL:(id)arg1 error:(id *)arg2;
- (_Bool)archiveURL:(id)arg1 completionHandler:(id /* block */)arg2;
- (void)invalidate;
...
- (_Bool)createUserActivityDataWithSaving:(_Bool)arg1 options:(id)arg2 completionHandler:(id /* block */)arg3;
- (_Bool)_encodeIntoUserActivityDataWithSave:(_Bool)arg1 completionHandler:(id /* block */)arg2;
- (_Bool)createUserActivityStringsWithSaving:(_Bool)arg1 options:(id)arg2 completionHandler:(id /* block */)arg3;
- (_Bool)_encodeIntoUserActivityStringWithSave:(_Bool)arg1 completionHandler:(id /* block */)arg2;
