...
@interface UAUserActivity : NSObject <SFCompanionAdvertiserDelegate>
{
    ...
    NSUInteger _suggestedActionType;
...
+ (BOOL)checkWebpageURL:(id)arg1 actionType:(NSUInteger)arg2 throwIfFailed:(BOOL)arg3;
+ (id)allowedWebpageURLSchemes;
+ (void)unregisterForSuggestedActionNudgeOfType:(id)arg1;
+ (id)registerForSuggestedActionNudgeOfType:(NSUInteger)arg1 withOptions:(id)arg2 block:(CDUnknownBlockType)arg3;
...
@property(readonly) NSUInteger suggestedActionType; // @synthesize suggestedActionType=_suggestedActionType;
...
@property(readonly) NSUInteger os_state_handler; // @synthesize os_state_handler=_os_state_handler;
...
- (NSUInteger)beginUserInfoUpdate:(id)arg1;
...
- (void)dealloc;
- (id)initDynamicActivityWithTypeIdentifier:(id)arg1 dynamicIdentifier:(id)arg2 suggestedActionType:(NSUInteger)arg3 options:(id)arg4;
- (id)initWithTypeIdentifier:(id)arg1 dynamicIdentifier:(id)arg2 options:(id)arg3;
- (id)initWithTypeIdentifier:(id)arg1 suggestedActionType:(NSUInteger)arg2 options:(id)arg3;
