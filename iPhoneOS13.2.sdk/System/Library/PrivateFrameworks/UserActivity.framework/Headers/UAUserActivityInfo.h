...
- (void)clearPayload;
- (_Bool)wasResumedOnAnotherDeviceWithCompletionHandler:(id /* block */)arg1;
- (_Bool)requestPayloadWithCompletionHandlerEvenIfClean:(_Bool)arg1 withCompletionHandler:(id /* block */)arg2;
- (void)fetchAllNearbyAppSuggestions:(id /* block */)arg1;
- (_Bool)requestPayloadWithCompletionHandler:(id /* block */)arg1;
