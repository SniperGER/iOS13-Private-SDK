...
- (void)injectBTLEItem:(id)arg1 type:(NSUInteger)arg2 identifier:(id)arg3 title:(id)arg4 activityPayload:(id)arg5 frameworkPayload:(id)arg6 payloadDelay:(double)arg7;
...
- (id)enabledUUIDs;
- (id)allUUIDsOfType:(NSUInteger)arg1;
