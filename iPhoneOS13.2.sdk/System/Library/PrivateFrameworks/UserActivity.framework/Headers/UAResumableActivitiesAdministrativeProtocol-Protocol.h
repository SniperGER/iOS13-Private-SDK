...
- (void)doInjectBTLE:(NSUUID *)arg1 type:(NSUInteger)arg2 identifier:(NSString *)arg3 title:(NSString *)arg4 activityPayload:(NSData *)arg5 frameworkPayload:(NSData *)arg6 payloadDelay:(double)arg7;
...
- (void)doCopyAllUUIDsOfType:(NSUInteger)arg1 withCompletionHandler:(void (^)(NSArray *))arg2;
