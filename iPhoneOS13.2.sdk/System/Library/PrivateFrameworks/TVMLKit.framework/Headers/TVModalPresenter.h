...
- (void)dismissAllViewControllersWithAnimation:(_Bool)arg1 completion:(id /* block */)arg2;
- (void)dismissViewController:(id)arg1 animated:(_Bool)arg2 completion:(id /* block */)arg3;
- (void)dismissViewControllerWithResponder:(id)arg1 animated:(_Bool)arg2 completion:(id /* block */)arg3;
