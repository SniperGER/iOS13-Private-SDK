...
//  (CGPathRef)shadowPathWithCornerRadii:(struct TVCornerRadii)arg1 andScaledSize:(CGSize)arg2;
//  (CGPathRef)shadowPathForViewElement:(id)arg1 withCornerRadii:(struct TVCornerRadii)arg2 andScaledSize:(CGSize)arg3;
