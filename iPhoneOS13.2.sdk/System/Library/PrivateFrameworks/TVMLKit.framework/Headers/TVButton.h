...
@property(copy, nonatomic) id /* block */ playActionHandler; // @synthesize playActionHandler=_playActionHandler;
@property(copy, nonatomic) id /* block */ selectActionHandler; // @synthesize selectActionHandler=_selectActionHandler;
