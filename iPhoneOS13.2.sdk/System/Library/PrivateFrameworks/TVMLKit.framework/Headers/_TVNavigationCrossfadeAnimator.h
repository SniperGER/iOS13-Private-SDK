...
+ (void)_beginCrossfadeAnimationFromView:(id)arg1 toView:(id)arg2 containerView:(id)arg3 delay:(double)arg4 fadeOutFromView:(_Bool)arg5 removeFromView:(_Bool)arg6 completion:(id /* block */)arg7;
