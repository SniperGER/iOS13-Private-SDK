...
- (void)_dismissAnimated:(_Bool)arg1 completion:(id /* block */)arg2;
- (_Bool)_isDismissing;
- (void)_configureModalController:(id)arg1 withFromController:(id)arg2 andConfiguration:(id)arg3;
- (void)hideAllAnimated:(_Bool)arg1 withCompletion:(id /* block */)arg2;
- (void)hideController:(id)arg1 animated:(_Bool)arg2 withCompletion:(id /* block */)arg3;
- (void)showController:(id)arg1 fromController:(id)arg2 withConfiguration:(id)arg3 animated:(_Bool)arg4 andCompletionBlock:(id /* block */)arg5;
