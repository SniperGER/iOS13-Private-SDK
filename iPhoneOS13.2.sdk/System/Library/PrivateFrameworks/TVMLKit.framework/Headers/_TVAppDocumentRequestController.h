...
- (void)shouldHideSupplementaryUI:(_Bool)arg1 animated:(_Bool)arg2 completion:(id /* block */)arg3;
...
- (void)mediaPlaybackManager:(id)arg1 shouldHideUI:(_Bool)arg2 animated:(_Bool)arg3 animations:(id /* block */)arg4 completion:(id /* block */)arg5;
