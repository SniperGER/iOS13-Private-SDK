...
- (void)_registerControllerTransitioningCreator:(CDUnknownBlockType)arg1 withType:(NSUInteger)arg2;
...
- (void)_registerViewControllerCreatorEx:(CDUnknownBlockType)arg1 withType:(NSUInteger)arg2;
- (void)_registerViewControllerCreator:(CDUnknownBlockType)arg1 withType:(NSUInteger)arg2;
- (void)_registerViewCreatorEx:(CDUnknownBlockType)arg1 withType:(NSUInteger)arg2;
- (void)_registerViewCreator:(CDUnknownBlockType)arg1 withType:(NSUInteger)arg2;
