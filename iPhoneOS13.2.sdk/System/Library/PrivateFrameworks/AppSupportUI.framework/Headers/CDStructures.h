...
struct map<UIView *, const std::__1::pair<NSRange *, NSRange *>, std::__1::less<UIView *>, std::__1::allocator<std::__1::pair<UIView *const, const std::__1::pair<NSRange *, NSRange *>>>> {
    struct __tree<std::__1::__value_type<UIView *, const std::__1::pair<NSRange *, NSRange *>>, std::__1::__map_value_compare<UIView *, std::__1::__value_type<UIView *, const std::__1::pair<NSRange *, NSRange *>>, std::__1::less<UIView *>, true>, std::__1::allocator<std::__1::__value_type<UIView *, const std::__1::pair<NSRange *, NSRange *>>>> {
        struct __tree_end_node<std::__1::__tree_node_base<void *>*> __begin_node_;
        struct __compressed_pair<std::__1::__tree_end_node<std::__1::__tree_node_base<void *>*>, std::__1::allocator<std::__1::__tree_node<std::__1::__value_type<UIView *, const std::__1::pair<NSRange *, NSRange *>>, void *>>> {
            struct __tree_end_node<std::__1::__tree_node_base<void *>*> __value_;
        } __pair1_;
        struct __compressed_pair<unsigned long, std::__1::__map_value_compare<UIView *, std::__1::__value_type<UIView *, const std::__1::pair<NSRange *, NSRange *>>, std::__1::less<UIView *>, true>> {
            NSUInteger __value_;
        } __pair3_;
    } __tree_;
};
