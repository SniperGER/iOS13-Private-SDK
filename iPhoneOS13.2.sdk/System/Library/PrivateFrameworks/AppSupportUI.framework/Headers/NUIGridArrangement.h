...
- (void)positionItemsInColumns:(struct _NSRange)arg1 rows:(struct _NSRange)arg2 inBounds:(struct CGRect)arg3 block:(id /* block */)arg4;
- (void)positionItemsInBounds:(struct CGRect)arg1 block:(id /* block */)arg2;
