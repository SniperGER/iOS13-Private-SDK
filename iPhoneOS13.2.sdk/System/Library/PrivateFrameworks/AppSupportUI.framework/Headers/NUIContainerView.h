...
- (NSUInteger)indexOfArrangedSubview:(id)arg1;
- (void)replaceArrangedSubview:(id)arg1 atIndex:(NSUInteger)arg2;
- (void)replaceArrangedSubviewAtIndex:(NSUInteger)arg1 withView:(id)arg2;
- (void)insertArrangedSubview:(id)arg1 atIndex:(NSUInteger)arg2;
