...
- (void)_queue_setTopics:(id)arg1 forBundleIdentifier:(id)arg2 withCompletionHandler:(id /* block */)arg3;
- (id)_queue_topicsForBundleIdentifier:(id)arg1;
- (void)contentProtectionStateChangedForFirstUnlock:(_Bool)arg1;
- (void)notificationSourcesDidUninstall:(id)arg1;
- (void)setTopics:(id)arg1 forBundleIdentifier:(id)arg2 withCompletionHandler:(id /* block */)arg3;
