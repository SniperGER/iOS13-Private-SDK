...
@class BBDataProviderProxy, BBSectionIcon, BBSectionInfo, BSCFBundle, NSMutableDictionary, UNSApplicationLauncher, UNSAttachmentsService, UNSDaemonLauncher, UNSLocalizationService, UNSNotificationCategoryRepository, UNSNotificationRepository, UNSNotificationSourceDescription, UNSNotificationTopicRepository;
...
- (id)clearedInfoAndBulletinsForClearingAllBulletinsWithLimit:(NSUInteger)arg1 lastClearedInfo:(id)arg2;
- (id)bulletinsWithRequestParameters:(id)arg1 lastCleared:(id)arg2;
- (id)notificationRecords;
- (id)_allBulletinsWithMaxCount:(NSUInteger)arg1 sinceDate:(id)arg2;
