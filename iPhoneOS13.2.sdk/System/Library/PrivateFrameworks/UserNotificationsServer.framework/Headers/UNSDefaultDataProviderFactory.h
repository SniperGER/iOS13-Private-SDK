...
- (void)_queue_setCriticalAlertAuthorization:(_Bool)arg1 forNotificationSourceDescription:(id)arg2 completionHandler:(id /* block */)arg3;
- (void)_queue_updateSettingsWithAuthorizationStatus:(long long)arg1 options:(unsigned long long)arg2 forNotificationSourceDescription:(id)arg3 completionHandler:(id /* block */)arg4;
...
- (void)setCriticalAlertAuthorization:(_Bool)arg1 forNotificationSourceDescription:(id)arg2 completionHandler:(id /* block */)arg3;
- (void)updateAuthorizationWithOptions:(unsigned long long)arg1 forNotificationSourceDescription:(id)arg2 completionHandler:(id /* block */)arg3;
- (void)requestAuthorizationStatus:(long long)arg1 withOptions:(unsigned long long)arg2 forNotificationSourceDescription:(id)arg3 completionHandler:(id /* block */)arg4;
