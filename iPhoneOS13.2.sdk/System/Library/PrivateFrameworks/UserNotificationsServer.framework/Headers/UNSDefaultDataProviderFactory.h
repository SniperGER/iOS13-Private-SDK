...
- (void)_queue_updateSettingsWithAuthorizationStatus:(long long)arg1 options:(NSUInteger)arg2 forNotificationSourceDescription:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;
...
- (void)updateAuthorizationWithOptions:(NSUInteger)arg1 forNotificationSourceDescription:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;
- (void)requestAuthorizationStatus:(long long)arg1 withOptions:(NSUInteger)arg2 forNotificationSourceDescription:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;
