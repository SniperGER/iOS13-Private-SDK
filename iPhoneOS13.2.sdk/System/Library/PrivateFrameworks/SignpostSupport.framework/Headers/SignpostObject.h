...
- (id)initWithSubsystem:(id)arg1 category:(id)arg2 name:(id)arg3 signpostId:(NSUInteger)arg4 scope:(NSUInteger)arg5 timebaseRatio:(double)arg6 attributes:(id)arg7;
