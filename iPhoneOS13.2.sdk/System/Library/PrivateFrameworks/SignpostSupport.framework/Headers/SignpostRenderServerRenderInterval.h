...
@interface SignpostRenderServerRenderInterval : SignpostAnimationSubInterval
{
    ...
    NSUInteger _displayRefreshIntervalMachContinuousTime;
    NSString *_renderSkipReason;
    NSUInteger _renderServerTID;
}

@property(readonly, nonatomic) NSUInteger renderServerTID; // @synthesize renderServerTID=_renderServerTID;
...
@property(readonly, nonatomic) NSUInteger displayRefreshIntervalMachContinuousTime; // @synthesize displayRefreshIntervalMachContinuousTime=_displayRefreshIntervalMachContinuousTime;
