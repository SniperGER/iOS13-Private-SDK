...
+ (id)speechActsForCategory:(NSUInteger)arg1 platform:(id)arg2;
...
- (id)responsesForCategory:(NSUInteger)arg1 gender:(NSUInteger)arg2 maximumResponses:(NSUInteger)arg3 withLanguage:(id)arg4 context:(id)arg5 options:(NSUInteger)arg6;
- (id)cannedResponsesForCategory:(id)arg1 withLanguage:(id)arg2 options:(NSUInteger)arg3;
