...
@class HFControlItem, HUQuickControlInteractionCoordinator, HUQuickControlViewProfile, NAValueThrottler;
...
- (void)setPreferredControl:(NSUInteger)arg1;
- (void)setControlOrientation:(NSUInteger)arg1;
