...
@class HFLocationTriggerBuilder, HUPresenceUserPickerItemModuleController, HUTriggerConditionEditorItemModuleController;
...
+ (id)defaultLocationEventBuilderForHome:(id)arg1 eventType:(NSUInteger)arg2;
