...
@property(copy, nonatomic) id /* block */ deletionHandler; // @synthesize deletionHandler=_deletionHandler;
@property(copy, nonatomic) id /* block */ endEditingHandler; // @synthesize endEditingHandler=_endEditingHandler;
@property(copy, nonatomic) id /* block */ beginEditingHandler; // @synthesize beginEditingHandler=_beginEditingHandler;
@property(copy, nonatomic) id /* block */ accessoryButtonHandler; // @synthesize accessoryButtonHandler=_accessoryButtonHandler;
