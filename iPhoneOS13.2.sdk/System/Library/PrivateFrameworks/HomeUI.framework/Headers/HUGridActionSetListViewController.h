...
@class HFWallpaperSlice, HUGridActionSetItemManager, HUGridLayoutOptions, HUWallpaperView, UILabel;
...
+ (double)requiredHeightWithLayoutOptions:(id)arg1 numberOfItems:(NSUInteger)arg2;
