...
@class HFItem, HUQuickControlPresentationCoordinator, NSMutableDictionary, UIGestureRecognizer, UILongPressGestureRecognizer, UIViewController;
...
@property(readonly, nonatomic) NSUInteger contentColorStyle; // @synthesize contentColorStyle=_contentColorStyle;
// - (void).cxx_destruct;
