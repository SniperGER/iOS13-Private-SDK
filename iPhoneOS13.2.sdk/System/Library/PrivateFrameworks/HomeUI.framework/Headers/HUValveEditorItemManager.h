...
@class HFControlPanelItemProvider, HFItem, HFServiceBuilder, HFStaticItem, HFStaticItemProvider, HFValveServiceItem, HUControlPanelController, HUNameItemModule;
...
@property(readonly, nonatomic) NSUInteger editorMode; // @synthesize editorMode=_editorMode;
...
- (id)initWithDelegate:(id)arg1 sourceItem:(id)arg2 editorMode:(NSUInteger)arg3;
