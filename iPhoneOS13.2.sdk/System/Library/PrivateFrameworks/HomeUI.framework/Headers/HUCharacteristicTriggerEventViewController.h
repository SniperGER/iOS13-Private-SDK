...
@class HFCharacteristicTriggerBuilder, HUCharacteristicEventOptionItem, HUTriggerConditionEditorItemModuleController;
...
- (id)initWithCharacteristicTriggerBuilder:(id)arg1 mode:(NSUInteger)arg2 delegate:(id)arg3;
