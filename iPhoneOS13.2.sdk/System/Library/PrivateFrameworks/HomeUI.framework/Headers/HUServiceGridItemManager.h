...
@property(copy, nonatomic) id /* block */ itemProvidersCreator; // @synthesize itemProvidersCreator=_itemProvidersCreator;
...
- (id)initWithDelegate:(id)arg1 shouldGroupByRoom:(_Bool)arg2 shouldShowSectionHeaders:(_Bool)arg3 itemProvidersCreator:(id /* block */)arg4;
