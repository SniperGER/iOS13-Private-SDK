...
+ (id)sectionIdentifierForActionGridEditorType:(NSUInteger)arg1;
+ (NSUInteger)actionGridEditorTypeForSectionIdentifier:(id)arg1;
...
// - (void).cxx_destruct;
- (void)_createItemsForActionGridEditorType:(NSUInteger)arg1 home:(id)arg2;
- (id)_buildSectionForActionGridEditorType:(NSUInteger)arg1;
...
- (id)initWithActionSetBuilder:(id)arg1 mode:(NSUInteger)arg2 delegate:(id)arg3;
