...
@class HFItem, HFTimerTriggerBuilder, HUTriggerConditionEditorItemModuleController, NSArray, NSDateComponents;
...
- (id)initWithTimerTriggerBuilder:(id)arg1 mode:(NSUInteger)arg2 delegate:(id)arg3;
