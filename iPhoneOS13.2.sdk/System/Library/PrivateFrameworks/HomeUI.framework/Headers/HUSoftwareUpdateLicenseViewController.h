...
@property(copy, nonatomic) id /* block */ disagreeHandler; // @synthesize disagreeHandler=_disagreeHandler;
@property(copy, nonatomic) id /* block */ agreeHandler; // @synthesize agreeHandler=_agreeHandler;
