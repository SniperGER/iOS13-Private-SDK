...
@interface HUSoftwareUpdateLicenseViewController : UIViewController <UIScrollViewDelegate, WKUIDelegate, WKNavigationDelegate, MFMailComposeViewControllerDelegate, HUPreloadableViewController>
{
    ...
    id /* CDUnknownBlockType */ _agreeHandler;
    id /* CDUnknownBlockType */ _disagreeHandler;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ disagreeHandler; // @synthesize disagreeHandler=_disagreeHandler;
@property(copy, nonatomic) id /* CDUnknownBlockType */ agreeHandler; // @synthesize agreeHandler=_agreeHandler;
