...
@class HFItemProvider, HUCameraPresenceRecordingSettingsModule, HUCameraRecordingOptionsItem, HULocationDeviceManager, NSArray, NSSet, NSString;
...
- (id)_expandingSectionModuleForPresenceType:(NSUInteger)arg1;
...
- (id)initWithItemUpdater:(id)arg1 cameraProfiles:(id)arg2 displayStyle:(NSUInteger)arg3;
