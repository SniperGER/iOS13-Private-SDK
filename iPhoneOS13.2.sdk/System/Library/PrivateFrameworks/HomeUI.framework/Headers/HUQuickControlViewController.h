...
@interface HUQuickControlViewController : UIViewController <HUQuickControlInteractiveContentContaining, HUQuickControlContentCharacteristicWriting, HUQuickControlItemHosting, HUPreloadableViewController>
{
    ...
    NSUInteger _controlOrientation;
    NSUInteger _preferredControl;
...
@property(nonatomic) NSUInteger preferredControl; // @synthesize preferredControl=_preferredControl;
@property(nonatomic) NSUInteger controlOrientation; // @synthesize controlOrientation=_controlOrientation;
