...
+ (id)_applyAnimationSettings:(id)arg1 withApplier:(id /* block */)arg2 completion:(id /* block */)arg3 applyDynamically:(_Bool)arg4;
...
- (_Bool)notifyUponEffectiveProgress:(double)arg1 withBlock:(id /* block */)arg2;
