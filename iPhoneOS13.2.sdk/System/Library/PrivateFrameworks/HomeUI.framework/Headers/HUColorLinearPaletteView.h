...
@class HFColorPalette, HFColorPaletteColor, HUQuickControlColorViewProfile, NSIndexPath, UICollectionView, UICollectionViewFlowLayout, UIImpactFeedbackGenerator, UISelectionFeedbackGenerator;
...
- (NSUInteger)_indexForSelectedColor:(id)arg1 includeBias:(BOOL)arg2;
