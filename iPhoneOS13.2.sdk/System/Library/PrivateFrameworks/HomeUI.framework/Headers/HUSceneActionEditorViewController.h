...
@class HUQuickControlSummaryNavigationBarTitleView, NSMutableDictionary, NSSet, NSString;
...
- (void)_done:(id)arg1;
- (id)commitChanges;
- (id)_actionGridViewControllerForEditorType:(NSUInteger)arg1;
@property(readonly, nonatomic) NSString *savedName;
@property(copy, nonatomic) NSSet *prioritizedServices;
- (void)viewDidAppear:(BOOL)arg1;
- (void)viewDidLoad;
- (id)initWithActionSetBuilder:(id)arg1 mode:(NSUInteger)arg2;
