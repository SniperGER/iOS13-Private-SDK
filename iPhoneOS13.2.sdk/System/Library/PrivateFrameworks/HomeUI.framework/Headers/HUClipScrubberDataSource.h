...
@class HFCameraPlaybackEngine, HMCameraClip, HUClipScrubberSelectionView, HUClipScrubberTimeController, NSArray, NSDate, UICollectionView;
...
@interface HUClipScrubberDataSource : NSObject <HFCameraPlaybackEngineObserver, UICollectionViewDataSource>
{
    ...
    NSUInteger _currentTimelineState;
    NSUInteger _displayMode;
    NSDate *_currentDate;
    HFCameraPlaybackEngine *_playbackEngine;
    NSUInteger _mostRecentClipIndex;
...
@property(readonly, nonatomic) NSUInteger mostRecentClipIndex; // @synthesize mostRecentClipIndex=_mostRecentClipIndex;
...
@property(nonatomic) NSUInteger currentTimelineState; // @synthesize currentTimelineState=_currentTimelineState;
