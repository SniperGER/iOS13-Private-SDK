...
@class HUQuickControlCollectionViewControllerLayoutOptions, HUQuickControlContentCharacteristicWritingUpdateAdapter, NSMapTable, NSSet;
...
- (id)intrinsicSizeDescriptorForItemAtIndexPath:(id)arg1 itemSize:(NSUInteger)arg2;
...
- (NSUInteger)_titlePositionForItem:(id)arg1;
