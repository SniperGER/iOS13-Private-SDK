...
@class CNContactStore, HMHome, NSArray, NSIndexPath, UITableView, UIViewController;
...
- (void)_didReloadAtIndex:(NSUInteger)arg1;
- (void)_didRemoveAtIndex:(NSUInteger)arg1;
- (void)_didInsertAtIndex:(NSUInteger)arg1;
