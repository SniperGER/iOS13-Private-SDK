...
- (void)prepareItems:(id)arg1 forMode:(unsigned long long)arg2 usingBookmark:(_Bool)arg3 completionBlock:(id /* block */)arg4;
- (void)prepareItems:(id)arg1 usingBookmark:(_Bool)arg2 completionBlock:(id /* block */)arg3;
...
- (void)importDocumentAtURL:(id)arg1 byMoving:(_Bool)arg2 toCurrentBrowserLocationWithCompletion:(id /* block */)arg3;
...
- (void)dismissAllPresentedViewControllers:(_Bool)arg1 completion:(id /* block */)arg2;
- (void)presentViewController:(id)arg1 animated:(_Bool)arg2 completion:(id /* block */)arg3;
- (void)revealDocumentAtURL:(id)arg1 importIfNeeded:(_Bool)arg2 completion:(id /* block */)arg3;
- (void)revealDocumentAtURL:(id)arg1 shouldImport:(_Bool)arg2 completion:(id /* block */)arg3;
