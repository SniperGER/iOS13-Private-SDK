...
- (void)_loadAllHistoricalUsageWithUsageBlocks:(id)arg1 selectedItemDisplayName:(id)arg2 selectedDay:(NSUInteger)arg3 selectedWeek:(NSUInteger)arg4 hadUsageData:(BOOL)arg5 referenceDate:(id)arg6 completionHandler:(CDUnknownBlockType)arg7;
