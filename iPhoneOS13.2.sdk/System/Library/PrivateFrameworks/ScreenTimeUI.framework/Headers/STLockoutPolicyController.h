...
- (_Bool)_actionIgnoreLimitForTodayWithCompletionHandler:(id /* block */)arg1;
- (_Bool)_actionRemindMeInOneHourWithCompletionHandler:(id /* block */)arg1;
- (_Bool)_actionRemindMeInMinutesWithCompletionHandler:(id /* block */)arg1;
- (_Bool)_actionOneMoreMinuteWithCompletionHandler:(id /* block */)arg1;
- (_Bool)_requestAdditionalTime:(long long)arg1 withCompletionHandler:(id /* block */)arg2;
...
- (void)dealloc;
- (_Bool)handleAction:(long long)arg1 withCompletionHandler:(id /* block */)arg2;
