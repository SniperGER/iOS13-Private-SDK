...
@interface STContentPrivacyViewModelCoordinator : NSObject <NSFetchedResultsControllerDelegate, STContentPrivacyViewModelCoordinator>
{
    ...
    NSUInteger _numExpectedChanges;
}

@property NSUInteger numExpectedChanges; // @synthesize numExpectedChanges=_numExpectedChanges;
...
- (id)_restrictionsForWebFilterState:(NSUInteger)arg1;
