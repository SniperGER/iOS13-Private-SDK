...
- (void)respondToAskForTime:(id)arg1 withApproval:(_Bool)arg2 timeApproved:(id)arg3 completionHandler:(id /* block */)arg4;
- (void)saveAlwaysAllowList:(id)arg1 completionHandler:(id /* block */)arg2;
- (void)saveAllAllowancesEnabled:(_Bool)arg1 completionHandler:(id /* block */)arg2;
