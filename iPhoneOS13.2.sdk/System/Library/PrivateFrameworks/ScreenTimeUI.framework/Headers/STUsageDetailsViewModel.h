...
+ (void)_enumerateDayReportStartDatesWithStartOfWeek:(id)arg1 ascending:(_Bool)arg2 block:(id /* block */)arg3;
+ (void)_enumerateWeeklyReportStartDatesWithReferenceDate:(id)arg1 ascending:(_Bool)arg2 block:(id /* block */)arg3;
