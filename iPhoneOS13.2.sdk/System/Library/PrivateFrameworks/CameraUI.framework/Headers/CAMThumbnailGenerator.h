...
// - (void).cxx_destruct;
//  (CGImageRef)newBGRAImageOfFormat:(long long)arg1 inOrientation:(long long)arg2 usingPixelBuffer:(struct __CVBuffer )arg3;
//  (CGImageRef)newBGRAImageInOrientation:(long long)arg1 usingPixelBuffer:(struct __CVBuffer )arg2;
