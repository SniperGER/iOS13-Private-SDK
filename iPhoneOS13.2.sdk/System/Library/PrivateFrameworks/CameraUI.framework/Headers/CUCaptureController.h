...
@property(nonatomic, setter=_setNextSignpostID:) NSUInteger _nextSignpostID; // @synthesize _nextSignpostID=__nextSignpostID;
...
- (void)startCaptureSessionWithRetryCount:(NSUInteger)arg1 retryInterval:(double)arg2 logReason:(id)arg3 completion:(CDUnknownBlockType)arg4;
...
- (NSUInteger)_maximumNumberOfStillImageRequestsDuringBurst;
...
- (void)changeToPreviewConfiguration:(NSUInteger)arg1;
- (void)changeToPreviewEnabledWithConfiguration:(NSUInteger)arg1;
