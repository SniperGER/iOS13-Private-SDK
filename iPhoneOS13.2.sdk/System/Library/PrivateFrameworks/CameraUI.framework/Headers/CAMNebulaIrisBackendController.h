...
@class AVAssetExportSession, BKSApplicationStateMonitor, CAMNebulaKeepAliveController, CAMPersistenceController, NSHashTable, NSMutableArray, NSMutableDictionary;
...
- (NSUInteger)_coordinationQueue_failureCountForVideoURL:(id)arg1;
- (void)_coordinationQueue_setFailureCount:(NSUInteger)arg1 forVideoURL:(id)arg2;
// - (BOOL)_extractIrisPropertiesFromAVAsset:(id)arg1 stillImageDisplayTime:(CDStruct_1b6d18a9 )arg2 irisIdentifier:(id )arg3;
