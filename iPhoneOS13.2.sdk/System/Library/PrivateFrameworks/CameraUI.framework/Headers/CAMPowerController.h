...
@interface CAMPowerController : NSObject
{
    ...
    NSUInteger __backgroundTaskIdentifier;
}
...
@property(readonly, nonatomic) NSUInteger _backgroundTaskIdentifier; // @synthesize _backgroundTaskIdentifier=__backgroundTaskIdentifier;
