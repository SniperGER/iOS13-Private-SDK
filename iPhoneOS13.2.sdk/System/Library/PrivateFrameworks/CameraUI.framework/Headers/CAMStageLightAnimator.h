...
// - (void).cxx_destruct;
// - (void)_animateCircleGeometry:(CDStruct_f31c9284 )arg1 count:(NSUInteger)arg2 duration:(double)arg3 timing:(id)arg4 repeats:(BOOL)arg5 completion:(CDUnknownBlockType)arg6;
