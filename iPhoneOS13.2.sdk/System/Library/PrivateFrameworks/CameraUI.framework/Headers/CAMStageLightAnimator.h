...
- (void)_animateCircleGeometry:(CDStruct_f31c9284 *)arg1 count:(unsigned long long)arg2 duration:(double)arg3 timing:(id)arg4 repeats:(_Bool)arg5 completion:(id /* block */)arg6;
- (void)_animateCircleFromGeometry:(CDStruct_f31c9284)arg1 toGeometry:(CDStruct_f31c9284)arg2 duration:(double)arg3 timing:(id)arg4 repeats:(_Bool)arg5 completion:(id /* block */)arg6;
- (void)_animateCircleToGeometry:(CDStruct_f31c9284)arg1 duration:(double)arg2 timing:(id)arg3 completion:(id /* block */)arg4;
