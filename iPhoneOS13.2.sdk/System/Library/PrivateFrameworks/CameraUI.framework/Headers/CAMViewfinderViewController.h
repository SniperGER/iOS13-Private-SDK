...
@interface CAMViewfinderViewController : UIViewController <UIGestureRecognizerDelegate, CAMModeDialDataSource, CAMStillImageCaptureRequestDelegate, CAMVideoCaptureRequestDelegate, CAMPanoramaCaptureRequestDelegate, CAMFacesDelegate, CAMMachineReadableCodeDelegate, CAMConfigurationDelegate, CAMSuggestionDelegate, CAMAvailabilityDelegate, CAMBurstDelegate, CAMTimerButtonDelegate, CAMControlVisibilityDelegate, CAMControlVisibilityUpdateDelegate, CAMPreviewViewControllerDelegate, CAMCaptureRecoveryDelegate, CAMCaptureInterruptionDelegate, CAMCaptureRunningDelegate, CAMZoomDelegate, CAMZoomSliderDelegate, CAMTimelapseControllerDelegate, CAMCameraRollControllerImageWellDelegate, CAMCameraRollControllerSessionDelegate, CAMCameraRollControllerPresentationDelegate, CAMClosedViewfinderControllerDelegate, CAMDisabledPreviewControllerDelegate, CAMStillImageCapturingVideoDelegate, CAMZoomControlDelegate, CAMShallowDepthOfFieldStatusDelegate, CAMPhysicalCaptureNotifierDelegate, CEKWheelScrubberViewDelegate, CAMVideoThumbnailContentsDelegate, CAMBarsAccessibilityHUDManagerDelegate, CAMDescriptionOverlayViewDelegate, CAMShutterButtonDelegate, CEKLightingControlDelegate, CAMStorageControllerDelegate, CAMFullscreenViewfinderDelegate, CAMDynamicShutterControlDelegate, CAMControlStatusBarDelegate, CAMBadgeTrayDelegate, CAMControlDrawerDelegate, CAMFullscreenModeSelectorDataSource, CAMFullscreenModeSelectorDelegate, CAMPreviewLayerOverCaptureStatusDelegate, CAMDynamicShutterControlAGGDDelegate, CAMVideoConfigurationStatusIndicatorDelegate, CAMRemoteShutterDelegate>
{
   struct {
    ...
    NSUInteger __lowLightAutoDisabledReasons;
    ...
    NSUInteger __lastPerformedShutterButtonFeedbackType;
    ...
    NSUInteger _persistenceBehavior;
...
@property(nonatomic) CGAffineTransform customPreviewViewTransform; // @synthesize customPreviewViewTransform=_customPreviewViewTransform;
...
@property(nonatomic) NSUInteger persistenceBehavior; // @synthesize persistenceBehavior=_persistenceBehavior;
...
@property(nonatomic, setter=_setLastPerformedShutterButtonFeedbackType:) NSUInteger _lastPerformedShutterButtonFeedbackType; // @synthesize _lastPerformedShutterButtonFeedbackType=__lastPerformedShutterButtonFeedbackType;
...
@property(nonatomic, setter=_setLastShutterButtonTouchDownTime:) NSUInteger _lastShutterButtonTouchDownTime; // @synthesize _lastShutterButtonTouchDownTime=__lastShutterButtonTouchDownTime;
...
@property(nonatomic, setter=_setRemainingCaptureTimerTicks:) NSUInteger _remainingCaptureTimerTicks; // @synthesize _remainingCaptureTimerTicks=__remainingCaptureTimerTicks;
...
@property(nonatomic, setter=_setLowLightAutoDisabledReasons:) NSUInteger _lowLightAutoDisabledReasons; // @synthesize _lowLightAutoDisabledReasons=__lowLightAutoDisabledReasons;
...
- (NSUInteger)_shutterButtonFeedbackForCurrentConfiguration;
...
- (void)remoteShutter:(id)arg1 takePhotoWithCountdown:(NSUInteger)arg2;
...
- (void)zoomControl:(id)arg1 didChangeSelectedButtonIndex:(NSUInteger)arg2 displayZoomFactor:(double)arg3;
...
- (BOOL)_hasLowLightAutoDisabledReason:(NSUInteger)arg1;
- (void)_updateLowLightAutoDisabledReason:(NSUInteger)arg1 isPreventingLowLight:(BOOL)arg2;
...
- (void)wheelScrubberView:(id)arg1 updateCell:(id)arg2 forItemAtIndex:(NSUInteger)arg3;
...
- (NSUInteger)_previewConfigurationForMode:(long long)arg1 videoThumbnailOutputEnabled:(BOOL)arg2;
...
- (BOOL)_redirectShutterEventIfNecessary:(NSUInteger)arg1;
...
- (NSUInteger)_nextModeSwitchDirectionForLayoutStyle:(long long)arg1;
- (NSUInteger)_previousModeSwipeDirectionForLayoutStyle:(long long)arg1;
...
- (void)badgeTray:(id)arg1 didCreateBadgeForType:(NSUInteger)arg2;
- (void)controlStatusBar:(id)arg1 didReceiveTapInIndicatorForType:(NSUInteger)arg2;
- (void)controlStatusBar:(id)arg1 didCreateIndicatorForType:(NSUInteger)arg2;
...
- (BOOL)_shouldShowIndicatorOfType:(NSUInteger)arg1 forGraphConfiguration:(id)arg2;
...
- (long long)_temporaryPersistenceOptionsForBehavior:(NSUInteger)arg1;
- (long long)_persistenceOptionsForBehavior:(NSUInteger)arg1 allowingOptionalLocalPersistence:(BOOL)arg2;
...
- (void)_initiateCTMCaptureWithCurrentSettingsAtSystemTime:(NSUInteger)arg1;
...
- (NSUInteger)_supportedInterfaceOrientationsForLayoutStyle:(long long)arg1;
