...
- (void)openForReason:(long long)arg1 animated:(_Bool)arg2 withCompletionHandler:(id /* block */)arg3;
- (void)closeAndRotateWithDirection:(unsigned long long)arg1 withCompletionHandler:(id /* block */)arg2;
- (void)closeWithBlur:(_Bool)arg1 animated:(_Bool)arg2 withCompletionHandler:(id /* block */)arg3;
