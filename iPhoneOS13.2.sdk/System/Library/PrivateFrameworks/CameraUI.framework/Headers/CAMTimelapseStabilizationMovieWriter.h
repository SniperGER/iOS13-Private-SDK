...
//    struct __CVBuffer __stashedSourceFrame;
    ...
    NSUInteger __frameLoadMode;
    id /* CDUnknownBlockType */ __completion;
    void __powerAssertion;
    CGAffineTransform __movieTransform;
}

//  (CGSize)_desiredOutputSizeForSourcePixelBuffer:(struct __CVBuffer )arg1;
@property(readonly, nonatomic) void _powerAssertion; // @synthesize _powerAssertion=__powerAssertion;
@property(readonly, copy, nonatomic) id /* CDUnknownBlockType */ _completion; // @synthesize _completion=__completion;
@property(readonly, nonatomic) NSUInteger _frameLoadMode; // @synthesize _frameLoadMode=__frameLoadMode;
...
@property(readonly, nonatomic) CGAffineTransform _movieTransform; // @synthesize _movieTransform=__movieTransform;
...
//  (int)_startWritingWithOutputPath:(id)arg1 width:(long long)arg2 height:(long long)arg3 videoFormatDescription:(struct opaqueCMFormatDescription )arg4 transform:(CGAffineTransform)arg5 framesPerSecond:(long long)arg6 frameCount:(long long)arg7 preferHEVC:(BOOL)arg8 visMetadataCount:(long long)arg9 videoMetadata:(id)arg10;
...
- (void)writeMovieFromImageFiles:(id)arg1 visMetadataFiles:(id)arg2 startDate:(id)arg3 location:(id)arg4 outputPath:(id)arg5 transform:(CGAffineTransform)arg6 framesPerSecond:(long long)arg7 preferHEVC:(BOOL)arg8 completionHandler:(CDUnknownBlockType)arg9;
