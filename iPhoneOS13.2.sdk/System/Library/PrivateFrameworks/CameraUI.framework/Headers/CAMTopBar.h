...
@property(nonatomic, setter=_setExpandedMenuButtonTappableInsets:) UIEdgeInsets _expandedMenuButtonTappableInsets; // @synthesize _expandedMenuButtonTappableInsets=__expandedMenuButtonTappableInsets;
...
- (void)_setMode:(long long)arg1 style:(long long)arg2 animationDuration:(double)arg3 animationOptions:(NSUInteger)arg4;
