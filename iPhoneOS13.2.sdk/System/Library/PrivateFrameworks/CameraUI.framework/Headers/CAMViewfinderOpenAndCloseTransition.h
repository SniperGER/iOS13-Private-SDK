...
- (void)closeAnimated:(_Bool)arg1 withCompletionHandler:(id /* block */)arg2;
- (void)openAnimated:(_Bool)arg1 withCompletionHandler:(id /* block */)arg2;
- (void)_closeViewfinder:(_Bool)arg1 animated:(_Bool)arg2 withCompletionHandler:(id /* block */)arg3;
