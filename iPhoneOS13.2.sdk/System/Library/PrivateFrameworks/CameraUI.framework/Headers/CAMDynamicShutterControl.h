...
@class CADisplayLink, CAMDisplayLinkTarget, CAMDynamicShutterGestureRecognizer, CAMFeedbackController, CAMLiquidShutterRenderer, CAMMetalView, CAMShutterButtonRingView, CAMSpring, CAMTimelapseShutterRingView, CAMTrackingSpring, NSArray, UIImageView, UILabel, UIView;
...
// - (CDStruct_299b3d1e)_touchForPoint:(CGPoint)arg1;
