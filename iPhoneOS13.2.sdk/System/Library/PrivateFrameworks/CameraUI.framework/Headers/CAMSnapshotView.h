...
- (void)_removeSnapshotDimAnimated:(_Bool)arg1 withCompletionBlock:(id /* block */)arg2;
- (void)_applySnapshotDimAnimated:(_Bool)arg1 withCompletionBlock:(id /* block */)arg2;
- (void)_setupDimOnSnapshot;
- (void)_removeLowQualityBlurForStyle:(long long)arg1 animated:(_Bool)arg2 withCompletionBlock:(id /* block */)arg3;
- (void)_applyLowQualityBlurForStyle:(long long)arg1 animated:(_Bool)arg2 withCompletionBlock:(id /* block */)arg3;
...
- (void)_removeSnapshotBlurForStyle:(long long)arg1 animated:(_Bool)arg2 withCompletionBlock:(id /* block */)arg3;
- (void)_applySnapshotBlurForStyle:(long long)arg1 animated:(_Bool)arg2 withCompletionBlock:(id /* block */)arg3;
...
- (void)setDimmed:(_Bool)arg1 animated:(_Bool)arg2 withCompletionBlock:(id /* block */)arg3;
- (void)setBlurred:(_Bool)arg1 animated:(_Bool)arg2 style:(long long)arg3 withCompletionBlock:(id /* block */)arg4;
