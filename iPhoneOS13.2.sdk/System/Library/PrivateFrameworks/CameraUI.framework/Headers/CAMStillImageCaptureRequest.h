...
@interface CAMStillImageCaptureRequest : CAMCaptureRequest <CAMCaptureAdjustmentProvider, CAMBurstIdentifierProvider, NSCopying, NSMutableCopying, CAMBurstRequest, CAMIrisRequest, CAMTimelapseRequest>
{
    ...
    NSUInteger _maximumBurstLength;
...
@property(readonly, nonatomic) NSUInteger maximumBurstLength; // @synthesize maximumBurstLength=_maximumBurstLength;
...
@property(readonly, nonatomic) CGSize desiredPreviewSize; // @synthesize desiredPreviewSize=_desiredPreviewSize;
