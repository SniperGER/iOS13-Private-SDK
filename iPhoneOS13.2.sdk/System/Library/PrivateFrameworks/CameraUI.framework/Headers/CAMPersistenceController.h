...
- (void)_handleCompletedStillImageJobForRequest:(id)arg1 withReply:(id)arg2 fromBatchOfSize:(NSUInteger)arg3 completionHandler:(CDUnknownBlockType)arg4 error:(id)arg5;
