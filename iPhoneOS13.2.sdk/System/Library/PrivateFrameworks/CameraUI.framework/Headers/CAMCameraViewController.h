...
@class CAMBurstController, CAMKeepAliveController, CAMLocationController, CAMMotionController, CAMNebulaDaemonProxyManager, CAMPersistenceController, CAMPowerController, CAMProtectionController, CAMRemoteShutterController, CAMReviewButton, CAMThumbnailGenerator, CAMTimelapseController, CAMViewfinderViewController, CUCaptureController, NSMutableDictionary, NSObject, PAImageConversionServiceClient, PAVideoConversionServiceClient;
...
- (void)stillImagePersistenceCoordinator:(id)arg1 requestsDispatchForResultSpecifiers:(NSUInteger)arg2 photoProperties:(id)arg3 videoProperties:(id)arg4 unfilteredPhotoProperties:(id)arg5 unfilteredVideoProperties:(id)arg6 assetAdjustments:(id)arg7 error:(id)arg8;
...
// - (id)_clientPropertiesForVideoURL:(id)arg1 renderedURL:(id)arg2 duration:(CDStruct_1b6d18a9)arg3 size:(CGSize)arg4 creationDate:(id)arg5 captureOrientation:(long long)arg6 previewOrientation:(long long)arg7 adjustments:(id)arg8 uniqueIdentifier:(id)arg9 savedToPhotoLibrary:(BOOL)arg10;
...
- (NSUInteger)_capturePersistenceBehaviorForViewfinderPersistenceBehavior:(NSUInteger)arg1;
- (NSUInteger)_viewfinderPersistenceBehaviorForCapturePersistenceBehavior:(NSUInteger)arg1;
