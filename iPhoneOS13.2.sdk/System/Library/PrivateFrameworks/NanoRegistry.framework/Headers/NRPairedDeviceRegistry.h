...
+ (Class)proxyClass;
@property(nonatomic) NSUInteger callCount; // @synthesize callCount=_callCount;
...
@property(nonatomic) NSUInteger lastStatus; // @synthesize lastStatus=_lastStatus;
...
- (NSUInteger)migrationCountForPairingID:(id)arg1;
...
- (void)_pingActiveGizmoWithPriority:(long long)arg1 withMessageSize:(NSUInteger)arg2 withBlock:(CDUnknownBlockType)arg3;
...
- (void)_fireChangeNotificationsForDiff:(id)arg1 collection:(id)arg2 secureProperties:(id)arg3 index:(NSUInteger)arg4 notify:(BOOL)arg5;
...
- (NSUInteger)_getStatusWithCollection:(id)arg1;
