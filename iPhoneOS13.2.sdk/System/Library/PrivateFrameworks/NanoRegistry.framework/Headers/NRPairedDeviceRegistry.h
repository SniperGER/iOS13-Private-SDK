...
- (void)setMigrationConsented:(_Bool)arg1 forDevice:(id)arg2 withBlock:(id /* block */)arg3;
- (void)setMigrationConsented:(_Bool)arg1 forDeviceID:(id)arg2 withBlock:(id /* block */)arg3;
...
- (void)unpairWithDevice:(id)arg1 shouldObliterate:(_Bool)arg2 operationHasBegun:(id /* block */)arg3;
...
- (void)setActivePairedDevice:(id)arg1 isMagicSwitch:(_Bool)arg2 operationHasCompleted:(id /* block */)arg3;
