...
- (void)_scanEventsInLastMessageOnly:(_Bool)arg1 synchronously:(_Bool)arg2 completionHandler:(id /* block */)arg3;
- (void)scanEventsInLastMessageOnly:(_Bool)arg1 synchronously:(_Bool)arg2 completionHandler:(id /* block */)arg3;
