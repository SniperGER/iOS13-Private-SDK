...
@interface IPEventClassificationType : NSObject
{
    ...
    NSUInteger _preferedMeridian;
    NSString *_language;
    NSUInteger _classificationDepth;
...
+ (id)humanReadableClusterType:(NSUInteger)arg1;
...
+ (id)_identifierForCluster:(NSUInteger)arg1;
...
+ (id)taxonomyForLanguageID:(id)arg1 clusterType:(NSUInteger)arg2;
+ (double)_averageDistanceBetweenFeatureKeyword:(id)arg1 featureDates:(id)arg2 subjectLength:(NSUInteger)arg3 inSubject:(BOOL)arg4;
+ (double)_scoreForKeywordsInSubject:(BOOL)arg1 distanceToDates:(double)arg2 polarity:(NSUInteger)arg3 matchedRatio:(double)arg4 keywordType:(NSUInteger)arg5;
...
@property(nonatomic) NSUInteger classificationDepth; // @synthesize classificationDepth=_classificationDepth;
@property(nonatomic, getter=isAllDayAllowed) BOOL allDayAllowed; // @synthesize allDayAllowed=_allDayAllowed;
@property(retain, nonatomic) NSString *language; // @synthesize language=_language;
@property(nonatomic) NSUInteger preferedMeridian; // @synthesize preferedMeridian=_preferedMeridian;
