...
- (void)setSecondaryViewVisible:(_Bool)arg1 withAnimationType:(unsigned long long)arg2 completion:(id /* block */)arg3;
- (void)setSecondaryViewVisible:(_Bool)arg1 animated:(_Bool)arg2 completion:(id /* block */)arg3;
