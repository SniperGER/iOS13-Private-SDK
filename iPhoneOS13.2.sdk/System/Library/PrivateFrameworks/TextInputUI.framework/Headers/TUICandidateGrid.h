...
- (void)setRowType:(long long)arg1 options:(unsigned long long)arg2 style:(id)arg3 animated:(_Bool)arg4 animator:(id)arg5 completion:(id /* block */)arg6;
- (void)setRowType:(long long)arg1 options:(unsigned long long)arg2 animated:(_Bool)arg3 completion:(id /* block */)arg4;
