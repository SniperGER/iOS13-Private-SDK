...
- (void)setRowType:(long long)arg1 options:(NSUInteger)arg2 style:(id)arg3 animated:(BOOL)arg4 animator:(id)arg5 completion:(CDUnknownBlockType)arg6;
- (void)setRowType:(long long)arg1 options:(NSUInteger)arg2 animated:(BOOL)arg3 completion:(CDUnknownBlockType)arg4;
