...
- (void)setState:(id)arg1 animated:(BOOL)arg2 animator:(id)arg3 options:(NSUInteger)arg4 force:(BOOL)arg5 completion:(CDUnknownBlockType)arg6;
- (void)setState:(id)arg1 animated:(BOOL)arg2 options:(NSUInteger)arg3 force:(BOOL)arg4 completion:(CDUnknownBlockType)arg5;
- (void)finalizeLayoutChange;
- (void)updatePrimaryGridRowTypeWithOptions:(NSUInteger)arg1 animated:(BOOL)arg2 animator:(id)arg3 completion:(CDUnknownBlockType)arg4;
