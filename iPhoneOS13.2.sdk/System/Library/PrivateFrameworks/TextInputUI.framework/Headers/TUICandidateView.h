...
- (void)setState:(id)arg1 animated:(_Bool)arg2 force:(_Bool)arg3 completion:(id /* block */)arg4;
- (void)setState:(id)arg1 animated:(_Bool)arg2 animator:(id)arg3 options:(unsigned long long)arg4 force:(_Bool)arg5 completion:(id /* block */)arg6;
- (void)setState:(id)arg1 animated:(_Bool)arg2 options:(unsigned long long)arg3 force:(_Bool)arg4 completion:(id /* block */)arg5;
- (void)finalizeLayoutChange;
- (void)updatePrimaryGridRowTypeWithOptions:(unsigned long long)arg1 animated:(_Bool)arg2 animator:(id)arg3 completion:(id /* block */)arg4;
