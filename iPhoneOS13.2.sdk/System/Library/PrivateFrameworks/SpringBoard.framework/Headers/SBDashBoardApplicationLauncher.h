...
- (void)_activateAppSceneBelowDashBoard:(id)arg1 secureAppType:(unsigned long long)arg2 withActions:(id)arg3 interactive:(_Bool)arg4 completion:(id /* block */)arg5;
- (void)_reallyActivateAppSceneWithEntity:(id)arg1 interactive:(_Bool)arg2 withCompletion:(id /* block */)arg3;
