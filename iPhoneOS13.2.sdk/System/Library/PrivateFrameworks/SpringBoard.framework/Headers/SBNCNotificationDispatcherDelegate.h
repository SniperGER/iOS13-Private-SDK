...
- (void)dispatcher:(id)arg1 willExecuteAction:(id)arg2 forDestination:(id)arg3 notificationRequest:(id)arg4 requestAuthentication:(BOOL)arg5 withParameters:(id)arg6 completionBlock:(CDUnknownBlockType)arg7;
