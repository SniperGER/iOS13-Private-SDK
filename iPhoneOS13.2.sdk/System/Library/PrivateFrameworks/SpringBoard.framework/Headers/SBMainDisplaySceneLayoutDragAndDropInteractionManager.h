...
@property(copy, nonatomic) id /* block */ windowDragSessionPrepareCompletionBlock; // @synthesize windowDragSessionPrepareCompletionBlock=_windowDragSessionPrepareCompletionBlock;
...
- (_Bool)_anyActiveAndVisibleSceneEntityMatches:(id /* block */)arg1;
