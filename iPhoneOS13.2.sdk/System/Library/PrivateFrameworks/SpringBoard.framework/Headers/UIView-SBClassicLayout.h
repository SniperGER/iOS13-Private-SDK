...
+ (void)sb_animateWithSettings:(id)arg1 interactive:(_Bool)arg2 animations:(id /* block */)arg3 completion:(id /* block */)arg4;
...
- (void)sb_removeAnimationsIncludingSubviews:(_Bool)arg1 predicate:(id /* block */)arg2;
