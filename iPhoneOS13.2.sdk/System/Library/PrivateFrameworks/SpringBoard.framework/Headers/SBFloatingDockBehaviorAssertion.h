...
- (void)modifyProgress:(double)arg1 interactive:(_Bool)arg2 completion:(id /* block */)arg3;
- (void)invalidateWithCompletion:(id /* block */)arg1;
- (void)invalidate;
- (void)dealloc;
- (id)initWithFloatingDockController:(id)arg1 visibleProgress:(double)arg2 animated:(_Bool)arg3 gesturePossible:(_Bool)arg4 atLevel:(unsigned long long)arg5 reason:(id)arg6 withCompletion:(id /* block */)arg7;
- (id)initWithVisibleProgress:(double)arg1 gesturePossible:(_Bool)arg2 atLevel:(unsigned long long)arg3 reason:(id)arg4 withCompletion:(id /* block */)arg5;
- (id)initWithPinned:(_Bool)arg1 gesturePossible:(_Bool)arg2 atLevel:(unsigned long long)arg3 reason:(id)arg4 withCompletion:(id /* block */)arg5;
- (id)init;
