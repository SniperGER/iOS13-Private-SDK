...
@property(copy, nonatomic) id /* block */ ppt_transitionEndsCallback; // @synthesize ppt_transitionEndsCallback=_ppt_transitionEndsCallback;
@property(copy, nonatomic) id /* block */ ppt_transitionBeginsCallback; // @synthesize ppt_transitionBeginsCallback=_ppt_transitionBeginsCallback;
...
@property(copy, nonatomic) id /* block */ iconAnimatorCompletionBlock; // @synthesize iconAnimatorCompletionBlock=_iconAnimatorCompletionBlock;
...
@property(copy, nonatomic) id /* block */ secureAppCleanupHandler; // @synthesize secureAppCleanupHandler=_secureAppCleanupHandler;
...
- (void)_setTransitionProgress:(double)arg1 animated:(_Bool)arg2 gestureActive:(_Bool)arg3 coverSheetProgress:(double)arg4 completion:(id /* block */)arg5;
...
- (void)coverSheetSlidingViewController:(id)arg1 animateForGestureActive:(_Bool)arg2 withProgress:(double)arg3 beginBlock:(id /* block */)arg4 endBlock:(id /* block */)arg5;
...
- (_Bool)isInSecureApp;
- (void)setCoverSheetPresented:(_Bool)arg1 animated:(_Bool)arg2 options:(unsigned long long)arg3 withCompletion:(id /* block */)arg4;
- (void)setCoverSheetPresented:(_Bool)arg1 animated:(_Bool)arg2 withCompletion:(id /* block */)arg3;
- (id)init;
