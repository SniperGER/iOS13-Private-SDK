...
- (_Bool)_sendEvent:(long long)arg1 buttonKind:(long long)arg2 withPriority:(long long)arg3 continuation:(out id /* block */ *)arg4;
...
- (_Bool)consumeHeadsetPlayPauseSinglePressDownWithPriority:(long long)arg1 continuation:(out id /* block */ *)arg2;
- (_Bool)consumeVolumeDecreaseButtonSinglePressUpWithPriority:(long long)arg1;
- (_Bool)consumeVolumeDecreaseButtonSinglePressDownWithPriority:(long long)arg1 continuation:(out id /* block */ *)arg2;
- (_Bool)consumeVolumeIncreaseButtonSinglePressUpWithPriority:(long long)arg1;
- (_Bool)consumeVolumeIncreaseButtonSinglePressDownWithPriority:(long long)arg1 continuation:(out id /* block */ *)arg2;
