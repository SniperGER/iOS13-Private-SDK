...
- (void)_presentNotificationViewController:(id)arg1 modal:(_Bool)arg2 forRequest:(id)arg3 completion:(id /* block */)arg4;
...
- (void)_postNotificationRequest:(id)arg1 modal:(_Bool)arg2 completion:(id /* block */)arg3;
...
- (void)_runLongLookDismissalTestAndClearNotifications:(_Bool)arg1 withBeginBlock:(id /* block */)arg2 completion:(id /* block */)arg3;
