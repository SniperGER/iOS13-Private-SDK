...
- (CGRect)_updateRectInReferenceCoordinateSpace:(CGRect)arg1 withBlock:(CDUnknownBlockType)arg2;
- (CGPoint)_updatePointInReferenceCoordinateSpace:(CGPoint)arg1 withBlock:(CDUnknownBlockType)arg2;
