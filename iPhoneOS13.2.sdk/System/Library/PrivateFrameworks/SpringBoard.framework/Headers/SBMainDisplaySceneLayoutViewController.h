...
- (struct CGRect)_updateRectInReferenceCoordinateSpace:(struct CGRect)arg1 withBlock:(id /* block */)arg2;
- (struct CGPoint)_updatePointInReferenceCoordinateSpace:(struct CGPoint)arg1 withBlock:(id /* block */)arg2;
