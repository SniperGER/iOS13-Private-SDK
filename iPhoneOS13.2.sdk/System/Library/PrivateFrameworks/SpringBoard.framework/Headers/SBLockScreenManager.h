...
@property(copy, nonatomic) id /* block */ unlockActionBlock; // @synthesize unlockActionBlock=_unlockActionBlock;
...
- (void)attemptUnlockWithPasscode:(id)arg1 finishUIUnlock:(_Bool)arg2 completion:(id /* block */)arg3;
- (_Bool)_attemptUnlockWithPasscode:(id)arg1 mesa:(_Bool)arg2 finishUIUnlock:(_Bool)arg3 completion:(id /* block */)arg4;
...
- (_Bool)_unlockWithRequest:(id)arg1 cancelPendingRequests:(_Bool)arg2 completion:(id /* block */)arg3;
...
- (void)_activateLockScreenAnimated:(_Bool)arg1 animationProvider:(id /* block */)arg2 automatically:(_Bool)arg3 inScreenOffMode:(_Bool)arg4 dimInAnimation:(_Bool)arg5 dismissNotificationCenter:(_Bool)arg6 completion:(id /* block */)arg7;
