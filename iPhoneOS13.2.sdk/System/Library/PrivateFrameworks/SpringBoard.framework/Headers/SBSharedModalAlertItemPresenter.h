...
- (void)dismissAlertItem:(id)arg1 animated:(_Bool)arg2 completion:(id /* block */)arg3;
- (void)presentAlertItem:(id)arg1 isLocked:(_Bool)arg2 animated:(_Bool)arg3 completion:(id /* block */)arg4;
