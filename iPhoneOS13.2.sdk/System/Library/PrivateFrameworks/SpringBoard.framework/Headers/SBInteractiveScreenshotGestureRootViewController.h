...
// - (void).cxx_destruct;
- (void)_updateWithUpdateMode:(long long)arg1 contentAnimationSettings:(id)arg2 commitProgress:(double)arg3 additionalContentTranslation:(CGPoint)arg4 completion:(CDUnknownBlockType)arg5;
- (void)_updateWithUpdateMode:(long long)arg1 commitProgress:(double)arg2 additionalContentTranslation:(CGPoint)arg3 completion:(CDUnknownBlockType)arg4;
