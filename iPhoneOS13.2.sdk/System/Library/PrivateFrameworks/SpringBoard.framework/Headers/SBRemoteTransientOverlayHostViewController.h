...
- (void)dismissForTransientOverlayAnimated:(_Bool)arg1 completion:(id /* block */)arg2;
- (void)presentForTransientOverlayAnimated:(_Bool)arg1 completion:(id /* block */)arg2;
