...
@class NSMutableArray, NSMutableDictionary, NSSet, SBAppSuggestionManager, SBApplicationController, SBDockIconListView, SBFloatingDockSuggestionsModel, SBFloatingDockViewController, SBIconController, SBIconListModel, SBLayoutStateTransitionCoordinator, SBRecentDisplayItemsDataStore, SBRecentDisplayItemsDefaults;
...
@property(readonly, nonatomic) NSUInteger numberOfRecents; // @synthesize numberOfRecents=_numberOfRecents;
...
- (void)_fadeOutIcon:(id)arg1 atIndex:(NSUInteger)arg2 isReplacing:(BOOL)arg3 completion:(CDUnknownBlockType)arg4;
...
- (void)dockSuggestionsModel:(id)arg1 didReplaceItem:(id)arg2 atIndex:(NSUInteger)arg3 withItem:(id)arg4 atIndex:(NSUInteger)arg5 involvesContinuity:(BOOL)arg6;
- (void)dockSuggestionsModel:(id)arg1 didRemoveItem:(id)arg2 atIndex:(NSUInteger)arg3 involvesContinuity:(BOOL)arg4;
- (void)dockSuggestionsModel:(id)arg1 didInsertItem:(id)arg2 atIndex:(NSUInteger)arg3 involvesContinuity:(BOOL)arg4;
- (void)_performOrDefer:(BOOL)arg1 iconUpdate:(CDUnknownBlockType)arg2;
- (void)_emitPresentedEventInvolvingContinuity:(BOOL)arg1 fromModel:(id)arg2 atIndex:(NSUInteger)arg3;
...
- (id)initWithNumberOfRecents:(NSUInteger)arg1 iconController:(id)arg2 applicationController:(id)arg3 layoutStateTransitionCoordinator:(id)arg4 suggestionsModel:(id)arg5 iconViewProvider:(id)arg6;
