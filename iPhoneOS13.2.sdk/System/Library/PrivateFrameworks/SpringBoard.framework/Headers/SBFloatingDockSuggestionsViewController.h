...
- (void)_fadeInIcon:(id)arg1 isReplacing:(_Bool)arg2 completion:(id /* block */)arg3;
- (void)_fadeOutIcon:(id)arg1 atIndex:(unsigned long long)arg2 isReplacing:(_Bool)arg3 completion:(id /* block */)arg4;
...
- (void)_performOrDefer:(_Bool)arg1 iconUpdate:(id /* block */)arg2;
