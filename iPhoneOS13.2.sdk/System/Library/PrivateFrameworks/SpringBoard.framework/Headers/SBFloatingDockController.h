...
- (void)floatingDockRootViewController:(id)arg1 modifyProgress:(double)arg2 interactive:(_Bool)arg3 completion:(id /* block */)arg4;
...
- (void)_dismissFloatingDockIfPresentedAnimated:(_Bool)arg1 completionHandler:(id /* block */)arg2;
- (void)_presentFloatingDockIfDismissedAnimated:(_Bool)arg1 completionHandler:(id /* block */)arg2;
- (void)_handleSystemGestureRecognizer:(id)arg1;
- (void)registerAsSharedInstance;
- (void)_evaluateAssertions:(unsigned long long)arg1 interactive:(_Bool)arg2 withCompletion:(id /* block */)arg3;
...
- (void)_updateFloatingDockBehaviorAssertionsInteractive:(_Bool)arg1 completion:(id /* block */)arg2;
...
- (void)dismissPresentedFolderAnimated:(_Bool)arg1 withTransitionContext:(id)arg2 completion:(id /* block */)arg3;
- (void)dismissPresentedFolderAnimated:(_Bool)arg1 completion:(id /* block */)arg2;
- (void)presentFolderForIcon:(id)arg1 location:(id)arg2 animated:(_Bool)arg3 completion:(id /* block */)arg4;
...
- (void)dismissFloatingDockIfPresentedAnimated:(_Bool)arg1 completionHandler:(id /* block */)arg2;
- (void)presentFloatingDockIfDismissedAnimated:(_Bool)arg1 completionHandler:(id /* block */)arg2;
