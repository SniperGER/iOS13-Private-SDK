...
- (NSArray *)iconManager:(SBHIconManager *)arg1 defaultAutomaticFavoriteIconIdentifiersWithMaximumCount:(NSUInteger)arg2;
...
- (NSUInteger)maximumListCountForFoldersForIconManager:(SBHIconManager *)arg1;
- (BOOL)isFloatingDockVisibleForIconManager:(SBHIconManager *)arg1;
- (UIColor *)iconManager:(SBHIconManager *)arg1 accessibilityTintColorForScreenRect:(CGRect)arg2;
- (SBHIconAnimationSettings *)iconManager:(SBHIconManager *)arg1 animator:(SBHomeScreenIconTransitionAnimator *)arg2 animationSettingsForOperation:(NSUInteger)arg3 childViewController:(SBNestingViewController *)arg4;
...
- (void)iconManager:(SBHIconManager *)arg1 wantsToAdjustTodayContentForEdgeBounceForScrollOffset:(CGPoint)arg2;
...
- (UIEdgeInsets)iconManager:(SBHIconManager *)arg1 contentOverlayInsetsFromParentIfAvailableForFolderController:(SBFolderController *)arg2;
- (void)iconManager:(SBHIconManager *)arg1 statusBarInsetsDidChange:(UIEdgeInsets)arg2;
- (UIEdgeInsets)iconManager:(SBHIconManager *)arg1 statusBarEdgeInsetsForFolderController:(SBFolderController *)arg2;
...
- (BOOL)iconManager:(SBHIconManager *)arg1 shouldActivateApplicationShortcutItem:(SBSApplicationShortcutItem *)arg2 atIndex:(NSUInteger)arg3 forIconView:(SBIconView *)arg4;
...
- (void)iconManager:(SBHIconManager *)arg1 didEndIconDragWithUniqueIdentifier:(NSUUID *)arg2 numberOfDraggedItems:(NSUInteger)arg3;
- (void)iconManager:(SBHIconManager *)arg1 didAddItemsToIconDragWithUniqueIdentifier:(NSUUID *)arg2 numberOfDraggedItems:(NSUInteger)arg3;
- (void)iconManager:(SBHIconManager *)arg1 willBeginIconDragWithUniqueIdentifier:(NSUUID *)arg2 numberOfDraggedItems:(NSUInteger)arg3;
...
- (NSUInteger)allowedInterfaceOrientationsForIconManager:(SBHIconManager *)arg1;
