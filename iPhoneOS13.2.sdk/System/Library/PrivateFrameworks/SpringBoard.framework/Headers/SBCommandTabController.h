...
@class NSMutableSet, NSOrderedSet, NSTimer, PTToggleTestRecipe, SBCommandTabViewController, SBRecentDisplayItemsController, SBRecentDisplayItemsDataStore, SBRecentDisplayItemsDefaults, SBWindow, UIApplicationSceneDeactivationAssertion;
