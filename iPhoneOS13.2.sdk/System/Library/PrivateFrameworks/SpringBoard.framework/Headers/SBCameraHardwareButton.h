...
@class BKSHIDEventDeliveryManager, BSMutableIntegerMap, BSTimer, CMPocketStateManager, NSMutableIndexSet, RBSProcessMonitor, SBApplicationController, SBBacklightController, SBCameraHardwareButtonDefaults, SBCameraHardwareButtonSettings, SBCoverSheetPresentationManager, SBHIDButtonStateArbiter, SBLockScreenManager, SBProximitySensorManager, SBSceneManager, _SBCameraLaunchCondition;
