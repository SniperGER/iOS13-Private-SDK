...
- (void)_reallyShowLaunchAlertOfType:(NSUInteger)arg1 withLaunchAlertInfo:(id)arg2 application:(id)arg3;
...
- (void)showLaunchAlertOfType:(NSUInteger)arg1 forApplication:(id)arg2;
- (void)dealloc;
