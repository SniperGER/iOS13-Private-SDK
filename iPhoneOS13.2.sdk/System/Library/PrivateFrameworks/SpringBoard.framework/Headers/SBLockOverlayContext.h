...
@property(copy, nonatomic) id /* block */ deactivationBlock; // @synthesize deactivationBlock=_deactivationBlock;
@property(copy, nonatomic) id /* block */ activationBlock; // @synthesize activationBlock=_activationBlock;
