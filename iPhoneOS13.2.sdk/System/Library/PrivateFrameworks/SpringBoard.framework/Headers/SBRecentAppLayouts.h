...
@class NSDictionary, NSMutableArray, NSMutableSet, SBAppSwitcherDefaults, SBApplicationController, SBIconController, SBMainDisplaySceneManager, SBRecentAppLayoutsPersister;
