...
- (id /* block */)_dismissSwitcherValidatorToAppLayout:(id)arg1 dismissFloatingSwitcher:(_Bool)arg2 withEventLabel:(id)arg3 animated:(_Bool)arg4;
- (_Bool)_dismissSwitcherNoninteractivelyToAppLayout:(id)arg1 dismissFloatingSwitcher:(_Bool)arg2 animated:(_Bool)arg3;
- (id /* block */)_activateSwitcherValidatorWithEventLabel:(id)arg1 animated:(_Bool)arg2;
- (id /* block */)_toggleSwitcherTransitionValidatorAnimated:(_Bool)arg1;
