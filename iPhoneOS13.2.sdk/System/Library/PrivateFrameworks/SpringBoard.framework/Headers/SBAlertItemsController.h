...
- (void)_buddyDidExit;
- (void)moveActiveUnlockedAlertsToPendingWithAnimation:(_Bool)arg1 completion:(id /* block */)arg2;
...
- (void)_dismissAlertItem:(id)arg1 fromPresenter:(id)arg2 forReason:(int)arg3 animated:(_Bool)arg4 completion:(id /* block */)arg5;
- (void)_deactivateAlertItem:(id)arg1 reason:(int)arg2 animated:(_Bool)arg3 alertDismissCompletion:(id /* block */)arg4;
...
- (void)_performBatchActions:(id /* block */)arg1 animated:(_Bool)arg2 processQueue:(_Bool)arg3;
