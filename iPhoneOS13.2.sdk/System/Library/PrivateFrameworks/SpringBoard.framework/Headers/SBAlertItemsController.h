...
- (void)_enumerateWithDirection:(NSUInteger)arg1 presentationsWithType:(NSUInteger)arg2 usingBlock:(CDUnknownBlockType)arg3;
- (void)_enumeratePresentationsWithType:(NSUInteger)arg1 usingBlock:(CDUnknownBlockType)arg2;
