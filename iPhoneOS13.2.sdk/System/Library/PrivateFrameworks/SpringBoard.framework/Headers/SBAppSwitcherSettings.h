...
@interface SBAppSwitcherSettings : PTSettings
{
    ...
    NSUInteger _numberOfSnapshotsToCacheInSwitcher;
    NSUInteger _numberOfSnapshotsToAlwaysKeepAround;
...
@property NSUInteger numberOfSnapshotsToAlwaysKeepAround; // @synthesize numberOfSnapshotsToAlwaysKeepAround=_numberOfSnapshotsToAlwaysKeepAround;
@property NSUInteger numberOfSnapshotsToCacheInSwitcher; // @synthesize numberOfSnapshotsToCacheInSwitcher=_numberOfSnapshotsToCacheInSwitcher;
