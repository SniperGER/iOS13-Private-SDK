...
- (void)performStopAnimationWithFinalInterfaceOrientation:(long long)arg1 finalLayerFrame:(struct CGRect)arg2 animationHandler:(id /* block */)arg3 completionHandler:(id /* block */)arg4;
