...
- (void)removeViewControllerAnimated:(_Bool)arg1 completion:(id /* block */)arg2;
- (void)removeViewController:(id)arg1 animated:(_Bool)arg2 completion:(id /* block */)arg3;
- (void)addViewController:(id)arg1 animated:(_Bool)arg2 completion:(id /* block */)arg3;
