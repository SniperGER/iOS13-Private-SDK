...
@property(copy, nonatomic) id /* block */ sourceAllAnimationsCompletionBlock; // @synthesize sourceAllAnimationsCompletionBlock=_sourceAllAnimationsCompletionBlock;
...
- (void)didEndTargetAnimations:(unsigned long long)arg1 finished:(_Bool)arg2 continueBlock:(id /* block */)arg3;
- (void)willStartTargetAnimations:(unsigned long long)arg1;
- (void)didEndSourceAnimations:(unsigned long long)arg1 finished:(_Bool)arg2 continueBlock:(id /* block */)arg3;
...
- (void)noteTargetAnimationsDidEnd:(unsigned long long)arg1 finished:(_Bool)arg2 continueBlock:(id /* block */)arg3;
- (void)noteTargetAnimationsWillStart:(unsigned long long)arg1;
- (void)noteSourceAnimationsDidEnd:(unsigned long long)arg1 finished:(_Bool)arg2 continueBlock:(id /* block */)arg3;
