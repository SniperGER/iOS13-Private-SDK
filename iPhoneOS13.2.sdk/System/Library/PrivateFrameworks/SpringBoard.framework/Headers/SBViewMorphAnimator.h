...
- (void)noteTargetAnimationsDidEnd:(NSUInteger)arg1 finished:(BOOL)arg2 continueBlock:(CDUnknownBlockType)arg3;
- (void)noteTargetAnimationsWillStart:(NSUInteger)arg1;
- (void)noteSourceAnimationsDidEnd:(NSUInteger)arg1 finished:(BOOL)arg2 continueBlock:(CDUnknownBlockType)arg3;
