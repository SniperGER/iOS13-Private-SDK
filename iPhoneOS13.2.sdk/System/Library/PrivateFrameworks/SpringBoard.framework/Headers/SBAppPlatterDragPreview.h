...
@property(copy, nonatomic) id /* block */ platterViewAlphaAnimationCompletionBlock; // @synthesize platterViewAlphaAnimationCompletionBlock=_platterViewAlphaAnimationCompletionBlock;
@property(retain, nonatomic) SBApplicationBlurContentView *platterView; // @synthesize platterView=_platterView;
@property(retain, nonatomic) UIView *sourceView; // @synthesize sourceView=_sourceView;
@property(copy, nonatomic) id /* block */ cleanUpHandler; // @synthesize cleanUpHandler=_cleanUpHandler;
