...
@class FBDisplayLayoutTransition, FBSynchronizedTransactionGroup, NSMutableSet, NSSet, SBSceneBackgroundedStatusAssertion, SBSceneLayoutSynchronizeTransitionTransaction, SBWorkspaceApplicationSceneTransitionContext, SBWorkspaceTransitionRequest;
