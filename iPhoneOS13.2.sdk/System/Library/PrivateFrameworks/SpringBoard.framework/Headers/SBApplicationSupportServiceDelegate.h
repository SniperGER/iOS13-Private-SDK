...
// - (void).cxx_destruct;
- (void)destroyScenesWithPersistentIdentifiers:(id)arg1 animationType:(NSUInteger)arg2 destroySessions:(BOOL)arg3 forClient:(id)arg4 completion:(CDUnknownBlockType)arg5;
