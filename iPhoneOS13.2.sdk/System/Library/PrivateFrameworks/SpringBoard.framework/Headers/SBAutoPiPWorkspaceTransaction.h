...
+ (_Bool)_shouldAutoPiPEnteringBackgroundForRequest:(id)arg1 transientOverlayEntityFoundBlock:(id /* block */)arg2 appEntityFoundBlock:(id /* block */)arg3;
+ (_Bool)shouldAutoPiPEnteringBackgroundForRequest:(id)arg1 entityFoundBlock:(id /* block */)arg2;
