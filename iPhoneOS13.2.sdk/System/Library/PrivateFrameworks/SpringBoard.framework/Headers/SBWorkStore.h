...
@interface SBWorkStore : NSObject
{
    ...
    NSUInteger _maxWorkPerKey;
    NSMutableArray *_observers;
    NSObject<OS_dispatch_queue> *_observerQueue;
    double _defaultWorkExpirationPeriod;
}

@property(readonly, nonatomic) NSUInteger maxWorkPerKey; // @synthesize maxWorkPerKey=_maxWorkPerKey;
...
- (id)initWithMaximumNumberOfWorkItemsPerKey:(NSUInteger)arg1;
