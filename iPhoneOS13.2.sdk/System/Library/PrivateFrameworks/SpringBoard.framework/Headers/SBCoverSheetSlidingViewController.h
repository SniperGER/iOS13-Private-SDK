...
- (void)_finishTransitionToPresented:(_Bool)arg1 animated:(_Bool)arg2 withCompletion:(id /* block */)arg3;
...
- (void)_dismissCoverSheetAnimated:(_Bool)arg1 withCompletion:(id /* block */)arg2;
- (void)_presentCoverSheetAnimated:(_Bool)arg1 withCompletion:(id /* block */)arg2;
...
- (void)setPresented:(_Bool)arg1 animated:(_Bool)arg2 withCompletion:(id /* block */)arg3;
- (void)invalidate;
- (void)dealloc;
