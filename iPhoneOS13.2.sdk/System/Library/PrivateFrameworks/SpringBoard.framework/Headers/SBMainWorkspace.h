...
- (_Bool)presentTransientOverlayViewController:(id)arg1 animated:(_Bool)arg2 completion:(id /* block */)arg3;
- (_Bool)dismissTransientOverlayViewController:(id)arg1 animated:(_Bool)arg2 completion:(id /* block */)arg3;
...
- (void)_attemptUnlockToApplication:(id)arg1 showPasscode:(_Bool)arg2 origin:(id)arg3 givenOrigin:(id)arg4 options:(id)arg5 completion:(id /* block */)arg6;
...
- (id)_selectTransactionForReturningToTheLockScreenFromApp:(id)arg1 animated:(_Bool)arg2 forceToBuddy:(_Bool)arg3 withResult:(id /* block */)arg4;
...
- (_Bool)_setCurrentTransactionForRequest:(id)arg1 fallbackProvider:(id /* block */)arg2;
...
- (_Bool)_executeTransitionRequest:(id)arg1 options:(unsigned long long)arg2 validator:(id /* block */)arg3;
...
- (_Bool)executeTransitionRequest:(id)arg1 withValidator:(id /* block */)arg2;
- (_Bool)executeTransitionRequest:(id)arg1;
- (_Bool)requestTransitionWithOptions:(unsigned long long)arg1 builder:(id /* block */)arg2 validator:(id /* block */)arg3;
- (_Bool)requestTransitionWithBuilder:(id /* block */)arg1;
