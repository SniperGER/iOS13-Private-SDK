...
- (NSUInteger)defaultSupportedInterfaceOrientationsForTransientOverlayPresentationManager:(id)arg1;
...
- (void)systemServicePrepareForShutdown:(id)arg1 withOptions:(NSUInteger)arg2;
...
- (BOOL)_executeTransitionRequest:(id)arg1 options:(NSUInteger)arg2 validator:(CDUnknownBlockType)arg3;
...
- (BOOL)requestTransitionWithOptions:(NSUInteger)arg1 builder:(CDUnknownBlockType)arg2 validator:(CDUnknownBlockType)arg3;
