...
- (void)dismissPresentedBannerAnimated:(_Bool)arg1 completion:(id /* block */)arg2;
- (void)postNotificationRequest:(id)arg1 withPresentingViewController:(id)arg2 animated:(_Bool)arg3 completion:(id /* block */)arg4;
