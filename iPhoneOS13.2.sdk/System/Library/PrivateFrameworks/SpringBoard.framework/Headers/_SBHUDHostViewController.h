...
- (void)_executeDismissHUD:(id)arg1 animated:(_Bool)arg2 completion:(id /* block */)arg3;
- (void)_executePresentNewHUD:(id)arg1 animated:(_Bool)arg2 completion:(id /* block */)arg3;
- (id)_buildTransitionContextToPresentHUD:(id)arg1 dismissHUD:(id)arg2 animated:(_Bool)arg3 delegate:(id)arg4 containerView:(id)arg5 completion:(id /* block */)arg6;
...
- (void)dismissHUD:(id)arg1 animated:(_Bool)arg2 completion:(id /* block */)arg3;
- (void)presentHUD:(id)arg1 animated:(_Bool)arg2 completion:(id /* block */)arg3;
