...
- (void)_animateTransitionFromViewController:(id)arg1 toViewController:(id)arg2 containerView:(id)arg3 isAnimated:(_Bool)arg4 otherAnimations:(id /* block */)arg5 completion:(id /* block */)arg6;
