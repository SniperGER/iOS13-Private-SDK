...
- (void)_updateDataNetworkItem:(int)arg1 withData:(id)arg2 primary:(_Bool)arg3 dataNetworkTypeGetter:(id /* block */)arg4 dataNetworkTypeSetter:(id /* block */)arg5;
...
- (void)_tickRefCount:(long long *)arg1 up:(_Bool)arg2 withTransitionBlock:(id /* block */)arg3;
