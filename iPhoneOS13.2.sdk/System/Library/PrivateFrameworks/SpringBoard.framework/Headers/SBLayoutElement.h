...
- (id)initWithIdentifier:(id)arg1 layoutRole:(long long)arg2 supportedLayoutRoles:(NSUInteger)arg3 layoutAttributes:(NSUInteger)arg4 viewControllerClass:(Class)arg5 entityGenerator:(CDUnknownBlockType)arg6;
