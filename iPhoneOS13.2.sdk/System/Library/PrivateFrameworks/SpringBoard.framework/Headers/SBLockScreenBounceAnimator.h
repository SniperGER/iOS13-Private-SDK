...
@property(copy) id /* block */ completedBlock; // @synthesize completedBlock=_completedBlock;
@property(copy) id /* block */ canceledBlock; // @synthesize canceledBlock=_canceledBlock;
@property(copy) id /* block */ translateBlock; // @synthesize translateBlock=_translateBlock;
@property(copy) id /* block */ prepareBlock; // @synthesize prepareBlock=_prepareBlock;
@property(copy) id /* block */ shouldBeginBlock; // @synthesize shouldBeginBlock=_shouldBeginBlock;
