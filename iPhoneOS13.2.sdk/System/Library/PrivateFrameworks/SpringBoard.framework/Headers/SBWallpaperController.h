...
- (void)wallpaperServer:(id)arg1 setWallpaperVideoWithWallpaperMode:(id)arg2 cropRect:(CGRect)arg3 wallpaperMode:(long long)arg4 completionHandler:(CDUnknownBlockType)arg5;
...
- (id)wallpaperView:(id)arg1 wallpaperConfigurationIncludingValueTypes:(NSUInteger)arg2;
...
- (id)_newFakeBlurViewForVariant:(long long)arg1 style:(long long)arg2 transformOptions:(NSUInteger)arg3;
...
- (id)_makeWallpaperViewWithConfiguration:(id)arg1 forVariant:(long long)arg2 shared:(BOOL)arg3 options:(NSUInteger)arg4;
- (void)cleanupOldSharedWallpaper:(id)arg1 lockSreenWallpaper:(id)arg2 homeScreenWallpaper:(id)arg3;
- (void)_updateSeparateWallpaperForVariants:(long long)arg1 options:(NSUInteger)arg2 wallpaperMode:(long long)arg3;
- (void)_precacheStyles:(id)arg1 usingTraitCollection:(id)arg2;
- (void)_updateSharedWallpaperWithOptions:(NSUInteger)arg1 wallpaperMode:(long long)arg2;
- (BOOL)_isWallpaperView:(id)arg1 displayingWallpaperWithConfiguration:(id)arg2 forVariant:(long long)arg3;
- (void)_updateWallpaperForLocations:(long long)arg1 options:(NSUInteger)arg2 wallpaperMode:(long long)arg3 withCompletion:(CDUnknownBlockType)arg4;
- (void)_updateWallpaperForLocations:(long long)arg1 options:(NSUInteger)arg2 withCompletion:(CDUnknownBlockType)arg3;
...
- (id)_window;
- (id)vendWallpaperViewForConfiguration:(id)arg1 forVariant:(long long)arg2 shared:(BOOL)arg3 options:(NSUInteger)arg4;
- (Class)_wallpaperViewClassForType:(long long)arg1;
- (NSUInteger)_bestWallpaperViewInitializationOptionsForVariant:(long long)arg1 shared:(BOOL)arg2 wallpaperOptions:(id)arg3 options:(NSUInteger)arg4;
