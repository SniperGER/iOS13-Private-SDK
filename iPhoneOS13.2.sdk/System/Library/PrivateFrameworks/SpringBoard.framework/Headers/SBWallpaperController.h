...
- (void)wallpaperServer:(id)arg1 setWallpaperVideoWithWallpaperMode:(id)arg2 cropRect:(struct CGRect)arg3 wallpaperMode:(long long)arg4 completionHandler:(id /* block */)arg5;
...
- (void)_reloadWallpaperAndFlushCaches:(_Bool)arg1 completionHandler:(id /* block */)arg2;
