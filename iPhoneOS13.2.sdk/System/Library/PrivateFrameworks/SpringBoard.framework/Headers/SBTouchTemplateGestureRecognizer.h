...
@interface SBTouchTemplateGestureRecognizer : UIGestureRecognizer
{
    ...
    NSUInteger _failedRecognitionAttempts;
    NSUInteger _trackingTouchCount;
...
@property(nonatomic, getter=_trackingTouchCount, setter=_setTrackingTouchCount:) NSUInteger trackingTouchCount; // @synthesize trackingTouchCount=_trackingTouchCount;
@property(nonatomic, getter=_failedRecognitionAttempts, setter=_setFailedRecognitionAttempts:) NSUInteger failedRecognitionAttempts; // @synthesize failedRecognitionAttempts=_failedRecognitionAttempts;
