...
- (void)_setScrollViewContentOffset:(CGPoint)arg1 animated:(BOOL)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)setTetheredScrollViewContentOffset:(CGPoint)arg1 animated:(BOOL)arg2 completion:(CDUnknownBlockType)arg3;
