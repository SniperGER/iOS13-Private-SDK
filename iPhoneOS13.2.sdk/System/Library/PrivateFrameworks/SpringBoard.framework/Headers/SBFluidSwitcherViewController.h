...
- (void)_setScrollViewContentOffset:(struct CGPoint)arg1 animated:(_Bool)arg2 completion:(id /* block */)arg3;
...
- (void)_scrollToAppLayout:(id)arg1 animated:(_Bool)arg2 completion:(id /* block */)arg3;
...
- (void)_makeAppLayoutVisibleForTransitionWithContext:(id)arg1 animated:(_Bool)arg2 completion:(id /* block */)arg3;
...
- (void)setTetheredScrollViewContentOffset:(struct CGPoint)arg1 animated:(_Bool)arg2 completion:(id /* block */)arg3;
