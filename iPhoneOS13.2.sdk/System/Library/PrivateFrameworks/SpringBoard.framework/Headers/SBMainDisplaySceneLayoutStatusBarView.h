...
@class NSMutableDictionary, NSMutableSet, SBDeviceApplicationSceneHandle, SBMedusaSettings, SBOrientationTransformWrapperView, UIColor, UIStatusBar, _UIStatusBar;
...
- (void)_setDebugOffsetIndex:(NSUInteger)arg1;
