...
- (void)performPresentationTransitionAnimated:(_Bool)arg1 completionHandler:(id /* block */)arg2;
- (void)performDismissalTransitionAnimated:(_Bool)arg1 completionHandler:(id /* block */)arg2;
