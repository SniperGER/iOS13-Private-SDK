...
- (void)_kickoffUpdater:(id)arg1 forStocks:(id)arg2 comprehensive:(_Bool)arg3 forceUpdate:(_Bool)arg4 completion:(id /* block */)arg5;
- (void)_updateStocksBasic:(id)arg1 forced:(_Bool)arg2 withCompletion:(id /* block */)arg3;
...
- (void)updateStockComprehensive:(id)arg1 forced:(_Bool)arg2 withCompletion:(id /* block */)arg3;
