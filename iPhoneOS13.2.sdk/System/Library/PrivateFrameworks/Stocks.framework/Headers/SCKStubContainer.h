...
@property(copy, nonatomic) id /* block */ willModifyRecords; // @synthesize willModifyRecords=_willModifyRecords;
...
@property(copy, nonatomic) id /* block */ willFinishZoneChanges; // @synthesize willFinishZoneChanges=_willFinishZoneChanges;
