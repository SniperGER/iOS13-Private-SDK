...
- (void)_saveZonesToContainer:(id)arg1 allowRecoveryAttempt:(_Bool)arg2 completion:(id /* block */)arg3;
- (void)_saveZoneToContainer:(id)arg1 allowRecoveryAttempt:(_Bool)arg2 completion:(id /* block */)arg3;
