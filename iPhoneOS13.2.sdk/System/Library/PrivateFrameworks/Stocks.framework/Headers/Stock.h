...
// - (void).cxx_destruct;
- (id)formattedPriceDroppingFractionDigitsIfLengthExceeds:(NSUInteger)arg1;
...
- (BOOL)shouldUseCompanyNameAsListName:(NSUInteger)arg1;
- (id)listNameOverride;
- (id)listNameWithMaxIndexNameLength:(NSUInteger)arg1;
- (id)listName;
