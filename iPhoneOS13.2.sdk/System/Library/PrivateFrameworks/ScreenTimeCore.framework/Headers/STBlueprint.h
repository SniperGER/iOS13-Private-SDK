...
+ (void)_createDisplayNameWithItemNames:(id)arg1 itemCount:(NSUInteger)arg2 completionHandler:(CDUnknownBlockType)arg3;
+ (void)_addWebDomains:(id)arg1 toItemNames:(id)arg2 remainingItems:(NSUInteger)arg3 totalCount:(NSUInteger)arg4 completionHandler:(CDUnknownBlockType)arg5;
