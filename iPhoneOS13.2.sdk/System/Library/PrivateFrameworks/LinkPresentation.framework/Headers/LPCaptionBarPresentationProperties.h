...
@property(nonatomic) CGSize trailingIconSize; // @synthesize trailingIconSize=_trailingIconSize;
...
@property(nonatomic) CGSize leadingIconSize; // @synthesize leadingIconSize=_leadingIconSize;
