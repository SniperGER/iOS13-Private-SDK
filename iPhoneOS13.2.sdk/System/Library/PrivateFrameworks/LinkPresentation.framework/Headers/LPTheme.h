...
+ (id)themeWithStyle:(long long)arg1 icon:(id)arg2 platform:(long long)arg3 sizeClass:(NSUInteger)arg4;
...
- (void)adjustForStyle;
- (id)initWithStyle:(long long)arg1 icon:(id)arg2 platform:(long long)arg3 sizeClass:(NSUInteger)arg4;
