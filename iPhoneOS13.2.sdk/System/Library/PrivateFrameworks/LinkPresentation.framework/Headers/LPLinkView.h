...
@property(nonatomic, setter=_setPreferredSizeClass:) NSUInteger _preferredSizeClass; // @synthesize _preferredSizeClass;
@property(nonatomic, setter=_setTextSafeAreaInset:) UIEdgeInsets _textSafeAreaInset; // @synthesize _textSafeAreaInset;
...
- (void)set_preferredSizeClass:(NSUInteger)arg1;
