...
- (BOOL)deleteAllLocationsFromSourcesWithBundleId:(id)arg1 groupId:(id)arg2 olderThanDate:(id)arg3 atLeastOneLocationRemoved:(BOOL )arg4 deletedCount:(NSUInteger )arg5 error:(id )arg6;
- (BOOL)deleteAllLocationsFromSourcesWithBundleId:(id)arg1 atLeastOneLocationRemoved:(BOOL )arg2 deletedCount:(NSUInteger )arg3 error:(id )arg4;
- (BOOL)deleteAllLocationsFromSourcesWithBundleId:(id)arg1 groupIds:(id)arg2 atLeastOneLocationRemoved:(BOOL )arg3 deletedCount:(NSUInteger )arg4 error:(id )arg5;
- (BOOL)deleteAllLocationsFromSourcesWithBundleId:(id)arg1 documentIds:(id)arg2 atLeastOneLocationRemoved:(BOOL )arg3 deletedCount:(NSUInteger )arg4 error:(id )arg5;
- (BOOL)deleteAllLocationsOlderThanDate:(id)arg1 atLeastOneLocationRemoved:(BOOL )arg2 deletedCount:(NSUInteger )arg3 error:(id )arg4;
- (void)_deleteLocationsWithRowIdTableWithName:(id)arg1 txnWitness:(id)arg2 atLeastOneLocationRemoved:(BOOL )arg3 deletedCount:(NSUInteger )arg4;
