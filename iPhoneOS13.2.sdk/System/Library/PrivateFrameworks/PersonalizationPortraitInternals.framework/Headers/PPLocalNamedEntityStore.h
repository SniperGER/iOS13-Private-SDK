...
- (_Bool)_unlimitedNamedEntityRecordsWithQuery:(id)arg1 error:(id *)arg2 block:(id /* block */)arg3;
- (id)sourceStatsExcludedAlgorithms:(id)arg1;
- (_Bool)iterRankedNamedEntitiesWithQuery:(id)arg1 error:(id *)arg2 block:(id /* block */)arg3;
- (_Bool)monitorNamedEntityRecordChangesWithError:(id *)arg1 setup:(id /* block */)arg2 handler:(id /* block */)arg3 finish:(id /* block */)arg4;
