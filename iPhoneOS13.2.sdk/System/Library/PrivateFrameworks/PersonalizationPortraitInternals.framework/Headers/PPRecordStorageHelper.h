...
// - (void).cxx_destruct;
- (void)fixupDKEventsWithDatabase:(id)arg1 fixup49995922Table:(id)arg2 batchSize:(unsigned int)arg3 createRecordWithStatement:(CDUnknownBlockType)arg4 eventForRecord:(CDUnknownBlockType)arg5 isComplete:(BOOL )arg6;
...
- (void)_deleteRecordsWithRowIdsFromQuery:(id)arg1 txnWitness:(id)arg2 atLeastOneRecordClusterRemoved:(BOOL )arg3 deletedCount:(NSUInteger )arg4 bind:(CDUnknownBlockType)arg5;
...
- (void)importDuetEventsWithLimit:(unsigned int)arg1 database:(id)arg2 client:(unsigned char)arg3 remoteEventsOnly:(BOOL)arg4 isComplete:(BOOL )arg5 eventImportBlock:(CDUnknownBlockType)arg6;
...
- (BOOL)clearWithDatabase:(id)arg1 client:(unsigned char)arg2 deletedCount:(NSUInteger )arg3 error:(id )arg4 clearExternalTableReferences:(CDUnknownBlockType)arg5;
