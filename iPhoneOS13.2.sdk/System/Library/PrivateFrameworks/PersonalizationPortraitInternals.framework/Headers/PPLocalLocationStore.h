...
+ (unsigned short)namedEntityCategoryToLocationCategory:(NSUInteger)arg1;
+ (BOOL)isLocationRelevantNamedEntityCategory:(NSUInteger)arg1;
...
- (BOOL)deleteAllLocationsOlderThanDate:(id)arg1 deletedCount:(NSUInteger )arg2 error:(id )arg3;
- (BOOL)deleteAllLocationsFromSourcesWithBundleId:(id)arg1 groupId:(id)arg2 olderThan:(id)arg3 deletedCount:(NSUInteger )arg4 error:(id )arg5;
- (BOOL)deleteAllLocationsFromSourcesWithBundleId:(id)arg1 groupIds:(id)arg2 deletedCount:(NSUInteger )arg3 error:(id )arg4;
- (BOOL)deleteAllLocationsFromSourcesWithBundleId:(id)arg1 documentIds:(id)arg2 deletedCount:(NSUInteger )arg3 error:(id )arg4;
- (BOOL)deleteAllLocationsFromSourcesWithBundleId:(id)arg1 deletedCount:(NSUInteger )arg2 error:(id )arg3;
...
- (void)_petLoggingForQuery:(id)arg1 resultCount:(NSUInteger)arg2 hasError:(BOOL)arg3;
