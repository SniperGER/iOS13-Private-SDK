...
- (_Bool)iterLocationRecordsWithQuery:(id)arg1 error:(id *)arg2 block:(id /* block */)arg3;
- (id)rankedLocationsWithQuery:(id)arg1 error:(id *)arg2;
- (void)_petLoggingForQuery:(id)arg1 resultCount:(unsigned long long)arg2 hasError:(_Bool)arg3;
- (_Bool)iterRankedLocationsWithQuery:(id)arg1 error:(id *)arg2 block:(id /* block */)arg3;
