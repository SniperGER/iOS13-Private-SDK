...
- (BOOL)iterEventBatchesMatchingPredicate:(id)arg1 streams:(id)arg2 sortDescriptors:(id)arg3 batchSize:(NSUInteger)arg4 readMetaData:(BOOL)arg5 error:(id )arg6 block:(CDUnknownBlockType)arg7;
- (BOOL)iterEventBatchesMatchingPredicate:(id)arg1 streams:(id)arg2 sortDescriptors:(id)arg3 batchSize:(NSUInteger)arg4 error:(id )arg5 block:(CDUnknownBlockType)arg6;
