...
- (_Bool)iterTopicRecordsWithQuery:(id)arg1 error:(id *)arg2 block:(id /* block */)arg3;
...
- (_Bool)iterScoresForTopicMapping:(id)arg1 query:(id)arg2 error:(id *)arg3 block:(id /* block */)arg4;
...
- (_Bool)_unlimitedTopicRecordsWithQuery:(id)arg1 error:(id *)arg2 block:(id /* block */)arg3;
