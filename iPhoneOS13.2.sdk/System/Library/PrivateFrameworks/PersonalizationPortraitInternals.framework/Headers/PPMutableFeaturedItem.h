...
@interface PPMutableFeaturedItem : NSObject
{
    ...
    float _decayedSum;
    float _decayRate;
    NSUInteger _uniqueAlgorithmCount;
    NSUInteger _uniqueOsBuildCount;
    NSUInteger _uniqueAssetVersionCount;
    NSUInteger _uniqueBundleIdCount;
    NSUInteger _uniqueGroupIdCount;
    NSUInteger _uniqueSourceHourCount;
    NSMutableArray *_countInHour;
    NSUInteger _uniqueSourceDayOfWeekCount;
    NSDate *_scoringDate;
    PPSourceStats *_sourceStats;
    NSUInteger _namedEntityCharacterLength;
}

@property(readonly, nonatomic) NSUInteger namedEntityCharacterLength; // @synthesize namedEntityCharacterLength=_namedEntityCharacterLength;
...
@property(readonly, nonatomic) NSUInteger uniqueSourceDayOfWeekCount; // @synthesize uniqueSourceDayOfWeekCount=_uniqueSourceDayOfWeekCount;
@property(readonly, nonatomic) NSMutableArray *countInHour; // @synthesize countInHour=_countInHour;
@property(readonly, nonatomic) NSUInteger uniqueSourceHourCount; // @synthesize uniqueSourceHourCount=_uniqueSourceHourCount;
@property(readonly, nonatomic) NSUInteger uniqueGroupIdCount; // @synthesize uniqueGroupIdCount=_uniqueGroupIdCount;
...
@property(readonly, nonatomic) NSUInteger uniqueBundleIdCount; // @synthesize uniqueBundleIdCount=_uniqueBundleIdCount;
@property(readonly, nonatomic) NSUInteger uniqueAssetVersionCount; // @synthesize uniqueAssetVersionCount=_uniqueAssetVersionCount;
@property(readonly, nonatomic) NSUInteger uniqueOsBuildCount; // @synthesize uniqueOsBuildCount=_uniqueOsBuildCount;
...
@property(readonly, nonatomic) NSUInteger uniqueAlgorithmCount; // @synthesize uniqueAlgorithmCount=_uniqueAlgorithmCount;
// - (void).cxx_destruct;
