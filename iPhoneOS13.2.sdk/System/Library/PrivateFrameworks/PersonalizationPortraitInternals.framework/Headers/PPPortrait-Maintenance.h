...
+ (id)runPortraitMusicDataCollectionWithTopicStore:(id)arg1 namedEntityStore:(id)arg2 collectIntents:(_Bool)arg3 error:(id *)arg4 shouldContinueBlock:(id /* block */)arg5;
+ (void)_addMediaItem:(id)arg1 ofType:(int)arg2 withBundleId:(id)arg3 dateInterval:(id)arg4 to:(id)arg5;
+ (_Bool)_runPortraitMusicDataCollectionWithError:(id *)arg1 shouldContinueBlock:(id /* block */)arg2;
...
+ (_Bool)_logDailyMetricsWithError:(id *)arg1 shouldContinueBlock:(id /* block */)arg2;
