...
- (id)_predictMeCardDetailForQuery:(id)arg1 limit:(NSUInteger)arg2 fromSemanticTextField:(BOOL)arg3 explanationSet:(id)arg4;
- (id)_predictMeCardDetailForQuery:(id)arg1 limit:(NSUInteger)arg2 explanationSet:(id)arg3;
- (id)_mePredictionCacheKeyForQuery:(id)arg1;
- (BOOL)_isMeCardQuery:(id)arg1;
- (id)_predictionForPeopleQuery:(id)arg1 fromEligibleSemanticTextField:(BOOL)arg2 limit:(NSUInteger)arg3 explanationSet:(id)arg4;
- (id)_applySmartLimitingToCandidates:(id)arg1 clientLimit:(NSUInteger)arg2 explanationSet:(id)arg3;
