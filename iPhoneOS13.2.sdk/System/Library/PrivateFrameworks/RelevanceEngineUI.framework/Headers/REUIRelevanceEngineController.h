...
- (void)_enumerateEngineElementsWithOptions:(NSUInteger)arg1 usingBlock:(CDUnknownBlockType)arg2;
- (void)_enumerateEngineElementsInSection:(NSUInteger)arg1 withOptions:(NSUInteger)arg2 usingBlock:(CDUnknownBlockType)arg3;
