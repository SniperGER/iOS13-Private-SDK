...
@interface IDSServerBag : NSObject
{
    ...
    NSDate *_loadDate;
    NSNumber *_cacheTime;
    NSUInteger _hasPairedDeviceState;
    NSData *_serverSignature;
    NSArray *_serverCerts;
    NSData *_serverGivenBag;
    id /* CDUnknownBlockType */ _remoteURLCreationBlock;
    id /* CDUnknownBlockType */ _connectionMonitorCreationBlock;
...
@property(copy) id /* CDUnknownBlockType */ connectionMonitorCreationBlock; // @synthesize connectionMonitorCreationBlock=_connectionMonitorCreationBlock;
@property(copy) id /* CDUnknownBlockType */ remoteURLCreationBlock; // @synthesize remoteURLCreationBlock=_remoteURLCreationBlock;
...
@property NSUInteger hasPairedDeviceState; // @synthesize hasPairedDeviceState=_hasPairedDeviceState;
