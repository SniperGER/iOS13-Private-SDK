...
@property(copy) id /* block */ connectionMonitorCreationBlock; // @synthesize connectionMonitorCreationBlock=_connectionMonitorCreationBlock;
@property(copy) id /* block */ remoteURLCreationBlock; // @synthesize remoteURLCreationBlock=_remoteURLCreationBlock;
...
- (void)dealloc;
- (id)_initWithURL:(id)arg1 apsEnvironmentName:(id)arg2 allowSelfSignedCertificates:(_Bool)arg3 allowUnsignedBags:(_Bool)arg4 hashAlgorithm:(BOOL)arg5 remoteURLCreationBlock:(id /* block */)arg6 connectionMonitorCreationBlock:(id /* block */)arg7;
