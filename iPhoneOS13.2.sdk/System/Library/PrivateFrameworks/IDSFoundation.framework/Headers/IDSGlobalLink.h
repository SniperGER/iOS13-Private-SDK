...
- (void)_connectWithSessionInfo:(id)arg1 interfaceAddress:(id)arg2 joinSession:(_Bool)arg3 allocbindFailover:(_Bool)arg4 completionHandler:(id /* block */)arg5 withLocalInterfacePreference:(int)arg6;
- (void)connectWithSessionInfo:(id)arg1 interfaceAddress:(id)arg2 joinSession:(_Bool)arg3 completionHandler:(id /* block */)arg4 withLocalInterfacePreference:(int)arg5;
