...
@interface IDSGlobalLink : NSObject <IDSLink, IDSLinkDelegate, IDSStunCandidatePairDelegate, IDSGLSessionManagerDelegate>
{
    ...
    id /* CDUnknownBlockType */ _connectReadyHandler;
    id /* CDUnknownBlockType */ _disconnectCompletionHandler;
...
- (void)_updateSendStatsWithResult:(NSUInteger)arg1 bytesSent:(long long)arg2 packetsSent:(int)arg3 linkID:(BOOL)arg4 token:(id)arg5 useRelay:(BOOL)arg6 isClientData:(BOOL)arg7 sendTime:(double)arg8 stunTransport:(long long)arg9;
...
@property(readonly) NSUInteger headerOverhead; // @synthesize headerOverhead=_headerOverhead;
...
- (BOOL)_isReachableInterface:(id)arg1 interfaceIPVersion:(NSUInteger)arg2;
...
- (void)_recvGenericData:(char )arg1 dataLength:(NSUInteger)arg2 linkID:(BOOL)arg3;
- (long long)_sendZUDPData:(char )arg1 dataLength:(NSUInteger)arg2 linkID:(BOOL)arg3;
...
// - (BOOL)_processStunPacket:(CDStruct_12676517 )arg1 fromDeviceUniqueID:(id)arg2 cbuuid:(id)arg3 arrivalTime:(double)arg4 headerOverhead:(NSUInteger)arg5;
...
- (id)_getCandidatePairsWithSessionID:(id)arg1 inState:(NSUInteger)arg2;
...
- (BOOL)hasReachableInterface:(NSUInteger)arg1;
- (NSUInteger)defaultLinkType;
- (void)startWithOptions:(id)arg1;
- (void)_parseClientUUID:(id)arg1;
- (id)_addSocketAndInterfaceAddress:(NSUInteger)arg1 wantsWiFi:(BOOL)arg2 wantsCellular:(BOOL)arg3;
...
- (id)_createInterfaceAddressArray:(NSUInteger)arg1 wantsWiFi:(BOOL)arg2 wantsCellular:(BOOL)arg3;
