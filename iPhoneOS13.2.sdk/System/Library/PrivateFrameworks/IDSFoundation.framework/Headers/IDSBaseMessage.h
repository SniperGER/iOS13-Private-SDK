...
@interface IDSBaseMessage : NSObject <NSCopying>
{
    ...
    id /* CDUnknownBlockType */ _deliveryAcknowledgementBlock;
    double _timeout;
    double _timeSent;
    ...
    NSURL *_URLOverride;
    NSUInteger _sentByteCount;
    NSUInteger _receivedByteCount;
...
@property(nonatomic) NSUInteger receivedByteCount; // @synthesize receivedByteCount=_receivedByteCount;
@property(nonatomic) NSUInteger sentByteCount; // @synthesize sentByteCount=_sentByteCount;
...
@property(copy) id /* CDUnknownBlockType */ deliveryAcknowledgementBlock; // @synthesize deliveryAcknowledgementBlock=_deliveryAcknowledgementBlock;
...
@property NSUInteger uniqueID; // @synthesize uniqueID=_uniqueID;
