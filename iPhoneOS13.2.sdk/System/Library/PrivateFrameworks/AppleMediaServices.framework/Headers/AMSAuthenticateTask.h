...
- (id)_performAuthenticationUsingAccount:(id)arg1 credentialSource:(NSUInteger)arg2 error:(id )arg3;
- (id)_createVerifyCredentialOptionsWithCredentialSource:(NSUInteger)arg1;
