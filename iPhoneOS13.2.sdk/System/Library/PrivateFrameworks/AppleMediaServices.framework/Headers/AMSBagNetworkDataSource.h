...
{
    id /* CDUnknownBlockType */ _dataSourceChangedHandler;
    id /* CDUnknownBlockType */ _dataSourceDataInvalidatedHandler;
    NSString *_profile;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ dataSourceDataInvalidatedHandler; // @synthesize dataSourceDataInvalidatedHandler=_dataSourceDataInvalidatedHandler;
@property(copy, nonatomic) id /* CDUnknownBlockType */ dataSourceChangedHandler; // @synthesize dataSourceChangedHandler=_dataSourceChangedHandler;
// - (void).cxx_destruct;
...
- (id)_loadDataWithAttempt:(NSUInteger)arg1 error:(id )arg2;
