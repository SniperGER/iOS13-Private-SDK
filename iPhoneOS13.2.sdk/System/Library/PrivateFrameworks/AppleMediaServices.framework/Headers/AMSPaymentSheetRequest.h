...
// - (void).cxx_destruct;
- (CGImageRef)_createRGBImageRefForGreyScaleImageRef:(CGImageRef)arg1 width:(NSUInteger)arg2 height:(NSUInteger)arg3;
...
- (CGImageRef)_createImageRefForImageSource:(CGImageSource )arg1 screenScale:(float)arg2 outAssetScale:(float )arg3;
