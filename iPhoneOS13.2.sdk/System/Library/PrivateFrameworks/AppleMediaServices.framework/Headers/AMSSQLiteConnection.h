...
- (_Bool)_executeWithError:(id *)arg1 usingBlock:(id /* block */)arg2;
- (_Bool)_executeStatement:(id)arg1 error:(id *)arg2;
- (_Bool)_close;
- (_Bool)executeWithError:(id *)arg1 usingBlock:(id /* block */)arg2;
...
- (_Bool)executeStatement:(id)arg1 error:(id *)arg2 bindings:(id /* block */)arg3;
- (_Bool)executeStatement:(id)arg1 error:(id *)arg2;
- (void)executeQuery:(id)arg1 withResults:(id /* block */)arg2;
- (_Bool)executePreparedStatement:(id)arg1 error:(id *)arg2 bindings:(id /* block */)arg3;
