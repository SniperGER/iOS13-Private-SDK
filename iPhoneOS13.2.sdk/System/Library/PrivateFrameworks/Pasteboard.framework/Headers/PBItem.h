...
- (void)addRepresentationType:(id)arg1 preferredRepresentation:(NSUInteger)arg2 loader:(CDUnknownBlockType)arg3;
- (void)addRepresentationType:(id)arg1 loader:(CDUnknownBlockType)arg2;
- (void)v2_addRepresentationType:(id)arg1 preferredRepresentation:(NSUInteger)arg2 loader:(CDUnknownBlockType)arg3;
