...
- (id)showAlertViewWithButtons:(id)arg1 title:(id)arg2 message:(id)arg3 destructive:(_Bool)arg4 context:(id)arg5 completion:(id /* block */)arg6;
- (id)showAlertViewWithButtons:(id)arg1 title:(id)arg2 message:(id)arg3 destructive:(_Bool)arg4 cancelButtonIndex:(long long)arg5 context:(id)arg6 completion:(id /* block */)arg7;
- (id)showConfirmationViewWithButtons:(id)arg1 title:(id)arg2 message:(id)arg3 destructive:(_Bool)arg4 context:(id)arg5 completion:(id /* block */)arg6;
- (id)showConfirmationViewWithButtons:(id)arg1 title:(id)arg2 message:(id)arg3 destructive:(_Bool)arg4 cancelButtonIndex:(long long)arg5 context:(id)arg6 completion:(id /* block */)arg7;
- (id)showConfirmationViewWithButtons:(id)arg1 title:(id)arg2 message:(id)arg3 destructive:(_Bool)arg4 cancelButtonIndex:(long long)arg5 context:(id)arg6 forceAlert:(_Bool)arg7 completion:(id /* block */)arg8;
