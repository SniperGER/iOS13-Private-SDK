...
@class MFError, MFLocalActionReplayHandler, MFLock, MFMailMessageLibrary, MFMailboxUid, MFWeakObjectCache, NSArray, NSMutableDictionary, NSString;
...
+ (id)_loadAllAccountsWithOptions:(NSUInteger)arg1 error:(id )arg2;
+ (void)setMailAccountLoadOptions:(NSUInteger)arg1;
