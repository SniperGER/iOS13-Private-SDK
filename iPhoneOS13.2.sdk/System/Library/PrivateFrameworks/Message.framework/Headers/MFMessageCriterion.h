...
- (BOOL)includesCriterionSatisfyingPredicate:(/* void * CDUnknownFunctionPointerType */)arg1 restrictive:(BOOL)arg2;
- (id)criteriaSatisfyingPredicate:(/* void * CDUnknownFunctionPointerType */)arg1;
- (void)_addCriteriaSatisfyingPredicate:(/* void * CDUnknownFunctionPointerType */)arg1 toCollector:(id)arg2;
