...
- (_Bool)promptUserForWebLoginWithURL:(id)arg1 shouldConfirm:(_Bool)arg2 completionHandler:(id /* block */)arg3;
- (_Bool)promptUserForPasswordWithTitle:(id)arg1 message:(id)arg2 completionHandler:(id /* block */)arg3;
- (_Bool)renewCredentialsWithOptions:(id)arg1 completion:(id /* block */)arg2;
- (_Bool)_renewCredentialsWithOptions:(id)arg1 completion:(id /* block */)arg2;
