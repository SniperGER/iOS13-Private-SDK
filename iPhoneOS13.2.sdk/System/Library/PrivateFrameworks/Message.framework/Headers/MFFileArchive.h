...
+ (id)archive;
@property(copy, nonatomic) id /* block */ writerBlock; // @synthesize writerBlock=_writerBlock;
@property(copy, nonatomic) id /* block */ readerBlock; // @synthesize readerBlock=_readerBlock;
