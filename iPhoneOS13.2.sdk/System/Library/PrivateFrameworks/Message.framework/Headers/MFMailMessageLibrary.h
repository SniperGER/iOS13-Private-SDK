...
//  (void)iterateStatement:(struct sqlite3_stmt )arg1 connection:(id)arg2 withProgressMonitor:(id)arg3 andRowHandler:(/* void * CDUnknownFunctionPointerType */)arg4 context:(void )arg5;
// - (void)_iterateStatement:(id)arg1 connection:(id)arg2 withProgressMonitor:(id)arg3 andRowHandler:(/* void * CDUnknownFunctionPointerType */)arg4 context:(const CDStruct_6c71af79 )arg5;
