...
+ (_Bool)task:(id)arg1 equalsToTask:(id)arg2;
...
- (id)configuredURLRequestForTask:(id)arg1 download:(_Bool *)arg2 resumeData:(id *)arg3;
...
- (void)enqueueTask:(id)arg1 reschedule:(_Bool)arg2;
...
- (void)setupCache:(_Bool)arg1;
@property(readonly, nonatomic) NSURLCache *cache;
- (void)dispose;
- (id)init;
- (id)cookiesForURL:(id)arg1;
- (void)enumerateCookies:(id)arg1 secure:(_Bool)arg2 cookies:(id)arg3 withBlock:(id /* block */)arg4;
- (void)enumerateCookies:(id)arg1 inDomain:(id)arg2 secure:(_Bool)arg3 withBlock:(id /* block */)arg4;
- (void)deleteCookiesMatchingPredicate:(id)arg1;
- (_Bool)deleteCookie:(id)arg1 inDomain:(id)arg2 secure:(_Bool)arg3;
- (id)allCookies;
- (id)findMatchingCookies:(id)arg1 inDomain:(id)arg2 secure:(_Bool)arg3;
- (id)findCookie:(id)arg1 inDomain:(id)arg2 secure:(_Bool)arg3 cookies:(id)arg4;
- (id)findCookie:(id)arg1 inDomain:(id)arg2 secure:(_Bool)arg3;
