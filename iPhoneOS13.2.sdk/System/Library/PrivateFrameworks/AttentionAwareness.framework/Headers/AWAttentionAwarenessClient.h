...
- (_Bool)pollForAttentionWithTimeout:(double)arg1 queue:(id)arg2 block:(id /* block */)arg3 error:(id *)arg4;
...
- (_Bool)invokeRequiringClient:(_Bool)arg1 error:(id *)arg2 block:(id /* block */)arg3;
- (_Bool)_invokeRequiringClient:(_Bool)arg1 error:(id *)arg2 block:(id /* block */)arg3;
