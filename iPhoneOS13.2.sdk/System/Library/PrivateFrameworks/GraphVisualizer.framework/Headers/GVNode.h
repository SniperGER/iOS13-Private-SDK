...
- (void)traversePreorder:(int)arg1 withCallback:(id /* block */)arg2 randomize:(_Bool)arg3;
- (void)traversePostorder:(int)arg1 withCallback:(id /* block */)arg2 stopper:(id /* block */)arg3 randomize:(_Bool)arg4;
- (id)description;
