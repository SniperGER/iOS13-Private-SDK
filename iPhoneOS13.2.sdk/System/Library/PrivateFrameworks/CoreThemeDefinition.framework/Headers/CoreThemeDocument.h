...
- (void)deleteNamedAssets:(id)arg1 shouldDeleteAssetFiles:(_Bool)arg2 completionHandler:(id /* block */)arg3;
- (void)importNamedAssetsWithImportInfos:(id)arg1 referenceFiles:(_Bool)arg2 completionHandler:(id /* block */)arg3;
- (_Bool)canImportNamedAssetImportInfo:(id)arg1;
- (void)importNamedAssetsFromFileURLs:(id)arg1 referenceFiles:(_Bool)arg2 completionHandler:(id /* block */)arg3;
