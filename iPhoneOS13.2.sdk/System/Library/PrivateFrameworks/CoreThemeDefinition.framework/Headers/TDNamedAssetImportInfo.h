...
@interface TDNamedAssetImportInfo : NSObject <NSCopying>
{
    ...
    NSUInteger _memoryClass;
    NSUInteger _graphicsClass;
...
@property(nonatomic) NSUInteger arrayIndex; // @synthesize arrayIndex=_arrayIndex;
@property(nonatomic) BOOL cubeMap; // @synthesize cubeMap=_cubeMap;
@property(nonatomic) NSUInteger textureDepth; // @synthesize textureDepth=_textureDepth;
@property(nonatomic) NSUInteger textureHeight; // @synthesize textureHeight=_textureHeight;
@property(nonatomic) NSUInteger textureWidth; // @synthesize textureWidth=_textureWidth;
...
@property(nonatomic) NSUInteger graphicsClass; // @synthesize graphicsClass=_graphicsClass;
@property(nonatomic) NSUInteger memoryClass; // @synthesize memoryClass=_memoryClass;
