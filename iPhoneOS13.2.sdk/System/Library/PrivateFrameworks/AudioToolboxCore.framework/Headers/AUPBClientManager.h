...
// - (int)removePropertyListener:(/* void * CDUnknownFunctionPointerType */)arg1 onServer:(struct OpaqueAUPBServer )arg2 block:(struct OpaqueAUPB )arg3 property:(unsigned int)arg4 withUserData:(void )arg5;
// - (int)addPropertyListener:(/* void * CDUnknownFunctionPointerType */)arg1 onServer:(struct OpaqueAUPBServer )arg2 block:(struct OpaqueAUPB )arg3 property:(unsigned int)arg4 withUserData:(void )arg5;
- (int)removeServerListener:(/* void * CDUnknownFunctionPointerType */)arg1 withUserData:(void )arg2;
- (int)addNewServerListener:(/* void * CDUnknownFunctionPointerType */)arg1 withUserData:(void )arg2;
