...
+ (id)createGroupFromTemplate:(id)arg1 identifier:(id)arg2 name:(id)arg3 addressOffset:(NSUInteger)arg4;
+ (id)createGroupTemplate:(id)arg1;
+ (id)createGroupWithIdentifier:(id)arg1 name:(id)arg2 children:(id)arg3;
+ (id)createParameterWithIdentifier:(id)arg1 name:(id)arg2 address:(NSUInteger)arg3 min:(float)arg4 max:(float)arg5 unit:(unsigned int)arg6 unitName:(id)arg7 flags:(unsigned int)arg8 valueStrings:(id)arg9 dependentParameters:(id)arg10;
...
- (id).cxx_construct;
// - (void).cxx_destruct;
- (void)remoteSyncParameter:(NSUInteger)arg1 value:(float)arg2 extOriginator:(NSUInteger)arg3 hostTime:(NSUInteger)arg4 eventType:(unsigned int)arg5;
...
- (id)parameterWithAddress:(NSUInteger)arg1;
- (void)dealloc;
