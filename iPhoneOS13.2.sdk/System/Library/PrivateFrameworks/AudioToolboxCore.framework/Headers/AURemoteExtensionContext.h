...
- (void)parameterValueFromString:(id)arg1 address:(NSUInteger)arg2 reply:(CDUnknownBlockType)arg3;
- (void)parameterStringFromValue:(float)arg1 currentValue:(BOOL)arg2 address:(NSUInteger)arg3 reply:(CDUnknownBlockType)arg4;
- (void)getParameter:(NSUInteger)arg1 reply:(CDUnknownBlockType)arg2;
...
- (void)setBusCount:(NSUInteger)arg1 scope:(unsigned int)arg2 reply:(CDUnknownBlockType)arg3;
...
- (void)removePropertyObserver:(id)arg1 context:(NSUInteger)arg2 reply:(CDUnknownBlockType)arg3;
- (void)addPropertyObserver:(id)arg1 context:(NSUInteger)arg2 reply:(CDUnknownBlockType)arg3;
...
- (void)initialize2:(int)arg1 formats:(id)arg2 maxFrames:(NSUInteger)arg3 buffer:(id)arg4 bufferSize:(unsigned int)arg5 beginSem:(id)arg6 endSem:(id)arg7 reply:(CDUnknownBlockType)arg8;
- (void)setWorkIntervalPort:(id)arg1 reply:(CDUnknownBlockType)arg2;
- (void)initialize:(NSUInteger)arg1 reply:(CDUnknownBlockType)arg2;
