...
struct AUExtRenderingServer {
    ...
    id _field14;
    id /* CDUnknownBlockType */ _field15;
    BOOL _field16;
    long long _field17;
...
struct AUv3InstanceBase {
    ...
    id /* CDUnknownBlockType */ _field14;
...
struct CAMutex {
    /* void * CDUnknownFunctionPointerType _vptr$CAMutex */;
    char mName;
...
struct HostCallbackInfo {
    void hostUserData;
    /* void * CDUnknownFunctionPointerType beatAndTempoProc */;
    /* void * CDUnknownFunctionPointerType musicalTimeLocationProc */;
    /* void * CDUnknownFunctionPointerType transportStateProc */;
    /* void * CDUnknownFunctionPointerType transportStateProc2 */;
};

struct IOThread;

struct IPCAURenderingClient {
    /* void * CDUnknownFunctionPointerType _vptr$IPCAURenderingClient */;
    ...
    id /* CDUnknownBlockType */ mMusicalContextBlock;
    id /* CDUnknownBlockType */ mTransportStateBlock;
    id /* CDUnknownBlockType */ mMIDIOutputEventBlock;
    int mMIDIOutputBufferSizeHint;
    id /* CDUnknownBlockType */ mPullInputBlock;
    int mNumInputs;
    int mNumOutputs;
...
struct IPCAUSharedMemory {
    /* void * CDUnknownFunctionPointerType _vptr$SharableMemoryBase */;
    BOOL mIsOwner;
    BOOL mWasMapped;
    NSUInteger mSize;
    void mBuffer;
