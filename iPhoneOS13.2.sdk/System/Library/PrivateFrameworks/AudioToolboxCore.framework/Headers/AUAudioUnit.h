...
+ (void)instantiateWithComponentDescription:(struct AudioComponentDescription)arg1 options:(unsigned int)arg2 completionHandler:(id /* block */)arg3;
...
@property(copy, nonatomic) id /* block */ transportStateBlock; // @synthesize transportStateBlock=_transportStateBlock;
@property(copy, nonatomic) id /* block */ musicalContextBlock; // @synthesize musicalContextBlock=_musicalContextBlock;
...
@property(copy, nonatomic) id /* block */ MIDIOutputEventBlock; // @synthesize MIDIOutputEventBlock=_MIDIOutputEventBlock;
