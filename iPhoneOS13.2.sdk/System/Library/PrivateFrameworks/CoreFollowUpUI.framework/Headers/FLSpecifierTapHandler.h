...
- (void)_handleActionForItem:(id)arg1 fromSpecifier:(id)arg2 eventSource:(NSUInteger)arg3 withCompletionHandler:(CDUnknownBlockType)arg4;
- (void)actionTapped:(id)arg1 eventSource:(NSUInteger)arg2 withCompletionHandler:(CDUnknownBlockType)arg3;
