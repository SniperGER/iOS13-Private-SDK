...
@class DNDSClientDetailsProvider, NSMapTable, NSXPCListener;
...
- (void)invalidateActiveModeAssertionWithDetails:(id)arg1 reasonOverride:(NSUInteger)arg2 requestDetails:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;
