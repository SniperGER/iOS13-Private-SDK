...
// - (void)replaceRegion:(CDStruct_caaed6bc)arg1 mipmapLevel:(NSUInteger)arg2 slice:(NSUInteger)arg3 withBytes:(const void *)arg4 bytesPerRow:(NSUInteger)arg5 bytesPerImage:(NSUInteger)arg6 options:(NSUInteger)arg7;
// - (void)getBytes:(void )arg1 bytesPerRow:(NSUInteger)arg2 bytesPerImage:(NSUInteger)arg3 fromRegion:(CDStruct_caaed6bc)arg4 mipmapLevel:(NSUInteger)arg5 slice:(NSUInteger)arg6 options:(NSUInteger)arg7;
@end
