...
- (id)newTiledTextureWithBytesNoCopy:(void )arg1 length:(NSUInteger)arg2 deallocator:(CDUnknownBlockType)arg3 descriptor:(id)arg4 offset:(NSUInteger)arg5 bytesPerRow:(NSUInteger)arg6;
...
- (void)registerEventNotification:(unsigned int)arg1 listener:(id)arg2 event:(id)arg3 value:(NSUInteger)arg4 block:(CDUnknownBlockType)arg5;
...
- (id)newBufferWithLength:(NSUInteger)arg1 options:(NSUInteger)arg2 pointer:(void )arg3 copyBytes:(BOOL)arg4 deallocator:(CDUnknownBlockType)arg5;
