...
- (void)dealloc;
- (id)initWithDevice:(id)arg1 bufferRef:(unsigned int)arg2 content:(void )arg3 pointer:(void )arg4 length:(NSUInteger)arg5 options:(NSUInteger)arg6 heap:(id)arg7 deallocator:(CDUnknownBlockType)arg8;
