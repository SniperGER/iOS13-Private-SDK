...
@property(nonatomic) NSUInteger locationType; // @synthesize locationType=_locationType;
...
- (void)updateFenceLocation:(id)arg1 placemark:(id)arg2 label:(id)arg3 trigger:(id)arg4 type:(id)arg5 locationType:(NSUInteger)arg6;
...
- (id)initWithRecipient:(id)arg1 location:(id)arg2 placemark:(id)arg3 label:(id)arg4 trigger:(id)arg5 type:(id)arg6 locationType:(NSUInteger)arg7 recurring:(BOOL)arg8;
