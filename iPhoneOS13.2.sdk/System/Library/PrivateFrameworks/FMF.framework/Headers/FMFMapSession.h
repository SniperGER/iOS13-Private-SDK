...
- (void)mapImageForLocation:(id)arg1 altitude:(double)arg2 pitch:(double)arg3 width:(double)arg4 height:(double)arg5 cache:(_Bool)arg6 andCompletion:(id /* block */)arg7;
- (void)noLocationImageForWidth:(double)arg1 height:(double)arg2 cache:(_Bool)arg3 andCompletion:(id /* block */)arg4;
- (void)gridImageForWidth:(double)arg1 height:(double)arg2 cache:(_Bool)arg3 andCompletion:(id /* block */)arg4;
