...
- (void)transitionToTracking:(_Bool)arg1 mapMode:(long long)arg2 startLocation:(CDStruct_c3b9c2ee)arg3 startCourse:(double)arg4 pounceCompletionHandler:(id /* block */)arg5;
...
- (void)startFlyoverTourAnimation:(unsigned long long)arg1 animateToStart:(_Bool)arg2 completion:(id /* block */)arg3;
- (void)moveToFlyoverTourStartPosition:(id)arg1 duration:(double)arg2 completion:(id /* block */)arg3;
- (void)startFlyoverAnimation:(id)arg1 animateToStart:(_Bool)arg2 completion:(id /* block */)arg3;
...
- (void)setEdgeInsets:(struct VKEdgeInsets)arg1 duration:(double)arg2 timingFunction:(id)arg3 completionHandler:(id /* block */)arg4;
...
- (void)setCenterCoordinate:(CDStruct_c3b9c2ee)arg1 altitude:(double)arg2 yaw:(double)arg3 pitch:(double)arg4 duration:(double)arg5 timingCurve:(id /* block */)arg6 completion:(id /* block */)arg7;
...
- (_Bool)moveToMarker:(id)arg1 withHeading:(double)arg2 animated:(_Bool)arg3 completionHandler:(id /* block */)arg4;
- (_Bool)moveToStorefrontView:(id)arg1 animated:(_Bool)arg2 completionHandler:(id /* block */)arg3;
- (id)muninMarkerAtCoordinate:(CDStruct_c3b9c2ee)arg1;
- (id)muninMarkerAtCoordinate:(CDStruct_c3b9c2ee)arg1 completeMarkerHandler:(id /* block */)arg2;
