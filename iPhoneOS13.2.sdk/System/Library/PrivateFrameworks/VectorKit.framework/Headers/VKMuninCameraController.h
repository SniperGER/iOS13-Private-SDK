...
- (void)animatePath:(vector_e91c9c3b )arg1 withTarget:(const Geocentric_d8fde6f2 )arg2 lookAtTarget:(BOOL)arg3 constantLod:(BOOL)arg4 completionHandler:(CDUnknownBlockType)arg5;
