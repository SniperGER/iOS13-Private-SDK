...
{
    NSUInteger _matchingStyleAttributeLongValue;
...
@property(nonatomic) NSUInteger matchingStyleAttributeLongValue; // @synthesize matchingStyleAttributeLongValue=_matchingStyleAttributeLongValue;
