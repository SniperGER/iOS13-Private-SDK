...
//  (void)_addLabelsForJunctions:(id)arg1 withContext:(struct NavContext )arg2 maxLabelsToAdd:(NSUInteger)arg3 useAllJunctions:(BOOL)arg4 placeShieldsFrontToBack:(BOOL)arg5;
//  (void)_addLabelsAtJunctions:(id)arg1 withContext:(struct NavContext )arg2 maxLabelsToAdd:(NSUInteger)arg3;
