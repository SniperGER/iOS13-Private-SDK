...
@class CALayer, VKSharedResources;
...
- (void)dealloc;
//  (id)initWithContentScale:(double)arg1 shouldRasterize:(BOOL)arg2 taskContext:(const shared_ptr_e963992e )arg3 device:(struct Device )arg4 sharedResources:(id)arg5 signpostId:(NSUInteger)arg6;
