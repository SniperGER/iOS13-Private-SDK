...
- (void)drawToTexture:(struct Texture *)arg1 withRenderQueue:(struct RenderQueue *)arg2 completionHandler:(id /* block */)arg3;
- (void)drawToTexture:(struct Texture *)arg1 withRenderQueue:(struct RenderQueue *)arg2;
- (struct RenderQueue *)_renderQueueForTimestamp:(double)arg1 prepareHandler:(id /* block */)arg2;
