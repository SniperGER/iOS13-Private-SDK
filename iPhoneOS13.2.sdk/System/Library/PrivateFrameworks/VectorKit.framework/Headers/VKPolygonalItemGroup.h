...
- (BOOL)hasFeatureId:(NSUInteger)arg1;
...
//  (const MultiRange_4bdc93a8 )commitRangesToVerticalVenueWallStrokeRenderItemBatcher:(struct Batcher )arg1 forMeshAtIndex:(NSUInteger)arg2 cullingMask:(unsigned int)arg3;
//  (const MultiRange_4bdc93a8 )commitRangesToHorizontalVenueWallStrokeRenderItemBatcher:(struct Batcher )arg1 forMeshAtIndex:(NSUInteger)arg2 cullingMask:(unsigned int)arg3;
//  (const MultiRange_4bdc93a8 )commitRangesToVenueWallEndCapRenderItemBatcher:(struct Batcher )arg1 forMeshAtIndex:(NSUInteger)arg2 cullingMask:(unsigned int)arg3;
//  (const MultiRange_4bdc93a8 )commitRangesToVenueWallRenderItemBatcher:(struct Batcher )arg1 forMeshAtIndex:(NSUInteger)arg2 cullingMask:(unsigned int)arg3;
//  (const MultiRange_4bdc93a8 )commitRangesToStrokeRenderItemBatcher:(struct Batcher )arg1 forMeshAtIndex:(NSUInteger)arg2 cullingMask:(unsigned int)arg3 featureIdPredicate:(function_5fd0b804)arg4;
//  (const MultiRange_4bdc93a8 )commitRangesToFillRenderItemBatcher:(struct Batcher )arg1 forMeshAtIndex:(NSUInteger)arg2 cullingMask:(unsigned int)arg3 featureIdPredicate:(function_5fd0b804)arg4;
