...
// - (void)setLayers:(CDStruct_033e8ed6 )arg1 count:(NSUInteger)arg2;
// - (CDStruct_033e8ed6)layerAtIndex:(NSUInteger)arg1;
...
- (void)setCenterPoints:(float )arg1 count:(NSUInteger)arg2;
- (float)centerPointAtIndex:(NSUInteger)arg1;
- (void)addCenterPoint:(float)arg1;
- (void)clearCenterPoints;
@property(readonly, nonatomic) float centerPoints;
@property(readonly, nonatomic) NSUInteger centerPointsCount;
