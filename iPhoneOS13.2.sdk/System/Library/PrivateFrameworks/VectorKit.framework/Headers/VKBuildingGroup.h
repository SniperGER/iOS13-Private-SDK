...
// - (void)addExtrusionForBuilding:(CDStruct_985a2d1c )arg1 index:(NSUInteger)arg2 ofTotal:(NSUInteger)arg3;
// - (void)addBuilding:(CDStruct_985a2d1c )arg1 index:(NSUInteger)arg2 ofTotal:(NSUInteger)arg3 accessor:(struct ResourceAccessor )arg4 triangulator:(Triangulator_edf345a1 )arg5 prepareExtrusion:(BOOL)arg6 forRoofStyle:(unsigned char)arg7 scaleThreshold:(float)arg8;
...
//  (const MultiRange_4bdc93a8 )commitRangesToPointyRoofStrokeRenderItemBatcher:(struct Batcher )arg1 forMeshAtIndex:(NSUInteger)arg2 cullingMask:(unsigned int)arg3 featureIdPredicate:(function_5fd0b804)arg4;
//  (const MultiRange_4bdc93a8 )commitRangesToPointyRoofFillRenderItemBatcher:(struct Batcher )arg1 forMeshAtIndex:(NSUInteger)arg2 cullingMask:(unsigned int)arg3 featureIdPredicate:(function_5fd0b804)arg4;
//  (const MultiRange_4bdc93a8 )commitRangesToPointyRoofTopRenderItemBatcher:(struct Batcher )arg1 forMeshAtIndex:(NSUInteger)arg2 cullingMask:(unsigned int)arg3 featureIdPredicate:(function_5fd0b804)arg4;
//  (const MultiRange_4bdc93a8 )commitRangesToExtrusionStrokeRenderItemBatcher:(struct Batcher )arg1 forMeshAtIndex:(NSUInteger)arg2 cullingMask:(unsigned int)arg3 featureIdPredicate:(function_5fd0b804)arg4;
//  (const MultiRange_4bdc93a8 )commitRangesToExtrusionFillRenderItemBatcher:(struct Batcher )arg1 forMeshAtIndex:(NSUInteger)arg2 cullingMask:(unsigned int)arg3 featureIdPredicate:(function_5fd0b804)arg4;
