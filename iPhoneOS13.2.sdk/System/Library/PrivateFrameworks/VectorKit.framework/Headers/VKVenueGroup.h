...
//  (NSUInteger)verticalStrokeCountForSection:(const struct PolygonSection )arg1 styles:(const vector_0496561e )arg2 edges:(const vector_304c695f )arg3;
...
- (id)initWithStyleQuery:(shared_ptr_c5d816ee )arg1 tileZoom:(float)arg2 layer:(int)arg3 buildingId:(NSUInteger)arg4 contentScale:(float)arg5;
