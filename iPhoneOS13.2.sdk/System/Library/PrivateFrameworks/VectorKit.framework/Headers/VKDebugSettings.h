...
//    struct GEOTileSetRegion _selectedMapTilesToPaint;
    ...
    NSUInteger _etaLabelDebugScore;
    ...
    NSUInteger _arSwipeGesture;
    NSUInteger _arPinchGesture;
    ...
    NSUInteger _muninIntermediatePointStep;
    NSUInteger _muninAvailabilityOverride;
    BOOL _overrideLod;
...
@property(nonatomic) BOOL forceBumpAll; // @synthesize forceBumpAll=_forceBumpAll;
@property(nonatomic) BOOL forceBumpNextTap; // @synthesize forceBumpNextTap=_forceBumpNextTap;
...
@property(nonatomic) BOOL muninOverrideFov; // @synthesize muninOverrideFov=_muninOverrideFov;
// @property(nonatomic) CDStruct_5dbc7bbd muninTapState; // @synthesize muninTapState=_muninTapState;
@property(nonatomic) BOOL muninReplayLastTap; // @synthesize muninReplayLastTap=_muninReplayLastTap;
@property(nonatomic) unsigned char intermediateLodOverride; // @synthesize intermediateLodOverride=_intermediateLodOverride;
@property(nonatomic) BOOL overrideIntermediateLod; // @synthesize overrideIntermediateLod=_overrideIntermediateLod;
@property(nonatomic) unsigned char lodOverride; // @synthesize lodOverride=_lodOverride;
@property(nonatomic) BOOL overrideLod; // @synthesize overrideLod=_overrideLod;
@property(nonatomic) NSUInteger muninAvailabilityOverride; // @synthesize muninAvailabilityOverride=_muninAvailabilityOverride;
@property(nonatomic) NSUInteger muninIntermediatePointStep; // @synthesize muninIntermediatePointStep=_muninIntermediatePointStep;
...
@property(nonatomic) BOOL muninSlowMotion; // @synthesize muninSlowMotion=_muninSlowMotion;
...
@property(nonatomic) BOOL muninOverrideParallax; // @synthesize muninOverrideParallax=_muninOverrideParallax;
@property(nonatomic) BOOL muninIgnorePlacesMetadata; // @synthesize muninIgnorePlacesMetadata=_muninIgnorePlacesMetadata;
@property(nonatomic) BOOL muninShowRigTransitionInfo; // @synthesize muninShowRigTransitionInfo=_muninShowRigTransitionInfo;
@property(nonatomic) BOOL muninGraphConnections; // @synthesize muninGraphConnections=_muninGraphConnections;
@property(nonatomic) BOOL muninDebugLayer; // @synthesize muninDebugLayer=_muninDebugLayer;
...
@property(nonatomic) NSUInteger arPinchGesture; // @synthesize arPinchGesture=_arPinchGesture;
@property(nonatomic) NSUInteger arSwipeGesture; // @synthesize arSwipeGesture=_arSwipeGesture;
...
@property(nonatomic) NSUInteger etaLabelDebugScore; // @synthesize etaLabelDebugScore=_etaLabelDebugScore;
