...
@class VKAttachedNavGestureCameraBehavior, VKDetachedNavGestureCameraBehavior, VKGestureCameraBehavior, VKNavContext, VKSceneConfiguration, VKScreenCanvas, VKTimedAnimation;
...
- (Coordinate3D_bc242218)routeLocationAtDistance:(double)arg1 fromManeuver:(NSUInteger)arg2;
- (double)distanceToManeuver:(NSUInteger)arg1;
...
- (void)zoom:(double)arg1 withFocusPoint:(CGPoint)arg2 completionHandler:(CDUnknownBlockType)arg3;
