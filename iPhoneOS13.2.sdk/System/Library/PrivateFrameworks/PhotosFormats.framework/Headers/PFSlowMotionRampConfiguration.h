...
@interface PFSlowMotionRampConfiguration : NSObject
{
    ...
    NSUInteger _playbackNumIntermediateSteps;
    NSUInteger _exportNumIntermediateSteps;
}
...
@property(readonly, nonatomic) NSUInteger exportNumIntermediateSteps; // @synthesize exportNumIntermediateSteps=_exportNumIntermediateSteps;
@property(readonly, nonatomic) NSUInteger playbackNumIntermediateSteps; // @synthesize playbackNumIntermediateSteps=_playbackNumIntermediateSteps;
