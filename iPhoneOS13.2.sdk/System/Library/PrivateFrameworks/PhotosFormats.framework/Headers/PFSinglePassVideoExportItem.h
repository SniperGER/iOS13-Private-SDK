...
- (void)notifyDataAvailableToHandler:(id /* block */)arg1 ignoreMinimumChunkLength:(_Bool)arg2;
...
- (_Bool)startConversionWithError:(id *)arg1 outputAvailableHandler:(id /* block */)arg2;
- (_Bool)preflight;
- (void)dealloc;
- (id)init;
