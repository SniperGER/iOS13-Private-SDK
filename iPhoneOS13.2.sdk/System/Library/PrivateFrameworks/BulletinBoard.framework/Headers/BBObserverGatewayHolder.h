...
// - (void).cxx_destruct;
- (void)dealloc;
- (void)sendObserver:(id)arg1 addBulletin:(id)arg2 playLightsAndSirens:(BOOL)arg3 forFeeds:(NSUInteger)arg4 withHandler:(CDUnknownBlockType)arg5;
- (void)sendObserversAddBulletin:(id)arg1 playLightsAndSirens:(BOOL)arg2 forFeeds:(NSUInteger)arg3;
- (void)sendAddBulletin:(id)arg1 playLightsAndSirens:(BOOL)arg2 forFeeds:(NSUInteger)arg3 withTimeout:(double)arg4 handler:(CDUnknownBlockType)arg5;
