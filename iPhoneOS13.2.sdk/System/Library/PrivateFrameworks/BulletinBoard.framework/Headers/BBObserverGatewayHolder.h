...
- (void)dealloc;
- (void)sendObserver:(id)arg1 addBulletin:(id)arg2 playLightsAndSirens:(_Bool)arg3 forFeeds:(unsigned long long)arg4 withHandler:(id /* block */)arg5;
- (void)sendObserversAddBulletin:(id)arg1 playLightsAndSirens:(_Bool)arg2 forFeeds:(unsigned long long)arg3;
- (void)sendAddBulletin:(id)arg1 playLightsAndSirens:(_Bool)arg2 forFeeds:(unsigned long long)arg3 withTimeout:(double)arg4 handler:(id /* block */)arg5;
