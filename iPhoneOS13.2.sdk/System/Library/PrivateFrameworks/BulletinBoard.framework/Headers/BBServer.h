...
@class BBBiometricResource, BBDataProviderManager, BBDismissalSyncCache, BBMaskedSet, BBSyncService, NSDate, NSDateComponents, NSMutableArray, NSMutableDictionary, NSMutableSet, NSXPCListener;
...
+ (void)writeSectionInfo:(id)arg1 withVersionNumber:(NSUInteger)arg2;
+ (id)savedSectionInfo;
...
- (void)syncService:(id)arg1 receivedDismissalDictionaries:(id)arg2 dismissalIDs:(id)arg3 inSection:(id)arg4 forFeeds:(NSUInteger)arg5;
- (void)noteOccurrenceOfEvent:(NSUInteger)arg1;
- (void)noteChangeOfState:(NSUInteger)arg1 newValue:(BOOL)arg2;
...
- (id)_bulletinsForSectionID:(id)arg1 inFeeds:(NSUInteger)arg2;
...
- (NSUInteger)_filtersForSectionID:(id)arg1;
- (void)_publishBulletinRequest:(id)arg1 forSectionID:(id)arg2 forDestinations:(NSUInteger)arg3;
...
- (void)_updateBulletinsInFeed:(NSUInteger)arg1 forDataProvider:(id)arg2 enabledSectionIDs:(id)arg3;
- (id)_sinceDate;
- (void)_updateAllBulletinsForDataProviderIfSectionIsEnabled:(id)arg1;
- (void)_updateBulletinsInFeed:(NSUInteger)arg1 forDataProviderIfSectionIsEnabled:(id)arg2;
- (void)_updateBulletinsInFeed:(NSUInteger)arg1 ifSectionIsEnabled:(id)arg2;
...
- (NSUInteger)effectivePushSettingsForSectionInfo:(id)arg1;
...
- (void)observer:(id)arg1 removeBulletins:(id)arg2 inSection:(id)arg3 fromFeeds:(NSUInteger)arg4;
...
- (void)observer:(id)arg1 finishedWithBulletinID:(id)arg2 transactionID:(NSUInteger)arg3;
...
- (void)observer:(id)arg1 setObserverFeed:(NSUInteger)arg2 asLightsAndSirensGateway:(id)arg3 priority:(NSUInteger)arg4;
- (void)observer:(id)arg1 setObserverFeed:(NSUInteger)arg2 attachToLightsAndSirensGateway:(id)arg3;
- (void)_storeObserver:(id)arg1 forFeed:(NSUInteger)arg2;
...
- (void)_expireBulletinsDueToSystemEvent:(NSUInteger)arg1;
- (NSUInteger)_indexForNewDate:(id)arg1 inBulletinIDArray:(id)arg2 sortedAscendingByDateForKey:(id)arg3;
...
- (NSUInteger)_feedsForBulletin:(id)arg1 destinations:(NSUInteger)arg2;
...
- (void)_sendRemoveBulletin:(id)arg1 toFeeds:(NSUInteger)arg2 shouldSync:(BOOL)arg3;
- (void)_sendRemoveBulletins:(id)arg1 toFeeds:(NSUInteger)arg2 shouldSync:(BOOL)arg3;
- (void)_sendModifyBulletin:(id)arg1 toFeeds:(NSUInteger)arg2;
...
- (void)_sendAddBulletin:(id)arg1 toFeeds:(NSUInteger)arg2;
- (id)_observerGatewaysForFeeds:(NSUInteger)arg1;
...
- (void)removeBulletinID:(id)arg1 fromSection:(id)arg2 inFeed:(NSUInteger)arg3;
- (id)_mapForFeed:(NSUInteger)arg1;
- (void)withdrawBulletinID:(id)arg1;
- (void)publishBulletin:(id)arg1 destinations:(NSUInteger)arg2;
...
- (void)updateSection:(id)arg1 inFeed:(NSUInteger)arg2 withBulletinRequests:(id)arg3;
- (void)publishBulletinRequest:(id)arg1 destinations:(NSUInteger)arg2;
