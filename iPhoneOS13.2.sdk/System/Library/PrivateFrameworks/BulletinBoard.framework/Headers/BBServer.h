...
- (void)setEffectiveGlobalSpokenNotificationSetting:(long long)arg1 withHandler:(id /* block */)arg2;
- (void)getEffectiveGlobalSpokenNotificationSettingWithHandler:(id /* block */)arg1;
...
- (void)getAspectRatioForAttachmentUUID:(id)arg1 bulletinID:(id)arg2 isPrimary:(_Bool)arg3 withHandler:(id /* block */)arg4;
- (void)getPNGDataForAttachmentUUID:(id)arg1 bulletinID:(id)arg2 isPrimary:(_Bool)arg3 sizeConstraints:(id)arg4 withHandler:(id /* block */)arg5;
- (void)getDataForAttachmentUUID:(id)arg1 bulletinID:(id)arg2 isPrimary:(_Bool)arg3 withHandler:(id /* block */)arg4;
