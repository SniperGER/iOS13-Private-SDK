...
- (void)removeBulletins:(NSSet *)arg1 inSection:(NSString *)arg2 fromFeeds:(NSUInteger)arg3;
...
- (void)finishedWithBulletinID:(NSString *)arg1 transactionID:(NSUInteger)arg2;
- (void)handleResponse:(BBResponse *)arg1 withCompletion:(void (^)(BOOL))arg2;
- (void)setObserverFeed:(NSUInteger)arg1 asLightsAndSirensGateway:(NSString *)arg2 priority:(NSUInteger)arg3;
- (void)setObserverFeed:(NSUInteger)arg1 attachToLightsAndSirensGateway:(NSString *)arg2;
@end
