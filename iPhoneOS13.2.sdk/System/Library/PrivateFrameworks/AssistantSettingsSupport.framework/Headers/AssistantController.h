...
+ (void)presentAssistantEnableAlertForState:(_Bool)arg1 presentingViewController:(id)arg2 actionHandler:(id /* block */)arg3;
...
- (void)confirmDisableWithSpecifier:(id)arg1 pairedWatch:(_Bool)arg2 presentingViewController:(id)arg3 actionHandler:(id /* block */)arg4;
- (void)confirmDisableForMultiUserVoiceIdentificationWithSpecifier:(id)arg1 pairedWatch:(_Bool)arg2 presentingViewController:(id)arg3 actionHandler:(id /* block */)arg4;
