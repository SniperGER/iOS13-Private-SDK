...
@property(copy, nonatomic) id /* block */ popHandler; // @synthesize popHandler=_popHandler;
...
- (void)setEmbeddedViewController:(id)arg1 animated:(_Bool)arg2 completion:(id /* block */)arg3;
