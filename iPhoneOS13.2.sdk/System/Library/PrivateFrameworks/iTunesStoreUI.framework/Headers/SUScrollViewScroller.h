...
- (void)setContentOffset:(CGPoint)arg1 animated:(BOOL)arg2 completionBlock:(CDUnknownBlockType)arg3;
- (void)scrollFrameToVisible:(CGRect)arg1 animated:(BOOL)arg2 completionBlock:(CDUnknownBlockType)arg3;
