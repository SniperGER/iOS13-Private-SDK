...
- (void)setContentOffset:(struct CGPoint)arg1 animated:(_Bool)arg2 completionBlock:(id /* block */)arg3;
- (void)scrollFrameToVisible:(struct CGRect)arg1 animated:(_Bool)arg2 completionBlock:(id /* block */)arg3;
