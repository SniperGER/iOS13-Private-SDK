...
- (void)showInViewController:(id)arg1 animated:(_Bool)arg2 completionBlock:(id /* block */)arg3;
- (void)showInNavigationController:(id)arg1 animated:(_Bool)arg2 completionBlock:(id /* block */)arg3;
...
- (void)hideInViewController:(id)arg1 animated:(_Bool)arg2 completionBlock:(id /* block */)arg3;
- (void)hideInNavigationController:(id)arg1 animated:(_Bool)arg2 completionBlock:(id /* block */)arg3;
- (void)dealloc;
