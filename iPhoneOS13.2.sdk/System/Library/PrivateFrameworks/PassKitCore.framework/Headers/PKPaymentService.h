...
- (void)submitTransactionAnswerForTransaction:(id)arg1 questionType:(NSUInteger)arg2 answer:(id)arg3 completion:(CDUnknownBlockType)arg4;
...
- (void)disbursementVoucherWithDisbursementSource:(NSUInteger)arg1 disbursementTarget:(NSUInteger)arg2 bundleIdentifier:(id)arg3 teamIdentifier:(id)arg4 completion:(CDUnknownBlockType)arg5;
...
- (void)transactionsWithTransactionSource:(NSUInteger)arg1 withBackingData:(NSUInteger)arg2 limit:(long long)arg3 completion:(CDUnknownBlockType)arg4;
- (void)pendingTransactionsForPassWithUniqueIdentifier:(id)arg1 withTransactionSource:(NSUInteger)arg2 withBackingData:(NSUInteger)arg3 startDate:(id)arg4 endDate:(id)arg5 limit:(long long)arg6 completion:(CDUnknownBlockType)arg7;
...
- (void)approvedTransactionsForPassWithUniqueIdentifier:(id)arg1 withTransactionSource:(NSUInteger)arg2 withBackingData:(NSUInteger)arg3 startDate:(id)arg4 endDate:(id)arg5 limit:(long long)arg6 completion:(CDUnknownBlockType)arg7;
- (void)transactionsForPaymentPassWithUniqueIdentifier:(id)arg1 withTransactionType:(long long)arg2 withTransactionSource:(NSUInteger)arg3 withBackingData:(NSUInteger)arg4 startDate:(id)arg5 endDate:(id)arg6 limit:(long long)arg7 completion:(CDUnknownBlockType)arg8;
- (void)transactionsForPaymentPassWithuniqueIdentifier:(id)arg1 withMerchantCategory:(long long)arg2 withTransactionSource:(NSUInteger)arg3 withBackingData:(NSUInteger)arg4 startDate:(id)arg5 endDate:(id)arg6 limit:(long long)arg7 completion:(CDUnknownBlockType)arg8;
- (void)transactionsForPaymentPassWithUniqueIdentifier:(id)arg1 matchingMerchant:(id)arg2 withTransactionSource:(NSUInteger)arg3 withBackingData:(NSUInteger)arg4 limit:(long long)arg5 completion:(CDUnknownBlockType)arg6;
- (void)transactionsForPaymentPassWithUniqueIdentifier:(id)arg1 withMapsIdentifier:(NSUInteger)arg2 withTransactionSource:(NSUInteger)arg3 withBackingData:(NSUInteger)arg4 limit:(long long)arg5 completion:(CDUnknownBlockType)arg6;
- (void)transactionsForPaymentPassWithUniqueIdentifier:(id)arg1 withPeerPaymentCounterpartHandle:(id)arg2 withTransactionSource:(NSUInteger)arg3 withBackingData:(NSUInteger)arg4 limit:(long long)arg5 completion:(CDUnknownBlockType)arg6;
- (void)cashbackByPeriodFromPassUniqueIdentifier:(id)arg1 withStartDate:(id)arg2 endDate:(id)arg3 calendar:(id)arg4 calendarUnit:(NSUInteger)arg5 type:(long long)arg6 completion:(CDUnknownBlockType)arg7;
- (void)transactionCountByPeriodForPassWithUniqueIdentifier:(id)arg1 withTransactionSource:(NSUInteger)arg2 withBackingData:(NSUInteger)arg3 calendar:(id)arg4 unit:(NSUInteger)arg5 includePurchaseTotal:(BOOL)arg6 completion:(CDUnknownBlockType)arg7;
- (void)transactionsForPaymentPassWithUniqueIdentifier:(id)arg1 withTransactionSource:(NSUInteger)arg2 withBackingData:(NSUInteger)arg3 limit:(long long)arg4 completion:(CDUnknownBlockType)arg5;
- (void)transactionsForPaymentPassWithUniqueIdentifier:(id)arg1 withTransactionSource:(NSUInteger)arg2 withBackingData:(NSUInteger)arg3 startDate:(id)arg4 endDate:(id)arg5 orderedByDate:(long long)arg6 limit:(long long)arg7 completion:(CDUnknownBlockType)arg8;
- (void)transactionsForPaymentPassWithUniqueIdentifier:(id)arg1 withTransactionSource:(NSUInteger)arg2 withBackingData:(NSUInteger)arg3 startDate:(id)arg4 endDate:(id)arg5 limit:(long long)arg6 completion:(CDUnknownBlockType)arg7;
