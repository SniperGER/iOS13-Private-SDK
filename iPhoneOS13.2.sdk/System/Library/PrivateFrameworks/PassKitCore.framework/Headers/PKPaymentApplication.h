...
@property(nonatomic) NSUInteger paymentType; // @synthesize paymentType=_paymentType;
...
- (BOOL)acceptedForNonWebPaymentWithSupportedNetworkIdentifiers:(id)arg1 merchantCapabilities:(NSUInteger)arg2 paymentMode:(long long)arg3;
- (BOOL)acceptedForNonWebPaymentWithSupportedNetworkIdentifiers:(id)arg1 merchantCapabilities:(NSUInteger)arg2 paymentMode:(long long)arg3 paymentApplicationStates:(id)arg4;
- (BOOL)acceptedForWebPaymentWithSupportedNetworkIdentifiers:(id)arg1 merchantCapabilities:(NSUInteger)arg2 paymentMode:(long long)arg3 webService:(id)arg4;
- (BOOL)acceptedForWebPaymentWithSupportedNetworkIdentifiers:(id)arg1 merchantCapabilities:(NSUInteger)arg2 paymentMode:(long long)arg3 webService:(id)arg4 paymentApplicationStates:(id)arg5;
- (id)protobuf;
