...
- (void)_performDeviceRegistrationWithReason:(id)arg1 forceRegister:(_Bool)arg2 completion:(id /* block */)arg3;
- (void)_performDeviceRegistrationWithReason:(id)arg1 forceRegister:(_Bool)arg2;
- (void)performDeviceRegistrationForReason:(id)arg1 action:(long long)arg2 forceRegister:(_Bool)arg3 completion:(id /* block */)arg4;
