...
{
    id <NSCopying> _currentValue;
    id <NSCopying> _originalCameraCaptureValue;
    _Bool _optional;
...
@property(copy, nonatomic) id <NSCopying> originalCameraCaptureValue; // @synthesize originalCameraCaptureValue=_originalCameraCaptureValue;
...
@property(copy, nonatomic) id <NSCopying> currentValue; // @synthesize currentValue=_currentValue;
