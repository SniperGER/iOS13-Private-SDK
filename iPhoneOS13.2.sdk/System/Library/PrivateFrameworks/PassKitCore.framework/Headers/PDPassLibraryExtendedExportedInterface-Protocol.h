...
- (void)isRemovingPassesOfType:(NSUInteger)arg1 handler:(void (^)(BOOL))arg2;
...
- (void)personalizePassWithUniqueIdentifier:(NSString *)arg1 contact:(PKContact *)arg2 personalizationToken:(NSString *)arg3 requiredPersonalizationFields:(NSUInteger)arg4 personalizationSource:(NSUInteger)arg5 handler:(void (^)(BOOL))arg6;
...
- (void)updateSettings:(NSUInteger)arg1 forObjectWithUniqueID:(NSString *)arg2;
- (void)resetApplePayWithDiagnosticReason:(NSString *)arg1 handler:(void (^)(void))arg2;
- (void)removePassesOfType:(NSUInteger)arg1 withDiagnosticReason:(NSString *)arg2 handler:(void (^)(void))arg3;
