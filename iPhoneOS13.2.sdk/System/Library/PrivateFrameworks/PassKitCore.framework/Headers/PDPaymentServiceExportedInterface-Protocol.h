...
- (void)submitTransactionAnswerForTransaction:(NSString *)arg1 questionType:(NSUInteger)arg2 answer:(NSString *)arg3 completion:(void (^)(NSError *))arg4;
...
- (void)disbursementVoucherWithDisbursementSource:(NSUInteger)arg1 disbursementTarget:(NSUInteger)arg2 bundleIdentifier:(NSString *)arg3 teamIdentifier:(NSString *)arg4 completion:(void (^)(PKDisbursementVoucher *))arg5;
...
- (void)pendingTransactionsForPassWithUniqueIdentifier:(NSString *)arg1 withTransactionSource:(NSUInteger)arg2 withBackingData:(NSUInteger)arg3 startDate:(NSDate *)arg4 endDate:(NSDate *)arg5 limit:(long long)arg6 completion:(void (^)(NSSet *))arg7;
- (void)approvedTransactionsForPassWithUniqueIdentifier:(NSString *)arg1 withTransactionSource:(NSUInteger)arg2 withBackingData:(NSUInteger)arg3 startDate:(NSDate *)arg4 endDate:(NSDate *)arg5 limit:(long long)arg6 completion:(void (^)(NSSet *))arg7;
- (void)transactionsForPaymentPassWithUniqueIdentifier:(NSString *)arg1 withTransactionType:(long long)arg2 withTransactionSource:(NSUInteger)arg3 withBackingData:(NSUInteger)arg4 startDate:(NSDate *)arg5 endDate:(NSDate *)arg6 limit:(long long)arg7 completion:(void (^)(NSSet *))arg8;
- (void)transactionsForPaymentPassWithuniqueIdentifier:(NSString *)arg1 withMerchantCategory:(long long)arg2 withTransactionSource:(NSUInteger)arg3 withBackingData:(NSUInteger)arg4 startDate:(NSDate *)arg5 endDate:(NSDate *)arg6 limit:(long long)arg7 completion:(void (^)(NSSet *))arg8;
- (void)transactionsForPaymentPassWithUniqueIdentifier:(NSString *)arg1 matchingMerchant:(PKMerchant *)arg2 withTransactionSource:(NSUInteger)arg3 withBackingData:(NSUInteger)arg4 limit:(long long)arg5 completion:(void (^)(NSSet *))arg6;
- (void)transactionsForPaymentPassWithUniqueIdentifier:(NSString *)arg1 withMapsIdentifier:(NSUInteger)arg2 withTransactionSource:(NSUInteger)arg3 withBackingData:(NSUInteger)arg4 limit:(long long)arg5 completion:(void (^)(NSSet *))arg6;
- (void)transactionsForPaymentPassWithUniqueIdentifier:(NSString *)arg1 withPeerPaymentCounterpartHandle:(NSString *)arg2 withTransactionSource:(NSUInteger)arg3 withBackingData:(NSUInteger)arg4 limit:(long long)arg5 completion:(void (^)(NSSet *))arg6;
- (void)transactionsWithTransactionSource:(NSUInteger)arg1 withBackingData:(NSUInteger)arg2 limit:(long long)arg3 completion:(void (^)(NSSet *))arg4;
- (void)cashbackByPeriodFromPassUniqueIdentifier:(NSString *)arg1 withStartDate:(NSDate *)arg2 endDate:(NSDate *)arg3 calendar:(NSCalendar *)arg4 calendarUnit:(NSUInteger)arg5 type:(long long)arg6 completion:(void (^)(NSArray *))arg7;
- (void)transactionCountByPeriodForPassWithUniqueIdentifier:(NSString *)arg1 withTransactionSource:(NSUInteger)arg2 withBackingData:(NSUInteger)arg3 calendar:(NSCalendar *)arg4 unit:(NSUInteger)arg5 includePurchaseTotal:(BOOL)arg6 completion:(void (^)(NSArray *))arg7;
- (void)transactionsForPassWithUniqueIdentifier:(NSString *)arg1 withTransactionSource:(NSUInteger)arg2 withBackingData:(NSUInteger)arg3 startDate:(NSDate *)arg4 endDate:(NSDate *)arg5 orderedByDate:(long long)arg6 limit:(long long)arg7 completion:(void (^)(NSSet *))arg8;
- (void)transactionsForPassWithUniqueIdentifier:(NSString *)arg1 withTransactionSource:(NSUInteger)arg2 withBackingData:(NSUInteger)arg3 startDate:(NSDate *)arg4 endDate:(NSDate *)arg5 limit:(long long)arg6 completion:(void (^)(NSSet *))arg7;
- (void)transactionsForPaymentPassWithUniqueIdentifier:(NSString *)arg1 withTransactionSource:(NSUInteger)arg2 withBackingData:(NSUInteger)arg3 limit:(long long)arg4 completion:(void (^)(NSSet *))arg5;
