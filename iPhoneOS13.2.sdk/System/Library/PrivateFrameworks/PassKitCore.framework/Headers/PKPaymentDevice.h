...
- (void)_populateDeviceMetdata:(id)arg1 withFields:(NSUInteger)arg2 completion:(CDUnknownBlockType)arg3;
- (void)paymentDeviceMetadataFields:(NSUInteger)arg1 completion:(CDUnknownBlockType)arg2;
...
- (void)signData:(id)arg1 signatureEntanglementMode:(NSUInteger)arg2 withCompletionHandler:(CDUnknownBlockType)arg3;
