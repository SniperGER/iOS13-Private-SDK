...
- (void)_getPassesAndCatalogOfPassTypes:(unsigned long long)arg1 synchronously:(_Bool)arg2 limitResults:(_Bool)arg3 withRetries:(unsigned long long)arg4 handler:(id /* block */)arg5;
...
- (void)_fetchImageSetForUniqueID:(id)arg1 ofType:(long long)arg2 displayProfile:(id)arg3 suffix:(id)arg4 usingSynchronousProxy:(_Bool)arg5 withCompletion:(id /* block */)arg6;
- (void)_fetchImageSetContainerForUniqueID:(id)arg1 ofType:(long long)arg2 displayProfile:(id)arg3 suffix:(id)arg4 usingSynchronousProxy:(_Bool)arg5 withCompletion:(id /* block */)arg6;
...
- (void)_fetchContentForUniqueID:(id)arg1 usingSynchronousProxy:(_Bool)arg2 withCompletion:(id /* block */)arg3;
...
- (void)getPassesAndCatalogOfPassTypes:(unsigned long long)arg1 synchronously:(_Bool)arg2 withHandler:(id /* block */)arg3;
- (void)getPassesAndCatalog:(_Bool)arg1 synchronously:(_Bool)arg2 withHandler:(id /* block */)arg3;
- (void)getPassesAndCatalog:(_Bool)arg1 withHandler:(id /* block */)arg2;
