...
+ (NSUInteger)requestAutomaticPassPresentationSuppressionWithResponseHandler:(CDUnknownBlockType)arg1;
...
- (void)_getPassesAndCatalogOfPassTypes:(NSUInteger)arg1 synchronously:(BOOL)arg2 limitResults:(BOOL)arg3 withRetries:(NSUInteger)arg4 handler:(CDUnknownBlockType)arg5;
...
- (void)removePassesOfType:(NSUInteger)arg1 withDiagnosticReason:(id)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)requestPersonalizationOfPassWithUniqueIdentifier:(id)arg1 contact:(id)arg2 personalizationToken:(id)arg3 requiredPersonalizationFields:(NSUInteger)arg4 personalizationSource:(NSUInteger)arg5 handler:(CDUnknownBlockType)arg6;
...
- (void)getPassesAndCatalogOfPassTypes:(NSUInteger)arg1 synchronously:(BOOL)arg2 withHandler:(CDUnknownBlockType)arg3;
...
- (void)hasInAppPaymentPassesForNetworks:(id)arg1 capabilities:(NSUInteger)arg2 issuerCountryCodes:(id)arg3 withHandler:(CDUnknownBlockType)arg4;
