...
- (void)secureElementStatusWithCompletion:(void (^)(BOOL, NSUInteger))arg1;
- (void)paymentServicesMerchantURLForAPIType:(NSUInteger)arg1 handler:(void (^)(BOOL, NSURL *))arg2;
