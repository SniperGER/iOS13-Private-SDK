...
- (NSUInteger)pk_unsignedIntegerForKey:(id)arg1;
- (NSUInteger)pk_uint64ForKey:(id)arg1;
...
- (NSUInteger)pk_encryptedUnsignedIntegerForKey:(id)arg1;
- (NSUInteger)pk_encryptedUint64ForKey:(id)arg1;
