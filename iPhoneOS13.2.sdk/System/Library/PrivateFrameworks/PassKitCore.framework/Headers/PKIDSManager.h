...
@class IDSService, NSArray, NSHashTable, NSLock, NSMutableArray, NSMutableDictionary, PKProximityAdvertiser;
...
- (id)requestInstrumentThumbnail:(id)arg1 forRemoteDevice:(id)arg2 size:(CGSize)arg3 completion:(CDUnknownBlockType)arg4;
