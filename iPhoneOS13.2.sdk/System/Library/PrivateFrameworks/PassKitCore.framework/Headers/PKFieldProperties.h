...
@property(readonly, nonatomic) NSUInteger technology; // @synthesize technology=_technology;
// - (void).cxx_destruct;
- (void)encodeWithCoder:(id)arg1;
- (id)initWithCoder:(id)arg1;
- (id)description;
- (id)initWithTechnology:(NSUInteger)arg1 terminalType:(long long)arg2 valueAddedServiceMode:(long long)arg3;
