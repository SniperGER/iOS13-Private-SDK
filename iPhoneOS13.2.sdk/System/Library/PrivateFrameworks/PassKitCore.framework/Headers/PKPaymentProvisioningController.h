...
@interface PKPaymentProvisioningController : NSObject <CLLocationManagerDelegate, PKPaymentServiceDelegate, PKPaymentWebServiceDelegate>
{
    ...
    id /* CDUnknownBlockType */ _locationCompletion;
...
- (void)paymentWebService:(id)arg1 didCompleteTSMConnectionForTaskID:(NSUInteger)arg2;
- (void)paymentWebService:(id)arg1 didQueueTSMConnectionForTaskID:(NSUInteger)arg2;
...
- (id)_paymentPassWithPaymentMethodType:(NSUInteger)arg1;
- (id)passesWithPaymentMethodType:(NSUInteger)arg1;
...
- (void)_noteProvisioningDidEndWithTaskIdentifier:(NSUInteger)arg1;
- (NSUInteger)_noteProvisioningDidBegin;
...
- (void)_addAccountToProductMatchingFeatureIdentifier:(NSUInteger)arg1;
- (id)_fetchOrCreateProductsForIdentifier:(NSUInteger)arg1;
