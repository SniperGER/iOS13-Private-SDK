...
// - (void).cxx_destruct;
- (void)_parseAccountEventsFromRecords:(id)arg1 shouldUpdateLocalDatabase:(BOOL)arg2 updateReasons:(NSUInteger)arg3 completion:(CDUnknownBlockType)arg4;
- (id)_recordsFromAccountEvent:(id)arg1;
- (void)_fetchAndParseAccountEventRecordsForRecords:(id)arg1 request:(id)arg2 updateReasons:(NSUInteger)arg3 completion:(CDUnknownBlockType)arg4;
