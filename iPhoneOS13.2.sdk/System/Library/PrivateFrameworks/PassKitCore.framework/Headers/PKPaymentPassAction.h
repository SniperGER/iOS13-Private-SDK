...
@interface PKPaymentPassAction : NSObject <NSSecureCoding>
{
    ...
    NSUInteger _serviceProviderCapabilities;
...
@property(readonly, nonatomic) NSUInteger serviceProviderCapabilities; // @synthesize serviceProviderCapabilities=_serviceProviderCapabilities;
