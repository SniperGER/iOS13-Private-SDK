...
@property(nonatomic) NSUInteger nextExpectedState; // @synthesize nextExpectedState=_nextExpectedState;
...
- (void)_retryContainerStateWithError:(id)arg1 operationGroupNameSuffix:(id)arg2 retryCount:(NSUInteger)arg3 completion:(CDUnknownBlockType)arg4;
...
- (void)removeItemsWithRecordNames:(id)arg1 itemType:(NSUInteger)arg2 groupName:(id)arg3 groupNameSuffix:(id)arg4 qualityOfService:(long long)arg5 completion:(CDUnknownBlockType)arg6;
...
- (void)processResultWithError:(id)arg1 nextExpectedState:(NSUInteger)arg2 operationGroupNameSuffix:(id)arg3 retryCount:(NSUInteger)arg4 shouldRetry:(BOOL)arg5 completion:(CDUnknownBlockType)arg6;
...
- (void)setContainerState:(NSUInteger)arg1 operationGroupNameSuffix:(id)arg2 retryCount:(NSUInteger)arg3 completion:(CDUnknownBlockType)arg4;
- (void)setContainerState:(NSUInteger)arg1 operationGroupNameSuffix:(id)arg2 completion:(CDUnknownBlockType)arg3;
- (void)cloudStoreAccountInformationWithCompletion:(CDUnknownBlockType)arg1;
- (void)detachFromContainerWithState:(NSUInteger)arg1;
...
- (id)recordTypesForCloudStoreItemType:(NSUInteger)arg1;
- (id)zoneForCloudStoreItemType:(NSUInteger)arg1;
- (id)cloudRecordObjectFromItemType:(NSUInteger)arg1 records:(id)arg2;
...
- (BOOL)isSetup;
- (BOOL)ensureContainerState:(NSUInteger)arg1;
