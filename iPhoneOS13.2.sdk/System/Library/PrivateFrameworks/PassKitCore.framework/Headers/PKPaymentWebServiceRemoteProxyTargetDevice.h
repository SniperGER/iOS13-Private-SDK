...
- (void)deviceMetadataWithFields:(NSUInteger)arg1 completion:(CDUnknownBlockType)arg2;
...
- (void)passesOfType:(NSUInteger)arg1 completion:(CDUnknownBlockType)arg2;
- (void)hasPassesOfType:(NSUInteger)arg1 completion:(CDUnknownBlockType)arg2;
...
- (void)signData:(id)arg1 signatureEntanglementMode:(NSUInteger)arg2 withCompletion:(CDUnknownBlockType)arg3;
