...
@interface PKPaymentTransaction : NSObject <NSSecureCoding, PKCloudStoreCoding>
{
    ...
    NSUInteger _rewardsEligibilityReason;
    PKPaymentTransactionRewards *_rewards;
    NSUInteger _cardType;
...
+ (id)paymentTransactionWithSource:(NSUInteger)arg1 dictionary:(id)arg2 hasNotificationServiceData:(BOOL)arg3;
+ (id)paymentTransactionWithSource:(NSUInteger)arg1;
+ (id)paymentTransactionFromSource:(NSUInteger)arg1;
...
@property(nonatomic) NSUInteger transactionSource; // @synthesize transactionSource=_transactionSource;
...
@property(nonatomic) NSUInteger suppressBehavior; // @synthesize suppressBehavior=_suppressBehavior;
...
@property(nonatomic) NSUInteger cardType; // @synthesize cardType=_cardType;
@property(retain, nonatomic) PKPaymentTransactionRewards *rewards; // @synthesize rewards=_rewards;
@property(nonatomic) NSUInteger rewardsEligibilityReason; // @synthesize rewardsEligibilityReason=_rewardsEligibilityReason;
...
@property(nonatomic) NSUInteger transitModifiers; // @synthesize transitModifiers=_transitModifiers;
...
- (void)answeredQuestion:(NSUInteger)arg1;
