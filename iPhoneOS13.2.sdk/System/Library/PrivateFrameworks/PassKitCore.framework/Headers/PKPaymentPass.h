...
+ (id)displayableErrorForAction:(id)arg1 andReason:(NSUInteger)arg2;
+ (id)displayableErrorForTransitAction:(id)arg1 andReason:(NSUInteger)arg2;
...
@property(readonly, nonatomic) NSUInteger activationState;
- (NSUInteger)_activationStateForApplicationState:(long long)arg1;
...
- (BOOL)canPerformAction:(id)arg1 unableReason:(NSUInteger )arg2 displayableError:(id )arg3;
