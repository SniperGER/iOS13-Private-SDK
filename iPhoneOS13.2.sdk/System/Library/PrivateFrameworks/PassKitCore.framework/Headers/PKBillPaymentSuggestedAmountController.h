...
- (void)recordPaymentActionWithDifferentialPrivacy:(NSUInteger)arg1;
- (void)_setDifferentialPrivacyFeature:(NSUInteger)arg1 atIndex:(NSUInteger)arg2;
...
- (BOOL)_categoryIsCurrentBalanceType:(NSUInteger)arg1;
- (BOOL)_categoryIsPaymentPlan:(NSUInteger)arg1;
- (BOOL)_suggestedAmountListIsValidAfterPurgeIfNecessary:(id)arg1;
- (id)_calculateThresholdForLastPaymentCategory:(NSUInteger)arg1 statementBalance:(id)arg2 suggestedAmountWithSameCategory:(id)arg3;
- (id)_suggestedAmountsForPayOffDateForStatementBalance:(id)arg1 creditUtilization:(id)arg2 lastPaymentCategory:(NSUInteger)arg3;
