...
@interface PKRemotePaymentInstrument : NSObject <NSSecureCoding, NSCopying>
{
    ...
    NSUInteger _peerPaymentAccountState;
    NSArray *_associatedWebDomains;
}

+ (BOOL)supportsSecureCoding;
+ (id)sortDescriptorForDefaultPaymentInstrument:(id)arg1 supportedNetworks:(id)arg2 merchantCapabilities:(NSUInteger)arg3 webService:(id)arg4;
...
@property(nonatomic) NSUInteger peerPaymentAccountState; // @synthesize peerPaymentAccountState=_peerPaymentAccountState;
