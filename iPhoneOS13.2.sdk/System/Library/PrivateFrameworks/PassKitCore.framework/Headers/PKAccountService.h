...
- (void)activatePhysicalCard:(id)arg1 withActivationCode:(id)arg2 forFeatureIdentifier:(NSUInteger)arg3 completion:(CDUnknownBlockType)arg4;
- (void)inactivePhysicalCardForFeatureIdentifier:(NSUInteger)arg1 completion:(CDUnknownBlockType)arg2;
...
- (void)eventsForAccountIdentifier:(id)arg1 types:(id)arg2 startDate:(id)arg3 endDate:(id)arg4 orderedByDate:(long long)arg5 limit:(NSUInteger)arg6 completion:(CDUnknownBlockType)arg7;
...
- (void)defaultAccountForFeature:(NSUInteger)arg1 completion:(CDUnknownBlockType)arg2;
