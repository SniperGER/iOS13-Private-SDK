...
- (void)presentRegistrationFlowWithAccount:(id)arg1 amount:(id)arg2 state:(NSUInteger)arg3 senderAddress:(id)arg4 orientation:(id)arg5 completion:(CDUnknownBlockType)arg6;
