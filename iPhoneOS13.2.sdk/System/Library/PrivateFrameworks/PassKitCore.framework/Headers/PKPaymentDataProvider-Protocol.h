...
- (void)transactionsForPaymentPassWithUniqueIdentifier:(NSString *)arg1 withTransactionSource:(NSUInteger)arg2 withNotificationServiceData:(NSUInteger)arg3 limit:(long long)arg4 completion:(void (^)(NSSet *))arg5;
...
- (void)transactionCountByPeriodForPassWithUniqueIdentifier:(NSString *)arg1 withTransactionSource:(NSUInteger)arg2 withBackingData:(NSUInteger)arg3 calendar:(NSCalendar *)arg4 calendarUnit:(NSUInteger)arg5 includePurchaseTotal:(BOOL)arg6 completion:(void (^)(NSArray *))arg7;
- (void)pendingTransactionsForPaymentPassWithUniqueIdentifier:(NSString *)arg1 withTransactionSource:(NSUInteger)arg2 withBackingData:(NSUInteger)arg3 startDate:(NSDate *)arg4 endDate:(NSDate *)arg5 limit:(long long)arg6 completion:(void (^)(NSSet *))arg7;
- (void)approvedTransactionsForPaymentPassWithUniqueIdentifier:(NSString *)arg1 withTransactionSource:(NSUInteger)arg2 withBackingData:(NSUInteger)arg3 startDate:(NSDate *)arg4 endDate:(NSDate *)arg5 limit:(long long)arg6 completion:(void (^)(NSSet *))arg7;
...
- (void)transactionsForPaymentPassWithUniqueIdentifier:(NSString *)arg1 withTransactionSource:(NSUInteger)arg2 withBackingData:(NSUInteger)arg3 startDate:(NSDate *)arg4 endDate:(NSDate *)arg5 orderedByDate:(long long)arg6 limit:(long long)arg7 completion:(void (^)(NSSet *))arg8;
- (void)transactionsForPaymentPassWithUniqueIdentifier:(NSString *)arg1 withTransactionSource:(NSUInteger)arg2 withBackingData:(NSUInteger)arg3 startDate:(NSDate *)arg4 endDate:(NSDate *)arg5 limit:(long long)arg6 completion:(void (^)(NSSet *))arg7;
