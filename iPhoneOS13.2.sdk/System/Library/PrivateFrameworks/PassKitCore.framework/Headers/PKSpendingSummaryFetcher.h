...
- (void)_spendingSummaryStartingWithDate:(id)arg1 endDate:(id)arg2 type:(NSUInteger)arg3 withLastPeriodChange:(BOOL)arg4 completion:(CDUnknownBlockType)arg5;
- (void)_processNextRequest;
- (void)spendingSummaryStartingWithDate:(id)arg1 type:(NSUInteger)arg2 completion:(CDUnknownBlockType)arg3;
