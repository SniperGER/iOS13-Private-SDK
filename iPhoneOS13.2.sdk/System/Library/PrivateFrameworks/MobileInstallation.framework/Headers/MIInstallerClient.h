...
- (void)updatePlaceholderMetadataForApp:(id)arg1 installType:(NSUInteger)arg2 failureReason:(NSUInteger)arg3 underlyingError:(id)arg4 failureSource:(NSUInteger)arg5 completion:(CDUnknownBlockType)arg6;
