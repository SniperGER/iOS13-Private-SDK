...
@class ACAccountStore, AXDispatchTimer, CNContactStore, CTXPCServiceSubscriptionContext, CoreTelephonyClient, NSNumber, NSSet;
...
@interface RTTTelephonyUtilities : NSObject <CoreTelephonyClientCarrierBundleDelegate, TUCallCapabilitiesDelegatePrivate, TUCallCapabilitiesDelegate>
{
    ...
    NSUInteger _activeContextCount;
...
@property(nonatomic) NSUInteger activeContextCount; // @synthesize activeContextCount=_activeContextCount;
...
- (NSUInteger)currentPreferredTransportMethodForContext:(id)arg1;
