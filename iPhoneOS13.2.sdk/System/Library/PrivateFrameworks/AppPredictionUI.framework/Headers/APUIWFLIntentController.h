...
@property(copy, nonatomic) id /* block */ intentProceedHandler; // @synthesize intentProceedHandler=_intentProceedHandler;
...
- (void)handleIntentAction:(id)arg1 requiresUserConfirmation:(_Bool)arg2 requiresUserAuthentication:(_Bool)arg3 withIntentResponse:(id)arg4 proceedHandler:(id /* block */)arg5;
