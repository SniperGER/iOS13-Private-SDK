...
- (void)recursivelyExpandIncludedPeerIDs:(id)arg1 andExcludedPeerIDs:(id)arg2 dispositions:(id)arg3 withPeersTrustedBySponsorID:(id)arg4 currentMachineIDs:(id)arg5 forEpoch:(NSUInteger)arg6;
- (void)considerPreapprovalsSponsoredByPeer:(id)arg1 toRecursivelyExpandIncludedPeerIDs:(id)arg2 andExcludedPeerIDs:(id)arg3 dispositions:(id)arg4 currentMachineIDs:(id)arg5 forEpoch:(NSUInteger)arg6;
- (void)considerVouchersSponsoredByPeerID:(id)arg1 sponsorPermanentInfo:(id)arg2 toRecursivelyExpandIncludedPeerIDs:(id)arg3 andExcludedPeerIDs:(id)arg4 dispositions:(id)arg5 currentMachineIDs:(id)arg6 forEpoch:(NSUInteger)arg7;
- (id)considerCandidateID:(id)arg1 withSponsorID:(id)arg2 sponsorPermanentInfo:(id)arg3 toExpandIncludedPeerIDs:(id)arg4 andExcludedPeerIDs:(id)arg5 dispositions:(id)arg6 currentMachineIDs:(id)arg7 forEpoch:(NSUInteger)arg8;
- (void)checkVouchers;
- (void)registerVoucher:(id)arg1;
- (BOOL)validateVoucherForPeer:(id)arg1 sponsor:(id)arg2;
- (id)createVoucherForCandidate:(id)arg1 stableInfo:(id)arg2 withSponsorID:(id)arg3 reason:(NSUInteger)arg4 signingKeyPair:(id)arg5 error:(id )arg6;
- (BOOL)checkIntroductionForCandidate:(id)arg1 stableInfo:(id)arg2 withSponsorID:(id)arg3 error:(id )arg4;
- (BOOL)canIntroduceCandidate:(id)arg1 withSponsor:(id)arg2 toEpoch:(NSUInteger)arg3 underPolicy:(id)arg4 disposition:(id)arg5;
- (BOOL)canTrustCandidate:(id)arg1 inEpoch:(NSUInteger)arg2;
...
- (id)createStableInfoWithPolicyVersion:(NSUInteger)arg1 policyHash:(id)arg2 policySecrets:(id)arg3 deviceName:(id)arg4 serialNumber:(id)arg5 osVersion:(id)arg6 signingKeyPair:(id)arg7 recoverySigningPubKey:(id)arg8 recoveryEncryptionPubKey:(id)arg9 error:(id )arg10;
...
- (NSUInteger)statusOfPeerWithID:(id)arg1;
...
- (id)allPeers;
- (id)allPeerIDs;
- (id)policyWithVersion:(NSUInteger)arg1;
- (void)registerPolicyDocument:(id)arg1;
- (NSUInteger)latestEpochAmongPeerIDs:(id)arg1;
