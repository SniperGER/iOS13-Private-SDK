...
@property(readonly, nonatomic) NSUInteger maxCutLength; // @dynamic maxCutLength;
@property(readonly, nonatomic) NSUInteger minCutLength; // @dynamic minCutLength;
@property(readonly, nonatomic) NSUInteger bottomMarginInPoints; // @dynamic bottomMarginInPoints;
@property(readonly, nonatomic) NSUInteger topMarginInPoints; // @dynamic topMarginInPoints;
