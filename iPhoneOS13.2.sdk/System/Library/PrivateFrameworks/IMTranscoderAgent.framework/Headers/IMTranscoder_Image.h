...
- (id)_newGeneratedImage:(struct CGImageSource *)arg1 target:(long long)arg2 hardwareEncoder:(id)arg3 inFormat:(struct __CFString *)arg4 fromFormat:(struct __CFString *)arg5 withMaxLength:(unsigned long long)arg6 withMaxCount:(unsigned long long)arg7 withCompressionQuality:(double)arg8 enforceMaxes:(_Bool)arg9 subsampling:(int)arg10;
