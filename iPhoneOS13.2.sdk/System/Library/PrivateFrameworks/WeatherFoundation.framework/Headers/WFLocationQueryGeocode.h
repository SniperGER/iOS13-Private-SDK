...
+ (id)queryWithCoordinate:(struct CLLocationCoordinate2D)arg1 resultHandler:(id /* block */)arg2;
...
- (void)cancel;
- (void)start;
- (id)initWithCoordinate:(struct CLLocationCoordinate2D)arg1 resultHandler:(id /* block */)arg2;
