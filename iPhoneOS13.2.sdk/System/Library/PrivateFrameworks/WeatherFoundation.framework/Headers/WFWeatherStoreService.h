...
- (void)_submitRequest:(id)arg1 withIdentifier:(id)arg2 forLocation:(id)arg3 forecastTypes:(NSUInteger)arg4 configuration:(id)arg5 locale:(id)arg6 date:(id)arg7 apiVersion:(id)arg8 completionHandler:(CDUnknownBlockType)arg9;
- (void)_enumerateForecastTypesIn:(NSUInteger)arg1 usingBlock:(CDUnknownBlockType)arg2;
...
- (void)_forecastConditionsForTypes:(NSUInteger)arg1 location:(id)arg2 locale:(id)arg3 date:(id)arg4 requestIdentifier:(id)arg5 completionHandler:(CDUnknownBlockType)arg6;
...
- (void)forecast:(NSUInteger)arg1 forLocation:(id)arg2 locale:(id)arg3 requestIdentifier:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;
