...
@class NSArray, NSMapTable, NSMutableArray, WFQueryDispatcher, WFTemperatureUnitProvider, WFWeatherStoreService;
...
- (void)forecast:(NSUInteger)arg1 forLocation:(id)arg2 locale:(id)arg3 taskIdentifier:(id)arg4;
