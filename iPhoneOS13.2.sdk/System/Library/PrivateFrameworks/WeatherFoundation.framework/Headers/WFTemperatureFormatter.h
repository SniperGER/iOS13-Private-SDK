...
@property(nonatomic) NSUInteger maximumFractionDigits; // @synthesize maximumFractionDigits=_maximumFractionDigits;
@property(nonatomic) NSUInteger roundingMode; // @synthesize roundingMode=_roundingMode;
