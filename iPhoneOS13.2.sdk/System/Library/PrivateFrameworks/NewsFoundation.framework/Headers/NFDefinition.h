...
@property(copy, nonatomic) id /* block */ configurationBlock; // @synthesize configurationBlock=_configurationBlock;
...
@property(copy, nonatomic) id /* block */ factory; // @synthesize factory=_factory;
