...
- (_Bool)fromEntityWithName:(id)arg1 fetchAllObjectsMatchingPredicate:(id)arg2 handlingMOs:(id /* block */)arg3;
- (_Bool)fromEntityWithName:(id)arg1 deleteObjectsMatching:(id)arg2;
- (_Bool)withMOFromEntityWithName:(id)arg1 andUniqunessPredicate:(id)arg2 insertOrUpdate:(id /* block */)arg3;
- (id)getMOC;
