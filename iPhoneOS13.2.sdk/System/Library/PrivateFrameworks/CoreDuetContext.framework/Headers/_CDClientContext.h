...
@class NSCountedSet, NSMutableDictionary, NSXPCConnection, NSXPCListenerEndpoint;
...
- (NSDictionary )valuesForKeyPaths:(id)arg1 synchronous:(BOOL)arg2 responseQueue:(id)arg3 withCompletion:(CDUnknownBlockType)arg4;
