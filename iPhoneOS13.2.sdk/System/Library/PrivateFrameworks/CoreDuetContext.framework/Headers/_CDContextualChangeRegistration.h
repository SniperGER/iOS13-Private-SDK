...
+ (id)registrationWithIdentifier:(id)arg1 contextualPredicate:(id)arg2 deviceTypes:(unsigned long long)arg3 clientIdentifier:(id)arg4 mustWake:(_Bool)arg5 qualityOfService:(unsigned int)arg6 callback:(id /* block */)arg7;
+ (id)registrationWithIdentifier:(id)arg1 contextualPredicate:(id)arg2 deviceTypes:(unsigned long long)arg3 clientIdentifier:(id)arg4 mustWake:(_Bool)arg5 callback:(id /* block */)arg6;
+ (id)registrationWithIdentifier:(id)arg1 contextualPredicate:(id)arg2 dismissalPolicy:(id)arg3 deviceSet:(unsigned long long)arg4 clientIdentifier:(id)arg5 mustWake:(_Bool)arg6 qualityOfService:(unsigned int)arg7 callback:(id /* block */)arg8;
+ (id)registrationWithIdentifier:(id)arg1 contextualPredicate:(id)arg2 dismissalPolicy:(id)arg3 deviceSet:(unsigned long long)arg4 clientIdentifier:(id)arg5 mustWake:(_Bool)arg6 callback:(id /* block */)arg7;
+ (id)registrationWithIdentifier:(id)arg1 contextualPredicate:(id)arg2 dismissalPolicy:(id)arg3 deviceSet:(unsigned long long)arg4 mustWake:(_Bool)arg5 callback:(id /* block */)arg6;
@property(copy) id /* block */ informativeCallback; // @synthesize informativeCallback=_informativeCallback;
...
@property(readonly, copy) id /* block */ callback; // @synthesize callback=_callback;
...
- (id)initWithIdentifier:(id)arg1 contextualPredicate:(id)arg2 dismissalPolicy:(id)arg3 deviceSet:(unsigned long long)arg4 deviceTypes:(unsigned long long)arg5 clientIdentifier:(id)arg6 mustWake:(_Bool)arg7 qualityOfService:(unsigned int)arg8 informativeCallback:(id /* block */)arg9;
- (id)initWithIdentifier:(id)arg1 contextualPredicate:(id)arg2 dismissalPolicy:(id)arg3 deviceSet:(unsigned long long)arg4 deviceTypes:(unsigned long long)arg5 clientIdentifier:(id)arg6 mustWake:(_Bool)arg7 callback:(id /* block */)arg8;
- (id)init;
