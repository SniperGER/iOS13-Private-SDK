...
+ (id)registrationWithIdentifier:(id)arg1 contextualPredicate:(id)arg2 deviceTypes:(NSUInteger)arg3 clientIdentifier:(id)arg4 mustWake:(BOOL)arg5 qualityOfService:(unsigned int)arg6 callback:(CDUnknownBlockType)arg7;
+ (id)registrationWithIdentifier:(id)arg1 contextualPredicate:(id)arg2 deviceTypes:(NSUInteger)arg3 clientIdentifier:(id)arg4 mustWake:(BOOL)arg5 callback:(CDUnknownBlockType)arg6;
+ (id)registrationWithIdentifier:(id)arg1 contextualPredicate:(id)arg2 dismissalPolicy:(id)arg3 deviceSet:(NSUInteger)arg4 clientIdentifier:(id)arg5 mustWake:(BOOL)arg6 qualityOfService:(unsigned int)arg7 callback:(CDUnknownBlockType)arg8;
+ (id)registrationWithIdentifier:(id)arg1 contextualPredicate:(id)arg2 dismissalPolicy:(id)arg3 deviceSet:(NSUInteger)arg4 clientIdentifier:(id)arg5 mustWake:(BOOL)arg6 callback:(CDUnknownBlockType)arg7;
+ (id)registrationWithIdentifier:(id)arg1 contextualPredicate:(id)arg2 dismissalPolicy:(id)arg3 deviceSet:(NSUInteger)arg4 mustWake:(BOOL)arg5 callback:(CDUnknownBlockType)arg6;
...
- (id)initWithIdentifier:(id)arg1 contextualPredicate:(id)arg2 dismissalPolicy:(id)arg3 deviceSet:(NSUInteger)arg4 deviceTypes:(NSUInteger)arg5 clientIdentifier:(id)arg6 mustWake:(BOOL)arg7 qualityOfService:(unsigned int)arg8 informativeCallback:(CDUnknownBlockType)arg9;
- (id)initWithIdentifier:(id)arg1 contextualPredicate:(id)arg2 dismissalPolicy:(id)arg3 deviceSet:(NSUInteger)arg4 deviceTypes:(NSUInteger)arg5 clientIdentifier:(id)arg6 mustWake:(BOOL)arg7 callback:(CDUnknownBlockType)arg8;
- (id)init;
