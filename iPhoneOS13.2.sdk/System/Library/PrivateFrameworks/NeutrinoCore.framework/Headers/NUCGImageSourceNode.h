...
@property(retain, nonatomic) CGColorSpaceRef colorSpace; // @synthesize colorSpace=_colorSpace;
...
@property(retain, nonatomic) CGImageSource cgImageSource; // @synthesize cgImageSource=_cgImageSource;
...
- (id)initWithImageSource:(CGImageSource )arg1 identifier:(id)arg2;
- (void)_init;
