...
- (void)enumerateTilesForWritingInRect:(CDStruct_996ac03c)arg1 withBlock:(id /* block */)arg2;
- (void)enumerateTilesForReadingInRect:(CDStruct_996ac03c)arg1 withBlock:(id /* block */)arg2;
