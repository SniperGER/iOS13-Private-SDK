...
- (void)_writeDataInRange:(struct _NSRange)arg1 options:(unsigned int)arg2 context:(id)arg3 block:(id /* block */)arg4;
- (void)writeDataInRange:(struct _NSRange)arg1 context:(id)arg2 block:(id /* block */)arg3;
- (void)writeDataWithContext:(id)arg1 block:(id /* block */)arg2;
- (void)readDataInRange:(struct _NSRange)arg1 context:(id)arg2 block:(id /* block */)arg3;
