...
@interface NURenderClient : NSObject
{
    ...
    id /* CDUnknownBlockType */ _genericCompletionBlock;
}

@property(copy) id /* CDUnknownBlockType */ genericCompletionBlock; // @synthesize genericCompletionBlock=_genericCompletionBlock;
