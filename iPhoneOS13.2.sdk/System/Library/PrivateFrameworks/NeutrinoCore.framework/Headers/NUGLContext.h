...
- (void)drawVertexArray:(unsigned int)arg1 range:(NSRange *)arg2;
- (void)setVertexArrayAttribute:(id)arg1 atIndex:(NSUInteger)arg2 offset:(int)arg3 stride:(int)arg4;
- (void)disableVertexArrayAtIndex:(NSUInteger)arg1;
- (void)enableVertexArrayAtIndex:(NSUInteger)arg1;
...
- (void )mapBuffer:(id)arg1 range:(NSRange *)arg2 options:(unsigned int)arg3;
