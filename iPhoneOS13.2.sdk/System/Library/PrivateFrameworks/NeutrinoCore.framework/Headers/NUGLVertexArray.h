...
- (struct _NSRange)writeVertexData:(long long)arg1 context:(id)arg2 block:(id /* block */)arg3;
- (struct _NSRange)bufferRangeForVertexRange:(struct _NSRange)arg1;
- (void)readVertexDataInRange:(struct _NSRange)arg1 context:(id)arg2 block:(id /* block */)arg3;
