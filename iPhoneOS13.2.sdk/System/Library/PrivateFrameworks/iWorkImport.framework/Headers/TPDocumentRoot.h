...
- (id)childEnumerator;
- (id)modelEnumeratorWithFlags:(NSUInteger)arg1 forObjectsPassingTest:(CDUnknownBlockType)arg2;
...
- (id)modelEnumeratorForSearchWithFlags:(NSUInteger)arg1 forObjectsPassingTest:(CDUnknownBlockType)arg2;
