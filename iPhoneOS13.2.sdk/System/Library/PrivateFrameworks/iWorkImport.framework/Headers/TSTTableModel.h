...
- (void)setCellsConcurrently:(id)arg1 ignoreFormula:(_Bool)arg2 clearImportWarnings:(_Bool)arg3;
- (void)accumulateCurrentCellsConcurrently:(id)arg1 suppressCellBorder:(_Bool)arg2;
...
- (_Bool)hasFormulas;
- (void)prepareForPasteWithCalculationEngine:(id)arg1 sourceOffset:(struct TSUColumnRowOffset)arg2 bakeFormulas:(_Bool)arg3;
- (void)registerAllFormulasWithCalculationEngine:(id)arg1 wasCrossDocumentPaste:(_Bool)arg2 infoIsCategorized:(_Bool)arg3 wasUndo:(_Bool)arg4;
...
- (int)getValue:(out struct TSCEValue *)arg1 atBaseCellCoord:(struct TSUModelCellCoord)arg2 fetchRichTextAttributesIfPlainText:(_Bool)arg3;
...
- (struct TSCEValue)tsceValueFromCell:(id)arg1 atBaseCellCoord:(struct TSUModelCellCoord)arg2 fetchRichTextAttributesIfPlainText:(_Bool)arg3;
...
- (int)insertRowsAtIndex:(struct TSUModelRowIndex)arg1 uids:(const vector_4dc5f307 *)arg2 metadatas:(id)arg3 tableArea:(unsigned long long)arg4 unsetFilterHidingAction:(_Bool)arg5;
...
- (int)insertRowsInBaseRange:(struct _NSRange)arg1 uids:(const vector_4dc5f307 *)arg2 metadata:(id)arg3 unsetFilterHidingAction:(_Bool)arg4;
...
- (id)cellStyleAtBaseCellCoord:(struct TSUModelCellCoord)arg1 isDefault:(out _Bool *)arg2;
...
- (_Bool)textStyle:(id)arg1 isEqualToDefaultTextStyleForBaseCellCoord:(struct TSUModelCellCoord)arg2;
- (_Bool)cellStyle:(id)arg1 isEqualToDefaultCellStyleForBaseCellCoord:(struct TSUModelCellCoord)arg2;
- (id)textStyleForCellWithEmptyStyleAtBaseCellCoord:(struct TSUModelCellCoord)arg1 isDefault:(out _Bool *)arg2;
...
- (id)cellStyleForCellWithEmptyStyleAtBaseCellCoord:(struct TSUModelCellCoord)arg1 isDefault:(out _Bool *)arg2;
...
- (id)textStyleOfColumnAtIndex:(struct TSUModelColumnIndex)arg1 isDefault:(out _Bool *)arg2;
- (id)cellStyleOfColumnAtIndex:(struct TSUModelColumnIndex)arg1 isDefault:(out _Bool *)arg2;
...
- (_Bool)hasCommentStorageAtBaseCellCoord:(struct TSUModelCellCoord)arg1;
- (_Bool)hasCommentAtBaseCellCoord:(struct TSUModelCellCoord)arg1;
...
- (int)setCellsWithBaseCellMap:(id)arg1 ignoreFormulas:(_Bool)arg2 skipDirtyingNonFormulaCells:(_Bool)arg3;
- (int)p_shouldAllowApplyBaseCellMap:(id)arg1;
- (struct TSCEFormula *)formulaAtBaseCellCoord:(struct TSUModelCellCoord)arg1;
- (int)setCell:(id)arg1 atBaseCellCoord:(struct TSUModelCellCoord)arg2 ignoreFormula:(_Bool)arg3 clearImportWarnings:(_Bool)arg4;
- (int)p_shouldAllowSetCell:(id)arg1 atBaseCellCoord:(struct TSUModelCellCoord)arg2;
- (_Bool)hasFormulaAtBaseCellCoord:(struct TSUModelCellCoord)arg1;
...
- (int)getCell:(id)arg1 atBaseCellCoord:(struct TSUModelCellCoord)arg2 suppressCellBorder:(_Bool)arg3;
- (_Bool)cellExistsAtBaseCellCoord:(struct TSUModelCellCoord)arg1;
...
- (void)dealloc;
- (id)initWithContext:(id)arg1 fromSourceModel:(id)arg2 region:(id)arg3 tableInfo:(id)arg4 waitForCalcEngine:(_Bool)arg5 formulaCoordSpace:(long long)arg6;
...
- (id)mutableIndexesForUIDs:(const vector_4dc5f307 *)arg1 isRows:(_Bool)arg2;
