...
- (void)p_iterateDataStoreCellsInRegion:(id)arg1 searchFlags:(NSUInteger)arg2 usingBlock:(CDUnknownBlockType)arg3;
...
- (int)insertRowsInBaseRange:(NSRange *)arg1 uids:(const vector_4dc5f307 )arg2 metadata:(id)arg3 unsetFilterHidingAction:(BOOL)arg4;
