...
// - (void)drawText:(id)arg1 paragraphStyle:(id)arg2 intoContext:(CGContextRef )arg3 wrapWidth:(double)arg4 atPosition:(CGPoint)arg5 viewScale:(double)arg6 layoutProperties:(id)arg7 outTextLayoutResults:(struct TSCHTextLayoutResults )arg8;
...
// - (void)drawText:(id)arg1 paragraphStyle:(id)arg2 intoContext:(CGContextRef )arg3 wrapWidth:(double)arg4 atPosition:(CGPoint)arg5 range:(NSRange *)arg6 viewScale:(double)arg7 layoutProperties:(id)arg8 outTextLayoutResults:(struct TSCHTextLayoutResults )arg9;
...
// - (void)drawAttributedString:(const struct __CFAttributedString )arg1 paragraphStyle:(id)arg2 intoContext:(CGContextRef )arg3 atPosition:(CGPoint)arg4 range:(NSRange *)arg5 viewScale:(double)arg6;
