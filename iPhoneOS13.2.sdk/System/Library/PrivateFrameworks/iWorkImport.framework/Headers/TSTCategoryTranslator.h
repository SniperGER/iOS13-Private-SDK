...
- (void)p_applyViewColumnIndex:(struct TSUViewColumnIndex)arg1 toCategoryColumnUsingBlock:(id /* block */)arg2 toBaseUsingBlock:(id /* block */)arg3 toBeyondBoundsUsingBlock:(id /* block */)arg4;
- (void)p_applyViewRowIndex:(struct TSUViewRowIndex)arg1 toSummaryUsingBlock:(id /* block */)arg2 toLabelUsingBlock:(id /* block */)arg3 toBaseUsingBlock:(id /* block */)arg4 toBeyondBoundsUsingBlock:(id /* block */)arg5;
- (int)p_applyViewCellCoord:(struct TSUViewCellCoord)arg1 toSummaryUsingBlock:(id /* block */)arg2 toLabelUsingBlock:(id /* block */)arg3 toCategoryColumnUsingBlock:(id /* block */)arg4 toBaseUsingBlock:(id /* block */)arg5;
