...
- (BOOL)p_getBoundsRect:(CGRect )arg1 contentRect:(CGRect )arg2 transform:(CGAffineTransform )arg3 applyRef lection:(BOOL )arg4 applyShadow:(BOOL )arg5 forRange:(NSRange *)arg6 includeListLabel:(BOOL)arg7 isMagicMove:(BOOL)arg8;
