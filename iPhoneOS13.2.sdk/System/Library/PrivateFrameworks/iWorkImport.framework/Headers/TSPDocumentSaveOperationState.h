...
{
    _Bool _didResetDocumentRevision;
    _Bool _shouldResumeAsynchronousModifications;
...
@property(nonatomic) _Bool didResetDocumentRevision; // @synthesize didResetDocumentRevision=_didResetDocumentRevision;
