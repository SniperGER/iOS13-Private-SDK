...
- (BOOL)shouldAttemptToMaterializeData:(id)arg1 expectedLength:(NSUInteger)arg2;
...
- (id)dataForDigestImpl:(id)arg1 documentResourceInfo:(id)arg2 skipDocumentResourcesLookup:(BOOL)arg3 expectedLength:(NSUInteger)arg4 accessorBlock:(CDUnknownBlockType)arg5;
