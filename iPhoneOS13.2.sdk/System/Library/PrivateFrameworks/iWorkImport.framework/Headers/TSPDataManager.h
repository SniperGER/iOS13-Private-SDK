...
- (id)dataWithStorage:(id)arg1 digest:(id)arg2 filename:(id)arg3 skipDocumentResourcesLookup:(_Bool)arg4 accessorBlock:(id /* block */)arg5;
...
- (id)dataForDigestImpl:(id)arg1 documentResourceInfo:(id)arg2 skipDocumentResourcesLookup:(_Bool)arg3 expectedLength:(unsigned long long)arg4 accessorBlock:(id /* block */)arg5;
...
- (void)findExistingDataForReadChannel:(id)arg1 dataURL:(id)arg2 dataURLType:(long long)arg3 temporaryDataStorageURL:(id)arg4 keepTemporaryFileOnSuccess:(_Bool)arg5 completion:(id /* block */)arg6;
- (id)dataForExistingData:(id)arg1 digest:(id)arg2 filename:(id)arg3 temporaryDataStorageURL:(id)arg4;
- (void)dataFromReadChannel:(id)arg1 filename:(id)arg2 dataURLOrNil:(id)arg3 canLink:(_Bool)arg4 completion:(id /* block */)arg5;
