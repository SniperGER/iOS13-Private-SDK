...
- (id)newSlideTextureForEvent:(NSUInteger)arg1;
...
- (id)p_initializeTextureSetForRep:(id)arg1 info:(id)arg2 eventIndex:(NSUInteger)arg3 ignoreBuildVisibility:(BOOL)arg4 isRenderingToContext:(BOOL)arg5;
...
- (void)renderIntoContext:(CGContextRef )arg1 eventIndex:(NSUInteger)arg2 ignoreBuildVisibility:(BOOL)arg3;
...
- (id)infosVisibleAtEvent:(NSUInteger)arg1 ignoreBuildVisibility:(BOOL)arg2;
...
@property(readonly) NSUInteger slideNumber;
