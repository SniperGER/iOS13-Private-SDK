...
+ (void)initialize;
+ (struct TSWPAttributeArray *)createEmptyAttributeArrayForKind:(unsigned long long)arg1;
+ (struct TSWPAttributeArray *)createAttributeArrayForKind:(unsigned long long)arg1 actionState:(struct TSWPStorageActionState *)arg2;
...
- (struct TSWPAttributeArray *)attributeArrayForKind:(unsigned long long)arg1 withCreate:(_Bool)arg2;
- (int)compareBreakingTablesWithStorage:(id)arg1;
- (int)compareRange:(struct _NSRange)arg1 otherStorage:(id)arg2 otherRange:(struct _NSRange)arg3 options:(unsigned long long)arg4 styleComparisonBlock:(id /* block */)arg5;
...
- (void)p_mutateByWordWithUndoTransaction:(struct TSWPStorageTransaction *)arg1 locale:(id)arg2 transformer:(id /* block */)arg3;
...
- (struct _NSRange)charRangeForAttributeRange:(struct _NSRange)arg1 attributeKind:(unsigned long long)arg2;
- (struct _NSRange)attributeRangeForOverlappingField:(id)arg1 atAttributeIndex:(unsigned long long)arg2 attributeKind:(unsigned long long)arg3;
- (struct _NSRange)attributeRangeForOverlappingField:(id)arg1 attributeKind:(unsigned long long)arg2;
...
- (void)removeOverlappingField:(id)arg1 fromRange:(struct _NSRange)arg2 attributeKind:(unsigned long long)arg3 undoTransaction:(struct TSWPStorageTransaction *)arg4;
- (void)addOverlappingField:(id)arg1 toRange:(struct _NSRange)arg2 attributeKind:(unsigned long long)arg3 dolcContext:(id)arg4 undoTransaction:(struct TSWPStorageTransaction *)arg5;
- (void)enumerateTateChuYokoInRange:(struct _NSRange)arg1 usingBlock:(id /* block */)arg2;
- (void)enumerateBookmarksInRange:(struct _NSRange)arg1 usingBlock:(id /* block */)arg2;
...
- (void)enumerateAllHyperlinksUsingBlock:(id /* block */)arg1;
...
- (id)smartFieldsWithAttributeKind:(unsigned long long)arg1 intersectingRange:(struct _NSRange)arg2 passingTest:(id /* block */)arg3;
- (void)resetAllTextAttributeUUIDStrings;
- (void)enumerateSmartFieldsWithAttributeKind:(unsigned long long)arg1 inRange:(struct _NSRange)arg2 usingBlock:(id /* block */)arg3;
- (void)enumerateWithAttributeKind:(unsigned long long)arg1 inRange:(struct _NSRange)arg2 withOptions:(unsigned long long)arg3 usingBlock:(id /* block */)arg4;
- (void)enumerateWithAttributeKind:(unsigned long long)arg1 inRange:(struct _NSRange)arg2 usingBlock:(id /* block */)arg3;
...
- (struct _NSRange)attachmentRangeForCharIndex:(unsigned long long)arg1 forwards:(_Bool)arg2 attributeKind:(unsigned long long)arg3;
...
- (void)enumerateFootnoteAttachmentsInTextRange:(struct _NSRange)arg1 usingBlock:(id /* block */)arg2;
- (void)enumerateAttachmentsInTextRange:(struct _NSRange)arg1 usingBlock:(id /* block */)arg2;
- (void)enumerateAttachmentsOfClass:(Class)arg1 inTextRange:(struct _NSRange)arg2 usingBlock:(id /* block */)arg3;
...
- (void)applyChangeSet:(id)arg1 tableKind:(unsigned long long)arg2 range:(struct _NSRange)arg3 undoTransaction:(struct TSWPStorageTransaction *)arg4;
...
- (void)enumerateParagraphsIntersectingTextRange:(struct _NSRange)arg1 usingBlock:(id /* block */)arg2;
...
- (_Bool)hasData:(struct TSWPParagraphData)arg1 attribueArrayKind:(unsigned long long)arg2 range:(struct _NSRange)arg3;
- (_Bool)hasObject:(id)arg1 attribueArrayKind:(unsigned long long)arg2 range:(struct _NSRange)arg3;
...
- (struct _NSRange)rangeByTrimmingRange:(struct _NSRange)arg1 withBlock:(id /* block */)arg2;
...
- (void)splitSmartFieldAtCharIndex:(unsigned long long)arg1 lengthToInsert:(unsigned long long)arg2 attributeKind:(unsigned long long)arg3 dolcContext:(id)arg4 undoTransaction:(struct TSWPStorageTransaction *)arg5;
...
- (int)compareAttributeArray1:(struct TSWPAttributeArray *)arg1 array2:(struct TSWPAttributeArray *)arg2 range1:(struct _NSRange)arg3 range2:(struct _NSRange)arg4 attributeIndex1:(unsigned long long)arg5 attributeIndex2:(unsigned long long)arg6 styleComparisonBlock:(id /* block */)arg7;
- (int)compareAttributeArray:(struct TSWPAttributeArray *)arg1 range:(struct _NSRange)arg2 otherStorage:(id)arg3 otherRange:(struct _NSRange)arg4 styleComparisonBlock:(id /* block */)arg5;
...
- (void *)cfRetainedNonUndoableFastCopyAttributeRecord:(struct TSWPAttributeRecord *)arg1 shouldAddRecord:(_Bool *)arg2 attributeArrayKind:(unsigned long long)arg3 atIndex:(unsigned long long)arg4 sourceStorage:(id)arg5 objectContext:(id)arg6 flags:(unsigned int)arg7 actionState:(struct TSWPStorageActionState *)arg8;
- (_Bool)canTransferAttributesForInitialization:(unsigned long long)arg1 withFlags:(unsigned int)arg2;
- (struct _NSRange)replaceAllOccurrencesOfObject:(id)arg1 withObject:(id)arg2 forKind:(unsigned long long)arg3 undoTransaction:(struct TSWPStorageTransaction *)arg4;
- (void)applyWritingDirection:(int)arg1 toParagraphIndexRange:(struct _NSRange)arg2 forKind:(unsigned long long)arg3 undoTransaction:(struct TSWPStorageTransaction *)arg4;
- (void)applyDataValue:(unsigned int)arg1 toParagraphIndexRange:(struct _NSRange)arg2 forKind:(unsigned long long)arg3 undoTransaction:(struct TSWPStorageTransaction *)arg4;
...
- (void)applyFlags:(unsigned short)arg1 level:(unsigned long long)arg2 toParagraphIndexRange:(struct _NSRange)arg3 forKind:(unsigned long long)arg4 undoTransaction:(struct TSWPStorageTransaction *)arg5;
- (void)applyParagraphData:(struct TSWPParagraphData)arg1 toParagraphIndexRange:(struct _NSRange)arg2 forKind:(unsigned long long)arg3 undoTransaction:(struct TSWPStorageTransaction *)arg4;
- (void)applyObject:(id)arg1 toParagraphsInCharRange:(struct _NSRange)arg2 forKind:(unsigned long long)arg3 undoTransaction:(struct TSWPStorageTransaction *)arg4;
- (void)applyObject:(id)arg1 toParagraphIndexRange:(struct _NSRange)arg2 forKind:(unsigned long long)arg3 undoTransaction:(struct TSWPStorageTransaction *)arg4;
...
- (struct _NSRange)insertSpecialCharacter:(unsigned short)arg1 object:(id)arg2 kind:(unsigned long long)arg3 range:(struct _NSRange)arg4 placementIndex:(int)arg5 dolcContext:(id)arg6 undoTransaction:(struct TSWPStorageTransaction *)arg7 changeSession:(id)arg8;
- (struct _NSRange)insertSpecialCharacter:(unsigned short)arg1 object:(id)arg2 kind:(unsigned long long)arg3 range:(struct _NSRange)arg4 dolcContext:(id)arg5 undoTransaction:(struct TSWPStorageTransaction *)arg6 changeSession:(id)arg7;
- (void)p_attributesAtCharIndex:(unsigned long long)arg1 attributesOfInterest:(_Bool [22])arg2 attributesTable:(id [22])arg3 effectiveRange:(struct _NSRange *)arg4;
- (struct TSWPAttributeArray *)attributeArrayForKind:(unsigned long long)arg1;
- (struct TSWPParagraphAttributeArray *)paragraphAttributeArrayForKind:(unsigned long long)arg1 withCreate:(_Bool)arg2;
...
- (long long)pFlipSpecialCharacterForObject:(id)arg1 range:(struct _NSRange)arg2 insertLength:(unsigned long long)arg3 outChangeRange:(struct _NSRange *)arg4 attributeArrayKind:(unsigned long long)arg5 actionState:(struct TSWPStorageActionState *)arg6;
...
- (struct _NSRange)p_rangeForOverlappingField:(id)arg1 attributeKind:(unsigned long long)arg2;
- (void)p_removeOverlappingFieldsInRange:(struct _NSRange)arg1 attributeKind:(unsigned long long)arg2 undoTransaction:(struct TSWPStorageTransaction *)arg3;
- (void)removePencilAnnotationsInRange:(struct _NSRange)arg1 undoTransaction:(struct TSWPStorageTransaction *)arg2;
- (void)enumeratePencilAnnotationsInRange:(struct _NSRange)arg1 usingBlock:(id /* block */)arg2;
...
- (void)enumerateHighlightsInRange:(struct _NSRange)arg1 usingBlock:(id /* block */)arg2;
- (void)enumerateHighlightsInExpandedRange:(struct _NSRange)arg1 usingBlock:(id /* block */)arg2;
...
- (id)p_trackedChangesIntersectingRange:(struct _NSRange)arg1;
- (id)trackedChangesIntersectingSelection:(id)arg1;
- (struct _NSRange)annotationRangeForSelection:(id)arg1;
...
- (id)changeAtCharIndex:(unsigned long long)arg1 attributeKind:(unsigned long long)arg2 effectiveRange:(struct _NSRange *)arg3;
...
- (void)compressAttributeArrayKind:(unsigned long long)arg1 actionState:(struct TSWPStorageActionState *)arg2;
- (struct TSWPAttributeArray *)attributeArrayForKind:(unsigned long long)arg1 withCreate:(_Bool)arg2 fromUndo:(_Bool)arg3 actionState:(struct TSWPStorageActionState *)arg4;
- (struct TSWPAttributeArray *)attributeArrayForKind:(unsigned long long)arg1 withCreate:(_Bool)arg2 actionState:(struct TSWPStorageActionState *)arg3;
