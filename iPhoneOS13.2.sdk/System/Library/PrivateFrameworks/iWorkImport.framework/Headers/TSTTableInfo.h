...
// - (void)iterateCellsInRegion:(id)arg1 flags:(NSUInteger)arg2 searchFlags:(NSUInteger)arg3 clampingRange:(struct TSUCellRect)arg4 usingBlock:(CDUnknownBlockType)arg5;
- (void)iterateCellsInRegion:(id)arg1 flags:(NSUInteger)arg2 searchFlags:(NSUInteger)arg3 usingBlock:(CDUnknownBlockType)arg4;
...
- (void)iterateCellsWithFlags:(NSUInteger)arg1 searchFlags:(NSUInteger)arg2 usingBlock:(CDUnknownBlockType)arg3;
