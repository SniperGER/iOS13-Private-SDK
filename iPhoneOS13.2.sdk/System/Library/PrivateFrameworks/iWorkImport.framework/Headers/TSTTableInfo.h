...
-     // Error parsing type: v32@0:8^{TableInfoArchive=^^?{InternalMetadataWithArena=^v}{HasBits<1>=[1I]}{CachedSize={atomic<int>=Ai}}^{DrawableArchive}^{Reference}^{Reference}^{Reference}^{Reference}^{Reference}^{UUID}^{UUID}^{CoordMapperArchive}II}16@24, name: saveToArchive:archiver:
- (void)loadFromUnarchiver:(id)arg1;
-     // Error parsing type: v32@0:8r^{TableInfoArchive=^^?{InternalMetadataWithArena=^v}{HasBits<1>=[1I]}{CachedSize={atomic<int>=Ai}}^{DrawableArchive}^{Reference}^{Reference}^{Reference}^{Reference}^{Reference}^{UUID}^{UUID}^{CoordMapperArchive}II}16@24, name: loadFromArchive:unarchiver:
- (Class)iteratorClass;
- (Class)editorClass;
- (Class)layoutClass;
- (Class)repClass;
...
- (_Bool)isEquivalentForCrossDocumentPasteMasterComparison:(id)arg1 styleComparisonBlock:(id /* block */)arg2;
...
- (id)applyConcurrentCellMapToBaseTable:(id)arg1 options:(unsigned long long)arg2 requestPruneMap:(_Bool)arg3 stylesContainer:(id)arg4;
...
- (void)enumerateCellStringsForRows:(unsigned int)arg1 rowCount:(unsigned int)arg2 usingBlock:(id /* block */)arg3;
- (void)enumerateCellStringsUsingBlock:(id /* block */)arg1;
- (void)iterateCellsInRegion:(id)arg1 flags:(unsigned long long)arg2 searchFlags:(unsigned long long)arg3 clampingRange:(struct TSUCellRect)arg4 usingBlock:(id /* block */)arg5;
...
- (void)iterateCellsInRange:(struct TSUCellRect)arg1 flags:(unsigned long long)arg2 searchFlags:(unsigned long long)arg3 usingBlock:(id /* block */)arg4;
