...
- (void)enumerateStoragesInColumnRange:(struct _NSRange)arg1 getPreBNC:(_Bool)arg2 withBlock:(id /* block */)arg3;
- (void)enumerateStoragesInColumnRange:(struct _NSRange)arg1 withBlock:(id /* block */)arg2;
...
- (vector_73284f0b)accumulateCurrentCellsConcurrentlyAtColumns:(vector_5e7df3d8 *)arg1 usingCellCreationBlock:(id /* block */)arg2;
