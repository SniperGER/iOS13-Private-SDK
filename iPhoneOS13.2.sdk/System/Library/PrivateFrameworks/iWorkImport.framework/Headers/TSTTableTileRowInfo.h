...
- (void)enumerateStoragesInColumnRange:(NSRange *)arg1 getPreBNC:(BOOL)arg2 withBlock:(CDUnknownBlockType)arg3;
- (void)enumerateStoragesInColumnRange:(NSRange *)arg1 withBlock:(CDUnknownBlockType)arg2;
