...
- (void)p_drawInContext:(CGContextRef )arg1 withContent:(BOOL)arg2 strokeDrawOptions:(NSUInteger)arg3 withOpacity:(double)arg4 withMask:(BOOL)arg5 forLayer:(BOOL)arg6 forShadow:(BOOL)arg7 forHitTest:(BOOL)arg8;
- (BOOL)p_shouldFlipShadowsInContext:(CGContextRef )arg1 forLayer:(BOOL)arg2;
