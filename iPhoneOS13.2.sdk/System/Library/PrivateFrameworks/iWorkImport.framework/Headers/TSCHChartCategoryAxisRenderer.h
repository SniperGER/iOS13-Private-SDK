...
- (void)p_drawIntoLayer:(int)arg1 inContext:(CGContextRef )arg2 visible:(CGRect)arg3 limitRenderLabels:(int)arg4 limitLabelIndex:(NSUInteger)arg5 rangePtr:(NSRange * )arg6;
