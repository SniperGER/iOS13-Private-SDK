...
- (id).cxx_construct;
- (void)analyzeCommandToModelReference:(id)arg1 isAnalyzingExternalComponent:(_Bool)arg2 archiver:(id)arg3 completion:(id /* block */)arg4;
...
- (void)writeWithArchiverAccessLockForObjects:(id)arg1 parentObject:(id)arg2 isCommandToModelReference:(_Bool)arg3 isAnalyzingExternalComponent:(_Bool)arg4 completion:(id /* block */)arg5;
- (void)acquireArchiverAccessLockAndWriteObjects:(id)arg1 parentObject:(id)arg2 isCommandToModelReference:(_Bool)arg3 isAnalyzingExternalComponent:(_Bool)arg4 completion:(id /* block */)arg5;
