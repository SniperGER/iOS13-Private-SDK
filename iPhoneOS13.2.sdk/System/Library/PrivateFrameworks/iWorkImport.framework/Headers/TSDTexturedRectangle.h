...
@property CGImageRef sourceImage; // @synthesize sourceImage=_sourceImage;
...
@property(nonatomic) CGColorSpaceRef colorSpace; // @synthesize colorSpace=_colorSpace;
...
@property CGImageRef bakedImage; // @synthesize bakedImage=_bakedImage;
...
- (void)p_renderIntoContext:(CGContextRef )arg1 viewLayer:(id)arg2 shouldApplyAlpha:(BOOL)arg3 shouldIgnoreLayerVisibility:(BOOL)arg4 shouldClipToBounds:(BOOL)arg5;
- (void)renderIntoContext:(CGContextRef )arg1 eventIndex:(NSUInteger)arg2 shouldApplyAlpha:(BOOL)arg3 shouldClipToBounds:(BOOL)arg4;
...
- (id)initWithSize:(CGSize)arg1 offset:(CGPoint)arg2 renderBlock:(CDUnknownBlockType)arg3;
