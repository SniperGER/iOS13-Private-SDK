...
- (_Bool)applyEffectsForProperties:(id)arg1 series:(id)arg2 index:(const tvec2_3b141483 *)arg3 pipeline:(id)arg4 injectEffectsUsingBlock:(id /* block */)arg5;
...
- (void)renderTwoPassGeometry:(_Bool)arg1 processor:(id)arg2 renderBlock:(id /* block */)arg3;
