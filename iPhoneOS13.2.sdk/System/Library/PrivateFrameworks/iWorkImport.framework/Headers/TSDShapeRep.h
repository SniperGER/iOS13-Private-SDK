...
- (void)p_drawInContext:(CGContextRef )arg1 withContent:(BOOL)arg2 strokeDrawOptions:(NSUInteger)arg3 withOpacity:(BOOL)arg4 usingPathOverride:(id)arg5 patternOffsetsBySubpathOverride:(id)arg6 transparencyLayersBySubpath:(id)arg7;
- (void)p_drawInContext:(CGContextRef )arg1 withContent:(BOOL)arg2 strokeDrawOptions:(NSUInteger)arg3 withOpacity:(BOOL)arg4;
...
- (void)p_drawChildrenWithoutOpacityInContext:(CGContextRef )arg1 keepingChildrenPassingTest:(CDUnknownBlockType)arg2;
