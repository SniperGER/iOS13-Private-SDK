...
- (CGPathRef)pathOfElementForSeries:(NSUInteger)arg1 outWedgeCenterPoint:(CGPoint )arg2 withInnerRadius:(id)arg3;
- (id)labelStringForType:(long long)arg1 seriesModelCache:(id)arg2;
- (CGRect)calloutLineBoundingBoxForSeries:(NSUInteger)arg1;
- (id)newPathsForRenderingCalloutLineForSeries:(NSUInteger)arg1 outStartLineEndPath:(id )arg2 outEndLineEndPath:(id )arg3 stroke:(id)arg4 outStroke:(id )arg5 context:(CGContextRef )arg6 contextScale:(float)arg7;
