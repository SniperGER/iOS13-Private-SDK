...
- (id).cxx_construct;
-     // Error parsing type: v32@0:8^{TableDataList=^^?{InternalMetadataWithArena=^v}{HasBits<1>=[1I]}{CachedSize={atomic<int>=Ai}}{RepeatedPtrField<TST::TableDataList_ListEntry>=^{Arena}ii^{Rep}}{RepeatedPtrField<TSP::Reference>=^{Arena}ii^{Rep}}Ii}16@24, name: encodeObjectsToDataListArchive:archiver:
-     // Error parsing type: v32@0:8r^{TableDataList=^^?{InternalMetadataWithArena=^v}{HasBits<1>=[1I]}{CachedSize={atomic<int>=Ai}}{RepeatedPtrField<TST::TableDataList_ListEntry>=^{Arena}ii^{Rep}}{RepeatedPtrField<TSP::Reference>=^{Arena}ii^{Rep}}Ii}16@24, name: loadObjectsFromDataListArchive:unarchiver:
