...
-     // Error parsing type: v24@0:8^{ColumnOrRowUuidsInfoArchive=^^?{InternalMetadataWithArena=^v}{HasBits<1>=[1I]}{CachedSize={atomic<int>=Ai}}{RepeatedPtrField<TSCE::RewriteRangeEntryArchive>=^{Arena}ii^{Rep}}^{UUID}^{UUID}^{UUID}^{IndexedUidsArchive}^{RangeCoordinateArchive}^{UUID}^{UUID}B}16, name: saveToMessage:
-     // Error parsing type: @24@0:8r^{ColumnOrRowUuidsInfoArchive=^^?{InternalMetadataWithArena=^v}{HasBits<1>=[1I]}{CachedSize={atomic<int>=Ai}}{RepeatedPtrField<TSCE::RewriteRangeEntryArchive>=^{Arena}ii^{Rep}}^{UUID}^{UUID}^{UUID}^{IndexedUidsArchive}^{RangeCoordinateArchive}^{UUID}^{UUID}B}16, name: initFromMessage:
