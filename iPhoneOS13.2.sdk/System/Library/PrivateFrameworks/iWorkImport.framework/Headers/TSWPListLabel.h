...
@property(readonly, nonatomic) NSUInteger listNumber; // @synthesize listNumber=_listNumber;
...
- (void)dealloc;
// - (id)initWithType:(int)arg1 labelString:(id)arg2 textLine:(struct __CTLine )arg3 listNumber:(NSUInteger)arg4 isTateChuYoko:(BOOL)arg5 baselineOffset:(double)arg6;
