...
+ (id)newPackageWithURL:(id)arg1 options:(NSUInteger)arg2 packageIdentifier:(unsigned char)arg3 decryptionKey:(id)arg4 fileCoordinatorDelegate:(id)arg5 error:(id )arg6;
+ (id)dataEntryPathForFilename:(id)arg1;
+ (id)objectArchiveEntryPathForPackageLocator:(id)arg1;
+ (BOOL)isValidPackageAtURL:(id)arg1;
@property(readonly, nonatomic) NSUInteger fileFormatVersion; // @synthesize fileFormatVersion=_fileFormatVersion;
...
- (void)didReadFileFormatVersion:(NSUInteger)arg1;
...
- (id)initWithPackageIdentifier:(unsigned char)arg1 documentProperties:(id)arg2 fileFormatVersion:(NSUInteger)arg3 decryptionKey:(id)arg4 fileCoordinatorDelegate:(id)arg5 isLazyLoading:(BOOL)arg6;
- (id)initWithURL:(id)arg1 zipArchiveOrNil:(id)arg2 zipArchiveOptions:(NSUInteger)arg3 packageIdentifier:(unsigned char)arg4 documentProperties:(id)arg5 decryptionKey:(id)arg6 fileCoordinatorDelegate:(id)arg7 error:(id )arg8;
- (id)init;
