...
- (id)p_stylesPassingTest:(id /* block */)arg1 cascade:(_Bool)arg2;
...
- (id)_defaultStyleOfClass:(Class)arg1 withIdentifier:(id)arg2 wasCreated:(_Bool *)arg3 usingBlock:(id /* block */)arg4;
