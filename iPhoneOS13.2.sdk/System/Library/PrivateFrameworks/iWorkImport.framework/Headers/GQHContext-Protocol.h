...
//  (void)createMaskedImageWithId:(struct __CFString )arg1 geometry:(GQDAffineGeometry *)arg2 imageBinary:(GQDImageBinary *)arg3 cropGeometry:(GQDAffineGeometry *)arg4 maskingShapePath:(GQDPath *)arg5 alphaMaskBezier:(CGPathRef)arg6 graphicStyle:(GQDSStyle *)arg7 isFloating:(BOOL)arg8 state:(GQHState *)arg9;
