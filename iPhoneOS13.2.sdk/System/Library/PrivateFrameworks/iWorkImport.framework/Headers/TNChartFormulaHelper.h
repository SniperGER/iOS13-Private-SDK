...
- (void)p_addStringFormulasOfType:(NSUInteger)arg1 rangeList:(id)arg2 byRow:(BOOL)arg3 labels:(id)arg4 toFormulaMap:(id)arg5;
- (id)p_labelsOfType:(NSUInteger)arg1 formulaMap:(id)arg2;
- (unsigned char)p_addFormulasOfType:(NSUInteger)arg1 rangeList:(id)arg2 byRow:(BOOL)arg3 toFormulaMap:(id)arg4;
- (unsigned char)p_addFormulasOfType:(NSUInteger)arg1 rangeList:(id)arg2 byRow:(BOOL)arg3 toFormulaMap:(id)arg4 ofLevel:(unsigned char)arg5;
