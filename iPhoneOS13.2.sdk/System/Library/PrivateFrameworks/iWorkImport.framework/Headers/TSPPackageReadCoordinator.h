...
@class NSArray, NSMapTable, NSMutableSet, NSObject, NSSet, NSURL, NSUUID, TSPDocumentRevision, TSPFinalizeHandlerQueue, TSPObject, TSPObjectContainer, TSPObjectContext, TSPPackage, TSPPackageMetadata, TSPPersistedObjectUUIDMap;
...
//  (NSUInteger)fileFormatVersionFromMetadataMessage:(const struct PackageMetadata )arg1;
