...
//     struct RenderState mRenderState;
    ...
    id /* CDUnknownBlockType */ mUpdateShaderEffectsStatesBlock;
}

@property(copy, nonatomic) id /* CDUnknownBlockType */ updateShaderEffectsStatesBlock; // @synthesize updateShaderEffectsStatesBlock=mUpdateShaderEffectsStatesBlock;
