...
@property(readonly, nonatomic) NSUInteger deliveryStyle; // @synthesize deliveryStyle=_deliveryStyle;
@property(readonly, nonatomic) NSUInteger deliveryOption; // @synthesize deliveryOption=_deliveryOption;
...
- (id)description;
- (id)initWithBuildType:(long long)arg1 effectIdentifier:(id)arg2 attributes:(id)arg3 pluginClass:(Class)arg4 deliveryStyle:(NSUInteger)arg5 eventIndex:(long long)arg6 stageIndex:(long long)arg7 startTime:(double)arg8 eventStartTime:(double)arg9 duration:(double)arg10 direction:(NSUInteger)arg11 automatic:(BOOL)arg12 animateAtEndOfPreviousBuild:(BOOL)arg13 parentBuild:(id)arg14;
