...
+     // Error parsing type: @32@0:8^{shared_ptr<google::protobuf::UnknownFieldSet>=^{UnknownFieldSet}^{__shared_weak_count}}16r^{FieldInfo=^^?{InternalMetadataWithArena=^v}{HasBits<1>=[1I]}{CachedSize={atomic<int>=Ai}}{RepeatedField<unsigned long long>=ii(Pointer=^{Arena}^{Rep})}i{RepeatedField<unsigned long long>=ii(Pointer=^{Arena}^{Rep})}i{RepeatedField<unsigned int>=ii(Pointer=^{Arena}^{Rep})}i{ArenaStringPtr=^{basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >}}^{FieldPath}iii}24, name: unknownFieldWithFieldSet:fieldInfo:
- (id).cxx_construct;
- (id)debugDescription;
...
-     // Error parsing type: @32@0:8^{shared_ptr<google::protobuf::UnknownFieldSet>=^{UnknownFieldSet}^{__shared_weak_count}}16r^{FieldInfo=^^?{InternalMetadataWithArena=^v}{HasBits<1>=[1I]}{CachedSize={atomic<int>=Ai}}{RepeatedField<unsigned long long>=ii(Pointer=^{Arena}^{Rep})}i{RepeatedField<unsigned long long>=ii(Pointer=^{Arena}^{Rep})}i{RepeatedField<unsigned int>=ii(Pointer=^{Arena}^{Rep})}i{ArenaStringPtr=^{basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >}}^{FieldPath}iii}24, name: initWithFieldSet:fieldInfo:
