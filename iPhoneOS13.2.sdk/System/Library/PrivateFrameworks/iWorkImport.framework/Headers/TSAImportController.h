...
@class NSDictionary, NSError, NSMutableArray, NSMutableSet, NSOperationQueue, NSProgress, NSString, NSURL, TSPObjectContext, TSUProgressContext, TSUTemporaryDirectory;
@protocol OS_dispatch_group, TSADocumentPassphraseProvider, TSAImportDelegate, TSKImporter;
...
- (id)templateDocumentWithName:(id)arg1 variantIndex:(NSUInteger)arg2;
