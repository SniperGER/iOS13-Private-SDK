...
@property(copy, nonatomic) id /* block */ reachabilityUpdatedBlock; // @synthesize reachabilityUpdatedBlock=_reachabilityUpdatedBlock;
- (void)enableNotifier;
- (void)disableNotifier;
- (void)p_stopNotifier;
- (void)p_startNotifier;
- (void)reachabilityStatusWithCompletionQueue:(id)arg1 completionHandler:(id /* block */)arg2;
