...
@property(nonatomic) NSRange * subRange; // @synthesize subRange=_subRange;
- (id).cxx_construct;
// - (void).cxx_destruct;
...
- (id)initWithSubRange:(NSRange *)arg1 unmappedIndexes:(const vector_06e666a8 )arg2 isBackwardAffinities:(const vector_553f084a )arg3;
