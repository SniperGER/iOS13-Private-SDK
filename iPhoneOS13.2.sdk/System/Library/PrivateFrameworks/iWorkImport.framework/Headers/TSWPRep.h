...
- (void)recursivelyDrawInContext:(CGContextRef )arg1 limitSelection:(id)arg2 suppressInvisibles:(BOOL)arg3;
- (void)p_drawInContext:(CGContextRef )arg1 limitSelection:(id)arg2 suppressInvisibles:(BOOL)arg3;
