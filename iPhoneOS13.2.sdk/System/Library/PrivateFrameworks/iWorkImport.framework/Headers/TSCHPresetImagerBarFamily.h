...
- (void)renderInRoundedCornerClippedContext:(struct CGContext *)arg1 forPreset:(id)arg2 stroke:(id)arg3 barRect:(struct CGRect)arg4 clipRect:(struct CGRect)arg5 isVertical:(_Bool)arg6 renderBlock:(id /* block */)arg7;
