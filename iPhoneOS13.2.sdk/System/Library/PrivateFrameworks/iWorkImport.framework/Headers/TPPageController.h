...
- (void)p_withPageLayoutAtIndex:(NSUInteger)arg1 preferredLayoutController:(id)arg2 executeBlock:(CDUnknownBlockType)arg3;
...
- (double)footerHeight;
- (double)headerHeight;
- (void)withPageLayoutAtIndex:(NSUInteger)arg1 preferredLayoutController:(id)arg2 executeBlock:(CDUnknownBlockType)arg3;
- (void)withPageLayoutAtIndex:(NSUInteger)arg1 executeBlock:(CDUnknownBlockType)arg2;
