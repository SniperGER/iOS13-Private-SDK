...
- (id)p_pageIndicesForFlow:(id)arg1 withSelection:(id)arg2 forcePagination:(_Bool)arg3;
- (id)p_pageInfosForBodySelection:(id)arg1;
- (void)p_processWidowsAndInflationForLayoutController:(id)arg1;
- (unsigned long long)p_pageIndexForFootnoteIndex:(unsigned long long)arg1 forcePagination:(_Bool)arg2 searchAfterPaginationPoint:(_Bool)arg3;
...
- (unsigned long long)p_pageIndexForAnchoredCharIndex:(unsigned long long)arg1 forcePagination:(_Bool)arg2 searchAfterPaginationPoint:(_Bool)arg3;
...
- (struct CGRect)pageRectForPageIndex:(unsigned long long)arg1 allowAfterPaginationPoint:(_Bool)arg2;
- (struct CGPoint)pageOriginForPageIndex:(unsigned long long)arg1 allowAfterPaginationPoint:(_Bool)arg2;
...
- (struct _NSRange)sectionPageRangeForPageIndex:(unsigned long long)arg1 forcePagination:(_Bool)arg2 outEndIsValid:(_Bool *)arg3;
- (unsigned long long)sectionPageIndexForPageIndex:(unsigned long long)arg1 forcePagination:(_Bool)arg2;
- (struct _NSRange)sectionBodyRangeForPageIndex:(unsigned long long)arg1 forcePagination:(_Bool)arg2;
...
- (unsigned long long)pageIndexForFootnoteIndex:(unsigned long long)arg1 forcePagination:(_Bool)arg2;
- (unsigned long long)pageIndexForAnchoredAttachment:(id)arg1 forcePagination:(_Bool)arg2;
...
- (id)anchoredDrawablesOnPageIndex:(unsigned long long)arg1 forcePagination:(_Bool)arg2;
- (struct _NSRange)anchoredRangeForPageIndex:(unsigned long long)arg1 forcePagination:(_Bool)arg2;
...
- (struct _NSRange)p_pageRangeForSelection:(id)arg1 includingEmptyPages:(_Bool)arg2 outEndIsValid:(_Bool *)arg3 forcePagination:(_Bool)arg4;
