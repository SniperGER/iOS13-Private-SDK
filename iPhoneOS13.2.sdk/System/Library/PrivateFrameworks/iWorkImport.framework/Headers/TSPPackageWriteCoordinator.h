...
- (void)addDelayedObject:(id)arg1 forComponentRootObject:(id)arg2 claimingComponent:(id)arg3 isDelayedObjectReferencedByObjectContainer:(_Bool)arg4 completion:(id /* block */)arg5;
...
- (void)enqueueRootObjectImpl:(id)arg1 forceArchive:(_Bool)arg2 failToAutosaveOnArchive:(_Bool)arg3 isAddingDelayedObjectReferencedByObjectContainer:(_Bool)arg4 completion:(id /* block */)arg5;
- (void)enqueueRootObject:(id)arg1 forceArchive:(_Bool)arg2 failToAutosaveOnArchive:(_Bool)arg3 isAddingDelayedObjectReferencedByObjectContainer:(_Bool)arg4 completion:(id /* block */)arg5;
