...
+ (void)initDefaultPropertyMap:(id)arg1 presetID:(NSUInteger)arg2 colors:(id)arg3 alternate:(int)arg4;
+ (void)initDefaultStrokePresetListInPropertyMap:(id)arg1 presetID:(NSUInteger)arg2 colors:(id)arg3;
+ (int)defaultIntValueForProperty:(int)arg1;
+ (id)styleIDForPreset:(NSUInteger)arg1;
+ (NSUInteger)presetIDForStyleID:(id)arg1;
