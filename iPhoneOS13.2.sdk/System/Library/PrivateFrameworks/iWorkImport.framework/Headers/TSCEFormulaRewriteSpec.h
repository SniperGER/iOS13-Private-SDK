...
- (id).cxx_construct;
-     // Error parsing type: v32@0:8^{FormulaRewriteSpecArchive=^^?{InternalMetadataWithArena=^v}{HasBits<1>=[1I]}{CachedSize={atomic<int>=Ai}}^{UUID}^{UUID}^{UUID}^{ColumnOrRowUuidsInfoArchive}^{ColumnOrRowUuidsInfoArchive}^{RegionMovedInfoArchive}^{RegionInfoArchive}^{RewriteTableUIDInfoArchive}^{TableTransposeInfoArchive}^{MergeOriginMovedArchive}^{MergeSourceArchive}^{RewriteGroupNodeUIDInfoArchive}^{GroupByChangeArchive}Bi}16@24, name: saveToMessage:archiver:
-     // Error parsing type: @24@0:8r^{FormulaRewriteSpecArchive=^^?{InternalMetadataWithArena=^v}{HasBits<1>=[1I]}{CachedSize={atomic<int>=Ai}}^{UUID}^{UUID}^{UUID}^{ColumnOrRowUuidsInfoArchive}^{ColumnOrRowUuidsInfoArchive}^{RegionMovedInfoArchive}^{RegionInfoArchive}^{RewriteTableUIDInfoArchive}^{TableTransposeInfoArchive}^{MergeOriginMovedArchive}^{MergeSourceArchive}^{RewriteGroupNodeUIDInfoArchive}^{GroupByChangeArchive}Bi}16, name: initFromMessage:
...
- (id)initForCategorizedTableChromeToBaseRewriterWithSrcTableUID:(const UUIDData_5fbc143e *)arg1 srcTract:(const UUIDRect_d701734b *)arg2 dstTableUID:(const UUIDData_5fbc143e *)arg3 destTract:(const UUIDRect_d701734b *)arg4 coordMapper:(id)arg5 srcCoordMapper:(id)arg6 fromTableUID:(const UUIDData_5fbc143e *)arg7;
- (id)initForCategorizedTableBaseToChromeRewriterWithSrcTableUID:(const UUIDData_5fbc143e *)arg1 srcTract:(const UUIDRect_d701734b *)arg2 dstTableUID:(const UUIDData_5fbc143e *)arg3 destTract:(const UUIDRect_d701734b *)arg4 coordMapper:(id)arg5;
...
- (id)initForMovingRowsOrColumnsInTable:(const UUIDData_5fbc143e *)arg1 rowColumnUuids:(const vector_4dc5f307 *)arg2 shuffleMap:(id)arg3 areRows:(_Bool)arg4 srcTract:(const UUIDRect_d701734b *)arg5 destTract:(const UUIDRect_d701734b *)arg6;
