...
@class NSArray, NSMutableArray, TSKCustomFormatWrapper, TSTCategoryOwner, TSTGroupByChangeDistributor, TSTGroupNode, TSTTableInfo, TSULocale;
...
+ (id)p_dateBySettingUnit:(NSUInteger)arg1 value:(long long)arg2 ofDate:(id)arg3 inCalendar:(id)arg4;
...
// - (id)groupNodeForGroupValueHierarchyFromSplitter:(id)arg1 startAtComponent:(NSUInteger)arg2 startAtWord:(NSUInteger)arg3 preserveFlags:(struct TSUPreserveFlags )arg4;
...
- (NSUInteger)indexOfGroupingColumn:(id)arg1;
...
- (NSUInteger)numberOfGroupsAtLevel:(unsigned char)arg1;
...
- (id)labelRowUIDSetForCategoryLevel:(unsigned char)arg1 labelRowVisibility:(NSUInteger)arg2;
- (id)labelRowUIDSet;
