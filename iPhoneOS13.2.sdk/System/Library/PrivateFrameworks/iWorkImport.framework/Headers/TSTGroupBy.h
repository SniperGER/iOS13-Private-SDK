...
- (void)enumerateRowsUidsAtLevel:(unsigned char)arg1 withBlock:(id /* block */)arg2;
...
- (void)enumerateAggregatesAtLevel:(unsigned char)arg1 withBlock:(id /* block */)arg2;
- (void)enumerateAggregates:(id /* block */)arg1;
...
- (void)enumerateGroupingColumnsForColumn:(const UUIDData_5fbc143e *)arg1 withBlock:(id /* block */)arg2;
