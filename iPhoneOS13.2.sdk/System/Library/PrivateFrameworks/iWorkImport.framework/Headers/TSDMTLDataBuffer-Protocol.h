...
+ (id <TSDMTLDataBuffer>)newDataBufferWithVertexRect:(CGRect)arg1 textureRect:(CGRect)arg2 meshSize:(CGSize)arg3 textureFlipped:(BOOL)arg4 includeCenterAttribute:(BOOL)arg5 addTransparentBorder:(BOOL)arg6 device:(id <MTLDevice>)arg7;
...
+ (id <TSDGLDataBuffer>)newDataBufferWithVertexAttributes:(NSArray *)arg1 quadParticleCount:(NSUInteger)arg2 device:(id <MTLDevice>)arg3;
