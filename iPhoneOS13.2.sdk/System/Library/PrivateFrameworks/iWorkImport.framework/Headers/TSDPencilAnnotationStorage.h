...
@property(readonly, nonatomic) CGPathRef path; // @synthesize path=_path;
// - (void).cxx_destruct;
...
- (id)initFromSOSWithContext:(id)arg1 markupOffset:(CGPoint)arg2 rasterizedImageTSPData:(id)arg3 attachedLocation:(long long)arg4 attachedType:(long long)arg5 encodedDrawing:(id)arg6 legacyEncodedDrawing:(id)arg7 path:(CGPathRef)arg8 unscaledBoundsOfStrokes:(CGRect)arg9 originalAttachedSize:(CGSize)arg10 percentOfPAContainedInParentRep:(double)arg11 textBaselinesTouchedCount:(NSUInteger)arg12 visibleStrokesCount:(NSUInteger)arg13 penColor:(id)arg14 toolType:(long long)arg15 compoundAnnotationType:(long long)arg16 subStorages:(id)arg17 creationDate:(id)arg18 pencilAnnotationDrawingScale:(double)arg19 strokePointsFrame:(CGRect)arg20 renderedFrame:(CGRect)arg21;
- (id)initWithContext:(id)arg1 drawing:(id)arg2 markupOffset:(CGPoint)arg3 rasterizedImage:(id)arg4 attachedLocation:(long long)arg5 attachedType:(long long)arg6 path:(CGPathRef)arg7 unscaledBoundsOfStrokes:(CGRect)arg8 originalAttachedSize:(CGSize)arg9 percentOfPAContainedInParentRep:(double)arg10 textBaselinesTouchedCount:(NSUInteger)arg11 visibleStrokesCount:(NSUInteger)arg12 penColor:(id)arg13 toolType:(long long)arg14 compoundAnnotationType:(long long)arg15 subStorages:(id)arg16 creationDate:(id)arg17 pencilAnnotationDrawingScale:(double)arg18;
