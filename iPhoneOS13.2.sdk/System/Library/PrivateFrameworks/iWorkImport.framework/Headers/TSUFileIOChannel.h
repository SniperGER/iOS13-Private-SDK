...
- (void)dealloc;
- (id)initWithType:(unsigned long long)arg1 descriptor:(int)arg2 cleanupHandler:(id /* block */)arg3;
...
- (id)initForReadingDescriptor:(int)arg1 cleanupHandler:(id /* block */)arg2;
