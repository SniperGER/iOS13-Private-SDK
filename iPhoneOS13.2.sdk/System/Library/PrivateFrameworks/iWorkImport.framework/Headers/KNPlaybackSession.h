...
@property(copy, nonatomic) id /* block */ endShowHandler; // @synthesize endShowHandler=_endShowHandler;
...
- (void)dealloc;
- (id)init;
- (id)initWithShow:(id)arg1 viewScale:(double)arg2 showLayer:(id)arg3 canvasDelegate:(id)arg4 isMetalEnabled:(_Bool)arg5 endShowHandler:(id /* block */)arg6;
