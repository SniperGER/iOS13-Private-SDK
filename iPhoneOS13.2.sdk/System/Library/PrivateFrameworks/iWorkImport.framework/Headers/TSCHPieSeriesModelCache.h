...
@interface TSCHPieSeriesModelCache : NSObject
{
    ...
    NSUInteger mNumberOfSeries;
    double mTotalValue;
    TSCHChartSeries *mCurrentSeries;
    NSUInteger mCurrentSeriesIndex;
...
@property(readonly) NSUInteger seriesIndex; // @synthesize seriesIndex=mCurrentSeriesIndex;
// - (void).cxx_destruct;
...
- (id)initWithPrior:(id)arg1 orChartModel:(id)arg2 forSeries:(NSUInteger)arg3;
