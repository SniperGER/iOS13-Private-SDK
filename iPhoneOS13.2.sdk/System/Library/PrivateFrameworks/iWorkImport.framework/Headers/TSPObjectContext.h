...
- (void)enumerateObjectProvidersUsingBlock:(id /* block */)arg1;
...
- (void)canPerformUserActionUsingBlock:(id /* block */)arg1;
...
- (id)performResourceAccessUsingQueue:(id)arg1 block:(id /* block */)arg2;
...
- (void)prepareToReadSupportObjectExternalDataReferencesAllowed:(_Bool)arg1 accessor:(id /* block */)arg2;
...
- (_Bool)readWithReadCoordinator:(id)arg1 finalizeHandlerQueue:(id)arg2 rootObject:(id *)arg3 error:(id *)arg4 readCompletion:(id /* block */)arg5;
...
- (_Bool)copyIfAppropriateFromOriginalURL:(id)arg1 toURL:(id)arg2 apfsMode:(_Bool)arg3 originalPackage:(id)arg4 packageType:(long long)arg5 inheritAttributes:(_Bool)arg6;
