...
// - (void)drawStrokesInGridRange:(CDStruct_58eae27c)arg1 clearStrokes:(BOOL)arg2 context:(CGContextRef )arg3;
// - (void)p_drawStrokeForGridRow:(unsigned int)arg1 strokeRect:(CDStruct_58eae27c)arg2 clearStroke:(BOOL)arg3 shadowType:(int)arg4 context:(CGContextRef )arg5;
// - (void)p_drawStrokeForGridColumn:(unsigned int)arg1 strokeRect:(CDStruct_58eae27c)arg2 clearStroke:(BOOL)arg3 shadowType:(int)arg4 context:(CGContextRef )arg5;
