...
@interface TSCHChartRep : TSWPTextHostRep <TSCHChartRepPlatformProtocols, TSCHSupportsRendering, CALayerDelegate>
{
    ...
    CGPoint mLastSubselectionLayerRelativeRef erencePosition;
...
- (void)clearRenderers;
- (id)renderers;
@property(readonly, nonatomic) CGColorRef subSelectionKnobStrokeColor;
@property(readonly, nonatomic) CGColorRef subSelectionKnobFillColor;
