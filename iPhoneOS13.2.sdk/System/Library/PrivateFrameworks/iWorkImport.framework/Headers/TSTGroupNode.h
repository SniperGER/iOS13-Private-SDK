...
// - (id)findGroupNodeForDisplayValuesFromSplitter:(id)arg1 atLevel:(unsigned char)arg2 groupBy:(id)arg3 startAtComponent:(NSUInteger)arg4 startAtWord:(NSUInteger)arg5 preserveFlags:(struct TSUPreserveFlags )arg6;
