...
-     // Error parsing type: v24@0:8^{CoordMapperArchive=^^?{InternalMetadataWithArena=^v}{HasBits<1>=[1I]}{CachedSize={atomic<int>=Ai}}{RepeatedPtrField<TSCE::CoordMapperArchive_BaseToViewEntry>=^{Arena}ii^{Rep}}^{IndexSetArchive}^{UUID}}16, name: encodeToArchive:
- (const UUIDData_5fbc143e *)tableUID;
-     // Error parsing type: @24@0:8r^{CoordMapperArchive=^^?{InternalMetadataWithArena=^v}{HasBits<1>=[1I]}{CachedSize={atomic<int>=Ai}}{RepeatedPtrField<TSCE::CoordMapperArchive_BaseToViewEntry>=^{Arena}ii^{Rep}}^{IndexSetArchive}^{UUID}}16, name: initFromArchive:
