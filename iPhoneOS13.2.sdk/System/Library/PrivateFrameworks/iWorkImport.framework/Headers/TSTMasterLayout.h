...
- (double)heightOfRow:(unsigned int)arg1 skipDynamicSwap:(_Bool)arg2 withStrokeHeights:(_Bool)arg3 returnZeroIfHidden:(_Bool)arg4 clampToPartitionSize:(_Bool)arg5 outIsFitting:(_Bool *)arg6;
