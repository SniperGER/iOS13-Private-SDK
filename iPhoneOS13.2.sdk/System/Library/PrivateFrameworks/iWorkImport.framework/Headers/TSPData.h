...
- (void)addDownloadObserver:(id)arg1 options:(NSUInteger)arg2 completionHandler:(CDUnknownBlockType)arg3;
...
- (id)UIImage;
- (void)tsp_splitDataWithMaxSize:(NSUInteger)arg1 subdataHandlerBlock:(CDUnknownBlockType)arg2;
