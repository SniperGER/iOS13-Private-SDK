...
-     // Error parsing type: v32@0:8^{RecordingCorrectionHistory=^^?{InternalMetadataWithArena=^v}{HasBits<1>=[1I]}{CachedSize={atomic<int>=Ai}}B}16@24, name: saveToMessage:archiver:
-     // Error parsing type: @32@0:8r^{RecordingCorrectionHistory=^^?{InternalMetadataWithArena=^v}{HasBits<1>=[1I]}{CachedSize={atomic<int>=Ai}}B}16@24, name: initWithMessage:unarchiver:
