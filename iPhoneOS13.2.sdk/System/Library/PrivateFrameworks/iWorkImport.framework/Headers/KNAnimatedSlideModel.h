...
- (_Bool)p_shouldAnimateImplicitAmbientAnimatingDrawableAtFirstEvent:(id)arg1;
...
- (void)enumerateAnimatedBuildsAndTimeRangesAtIndex:(unsigned long long)arg1 ignoreInitialDelay:(_Bool)arg2 usingBlock:(id /* block */)arg3;
