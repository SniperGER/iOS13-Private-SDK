...
- (void)enumerateAnimatedBuildsAndTimeRangesAtIndex:(NSUInteger)arg1 ignoreInitialDelay:(BOOL)arg2 usingBlock:(CDUnknownBlockType)arg3;
- (void)enumerateAnimatedBuildsAndTimeRangesAtIndex:(NSUInteger)arg1 usingBlock:(CDUnknownBlockType)arg2;
