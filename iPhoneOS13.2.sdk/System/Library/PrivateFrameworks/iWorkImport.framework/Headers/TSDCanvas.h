...
- (struct CGImage *)i_newImageInContext:(struct CGContext *)arg1 bounds:(struct CGRect)arg2 integralBounds:(struct CGRect)arg3 distortedToMatch:(_Bool)arg4 keepingChildrenPassingTest:(id /* block */)arg5;
...
- (struct CGImage *)i_imageInScaledRect:(struct CGRect)arg1 withTargetIntegralSize:(struct CGSize)arg2 distortedToMatch:(_Bool)arg3 keepingChildrenPassingTest:(id /* block */)arg4;
- (struct CGImage *)i_imageInScaledRect:(struct CGRect)arg1 keepingChildrenPassingTest:(id /* block */)arg2;
- (struct CGImage *)i_image;
- (void)i_drawRepsInContext:(struct CGContext *)arg1 passingTest:(id /* block */)arg2;
- (void)i_drawRepsInContext:(struct CGContext *)arg1 passingTest:(id /* block */)arg2 distort:(struct CGAffineTransform)arg3;
