...
- (CGRect)p_bounds;
- (CGImageRef)i_newImageInContext:(CGContextRef )arg1 bounds:(CGRect)arg2 integralBounds:(CGRect)arg3 distortedToMatch:(BOOL)arg4 keepingChildrenPassingTest:(CDUnknownBlockType)arg5;
...
- (CGImageRef)i_imageInScaledRect:(CGRect)arg1 withTargetIntegralSize:(CGSize)arg2 distortedToMatch:(BOOL)arg3 keepingChildrenPassingTest:(CDUnknownBlockType)arg4;
- (CGImageRef)i_imageInScaledRect:(CGRect)arg1 keepingChildrenPassingTest:(CDUnknownBlockType)arg2;
- (CGImageRef)i_image;
- (void)i_drawRepsInContext:(CGContextRef )arg1 passingTest:(CDUnknownBlockType)arg2;
- (void)i_drawRepsInContext:(CGContextRef )arg1 passingTest:(CDUnknownBlockType)arg2 distort:(CGAffineTransform)arg3;
