...
// - (struct TSCECategoryRef)p_parseAsCategoryRefWithSheet:(id)arg1 tableName:(id)arg2 columnNameAndGroupValuesStartAt:(NSUInteger)arg3 withParsingContext:(id)arg4;
// - (UUIDData_5fbc143e)p_findFirstColumnNameInComponent:(id)arg1 tableName:(id)arg2 refResolver:(id)arg3 calcEngine:(id)arg4 outPreserveFlags:(struct TSUPreserveFlags )arg5 usedWordCount:(NSUInteger )arg6;
