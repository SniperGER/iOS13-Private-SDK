...
- (void)enumerateMissingColumnsIntersectingCellRange:(struct TSUCellRect)arg1 usingBlock:(id /* block */)arg2;
- (void)enumerateColumnsIntersectingCellRange:(struct TSUCellRect)arg1 usingBlock:(id /* block */)arg2;
- (void)enumerateMissingRowsIntersectingCellRange:(struct TSUCellRect)arg1 usingBlock:(id /* block */)arg2;
- (void)enumerateRowsIntersectingCellRange:(struct TSUCellRect)arg1 usingBlock:(id /* block */)arg2;
