...
- (struct CGPoint)transformTranslationCachedValueAtTime:(double)arg1;
...
- (struct CGPoint)positionCachedValueAtTime:(double)arg1;
...
- (_Bool)hiddenCachedValueAtTime:(double)arg1;
- (_Bool)hiddenCachedValueAtTime:(double)arg1 layer:(id)arg2 animation:(id)arg3;
- (_Bool)doubleSidedCachedValueAtTime:(double)arg1;
...
- (struct CGRect)boundsCachedValueAtTime:(double)arg1;
...
- (struct CGPoint)anchorPointCachedValueAtTime:(double)arg1;
