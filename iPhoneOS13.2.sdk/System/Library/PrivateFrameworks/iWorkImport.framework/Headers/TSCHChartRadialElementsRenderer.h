...
- (CGLayer )p_newPreRenderedImageWithContext:(CGContextRef )arg1 wedgePath:(CGPathRef)arg2 fullWedgePath:(CGPathRef)arg3 fill:(id)arg4 stroke:(id)arg5 shadow:(id)arg6 outUserSpaceLayerBounds:(CGRect )arg7;
...
- (void)p_drawOnlyShadow:(id)arg1 forImage:(CGLayer )arg2 intoRect:(CGRect)arg3 intoContext:(CGContextRef )arg4 atViewScale:(double)arg5 usingBlendMode:(int)arg6 opacity:(double)arg7;
- (void)p_drawOnlyShapeImage:(CGLayer )arg1 intoRect:(CGRect)arg2 intoContext:(CGContextRef )arg3 usingBlendMode:(int)arg4 opacity:(double)arg5;
- (int)chunkPlane;
- (void)dealloc;
