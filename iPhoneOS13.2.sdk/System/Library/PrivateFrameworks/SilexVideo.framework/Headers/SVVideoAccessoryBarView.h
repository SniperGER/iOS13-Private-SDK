...
- (void)transitionLeadingItemToDisplayMode:(unsigned long long)arg1 trailingItemToDisplayMode:(unsigned long long)arg2 animated:(_Bool)arg3 synchronized:(_Bool)arg4;
