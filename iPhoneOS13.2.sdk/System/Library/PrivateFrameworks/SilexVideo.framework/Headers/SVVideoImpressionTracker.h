...
@property(copy, nonatomic, setter=uponQuartileImpression:) id /* block */ quartileImpressionBlock; // @synthesize quartileImpressionBlock=_quartileImpressionBlock;
@property(copy, nonatomic, setter=uponThresholdImpression:) id /* block */ thresholdImpressionBlock; // @synthesize thresholdImpressionBlock=_thresholdImpressionBlock;
