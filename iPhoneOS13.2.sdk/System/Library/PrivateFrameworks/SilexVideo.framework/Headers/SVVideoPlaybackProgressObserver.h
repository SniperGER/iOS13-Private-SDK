...
@property(copy, nonatomic, setter=onProgressChanged:) id /* block */ progressChangedBlock; // @synthesize progressChangedBlock=_progressChangedBlock;
@property(copy, nonatomic, setter=onReset:) id /* block */ resetBlock; // @synthesize resetBlock=_resetBlock;
