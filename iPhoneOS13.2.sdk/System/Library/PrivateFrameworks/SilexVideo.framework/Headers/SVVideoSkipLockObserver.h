...
@property(copy, nonatomic, setter=onCountDown:) id /* block */ countdownBlock; // @synthesize countdownBlock=_countdownBlock;
@property(copy, nonatomic, setter=onUnlock:) id /* block */ unlockBlock; // @synthesize unlockBlock=_unlockBlock;
