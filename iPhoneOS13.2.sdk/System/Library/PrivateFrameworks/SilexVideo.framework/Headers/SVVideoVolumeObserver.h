...
@property(copy, nonatomic, setter=onMuteStateChange:) id /* block */ muteStateChangeBlock; // @synthesize muteStateChangeBlock=_muteStateChangeBlock;
@property(copy, nonatomic, setter=onVolumeChange:) id /* block */ volumeChangeBlock; // @synthesize volumeChangeBlock=_volumeChangeBlock;
