...
+ (void)_interpolateDrawing:(id)arg1 inSize:(struct CGSize)arg2 displayScale:(double)arg3 ellipseHandler:(id /* block */)arg4;
...
+ (id)imageForDrawing:(id)arg1 fittingInSize:(struct CGSize)arg2 backingScale:(double)arg3 color:(id)arg4 highFidelity:(_Bool)arg5;
