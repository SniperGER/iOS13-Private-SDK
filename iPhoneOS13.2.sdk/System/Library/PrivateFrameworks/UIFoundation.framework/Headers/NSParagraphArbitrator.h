...
@property(copy) id /* block */ validateLineBreakContext; // @synthesize validateLineBreakContext=_validateLineBreakContext;
@property(copy) id /* block */ lineWidth; // @synthesize lineWidth=_lineWidth;
