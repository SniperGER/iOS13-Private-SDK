...
@property(copy) id /* block */ emissionHandler; // @synthesize emissionHandler=_emissionHandler;
...
- (void)enumerateInterpolationFromPoint:(id /* block */)arg1 toPoint:controlPoint:usingBlock: /* Error: Ran out of types for this method. */;
- (void)dealloc;
