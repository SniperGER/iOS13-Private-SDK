...
- (void)persistChanges;
- (id)_onQueueAndBlockingMainQueue_loadSettingsOfClass:(Class)arg1 forDomainID:(id)arg2 observeOutlets:(_Bool)arg3;
...
- (_Bool)testRecipeForID:(id)arg1 consumesEvent:(long long)arg2;
