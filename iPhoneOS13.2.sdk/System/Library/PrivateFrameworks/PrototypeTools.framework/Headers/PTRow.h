...
@property(copy, nonatomic) id /* block */ unregisterBlock; // @synthesize unregisterBlock=_unregisterBlock;
@property(copy, nonatomic) id /* block */ externalCondition; // @synthesize externalCondition=_externalCondition;
@property(copy, nonatomic) id /* block */ valueSetter; // @synthesize valueSetter=_valueSetter;
@property(copy, nonatomic) id /* block */ valueGetter; // @synthesize valueGetter=_valueGetter;
@property(copy, nonatomic) id /* block */ valueFormatter; // @synthesize valueFormatter=_valueFormatter;
@property(copy, nonatomic) id /* block */ valueValidatator; // @synthesize valueValidatator=_valueValidatator;
