...
@property(nonatomic) NSUInteger groupKind; // @synthesize groupKind=_groupKind;
...
- (void)insertDate:(id)arg1 atIndex:(NSUInteger)arg2 required:(BOOL)arg3;
- (NSUInteger)insertionIndexForDate:(id)arg1 wouldBeUnique:(BOOL )arg2;
