...
@property(nonatomic) NSUInteger theme; // @synthesize theme=_theme;
@property(nonatomic) NSUInteger sizeCategory; // @synthesize sizeCategory=_sizeCategory;
// - (void).cxx_destruct;
...
- (void)commonInit;
- (id)initWithTitle:(id)arg1 theme:(NSUInteger)arg2;
