...
// - (void).cxx_destruct;
- (id)initInternalWithMachServiceName:(id)arg1 options:(NSUInteger)arg2 exportedObject:(id)arg3 exportedInterface:(id)arg4 remoteObjectInterface:(id)arg5 interruptionHandler:(CDUnknownBlockType)arg6 invalidationHandler:(CDUnknownBlockType)arg7;
- (id)initWithMachServiceName:(id)arg1 options:(NSUInteger)arg2 exportedObject:(id)arg3 exportedInterface:(id)arg4 remoteObjectInterface:(id)arg5 interruptionHandler:(CDUnknownBlockType)arg6 invalidationHandler:(CDUnknownBlockType)arg7;
- (id)initWithMachServiceName:(id)arg1 options:(NSUInteger)arg2 remoteObjectInterface:(id)arg3 interruptionHandler:(CDUnknownBlockType)arg4 invalidationHandler:(CDUnknownBlockType)arg5;
