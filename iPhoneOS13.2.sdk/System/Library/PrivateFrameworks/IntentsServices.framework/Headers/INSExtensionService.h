...
- (void)_logEventWithType:(long long)arg1 context:(id)arg2 contextNoCopy:(_Bool)arg3;
- (void)_logPrewarmDidEndWithCommand:(id)arg1 applicationIdentifier:(id)arg2 wasPrewarmed:(_Bool)arg3 completionHandler:(id /* block */)arg4;
- (_Bool)_prewarmExtensionWithIntent:(id)arg1 applicationIdentifier:(id)arg2 command:(id)arg3 completionHandler:(id /* block */)arg4;
