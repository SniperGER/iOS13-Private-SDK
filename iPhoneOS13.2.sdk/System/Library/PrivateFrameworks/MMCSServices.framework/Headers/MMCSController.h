...
- (void)putFiles:(id)arg1 requestURL:(id)arg2 requestorID:(id)arg3 transferID:(id)arg4 authToken:(id)arg5 preauthenticate:(_Bool)arg6 completionBlock:(id /* block */)arg7;
...
- (void)registerFilesForUpload:(id)arg1 withPreauthentication:(_Bool)arg2 completionBlock:(id /* block */)arg3;
