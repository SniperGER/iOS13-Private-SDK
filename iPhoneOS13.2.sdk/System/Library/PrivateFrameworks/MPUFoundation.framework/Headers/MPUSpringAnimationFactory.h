...
+ (void)animateUsingSpringWithDamping:(double)arg1 mass:(double)arg2 stiffness:(double)arg3 velocity:(double)arg4 animations:(CDUnknownBlockType)arg5 options:(NSUInteger)arg6 completion:(CDUnknownBlockType)arg7;
