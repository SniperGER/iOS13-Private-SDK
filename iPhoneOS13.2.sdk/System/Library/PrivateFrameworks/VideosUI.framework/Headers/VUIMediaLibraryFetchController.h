...
- (void)_startFetchIfNeededWithMediaLibraryRevision:(NSUInteger)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (void)_cancelFetch;
...
- (void)cancelFetch;
- (void)beginFetchWithMediaLibraryRevision:(NSUInteger)arg1 completionHandler:(CDUnknownBlockType)arg2 completionQueue:(id)arg3;
- (void)resume;
- (void)pause;
