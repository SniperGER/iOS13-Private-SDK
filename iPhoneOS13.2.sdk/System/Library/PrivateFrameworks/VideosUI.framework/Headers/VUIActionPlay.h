...
+ (void)_preflightWithMediaInfo:(id)arg1 isRentAndWatchNow:(_Bool)arg2 completion:(id /* block */)arg3;
+ (void)_playMediaInfo:(id)arg1 extrasInfo:(id)arg2 isRentAndWatchNow:(_Bool)arg3 completion:(id /* block */)arg4;
