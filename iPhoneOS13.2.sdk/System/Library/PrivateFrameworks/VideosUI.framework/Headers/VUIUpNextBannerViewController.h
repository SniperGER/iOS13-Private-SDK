...
@class IKViewElement, TVMediaInfo, TVObservableEventController, UIView, _TVShelfViewController;
...
@property(readonly, nonatomic) NSUInteger host; // @synthesize host=_host;
// - (void).cxx_destruct;
...
- (id)initWithHost:(NSUInteger)arg1;
