...
- (void)_preflightPlaybackWithMediaItem:(id)arg1 disableLocalAsset:(_Bool)arg2 presentingViewController:(id)arg3 completionHandler:(id /* block */)arg4;
...
- (void)preflightPlaybackWithMediaItem:(id)arg1 disableLocalAsset:(_Bool)arg2 presentingViewController:(id)arg3 completionHandler:(id /* block */)arg4;
