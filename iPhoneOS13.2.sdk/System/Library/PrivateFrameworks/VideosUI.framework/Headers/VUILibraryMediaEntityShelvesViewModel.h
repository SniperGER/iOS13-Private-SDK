...
@property(copy, nonatomic) id /* block */ shelfTypeComparator; // @synthesize shelfTypeComparator=_shelfTypeComparator;
@property(copy, nonatomic) id /* block */ configureShelfViewControllerBlock; // @synthesize configureShelfViewControllerBlock=_configureShelfViewControllerBlock;
