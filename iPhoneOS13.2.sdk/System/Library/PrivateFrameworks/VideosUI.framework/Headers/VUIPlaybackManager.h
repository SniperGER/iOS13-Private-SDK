...
- (void)dismissPlaybackAnimated:(_Bool)arg1 completion:(id /* block */)arg2;
...
- (void)presentPlaylist:(id)arg1 fromViewController:(id)arg2 dismissalOperation:(long long)arg3 animated:(_Bool)arg4 completion:(id /* block */)arg5;
