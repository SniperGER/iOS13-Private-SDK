...
+ (id)groupingForMediaEntities:(id)arg1 groupingKeyPath:(id)arg2 groupingSortComparator:(id /* block */)arg3 performDefaultSort:(_Bool)arg4 sortIndexPropertyKey:(id)arg5;
