...
@class NSIndexPath, UICollectionView, UILongPressGestureRecognizer, UIViewController, VUIDialogPresentationController, VUIPresentationContainerViewController, VUIPreviewInteractionController;
