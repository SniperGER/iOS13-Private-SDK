...
@property(copy, nonatomic) id /* block */ sourceFilterBlock; // @synthesize sourceFilterBlock=_sourceFilterBlock;
@property(copy, nonatomic) id /* block */ sourceFilterValueBlock; // @synthesize sourceFilterValueBlock=_sourceFilterValueBlock;
