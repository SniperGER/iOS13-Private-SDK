...
@property(copy, nonatomic) id /* block */ secondaryLinkHandler; // @synthesize secondaryLinkHandler=_secondaryLinkHandler;
@property(copy, nonatomic) id /* block */ appStoreHandler; // @synthesize appStoreHandler=_appStoreHandler;
@property(copy, nonatomic) id /* block */ actionHandler; // @synthesize actionHandler=_actionHandler;
@property(copy, nonatomic) id /* block */ cancelationHandler; // @synthesize cancelationHandler=_cancelationHandler;
