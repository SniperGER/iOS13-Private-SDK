...
- (void)imageBrowserViewController:(id)arg1 loadDescriptionAtIndex:(NSUInteger)arg2 withCompletionHandler:(CDUnknownBlockType)arg3;
- (void)imageBrowserViewController:(id)arg1 loadSubtitleAtIndex:(NSUInteger)arg2 withCompletionHandler:(CDUnknownBlockType)arg3;
- (void)imageBrowserViewController:(id)arg1 loadTitleAtIndex:(NSUInteger)arg2 withCompletionHandler:(CDUnknownBlockType)arg3;
- (void)imageBrowserViewController:(id)arg1 loadImageAtIndex:(NSUInteger)arg2 withCompletionHandler:(CDUnknownBlockType)arg3;
- (NSUInteger)numberOfImagesForBrowserViewController:(id)arg1;
- (void)carouselViewController:(id)arg1 didSelectItemAtIndex:(NSUInteger)arg2 completionHandler:(CDUnknownBlockType)arg3;
