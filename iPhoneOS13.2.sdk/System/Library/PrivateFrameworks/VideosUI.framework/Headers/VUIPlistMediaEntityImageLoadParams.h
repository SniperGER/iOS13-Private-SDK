...
@property(nonatomic) NSUInteger imageType; // @synthesize imageType=_imageType;
...
- (id)init;
- (id)initWithImageURL:(id)arg1 baseImageIdentifier:(id)arg2 imageType:(NSUInteger)arg3;
