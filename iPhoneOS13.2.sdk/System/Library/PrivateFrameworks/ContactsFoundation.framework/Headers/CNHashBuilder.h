...
+ (NSUInteger)cgrectHash:(CGRect)arg1;
+ (NSUInteger)cgsizeHash:(CGSize)arg1;
+ (NSUInteger)cgpointHash:(CGPoint)arg1;
+ (NSUInteger)cgfloatHash:(double)arg1;
+ (NSUInteger)unsignedIntegerHash:(NSUInteger)arg1;
+ (NSUInteger)integerHash:(long long)arg1;
+ (NSUInteger)boolHash:(BOOL)arg1;
+ (NSUInteger)orderedSetHash:(id)arg1;
+ (NSUInteger)setHash:(id)arg1;
