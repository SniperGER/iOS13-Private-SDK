...
+ (id)methodWithName:(id)arg1 implementation:(/* void * CDUnknownFunctionPointerType */)arg2 typeEncoding:(id)arg3;
...
- (id)initWithName:(id)arg1 implementation:(/* void * CDUnknownFunctionPointerType */)arg2 typeEncoding:(id)arg3;
