...
@property(copy, nonatomic) id /* block */ performAfterFirstLayoutBlock; // @synthesize performAfterFirstLayoutBlock=_performAfterFirstLayoutBlock;
...
- (void)dismissBrowserFullscreenAnimated:(_Bool)arg1 withCompletion:(id /* block */)arg2;
