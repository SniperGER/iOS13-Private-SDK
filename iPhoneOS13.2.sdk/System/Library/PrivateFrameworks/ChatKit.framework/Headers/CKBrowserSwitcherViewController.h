...
@interface CKBrowserSwitcherViewController : UIViewController <UIGestureRecognizerDelegate, UIScrollViewDelegate, UICollectionViewDelegate, UICollectionViewDataSource, CKBrowserSwitcherScrollPreventerDelegate, CKBrowserTransitionCoordinatorDelegate, CKAppGrabberViewDelegate, _UIBackdropViewGraphicsQualityChangeDelegate>
{
    ...
    id /* CDUnknownBlockType */ _performAfterFirstLayoutBlock;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ performAfterFirstLayoutBlock; // @synthesize performAfterFirstLayoutBlock=_performAfterFirstLayoutBlock;
...
- (double)_horizontalOffsetForVisibleSwitcherPluginIndex:(NSUInteger)arg1;
- (NSUInteger)_visibleSwitcherPluginIndexForHorizontalOffset:(double)arg1;
- (CGSize)_browserSize;
