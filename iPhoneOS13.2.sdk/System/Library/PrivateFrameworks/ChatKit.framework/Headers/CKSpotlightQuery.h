...
- (id)chatRegistry;
- (id)initWithSearchText:(id)arg1 chatRegistryOverride:(id)arg2 startQuery:(_Bool)arg3 completionBlock:(id /* block */)arg4;
...
- (void)dealloc;
- (id)initWithSearchText:(id)arg1 completionBlock:(id /* block */)arg2 startQuery:(_Bool)arg3;
