...
- (void)setPreferredCallService:(NSUInteger)arg1 forID:(id)arg2;
- (NSUInteger)preferredCallServiceForID:(id)arg1;
...
- (void)startCommunicationForEntity:(id)arg1 action:(NSUInteger)arg2 address:(id)arg3 usePreferredRouteIfAvailable:(BOOL)arg4;
- (void)startCommunicationForEntity:(id)arg1 action:(NSUInteger)arg2 address:(id)arg3;
