...
@property(nonatomic) CGSize sectionReferenceSize; // @synthesize sectionReferenceSize=_sectionRef erenceSize;
...
- (void)_enumerateSectionsInRect:(CGRect)arg1 withBlock:(CDUnknownBlockType)arg2;
...
- (void)enumerateImageElementsInRect:(CGRect)arg1 usingBlock:(CDUnknownBlockType)arg2;
