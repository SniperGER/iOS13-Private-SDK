...
@class CKComposeRecipientView, CKManualUpdater, CKPendingConversation, CKRecipientSearchListController, CNComposeRecipient, CNContactPickerViewController, CNContactStore, NSMutableDictionary, STConversationContext, UILabel, UIScrollView, UIView;
...
- (void)autocompleteResultsController:(id)arg1 didSelectRecipient:(id)arg2 atIndex:(NSUInteger)arg3;
...
- (NSUInteger)presentationOptionsForRecipient:(id)arg1;
