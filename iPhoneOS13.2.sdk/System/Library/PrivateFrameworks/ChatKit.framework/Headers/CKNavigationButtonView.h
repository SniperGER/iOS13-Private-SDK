...
@property(copy, nonatomic) id /* block */ buttonLongPressCallback; // @synthesize buttonLongPressCallback=_buttonLongPressCallback;
@property(copy, nonatomic) id /* block */ buttonTappedCallback; // @synthesize buttonTappedCallback=_buttonTappedCallback;
- (void)layoutSubviews;
