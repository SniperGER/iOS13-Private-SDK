...
@class CKMessageAcknowledgmentPickerBarViewController, CKMessagePartChatItem, UIGestureRecognizer, UIView;
...
@property(readonly, nonatomic) CGRect gradientFrame; // @synthesize gradientFrame=_gradientFrame;
