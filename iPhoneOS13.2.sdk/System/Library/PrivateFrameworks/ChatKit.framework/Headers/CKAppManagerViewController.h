...
@class CKAppSearchResultsTableViewController, NSArray, UIBarButtonItem, UISearchController, UITableView;
...
// - (void).cxx_destruct;
- (BOOL)togglePluginAtIndex:(NSUInteger)arg1 enabled:(BOOL)arg2;
