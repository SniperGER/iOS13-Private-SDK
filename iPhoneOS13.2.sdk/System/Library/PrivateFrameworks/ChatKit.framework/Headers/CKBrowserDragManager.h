...
@class CKBrowserDragViewController, UILongPressGestureRecognizer, UIView, UIViewController, UIWindow;
...
@property(nonatomic) CGPoint locationInView; // @synthesize locationInView=_locationInView;
