...
@property(readonly, nonatomic) CGSize messageAcknowledgmentTranscriptAcknowledgmentImageSize;
...
- (UIEdgeInsets)thumbnailContentAlignmentInsetsForOrientation:(BOOL)arg1;
...
- (UIEdgeInsets)balloonMaskFrameInsetsWithBalloonShape:(BOOL)arg1;
...
- (UIEdgeInsets)attachmentBalloonAlignmentRectInsetsWithTailShape:(BOOL)arg1;
- (UIEdgeInsets)balloonMaskAlignmentRectInsetsWithTailShape:(BOOL)arg1;
...
//  (UIEdgeInsets)balloonMaskCapInsetsWithBalloonDescriptor:(struct CKBalloonDescriptor_t)arg1;
...
//  (CGSize)balloonMaskSizeWithBalloonDescriptor:(struct CKBalloonDescriptor_t)arg1;
- (CGSize)roundBalloonMaskSizeWithTailShape:(BOOL)arg1;
- (CGSize)skinnyBalloonMaskSizeWithTailShape:(BOOL)arg1;
- (CGSize)balloonMaskSizeWithTailShape:(BOOL)arg1;
- (CGSize)balloonMaskTailSizeForTailShape:(BOOL)arg1;
@property(readonly, nonatomic) double extensionBalloonMaximumHeight;
- (UIEdgeInsets)extensionBalloonContentInsetsForOrientation:(BOOL)arg1;
- (CGRect)extensionIconBadgeRectForOrientation:(BOOL)arg1;
...
@property(readonly, nonatomic) UIEdgeInsets conversationListFilterSegmentInset;
