...
@property(copy, nonatomic) id /* block */ deferredPresentationBlock; // @synthesize deferredPresentationBlock=_deferredPresentationBlock;
...
@property(copy, nonatomic) id /* block */ deferredSendAnimationBlock; // @synthesize deferredSendAnimationBlock=_deferredSendAnimationBlock;
...
@property(copy, nonatomic) id /* block */ scrollBlock; // @synthesize scrollBlock=_scrollBlock;
...
- (void)stageAssetArchive:(id)arg1 skipShelf:(_Bool)arg2 completionHandler:(id /* block */)arg3;
...
- (void)fullScreenBalloonViewController:(id)arg1 verticallyScrollTranscriptByAmount:(double)arg2 animated:(_Bool)arg3 completion:(id /* block */)arg4;
...
- (void)chatInputController:(id)arg1 presentShelfModal:(id)arg2 animated:(_Bool)arg3 completion:(id /* block */)arg4;
...
- (void)hideMediaPickerAnimated:(_Bool)arg1 completion:(id /* block */)arg2;
