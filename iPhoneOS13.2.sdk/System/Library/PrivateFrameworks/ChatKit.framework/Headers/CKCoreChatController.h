...
@class CKConversation, CKFullScreenBalloonViewController, CKScheduledUpdater, CKTranscriptCollectionView, CKTranscriptCollectionViewController, IMChat, STLockoutViewController, UIProgressView;
...
@interface CKCoreChatController : CKScrollViewController <IMChatSendProgressDelegate, IMSystemMonitorListener>
{
    ...
    NSUInteger _sendProgressSendCount;
    NSUInteger _sendProgressTotalCount;
...
@property(nonatomic) NSUInteger sendProgressTotalCount; // @synthesize sendProgressTotalCount=_sendProgressTotalCount;
@property(nonatomic) NSUInteger sendProgressSendCount; // @synthesize sendProgressSendCount=_sendProgressSendCount;
...
- (void)chat:(id)arg1 progressDidChange:(float)arg2 sendingMessages:(id)arg3 sendCount:(NSUInteger)arg4 totalCount:(NSUInteger)arg5 finished:(BOOL)arg6;
