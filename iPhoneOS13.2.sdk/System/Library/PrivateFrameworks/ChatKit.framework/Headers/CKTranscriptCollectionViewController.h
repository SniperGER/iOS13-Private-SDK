...
@property(copy, nonatomic) id /* block */ transcriptUpdateCompletion; // @synthesize transcriptUpdateCompletion=_transcriptUpdateCompletion;
...
@property(copy, nonatomic) id /* block */ alertHandler; // @synthesize alertHandler=_alertHandler;
...
- (void)verticallyScrollTranscriptByAmount:(double)arg1 animated:(_Bool)arg2 completion:(id /* block */)arg3;
...
- (void)updateTranscriptChatItems:(id)arg1 inserted:(id)arg2 removed:(id)arg3 reload:(id)arg4 regenerate:(id)arg5 animated:(_Bool)arg6 completion:(id /* block */)arg7;
- (void)updateTranscriptChatItems:(id)arg1 inserted:(id)arg2 removed:(id)arg3 reload:(id)arg4 regenerate:(id)arg5 animated:(_Bool)arg6 checkFiltered:(_Bool)arg7 completion:(id /* block */)arg8;
...
- (void)liveViewController:(id)arg1 stageSticker:(id)arg2 skipShelf:(_Bool)arg3 allowAllCommits:(_Bool)arg4 completionHandler:(id /* block */)arg5;
- (void)liveViewController:(id)arg1 stagePayload:(id)arg2 skipShelf:(_Bool)arg3 allowAllCommits:(_Bool)arg4 completionHandler:(id /* block */)arg5;
...
- (void)updateTranscript:(id /* block */)arg1 animated:(_Bool)arg2 completion:(id /* block */)arg3;
- (void)reloadData;
