...
@interface CKTranscriptCollectionViewController : CKViewController <CKAudioControllerDelegate, CKLocationShareBalloonViewDelegate, CKLocationSharingDelegate, CKMovieBalloonViewDelegate, CKTitledImageBalloonViewDelegate, CKTranscriptCollectionViewDelegate, CNAvatarViewDelegate, UIAlertViewDelegate, UICollectionViewDelegate, UICollectionViewDelegate_Private, UICollectionViewDelegateFlowLayout, UICollectionViewDataSource, CKFullScreenEffectManagerDelegate, CKPluginPlaybackManagerDelegate, CKAssociatedMessageTranscriptCellDelegate, CKBalloonViewDelegate, CKSendAnimationManagerDelegate>
{
    ...
    id /* CDUnknownBlockType */ _alertHandler;
    ...
    id /* CDUnknownBlockType */ _transcriptUpdateCompletion;
    CGPoint _peekSampleTranslation;
    UIEdgeInsets _marginInsets;
}

@property(copy, nonatomic) id /* CDUnknownBlockType */ transcriptUpdateCompletion; // @synthesize transcriptUpdateCompletion=_transcriptUpdateCompletion;
...
@property(nonatomic) BOOL playedLastImpactEffectForTransitionFromComposing; // @synthesize playedLastImpactEffectForTransitionFromComposing=_playedLastImpactEffectForTransitionFromComposing;
...
@property(nonatomic) BOOL isLoadingMoreMessages; // @synthesize isLoadingMoreMessages=_isLoadingMoreMessages;
...
@property(nonatomic) CGPoint peekSampleTranslation; // @synthesize peekSampleTranslation=_peekSampleTranslation;
@property(copy, nonatomic) id /* CDUnknownBlockType */ alertHandler; // @synthesize alertHandler=_alertHandler;
@property(nonatomic) BOOL isPerformingRegenerateOrReloadOnlyUpdate; // @synthesize isPerformingRegenerateOrReloadOnlyUpdate=_isPerformingRegenerateOrReloadOnlyUpdate;
...
- (void)updateTranscriptChatItems:(id)arg1 inserted:(id)arg2 removed:(id)arg3 reload:(id)arg4 regenerate:(id)arg5 animated:(BOOL)arg6 checkFiltered:(BOOL)arg7 completion:(CDUnknownBlockType)arg8;
- (void)_updatePluginPlaybackManagerForInsertedChatItems:(id)arg1;
- (NSUInteger)_indexOfBreadcrumbReplacingTranscriptPluginInChatItems:(id)arg1 inserted:(id)arg2 removed:(id)arg3 outIndexOfReplacedPlugin:(NSUInteger )arg4 outIndexOfNewPlugin:(NSUInteger )arg5;
...
- (void)liveViewController:(id)arg1 stageSticker:(id)arg2 skipShelf:(BOOL)arg3 allowAllCommits:(BOOL)arg4 completionHandler:(CDUnknownBlockType)arg5;
- (void)liveViewController:(id)arg1 stagePayload:(id)arg2 skipShelf:(BOOL)arg3 allowAllCommits:(BOOL)arg4 completionHandler:(CDUnknownBlockType)arg5;
- (void)liveViewController:(id)arg1 requestPresentationStyle:(NSUInteger)arg2;
