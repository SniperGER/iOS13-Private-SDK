...
@interface CKChatInputController : NSObject <UITextInputPayloadDelegate, CKMessageEntryViewInputDelegate, CKBrowserViewControllerSendDelegate, CKPhotoBrowserViewControllerSendDelegate, CKHandwritingViewControllerSendDelegate, CKBrowserViewControllerStoreSendDelegate, CKPluginEntryViewControllerDelegate, CKFullScreenAppViewControllerDelegate, CKDeviceOrientationManagerDelegate, CKBrowserSwitcherViewControllerDelegate, CKBrowserTransitionCoordinatorDelegate, CKHandwritingPresentationControllerDelegate, CKBrowserAppManagerViewControllerDelegate>
{
    ...
    id /* CDUnknownBlockType */ _insertPayloadCompletionHandler;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ insertPayloadCompletionHandler; // @synthesize insertPayloadCompletionHandler=_insertPayloadCompletionHandler;
...
- (void)showBrowserForPlugin:(id)arg1 dataSource:(id)arg2 style:(NSUInteger)arg3;
- (void)launchAndShowBrowserForPlugin:(id)arg1 dataSource:(id)arg2 style:(NSUInteger)arg3;
...
- (void)switcherViewController:(id)arg1 willHideSelectionViewWithAnimations:(id /* CDUnknownBlockType */ )arg2 completion:(id /* CDUnknownBlockType */ )arg3;
- (void)switcherViewController:(id)arg1 willShowSelectionViewWithAnimations:(id /* CDUnknownBlockType */ )arg2 completion:(id /* CDUnknownBlockType */ )arg3;
...
- (void)presentViewControllerWithPluginChatItem:(id)arg1 presentationStyle:(NSUInteger)arg2;
...
- (void)_presentPluginWithBundleID:(id)arg1 sendingTextInputPayload:(id)arg2 withPayloadID:(id)arg3 style:(NSUInteger)arg4;
