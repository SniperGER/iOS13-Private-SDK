...
@property(copy, nonatomic) id /* block */ insertPayloadCompletionHandler; // @synthesize insertPayloadCompletionHandler=_insertPayloadCompletionHandler;
...
- (void)showModalViewController:(id)arg1 animated:(_Bool)arg2 completion:(id /* block */)arg3;
...
- (void)startEditingPayload:(id)arg1 dismiss:(_Bool)arg2 forPlugin:(id)arg3 completion:(id /* block */)arg4;
