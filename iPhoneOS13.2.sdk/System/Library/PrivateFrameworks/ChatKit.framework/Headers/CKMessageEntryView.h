...
@property(nonatomic) CGSize waveformViewSize; // @synthesize waveformViewSize=_waveformViewSize;
...
@property(nonatomic) CGRect audioActionMenuFrame; // @synthesize audioActionMenuFrame=_audioActionMenuFrame;
...
@property(nonatomic) CGSize characterCountSize; // @synthesize characterCountSize=_characterCountSize;
@property(nonatomic) CGSize sendButtonSize; // @synthesize sendButtonSize=_sendButtonSize;
@property(nonatomic) CGSize inputButtonSize; // @synthesize inputButtonSize=_inputButtonSize;
...
- (NSUInteger)_durationBucketForAudioComposition:(id)arg1;
...
- (void)configureForDisplayMode:(NSUInteger)arg1;
