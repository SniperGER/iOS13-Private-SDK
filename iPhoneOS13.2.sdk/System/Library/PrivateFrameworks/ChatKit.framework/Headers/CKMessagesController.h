...
@property(copy, nonatomic) id /* block */ alertViewHandler; // @synthesize alertViewHandler=_alertViewHandler;
...
@property(copy, nonatomic) id /* block */ deferredHandleURLBlock; // @synthesize deferredHandleURLBlock=_deferredHandleURLBlock;
...
- (void)_popToConversationListAndPerformBlockAnimated:(_Bool)arg1 block:(id /* block */)arg2;
