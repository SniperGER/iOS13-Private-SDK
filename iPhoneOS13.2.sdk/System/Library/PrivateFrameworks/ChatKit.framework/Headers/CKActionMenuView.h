...
- (void)setCollapsed:(_Bool)arg1 animated:(_Bool)arg2 completion:(id /* block */)arg3;
- (void)actionMenuGestureRecognized:(id)arg1;
- (void)dismissActionMenuViewAnimated:(_Bool)arg1 completion:(id /* block */)arg2;
- (void)presentActionMenuViewFromPoint:(struct CGPoint)arg1 inRect:(struct CGRect)arg2 animated:(_Bool)arg3 completion:(id /* block */)arg4;
