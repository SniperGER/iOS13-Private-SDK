...
@property(copy, nonatomic) id /* block */ presentationHandler; // @synthesize presentationHandler=_presentationHandler;
...
- (void)presentViewController:(id)arg1 fromViewController:(id)arg2 presentationHandler:(id /* block */)arg3 dismissalHandler:(id /* block */)arg4 animated:(_Bool)arg5 completion:(id /* block */)arg6;
