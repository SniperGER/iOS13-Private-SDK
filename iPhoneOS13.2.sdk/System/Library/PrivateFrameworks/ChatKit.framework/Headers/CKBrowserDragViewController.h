...
- (void)reversePeelAnimationToPoint:(struct CGPoint)arg1 forPlacement:(_Bool)arg2 shouldShrink:(_Bool)arg3 completionBlock:(id /* block */)arg4;
...
- (void)animatePlacementAtPoint:(struct CGPoint)arg1 shouldShrink:(_Bool)arg2 completionBlock:(id /* block */)arg3;
