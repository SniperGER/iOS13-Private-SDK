...
@property(copy, nonatomic) id /* block */ draggingCompletionHandler; // @synthesize draggingCompletionHandler=_draggingCompletionHandler;
...
- (void)startDragSticker:(id)arg1 frameInRemoteView:(struct CGRect)arg2 fence:(id)arg3 completionHandler:(id /* block */)arg4;
