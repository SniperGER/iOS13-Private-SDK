...
@property(copy, nonatomic) id /* block */ queryCompletionHandler; // @synthesize queryCompletionHandler=_queryCompletionHandler;
@property(copy, nonatomic) id /* block */ queryFoundItemHandler; // @synthesize queryFoundItemHandler=_queryFoundItemHandler;
