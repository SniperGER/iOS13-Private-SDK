...
- (NSDictionary *)analyticsEnvelopeContentTypeConfigsForEnvironment:(NSUInteger)arg1;
- (NTPBTodayConfig *)todayConfigWithQueueConfigs:(NSArray *)arg1 maxSlotCount:(NSUInteger)arg2;
