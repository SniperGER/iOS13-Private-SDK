...
- (void)paymentSession:(NPKQuickPaymentSession *)arg1 didCompleteForReason:(NSUInteger)arg2 withTransactionContext:(PKContactlessInterfaceTransactionContext *)arg3;
