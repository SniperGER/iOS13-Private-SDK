...
@interface NPKPassDescription : NSObject <NSSecureCoding, NSCopying>
{
    ...
    NSUInteger _expressPassTypesMask;
...
@property(nonatomic) NSUInteger settings; // @synthesize settings=_settings;
...
@property(nonatomic) NSUInteger expressPassTypesMask; // @synthesize expressPassTypesMask=_expressPassTypesMask;
// - (void).cxx_destruct;
...
- (BOOL)supportsInAppPaymentOnNetworks:(id)arg1 capabilities:(NSUInteger)arg2 issuerCountryCodes:(id)arg3 paymentApplicationStates:(id)arg4;
