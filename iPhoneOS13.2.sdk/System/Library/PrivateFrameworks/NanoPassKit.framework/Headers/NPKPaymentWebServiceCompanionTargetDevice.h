...
- (void)peerPaymentRegisterWithURL:(id)arg1 forceReRegistration:(_Bool)arg2 completion:(id /* block */)arg3;
- (void)peerPaymentRegisterResponse:(id)arg1;
- (void)cancelOutstandingRemotePassUpdateRequest:(id)arg1 pass:(id)arg2;
- (void)remotePassUpgradeWithRequest:(id)arg1 pass:(id)arg2 requireAuthorization:(_Bool)arg3 notifyUserOnPairedDevice:(_Bool)arg4 updateBlock:(id /* block */)arg5;
...
- (void)commutePlanReminderIntervalForCommutePlan:(id)arg1 pass:(id)arg2 completion:(id /* block */)arg3;
...
- (void)setExpressWithPassInformation:(id)arg1 requestAuthorization:(_Bool)arg2 completion:(id /* block */)arg3;
...
- (void)_getPairingInfoAndSetAuthRandomIfNotPaired:(_Bool)arg1 completion:(id /* block */)arg2;
