...
@class IDSService, NPKCompanionAgentConnection, NPKTapToRadarManager, NPKTargetDeviceAssertionManager, NRActiveDeviceAssertion, NSMutableDictionary;
...
- (void)_invalidateAssertionOfType:(NSUInteger)arg1;
- (void)_acquireAssertionOfType:(NSUInteger)arg1;
...
- (void)paymentWebService:(id)arg1 deviceMetadataWithFields:(NSUInteger)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)paymentWebService:(id)arg1 signData:(id)arg2 signatureEntanglementMode:(NSUInteger)arg3 withCompletionHandler:(CDUnknownBlockType)arg4;
...
- (id)initWithContext:(NSUInteger)arg1 responseQueue:(id)arg2;
- (id)init;
