...
- (BOOL)paymentWebService:(PKPaymentWebService *)arg1 hasPassesOfType:(NSUInteger)arg2;
...
- (void)paymentWebService:(PKPaymentWebService *)arg1 signData:(NSData *)arg2 signatureEntanglementMode:(NSUInteger)arg3 withCompletionHandler:(void (^)(NSData *, PKSecureElementSignatureInfo *, NSError *))arg4;
...
- (void)paymentWebService:(PKPaymentWebService *)arg1 deviceMetadataWithFields:(NSUInteger)arg2 completion:(void (^)(PKPaymentDeviceMetadata *))arg3;
...
- (NSArray *)paymentWebService:(PKPaymentWebService *)arg1 passesOfType:(NSUInteger)arg2;
