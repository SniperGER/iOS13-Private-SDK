...
- (_Bool)_migrateDatabase:(id /* block */)arg1;
...
- (void)enumerateAllPassesAndDescriptionsWithBlock:(id /* block */)arg1 includeImageSets:(_Bool)arg2;
- (void)enumerateAllPassesWithBlock:(id /* block */)arg1 includeImageSets:(_Bool)arg2;
