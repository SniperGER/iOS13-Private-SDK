...
- (void)trustedDeviceEnrollmentSignatureWithAccountDSID:(NSString *)arg1 sessionData:(NSData *)arg2 handler:(void (^)(NSString *, NSUInteger, NSData *, NSError *))arg3;
...
- (void)updateSettings:(NSUInteger)arg1 forPassWithUniqueID:(NSString *)arg2;
...
- (void)registerDeviceWithCompletion:(void (^)(NSUInteger, NSUInteger, NSError *))arg1;
