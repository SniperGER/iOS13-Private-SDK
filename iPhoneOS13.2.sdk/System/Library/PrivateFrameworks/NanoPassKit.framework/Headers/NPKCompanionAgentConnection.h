...
- (id)_remoteObjectProxySynchronize:(_Bool)arg1 withFailureHandler:(id /* block */)arg2;
...
- (void)removePaymentPassWithUniqueID:(id)arg1 forDevice:(id)arg2 waitForConfirmation:(_Bool)arg3 completion:(id /* block */)arg4;
...
- (void)paymentPassWithUniqueID:(id)arg1 synchronous:(_Bool)arg2 reply:(id /* block */)arg3;
- (void)paymentPassUniqueIDsSynchronous:(_Bool)arg1 reply:(id /* block */)arg2;
- (void)paymentPassWithUniqueID:(id)arg1 reply:(id /* block */)arg2;
- (void)paymentPassUniqueIDs:(id /* block */)arg1;
- (void)noteProvisioningPreflightCompleteWithSuccess:(_Bool)arg1 error:(id)arg2 completion:(id /* block */)arg3;
- (void)registerDeviceWithCompletion:(id /* block */)arg1;
- (void)provisionPassForAccountIdentifier:(id)arg1 makeDefault:(_Bool)arg2 completion:(id /* block */)arg3;
