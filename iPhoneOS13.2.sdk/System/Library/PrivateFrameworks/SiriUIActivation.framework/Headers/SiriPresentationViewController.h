...
- (void)_openURL:(id)arg1 bundleId:(id)arg2 delaySessionEndForTTS:(_Bool)arg3 punchoutStyle:(long long)arg4 completion:(id /* block */)arg5;
- (_Bool)siriViewController:(id)arg1 openURL:(id)arg2 appBundleID:(id)arg3 allowSiriDismissal:(_Bool)arg4;
- (void)siriViewController:(id)arg1 openURL:(id)arg2 delaySessionEndForTTS:(_Bool)arg3 completion:(id /* block */)arg4;
