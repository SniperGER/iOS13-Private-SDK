...
@class FMAnnotationView, FMFWildcardGestureRecognizer, MKMapView;
...
// - (void)_moveCenterByOffset:(CGPoint)arg1 from:(struct CLLocationCoordinate2D)arg2 mapView:(id)arg3;
