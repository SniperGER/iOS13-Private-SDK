...
@property(copy, nonatomic) id /* block */ allAssetsDownloadCompletion; // @synthesize allAssetsDownloadCompletion=_allAssetsDownloadCompletion;
@property(copy, nonatomic) id /* block */ assetDownloadCompletion; // @synthesize assetDownloadCompletion=_assetDownloadCompletion;
