...
@property(copy, nonatomic) id /* block */ contextMenuInteractionPendingCompletion; // @synthesize contextMenuInteractionPendingCompletion=_contextMenuInteractionPendingCompletion;
