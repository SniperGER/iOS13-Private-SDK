...
- (void)dismissPresentedFolderControllerAnimated:(_Bool)arg1 completion:(id /* block */)arg2;
- (void)presentFolderController:(id)arg1 animated:(_Bool)arg2 completion:(id /* block */)arg3;
