...
- (void)sort;
- (void)enumerateAllIconsWithBaseIndexPath:(id)arg1 options:(NSUInteger)arg2 usingBlock:(CDUnknownBlockType)arg3;
- (void)enumerateAllIconsWithOptions:(NSUInteger)arg1 usingBlock:(CDUnknownBlockType)arg2;
...
- (id)indexPathForIconWithOptions:(NSUInteger)arg1 passingTest:(CDUnknownBlockType)arg2;
