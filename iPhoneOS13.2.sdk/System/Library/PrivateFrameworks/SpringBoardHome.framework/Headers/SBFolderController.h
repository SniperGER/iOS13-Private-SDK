...
- (void)popFolderAnimated:(_Bool)arg1 completion:(id /* block */)arg2;
- (void)configureInnerFolderControllerConfiguration:(id)arg1;
- (void)pushFolderIcon:(id)arg1 location:(id)arg2 animated:(_Bool)arg3 completion:(id /* block */)arg4;
- (void)prepareToClose;
- (void)prepareToOpen;
...
- (void)setCurrentPageIndexToListDirectlyContainingIcon:(id)arg1 animated:(_Bool)arg2 completion:(id /* block */)arg3;
