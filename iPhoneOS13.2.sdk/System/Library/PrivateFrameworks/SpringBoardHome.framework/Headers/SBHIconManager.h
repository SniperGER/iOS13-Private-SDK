...
- (_Bool)animator:(id)arg1 canAlterViewHierarchyDuringCleanupUsingBlock:(id /* block */)arg2;
...
- (_Bool)dismissSpotlightAnimated:(_Bool)arg1 completionHandler:(id /* block */)arg2;
- (_Bool)dismissSpotlightOrTodayViewAnimated:(_Bool)arg1;
- (_Bool)presentSpotlightFromSource:(unsigned long long)arg1 fromBreadcrumb:(_Bool)arg2 animated:(_Bool)arg3 completionHandler:(id /* block */)arg4;
- (_Bool)presentSpotlightFromBreadcrumb:(_Bool)arg1 animated:(_Bool)arg2 completionHandler:(id /* block */)arg3;
...
- (void)_animateFolderIcon:(id)arg1 open:(_Bool)arg2 location:(id)arg3 animated:(_Bool)arg4 withCompletion:(id /* block */)arg5;
- (void)_closeFolderController:(id)arg1 animated:(_Bool)arg2 withCompletion:(id /* block */)arg3;
- (void)closeFolderAnimated:(_Bool)arg1 withCompletion:(id /* block */)arg2;
- (void)openFolderIcon:(id)arg1 location:(id)arg2 animated:(_Bool)arg3 withCompletion:(id /* block */)arg4;
...
- (void)popExpandedIconFromLocation:(id)arg1 interactionContext:(id)arg2 animated:(_Bool)arg3 completionHandler:(id /* block */)arg4;
- (void)popExpandedIconAnimated:(_Bool)arg1 completionHandler:(id /* block */)arg2;
- (void)pushExpandedIcon:(id)arg1 location:(id)arg2 animated:(_Bool)arg3 completionHandler:(id /* block */)arg4;
...
- (void)addIcons:(id)arg1 intoFolderIcon:(id)arg2 openFolderOnFinish:(_Bool)arg3 complete:(id /* block */)arg4;
...
- (void)unscatterAnimated:(_Bool)arg1 afterDelay:(double)arg2 withCompletion:(id /* block */)arg3;
...
- (void)uninstallIcon:(id)arg1 animate:(_Bool)arg2 completion:(id /* block */)arg3;
