...
- (BOOL)presentSpotlightFromSource:(NSUInteger)arg1 fromBreadcrumb:(BOOL)arg2 animated:(BOOL)arg3 completionHandler:(CDUnknownBlockType)arg4;
...
- (void)removeIcon:(id)arg1 options:(NSUInteger)arg2 completion:(CDUnknownBlockType)arg3;
