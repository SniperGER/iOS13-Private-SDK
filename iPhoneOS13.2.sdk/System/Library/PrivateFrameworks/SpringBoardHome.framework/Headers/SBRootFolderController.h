...
- (void)dismissSpotlightAnimated:(_Bool)arg1 completionHandler:(id /* block */)arg2;
- (void)presentSpotlightAnimated:(_Bool)arg1 completionHandler:(id /* block */)arg2;
- (void)performDefaultPageStateTransitionToState:(long long)arg1 reason:(id)arg2 animated:(_Bool)arg3 completionHandler:(id /* block */)arg4;
- (void)performPageStateTransitionToState:(long long)arg1 reason:(id)arg2 animated:(_Bool)arg3 completionHandler:(id /* block */)arg4;
