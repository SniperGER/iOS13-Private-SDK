...
- (void)enumerateExtraViewsWithHandler:(id /* block */)arg1;
- (double)_iconZoomDelay;
- (void)_performAnimationToFraction:(double)arg1 withCentralAnimationSettings:(id)arg2 delay:(double)arg3 alreadyAnimating:(_Bool)arg4 sharedCompletion:(id /* block */)arg5;
