...
@property(copy, nonatomic) id /* block */ clientOperationCompletion; // @synthesize clientOperationCompletion=_clientOperationCompletion;
...
- (void)_performOperation:(long long)arg1 onViewController:(id)arg2 animated:(_Bool)arg3 withCompletion:(id /* block */)arg4;
...
- (void)popNestedViewControllerAnimated:(_Bool)arg1 withCompletion:(id /* block */)arg2;
- (void)pushNestedViewController:(id)arg1 animated:(_Bool)arg2 withCompletion:(id /* block */)arg3;
