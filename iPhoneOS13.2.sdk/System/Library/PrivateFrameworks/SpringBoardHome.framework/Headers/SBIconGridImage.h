...
+ (id)gridImageForLayout:(id)arg1 previousGridImage:(id)arg2 previousGridCellIndexToUpdate:(NSUInteger)arg3 pool:(id)arg4 cellImageDrawBlock:(CDUnknownBlockType)arg5;
...
- (id)gridImageByPatchingCellAtIndex:(NSUInteger)arg1 cellImageProviderBlock:(CDUnknownBlockType)arg2;
