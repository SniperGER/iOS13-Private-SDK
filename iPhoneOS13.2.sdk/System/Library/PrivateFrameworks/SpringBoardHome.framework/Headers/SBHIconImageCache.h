...
- (id)memoryMappedIconImageOfSize:(CGSize)arg1 scale:(double)arg2 withDrawing:(CDUnknownBlockType)arg3;
...
- (id)_iconImageOfSize:(CGSize)arg1 scale:(double)arg2 failGracefully:(BOOL)arg3 drawing:(CDUnknownBlockType)arg4;
- (BOOL)_canPoolImage;
...
- (void)cacheImageForIcon:(id)arg1 options:(NSUInteger)arg2 completionHandler:(CDUnknownBlockType)arg3;
