...
- (id)memoryMappedIconImageOfSize:(struct CGSize)arg1 scale:(double)arg2 withDrawing:(id /* block */)arg3;
...
- (id)_iconImageOfSize:(struct CGSize)arg1 scale:(double)arg2 failGracefully:(_Bool)arg3 drawing:(id /* block */)arg4;
- (_Bool)_canPoolImage;
