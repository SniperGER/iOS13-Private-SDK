...
+ (void)unregisterAndRemoveFontFilesForIdentifier:(id)arg1 ignoringError:(_Bool)arg2 completionHandler:(id /* block */)arg3;
...
+ (void)installFonts:(id)arg1 forIdentifier:(id)arg2 enabled:(_Bool)arg3 completionHandler:(id /* block */)arg4;
