...
- (void)_openDatabase:(id)arg1 createIfNeeded:(_Bool)arg2 checkIntegrity:(_Bool)arg3 completionHandler:(id /* block */)arg4;
- (void)openAndCheckIntegrity:(_Bool)arg1 createIfNeeded:(_Bool)arg2 fallBackToMemoryStoreIfError:(_Bool)arg3 lockingPolicy:(long long)arg4 completionHandler:(id /* block */)arg5;
