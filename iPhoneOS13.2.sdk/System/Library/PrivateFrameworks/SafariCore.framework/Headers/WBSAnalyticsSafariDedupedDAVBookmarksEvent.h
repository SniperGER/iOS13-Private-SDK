...
{
    NSUInteger _dedupeCount;
    NSUInteger _foldersWithDupesCount;
...
@property(nonatomic) NSUInteger foldersWithDupesCount; // @synthesize foldersWithDupesCount=_foldersWithDupesCount;
@property(nonatomic) NSUInteger dedupeCount; // @synthesize dedupeCount=_dedupeCount;
