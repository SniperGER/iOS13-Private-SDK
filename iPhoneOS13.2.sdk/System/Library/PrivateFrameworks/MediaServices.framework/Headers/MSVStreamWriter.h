...
@property(copy, nonatomic) id /* block */ didFinishWritingBlock; // @synthesize didFinishWritingBlock=_didFinishWritingBlock;
@property(copy, nonatomic) id /* block */ canWriteDataBlock; // @synthesize canWriteDataBlock=_canWriteDataBlock;
