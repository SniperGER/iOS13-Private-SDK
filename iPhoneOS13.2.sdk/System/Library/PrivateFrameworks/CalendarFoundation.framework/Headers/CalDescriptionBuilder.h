...
- (void)setKey:(id)arg1 withSize:(NSUInteger)arg2;
...
- (void)setKey:(id)arg1 withUnsignedLongLong:(NSUInteger)arg2;
- (void)setKey:(id)arg1 withUnsignedLong:(NSUInteger)arg2;
- (void)setKey:(id)arg1 withUnsignedInteger:(NSUInteger)arg2;
