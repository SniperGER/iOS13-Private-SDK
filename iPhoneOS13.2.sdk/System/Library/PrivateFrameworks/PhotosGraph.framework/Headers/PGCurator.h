...
- (void)completeItems:(id)arg1 withItems:(id)arg2 forPersonsWithIdentifiers:(id)arg3 options:(id)arg4 nonRemovableItems:(id)arg5 debugInfo:(id)arg6 progressBlock:(id /* block */)arg7;
