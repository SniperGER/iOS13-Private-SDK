...
- (_Bool)_performEnrichmentWithGraphUpdateInventory:(id)arg1 enrichmentContext:(long long)arg2 progressBlock:(id /* block */)arg3;
- (void)_triggerUpdateForGraphUpdate:(id)arg1;
- (void)_triggerFullRebuildDuringLiveUpdate:(_Bool)arg1 graphIngestRecipe:(id)arg2 progressBlock:(id /* block */)arg3 keepExistingGraph:(_Bool)arg4 completionBlock:(id /* block */)arg5;
