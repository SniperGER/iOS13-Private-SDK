...
- (id)highlightsToProcessForKind:(unsigned short)arg1 withHighlightUpdateTypes:(NSUInteger)arg2 includeHighlightsToIngest:(BOOL)arg3;
...
- (void)registerPublicEventNode:(id)arg1 withConsolidatedAddress:(id)arg2 toResolveBusinessItemMuid:(NSUInteger)arg3;
- (void)registerLocationOfInterestVisitToResolve:(id)arg1 forMomentLocalIdentifier:(id)arg2;
- (id)momentNodesToProcessForMomentUpdateTypes:(NSUInteger)arg1 includeInsertedNodes:(BOOL)arg2;
- (id)momentsToProcessForMomentUpdateTypes:(NSUInteger)arg1 includeMomentsToIngest:(BOOL)arg2;
@property(readonly, copy) NSString *description;
- (void)updatedHighlightNode:(id)arg1 forUpdateChangeType:(NSUInteger)arg2;
- (void)updatedMomentNode:(id)arg1 forUpdateChangeType:(NSUInteger)arg2;
...
@property(readonly, nonatomic) NSUInteger momentUpdateTypes; // @synthesize momentUpdateTypes=_momentUpdateTypes;
