...
- (void)enumeratePeopleClustersWithLinkage:(NSUInteger)arg1 threshold:(double)arg2 includingMeNode:(BOOL)arg3 withBlock:(CDUnknownBlockType)arg4;
...
- (void)enumerateMomentNodesWithMeaning:(NSUInteger)arg1 usingBlock:(CDUnknownBlockType)arg2;
...
- (void)enumerateMeaningfulEventsWithMeaning:(NSUInteger)arg1 usingBlock:(CDUnknownBlockType)arg2;
