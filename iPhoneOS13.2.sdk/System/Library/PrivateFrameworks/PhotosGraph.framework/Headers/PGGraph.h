...
- (_Bool)_enumerateEventNodesForAssetCollection:(id)arg1 paddingTime:(double)arg2 error:(id *)arg3 enumerationBlock:(id /* block */)arg4;
...
- (void)_enumerateSocialGroupsIncludingMeNode:(_Bool)arg1 withValidGroupsBlock:(id /* block */)arg2 invalidGroupsBlock:(id /* block */)arg3 averageWeight:(out float *)arg4;
- (id)socialGroupsDebugStringIncludingMeNode:(_Bool)arg1;
- (void)enumerateSocialGroupsWithBlock:(id /* block */)arg1;
- (void)enumeratePeopleClustersWithLinkage:(unsigned long long)arg1 threshold:(double)arg2 includingMeNode:(_Bool)arg3 withBlock:(id /* block */)arg4;
- (void)enumeratePeopleClustersIncludingMeNode:(_Bool)arg1 withBlock:(id /* block */)arg2;
