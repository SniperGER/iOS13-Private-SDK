...
- (_Bool)enrichAllHighlightsWithOptions:(unsigned long long)arg1 progressBlock:(id /* block */)arg2;
- (_Bool)enrichHighlights:(id)arg1 options:(unsigned long long)arg2 progressBlock:(id /* block */)arg3;
...
- (id)enrichmentValuesForHighlight:(id)arg1 usingEnrichmentProfile:(id)arg2 options:(unsigned long long)arg3 reportChangedValuesOnly:(_Bool)arg4 progressBlock:(id /* block */)arg5;
