...
+ (void)generateHighlightLocationTitleForTripWithMomentNodes:(id)arg1 lineBreakBehavior:(unsigned long long)arg2 result:(id /* block */)arg3;
+ (void)generateLocationTitleForTripWithMomentNodes:(id)arg1 result:(id /* block */)arg2;
+ (_Bool)_containsAmusementParkPOIFromMomentNodes:(id)arg1;
+ (void)generateLocationTitleWithOptions:(id)arg1 result:(id /* block */)arg2;
