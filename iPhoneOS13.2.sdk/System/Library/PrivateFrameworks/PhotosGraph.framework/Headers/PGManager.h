...
- (_Bool)swapInGraph:(id)arg1 progressBlock:(id /* block */)arg2;
...
- (void)updateGraphWithGraphUpdate:(id)arg1 withRecipe:(id)arg2 keepExistingGraph:(_Bool)arg3 progressBlock:(id /* block */)arg4 completionBlock:(id /* block */)arg5;
- (void)startGraphUpdate:(id)arg1 usingCurrentGraph:(_Bool)arg2 progressBlock:(id /* block */)arg3 completionBlock:(id /* block */)arg4;
...
- (void)startLibraryAnalysisWithRecipe:(id)arg1 progressBlock:(id /* block */)arg2 keepExistingGraph:(_Bool)arg3 completionBlock:(id /* block */)arg4;
- (void)startLibraryAnalysis:(id /* block */)arg1 keepExistingGraph:(_Bool)arg2 completionBlock:(id /* block */)arg3;
