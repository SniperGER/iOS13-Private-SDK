...
- (void)matchFeatureVector:(id)arg1 options:(NSUInteger)arg2 completionBlock:(CDUnknownBlockType)arg3;
...
- (id)curatedAssetsForAssetCollection:(id)arg1 duration:(NSUInteger)arg2 precision:(NSUInteger)arg3 withContextualAssets:(id)arg4 minimumProportion:(double)arg5 progressBlock:(CDUnknownBlockType)arg6;
- (id)curatedAssetsForAssetCollection:(id)arg1 duration:(NSUInteger)arg2 precision:(NSUInteger)arg3 referencePeople:(id)arg4 progressBlock:(CDUnknownBlockType)arg5;
