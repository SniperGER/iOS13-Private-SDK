...
@interface PGRelated : NSObject
{
    ...
    NSUInteger _memoryTripTitleType;
...
@property(nonatomic) NSUInteger memoryTripTitleType; // @synthesize memoryTripTitleType=_memoryTripTitleType;
...
// - (void).cxx_destruct;
- (void)_addKeywords:(id)arg1 forRelatedType:(NSUInteger)arg2;
...
- (id)initWithGraphMatchingResult:(id)arg1 moments:(id)arg2 tripMemoryTitleType:(NSUInteger)arg3 tripMomentNodes:(id)arg4 needsDebugInfo:(BOOL)arg5;
