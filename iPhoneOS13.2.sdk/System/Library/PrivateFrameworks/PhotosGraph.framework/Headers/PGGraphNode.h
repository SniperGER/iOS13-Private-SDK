...
- (void)_enumerateDeepNeighborsWithLabel:(id)arg1 domain:(unsigned short)arg2 edgeType:(NSUInteger)arg3 shouldStop:(BOOL )arg4 block:(CDUnknownBlockType)arg5;
- (void)_enumerateDeepNeighborsWithLabel:(id)arg1 domain:(unsigned short)arg2 edgeType:(NSUInteger)arg3 excluding:(id)arg4 shouldStop:(BOOL )arg5 block:(CDUnknownBlockType)arg6;
