...
+ (id)_closestLocationNodeFromNode:(id)arg1 withDimension:(NSUInteger)arg2 remapMatchingDimensionBlock:(CDUnknownBlockType)arg3 reverse:(BOOL)arg4;
...
+ (id)closestLocationNodeFromNode:(id)arg1 withDimension:(NSUInteger)arg2 remapMatchingDimensionBlock:(CDUnknownBlockType)arg3;
