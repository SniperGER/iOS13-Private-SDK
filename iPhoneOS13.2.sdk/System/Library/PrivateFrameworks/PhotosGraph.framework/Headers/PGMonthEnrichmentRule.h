...
- (void)enumerateChildVisibilityStateForHighlightItemList:(id)arg1 withBlock:(CDUnknownBlockType)arg2 maximumNumberOfVisibleItems:(NSUInteger)arg3 maximumNumberOfVisibleRegularItems:(NSUInteger)arg4;
