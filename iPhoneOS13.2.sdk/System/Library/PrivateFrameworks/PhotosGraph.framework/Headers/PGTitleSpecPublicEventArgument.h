...
+ (id)argumentWithPublicEventType:(NSUInteger)arg1 shouldUseLongPublicEventTitle:(BOOL)arg2;
+ (id)argumentWithPublicEventType:(NSUInteger)arg1;
...
- (id)initWithPublicEventType:(NSUInteger)arg1 shouldUseLongPublicEventTitle:(BOOL)arg2;
- (id)initWithPublicEventType:(NSUInteger)arg1;
