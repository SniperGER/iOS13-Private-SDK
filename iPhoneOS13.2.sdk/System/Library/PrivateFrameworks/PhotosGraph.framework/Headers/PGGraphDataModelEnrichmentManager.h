...
- (_Bool)_enrichDataModelWithGraphUpdateInventory:(id)arg1 error:(id *)arg2 progressBlock:(id /* block */)arg3;
- (_Bool)enrichDataModelWithError:(id *)arg1 progressBlock:(id /* block */)arg2;
- (_Bool)enrichDataModelWithGraphUpdateInventory:(id)arg1 error:(id *)arg2 progressBlock:(id /* block */)arg3;
