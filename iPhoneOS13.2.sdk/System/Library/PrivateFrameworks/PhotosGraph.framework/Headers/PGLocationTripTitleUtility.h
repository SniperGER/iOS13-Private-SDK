...
+ (void)_aoiTitleWithLocationNodes:(id)arg1 momentNodes:(id)arg2 allowLongAOI:(_Bool)arg3 result:(id /* block */)arg4;
...
- (void)_cityTitleWithCityNode:(id)arg1 countryNode:(id)arg2 visitedCountryOnlyOnce:(_Bool)arg3 momentNodes:(id)arg4 result:(id /* block */)arg5;
