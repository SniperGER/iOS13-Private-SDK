...
- (_Bool)_populateCacheWithRegions:(id)arg1 manager:(id)arg2 withProgressBlock:(id /* block */)arg3;
- (void)_processMetricsOfAssetClustersInMoment:(id)arg1;
- (_Bool)_revGeocodeAssetClusters:(id)arg1 manager:(id)arg2 progressBlock:(id /* block */)arg3;
- (_Bool)revGeocodeAssets:(id)arg1 manager:(id)arg2 progressBlock:(id /* block */)arg3;
