...
@interface PGGraphAssetRevGeocodeEnrichmentProcessor : NSObject <PGGraphDataModelEnrichmentProcessor>
{
    ...
    NSUInteger _numberOfMomentsRevGeocoded;
    NSUInteger _numberOfAssetClustersRevGeocoded;
}
...
@property(readonly, nonatomic) NSUInteger numberOfAssetClustersRevGeocoded; // @synthesize numberOfAssetClustersRevGeocoded=_numberOfAssetClustersRevGeocoded;
@property(readonly, nonatomic) NSUInteger numberOfMomentsRevGeocoded; // @synthesize numberOfMomentsRevGeocoded=_numberOfMomentsRevGeocoded;
