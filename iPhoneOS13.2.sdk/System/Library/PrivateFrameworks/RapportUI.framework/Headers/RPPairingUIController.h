...
@property(copy, nonatomic) id /* block */ tryPINHandler; // @synthesize tryPINHandler=_tryPINHandler;
@property(copy, nonatomic) id /* block */ retryHandler; // @synthesize retryHandler=_retryHandler;
