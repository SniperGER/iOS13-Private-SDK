...
@interface RPPINEntryView : UIView <UIKeyInput, UITextInputTraits>
{
    ...
    UILabel *_label7;
    UILabel *_label8;
    id /* CDUnknownBlockType */ _textChangedHandler;
    NSArray *_wells;
    UIView *_well1;
    UIView *_well2;
    UIView *_well3;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ textChangedHandler; // @synthesize textChangedHandler=_textChangedHandler;
