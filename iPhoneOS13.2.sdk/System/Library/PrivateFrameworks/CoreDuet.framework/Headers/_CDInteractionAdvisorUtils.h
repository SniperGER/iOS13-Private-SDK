...
+ (id)nameFromModelID:(NSUInteger)arg1;
+ (BOOL)adjustRanker:(id)arg1 forModel:(NSUInteger)arg2;
+ (void)adjustForConsumerSettings:(id)arg1 modelSettings:(id)arg2 andRanker:(id)arg3;
+ (NSUInteger)modelTypeForConsumerIdentifier:(id)arg1 modelSettings:(id)arg2;
...
+ (id)adviceBasedOnInteractions:(id)arg1 forContacts:(id)arg2 andRanker:(id)arg3 ignoringContacts:(id)arg4 withLimit:(NSUInteger)arg5 aggregateByIdentifier:(BOOL)arg6 requireOneOutgoingInteraction:(BOOL)arg7;
