...
- (void)dealloc;
- (_Bool)requestStatisticFromDevice:(id)arg1 statistic:(long long)arg2 forHistoryWindow:(id)arg3 error:(id *)arg4 handler:(id /* block */)arg5;
- (_Bool)requestPeerForecastFromDevice:(id)arg1 withValue:(id)arg2 forHistoryWindow:(id)arg3 forecastType:(long long)arg4 error:(id *)arg5 handler:(id /* block */)arg6;
- (_Bool)requestTemporalForecastFromDevice:(id)arg1 withValue:(id)arg2 forHistoryWindow:(id)arg3 forecastType:(long long)arg4 error:(id *)arg5 handler:(id /* block */)arg6;
...
- (_Bool)setResourceAvailabilityBlockWithError:(id *)arg1 handler:(id /* block */)arg2;
- (_Bool)setAdmissionRevocationBlockWithError:(id *)arg1 handler:(id /* block */)arg2;
...
- (_Bool)setTrendBlockForValue:(id)arg1 withConfig:(id)arg2 error:(id *)arg3 handler:(id /* block */)arg4;
- (void)admissionCheckOfValueAsync:(id)arg1 type:(long long)arg2 options:(id)arg3 handleQueue:(id)arg4 handler:(id /* block */)arg5;
- (_Bool)admissionCheckOfValue:(id)arg1 type:(long long)arg2 options:(id)arg3 error:(id *)arg4 handler:(id /* block */)arg5;
- (void)addAdmissionValidity:(id)arg1 validity:(long long)arg2;
- (long long)isAdmissionValid:(id)arg1;
- (_Bool)admissionCheckOfValue:(id)arg1 andOccurredWithValue:(id)arg2 cost:(long long)arg3 type:(long long)arg4 options:(id)arg5 error:(id *)arg6 handler:(id /* block */)arg7;
- (_Bool)admissionCheckOfValue:(id)arg1 andStartedWithValue:(id)arg2 cost:(long long)arg3 type:(long long)arg4 options:(id)arg5 error:(id *)arg6 handler:(id /* block */)arg7;
...
- (_Bool)activityWithValue:(id)arg1 cost:(long long)arg2 error:(id *)arg3 block:(id /* block */)arg4;
