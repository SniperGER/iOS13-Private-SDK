...
- (BOOL)resetAdmissionBitMask:(NSUInteger)arg1 error:(id )arg2;
- (BOOL)setAdmissionBitMask:(NSUInteger)arg1 error:(id )arg2;
...
- (id)peerForecastOfValue:(id)arg1 forHistoryWindow:(id)arg2 deviceDescription:(id)arg3 forecastType:(long long)arg4 temporalLeeway:(double)arg5 maximumElements:(NSUInteger)arg6 error:(id )arg7;
- (id)temporalForecastOfValue:(id)arg1 forHistoryWindow:(id)arg2 deviceDescription:(id)arg3 forecastType:(long long)arg4 temporalLeeway:(double)arg5 maximumElements:(NSUInteger)arg6 error:(id )arg7;
- (BOOL)reset:(long long)arg1 error:(id )arg2;
- (id)historyOfValue:(id)arg1 forWindow:(id)arg2 filter:(long long)arg3 maximumElements:(NSUInteger)arg4 error:(id )arg5;
...
- (id)peerForecastOfValue:(id)arg1 forHistoryWindow:(id)arg2 device:(id)arg3 forecastType:(long long)arg4 temporalLeeway:(double)arg5 maximumElements:(NSUInteger)arg6 error:(id )arg7;
- (id)temporalForecastOfValue:(id)arg1 forHistoryWindow:(id)arg2 device:(id)arg3 forecastType:(long long)arg4 temporalLeeway:(double)arg5 maximumElements:(NSUInteger)arg6 error:(id )arg7;
- (BOOL)meteringUpdateWithValue:(id)arg1 costDictionary:(id)arg2 onDate:(id)arg3 meteringToken:(NSUInteger)arg4 error:(id )arg5;
- (BOOL)meteringStoppedWithValue:(id)arg1 costDictionary:(id)arg2 onDate:(id)arg3 meteringToken:(NSUInteger)arg4 error:(id )arg5;
- (NSUInteger)meteringStartedWithValue:(id)arg1 costDictionary:(id)arg2 onDate:(id)arg3 error:(id )arg4;
- (NSUInteger)meteringIsActive:(id)arg1;
- (void)meteringInsertCachedToken:(id)arg1 meteringToken:(NSUInteger)arg2;
- (id)meteringLookupCachedToken:(id)arg1;
- (void)reportAccumulatedCost;
- (BOOL)accumulateCostDictionary:(id)arg1 meteringToken:(NSUInteger)arg2 date:(id)arg3;
- (id)fullNameFromString:(id)arg1 clientId:(NSUInteger)arg2 error:(id )arg3;
...
- (id)peerForecastOfValue:(id)arg1 forHistoryWindow:(id)arg2 forecastType:(long long)arg3 maximumElements:(NSUInteger)arg4 error:(id )arg5;
- (id)peerForecastXPCObjectToDictionary:(id)arg1 attributeValue:(id)arg2 error:(id )arg3;
- (id)temporalForecastOfValue:(id)arg1 forHistoryWindow:(id)arg2 forecastType:(long long)arg3 maximumElements:(NSUInteger)arg4 error:(id )arg5;
...
- (id)description;
- (id)session;
- (id)initWithMySession:(id)arg1 name:(id)arg2 type:(long long)arg3 integerId:(NSUInteger)arg4 error:(id )arg5;
- (id)initWithSession:(id)arg1 name:(id)arg2 type:(long long)arg3 integerId:(NSUInteger)arg4 error:(id )arg5;
- (id)_initWithSession:(id)arg1 name:(id)arg2 type:(long long)arg3 integerId:(NSUInteger)arg4 weak:(BOOL)arg5 error:(id )arg6;
