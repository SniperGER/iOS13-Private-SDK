...
- (NSUInteger)deleteAllEventsMatchingPredicate:(id)arg1 synchronous:(BOOL)arg2 error:(id )arg3 responseQueue:(id)arg4 withCompletion:(CDUnknownBlockType)arg5;
...
- (NSUInteger)deleteAllEventsInEventStream:(id)arg1 synchronous:(BOOL)arg2 error:(id )arg3 responseQueue:(id)arg4 withCompletion:(CDUnknownBlockType)arg5;
