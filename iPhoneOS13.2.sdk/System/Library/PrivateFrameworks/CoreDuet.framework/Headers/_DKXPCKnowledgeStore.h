...
- (id)executeQuery:(id)arg1 synchronous:(_Bool)arg2 error:(id *)arg3 responseQueue:(id)arg4 withCompletion:(id /* block */)arg5;
...
- (unsigned long long)deleteAllEventsMatchingPredicate:(id)arg1 synchronous:(_Bool)arg2 error:(id *)arg3 responseQueue:(id)arg4 withCompletion:(id /* block */)arg5;
...
- (unsigned long long)deleteAllEventsInEventStream:(id)arg1 synchronous:(_Bool)arg2 error:(id *)arg3 responseQueue:(id)arg4 withCompletion:(id /* block */)arg5;
- (_Bool)deleteObjects:(id)arg1 error:(id *)arg2;
- (void)deleteObjects:(id)arg1 responseQueue:(id)arg2 withCompletion:(id /* block */)arg3;
- (id)deleteObjects:(id)arg1 synchronous:(_Bool)arg2 responseQueue:(id)arg3 withCompletion:(id /* block */)arg4;
- (_Bool)saveObjects:(id)arg1 error:(id *)arg2;
- (void)saveObjects:(id)arg1 responseQueue:(id)arg2 withCompletion:(id /* block */)arg3;
- (id)saveObjects:(id)arg1 synchronous:(_Bool)arg2 responseQueue:(id)arg3 withCompletion:(id /* block */)arg4;
- (void)dealloc;
