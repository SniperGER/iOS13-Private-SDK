...
@interface _DKHistogramQuery : _DKQuery <_DKExecutableQuery>
{
    ...
    id /* CDUnknownBlockType */ _histogramHandler;
    NSString *_customIdentifier;
    NSUInteger _minimumOccurrencesForInclusion;
...
@property(nonatomic) NSUInteger minimumOccurrencesForInclusion; // @synthesize minimumOccurrencesForInclusion=_minimumOccurrencesForInclusion;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ histogramHandler; // @synthesize histogramHandler=_histogramHandler;
