...
- (void)_synchronizeWithUrgency:(NSUInteger)arg1 client:(id)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)synchronizeWithUrgency:(NSUInteger)arg1 client:(id)arg2 reply:(CDUnknownBlockType)arg3;
...
- (id)deletedEventIDsSinceDate:(id)arg1 streamNames:(id)arg2 limit:(NSUInteger)arg3 endDate:(id )arg4 error:(id )arg5;
