...
+ (id)predictionQueryForStreams:(id)arg1 withPredicate:(id)arg2 withPredictionType:(NSUInteger)arg3;
+ (id)predictionQueryForStream:(id)arg1 withPredicate:(id)arg2 withPredictionType:(NSUInteger)arg3;
...
@property(copy) id /* CDUnknownBlockType */ predictionHandler; // @synthesize predictionHandler=_predictionHandler;
...
@property(nonatomic) NSUInteger partitionType; // @synthesize partitionType=_partitionType;
...
- (id)predictionOfType:(NSUInteger)arg1 withData:(id)arg2;
...
- (BOOL)shouldIncludeEventWithStartDate:(id)arg1 eventSlot:(int)arg2 withPredictionStartDate:(id)arg3 withPartitionType:(NSUInteger)arg4 andCalendar:(id)arg5;
