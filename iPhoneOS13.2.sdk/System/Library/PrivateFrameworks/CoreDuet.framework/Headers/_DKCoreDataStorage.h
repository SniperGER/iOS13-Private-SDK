...
+ (NSUInteger)updateObjectsInContext:(id)arg1 entityName:(id)arg2 predicate:(id)arg3 sortDescriptors:(id)arg4 batchFetchLimit:(NSUInteger)arg5 totalFetchLimit:(NSUInteger)arg6 includeSubentities:(BOOL)arg7 updateBlock:(CDUnknownBlockType)arg8;
