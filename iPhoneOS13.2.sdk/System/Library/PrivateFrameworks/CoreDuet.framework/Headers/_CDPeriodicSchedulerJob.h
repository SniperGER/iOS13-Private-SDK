...
+ (id)jobWithInterval:(double)arg1 schedulerJobName:(id)arg2 queue:(id)arg3 asynchronousHandler:(_Bool)arg4 handler:(id /* block */)arg5;
...
@property(readonly) id /* block */ handler; // @synthesize handler=_handler;
...
- (id)initWithPeriod:(long long)arg1 interval:(double)arg2 schedulerJobName:(id)arg3 queue:(id)arg4 asynchronousHandler:(_Bool)arg5 handler:(id /* block */)arg6;
- (id)init;
