...
- (void)closeStorage;
- (NSUInteger)deleteOldInteractionsIfNeededToLimitTotalNumber:(NSUInteger)arg1 limit:(NSUInteger)arg2;
- (NSUInteger)deleteInteractionsOlderThanDate:(id)arg1 limit:(NSUInteger)arg2;
- (NSUInteger)deleteUnreferencedContacts;
- (NSUInteger)deleteUnreferencedKeywords;
- (id)interactionCountPerMechanism;
- (id)histogramContactInteractionsUsingPredicate:(id)arg1 withLimit:(NSUInteger)arg2;
- (id)queryContactInteractionsUsingPredicate:(id)arg1 withLimit:(NSUInteger)arg2;
- (NSUInteger)numberOfContactsMatchingPredicate:(id)arg1;
...
- (id)queryContactsUsingPredicate:(id)arg1 withLimit:(NSUInteger)arg2 error:(id )arg3;
- (id)queryContactsUsingPredicate:(id)arg1 sortDescriptors:(id)arg2 limit:(NSUInteger)arg3 error:(id )arg4;
- (id)queryInteractionsUsingPredicate:(id)arg1 withLimit:(NSUInteger)arg2;
...
- (id)queryInteractionsUsingPredicate:(id)arg1 sortDescriptors:(id)arg2 limit:(NSUInteger)arg3 offset:(NSUInteger)arg4 error:(id )arg5;
- (id)queryInteractionsUsingPredicate:(id)arg1 sortDescriptors:(id)arg2 limit:(NSUInteger)arg3 error:(id )arg4;
- (NSUInteger)numberOfInteractionsMatchingPredicate:(id)arg1;
