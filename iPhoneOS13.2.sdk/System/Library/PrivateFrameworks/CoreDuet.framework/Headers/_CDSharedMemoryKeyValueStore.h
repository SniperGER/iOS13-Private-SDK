...
- (_Bool)setData:(id)arg1 forKey:(id)arg2 completionBlock:(id /* block */)arg3;
- (_Bool)setData:(id)arg1 forKey:(id)arg2;
- (_Bool)asyncPersistToShMemWithCompletionBlock:(id /* block */)arg1;
- (_Bool)persistToShMemWithCompletionBlock:(id /* block */)arg1;
