...
+ (id)eventQueryWithPredicate:(id)arg1 eventStreams:(id)arg2 offset:(NSUInteger)arg3 limit:(NSUInteger)arg4 sortDescriptors:(id)arg5 resultHandler:(CDUnknownBlockType)arg6;
+ (void)load;
...
- (id)init;
- (id)initWithPredicate:(id)arg1 eventStreams:(id)arg2 offset:(NSUInteger)arg3 limit:(NSUInteger)arg4 sortDescriptors:(id)arg5 resultHandler:(CDUnknownBlockType)arg6;
