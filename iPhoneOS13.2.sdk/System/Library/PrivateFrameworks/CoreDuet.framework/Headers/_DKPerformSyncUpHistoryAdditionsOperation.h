...
+ (void)_updateEventStatsWithTotal:(NSUInteger)arg1 streamNameCounts:(id)arg2 transportType:(long long)arg3;
...
- (void)endOperation;
- (void)handleUpdateStorageWithFetchedWindow:(id)arg1 eventsCount:(NSUInteger)arg2 error:(id)arg3;
