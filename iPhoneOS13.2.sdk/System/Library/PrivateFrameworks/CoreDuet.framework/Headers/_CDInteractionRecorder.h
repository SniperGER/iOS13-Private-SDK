...
- (void)deleteInteractionsWithBundleId:(id)arg1 synchronous:(_Bool)arg2 domainIdentifier:(id)arg3 completionHandler:(id /* block */)arg4;
...
- (void)deleteInteractionsWithBundleId:(id)arg1 synchronous:(_Bool)arg2 account:(id)arg3 completionHandler:(id /* block */)arg4;
...
- (void)deleteInteractionsWithBundleId:(id)arg1 synchronous:(_Bool)arg2 completionHandler:(id /* block */)arg3;
...
- (void)deleteInteractionsMatchingPredicate:(id)arg1 synchronous:(_Bool)arg2 sortDescriptors:(id)arg3 limit:(unsigned long long)arg4 completionHandler:(id /* block */)arg5;
...
- (void)countContactsUsingPredicate:(id)arg1 synchronous:(_Bool)arg2 completionHandler:(id /* block */)arg3;
...
- (void)queryContactsUsingPredicate:(id)arg1 synchronous:(_Bool)arg2 sortDescriptors:(id)arg3 limit:(unsigned long long)arg4 completionHandler:(id /* block */)arg5;
...
- (void)countInteractionsUsingPredicate:(id)arg1 synchronous:(_Bool)arg2 completionHandler:(id /* block */)arg3;
...
- (void)queryInteractionsUsingPredicate:(id)arg1 synchronous:(_Bool)arg2 sortDescriptors:(id)arg3 limit:(unsigned long long)arg4 completionHandler:(id /* block */)arg5;
...
- (_Bool)recordInteractions:(id)arg1 synchronous:(_Bool)arg2 completionHandler:(id /* block */)arg3;
- (void)dealloc;
