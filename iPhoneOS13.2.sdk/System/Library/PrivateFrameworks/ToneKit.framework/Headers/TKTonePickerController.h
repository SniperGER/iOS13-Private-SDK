...
@interface TKTonePickerController : NSObject <TLToneStoreDownloadObserver>
{
    ...
    NSUInteger __selectedClassicRingtoneIndex;
    NSUInteger __selectedClassicAlertToneIndex;
...
@property(nonatomic, setter=_setSelectedClassicAlertToneIndex:) NSUInteger _selectedClassicAlertToneIndex; // @synthesize _selectedClassicAlertToneIndex=__selectedClassicAlertToneIndex;
@property(nonatomic, setter=_setSelectedClassicRingtoneIndex:) NSUInteger _selectedClassicRingtoneIndex; // @synthesize _selectedClassicRingtoneIndex=__selectedClassicRingtoneIndex;
...
- (NSUInteger)_indexOfMediaItemWithIdentifier:(id)arg1;
- (id)_identifierOfMediaItemAtIndex:(NSUInteger)arg1;
...
- (void)_cacheToneClassicsPickerItem:(id)arg1 forIndex:(long long)arg2 headerKind:(NSUInteger)arg3;
- (id)_cachedToneClassicsPickerItemForIndex:(long long)arg1 headerKind:(NSUInteger)arg2;
