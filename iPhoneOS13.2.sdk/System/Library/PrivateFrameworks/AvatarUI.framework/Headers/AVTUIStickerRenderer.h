...
- (void)saveImageForResource:(id)arg1 forScope:(id)arg2 synchronous:(_Bool)arg3 completionHandler:(id /* block */)arg4;
- (id /* block */)providerForResourceForScope:(id)arg1 queue:(id)arg2 renderingHandler:(id /* block */)arg3;
- (id /* block */)scheduledTaskForItem:(id)arg1 scope:(id)arg2 queue:(id)arg3 renderingHandler:(id /* block */)arg4 resourceHandler:(id /* block */)arg5 synchronous:(_Bool)arg6;
