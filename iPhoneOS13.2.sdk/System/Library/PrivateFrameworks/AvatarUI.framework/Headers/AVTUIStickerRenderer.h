...
- (CDUnknownBlockType)scheduledTaskForItem:(id)arg1 scope:(id)arg2 queue:(id)arg3 renderingHandler:(CDUnknownBlockType)arg4 resourceHandler:(CDUnknownBlockType)arg5 synchronous:(BOOL)arg6;
