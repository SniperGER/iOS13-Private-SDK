...
@interface AVTAvatarRecordDataSource : NSObject <AVTAvatarStoreDelegate, AVTAvatarRecordDataSourceInternal, AVTAvatarRecordDataSource>
{
    ...
    id  _nts_changeNotificationObserver;
}
...
@property(retain, nonatomic) id  nts_changeNotificationObserver; // @synthesize nts_changeNotificationObserver=_nts_changeNotificationObserver;
