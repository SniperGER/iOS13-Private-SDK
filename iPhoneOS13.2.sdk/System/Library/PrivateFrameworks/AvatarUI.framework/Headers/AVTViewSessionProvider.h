...
@property(readonly, copy, nonatomic) id /* block */ viewCreator; // @synthesize viewCreator=_viewCreator;
...
- (void)dealloc;
- (id)initWithAVTViewBackingSize:(struct CGSize)arg1 viewCreator:(id /* block */)arg2 environment:(id)arg3;
