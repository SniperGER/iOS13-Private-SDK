...
- (id /* block */)_providerForAvatar:(id)arg1 forRecord:(id)arg2 scope:(id)arg3 usingCache:(_Bool)arg4;
- (id /* block */)_providerForRecord:(id)arg1 scope:(id)arg2;
- (id /* block */)providerForAvatar:(id)arg1 forRecord:(id)arg2 scope:(id)arg3 usingCache:(_Bool)arg4;
