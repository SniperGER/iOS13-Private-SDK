...
@property(copy, nonatomic) id /* block */ userRequestedBackupActivityCompletion; // @synthesize userRequestedBackupActivityCompletion=_userRequestedBackupActivityCompletion;
@property(copy, nonatomic) id /* block */ migrationActivityCompletion; // @synthesize migrationActivityCompletion=_migrationActivityCompletion;
...
@property(readonly, copy, nonatomic) id /* block */ migratorProvider; // @synthesize migratorProvider=_migratorProvider;
...
- (_Bool)processInternalSettingsChanges:(id /* block */)arg1;
