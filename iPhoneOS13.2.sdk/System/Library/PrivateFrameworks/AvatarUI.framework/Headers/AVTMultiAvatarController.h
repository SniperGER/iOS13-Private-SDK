...
- (void)transitionCell:(id)arg1 toStopFocusingAnimated:(_Bool)arg2 completionHandler:(id /* block */)arg3;
- (void)transitionCell:(id)arg1 indexPath:(id)arg2 toStartFocusingAnimated:(_Bool)arg3 session:(id)arg4 completionHandler:(id /* block */)arg5;
...
- (void)prepareToTransitionToVisible:(_Bool)arg1 completionHandler:(id /* block */ *)arg2;
- (void)stopUsingAVTViewSessionSynchronously:(_Bool)arg1 completionHandler:(id /* block */)arg2;
