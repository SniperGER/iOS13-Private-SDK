...
@property(readonly, copy, nonatomic) id /* block */ timeProvider; // @synthesize timeProvider=_timeProvider;
...
@property(readonly, copy, nonatomic) id /* block */ recordTransformer; // @synthesize recordTransformer=_recordTransformer;
