...
@interface AVTUsageTrackingSession : NSObject <AVTUsageTrackingSession>
{
    ...
    id /* CDUnknownBlockType */ _recordTransformer;
    AVTAvatarConfiguration *_defaultConfiguration;
    AVTAvatarRecord *_avatarRecord;
    id /* CDUnknownBlockType */ _timeProvider;
...
@property(readonly, copy, nonatomic) id /* CDUnknownBlockType */ timeProvider; // @synthesize timeProvider=_timeProvider;
...
@property(readonly, copy, nonatomic) id /* CDUnknownBlockType */ recordTransformer; // @synthesize recordTransformer=_recordTransformer;
