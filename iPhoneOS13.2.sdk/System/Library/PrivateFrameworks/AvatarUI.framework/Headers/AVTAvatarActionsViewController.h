...
- (void)performTransitionAfterDeleteToRecord:(id)arg1 fromLeft:(_Bool)arg2 previousRecordImage:(id)arg3 completionBlock:(id /* block */)arg4;
...
- (void)dismissEditorViewController:(id)arg1 forActionsModel:(id)arg2 wasCreate:(_Bool)arg3 didEdit:(_Bool)arg4 animated:(_Bool)arg5 completion:(id /* block */)arg6;
