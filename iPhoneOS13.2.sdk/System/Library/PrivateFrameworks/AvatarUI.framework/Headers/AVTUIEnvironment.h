...
@property(readonly, nonatomic) CGSize mainScreenSize; // @synthesize mainScreenSize=_mainScreenSize;
...
@property(readonly, copy, nonatomic) id /* CDUnknownBlockType */ lockProvider;
@property(readonly, copy, nonatomic) id /* CDUnknownBlockType */ serialQueueProvider;
