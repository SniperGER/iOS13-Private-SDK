...
- (void)logTransition:(NSString *)arg1 state:(NSUInteger)arg2 reachedStage:(NSUInteger)arg3;
...
- (void)logDiscoveredDuplicates:(NSString *)arg1 count:(NSUInteger)arg2;
...
- (void)logTrackerProcessingChanges:(NSString *)arg1 count:(NSUInteger)arg2 from:(NSString *)arg3;
...
- (void)logRequestingThumbnailForIndex:(NSUInteger)arg1 section:(NSString *)arg2;
...
- (void)logRequestingPreLoadingTask:(NSString *)arg1 forIndex:(NSUInteger)arg2 section:(NSUInteger)arg3;
...
- (void)logImageStoreCacheHitForItemDescription:(NSString *)arg1 sizeCost:(NSUInteger)arg2;
...
- (void)logRenderingRecord:(NSString *)arg1 size:(CGSize)arg2;
