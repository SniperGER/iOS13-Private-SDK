...
@property(copy, nonatomic) id /* block */ pendingCollectionViewReloadDataBlock; // @synthesize pendingCollectionViewReloadDataBlock=_pendingCollectionViewReloadDataBlock;
...
@property(copy, nonatomic) id /* block */ pendingUnhighlightBlock; // @synthesize pendingUnhighlightBlock=_pendingUnhighlightBlock;
...
@property(copy, nonatomic) id /* block */ postSessionDidBecomeActiveHandler; // @synthesize postSessionDidBecomeActiveHandler=_postSessionDidBecomeActiveHandler;
...
- (void)updateImageViewWithPosedAvatarRecordForcingRender:(_Bool)arg1 completionHandler:(id /* block */)arg2;
