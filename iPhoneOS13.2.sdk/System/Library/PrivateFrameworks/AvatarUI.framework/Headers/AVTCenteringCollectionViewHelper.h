...
+ (id)indexPathForItemBeingScrolledTowardFromOffset:(struct CGPoint)arg1 currentOffset:(struct CGPoint)arg2 nearestItemToCenter:(id)arg3 itemCount:(unsigned long long)arg4 itemOffsetProvider:(id /* block */)arg5 ratio:(double *)arg6;
