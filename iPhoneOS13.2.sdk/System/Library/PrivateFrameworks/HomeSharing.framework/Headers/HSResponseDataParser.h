...
+ (id)_parseListingCollectionWithBytes:(const char )arg1 length:(NSUInteger)arg2 usingHandler:(CDUnknownBlockType)arg3;
+ (id)_parseItemsResponseWithBytes:(const char )arg1 length:(NSUInteger)arg2 usingHandler:(CDUnknownBlockType)arg3;
...
+ (id)_parseResponseCode:(unsigned int)arg1 bytes:(const char )arg2 length:(NSUInteger)arg3 usingHandler:(CDUnknownBlockType)arg4;
...
+ (void)parseItemWithBytes:(const char )arg1 length:(NSUInteger)arg2 usingHandler:(CDUnknownBlockType)arg3;
