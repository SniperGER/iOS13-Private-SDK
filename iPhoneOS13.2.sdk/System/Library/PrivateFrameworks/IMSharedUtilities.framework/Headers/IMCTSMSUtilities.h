...
+ (NSUInteger)IMiMessageMaxTransferVideoFileSizeForWifiForPhoneNumber:(NSUInteger )arg1 cellSize:(NSUInteger )arg2 serverConfigurationBag:(id)arg3 phoneNumber:(id)arg4 simID:(id)arg5;
+ (NSUInteger)IMiMessageMaxTransferAudioFileSizeForWifiForPhoneNumber:(NSUInteger )arg1 cellSize:(NSUInteger )arg2 serverConfigurationBag:(id)arg3 phoneNumber:(id)arg4 simID:(id)arg5;
+ (void)IMiMessageMaxTransferFileSizeForWifiForPhoneNumber:(NSUInteger )arg1 cellSize:(NSUInteger )arg2 serverConfigurationBag:(id)arg3 phoneNumber:(id)arg4 simID:(id)arg5;
...
+ (NSUInteger)IMReadAttachmentPreviewTranscodingQualitySizeCarrierValueForPhoneNumber:(id)arg1 simID:(id)arg2;
