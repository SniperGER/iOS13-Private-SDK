...
@interface IMFileTransfer : NSObject
{
    ...
    NSUInteger _averageTransferRate;
    long long _error;
...
@property(nonatomic) NSUInteger averageTransferRate; // @synthesize averageTransferRate=_averageTransferRate;
@property(nonatomic) NSUInteger totalBytes; // @synthesize totalBytes=_totalBytes;
@property(nonatomic) NSUInteger currentBytes; // @synthesize currentBytes=_currentBytes;
...
@property(readonly, nonatomic) NSUInteger _lastAveragedBytes; // @synthesize _lastAveragedBytes;
...
- (void)_setAveragedTransferRate:(NSUInteger)arg1 lastAveragedInterval:(double)arg2 lastAveragedBytes:(NSUInteger)arg3;
- (void)_setCurrentBytes:(NSUInteger)arg1 totalBytes:(NSUInteger)arg2;
- (void)_setAccount:(id)arg1 otherPerson:(id)arg2;
- (id)_initWithGUID:(id)arg1 filename:(id)arg2 isDirectory:(BOOL)arg3 localURL:(id)arg4 account:(id)arg5 otherPerson:(id)arg6 totalBytes:(NSUInteger)arg7 hfsType:(unsigned int)arg8 hfsCreator:(unsigned int)arg9 hfsFlags:(unsigned short)arg10 isIncoming:(BOOL)arg11;
- (id)init;
- (void)dealloc;
