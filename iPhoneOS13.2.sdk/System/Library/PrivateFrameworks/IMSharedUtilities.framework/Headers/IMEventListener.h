...
@property(copy) id /* block */ didInvokeCompletion; // @synthesize didInvokeCompletion=_didInvokeCompletion;
@property(copy) id /* block */ willInvokeCompletion; // @synthesize willInvokeCompletion=_willInvokeCompletion;
