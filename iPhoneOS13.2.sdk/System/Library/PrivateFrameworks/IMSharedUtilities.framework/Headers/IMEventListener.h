...
@interface IMEventListener : NSObject
{
    ...
    id /* CDUnknownBlockType */ _willInvokeCompletion;
    id /* CDUnknownBlockType */ _didInvokeCompletion;
}
...
@property(copy) id /* CDUnknownBlockType */ didInvokeCompletion; // @synthesize didInvokeCompletion=_didInvokeCompletion;
@property(copy) id /* CDUnknownBlockType */ willInvokeCompletion; // @synthesize willInvokeCompletion=_willInvokeCompletion;
@property __weak id target; // @synthesize target=_target;
@property(readonly) NSUInteger eventCount; // @synthesize eventCount=_eventCount;
