...
- (void)animateToViewScale:(double)arg1 contentOffset:(CGPoint)arg2 duration:(double)arg3 forceAnimation:(BOOL)arg4 completion:(CDUnknownBlockType)arg5;
- (void)animateToViewScale:(double)arg1 contentOffset:(CGPoint)arg2 duration:(double)arg3 completion:(CDUnknownBlockType)arg4;
...
@property(nonatomic) CGColorRef selectionHighlightColor;
...
- (void)setContentOffset:(CGPoint)arg1 clamp:(BOOL)arg2 animated:(BOOL)arg3 completionBlock:(CDUnknownBlockType)arg4;
...
- (void)setViewScale:(double)arg1 contentOffset:(CGPoint)arg2 clampOffset:(BOOL)arg3 animationDuration:(double)arg4 forceAnimation:(BOOL)arg5 completion:(CDUnknownBlockType)arg6;
- (void)setViewScale:(double)arg1 contentOffset:(CGPoint)arg2 clampOffset:(BOOL)arg3 animationDuration:(double)arg4 completion:(CDUnknownBlockType)arg5;
