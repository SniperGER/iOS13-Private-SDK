...
- (void)animateToViewScale:(double)arg1 contentOffset:(struct CGPoint)arg2 duration:(double)arg3 forceAnimation:(_Bool)arg4 completion:(id /* block */)arg5;
- (void)animateToViewScale:(double)arg1 contentOffset:(struct CGPoint)arg2 duration:(double)arg3 completion:(id /* block */)arg4;
...
- (_Bool)backgroundLayoutAndRenderState:(id)arg1 shouldDispatchBackgroundWork:(id /* block */)arg2;
...
- (id)hitRep:(struct CGPoint)arg1 withGesture:(id)arg2 passingTest:(id /* block */)arg3;
...
- (void)setContentOffset:(struct CGPoint)arg1 clamp:(_Bool)arg2 animated:(_Bool)arg3 completionBlock:(id /* block */)arg4;
...
- (void)setViewScale:(double)arg1 contentOffset:(struct CGPoint)arg2 clampOffset:(_Bool)arg3 animationDuration:(double)arg4 forceAnimation:(_Bool)arg5 completion:(id /* block */)arg6;
- (void)setViewScale:(double)arg1 contentOffset:(struct CGPoint)arg2 clampOffset:(_Bool)arg3 animationDuration:(double)arg4 completion:(id /* block */)arg5;
...
- (id)beginEditingRep:(id)arg1 clearingSelection:(_Bool)arg2 withEditorProvider:(id /* block */)arg3;
