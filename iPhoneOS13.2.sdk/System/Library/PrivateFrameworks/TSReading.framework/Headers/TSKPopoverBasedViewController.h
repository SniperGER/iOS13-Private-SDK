...
@class TSKHideOnTouchOutsideViewGestureRecognizer, TSKModalShieldView, TSKPopoverController, UIView;
...
@interface TSKPopoverBasedViewController : UIViewController <TSKModalShieldDelegate, UIPopoverControllerDelegate, UINavigationControllerDelegate, TSKPopoverBasedViewControllerDismissible, TSKKeyboardObserver>
{
    ...
    id /* CDUnknownBlockType */ mHalfHeightCloseBlock;
...
- (void)showPopoverFromRect:(CGRect)arg1 inView:(id)arg2 arrowDirection:(NSUInteger)arg3 animated:(BOOL)arg4 constrainToView:(BOOL)arg5 withPadding:(double)arg6 fromToolbar:(BOOL)arg7;
- (void)showPopoverFromRect:(CGRect)arg1 inView:(id)arg2 arrowDirection:(NSUInteger)arg3 animated:(BOOL)arg4;
...
- (void)presentInRect:(CGRect)arg1 inView:(id)arg2 animated:(BOOL)arg3 modal:(BOOL)arg4 closeBlock:(CDUnknownBlockType)arg5 animations:(CDUnknownBlockType)arg6;
- (void)presentInRect:(CGRect)arg1 inView:(id)arg2 animated:(BOOL)arg3 modal:(BOOL)arg4 closeBlock:(CDUnknownBlockType)arg5;
...
- (void)presentModallyFromRect:(CGRect)arg1 inView:(id)arg2 viewController:(id)arg3 arrowDirection:(NSUInteger)arg4 animated:(BOOL)arg5 withDoneButton:(BOOL)arg6 constrainToView:(BOOL)arg7 withPadding:(double)arg8 fromToolbar:(BOOL)arg9;
- (void)presentModallyFromRect:(CGRect)arg1 inView:(id)arg2 viewController:(id)arg3 arrowDirection:(NSUInteger)arg4 animated:(BOOL)arg5 withDoneButton:(BOOL)arg6;
- (void)presentModallyFromRect:(CGRect)arg1 inView:(id)arg2 viewController:(id)arg3 arrowDirection:(NSUInteger)arg4 animated:(BOOL)arg5;
