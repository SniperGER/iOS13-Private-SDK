...
- (void)presentInRect:(struct CGRect)arg1 inView:(id)arg2 animated:(_Bool)arg3 modal:(_Bool)arg4 closeBlock:(id /* block */)arg5 animations:(id /* block */)arg6;
- (void)presentInRect:(struct CGRect)arg1 inView:(id)arg2 animated:(_Bool)arg3 modal:(_Bool)arg4 closeBlock:(id /* block */)arg5;
