...
- (void)animateToViewScale:(double)arg1 contentCenter:(CGPoint)arg2 contentInset:(UIEdgeInsets)arg3 duration:(double)arg4 animation:(id)arg5 completionBlock:(CDUnknownBlockType)arg6;
- (void)animateToViewScale:(double)arg1 contentCenter:(CGPoint)arg2 contentInset:(UIEdgeInsets)arg3 duration:(double)arg4 completionBlock:(CDUnknownBlockType)arg5;
