...
@property(nonatomic) CGSize maximumPartitionSize; // @synthesize maximumPartitionSize=mMaximumPartitionSize;
...
// - (UIEdgeInsets)defaultPaddingForCellID:(CDStruct_0441cfb5)arg1;
// - (UIEdgeInsets)paddingForCellID:(CDStruct_0441cfb5)arg1;
...
// - (id)validateCellForDrawing:(CDStruct_0441cfb5)arg1 cell:(id)arg2 contents:(id)arg3 wrap:(BOOL)arg4 verticalAlignment:(unsigned int)arg5 padding:(id)arg6 layoutCacheFlags:(int)arg7 pageNumber:(NSUInteger)arg8 pageCount:(NSUInteger)arg9;
