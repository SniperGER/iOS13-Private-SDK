...
+ (BOOL)searchReference:(id)arg1 isAfterSearchReference:(id)arg2 orEqual:(BOOL)arg3 inDirection:(NSUInteger)arg4 comparator:(CDUnknownBlockType)arg5;
+ (BOOL)searchReference:(id)arg1 isBeforeSearchReference:(id)arg2 orEqual:(BOOL)arg3 inDirection:(NSUInteger)arg4 comparator:(CDUnknownBlockType)arg5;
+ (BOOL)p_searchReference:(id)arg1 comparedWithSearchReference:(id)arg2 orEqual:(BOOL)arg3 inDirection:(NSUInteger)arg4 before:(BOOL)arg5 comparator:(CDUnknownBlockType)arg6;
+ (void)_recursiveSearchWithSearchTarget:(id)arg1 forAnnotationsWithHitBlock:(CDUnknownBlockType)arg2;
+ (void)_recursiveSearchWithSearchTarget:(id)arg1 forString:(id)arg2 options:(NSUInteger)arg3 hitBlock:(CDUnknownBlockType)arg4;
