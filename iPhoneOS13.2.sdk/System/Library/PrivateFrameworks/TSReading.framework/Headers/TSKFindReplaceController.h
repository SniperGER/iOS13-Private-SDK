...
+ (_Bool)searchReference:(id)arg1 isAfterSearchReference:(id)arg2 orEqual:(_Bool)arg3 inDirection:(unsigned long long)arg4 comparator:(id /* block */)arg5;
+ (_Bool)searchReference:(id)arg1 isBeforeSearchReference:(id)arg2 orEqual:(_Bool)arg3 inDirection:(unsigned long long)arg4 comparator:(id /* block */)arg5;
+ (_Bool)p_searchReference:(id)arg1 comparedWithSearchReference:(id)arg2 orEqual:(_Bool)arg3 inDirection:(unsigned long long)arg4 before:(_Bool)arg5 comparator:(id /* block */)arg6;
...
@property(copy, nonatomic) id /* block */ searchResultComparator; // @synthesize searchResultComparator=_searchResultComparator;
