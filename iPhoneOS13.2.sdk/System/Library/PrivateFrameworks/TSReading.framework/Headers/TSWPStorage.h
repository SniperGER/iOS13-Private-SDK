...
- (id)smartFieldsWithAttributeKind:(unsigned int)arg1 intersectingRange:(struct _NSRange)arg2 passingTest:(id /* block */)arg3;
- (void)enumerateSmartFieldsWithAttributeKind:(unsigned int)arg1 inRange:(struct _NSRange)arg2 usingBlock:(id /* block */)arg3;
- (void)enumerateWithAttributeKind:(unsigned int)arg1 inRange:(struct _NSRange)arg2 usingBlock:(id /* block */)arg3;
...
- (id)searchInRange:(struct _NSRange)arg1 forString:(id)arg2 options:(unsigned long long)arg3 onHit:(id /* block */)arg4;
- (id)searchForString:(id)arg1 options:(unsigned long long)arg2 onHit:(id /* block */)arg3;
- (struct _NSRange)rangeForHighlight:(id)arg1;
- (void)findChangesInRange:(struct _NSRange)arg1 onHit:(id /* block */)arg2;
- (void)p_findChangesInRange:(struct _NSRange)arg1 onHit:(id /* block */)arg2 withAttributeKind:(unsigned int)arg3;
- (void)findCommentsInRange:(struct _NSRange)arg1 onHit:(id /* block */)arg2;
