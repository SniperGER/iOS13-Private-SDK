...
- (id)allValues;
- (long long)count;
- (void)transformWithFunction:(/* void * CDUnknownFunctionPointerType */)arg1 withState:(void )arg2;
- (void)applyFunction:(/* void * CDUnknownFunctionPointerType */)arg1 withState:(void )arg2 andState:(void )arg3;
- (void)applyFunction:(/* void * CDUnknownFunctionPointerType */)arg1 withState:(void )arg2;
