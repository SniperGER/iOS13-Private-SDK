...
@class NSDictionary, NSObject, TSDTextInputTokenizer, TSDTextPosition, UITextPosition, UITextRange, UIView;
...
- (void)editorDidChangeSelection:(id)arg1 withFlags:(NSUInteger)arg2;
