...
// - (void)addAllDictationInterpretationRangesInRange:(NSRange *)arg1 toRanges:(struct TSWPRangeVector )arg2;
- (id)dictationInterpretationsAtCharIndex:(NSUInteger)arg1 outRange:(NSRange * )arg2;
- (void)p_removeAutocorrectionAtCharIndex:(NSUInteger)arg1;
- (int)valueForWritingDirectionPropertyForInspector:(id)arg1;
- (id)p_previousAutocorrectionForWordAtCharIndex:(NSUInteger)arg1 outRange:(NSRange * )arg2;
...
- (NSUInteger)p_MoveByLineRange:(NSRange *)arg1 up:(BOOL)arg2;
...
- (NSRange *)tsax_rangeOfLineFragmentAtCharIndex:(NSUInteger)arg1;
...
// - (int)p_moveFromCharIndex:(NSUInteger )arg1 tokenizerRef:(struct __CFStringTokenizer )arg2 tokenizerRange:(NSRange * )arg3 direction:(long long)arg4 currentWordRange:(NSRange *)arg5 newWordRange:(NSRange * )arg6 reasonToStop:(unsigned int)arg7;
// - (struct __CFStringTokenizer )p_createTokenizerForCharIndex:(NSUInteger)arg1 outTokenizerRange:(NSRange * )arg2;
...
// - (NSRange *)p_expandParagraphRangeForEnumerator:(struct TSWPParagraphEnumerator )arg1;
