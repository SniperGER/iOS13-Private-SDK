...
+ (BOOL)tsp_coordinateReadingItemAtURL:(id)arg1 options:(NSUInteger)arg2 writingItemAtURL:(id)arg3 options:(NSUInteger)arg4 filePresenter:(id)arg5 error:(id )arg6 byAccessor:(CDUnknownBlockType)arg7;
+ (BOOL)tsp_coordinateReadingItemAtURL:(id)arg1 options:(NSUInteger)arg2 filePresenter:(id)arg3 error:(id )arg4 byAccessor:(CDUnknownBlockType)arg5;
