...
- (id)dataWithStorage:(id)arg1 digest:(const array_019f9a10 *)arg2 filename:(id)arg3 skipDocumentResourcesLookup:(_Bool)arg4 accessorBlock:(id /* block */)arg5;
- (void)dataForDigest:(const array_019f9a10 *)arg1 queue:(id)arg2 completion:(id /* block */)arg3;
- (id)dataForDigest:(const array_019f9a10 *)arg1;
- (id)dataForDigestImpl:(const array_019f9a10 *)arg1 skipDocumentResourcesLookup:(_Bool)arg2 accessorBlock:(id /* block */)arg3;
- (id)dataForDigestImpl:(const array_019f9a10 *)arg1 accessorBlock:(id /* block */)arg2;
...
- (void)findExistingDataForReadChannel:(id)arg1 dataURL:(id)arg2 temporaryPath:(id)arg3 shouldWriteIfFound:(_Bool)arg4 completion:(id /* block */)arg5;
