...
- (void)editorDidChangeSelectionAndWantsKeyboard:(id)arg1 withSelectionFlags:(NSUInteger)arg2;
- (void)editorSelectionWasForciblyChanged:(id)arg1;
- (void)editorDidChangeSelection:(id)arg1 withSelectionFlags:(NSUInteger)arg2;
