...
- (void)layoutSearchForString:(id)arg1 options:(NSUInteger)arg2 hitBlock:(CDUnknownBlockType)arg3;
...
- (void)bezierPathsForCellRegion:(id)arg1 transform:(CGAffineTransform)arg2 viewScale:(double)arg3 inset:(double)arg4 block:(CDUnknownBlockType)arg5;
- (void)invalidateSize;
- (void)invalidate;
