...
- (void)layoutSearchForSpellingErrorsWithHitBlock:(id /* block */)arg1 stop:(_Bool *)arg2;
...
- (void)bezierPathsForCellRegion:(id)arg1 transform:(struct CGAffineTransform)arg2 viewScale:(double)arg3 inset:(double)arg4 block:(id /* block */)arg5;
- (void)invalidateSize;
- (void)invalidate;
