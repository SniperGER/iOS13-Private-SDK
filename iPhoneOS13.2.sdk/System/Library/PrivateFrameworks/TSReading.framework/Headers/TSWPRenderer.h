...
// - (void)p_drawTextInRunsForLine:(struct __CTLine )arg1 fragment:(const struct TSWPLineFragment )arg2 state:(const struct TSWPDrawingState )arg3 tateChuYoko:(BOOL)arg4 baseRange:(NSRange *)arg5 isFirstLineRef:(BOOL)arg6;
...
// - (void)p_drawWordMarkingsForFragment:(const struct TSWPLineFragment )arg1 color:(id)arg2 ranges:(const struct TSWPRangeVector )arg3 suppressRange:(NSRange *)arg4 drawingState:(const struct TSWPDrawingState )arg5;
