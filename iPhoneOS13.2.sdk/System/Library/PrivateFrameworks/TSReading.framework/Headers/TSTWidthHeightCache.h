...
// - (BOOL)verifyDims:(CGSize)arg1 forCellID:(CDStruct_0441cfb5)arg2;
...
- (NSUInteger)resetAllInvalidColsInRow:(unsigned short)arg1;
...
// - (BOOL)setFitDims:(CGSize)arg1 forCellID:(CDStruct_0441cfb5)arg2;
- (void)dealloc;
