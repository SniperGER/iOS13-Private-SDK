...
- (void)p_setButtonAttributedTitle:(id)arg1 color:(id)arg2 forState:(NSUInteger)arg3 button:(id)arg4;
...
- (NSUInteger)segmentWithTag:(long long)arg1;
- (long long)tagForSegment:(NSUInteger)arg1;
- (void)setTag:(long long)arg1 forSegment:(NSUInteger)arg2;
- (void)setBackgroundImage:(id)arg1 forState:(NSUInteger)arg2 forSegment:(NSUInteger)arg3;
