...
- (CGRect)coachingTipManager:(APDCoachingTipsManager *)arg1 coachingTipView:(APDCoachingTipView *)arg2 canvasRectForKey:(NSString *)arg3;
...
- (CGRect)zoomRectForSelection:(TSKSelection *)arg1;
...
- (void)setSelection:(TSKSelection *)arg1 withFlags:(NSUInteger)arg2;
- (void)teardown;
- (id <TSKModel>)model;
@end
