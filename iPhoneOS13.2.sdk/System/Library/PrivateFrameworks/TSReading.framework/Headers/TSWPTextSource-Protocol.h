...
- (NSArray *)smartFieldsWithAttributeKind:(unsigned int)arg1 intersectingRange:(NSRange *)arg2;
- (double)filteredCoreTextAttributesFontScaleEffectiveRange:(NSRange * )arg1 filterDelegate:(id <TSWPCoreTextPropertiesFilterDelegate>)arg2;
// - (struct __CFDictionary )createFilteredCoreTextAttributes:(struct __CFDictionary )arg1 effectiveRange:(NSRange * )arg2 filterDelegate:(id <TSWPCoreTextPropertiesFilterDelegate>)arg3;
- (TSWPSmartField *)smartFieldAtCharIndex:(NSUInteger)arg1 attributeKind:(unsigned int)arg2 effectiveRange:(NSRange * )arg3;
...
- (void)enumerateWithAttributeKind:(unsigned int)arg1 inRange:(NSRange *)arg2 usingBlock:(void (^)(id, NSRange *, BOOL ))arg3;
- (void)enumerateSmartFieldsWithAttributeKind:(unsigned int)arg1 inRange:(NSRange *)arg2 usingBlock:(void (^)(id, NSRange *, BOOL ))arg3;
