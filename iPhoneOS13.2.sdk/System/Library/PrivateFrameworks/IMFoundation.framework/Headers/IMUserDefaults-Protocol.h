...
- (void)setAppBool:(_Bool)arg1 forKey:(NSString *)arg2;
- (_Bool)appBoolForKey:(NSString *)arg1;
- (void)removeAppValueForKey:(NSString *)arg1;
- (void)setAppValue:(id)arg1 forKey:(NSString *)arg2;
- (id)appValueForKey:(NSString *)arg1;
- (void)setAppBool:(_Bool)arg1 byHostForKey:(NSString *)arg2;
- (_Bool)appBoolByHostForKey:(NSString *)arg1;
@end
