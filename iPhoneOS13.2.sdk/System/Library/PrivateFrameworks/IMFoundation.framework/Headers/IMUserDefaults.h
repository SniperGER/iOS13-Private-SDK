...
+ (void)setEnableEngram:(_Bool)arg1;
+ (id)sharedDefaults;
...
- (void)setAppBool:(_Bool)arg1 forKey:(id)arg2;
- (_Bool)appBoolForKey:(id)arg1;
- (void)removeAppValueForKey:(id)arg1;
- (void)setAppValue:(id)arg1 forKey:(id)arg2;
- (id)appValueForKey:(id)arg1;
- (void)setAppBool:(_Bool)arg1 byHostForKey:(id)arg2;
- (_Bool)appBoolByHostForKey:(id)arg1;
