...
@class CADisplayLink, FMAnnotationView, FMMapGestureRecognizer, MKMapCamera, MKMapView, MKUserLocation, MKUserLocationView, NSMutableArray, NSTimer, UIColor, _MKUserTrackingButton;
...
@property(nonatomic) UIEdgeInsets lastVisibleInsets; // @synthesize lastVisibleInsets=_lastVisibleInsets;
...
//  (void)moveCenterByOffset:(CGPoint)arg1 from:(struct CLLocationCoordinate2D)arg2;
...
// - (void)animateMapToPosition:(CDStruct_02837cd9)arg1 withInsets:(UIEdgeInsets)arg2 attributionInsets:(UIEdgeInsets)arg3 andZoom:(BOOL)arg4;
