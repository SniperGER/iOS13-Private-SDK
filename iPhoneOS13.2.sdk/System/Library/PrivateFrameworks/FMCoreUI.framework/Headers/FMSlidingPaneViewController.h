...
- (void)presentPaneViewController:(id)arg1 fromEdge:(NSUInteger)arg2 withPercent:(double)arg3 completion:(CDUnknownBlockType)arg4;
- (void)presentPaneViewController:(id)arg1 fromEdge:(NSUInteger)arg2 animated:(BOOL)arg3 completion:(CDUnknownBlockType)arg4;
