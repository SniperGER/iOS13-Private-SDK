...
- (void)_crossDissolveOldPaneState:(id)arg1 newPaneState:(id)arg2 animated:(_Bool)arg3 completion:(id /* block */)arg4;
- (void)_dismissPaneState:(id)arg1 animated:(_Bool)arg2 completion:(id /* block */)arg3;
- (void)_presentPaneState:(id)arg1 animated:(_Bool)arg2 interactive:(_Bool)arg3 completion:(id /* block */)arg4;
...
- (void)dismissPaneViewControllerAnimated:(_Bool)arg1 completion:(id /* block */)arg2;
- (void)presentPaneViewController:(id)arg1 fromEdge:(unsigned long long)arg2 withPercent:(double)arg3 completion:(id /* block */)arg4;
- (void)presentPaneViewController:(id)arg1 fromEdge:(unsigned long long)arg2 animated:(_Bool)arg3 completion:(id /* block */)arg4;
