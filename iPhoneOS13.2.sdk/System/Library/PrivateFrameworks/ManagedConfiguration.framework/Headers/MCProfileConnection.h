...
- (void)removeUninstalledProfileWithIdentifier:(id)arg1 installationType:(long long)arg2 targetDeviceType:(NSUInteger)arg3 completion:(CDUnknownBlockType)arg4;
...
- (void)setGracePeriod:(NSUInteger)arg1 passcode:(id)arg2 completionBlock:(CDUnknownBlockType)arg3;
- (BOOL)isMUAllowed;
- (void)flush;
