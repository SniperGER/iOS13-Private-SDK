...
- (void)_queueDataForAcceptance:(id)arg1 originalFileName:(id)arg2 originatingBundleID:(id)arg3 transitionToUI:(_Bool)arg4 completion:(id /* block */)arg5;
...
- (void)resetAllSettingsToDefaultsIsUserInitiated:(_Bool)arg1 waitUntilCompleted:(_Bool)arg2 completion:(id /* block */)arg3;
- (void)resetAllSettingsToDefaultsIsUserInitiated:(_Bool)arg1 completion:(id /* block */)arg2;
...
- (void)setBoolValue:(_Bool)arg1 forSetting:(id)arg2 toSystem:(_Bool)arg3 user:(_Bool)arg4 passcode:(id)arg5 completion:(id /* block */)arg6;
...
- (void)setAsk:(_Bool)arg1 forBoolSetting:(id)arg2 configurationUUID:(id)arg3 toSystem:(_Bool)arg4 user:(_Bool)arg5 passcode:(id)arg6 waitUntilCompleted:(_Bool)arg7 completion:(id /* block */)arg8;
- (void)setAsk:(_Bool)arg1 forBoolSetting:(id)arg2 configurationUUID:(id)arg3 toSystem:(_Bool)arg4 user:(_Bool)arg5 passcode:(id)arg6 completion:(id /* block */)arg7;
...
- (void)setBoolValue:(_Bool)arg1 ask:(_Bool)arg2 forSetting:(id)arg3 configurationUUID:(id)arg4 toSystem:(_Bool)arg5 user:(_Bool)arg6 passcode:(id)arg7 credentialSet:(id)arg8 waitUntilCompleted:(_Bool)arg9 completion:(id /* block */)arg10;
- (void)setBoolValue:(_Bool)arg1 ask:(_Bool)arg2 forSetting:(id)arg3 configurationUUID:(id)arg4 toSystem:(_Bool)arg5 user:(_Bool)arg6 passcode:(id)arg7 completion:(id /* block */)arg8;
...
- (void)setBoolValue:(_Bool)arg1 ask:(_Bool)arg2 forSetting:(id)arg3 toSystem:(_Bool)arg4 user:(_Bool)arg5 passcode:(id)arg6 completion:(id /* block */)arg7;
- (void)setBoolValue:(_Bool)arg1 ask:(_Bool)arg2 forSetting:(id)arg3 passcode:(id)arg4 completion:(id /* block */)arg5;
- (void)setBoolValue:(_Bool)arg1 ask:(_Bool)arg2 forSetting:(id)arg3 passcode:(id)arg4;
- (void)setBoolValue:(_Bool)arg1 forSetting:(id)arg2 passcode:(id)arg3 completion:(id /* block */)arg4;
...
- (void)setParametersForSettingsByType:(id)arg1 configurationUUID:(id)arg2 toSystem:(_Bool)arg3 user:(_Bool)arg4 passcode:(id)arg5 credentialSet:(id)arg6 waitUntilCompleted:(_Bool)arg7 completion:(id /* block */)arg8;
- (void)setParametersForSettingsByType:(id)arg1 toSystem:(_Bool)arg2 user:(_Bool)arg3 passcode:(id)arg4 waitUntilCompleted:(_Bool)arg5 completion:(id /* block */)arg6;
- (void)setParametersForSettingsByType:(id)arg1 toSystem:(_Bool)arg2 user:(_Bool)arg3 passcode:(id)arg4 completion:(id /* block */)arg5;
...
- (void)setConferenceRoomDisplaySettingsUIAllowed:(_Bool)arg1 ask:(_Bool)arg2 completion:(id /* block */)arg3;
- (_Bool)isConferenceRoomDisplayModeEnabledOutAsk:(_Bool *)arg1;
- (void)setConferenceRoomDisplayModeEnabled:(_Bool)arg1 ask:(_Bool)arg2 completion:(id /* block */)arg3;
- (_Bool)isExplicitContentAllowedOutAsk:(_Bool *)arg1;
- (void)setExplicitContentAllowed:(_Bool)arg1 ask:(_Bool)arg2 completion:(id /* block */)arg3;
- (_Bool)isMediaPurchaseAllowedOutAsk:(_Bool *)arg1;
- (void)setMediaPurchaseAllowed:(_Bool)arg1 ask:(_Bool)arg2 completion:(id /* block */)arg3;
...
- (void)setAirPlaySettingsUIAllowed:(_Bool)arg1 ask:(_Bool)arg2 completion:(id /* block */)arg3;
- (_Bool)shouldDestroyOldKeybag;
- (_Bool)isAttentionAwareAutoLockAllowed;
- (void)setFingerprintUnlockAllowed:(_Bool)arg1 credentialSet:(id)arg2 completionBlock:(id /* block */)arg3;
- (void)setFingerprintUnlockAllowed:(_Bool)arg1 passcode:(id)arg2 completionBlock:(id /* block */)arg3;
- (unsigned long long)gracePeriod;
- (void)setGracePeriod:(unsigned long long)arg1 passcode:(id)arg2 completionBlock:(id /* block */)arg3;
- (_Bool)isMUAllowed;
- (void)flush;
- (void)waitForMigrationIncludingPostRestoreMigration:(_Bool)arg1 waitUntilCompleted:(_Bool)arg2 completion:(id /* block */)arg3;
- (void)waitForMigrationIncludingPostRestoreMigration:(_Bool)arg1 completion:(id /* block */)arg2;
...
- (void)validateAppBundleIDs:(id)arg1 waitUntilCompleted:(_Bool)arg2 completion:(id /* block */)arg3;
...
- (void)migrateWithContext:(int)arg1 passcodeWasSetInBackup:(_Bool)arg2 completion:(id /* block */)arg3;
...
- (void)parentalControlsWhitelistedAppBundleIDsIncludingWatchBundleIDs:(_Bool)arg1 completion:(id /* block */)arg2;
...
- (void)restrictionEnforcedWhitelistedAppBundleIDsIncludingWatchBundleIDs:(_Bool)arg1 completion:(id /* block */)arg2;
- (void)restrictionEnforcedWhitelistedAppBundleIDsWithCompletion:(id /* block */)arg1;
- (id)restrictionEnforcedWhitelistedAppBundleIDs;
- (void)effectiveWhitelistedAppBundleIDsIncludingWatchBundleIDs:(_Bool)arg1 completion:(id /* block */)arg2;
...
- (void)parentalControlsBlacklistedAppBundleIDsIncludingWatchBundleIDs:(_Bool)arg1 completion:(id /* block */)arg2;
- (void)parentalControlsBlacklistedAppBundleIDsWithCompletion:(id /* block */)arg1;
- (id)parentalControlsBlacklistedAppBundleIDs;
- (void)restrictionEnforcedBlacklistedAppBundleIDsExcludingRemovedSystemApps:(_Bool)arg1 includeWatchBundleIDs:(_Bool)arg2 completion:(id /* block */)arg3;
- (void)restrictionEnforcedBlacklistedAppBundleIDsExcludingRemovedSystemApps:(_Bool)arg1 completion:(id /* block */)arg2;
...
- (void)effectiveBlacklistedAppBundleIDsExcludingRemovedSystemApps:(_Bool)arg1 includeWatchBundleIDs:(_Bool)arg2 completion:(id /* block */)arg3;
- (void)effectiveBlacklistedAppBundleIDsIncludingWatchBundleIDs:(_Bool)arg1 completion:(id /* block */)arg2;
- (void)effectiveBlacklistedAppBundleIDsExcludingRemovedSystemApps:(_Bool)arg1 completion:(id /* block */)arg2;
...
- (void)removedSystemAppBundleIDsIncludingWatchBundleIDs:(_Bool)arg1 completion:(id /* block */)arg2;
- (void)removedSystemAppBundleIDsWithCompletion:(id /* block */)arg1;
- (id)removedSystemAppBundleIDs;
- (void)restrictedAppBundleIDsExcludingRemovedSystemApps:(_Bool)arg1 includeWatchBundleIDs:(_Bool)arg2 completion:(id /* block */)arg3;
- (void)restrictedAppBundleIDsExcludingRemovedSystemApps:(_Bool)arg1 completion:(id /* block */)arg2;
- (void)restrictedAppBundleIDsIncludingWatchBundleIDs:(_Bool)arg1 completion:(id /* block */)arg2;
...
- (void)storeCloudConfigurationDetails:(id)arg1 waitUntilCompleted:(_Bool)arg2 completion:(id /* block */)arg3;
...
- (void)allowedKeyboardBundleIDsAfterApplyingFilterToBundleIDs:(id)arg1 hostAppBundleID:(id)arg2 accountIsManaged:(_Bool)arg3 completion:(id /* block */)arg4;
