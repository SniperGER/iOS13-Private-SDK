...
- (_Bool)registerConfigChangeCallback:(id /* block */)arg1;
- (_Bool)registerQueriableMetricCallback:(id /* block */)arg1 forIdentifier:(unsigned int)arg2;
- (_Bool)registerQueriableMetric:(unsigned int)arg1 callback:(id /* block */)arg2;
