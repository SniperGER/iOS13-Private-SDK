...
- (void)serializeDictionaryIntoDictionary:(id)arg1 withKey:(id)arg2 withValue:(id)arg3 dictSerializer:(id /* block */)arg4 isRequired:(_Bool)arg5 defaultValue:(id)arg6;
- (void)serializeArrayIntoDictionary:(id)arg1 withKey:(id)arg2 withValue:(id)arg3 itemSerializer:(id /* block */)arg4 isRequired:(_Bool)arg5 defaultValue:(id)arg6;
...
- (id)loadArrayFromDictionary:(id)arg1 withKey:(id)arg2 validator:(id /* block */)arg3 isRequired:(_Bool)arg4 defaultValue:(id)arg5 error:(id *)arg6;
