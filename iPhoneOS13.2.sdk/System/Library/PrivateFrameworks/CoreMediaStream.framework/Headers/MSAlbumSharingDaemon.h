...
- (void)workQueueForgetEverythingAboutPersonIDs:(id)arg1 index:(NSUInteger)arg2 completionBlock:(CDUnknownBlockType)arg3;
...
- (void)mapQueueShutDownStateMachineInMap:(id)arg1 personIDs:(id)arg2 index:(NSUInteger)arg3 forDestruction:(BOOL)arg4 completionBlock:(CDUnknownBlockType)arg5;
- (void)shutDown;
- (void)start;
- (id)init;
