...
- (void)albumSummaryAlbum:(id)arg1 albumURLString:(id)arg2 resetSync:(_Bool)arg3 completionBlock:(id /* block */)arg4;
...
- (void)setMultipleContributorsEnabled:(_Bool)arg1 forAlbum:(id)arg2 completionBlock:(id /* block */)arg3;
- (void)setPublicAccessEnabled:(_Bool)arg1 forAlbum:(id)arg2 completionBlock:(id /* block */)arg3;
...
- (void)_sendOneURLRequest:(id)arg1 checkServerSideConfigVersion:(_Bool)arg2 retryCount:(unsigned long long)arg3 completionBlock:(id /* block */)arg4;
- (void)sendURLRequest:(id)arg1 method:(id)arg2 bodyObj:(id)arg3 checkServerSideConfigVersion:(_Bool)arg4 completionBlock:(id /* block */)arg5;
