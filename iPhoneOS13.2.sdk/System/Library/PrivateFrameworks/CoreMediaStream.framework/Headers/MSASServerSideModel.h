...
- (void)setMultipleContributorsEnabled:(_Bool)arg1 forAlbumWithGUID:(id)arg2 info:(id)arg3 completionBlock:(id /* block */)arg4;
- (void)setMultipleContributorsEnabled:(_Bool)arg1 forAlbumWithGUID:(id)arg2 completionBlock:(id /* block */)arg3;
- (void)setPublicAccessEnabled:(_Bool)arg1 forAlbumWithGUID:(id)arg2 info:(id)arg3 completionBlock:(id /* block */)arg4;
- (void)setPublicAccessEnabled:(_Bool)arg1 forAlbumWithGUID:(id)arg2 completionBlock:(id /* block */)arg3;
...
- (void)shutDownForDestruction:(_Bool)arg1 completionBlock:(id /* block */)arg2;
- (void)shutDown;
- (void)cancel;
- (void)start;
