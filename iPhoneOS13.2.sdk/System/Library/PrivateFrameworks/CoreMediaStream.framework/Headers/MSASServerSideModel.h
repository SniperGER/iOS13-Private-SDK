...
@class MSASPendingChanges, MSASServerSideModelGroupedCommandQueue, MSASStateMachine, MSAlbumSharingDaemon, NSCountedSet, NSObject;
...
- (BOOL)dbQueueCommentWithGUID:(id)arg1 outObject:(id )arg2 outID:(NSUInteger )arg3 outTimestamp:(id )arg4 outAssetCollectionGUID:(id )arg5 outIsCaption:(BOOL )arg6 outUserInfoData:(id )arg7;
...
- (void)videoURLsForAssetCollectionWithGUID:(id)arg1 forMediaAssetType:(NSUInteger)arg2 completionBlock:(CDUnknownBlockType)arg3;
