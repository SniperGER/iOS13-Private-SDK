...
@interface MSASStateMachine : NSObject <MSBackoffManagerDelegate, MSASAssetUploaderDelegate, MSASAssetDownloaderDelegate>
{
    ...
    id /* CDUnknownBlockType */ _stopHandlerBlock;
    ...
    id /* CDUnknownBlockType */ _postCommandCompletionBlock;
}

@property(copy, nonatomic) id /* CDUnknownBlockType */ postCommandCompletionBlock; // @synthesize postCommandCompletionBlock=_postCommandCompletionBlock;
...
@property(copy, nonatomic, setter=_setStopHandlerBlock:) id /* CDUnknownBlockType */ _stopHandlerBlock; // @synthesize _stopHandlerBlock;
...
- (void)MSASAssetDownloader:(id)arg1 willBeginBatchCount:(NSUInteger)arg2;
...
- (void)videoURLsForAssetCollection:(id)arg1 forMediaAssetType:(NSUInteger)arg2 inAlbum:(id)arg3 completionBlock:(CDUnknownBlockType)arg4;
