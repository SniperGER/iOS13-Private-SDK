...
@property(copy, nonatomic) id /* block */ postCommandCompletionBlock; // @synthesize postCommandCompletionBlock=_postCommandCompletionBlock;
...
@property(copy, nonatomic, setter=_setStopHandlerBlock:) id /* block */ _stopHandlerBlock; // @synthesize _stopHandlerBlock;
...
- (void)setMultipleContributorsEnabled:(_Bool)arg1 forAlbum:(id)arg2 info:(id)arg3 completionBlock:(id /* block */)arg4;
- (void)setPublicAccessEnabled:(_Bool)arg1 forAlbum:(id)arg2 info:(id)arg3 completionBlock:(id /* block */)arg4;
