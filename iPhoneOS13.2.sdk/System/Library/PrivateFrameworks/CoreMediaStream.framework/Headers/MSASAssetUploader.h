...
- (void)workQueueRegisterAssetCollections:(id)arg1 index:(NSUInteger)arg2 results:(id)arg3 completionBlock:(CDUnknownBlockType)arg4;
- (void)workQueueRegisterAssets:(id)arg1 index:(NSUInteger)arg2 completionBlock:(CDUnknownBlockType)arg3;
