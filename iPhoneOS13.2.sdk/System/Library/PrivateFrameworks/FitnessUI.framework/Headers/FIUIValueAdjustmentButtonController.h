...
@property(copy, nonatomic) id /* block */ buttonStateUpdateHandler; // @synthesize buttonStateUpdateHandler=_buttonStateUpdateHandler;
...
@property(copy, nonatomic) id /* block */ valueUpdateHandler; // @synthesize valueUpdateHandler=_valueUpdateHandler;
