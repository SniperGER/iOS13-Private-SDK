...
{
    id /* CDUnknownBlockType */ _wheelchairUseUpdateHandler;
}

@property(copy, nonatomic) id /* CDUnknownBlockType */ wheelchairUseUpdateHandler; // @synthesize wheelchairUseUpdateHandler=_wheelchairUseUpdateHandler;
// - (void).cxx_destruct;
