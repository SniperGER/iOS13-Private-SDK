...
@property(copy, nonatomic) id /* block */ exitConfirmationChangeObserver; // @synthesize exitConfirmationChangeObserver=_exitConfirmationChangeObserver;
@property(copy, nonatomic) id /* block */ statusChangeObserver; // @synthesize statusChangeObserver=_statusChangeObserver;
...
- (void)_performCARPreferencesBlock:(id /* block */)arg1 forReading:(_Bool)arg2;
...
- (void)setAutomaticDNDActive:(_Bool)arg1 withReply:(id /* block */)arg2;
