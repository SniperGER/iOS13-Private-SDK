...
@property(copy, nonatomic) id /* block */ serializedLogMessageBlock; // @synthesize serializedLogMessageBlock=_serializedLogMessageBlock;
@property(copy, nonatomic) id /* block */ serializedSignpostEventBlock; // @synthesize serializedSignpostEventBlock=_serializedSignpostEventBlock;
