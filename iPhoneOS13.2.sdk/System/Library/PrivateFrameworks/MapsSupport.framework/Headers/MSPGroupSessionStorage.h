...
- (id)messageStrategyIdentifierAtIndex:(NSUInteger)arg1;
- (NSUInteger)messageStrategyIdentifiersCount;
- (void)addMessageStrategyIdentifier:(id)arg1;
- (void)clearMessageStrategyIdentifiers;
- (id)liveStrategyIdentifierAtIndex:(NSUInteger)arg1;
- (NSUInteger)liveStrategyIdentifiersCount;
- (void)addLiveStrategyIdentifier:(id)arg1;
- (void)clearLiveStrategyIdentifiers;
- (id)minimalStrategyIdentifierAtIndex:(NSUInteger)arg1;
- (NSUInteger)minimalStrategyIdentifiersCount;
