...
- (_Bool)_checkAndAddCoalescedEditForContext:(id)arg1 identifiers:(id)arg2 enqueuedBlock:(id /* block */)arg3 completionQueue:(id)arg4 completion:(id /* block */)arg5;
...
- (void)_performInitialLoadNotifyingObservers:(_Bool)arg1 kickOffSynchronously:(_Bool)arg2 completion:(id /* block */)arg3;
