...
- (void)serviceOpenURL:(id)arg1 delaySessionEndForTTS:(_Bool)arg2 replyHandler:(id /* block */)arg3;
...
- (void)setStatusBarHidden:(_Bool)arg1 animated:(_Bool)arg2 completion:(id /* block */)arg3;
