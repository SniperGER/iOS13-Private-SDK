...
- (id)description;
- (id)initWithText:(id)arg1 audioData:(id)arg2 identifier:(id)arg3 language:(id)arg4 gender:(id)arg5 provisional:(BOOL)arg6 eligibleAfterDuration:(double)arg7 delayed:(BOOL)arg8 preparation:(CDUnknownBlockType)arg9 completion:(CDUnknownBlockType)arg10 animationIdentifier:(id)arg11 analyticsContext:(id)arg12 speakableContextInfo:(id)arg13 canUseServerTTS:(BOOL)arg14 eligibilityChangedQueue:(id)arg15;
