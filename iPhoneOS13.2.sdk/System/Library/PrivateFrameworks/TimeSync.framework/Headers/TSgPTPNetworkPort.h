...
@interface TSgPTPNetworkPort : TSgPTPPort
{
    ...
    NSUInteger _remoteClockIdentity;
    NSString *_sourceAddressString;
    NSString *_destinationAddressString;
    NSString *_interfaceName;
    NSUInteger _overridenReceiveClockIdentity;
}
...
@property(nonatomic) NSUInteger overridenReceiveClockIdentity; // @synthesize overridenReceiveClockIdentity=_overridenReceiveClockIdentity;
...
@property(nonatomic) NSUInteger remoteClockIdentity; // @synthesize remoteClockIdentity=_remoteClockIdentity;
- (void)dealloc;
- (void)removeClient:(id)arg1;
- (void)addClient:(id)arg1;
- (BOOL)deregisterAsyncCallbackError:(id )arg1;
- (BOOL)registerAsyncCallbackError:(id )arg1;
- (void)_handleNotification:(int)arg1 withArg1:(NSUInteger)arg2 andArg2:(NSUInteger)arg3;
...
- (BOOL)overrideReceiveMatchingWithRemoteClockIdentity:(NSUInteger)arg1 remotePortNumber:(unsigned short)arg2 error:(id )arg3;
