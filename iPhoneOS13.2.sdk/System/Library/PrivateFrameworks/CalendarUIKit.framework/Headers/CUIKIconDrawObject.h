...
@property(readonly, nonatomic) id /* block */ dateNameBlock; // @synthesize dateNameBlock=_dateNameBlock;
...
- (void)_drawDayNumber;
- (void)draw;
- (id)initWithCalendar:(id)arg1 dayNumber:(id)arg2 dateNameBlock:(id /* block */)arg3 dateNameFormatType:(long long)arg4 canvasSize:(struct CGSize)arg5 canvasScale:(double)arg6;
