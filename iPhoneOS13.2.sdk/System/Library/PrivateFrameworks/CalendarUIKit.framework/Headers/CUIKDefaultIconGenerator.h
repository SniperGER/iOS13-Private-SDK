...
+ (void)_drawIconInContext:(struct CGContext *)arg1 imageSize:(struct CGSize)arg2 scale:(double)arg3 iconBase:(id)arg4 calendar:(id)arg5 dayNumberString:(id)arg6 dateNameBlock:(id /* block */)arg7 dateNameFormatType:(long long)arg8 showGrid:(_Bool)arg9;
...
+ (id)_iconImageWithSize:(struct CGSize)arg1 scale:(double)arg2 drawBlock:(id /* block */)arg3;
