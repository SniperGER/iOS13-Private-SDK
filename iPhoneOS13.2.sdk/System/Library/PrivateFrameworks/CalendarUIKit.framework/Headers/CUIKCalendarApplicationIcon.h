...
+ (void)_drawIconInContext:(struct CGContext *)arg1 imageSize:(struct CGSize)arg2 iconBase:(id)arg3 calendar:(id)arg4 dayNumberString:(id)arg5 dateNameBlock:(id /* block */)arg6 dateNameFormatType:(long long)arg7 format:(long long)arg8 showGrid:(_Bool)arg9;
...
+ (id)_iconImageWithFormat:(int)arg1 square:(_Bool)arg2 outline:(_Bool)arg3 drawBlock:(id /* block */)arg4;
