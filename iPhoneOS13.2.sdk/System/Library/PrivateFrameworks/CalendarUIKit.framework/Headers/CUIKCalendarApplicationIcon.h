...
+ (void)_drawIconInContext:(CGContextRef )arg1 imageSize:(CGSize)arg2 iconBase:(id)arg3 calendar:(id)arg4 dayNumberString:(id)arg5 dateNameBlock:(CDUnknownBlockType)arg6 dateNameFormatType:(long long)arg7 format:(long long)arg8 showGrid:(BOOL)arg9;
