...
@interface CUIKiCloudKVStore : NSObject
{
    ...
    id <NSCopying><NSCoding> _ubiquityIdentityToken;
}

+ (_Bool)_haveiCloudKVStoreEntitlement;
+ (id)sharediCloudKVStore;
@property(retain) id <NSCopying><NSCoding> ubiquityIdentityToken; // @synthesize ubiquityIdentityToken=_ubiquityIdentityToken;
