...
@property(copy, nonatomic) id /* block */ userInterfaceStyleChanged; // @synthesize userInterfaceStyleChanged=_userInterfaceStyleChanged;
...
- (void)layoutSubviews;
- (id)initWithLinkRange:(struct _NSRange)arg1 URLIdentifier:(long long)arg2 delegate:(id)arg3 userInterfaceStyleChanged:(id /* block */)arg4;
