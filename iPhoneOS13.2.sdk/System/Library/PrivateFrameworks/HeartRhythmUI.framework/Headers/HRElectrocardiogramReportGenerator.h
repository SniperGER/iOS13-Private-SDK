...
@property(nonatomic) CGContextRef pdfContext; // @synthesize pdfContext=_pdfContext;
...
- (void)_drawUIKitContentAtDocumentOrigin:(CGPoint)arg1 drawingBlock:(CDUnknownBlockType)arg2;
