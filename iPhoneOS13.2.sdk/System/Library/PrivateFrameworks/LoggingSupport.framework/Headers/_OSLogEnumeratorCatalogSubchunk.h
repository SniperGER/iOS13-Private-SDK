...
//  (id)initWithCatalog:(id)arg1 subchunk:(struct catalog_subchunk_s )arg2 range:(NSRange *)arg3 oldestTime:(NSUInteger)arg4 endTime:(NSUInteger)arg5;
//  (id)initWithCatalog:(id)arg1 subchunk:(struct catalog_subchunk_s )arg2 range:(NSRange *)arg3;
