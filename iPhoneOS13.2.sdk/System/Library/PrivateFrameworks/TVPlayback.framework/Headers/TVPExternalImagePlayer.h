...
@interface TVPExternalImagePlayer : NSObject
{
    ...
    id /* CDUnknownBlockType */ _elapsedTimeUpdateBlock;
    id /* CDUnknownBlockType */ _imageUpdateBlock;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ imageUpdateBlock; // @synthesize imageUpdateBlock=_imageUpdateBlock;
@property(copy, nonatomic) id /* CDUnknownBlockType */ elapsedTimeUpdateBlock; // @synthesize elapsedTimeUpdateBlock=_elapsedTimeUpdateBlock;
