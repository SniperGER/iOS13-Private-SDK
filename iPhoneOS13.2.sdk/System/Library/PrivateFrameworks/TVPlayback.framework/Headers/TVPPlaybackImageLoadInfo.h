...
@property(copy, nonatomic) id /* block */ dateBasedHandler; // @synthesize dateBasedHandler=_dateBasedHandler;
@property(copy, nonatomic) id /* block */ timeBasedHandler; // @synthesize timeBasedHandler=_timeBasedHandler;
