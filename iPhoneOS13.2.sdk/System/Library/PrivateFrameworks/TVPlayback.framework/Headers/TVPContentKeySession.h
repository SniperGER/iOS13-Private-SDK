...
@property(copy, nonatomic) id /* block */ offlineKeyGenerationCompletionHandler; // @synthesize offlineKeyGenerationCompletionHandler=_offlineKeyGenerationCompletionHandler;
...
- (void)_generateOfflineKeyRequestsForIdentifiers:(id)arg1 isRenewal:(_Bool)arg2 completion:(id /* block */)arg3;
