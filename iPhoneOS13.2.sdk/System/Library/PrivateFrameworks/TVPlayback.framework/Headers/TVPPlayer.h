...
@property(copy, nonatomic) id /* block */ AVKitExternalImageScanningUpdateBlock; // @synthesize AVKitExternalImageScanningUpdateBlock=_AVKitExternalImageScanningUpdateBlock;
...
@property(copy, nonatomic) id /* block */ highFrequencyElapsedTimeObserverBlock; // @synthesize highFrequencyElapsedTimeObserverBlock=_highFrequencyElapsedTimeObserverBlock;
...
- (void)setElapsedTime:(double)arg1 seekPrecision:(CDStruct_1b6d18a9)arg2 ignoreDelegate:(_Bool)arg3 withAVKitCompletion:(id /* block */)arg4;
