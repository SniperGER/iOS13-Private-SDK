...
@interface NTTodayItemOperation : FCOperation
{
    ...
    id /* CDUnknownBlockType */ _todayItemCompletion;
    NSArray *_feedItems;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ todayItemCompletion; // @synthesize todayItemCompletion=_todayItemCompletion;
