...
- (void)_fetchTodayResultsWithFetchHelper:(id)arg1 maximumCachedAgeForForYou:(NSUInteger)arg2 aggregator:(id)arg3 appConfiguration:(id)arg4 feedPersonalizer:(id)arg5 todayData:(id)arg6 completion:(CDUnknownBlockType)arg7;
