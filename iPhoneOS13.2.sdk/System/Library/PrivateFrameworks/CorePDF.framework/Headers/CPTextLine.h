...
- (id)properties;
- (BOOL)mapToWordPairsWithIndex:(/* void * CDUnknownFunctionPointerType */)arg1 passing:(void )arg2;
- (BOOL)mapToWordPairs:(/* void * CDUnknownFunctionPointerType */)arg1 passing:(void )arg2;
- (BOOL)mapToWordsWithIndex:(/* void * CDUnknownFunctionPointerType */)arg1 passing:(void )arg2;
- (BOOL)mapToWords:(/* void * CDUnknownFunctionPointerType */)arg1 passing:(void )arg2;
- (BOOL)removeTextLines:(id)arg1 whereTrue:(/* void * CDUnknownFunctionPointerType */)arg2 passing:(void )arg3;
...
- (CGRect)boundsOfWordAtIndex:(unsigned int)arg1;
- (unsigned int)wordCount;
