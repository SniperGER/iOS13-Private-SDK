...
@interface ARPRoutePredictor : NSObject
{
    ...
    id /* CDUnknownBlockType */ _longFormVideoFilter;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ longFormVideoFilter; // @synthesize longFormVideoFilter=_longFormVideoFilter;
