...
@property(copy, nonatomic) id /* block */ latestLocationsUpdatedBlock; // @synthesize latestLocationsUpdatedBlock;
@property(copy, nonatomic) id /* block */ beaconsChangedBlock; // @synthesize beaconsChangedBlock;
@property(copy, nonatomic) id /* block */ beaconRemovedBlock; // @synthesize beaconRemovedBlock;
@property(copy, nonatomic) id /* block */ beaconAddedBlock; // @synthesize beaconAddedBlock;
- (void)removeBeacon:(id)arg1 completion:(id /* block */)arg2;
- (void)shareBeacon:(id)arg1 handles:(id)arg2 completion:(id /* block */)arg3;
