...
//  (void)setupVolumeControlSupportChangedCallback:(/* void * CDUnknownFunctionPointerType */)arg1 withContext:(void )arg2 andRunLoop:(struct __CFRunLoop )arg3;
- (void)clearPauseOnHeadphoneDisconnectChangedCallback;
//  (void)setupPauseOnHeadphoneDisconnectChangedCallback:(/* void * CDUnknownFunctionPointerType */)arg1 withContext:(void )arg2 andRunLoop:(struct __CFRunLoop )arg3;
- (void)clearVolumeChangedCallback;
//  (void)setupVolumeChangedCallback:(/* void * CDUnknownFunctionPointerType */)arg1 withContext:(void )arg2 andRunLoop:(struct __CFRunLoop )arg3;
- (void)clearDeviceStateChangedCallback;
//  (void)setupDeviceStateChangedCallback:(/* void * CDUnknownFunctionPointerType */)arg1 withContext:(void )arg2 andRunLoop:(struct __CFRunLoop )arg3;
- (void)dealloc;
- (id)init;
