...
- (void)_updateContentViewControllersAnimated:(_Bool)arg1 completion:(id /* block */)arg2;
...
- (void)dismissPresentationAnimated:(_Bool)arg1 completion:(id /* block */)arg2;
- (void)dismissPresentationAnimated:(_Bool)arg1;
- (void)dismissContentViewControllers:(id)arg1 animated:(_Bool)arg2 completion:(id /* block */)arg3;
- (void)dismissContentViewController:(id)arg1 animated:(_Bool)arg2 completion:(id /* block */)arg3;
- (void)dismissContentViewController:(id)arg1 animated:(_Bool)arg2;
- (void)presentContentViewControllers:(id)arg1 animated:(_Bool)arg2 completion:(id /* block */)arg3;
- (void)presentContentViewController:(id)arg1 animated:(_Bool)arg2 completion:(id /* block */)arg3;
