...
- (_Bool)scrollToPageAtIndex:(unsigned long long)arg1 animated:(_Bool)arg2 withCompletion:(id /* block */)arg3;
- (_Bool)resetScrollViewToMainPageAnimated:(_Bool)arg1 withAnimationSettings:(id)arg2 withCompletion:(id /* block */)arg3;
- (_Bool)resetScrollViewToMainPageAnimated:(_Bool)arg1 withCompletion:(id /* block */)arg2;
