...
- (void)_dismissModalViewController:(id)arg1 animated:(_Bool)arg2 completion:(id /* block */)arg3;
- (void)_dismissModalViewControllersWithIdentifier:(id)arg1 animated:(_Bool)arg2 completion:(id /* block */)arg3;
- (void)_presentModalViewController:(id)arg1 animated:(_Bool)arg2 completion:(id /* block */)arg3;
...
- (void)activatePage:(unsigned long long)arg1 animated:(_Bool)arg2 withCompletion:(id /* block */)arg3;
...
- (void)_activateCameraAnimated:(_Bool)arg1 actions:(id)arg2 completion:(id /* block */)arg3;
...
- (void)setPasscodeLockVisible:(_Bool)arg1 animated:(_Bool)arg2 forceBiometricPresentation:(_Bool)arg3 completion:(id /* block */)arg4;
- (void)setPasscodeLockVisible:(_Bool)arg1 animated:(_Bool)arg2 completion:(id /* block */)arg3;
...
- (void)activateCameraViewAnimated:(_Bool)arg1 sendingActions:(id)arg2 completion:(id /* block */)arg3;
