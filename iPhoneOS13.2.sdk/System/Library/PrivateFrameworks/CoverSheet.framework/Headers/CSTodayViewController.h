...
@class CSComponent, CSLayoutStrategy, CSPaddingHeaderViewController, CSPageViewController, NSSet, SBViewControllerTransitionContext, UIView, WGWidgetGroupViewController, _UILegibilitySettings;
