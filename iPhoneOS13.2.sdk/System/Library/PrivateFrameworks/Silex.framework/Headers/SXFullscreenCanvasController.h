...
- (void)goToOriginalFromVerticalSwipingWithVelocity:(struct CGPoint)arg1 completionBlock:(id /* block */)arg2;
- (void)goToOriginalFromOriginalAnimated:(_Bool)arg1 completionBlock:(id /* block */)arg2;
- (void)goToOriginalFromFullScreenAnimated:(_Bool)arg1 completionBlock:(id /* block */)arg2;
- (void)goToFullScreenFromFullScreenAnimated:(_Bool)arg1 completionBlock:(id /* block */)arg2;
- (void)goToFullScreenFromOriginalAnimated:(_Bool)arg1 completionBlock:(id /* block */)arg2;
