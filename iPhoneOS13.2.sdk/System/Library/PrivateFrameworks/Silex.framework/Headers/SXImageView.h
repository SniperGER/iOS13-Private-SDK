...
@property(copy, nonatomic) id /* block */ highQualityImageRequestCancelHandler; // @synthesize highQualityImageRequestCancelHandler=_highQualityImageRequestCancelHandler;
@property(copy, nonatomic) id /* block */ preferredQualityImageRequestCancelHandler; // @synthesize preferredQualityImageRequestCancelHandler=_preferredQualityImageRequestCancelHandler;
...
@property(copy, nonatomic) id /* block */ frameChangeBlock; // @synthesize frameChangeBlock=_frameChangeBlock;
