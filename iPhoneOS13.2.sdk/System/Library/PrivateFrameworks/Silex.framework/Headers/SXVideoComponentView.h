...
@property(copy, nonatomic) id /* block */ presentationBlock; // @synthesize presentationBlock=_presentationBlock;
...
@property(copy, nonatomic) id /* block */ thumbnailRequestCancelHandler; // @synthesize thumbnailRequestCancelHandler=_thumbnailRequestCancelHandler;
