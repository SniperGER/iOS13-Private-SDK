...
@class ADBannerView, SVVolumeProvider, SXAdController, SXPosterFrameView, SXVideoAnalyticsRouter, SXVideoComponentAnalyticsReporting, SXVideoPlayerViewController, SXVideoPlayerViewControllerManager;
...
@interface SXVideoComponentView : SXMediaComponentView <SXViewportChangeListener, SXMediaPlaybackDelegate, SXVideoPlayerViewControllerDelegate, SXVideoPlayerViewControllerDataSource, SXVideoAdProviderDataSource, SXReachabilityObserver, SXFullscreenVideoPlaybackCandidate>
{
    ...
    id /* CDUnknownBlockType */ _thumbnailRequestCancelHandler;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ presentationBlock; // @synthesize presentationBlock=_presentationBlock;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ thumbnailRequestCancelHandler; // @synthesize thumbnailRequestCancelHandler=_thumbnailRequestCancelHandler;
