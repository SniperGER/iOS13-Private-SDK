...
// - (void).cxx_destruct;
- (id)initWithImageIdentifier:(id)arg1 imageQualities:(NSUInteger)arg2 url:(id)arg3 size:(CGSize)arg4 preserveColorspace:(BOOL)arg5 loadingBlock:(CDUnknownBlockType)arg6;
