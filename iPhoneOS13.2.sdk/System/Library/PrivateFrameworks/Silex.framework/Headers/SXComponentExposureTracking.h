...
@property(readonly, copy, nonatomic) id /* block */ conditionBlock; // @synthesize conditionBlock=_conditionBlock;
@property(readonly, copy, nonatomic) id /* block */ exposureStateChangeBlock; // @synthesize exposureStateChangeBlock=_exposureStateChangeBlock;
