...
@property(copy, nonatomic, setter=onPresentable:) id /* block */ presentableBlock; // @synthesize presentableBlock;
@property(copy, nonatomic, setter=onLoad:) id /* block */ loadBlock; // @synthesize loadBlock;
