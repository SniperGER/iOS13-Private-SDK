...
@class SXComponentView, SXGradientFillView, SXImageFillView, SXLayer, SXRepeatableImageFillView, SXShapeLayer, SXVideoFillView, SXViewport;
...
- (void)applyCornerRadius:(double)arg1 cornerMask:(NSUInteger)arg2 curve:(id)arg3 onView:(id)arg4;
