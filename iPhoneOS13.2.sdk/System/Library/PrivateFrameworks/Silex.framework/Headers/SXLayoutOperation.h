...
@property(copy, nonatomic, setter=afterLayout:) id /* block */ afterBlock; // @synthesize afterBlock=_afterBlock;
@property(copy, nonatomic, setter=beforeLayout:) id /* block */ beforeBlock; // @synthesize beforeBlock=_beforeBlock;
