...
@class SXColumnLayouter, SXLayoutBlueprint, SXLayoutTask;
...
@interface SXLayoutOperation : NSOperation <SXLayouterDelegate>
{
    ...
    id /* CDUnknownBlockType */ _beforeBlock;
...
@property(copy, nonatomic, setter=afterLayout:) id /* CDUnknownBlockType */ afterBlock; // @synthesize afterBlock=_afterBlock;
@property(copy, nonatomic, setter=beforeLayout:) id /* CDUnknownBlockType */ beforeBlock; // @synthesize beforeBlock=_beforeBlock;
...
- (void)registerComponent:(id)arg1 layoutBlueprint:(id)arg2 componentIndex:(NSUInteger)arg3;
