...
@class AVPlayerViewController, SVAdPrivacyButton, SVKeyValueObserver, SVLearnMoreButton, SXAutomaticFullscreenVideoPlaybackBehaviorManager, SXPlaybackCoordinator, SXVideoAdSkipButton, SXVideoPlaybackQueue, SXVideoVolumeObserver, UIActivityIndicatorView, UIGestureRecognizer;
...
@interface SXVideoPlayerViewController : UIViewController <SXVideoPlaybackObserver, AVPlayerViewControllerDelegate_WebKitOnly, AVPlayerViewControllerDelegatePrivate, SXAutomaticFullscreenVideoPlaybackBehaviorManagerDelegate, UIGestureRecognizerDelegate, SXVideoAdViewControllerProviding>
{
    ...
    NSUInteger _mode;
    NSUInteger _fullscreenBehavior;
...
@property(nonatomic) NSUInteger fullscreenBehavior; // @synthesize fullscreenBehavior=_fullscreenBehavior;
...
- (void)updateSkipButtonWithThreshold:(NSUInteger)arg1 time:(double)arg2;
