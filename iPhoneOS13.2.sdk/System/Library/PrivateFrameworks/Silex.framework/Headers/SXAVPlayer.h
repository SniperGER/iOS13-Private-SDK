...
@property(copy, nonatomic) id /* block */ loadingProgressBlock; // @synthesize loadingProgressBlock=_loadingProgressBlock;
@property(copy, nonatomic) id /* block */ playbackProgressBlock; // @synthesize playbackProgressBlock=_playbackProgressBlock;
@property(copy, nonatomic) id /* block */ playbackStatusBlock; // @synthesize playbackStatusBlock=_playbackStatusBlock;
