...
- (oneway void)stopPictureInPictureAnimated:(BOOL)arg1 withFinalInterfaceOrientation:(long long)arg2 finalLayerFrame:(CGRect)arg3 completionHandler:(CDUnknownBlockType)arg4;
...
- (oneway void)updatePreferredContentSize:(CGSize)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;
...
- (oneway void)updateInitialLayerFrameForInteractiveTransitionAnimationUponBackgrounding:(CGRect)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;
- (oneway void)startPictureInPictureAnimated:(BOOL)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (oneway void)setupStartAnimated:(BOOL)arg1 hostedWindowHostingHandle:(id)arg2 sceneSessionPersistentIdentifier:(id)arg3 preferredContentSize:(CGSize)arg4 initialInterfaceOrientation:(long long)arg5 initialLayerFrame:(CGRect)arg6 completionHandler:(CDUnknownBlockType)arg7;
- (oneway void)initializePictureInPictureWithControlsStyle:(long long)arg1 preferredContentSize:(CGSize)arg2 completionHandler:(CDUnknownBlockType)arg3;
