...
- (oneway void)setShouldShowLoadingIndicator:(_Bool)arg1 completionHandler:(id /* block */)arg2;
- (oneway void)setShouldShowAlternateActionButtonImage:(_Bool)arg1 completionHandler:(id /* block */)arg2;
- (oneway void)setControlsStyle:(long long)arg1 animated:(_Bool)arg2 completionHandler:(id /* block */)arg3;
- (oneway void)setPictureInPictureShouldStartWhenEnteringBackground:(_Bool)arg1 completionHandler:(id /* block */)arg2;
- (oneway void)cleanupWithCompletionHandler:(id /* block */)arg1;
- (oneway void)stopPictureInPictureAnimated:(_Bool)arg1 withFinalInterfaceOrientation:(long long)arg2 finalLayerFrame:(struct CGRect)arg3 completionHandler:(id /* block */)arg4;
- (oneway void)setupStopAnimated:(_Bool)arg1 activateApplicationIfNeeded:(_Bool)arg2 completionHandler:(id /* block */)arg3;
...
- (oneway void)updatePreferredContentSize:(struct CGSize)arg1 withCompletionHandler:(id /* block */)arg2;
...
- (oneway void)updateInitialLayerFrameForInteractiveTransitionAnimationUponBackgrounding:(struct CGRect)arg1 withCompletionHandler:(id /* block */)arg2;
- (oneway void)startPictureInPictureAnimated:(_Bool)arg1 completionHandler:(id /* block */)arg2;
- (oneway void)setupStartAnimated:(_Bool)arg1 hostedWindowHostingHandle:(id)arg2 sceneSessionPersistentIdentifier:(id)arg3 preferredContentSize:(struct CGSize)arg4 initialInterfaceOrientation:(long long)arg5 initialLayerFrame:(struct CGRect)arg6 completionHandler:(id /* block */)arg7;
- (oneway void)initializePictureInPictureWithControlsStyle:(long long)arg1 preferredContentSize:(struct CGSize)arg2 completionHandler:(id /* block */)arg3;
...
- (void)stopPictureInPictureAnimated:(_Bool)arg1 withCompletionHandler:(id /* block */)arg2;
- (void)startPictureInPictureEnteringBackgroundAnimated:(_Bool)arg1 withCompletionHandler:(id /* block */)arg2;
