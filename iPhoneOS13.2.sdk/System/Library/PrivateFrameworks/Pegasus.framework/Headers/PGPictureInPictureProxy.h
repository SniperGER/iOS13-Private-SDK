...
- (oneway void)pictureInPictureCancelRequestedAnimated:(_Bool)arg1 withCompletionHandler:(id /* block */)arg2;
- (oneway void)pictureInPictureStopRequestedAnimated:(_Bool)arg1 withCompletionHandler:(id /* block */)arg2;
- (oneway void)pictureInPictureStartRequestedAnimated:(_Bool)arg1 withCompletionHandler:(id /* block */)arg2;
...
- (id)_expectedScene;
- (void)_executeDelegateCallbackBlock:(id /* block */)arg1 assumeApplicationActive:(_Bool)arg2;
- (id)_sourceScene;
...
- (void)_stopPictureInPictureAnimated:(_Bool)arg1 restoreUserInterface:(_Bool)arg2 withCompletionHandler:(id /* block */)arg3;
- (void)_didStartWithSuccess:(_Bool)arg1 animationType:(long long)arg2 completionHandler:(id /* block */)arg3;
- (void)_actuallyStartAnimated:(_Bool)arg1 animationType:(long long)arg2 completionHandler:(id /* block */)arg3;
- (void)_setupStart:(_Bool)arg1 animationType:(long long)arg2 initialLayerFrame:(struct CGRect)arg3 completionHandler:(id /* block */)arg4;
- (void)_manageStartAnimated:(_Bool)arg1 cancelActiveOnStart:(_Bool)arg2 competionHandler:(id /* block */)arg3;
- (void)_updateCancellationPolicyWithCompletionHandler:(id /* block */)arg1;
- (void)_startPictureInPictureAnimated:(_Bool)arg1 enteringBackground:(_Bool)arg2 withCompletionHandler:(id /* block */)arg3;
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;
- (void)setControlsStyle:(long long)arg1 animated:(_Bool)arg2 withCompletionHandler:(id /* block */)arg3;
