...
- (void)stopPictureInPictureForApplication:(id)arg1 sceneSessionPersistentIdentifier:(id)arg2 animated:(_Bool)arg3 completionHandler:(id /* block */)arg4;
- (void)startPictureInPictureForApplicationEnteringBackground:(id)arg1 sceneSessionPersistentIdentifier:(id)arg2 animated:(_Bool)arg3 completionHandler:(id /* block */)arg4;
...
- (void)stopPictureInPictureForApplication:(id)arg1 animated:(_Bool)arg2 completionHandler:(id /* block */)arg3;
- (void)startPictureInPictureForApplicationEnteringBackground:(id)arg1 animated:(_Bool)arg2 completionHandler:(id /* block */)arg3;
