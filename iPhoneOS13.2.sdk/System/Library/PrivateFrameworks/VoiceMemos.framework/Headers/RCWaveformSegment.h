...
+ (id)_segmentsByJoiningSegment:(id)arg1 toSegmentIfNecessaryWithGreaterSegment:(id)arg2 averagePowerLevelJoinLimit:(NSUInteger)arg3;
...
// - (void).cxx_destruct;
- (id)_segmentsByJoiningIfNecessaryGreaterSegment:(id)arg1 averagePowerLevelJoinLimit:(NSUInteger)arg2;
// - (id)_segmentWithValuesInContainedTimeRange:(CDStruct_73a5d3ca)arg1;
// - (id)segmentByClippingToTimeRange:(CDStruct_73a5d3ca)arg1;
- (id)segmentsByJoiningIfSmallSegment:(id)arg1 averagePowerLevelJoinLimit:(NSUInteger)arg2;
