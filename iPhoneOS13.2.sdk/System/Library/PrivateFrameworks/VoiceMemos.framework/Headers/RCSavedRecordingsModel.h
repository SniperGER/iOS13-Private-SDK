...
- (_Bool)fetchExportProgress:(id)arg1 completionHandler:(id /* block */)arg2;
- (_Bool)fetchObjectsFromCloud:(id)arg1 entityToAttributesToFetch:(struct NSDictionary *)arg2 completionHandler:(id /* block */)arg3;
- (_Bool)importFromCloud:(id /* block */)arg1;
- (_Bool)exportToCloud:(id /* block */)arg1;
- (_Bool)resetCloud:(id /* block */)arg1;
