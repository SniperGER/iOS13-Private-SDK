...
@class NSArray, RCComposition, RCCompositionFragment, RCCompositionWaveformDataSource, RCMutableComposition, RCMutableCompositionFragment, RCWaveform;
...
- (void)finishLoadingWithCompletionTimeout:(NSUInteger)arg1 finalizedFragmentDuration:(double)arg2 completionBlock:(CDUnknownBlockType)arg3;
- (BOOL)waitUntilFinished;
- (void)finishLoadingWithCompletionTimeout:(NSUInteger)arg1 completionBlock:(CDUnknownBlockType)arg2;
- (void)startLoading;
- (void)cancelLoading;
