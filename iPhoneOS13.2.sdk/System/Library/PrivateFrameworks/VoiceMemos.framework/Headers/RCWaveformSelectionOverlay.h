...
@property(readonly, nonatomic) CGRect selectionRect; // @synthesize selectionRect=_selectionRect;
...
// - (CGRect)_selectionRectForSelectedTimeRange:(CDStruct_73a5d3ca)arg1;
