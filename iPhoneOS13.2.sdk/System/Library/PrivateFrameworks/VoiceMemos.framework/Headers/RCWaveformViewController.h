...
@class NSLayoutConstraint, NSMutableArray, NSTimer, RCLayoutMetrics, RCUIConfiguration, RCWaveformDataSource, RCWaveformRenderer, RCWaveformScrollView, RCWaveformSelectionOverlay, UIPinchGestureRecognizer, UIView;
...
@property(nonatomic) NSUInteger currentTimeDisplayOptions; // @synthesize currentTimeDisplayOptions=_currentTimeDisplayOptions;
