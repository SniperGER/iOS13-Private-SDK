...
@class EDMessagePersistence, EDPersistenceDatabase, EDPersistenceHookRegistry, EDThreadScopeManager, EFDebouncer, EMBlockedSenderManager, NSMutableArray, NSMutableSet;
...
- (id)_recipientAddressesExpressionForRecipientType:(NSUInteger)arg1 messages:(id)arg2;
...
- (BOOL)_deleteRecipientsOfType:(NSUInteger)arg1 fromThreadWithDatabaseID:(id)arg2 messageThreadExpression:(id)arg3;
...
- (id)_recipientDatabaseIDsAndDatesForMessages:(id)arg1 recipientType:(NSUInteger)arg2;
- (id)_recipientDatabaseIDsAndDatesForWrappedMessages:(id)arg1 recipientType:(NSUInteger)arg2;
- (id)_recipientDatabaseIDsAndDatesForThreadWithObjectID:(id)arg1 recipientType:(NSUInteger)arg2;
...
- (id)_recipientsOfType:(NSUInteger)arg1 fromMessagesForThreadObjectID:(id)arg2;
- (id)_recipientsOfType:(NSUInteger)arg1 forThreadDatabaseID:(id)arg2;
...
- (void)threadObjectIDsForThreadScope:(id)arg1 sortDescriptors:(id)arg2 initialBatchSize:(NSUInteger)arg3 journaledObjectIDs:(id)arg4 batchBlock:(CDUnknownBlockType)arg5;
...
- (NSUInteger)persistenceStateForThreadScope:(id)arg1;
