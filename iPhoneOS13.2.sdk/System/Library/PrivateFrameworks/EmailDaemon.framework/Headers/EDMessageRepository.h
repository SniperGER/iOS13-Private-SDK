...
@class EDConversationPersistence, EDFetchController, EDMailboxPersistence, EDMailboxPredictionController, EDMessageChangeManager, EDMessagePersistence, EDPersistenceHookRegistry, EDThreadPersistence, EDVIPManager, NSConditionLock, NSHashTable, NSMutableDictionary;
...
- (id)requestRepresentationForMessageWithID:(id)arg1 requestID:(NSUInteger)arg2 options:(id)arg3 delegate:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;
...
- (void)performMessageChangeAction:(id)arg1 requestID:(NSUInteger)arg2 returnUndoAction:(BOOL)arg3 completionHandler:(CDUnknownBlockType)arg4;
- (void)messageListItemsForObjectIDs:(id)arg1 requestID:(NSUInteger)arg2 observationIdentifier:(id)arg3 loadSummaryForAdditionalObjectIDs:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;
