...
- (NSProgress *)requestRepresentationForMessageWithID:(EMMessageObjectID *)arg1 requestID:(NSUInteger)arg2 options:(EMContentRequestOptions *)arg3 delegate:(id <EMContentItemRequestDelegate>)arg4 completionHandler:(void (^)(id <_EMDistantContentRepresentation>, EMContentRepresentation *, NSError *))arg5;
- (void)performMessageChangeAction:(EMMessageChangeAction *)arg1 requestID:(NSUInteger)arg2 returnUndoAction:(BOOL)arg3 completionHandler:(void (^)(EMUndoMessageAction *))arg4;
- (void)messageListItemsForObjectIDs:(NSArray *)arg1 requestID:(NSUInteger)arg2 observationIdentifier:(EMObjectID *)arg3 loadSummaryForAdditionalObjectIDs:(NSArray *)arg4 completionHandler:(void (^)(NSArray *, NSDictionary *))arg5;
