...
- (_Bool)executeSQL:(id)arg1 errorHandler:(id /* block */)arg2;
- (_Bool)executeSQL:(id)arg1 indexBindings:(id)arg2 errorHandler:(id /* block */)arg3;
- (_Bool)executeSelectSQL:(id)arg1 bindings:(id /* block */)arg2 errorHandler:(id /* block */)arg3 rowHandler:(id /* block */)arg4;
