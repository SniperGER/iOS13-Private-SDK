...
@property(copy, nonatomic) id /* block */ work; // @synthesize work=_work;
@property(copy, nonatomic) id /* block */ canceledCallback; // @synthesize canceledCallback=_canceledCallback;
@property(copy, nonatomic) id /* block */ task; // @synthesize task=_task;
