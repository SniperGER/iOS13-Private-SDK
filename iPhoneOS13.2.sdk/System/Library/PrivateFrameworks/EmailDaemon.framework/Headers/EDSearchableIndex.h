...
- (void)reindexAllItemsWithOptions:(NSUInteger)arg1 acknowledgementHandler:(CDUnknownBlockType)arg2;
...
- (double)_throttleRequestedSize:(NSUInteger )arg1 targetTime:(double)arg2 action:(CDUnknownBlockType)arg3;
