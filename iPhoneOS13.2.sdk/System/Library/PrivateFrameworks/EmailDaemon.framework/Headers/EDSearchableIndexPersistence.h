...
- (id)_attachmentItemsFromAttachmentData:(id)arg1 limit:(NSUInteger)arg2 cancelationToken:(id)arg3;
- (id)_attachmentDataForItemsRequiringIndexingExcludingIdentifiers:(id)arg1 limit:(NSUInteger)arg2 cancelationToken:(id)arg3 connection:(id)arg4;
- (id)_messageIDTransactionIDDictionaryToVerifyUsingConnection:(id)arg1 count:(NSUInteger)arg2;
...
- (id)verificationDataSamplesForSearchableIndex:(id)arg1 count:(NSUInteger)arg2;
...
- (id)updatesForSearchableIndex:(id)arg1 excludingIdentifiers:(id)arg2 count:(NSUInteger)arg3 cancelationToken:(id)arg4;
