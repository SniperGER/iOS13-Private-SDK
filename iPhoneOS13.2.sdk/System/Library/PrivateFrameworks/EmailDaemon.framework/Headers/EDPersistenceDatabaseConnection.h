...
- (_Bool)performUsingTransaction:(_Bool)arg1 isWriter:(_Bool)arg2 transactionError:(id *)arg3 block:(id /* block */)arg4;
...
- (_Bool)_executePreparedStatement:(id)arg1 withBlock:(id /* block */)arg2 description:(id)arg3 error:(id *)arg4;
...
- (_Bool)executeSelectStatement:(id)arg1 withBlock:(id /* block */)arg2 error:(id *)arg3;
