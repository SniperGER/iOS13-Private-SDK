...
- (_Bool)performBlock:(id /* block */)arg1 isWriter:(_Bool)arg2 useTransaction:(_Bool)arg3;
- (_Bool)performDatabaseSetupUsingTransaction:(_Bool)arg1 block:(id /* block */)arg2;
- (_Bool)performWriteBlock:(id /* block */)arg1;
- (_Bool)performReadBlock:(id /* block */)arg1;
