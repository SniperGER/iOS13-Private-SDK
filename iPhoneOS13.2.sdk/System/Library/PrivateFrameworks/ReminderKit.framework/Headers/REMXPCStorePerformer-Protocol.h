...
- (void)saveAccountStorages:(NSArray *)arg1 listStorages:(NSArray *)arg2 reminderStorages:(NSArray *)arg3 changedKeys:(NSDictionary *)arg4 replicaManagers:(NSDictionary *)arg5 author:(NSString *)arg6 mode:(NSUInteger)arg7 synchronously:(BOOL)arg8 completion:(void (^)(NSError *))arg9;
