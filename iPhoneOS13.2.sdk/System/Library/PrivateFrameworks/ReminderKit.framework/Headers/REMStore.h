...
- (void)_saveAccountChangeItems:(id)arg1 listChangeItems:(id)arg2 reminderChangeItems:(id)arg3 author:(id)arg4 replicaManagerProvider:(id)arg5 synchronously:(_Bool)arg6 performer:(id)arg7 completion:(id /* block */)arg8;
- (id)_xpcSyncStorePerformerWithReason:(id)arg1 errorHandler:(id /* block */)arg2;
- (void)_enumerateAllListsIncludingGroups:(_Bool)arg1 withBlock:(id /* block */)arg2;
...
- (void)notifyOfInteractionWithPeople:(id)arg1 force:(_Bool)arg2 completion:(id /* block */)arg3;
- (void)notifyOfUserInterestInSiriSuggestedReminder:(id)arg1;
...
- (void)_triggerSyncWithReason:(id)arg1 forcingCloudKitReload:(_Bool)arg2 discretionary:(_Bool)arg3 completion:(id /* block */)arg4;
- (void)removeOrphanedAccountsWithCompletion:(id /* block */)arg1;
- (void)deleteAccountWithAccountID:(id)arg1 completion:(id /* block */)arg2;
- (void)updateAccountWithAccountID:(id)arg1 restartDA:(_Bool)arg2 completion:(id /* block */)arg3;
- (void)updateAccountWithAccountID:(id)arg1 completion:(id /* block */)arg2;
- (void)updateAccountsAndFetchMigrationState:(_Bool)arg1 completion:(id /* block */)arg2;
- (void)updateAccountsAndSync:(_Bool)arg1 completion:(id /* block */)arg2;
- (void)triggerSyncForDataAccessAccountsWithAccountIDs:(id)arg1;
- (void)triggerThrottledSyncWithReason:(id)arg1 discretionary:(_Bool)arg2 WithCompletion:(id /* block */)arg3;
