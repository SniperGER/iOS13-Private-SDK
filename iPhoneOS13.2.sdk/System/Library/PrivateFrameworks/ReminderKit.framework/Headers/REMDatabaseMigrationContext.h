...
@interface REMDatabaseMigrationContext : NSObject
{
    ...
    NSUInteger _lastReportedErrorStage;
...
@property(nonatomic) NSUInteger lastReportedErrorStage; // @synthesize lastReportedErrorStage=_lastReportedErrorStage;
...
- (void)_diagnosticReportWithStage:(NSUInteger)arg1 failureIdentifier:(id)arg2 error:(id)arg3;
- (void)reportMigrationDidFinishWithSuccess:(BOOL)arg1;
- (void)_postMigrationLocalAccountCleanup;
- (void)reportMigrationErrorWithIdentifier:(id)arg1 atStage:(NSUInteger)arg2 error:(id)arg3 objectLocator:(id)arg4;
