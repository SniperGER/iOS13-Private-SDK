...
@interface TTParagraphStyle : NSObject <NSSecureCoding, NSCopying, NSMutableCopying, TTModelAttributeComparable>
{
    ...
    NSUInteger _indent;
    NSUInteger _startingItemNumber;
}

+ (id)paragraphStyleNamed:(unsigned int)arg1;
+ (id)defaultParagraphStyle;
+ (BOOL)supportsSecureCoding;
+ (int)paragraphStyleAlignmentForTextAlignment:(NSUInteger)arg1;
+ (NSUInteger)textAlignmentForParagraphStyleAlignment:(int)arg1;
...
@property(nonatomic) NSUInteger startingItemNumber; // @synthesize startingItemNumber=_startingItemNumber;
@property(nonatomic) NSUInteger indent; // @synthesize indent=_indent;
...
- (id)listBulletInAttributedString:(id)arg1 atIndex:(NSUInteger)arg2;
