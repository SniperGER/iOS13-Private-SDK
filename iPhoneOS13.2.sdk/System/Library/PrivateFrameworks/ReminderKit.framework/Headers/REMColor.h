...
@property(readonly, nonatomic) NSUInteger colorRGBSpace; // @synthesize colorRGBSpace=_colorRGBSpace;
// - (void).cxx_destruct;
...
- (id)initWithRed:(double)arg1 green:(double)arg2 blue:(double)arg3 alpha:(double)arg4 colorSpace:(NSUInteger)arg5 daSymbolicColorName:(id)arg6 daHexString:(id)arg7 ckSymbolicColorName:(id)arg8;
