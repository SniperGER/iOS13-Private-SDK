...
@class NSMutableDictionary, NSSet, PVVisionHelper;
...
- (NSUInteger)numberOfMomentsInCommonBetweenPerson:(id)arg1 andPerson:(id)arg2;
- (NSUInteger)numberOfAssetsInCommonBetweenPersonAssetIdentifiers:(id)arg1 andPersonAssetIdentifiers:(id)arg2;
- (NSUInteger)numberOfAssetsInCommonBetweenPerson:(id)arg1 andPerson:(id)arg2;
