...
- (_Bool)pv_performChangesAndWait:(id /* block */)arg1 error:(id *)arg2;
...
- (float)distanceBetweenPerson:(id)arg1 andPerson:(id)arg2 useCommonMoments:(_Bool)arg3 minAgeType:(unsigned short *)arg4 updateBlock:(id /* block */)arg5 error:(id *)arg6;
- (float)distanceWithOverlapCheckBetweenPerson:(id)arg1 andPerson:(id)arg2 useCommonMoments:(_Bool)arg3 minAgeType:(unsigned short *)arg4 updateBlock:(id /* block */)arg5 error:(id *)arg6;
