...
@interface PVPersonPromoterProfile : NSObject
{
    ...
    NSUInteger _interestingPersonNormalDistributionsToMatch;
    NSUInteger _highlyInterestingPersonNormalDistributionsToMatch;
}

@property(nonatomic) NSUInteger highlyInterestingPersonNormalDistributionsToMatch; // @synthesize highlyInterestingPersonNormalDistributionsToMatch=_highlyInterestingPersonNormalDistributionsToMatch;
@property(nonatomic) NSUInteger interestingPersonNormalDistributionsToMatch; // @synthesize interestingPersonNormalDistributionsToMatch=_interestingPersonNormalDistributionsToMatch;
