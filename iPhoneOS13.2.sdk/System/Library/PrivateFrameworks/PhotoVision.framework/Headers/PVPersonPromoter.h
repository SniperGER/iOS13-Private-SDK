...
+ (void)setProcessed:(_Bool)arg1 forLibrary:(id)arg2;
+ (_Bool)hasProcessedForLibrary:(id)arg1;
...
- (_Bool)_updateSuggestedMeIdentifierWithPersons:(id)arg1 updateBlock:(id /* block */)arg2;
- (_Bool)_promoteInterestingPersons:(id)arg1 updateBlock:(id /* block */)arg2;
...
- (id)advancedStatus;
- (_Bool)promoteUnverifiedPersonsWithUpdateBlock:(id /* block */)arg1;
