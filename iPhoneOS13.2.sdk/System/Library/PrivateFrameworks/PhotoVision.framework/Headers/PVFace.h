...
+ (id)faceFromVNFaceObservation:(id)arg1 fromImageWithPixelWidth:(NSUInteger)arg2 pixelHeight:(NSUInteger)arg3 additionalVisionRequests:(id)arg4 faceAlgorithmUmbrellaVersion:(unsigned int)arg5 error:(id )arg6;
