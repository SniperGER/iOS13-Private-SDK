...
@property(copy, nonatomic) id /* block */ unlockCompletion; // @synthesize unlockCompletion=_unlockCompletion;
...
- (void)_setIconState:(long long)arg1 animated:(_Bool)arg2 options:(long long)arg3 force:(_Bool)arg4 completion:(id /* block */)arg5;
...
- (void)_dontCallThis_showLockIfNeededAnimated:(_Bool)arg1 force:(_Bool)arg2 completion:(id /* block */)arg3;
- (void)_updateIconViewStateAnimated:(_Bool)arg1 force:(_Bool)arg2 completion:(id /* block */)arg3;
...
- (void)setAuthenticated:(_Bool)arg1 completion:(id /* block */)arg2;
