...
- (_Bool)isPrefix:(id)arg1;
- (id)normalizeFullname:(id)arg1;
- (id)parseKoreanName:(id)arg1 normalize:(_Bool)arg2;
- (id)parseKoreanName:(id)arg1;
- (id)parseJapaneseName:(id)arg1 normalize:(_Bool)arg2;
- (id)parseJapaneseName:(id)arg1;
- (id)parseChineseName:(id)arg1 normalize:(_Bool)arg2;
...
- (id)parseFullnameWithDefaultHMMClassifier:(id)arg1 normalize:(_Bool)arg2 score:(double *)arg3;
