...
- (id)appendCGRect:(CGRect)arg1 counterpart:(CDUnknownBlockType)arg2;
- (id)appendCGSize:(CGSize)arg1 counterpart:(CDUnknownBlockType)arg2;
- (id)appendCGPoint:(CGPoint)arg1 counterpart:(CDUnknownBlockType)arg2;
...
- (id)appendSizeT:(NSUInteger)arg1 counterpart:(CDUnknownBlockType)arg2;
- (id)appendUnsignedInteger:(NSUInteger)arg1 counterpart:(CDUnknownBlockType)arg2;
