...
- (BOOL)_evaluateParentTransactionsWithSchedulingPolicy:(NSUInteger)arg1 evaluator:(CDUnknownBlockType)arg2;
...
- (id)_childTransactionsWithSchedulingPolicy:(NSUInteger)arg1;
...
- (id)_parentTransactionsWithSchedulingPolicy:(NSUInteger)arg1;
...
- (void)_addParentTransaction:(id)arg1 withSchedulingPolicy:(NSUInteger)arg2;
- (NSUInteger)_state;
- (BOOL)_inFinishedWorkingState;
- (BOOL)_isDoingWork;
- (void)_setState:(NSUInteger)arg1;
- (id)_descriptionForDebugging:(BOOL)arg1 indentLevel:(NSUInteger)arg2 visited:(id)arg3;
- (id)_descriptionForDebugging:(BOOL)arg1 indentLevel:(NSUInteger)arg2;
...
- (void)addChildTransaction:(id)arg1 withSchedulingPolicy:(NSUInteger)arg2;
