...
- (void)_preventTransactionCompletionForReason:(id)arg1 ignoringAuditHistory:(_Bool)arg2 andExecuteBlock:(id /* block */)arg3;
- (void)_notifyObserversOfCompletion;
- (void)_notifyObserversOfFinishedWork;
- (_Bool)_evaluateParentTransactionsWithSchedulingPolicy:(unsigned long long)arg1 evaluator:(id /* block */)arg2;
