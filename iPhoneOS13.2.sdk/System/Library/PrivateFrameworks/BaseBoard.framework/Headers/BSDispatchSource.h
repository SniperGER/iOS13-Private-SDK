...
- (void)resume;
- (void)dealloc;
// - (id)initWithType:(struct dispatch_source_type_s )arg1 handle:(NSUInteger)arg2 mask:(NSUInteger)arg3 queue:(id)arg4 configureSourceBlock:(CDUnknownBlockType)arg5;
