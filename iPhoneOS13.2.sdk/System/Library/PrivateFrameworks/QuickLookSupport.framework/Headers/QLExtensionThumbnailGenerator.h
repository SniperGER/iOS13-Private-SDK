...
- (void)generatePlatformImageThumbnailForExtensionThumbnailItem:(id)arg1 ofSize:(CGSize)arg2 minimumSize:(double)arg3 scale:(double)arg4 badgeType:(NSUInteger)arg5 completionBlock:(CDUnknownBlockType)arg6;
- (void)generateThumbnailForExtensionThumbnailItem:(id)arg1 ofSize:(CGSize)arg2 minimumSize:(double)arg3 scale:(double)arg4 badgeType:(NSUInteger)arg5 completionBlock:(CDUnknownBlockType)arg6;
