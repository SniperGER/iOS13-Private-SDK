...
- (_Bool)_performAction:(unsigned long long)arg1 withResult:(id /* block */)arg2;
...
- (_Bool)isRestricted;
- (_Bool)cancelWithResult:(id /* block */)arg1;
- (_Bool)resumeWithResult:(id /* block */)arg1;
- (_Bool)pauseWithResult:(id /* block */)arg1;
- (_Bool)prioritizeWithResult:(id /* block */)arg1;
