...
- (void)dealloc;
- (id)_initWithConfiguration:(id)arg1 singleton:(_Bool)arg2 needsDefaultPriority:(_Bool)arg3 mutable:(_Bool)arg4 displayType:(long long)arg5 mutableHandler:(id /* block */)arg6;
- (id)init;
