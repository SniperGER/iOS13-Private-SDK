...
- (void)fetchAuthModeWithContext:(AKAppleIDAuthenticationContext *)arg1 completion:(void (^)(NSUInteger, NSError *))arg2;
...
- (void)validateLoginCode:(NSUInteger)arg1 forAppleID:(NSString *)arg2 withCompletion:(void (^)(BOOL, NSError *))arg3;
