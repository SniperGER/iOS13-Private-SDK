...
- (void)_gkWriteXattrBytes:(void )arg1 count:(NSUInteger)arg2 withName:(id)arg3 path:(id)arg4;
- (long long)_gkReadXattrBytes:(void )arg1 count:(NSUInteger)arg2 withName:(id)arg3 path:(id)arg4;
@end
