...
@property(copy, nonatomic) id /* block */ chooseHostCompletion; // @synthesize chooseHostCompletion=_chooseHostCompletion;
...
- (void)withEventQueueForPlayer:(id)arg1 createIfNeeded:(_Bool)arg2 perform:(id /* block */)arg3;
