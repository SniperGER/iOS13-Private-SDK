...
@interface GKMatch : NSObject <GKSessionDelegate, GKSessionPrivateDelegate>
{
    ...
    id /* CDUnknownBlockType */ _chooseHostCompletion;
}

@property(nonatomic) BOOL recentlyBecameActive; // @synthesize recentlyBecameActive=_recentlyBecameActive;
@property(copy, nonatomic) id /* CDUnknownBlockType */ chooseHostCompletion; // @synthesize chooseHostCompletion=_chooseHostCompletion;
...
@property(readonly, nonatomic) NSUInteger expectedPlayerCount; // @synthesize expectedPlayerCount=_expectedPlayerCount;
