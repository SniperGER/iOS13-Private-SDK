...
- (oneway void)getOverallFlowRateWithHandler:(void (^)(NSUInteger, NSError *))arg1;
- (oneway void)getFlowRateForPlayerGroup:(long long)arg1 handler:(void (^)(NSUInteger, NSError *))arg2;
