...
- (void)loadGamesPlayedIncludingInstalledGames:(_Bool)arg1 completionHandler:(id /* block */)arg2;
- (void)loadGamesPlayed:(id /* block */)arg1;
- (void)loadRecentMatchesForGame:(id)arg1 block:(id /* block */)arg2;
- (void)loadCommonFriends:(_Bool)arg1 asPlayersWithCompletionHandler:(id /* block */)arg2;
