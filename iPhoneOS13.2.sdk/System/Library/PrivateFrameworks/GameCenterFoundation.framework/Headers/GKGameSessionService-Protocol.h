...
@protocol GKGameSessionService 
- (oneway void)sendMessageForSessionWithID:(NSString *)arg1 withLocalizedFormatKey:(NSString *)arg2 arguments:(NSArray *)arg3 userMessage:(NSString *)arg4 data:(NSData *)arg5 recipientIDs:(NSArray *)arg6 badgePlayers:(_Bool)arg7 handler:(void (^)(GKGameSession *, NSError *))arg8;
- (oneway void)setBadged:(_Bool)arg1 forPlayerIDs:(NSArray *)arg2 forSessionWithIdentifier:(NSString *)arg3 handler:(void (^)(GKGameSession *, NSError *))arg4;
- (oneway void)fetchShareURLForSessionWithIdentifier:(NSString *)arg1 handler:(void (^)(NSURL *, NSError *))arg2;
- (oneway void)sendData:(NSData *)arg1 reliably:(_Bool)arg2 forSessionWithIdentifier:(NSString *)arg3 handler:(void (^)(NSError *))arg4;
