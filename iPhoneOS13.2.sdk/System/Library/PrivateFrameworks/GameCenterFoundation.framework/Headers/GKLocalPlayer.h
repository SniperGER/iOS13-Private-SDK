...
@class GKEventEmitter, GKInvite, NSInvocation, UIAlertView;
...
@interface GKLocalPlayer : GKPlayer <NSCoding, NSSecureCoding, GKSavedGameListener>
{
    ...
    id /* CDUnknownBlockType */ _validateAccountCompletionHandler;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ validateAccountCompletionHandler; // @synthesize validateAccountCompletionHandler=_validateAccountCompletionHandler;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ authenticateHandler;
- (void)callAuthHandlerWithError:(id)arg1;
@property(nonatomic) BOOL insideAuthenticatorInvocation;
- (void)updateLoginStatus:(NSUInteger)arg1 completionHandler:(CDUnknownBlockType)arg2;
