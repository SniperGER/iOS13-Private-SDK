...
@property(copy) id /* block */ recipientResponseHandler; // @synthesize recipientResponseHandler=_recipientResponseHandler;
@property(copy) id /* block */ inviteeResponseHandler; // @synthesize inviteeResponseHandler=_inviteeResponseHandler;
