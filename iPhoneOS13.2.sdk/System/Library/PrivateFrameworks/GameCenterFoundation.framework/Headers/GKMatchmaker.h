...
@interface GKMatchmaker : NSObject
{
    ...
    int _matching;
    id /* CDUnknownBlockType */ _inviteHandler;
    GKMatch *_match;
    ...
    id /* CDUnknownBlockType */ _nearbyPlayerHandler;
    id /* CDUnknownBlockType */ _nearbyPlayerIDHandler;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ nearbyPlayerIDHandler; // @synthesize nearbyPlayerIDHandler=_nearbyPlayerIDHandler;
@property(copy, nonatomic) id /* CDUnknownBlockType */ nearbyPlayerHandler; // @synthesize nearbyPlayerHandler=_nearbyPlayerHandler;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ recipientResponseHandler; // @synthesize recipientResponseHandler=_recipientResponseHandler;
@property(copy, nonatomic) id /* CDUnknownBlockType */ inviteeResponseHandler; // @synthesize inviteeResponseHandler=_inviteeResponseHandler;
@property(retain, nonatomic) GKMatch *match; // @synthesize match=_match;
@property(copy, nonatomic) id /* CDUnknownBlockType */ inviteHandler; // @synthesize inviteHandler=_inviteHandler;
...
- (void)queryPlayerGroupActivity:(NSUInteger)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;
