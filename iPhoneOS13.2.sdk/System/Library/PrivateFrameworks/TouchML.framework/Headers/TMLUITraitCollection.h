...
@class NSArray, NSMutableDictionary, NSMutableOrderedSet, NSString, UITraitCollection;
...
@property(readonly, nonatomic) NSUInteger specificity; // @synthesize specificity=_specificity;
