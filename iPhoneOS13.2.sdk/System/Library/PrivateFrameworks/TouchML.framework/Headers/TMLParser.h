...
- (void)addToken:(NSUInteger)arg1 text:(const char )arg2;
- (BOOL)consumeToken:(NSUInteger)arg1 text:(const char )arg2;
- (void)teardown;
- (void)setup;
- (BOOL)parseTokens:(id)arg1 startingLine:(NSUInteger)arg2;
