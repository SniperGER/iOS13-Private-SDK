...
- (_Bool)_displayAndCheckForDrawable:(_Bool)arg1 WithCompletion:(id /* block */)arg2;
...
- (_Bool)_prepareAndRenderForTime:(double)arg1 inGroup:(id)arg2 checkForDrawable:(_Bool)arg3 completion:(id /* block */)arg4;
- (void)dealloc;
- (id)initWithFrame:(struct CGRect)arg1;
- (_Bool)renderSynchronouslyWithImageQueueDiscard:(_Bool)arg1 inGroup:(id)arg2 completion:(id /* block */)arg3;
