...
@class WFBasicTableItem, WFSSHKeyPair, WFTableDataSource, WFTableSection;
...
- (void)showHashWithType:(NSUInteger)arg1;
- (id)localizedDisplayNameForType:(NSUInteger)arg1;
