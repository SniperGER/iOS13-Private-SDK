...
@class NSArray, NSDictionary, NSMutableSet, NSSet, NSURL, SPCoreSpotlightInteractionHandler, SPCoreSpotlightTask;
...
+ (void)shutdown;
+ (void)deactivate;
+ (void)setMemoryPressureStatus:(NSUInteger)arg1;
...
@property(nonatomic) BOOL updatePersonas; // @synthesize updatePersonas=_updatePersonas;
