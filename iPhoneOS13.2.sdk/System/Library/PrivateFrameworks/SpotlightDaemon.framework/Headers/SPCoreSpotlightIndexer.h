...
@interface SPCoreSpotlightIndexer : NSObject <UMUserPersonaUpdateObserver, MDIndexer>
{
    ...
    id ationStartObserver;
    id ationFinishObserver;
...
@property(retain, nonatomic) id tionFinishObserver; // @synthesize dataMigrationFinishObserver=_dataMigrationFinishObserver;
@property(retain, nonatomic) id tionStartObserver; // @synthesize dataMigrationStartObserver=_dataMigrationStartObserver;
...
- (void)_migrateIndexExtensionsWithEnumerator:(id)arg1 forced:(_Bool)arg2 migratedBundleIds:(id)arg3 completionHandler:(id /* block */)arg4;
...
- (void)fetchAttributes:(id)arg1 protectionClass:(id)arg2 bundleID:(id)arg3 identifiers:(id)arg4 includeParents:(_Bool)arg5 completionHandler:(id /* block */)arg6;
...
- (void)deleteAllSearchableItemsWithBundleID:(id)arg1 protectionClass:(id)arg2 shouldGC:(_Bool)arg3 completionHandler:(id /* block */)arg4;
...
- (void)mergeWithProtectionClasses:(id)arg1 power:(_Bool)arg2 completionHandler:(id /* block */)arg3;
