...
- (void)_deleteAllSearchableItemsWithBundleID:(id)arg1 protectionClass:(id)arg2 shouldGC:(_Bool)arg3 options:(long long)arg4 completionHandler:(id /* block */)arg5;
...
- (void)fetchAttributes:(id)arg1 protectionClass:(id)arg2 bundleID:(id)arg3 identifiers:(id)arg4 includeParents:(_Bool)arg5 reply:(id)arg6 completionHandler:(id /* block */)arg7;
