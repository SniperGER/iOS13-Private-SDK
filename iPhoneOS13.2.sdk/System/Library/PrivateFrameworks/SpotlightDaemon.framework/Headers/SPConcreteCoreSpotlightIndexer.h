...
- (_Bool)_startInternalQueryWithIndex:(struct __SI *)arg1 query:(id)arg2 fetchAttributes:(id)arg3 forBundleIds:(id)arg4 resultsHandler:(id /* block */)arg5;
- (void)powerStateChanged;
- (void)attributesForBundleId:(id)arg1 identifier:(id)arg2 completion:(id /* block */)arg3;
- (void)fetchAttributes:(id)arg1 bundleID:(id)arg2 identifiers:(id)arg3 includeParents:(_Bool)arg4 completion:(id /* block */)arg5;
- (void)fetchAttributes:(id)arg1 bundleID:(id)arg2 identifiers:(id)arg3 includeParents:(_Bool)arg4 completionHandler:(id /* block */)arg5;
...
- (void)deleteAllSearchableItemsForBundleID:(id)arg1 shouldGC:(_Bool)arg2 completionHandler:(id /* block */)arg3;
...
- (void)scheduleMaintenance:(id /* block */)arg1 description:(id)arg2 forDarkWake:(_Bool)arg3;
