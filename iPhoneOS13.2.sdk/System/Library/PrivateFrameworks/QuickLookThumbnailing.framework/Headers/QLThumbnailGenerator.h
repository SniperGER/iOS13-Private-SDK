...
+ (void)generateThumbnailOfMaximumSize:(CGSize)arg1 scale:(double)arg2 forURL:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;
+ (id)sharedGenerator;
+ (void)initialize;
...
@property(nonatomic) NSUInteger batchingCount; // @synthesize batchingCount=_batchingCount;
