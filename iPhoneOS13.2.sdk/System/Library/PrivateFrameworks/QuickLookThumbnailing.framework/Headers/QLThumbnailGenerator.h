...
+ (void)generateThumbnailOfMaximumSize:(struct CGSize)arg1 scale:(double)arg2 forURL:(id)arg3 completionHandler:(id /* block */)arg4;
+ (id)sharedGenerator;
+ (void)initialize;
...
- (void)saveBestRepresentationForRequest:(id)arg1 toFileAtURL:(id)arg2 withContentType:(id)arg3 allowingThumbnailDownloads:(_Bool)arg4 completionHandler:(id /* block */)arg5;
