...
@interface QLThumbnailGenerationRequest : NSObject <NSCopying, NSSecureCoding>
{
    ...
    double _scale;
    NSUInteger _representationTypes;
    ...
    id /* CDUnknownBlockType */ _statusBlock;
    FPSandboxingURLWrapper *_saveURLSandboxWrapper;
    NSString *_saveURLContentType;
    NSUInteger _typesForWhichUpdateBlockHasBeenCalled;
...
@property(nonatomic) NSUInteger typesForWhichUpdateBlockHasBeenCalled; // @synthesize typesForWhichUpdateBlockHasBeenCalled=_typesForWhichUpdateBlockHasBeenCalled;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ statusBlock; // @synthesize statusBlock=_statusBlock;
...
@property(nonatomic) NSUInteger representationTypes; // @synthesize representationTypes=_representationTypes;
...
- (id)equivalentFPItemRequestWithItem:(id)arg1 representationTypes:(NSUInteger)arg2;
...
- (id)initWithFPItem:(id)arg1 size:(CGSize)arg2 scale:(double)arg3 representationTypes:(NSUInteger)arg4;
- (id)initWithFileAtURL:(id)arg1 size:(CGSize)arg2 scale:(double)arg3 representationTypes:(NSUInteger)arg4;
- (id)initWithSize:(CGSize)arg1 scale:(double)arg2 representationTypes:(NSUInteger)arg3;
