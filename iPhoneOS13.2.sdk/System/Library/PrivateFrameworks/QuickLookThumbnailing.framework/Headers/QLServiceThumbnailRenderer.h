...
- (void)_drawInCurrentContextOfSize:(CGSize)arg1 drawingBlock:(CDUnknownBlockType)arg2;
- (void)_drawInContextOfSize:(CGSize)arg1 drawingBlock:(CDUnknownBlockType)arg2;
