...
- (void)sendProgress:(id)arg1 progressDidChange:(float)arg2 sendingMessages:(id)arg3 sendCount:(NSUInteger)arg4 totalCount:(NSUInteger)arg5 finished:(BOOL)arg6;
...
- (void)_addParticipants:(id)arg1 withState:(NSUInteger)arg2;
- (void)remove;
...
- (void)updateMessage:(id)arg1 flags:(NSUInteger)arg2;
...
- (NSUInteger)stateForParticipant:(id)arg1;
...
- (BOOL)hasSurfRequestForPaymentType:(NSUInteger)arg1;
- (NSUInteger)paymentTypeForMessage:(id)arg1;
- (void)_resetChatIdToLastMessageItemMap;
- (void)_handleMessageGUIDDeletions:(id)arg1;
- (void)_setParticipantState:(NSUInteger)arg1 forHandles:(id)arg2 quietly:(BOOL)arg3;
- (void)_setParticipantState:(NSUInteger)arg1 forHandle:(id)arg2 quietly:(BOOL)arg3;
...
- (id)_archivedItemsToReplace:(id)arg1 numberOfMessagesBeforeGUID:(NSUInteger)arg2 numberOfMessagesAfterGUID:(NSUInteger)arg3;
- (void)_insertHistoricalMessages:(id)arg1 queryID:(id)arg2 isRefresh:(BOOL)arg3 isHistoryQuery:(BOOL)arg4 limit:(NSUInteger)arg5 numberOfMessagesBeforeGUID:(NSUInteger)arg6 numberOfMessagesAfterGUID:(NSUInteger)arg7;
- (void)_insertHistoricalMessages:(id)arg1 queryID:(id)arg2 isRefresh:(BOOL)arg3 isHistoryQuery:(BOOL)arg4 limit:(NSUInteger)arg5;
...
- (void)_setDBFailedCount:(NSUInteger)arg1;
- (void)_setDBUnreadCount:(NSUInteger)arg1 postNotification:(BOOL)arg2;
- (void)_setDBUnreadCount:(NSUInteger)arg1;
...
- (id)loadUnreadMessagesWithLimit:(NSUInteger)arg1 fallbackToMessagesUpToGUID:(id)arg2;
- (id)loadFrequentRepliesLimit:(NSUInteger)arg1 loadImmediately:(BOOL)arg2;
- (id)loadMessagesBeforeAndAfterGUID:(id)arg1 numberOfMessagesToLoadBeforeGUID:(NSUInteger)arg2 numberOfMessagesToLoadAfterGUID:(NSUInteger)arg3 loadImmediately:(BOOL)arg4;
- (id)loadMessagesUpToGUID:(id)arg1 date:(id)arg2 limit:(NSUInteger)arg3 loadImmediately:(BOOL)arg4;
- (id)loadMessagesBeforeDate:(id)arg1 limit:(NSUInteger)arg2 loadImmediately:(BOOL)arg3;
- (id)loadMessagesBeforeDate:(id)arg1 limit:(NSUInteger)arg2;
- (id)loadMessagesUpToGUID:(id)arg1 limit:(NSUInteger)arg2;
