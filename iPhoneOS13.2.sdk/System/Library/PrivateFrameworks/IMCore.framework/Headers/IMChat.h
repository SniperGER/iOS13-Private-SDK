...
- (id)_performQueryWithKey:(id)arg1 loadImmediately:(_Bool)arg2 block:(id /* block */)arg3;
- (id)_performQueryWithKey:(id)arg1 loadImmediately:(_Bool)arg2 block:(id /* block */)arg3 completion:(id /* block */)arg4;
...
- (void)_updateChatItemsWithReason:(id)arg1 block:(id /* block */)arg2 shouldPost:(_Bool)arg3;
