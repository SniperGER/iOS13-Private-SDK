...
@property(readonly, nonatomic) NSUInteger vcCapabilities; // @synthesize vcCapabilities=_vcCapabilities;
...
- (void)didPerformAdditionalStorageRequiredCheckWithSuccess:(BOOL)arg1 additionalStorageRequired:(NSUInteger)arg2 forAccountId:(id)arg3 error:(id)arg4;
...
- (void)account:(id)arg1 defaults:(id)arg2 blockList:(id)arg3 allowList:(id)arg4 blockingMode:(unsigned int)arg5 blockIdleStatus:(BOOL)arg6 status:(id)arg7 capabilities:(NSUInteger)arg8 serviceLoginStatus:(unsigned int)arg9 loginStatusMessage:(id)arg10;
...
- (void)account:(id)arg1 status:(id)arg2 capabilities:(NSUInteger)arg3 serviceLoginStatus:(unsigned int)arg4 loginStatusMessage:(id)arg5;
...
- (void)fileTransfer:(id)arg1 updatedWithCurrentBytes:(NSUInteger)arg2 totalBytes:(NSUInteger)arg3 averageTransferRate:(NSUInteger)arg4;
...
- (void)account:(id)arg1 capabilitiesChanged:(NSUInteger)arg2;
