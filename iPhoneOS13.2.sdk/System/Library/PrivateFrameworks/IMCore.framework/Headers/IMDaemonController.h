...
+ (id)sharedController;
+ (id)sharedInstance;
@property(copy, nonatomic) id /* block */ prewarmingBlock; // @synthesize prewarmingBlock=_prewarmingBlock;
...
- (void)killDaemon;
- (void)_blockUntilSendQueueIsEmpty;
- (_Bool)_makeConnectionWithLaunch:(_Bool)arg1 completionBlock:(id /* block */)arg2;
