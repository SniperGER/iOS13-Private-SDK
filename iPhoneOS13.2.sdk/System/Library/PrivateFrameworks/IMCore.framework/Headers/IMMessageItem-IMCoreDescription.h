...
+ (Class)contextClass;
- (id)descriptionForPurpose:(long long)arg1 isGroupMessage:(_Bool)arg2 messageDataSource:(id /* block */)arg3 attachmentDataSource:(id /* block */)arg4;
- (id)descriptionForPurpose:(long long)arg1 isGroupMessage:(_Bool)arg2 senderDisplayName:(id)arg3 messageDataSource:(id /* block */)arg4 attachmentDataSource:(id /* block */)arg5;
