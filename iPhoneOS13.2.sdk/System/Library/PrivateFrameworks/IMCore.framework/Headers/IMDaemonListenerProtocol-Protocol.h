...
- (void)didPerformAdditionalStorageRequiredCheckWithSuccess:(BOOL)arg1 additionalStorageRequired:(NSUInteger)arg2 forAccountId:(NSString *)arg3 error:(NSError *)arg4;
- (void)didAttemptToSetEnabledTo:(BOOL)arg1 result:(BOOL)arg2;
- (void)returnMOCEnabledState:(NSUInteger)arg1;
...
- (void)fileTransfer:(NSString *)arg1 updatedWithCurrentBytes:(NSUInteger)arg2 totalBytes:(NSUInteger)arg3 averageTransferRate:(NSUInteger)arg4;
...
- (void)frequentRepliesQuery:(NSString *)arg1 chatID:(NSString *)arg2 services:(NSArray *)arg3 finishedWithResult:(NSArray *)arg4 limit:(NSUInteger)arg5;
...
- (void)pagedHistoryQuery:(NSString *)arg1 chatID:(NSString *)arg2 services:(NSArray *)arg3 numberOfMessagesBefore:(NSUInteger)arg4 numberOfMessagesAfter:(NSUInteger)arg5 finishedWithResult:(NSArray *)arg6;
- (void)historyQuery:(NSString *)arg1 chatID:(NSString *)arg2 services:(NSArray *)arg3 finishedWithResult:(NSArray *)arg4 limit:(NSUInteger)arg5;
...
- (void)account:(NSString *)arg1 capabilitiesChanged:(NSUInteger)arg2;
...
- (void)account:(NSString *)arg1 defaults:(NSDictionary *)arg2 blockList:(NSArray *)arg3 allowList:(NSArray *)arg4 blockingMode:(unsigned int)arg5 blockIdleStatus:(BOOL)arg6 status:(NSDictionary *)arg7 capabilities:(NSUInteger)arg8 serviceLoginStatus:(unsigned int)arg9 loginStatusMessage:(NSString *)arg10;
