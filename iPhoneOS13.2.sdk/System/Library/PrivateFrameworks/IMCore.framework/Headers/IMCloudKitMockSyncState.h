...
@interface IMCloudKitMockSyncState : NSObject
{
    ...
    NSUInteger _IMCloudKitSyncControllerSyncState;
...
@property NSUInteger IMCloudKitSyncControllerSyncState; // @synthesize IMCloudKitSyncControllerSyncState=_IMCloudKitSyncControllerSyncState;
