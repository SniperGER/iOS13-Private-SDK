...
@interface IMCloudKitHookTestSingleton : IMSingletonOverride
{
    ...
    NSUInteger _syncControllerSyncState;
    long long _syncType;
...
@property(nonatomic) NSUInteger syncControllerSyncState; // @synthesize syncControllerSyncState=_syncControllerSyncState;
...
- (void)setControllerSyncState:(NSUInteger)arg1;
