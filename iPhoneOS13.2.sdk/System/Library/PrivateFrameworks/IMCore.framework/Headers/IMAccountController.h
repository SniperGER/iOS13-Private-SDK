...
- (id)bestAccountWithCapability:(NSUInteger)arg1;
...
- (id)connectedAccountsWithCapability:(NSUInteger)arg1;
- (id)operationalAccountsWithCapability:(NSUInteger)arg1;
- (id)accountsWithCapability:(NSUInteger)arg1;
