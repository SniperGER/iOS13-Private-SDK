...
- (void)setCloudKitSyncEnabled:(_Bool)arg1 withCompletion:(id /* block */)arg2;
- (void)setCloudKitSyncEnabled:(_Bool)arg1;
- (void)fetchSyncStateAfterClearingErrorsWithRepairSuccess:(_Bool)arg1 completion:(id /* block */)arg2;
