...
+ (void)handlesForPersons:(id)arg1 useBestHandle:(_Bool)arg2 useExtendedAsyncLookup:(_Bool)arg3 completion:(id /* block */)arg4;
+ (void)validHandlesForPersons:(id)arg1 useExtendedAsyncLookup:(_Bool)arg2 completion:(id /* block */)arg3;
+ (void)validHandlesForPersons:(id)arg1 completion:(id /* block */)arg2;
+ (void)bestHandlesForPersons:(id)arg1 useExtendedAsyncLookup:(_Bool)arg2 completion:(id /* block */)arg3;
