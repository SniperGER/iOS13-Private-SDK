...
@property(readonly, nonatomic) NSUInteger loginStatus; // @synthesize loginStatus=_loginStatus;
...
@property(readonly, nonatomic) NSUInteger myStatus; // @synthesize myStatus=_myStatus;
...
- (void)setIMAccountLoginStatus:(NSUInteger)arg1 errorMessage:(id)arg2 reason:(int)arg3;
...
- (void)updateCapabilities:(NSUInteger)arg1;
