...
@interface IMChatRegistry : NSObject <TUConversationManagerDelegate, NSFastEnumeration>
{
    ...
    NSUInteger _defaultNumberOfMessagesToLoad;
    NSUInteger _daemonUnreadCount;
...
@property(nonatomic, setter=_setDefaultNumberOfMessagesToLoad:) NSUInteger _defaultNumberOfMessagesToLoad; // @synthesize _defaultNumberOfMessagesToLoad;
// - (void).cxx_destruct;
...
- (void)enumerateAllChatsAndAttachmentSizesWithOptions:(NSUInteger)arg1 usingBlock:(CDUnknownBlockType)arg2;
...
- (void)_chat_loadUnreadMessages:(id)arg1 limit:(NSUInteger)arg2 fallbackGUID:(id)arg3 queryId:(id)arg4;
- (void)_chat_loadFrequentReplies:(id)arg1 limit:(NSUInteger)arg2 queryID:(id)arg3;
...
- (void)_chat_loadPagedHistory:(id)arg1 numberOfMessagesBefore:(NSUInteger)arg2 numberOfMessagesAfter:(NSUInteger)arg3 messageGUID:(id)arg4 queryID:(id)arg5;
- (void)_chat_loadHistory:(id)arg1 limit:(NSUInteger)arg2 beforeGUID:(id)arg3 afterGUID:(id)arg4 queryID:(id)arg5;
...
- (void)frequentRepliesQuery:(id)arg1 finishedWithResult:(id)arg2 limit:(NSUInteger)arg3;
- (void)frequentRepliesQuery:(id)arg1 chatID:(id)arg2 services:(id)arg3 finishedWithResult:(id)arg4 limit:(NSUInteger)arg5;
...
- (void)pagedHistoryQuery:(id)arg1 chatID:(id)arg2 services:(id)arg3 numberOfMessagesBefore:(NSUInteger)arg4 numberOfMessagesAfter:(NSUInteger)arg5 finishedWithResult:(id)arg6;
- (void)historyQuery:(id)arg1 chatID:(id)arg2 services:(id)arg3 finishedWithResult:(id)arg4 limit:(NSUInteger)arg5;
- (void)_checkIfItemIsCorrupt:(id)arg1;
- (void)_checkLimitAndSetMessagesToKeepLoadedIfNeeded:(NSUInteger)arg1 chat:(id)arg2;
