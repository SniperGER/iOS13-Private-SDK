...
- (void)__handleMergedChatReconstructions:(id)arg1 fullReload:(_Bool)arg2;
...
- (void)_updateInfo:(id)arg1 forGUID:(id)arg2 updatingUnreadCount:(_Bool)arg3 shouldPostUnreadNotification:(_Bool)arg4;
