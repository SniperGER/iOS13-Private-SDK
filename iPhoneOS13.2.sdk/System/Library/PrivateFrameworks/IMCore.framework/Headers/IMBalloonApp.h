...
@interface IMBalloonApp : NSObject
{
    ...
    NSString *_version;
    id <PKPlugIn> _plugin;
    NSUInteger _presentationContexts;
}

+ (NSUInteger)presentationContextsForInfoPlistArray:(id)arg1 isStickerPackOnly:(BOOL)arg2;
...
@property(nonatomic) NSUInteger presentationContexts; // @synthesize presentationContexts=_presentationContexts;
