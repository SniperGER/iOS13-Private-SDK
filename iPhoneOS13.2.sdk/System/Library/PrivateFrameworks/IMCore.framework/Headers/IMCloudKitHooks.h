...
- (void)_didPerformAdditionalStorageRequiredCheckWithSuccess:(BOOL)arg1 additionalStorageRequired:(NSUInteger)arg2 forAccountId:(id)arg3 error:(id)arg4;
...
- (BOOL)isStartingSync;
- (void)initiateSync;
- (void)_requestMOCEnabledReturned:(NSUInteger)arg1;
