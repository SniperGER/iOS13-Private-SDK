...
- (void)_attemptBackupRecoveryByPromptingForRemoteSecretWithLocalSecret:(id)arg1 localSecretType:(NSUInteger)arg2 useCachedSecret:(BOOL)arg3 circleJoinResult:(id)arg4 completion:(CDUnknownBlockType)arg5;
- (void)_attemptBackupRecoveryWithLocalSecret:(id)arg1 type:(NSUInteger)arg2 useCachedSecret:(BOOL)arg3 circleJoinResult:(id)arg4 completion:(CDUnknownBlockType)arg5;
