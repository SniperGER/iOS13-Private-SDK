...
- (void)setUserVisibleKeychainSyncEnabled:(_Bool)arg1 withCompletion:(id /* block */)arg2;
- (void)isUserVisibleKeychainSyncEnabledWithCompletion:(id /* block */)arg1;
- (void)hasLocalSecretWithCompletion:(id /* block */)arg1;
- (void)isICDPEnabledForDSID:(id)arg1 checkWithServer:(_Bool)arg2 completion:(id /* block */)arg3;
