...
@interface MCDNowPlayingViewController : UIViewController <CARSessionObserving, MCDNowPlayingContentManagerDelegate>
{
    ...
    id /* CDUnknownBlockType */ _albumViewControllerProvider;
}

@property(copy, nonatomic) id /* CDUnknownBlockType */ albumViewControllerProvider; // @synthesize albumViewControllerProvider=_albumViewControllerProvider;
