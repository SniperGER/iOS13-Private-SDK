...
@property(copy, nonatomic) id /* block */ containerCompletion; // @synthesize containerCompletion=_containerCompletion;
@property(copy, nonatomic) id /* block */ playbackCompletion; // @synthesize playbackCompletion=_playbackCompletion;
...
- (void)getChildrenAtIndexPath:(id)arg1 inRange:(struct _NSRange)arg2 completion:(id /* block */)arg3;
