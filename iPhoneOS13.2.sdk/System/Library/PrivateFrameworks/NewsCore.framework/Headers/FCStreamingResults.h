...
- (void)fetchObjectsUpToCount:(NSUInteger)arg1 qualityOfService:(long long)arg2 batchSize:(NSUInteger)arg3 completion:(CDUnknownBlockType)arg4;
- (void)fetchAllObjectsWithBatchSize:(NSUInteger)arg1 qualityOfService:(long long)arg2 completion:(CDUnknownBlockType)arg3;
- (void)fetchObjectsUpToCount:(NSUInteger)arg1 qualityOfService:(long long)arg2 completion:(CDUnknownBlockType)arg3;
- (void)fetchObjectsUpToCount:(NSUInteger)arg1 completion:(CDUnknownBlockType)arg2;
