...
@property(copy, nonatomic) id /* block */ valueEqualityTest; // @synthesize valueEqualityTest=_valueEqualityTest;
...
@property(copy, nonatomic) id /* block */ willFetchBlock; // @synthesize willFetchBlock=_willFetchBlock;
- (id)inputManagers;
