...
@class FCMTWriterLock, NSMutableDictionary, NSSet;
...
- (BOOL)_markArticle:(id)arg1 withLikingStatus:(NSUInteger)arg2;
- (BOOL)markArticle:(id)arg1 withLikingStatus:(NSUInteger)arg2;
- (NSUInteger)likingStatusForArticleID:(id)arg1;
- (BOOL)_markArticleAsSeenWithArticleID:(id)arg1 articleVersion:(long long)arg2 historyItem:(id)arg3 modifiedHistoryFeaturesOut:(NSUInteger )arg4;
- (BOOL)_markArticleAsSeenWithHeadline:(id)arg1 historyItem:(id)arg2 modifiedHistoryFeaturesOut:(NSUInteger )arg3;
...
- (id)_sortedReadingHistoryItemsWithMaxCount:(NSUInteger)arg1;
- (id)allSortedArticleIDsInReadingHistory;
- (id)mostRecentlyReadArticlesWithMaxCount:(NSUInteger)arg1;
- (id)historyItemsForArticleIDs:(id)arg1;
- (NSUInteger)softMaxRecordCountWhenMigratingZoneName:(id)arg1;
