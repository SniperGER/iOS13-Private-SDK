...
- (int)_pbNotificationEntityPaidBundleSubscriptionStatusFromSubscriptionState:(NSUInteger)arg1;
- (id)_notificationEntitiyWithChannelIDs:(id)arg1 isPaid:(BOOL)arg2 paidBundleSubscriptionStatus:(NSUInteger)arg3 notificationType:(int)arg4;
- (id)_notificationEntitiesWithChannelIDs:(id)arg1 isPaid:(BOOL)arg2 paidBundleSubscriptionStatus:(NSUInteger)arg3 editorialChannelID:(id)arg4;
