...
@interface FCCKContentBatchedRefreshRecordsOperation : FCOperation
{
    ...
    id /* CDUnknownBlockType */ _refreshRecordsCompletionBlock;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ refreshRecordsCompletionBlock; // @synthesize refreshRecordsCompletionBlock=_refreshRecordsCompletionBlock;
