...
@interface FCFeedGroupEmittingOperation : FCOperation
{
    ...
    id /* CDUnknownBlockType */ _groupEmittingCompletionHandler;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ groupEmittingCompletionHandler; // @synthesize groupEmittingCompletionHandler=_groupEmittingCompletionHandler;
// - (void).cxx_destruct;
