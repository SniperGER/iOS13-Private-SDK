...
- (void)_fetchRemoteAppWidgetConfigurationIfNeededUseBackgroundRefreshRate:(_Bool)arg1 completionQueue:(id)arg2 completion:(id /* block */)arg3;
- (void)_refreshAppConfigurationWithConfigurationSettings:(id)arg1 force:(_Bool)arg2 completionQueue:(id)arg3 completion:(id /* block */)arg4;
- (void)_fetchAppConfigurationIfNeededWithCompletionQueue:(id)arg1 forceRefresh:(_Bool)arg2 completion:(id /* block */)arg3;
...
- (void)fetchAppWidgetConfigurationUseBackgroundRefreshRate:(_Bool)arg1 completion:(id /* block */)arg2;
