...
+ (id)fc_encryptionErrorWithCode:(NSUInteger)arg1 descriptionFormat:(id)arg2;
+ (id)fc_encryptionErrorWithCode:(NSUInteger)arg1 description:(id)arg2;
+ (id)fc_encryptionErrorWithCode:(NSUInteger)arg1;
...
+ (id)fc_requestDroppedErrorForDroppedFeeds:(NSUInteger)arg1 totalFeeds:(NSUInteger)arg2;
