...
{
    BOOL _cachedOnly;
    id /* CDUnknownBlockType */ _layeredCoverHandlesProvider;
    double _progress;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ layeredCoverHandlesProvider; // @synthesize layeredCoverHandlesProvider=_layeredCoverHandlesProvider;
