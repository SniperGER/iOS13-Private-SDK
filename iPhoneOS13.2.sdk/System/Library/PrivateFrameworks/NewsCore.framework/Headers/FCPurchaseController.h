...
- (void)performHTTPRequestForVerifyAccessTokenWithURL:(id)arg1 accessToken:(id)arg2 consumedArticleCount:(NSUInteger)arg3 completion:(CDUnknownBlockType)arg4;
- (void)verifyAccessTokenWithTagID:(id)arg1 accessToken:(id)arg2 consumedArticleCount:(NSUInteger)arg3 serialCompletion:(CDUnknownBlockType)arg4 callbackQueue:(id)arg5 completion:(CDUnknownBlockType)arg6;
...
- (void)updatePurchaseEntryToValid:(id)arg1 purchaseType:(NSUInteger)arg2;
...
- (void)addToPurchasedChannelsListWithTagID:(id)arg1 purchaseID:(id)arg2 purchaseType:(NSUInteger)arg3 purchaseValidationState:(NSUInteger)arg4 isNewsAppPurchase:(BOOL)arg5 lastVerificationTime:(id)arg6;
...
- (void)addExpiredPurchaseWithTagID:(id)arg1 purchaseID:(id)arg2 purchaseType:(NSUInteger)arg3 isNewsAppPurchase:(BOOL)arg4 expirationDate:(id)arg5;
- (void)addPurchaseWithTagID:(id)arg1 purchaseID:(id)arg2 purchaseType:(NSUInteger)arg3 isNewsAppPurchase:(BOOL)arg4;
...
- (void)dealloc;
- (id)initWithCloudContext:(id)arg1 keyValueStoreOption:(NSUInteger)arg2;
