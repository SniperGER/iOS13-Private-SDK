...
- (void)_entitlementCheckWithIgnoreCache:(_Bool)arg1 restorableBundleIAPs:(id)arg2 callbackQueue:(id)arg3 completion:(id /* block */)arg4 serialCompletion:(id /* block */)arg5;
- (void)performEntitlementCheckWithIgnoreCache:(_Bool)arg1 callbackQueue:(id)arg2 completion:(id /* block */)arg3;
...
- (void)shouldShowiTunesSignedOutAlertWithiTunesAccountName:(id)arg1 iTunesAccountDSID:(id)arg2 isUserSignedIntoiTunes:(_Bool)arg3 isBundleSubscriber:(_Bool)arg4 completion:(id /* block */)arg5;
- (void)shouldShowSignedInWithDifferentiTunesAccountAlertWithiTunesAccountName:(id)arg1 iTunesAccountDSID:(id)arg2 isUserSignedIntoiTunes:(_Bool)arg3 isBundleSubscriber:(_Bool)arg4 completion:(id /* block */)arg5;
