...
@interface FCArticleHeadlinesFetchOperation : FCMultiStepFetchOperation
{
    ...
    NSUInteger _articleCachePolicy;
    double _articleMaximumCachedAge;
    NSUInteger _tagCachePolicy;
...
@property NSUInteger tagCachePolicy; // @synthesize tagCachePolicy=_tagCachePolicy;
...
@property NSUInteger articleCachePolicy; // @synthesize articleCachePolicy=_articleCachePolicy;
