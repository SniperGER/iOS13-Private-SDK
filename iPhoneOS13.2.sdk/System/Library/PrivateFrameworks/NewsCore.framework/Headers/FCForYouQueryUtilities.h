...
+ (id)feedRequestsForTags:(id)arg1 tagBinProvider:(CDUnknownBlockType)arg2 hiddenFeedIDs:(id)arg3 paidBundleFeedID:(id)arg4 purchasedTagIDs:(id)arg5 bundleSubscriptionProvider:(id)arg6 configuration:(id)arg7 maxCount:(NSUInteger)arg8 tagIDFeedRangeProvider:(CDUnknownBlockType)arg9 isRunningPPT:(BOOL)arg10;
