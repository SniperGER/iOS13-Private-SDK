...
+ (id)testingContextWithDesiredHeadlineFieldOptions:(NSUInteger)arg1;
+ (id)testingContext;
+ (void)initialize;
...
- (id)insertTestArticlesWithCount:(NSUInteger)arg1;
...
- (id)privateStoreWithName:(id)arg1 version:(NSUInteger)arg2 options:(NSUInteger)arg3;
...
- (id)initForTestingWithDesiredHeadlineFieldOptions:(NSUInteger)arg1;
- (id)initForTesting;
- (id)initWithConfiguration:(id)arg1 configurationManager:(id)arg2 contentHostDirectory:(id)arg3 privateDataHostDirectory:(id)arg4 privateDataActionProvider:(id)arg5 networkBehaviorMonitor:(id)arg6 appActivityMonitor:(id)arg7 desiredHeadlineFieldOptions:(NSUInteger)arg8 feedUsage:(long long)arg9 deviceIsiPad:(BOOL)arg10 backgroundTaskable:(id)arg11 privateDataSyncAvailability:(id)arg12 pptContext:(id)arg13 options:(long long)arg14;
- (id)initWithConfiguration:(id)arg1 configurationManager:(id)arg2 contentHostDirectory:(id)arg3 privateDataHostDirectory:(id)arg4 privateDataActionProvider:(id)arg5 networkBehaviorMonitor:(id)arg6 appActivityMonitor:(id)arg7 desiredHeadlineFieldOptions:(NSUInteger)arg8 feedUsage:(long long)arg9 lockStoreFrontIfNeeded:(BOOL)arg10 deviceIsiPad:(BOOL)arg11 backgroundTaskable:(id)arg12 privateDataSyncAvailability:(id)arg13 pptContext:(id)arg14;
- (id)init;
