...
@property(readonly, nonatomic) CGSize nameImageMaskSize;
...
@property(readonly, nonatomic) CGSize nameImageForDarkBackgroundSize;
...
@property(readonly, nonatomic) CGSize nameImageSize;
