...
- (void)fireCompletion;
- (id)initWithKeys:(id)arg1 context:(id)arg2 shouldFilter:(_Bool)arg3 qualityOfService:(long long)arg4 relativePriority:(long long)arg5 completionQueue:(id)arg6 completion:(id /* block */)arg7;
