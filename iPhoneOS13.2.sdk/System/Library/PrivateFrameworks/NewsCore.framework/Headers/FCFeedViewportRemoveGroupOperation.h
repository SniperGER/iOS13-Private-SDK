...
@interface FCFeedViewportRemoveGroupOperation : FCOperation <FCFeedViewportRemoveGroupOperationType>
{
    ...
    id /* CDUnknownBlockType */ _removeGroupCompletionHandler;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ removeGroupCompletionHandler; // @synthesize removeGroupCompletionHandler=_removeGroupCompletionHandler;
