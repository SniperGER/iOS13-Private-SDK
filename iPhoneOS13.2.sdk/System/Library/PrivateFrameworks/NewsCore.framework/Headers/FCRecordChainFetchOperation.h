...
@property(copy, nonatomic) id /* block */ recordChainCompletionHandler; // @synthesize recordChainCompletionHandler=_recordChainCompletionHandler;
@property(copy, nonatomic) id /* block */ cachedRecordsLookupBlock; // @synthesize cachedRecordsLookupBlock=_cachedRecordsLookupBlock;
...
@property(copy, nonatomic) id /* block */ dynamicCachePolicyBlock; // @synthesize dynamicCachePolicyBlock=_dynamicCachePolicyBlock;
