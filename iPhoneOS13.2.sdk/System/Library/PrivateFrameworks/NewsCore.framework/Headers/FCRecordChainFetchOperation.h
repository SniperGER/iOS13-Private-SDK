...
@interface FCRecordChainFetchOperation : FCOperation
{
    ...
    id /* CDUnknownBlockType */ _dynamicCachePolicyBlock;
    FCEdgeCacheHint *_edgeCacheHint;
    NSArray *_additionalRecordSources;
    id /* CDUnknownBlockType */ _cachedRecordsLookupBlock;
    id /* CDUnknownBlockType */ _recordChainCompletionHandler;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ recordChainCompletionHandler; // @synthesize recordChainCompletionHandler=_recordChainCompletionHandler;
@property(copy, nonatomic) id /* CDUnknownBlockType */ cachedRecordsLookupBlock; // @synthesize cachedRecordsLookupBlock=_cachedRecordsLookupBlock;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ dynamicCachePolicyBlock; // @synthesize dynamicCachePolicyBlock=_dynamicCachePolicyBlock;
