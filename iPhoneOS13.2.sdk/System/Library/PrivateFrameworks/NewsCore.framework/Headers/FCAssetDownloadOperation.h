...
@interface FCAssetDownloadOperation : FCNetworkOperation
{
    ...
    id /* CDUnknownBlockType */ _fileDownloadCompletionHandler;
    id /* CDUnknownBlockType */ _dataDownloadCompletionHandler;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ dataDownloadCompletionHandler; // @synthesize dataDownloadCompletionHandler=_dataDownloadCompletionHandler;
@property(copy, nonatomic) id /* CDUnknownBlockType */ fileDownloadCompletionHandler; // @synthesize fileDownloadCompletionHandler=_fileDownloadCompletionHandler;
