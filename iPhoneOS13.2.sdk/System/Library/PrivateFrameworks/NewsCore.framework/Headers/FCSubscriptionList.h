...
+ (id)subscriptionIDForTagID:(id)arg1 type:(NSUInteger)arg2;
...
// - (void).cxx_destruct;
- (NSUInteger)_preferredZoneForSubscriptionType:(NSUInteger)arg1;
...
- (id)subscriptionForTagID:(id)arg1 type:(NSUInteger)arg2;
- (BOOL)hasSubscriptionForTagID:(id)arg1;
- (BOOL)canAddSubscription;
- (id)subscriptionsForType:(NSUInteger)arg1;
...
- (BOOL)addSubscriptionForTagID:(id)arg1 type:(NSUInteger)arg2 eventInitiationLevel:(long long)arg3;
- (BOOL)addSubscriptionForTagID:(id)arg1 type:(NSUInteger)arg2 origin:(NSUInteger)arg3 eventInitiationLevel:(long long)arg4;
...
- (BOOL)addSubscriptionForTagID:(id)arg1 type:(NSUInteger)arg2 origin:(NSUInteger)arg3 groupID:(id)arg4 eventInitiationLevel:(long long)arg5;
- (BOOL)addSubscriptionForTagID:(id)arg1 type:(NSUInteger)arg2 origin:(NSUInteger)arg3 groupID:(id)arg4 notificationsEnabled:(BOOL)arg5 eventInitiationLevel:(long long)arg6;
