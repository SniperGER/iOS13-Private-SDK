...
@interface FCFeedViewportUpdateHeadlinesOperation : FCOperation
{
    ...
    id /* CDUnknownBlockType */ _updateHeadlinesCompletionHandler;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ updateHeadlinesCompletionHandler; // @synthesize updateHeadlinesCompletionHandler=_updateHeadlinesCompletionHandler;
