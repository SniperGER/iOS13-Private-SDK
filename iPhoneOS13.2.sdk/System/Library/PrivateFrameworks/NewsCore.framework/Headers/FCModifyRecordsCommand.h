...
@property(copy, nonatomic) id /* block */ localRecordsGenerator; // @synthesize localRecordsGenerator=_localRecordsGenerator;
...
- (id)initWithLocalRecordsGenerator:(id /* block */)arg1 merge:(_Bool)arg2;
- (id)init;
