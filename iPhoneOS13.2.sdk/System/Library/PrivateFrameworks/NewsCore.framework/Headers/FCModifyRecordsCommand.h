...
{
    BOOL _merge;
    id /* CDUnknownBlockType */ _localRecordsGenerator;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ localRecordsGenerator; // @synthesize localRecordsGenerator=_localRecordsGenerator;
// - (void).cxx_destruct;
