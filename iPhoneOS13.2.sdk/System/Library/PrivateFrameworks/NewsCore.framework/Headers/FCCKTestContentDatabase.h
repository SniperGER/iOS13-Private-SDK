...
- (NSUInteger)orderForArticleID:(id)arg1 feedID:(id)arg2;
- (id)addArticlesToTopOfFeed:(id)arg1 count:(NSUInteger)arg2;
...
- (void)insertArticleID:(id)arg1 inFeedID:(id)arg2 withOrder:(NSUInteger)arg3 subOrder:(NSUInteger)arg4;
- (void)insertArticleID:(id)arg1 inFeedID:(id)arg2 withOrder:(NSUInteger)arg3;
