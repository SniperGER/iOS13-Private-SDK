...
@property(copy, nonatomic) id /* block */ feedItemCompletionBlock; // @synthesize feedItemCompletionBlock=_feedItemCompletionBlock;
...
@property(copy, nonatomic) id /* block */ feedItemsChangedHandler; // @synthesize feedItemsChangedHandler=_feedItemsChangedHandler;
