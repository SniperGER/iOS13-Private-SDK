...
@interface FCCKPrivateSaveRecordZonesOperation : FCCKPrivateDatabaseOperation
{
    ...
    id /* CDUnknownBlockType */ _saveRecordZonesCompletionBlock;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ saveRecordZonesCompletionBlock; // @synthesize saveRecordZonesCompletionBlock=_saveRecordZonesCompletionBlock;
