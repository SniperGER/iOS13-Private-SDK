...
+ (_Bool)enumerateRawDataWithTransaction:(id)arg1 HFDKey:(long long)arg2 error:(id *)arg3 handler:(id /* block */)arg4;
+ (_Bool)enumerateDataWithTransaction:(id)arg1 HFDKey:(long long)arg2 error:(id *)arg3 handler:(id /* block */)arg4;
...
+ (_Bool)enumerateDataWithIdentifier:(id)arg1 transaction:(id)arg2 error:(id *)arg3 handler:(id /* block */)arg4;
+ (_Bool)enumerateDataWithIdentifier:(id)arg1 profile:(id)arg2 error:(id *)arg3 handler:(id /* block */)arg4;
...
+ (_Bool)performSeriesWriteTransactionWithProfile:(id)arg1 error:(id *)arg2 block:(id /* block */)arg3;
...
- (_Bool)_getFirstTimeEndTimeCountWithTransaction:(id)arg1 HFDKey:(id)arg2 error:(id *)arg3 handler:(id /* block */)arg4;
- (_Bool)enumerateDataWithTransaction:(id)arg1 error:(id *)arg2 handler:(id /* block */)arg3;
- (_Bool)enumerateDataInInterval:(id)arg1 transaction:(id)arg2 error:(id *)arg3 handler:(id /* block */)arg4;
- (_Bool)startTimeEndTimeCountForSeriesWithTransaction:(id)arg1 error:(id *)arg2 handler:(id /* block */)arg3;
