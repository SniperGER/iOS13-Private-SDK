...
@property(copy, nonatomic) id /* block */ unitTest_didWaitForJournalMergeHandler; // @synthesize unitTest_didWaitForJournalMergeHandler=_unitTest_didWaitForJournalMergeHandler;
...
- (_Bool)accessHighFrequencyDataStoreWithError:(id *)arg1 block:(id /* block */)arg2;
...
- (_Bool)performWithJournalType:(long long)arg1 error:(id *)arg2 block:(id /* block */)arg3;
...
- (_Bool)performWithTransactionContext:(id)arg1 error:(id *)arg2 block:(id /* block */)arg3;
- (_Bool)performTransactionWithContext:(id)arg1 error:(id *)arg2 block:(id /* block */)arg3 inaccessibilityHandler:(id /* block */)arg4;
