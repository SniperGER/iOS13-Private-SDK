...
@property(copy, nonatomic) id /* block */ testHandler; // @synthesize testHandler=_testHandler;
...
- (_Bool)_enumerateAppleStandHoursFromDate:(id)arg1 toDate:(id)arg2 error:(id *)arg3 handler:(id /* block */)arg4;
