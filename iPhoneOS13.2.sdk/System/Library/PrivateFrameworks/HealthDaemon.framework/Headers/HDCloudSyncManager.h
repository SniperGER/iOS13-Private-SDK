...
- (id)fetchDescriptionWithOptions:(NSUInteger)arg1 reason:(long long)arg2 taskTree:(id)arg3 resultHandler:(CDUnknownBlockType)arg4;
...
- (id)syncWithOptions:(NSUInteger)arg1 reason:(long long)arg2 completion:(CDUnknownBlockType)arg3;
