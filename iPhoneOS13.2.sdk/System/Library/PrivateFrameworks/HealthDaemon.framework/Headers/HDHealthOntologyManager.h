...
- (void)importUsingAssetAtLocation:(id)arg1 rememberLocation:(_Bool)arg2 completion:(id /* block */)arg3;
...
- (_Bool)performGraphDatabaseWork:(id /* block */)arg1 usingTransaction:(_Bool)arg2 error:(id *)arg3;
