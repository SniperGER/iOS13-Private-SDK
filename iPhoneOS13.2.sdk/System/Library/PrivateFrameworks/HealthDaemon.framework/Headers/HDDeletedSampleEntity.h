...
//  (BOOL)enumerateEntitiesForSyncWithProperties:(id)arg1 predicate:(id)arg2 session:(id)arg3 syncAnchorRange:(struct HDSyncAnchorRange)arg4 limit:(NSUInteger)arg5 lastSyncAnchor:(long long )arg6 healthDatabase:(id)arg7 error:(id )arg8 block:(CDUnknownBlockType)arg9;
...
+ (BOOL)enumerateDeletedSamplesWithType:(id)arg1 profile:(id)arg2 restrictedSourceEntities:(id)arg3 limit:(NSUInteger)arg4 anchor:(long long)arg5 error:(id )arg6 handler:(CDUnknownBlockType)arg7;
