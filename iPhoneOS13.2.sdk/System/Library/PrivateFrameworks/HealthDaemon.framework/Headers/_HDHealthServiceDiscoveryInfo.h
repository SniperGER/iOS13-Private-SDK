...
@property(readonly, nonatomic) id /* block */ discoveryHandler; // @synthesize discoveryHandler=_discoveryHandler;
...
- (id)initWithHandler:(id /* block */)arg1 serviceUUID:(id)arg2 alwaysNotify:(_Bool)arg3 requiresActiveScan:(_Bool)arg4;
