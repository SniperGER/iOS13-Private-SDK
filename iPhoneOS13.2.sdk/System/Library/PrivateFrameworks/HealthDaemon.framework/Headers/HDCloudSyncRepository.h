...
- (id)_fetchDescriptionWithOptions:(NSUInteger)arg1 reason:(long long)arg2 identifier:(id)arg3 taskTree:(id)arg4 resultHandler:(CDUnknownBlockType)arg5;
- (id)fetchDescriptionWithOptions:(NSUInteger)arg1 reason:(long long)arg2 identifier:(id)arg3 taskTree:(id)arg4 resultHandler:(CDUnknownBlockType)arg5;
...
- (id)syncWithOptions:(NSUInteger)arg1 reason:(long long)arg2 identifier:(id)arg3 completion:(CDUnknownBlockType)arg4;
