...
// - (void).cxx_destruct;
- (void)remote_getIsFeatureSetAvailable:(NSUInteger)arg1 completion:(CDUnknownBlockType)arg2;
...
- (void)remote_obliterateHealthDataWithOptions:(NSUInteger)arg1 completion:(CDUnknownBlockType)arg2;
...
- (void)remote_deleteObjectsWithUUIDs:(id)arg1 options:(NSUInteger)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)remote_deleteAllSamplesWithTypes:(id)arg1 sourceBundleIdentifier:(id)arg2 options:(NSUInteger)arg3 completion:(CDUnknownBlockType)arg4;
...
- (void)remote_deleteDataObjectsOfType:(id)arg1 matchingFilter:(id)arg2 options:(NSUInteger)arg3 handler:(CDUnknownBlockType)arg4;
- (void)remote_deleteDataObjects:(id)arg1 options:(NSUInteger)arg2 handler:(CDUnknownBlockType)arg3;
...
- (void)remote_setAuthorizationStatuses:(id)arg1 authorizationModes:(id)arg2 forBundleIdentifier:(id)arg3 options:(NSUInteger)arg4 completion:(CDUnknownBlockType)arg5;
