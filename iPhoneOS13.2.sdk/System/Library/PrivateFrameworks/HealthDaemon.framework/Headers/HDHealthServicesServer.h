...
- (void)remote_performHealthServiceOperation:(id)arg1 onSession:(NSUInteger)arg2 withParameters:(id)arg3 completion:(CDUnknownBlockType)arg4;
- (void)remote_getHealthServiceProperty:(id)arg1 forSession:(NSUInteger)arg2 withHandler:(CDUnknownBlockType)arg3;
...
- (void)remote_getHealthPeripheralsWithFilter:(NSUInteger)arg1 handler:(CDUnknownBlockType)arg2;
