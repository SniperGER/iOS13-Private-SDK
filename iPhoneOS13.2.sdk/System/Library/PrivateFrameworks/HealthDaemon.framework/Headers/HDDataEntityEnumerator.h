...
@property(copy, nonatomic) id /* block */ authorizationFilter; // @synthesize authorizationFilter=_authorizationFilter;
...
- (_Bool)_enumerateObjectsOnDatabase:(id)arg1 error:(id *)arg2 handler:(id /* block */)arg3;
...
- (_Bool)enumerateIncludingDeletedObjects:(_Bool)arg1 error:(id *)arg2 handler:(id /* block */)arg3;
- (_Bool)enumerateWithError:(id *)arg1 handler:(id /* block */)arg2;
