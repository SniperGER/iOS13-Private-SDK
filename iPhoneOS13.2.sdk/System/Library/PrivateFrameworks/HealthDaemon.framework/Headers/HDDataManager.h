...
- (_Bool)_deleteObjectsWithTypes:(id)arg1 sourceEntities:(id)arg2 recursiveDeleteAuthorizationBlock:(id /* block */)arg3 error:(id *)arg4;
- (_Bool)deleteSamplesWithUUIDs:(id)arg1 generateDeletedObjects:(_Bool)arg2 database:(id)arg3 error:(id *)arg4;
- (_Bool)deleteSamplesWithUUIDs:(id)arg1 recursiveDeleteAuthorizationBlock:(id /* block */)arg2 error:(id *)arg3;
- (_Bool)deleteSamplesWithSourceEntities:(id)arg1 error:(id *)arg2;
- (_Bool)deleteSamplesWithTypes:(id)arg1 sourceEntities:(id)arg2 recursiveDeleteAuthorizationBlock:(id /* block */)arg3 error:(id *)arg4;
- (_Bool)deleteSamplesWithTypes:(id)arg1 sourceBundleIdentifier:(id)arg2 recursiveDeleteAuthorizationBlock:(id /* block */)arg3 error:(id *)arg4;
- (_Bool)deleteDataObjectsOfClass:(Class)arg1 predicate:(id)arg2 limit:(unsigned long long)arg3 deletedSampleCount:(unsigned long long *)arg4 notifyObservers:(_Bool)arg5 generateDeletedObjects:(_Bool)arg6 recursiveDeleteAuthorizationBlock:(id /* block */)arg7 error:(id *)arg8;
- (_Bool)deleteDataObjects:(id)arg1 restrictedSourceEntities:(id)arg2 failIfNotFound:(_Bool)arg3 recursiveDeleteAuthorizationBlock:(id /* block */)arg4 error:(id *)arg5;
