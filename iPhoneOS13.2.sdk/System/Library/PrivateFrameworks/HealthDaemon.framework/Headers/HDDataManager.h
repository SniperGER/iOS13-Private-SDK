...
- (BOOL)deleteDataObjectsOfClass:(Class)arg1 predicate:(id)arg2 limit:(NSUInteger)arg3 deletedSampleCount:(NSUInteger )arg4 notifyObservers:(BOOL)arg5 generateDeletedObjects:(BOOL)arg6 recursiveDeleteAuthorizationBlock:(CDUnknownBlockType)arg7 error:(id )arg8;
