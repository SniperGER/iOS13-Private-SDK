...
@class HDAudioExposureEventObserver, HDBTLEHeartRateDataCollector, HDDatabaseCoalescedWritePool, HDDemoManager, HDPeriodicActivity, HDProfile, NSDate, NSMutableArray, NSMutableDictionary, NSSet;
...
//    struct os_unfair_lock_s _fakingLock;
    id /* CDUnknownBlockType */ _unitTest_aggregatorConfigurationChangedHandler;
...
- (void)stopFakingData;
- (void)startFakingWithHKWorkoutActivityType:(NSUInteger)arg1;
