...
- (void)_requestAggregationThroughDate:(id)arg1 type:(id)arg2 mode:(long long)arg3 freezeSeries:(_Bool)arg4 completion:(id /* block */)arg5;
- (void)_requestAggregationThroughDate:(id)arg1 types:(id)arg2 mode:(long long)arg3 freezeSeries:(_Bool)arg4 completion:(id /* block */)arg5;
- (void)requestAggregationForAllTypesThroughDate:(id)arg1 mode:(long long)arg2 completion:(id /* block */)arg3;
- (void)requestAggregationThroughDate:(id)arg1 types:(id)arg2 mode:(long long)arg3 freezeSeries:(_Bool)arg4 completion:(id /* block */)arg5;
