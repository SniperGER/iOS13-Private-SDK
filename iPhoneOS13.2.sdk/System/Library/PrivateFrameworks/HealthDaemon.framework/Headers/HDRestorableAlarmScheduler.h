...
- (_Bool)_enumerateAllAlarmEventsWithError:(id *)arg1 enumerationHandler:(id /* block */)arg2;
- (void)checkForDueEventsImmediatelyWithCompletion:(id /* block */)arg1;
- (_Bool)_performWriteTransactionAndFireEventsWithError:(id *)arg1 block:(id /* block */)arg2;
