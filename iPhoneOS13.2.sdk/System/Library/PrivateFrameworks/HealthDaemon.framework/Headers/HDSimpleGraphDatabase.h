...
- (_Bool)performWork:(id /* block */)arg1 usingTransaction:(_Bool)arg2 error:(id *)arg3;
- (void)performWork:(id /* block */)arg1 usingTransaction:(_Bool)arg2 completionHandler:(id /* block */)arg3;
- (_Bool)_performWork:(id /* block */)arg1 usingTransaction:(_Bool)arg2 error:(id *)arg3;
