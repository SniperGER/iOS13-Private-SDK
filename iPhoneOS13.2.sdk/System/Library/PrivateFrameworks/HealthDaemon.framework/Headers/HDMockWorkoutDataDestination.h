...
@property(copy) id /* block */ metadataHandler; // @synthesize metadataHandler=_metadataHandler;
@property(copy) id /* block */ eventHandler; // @synthesize eventHandler=_eventHandler;
@property(copy) id /* block */ sampleHandler; // @synthesize sampleHandler=_sampleHandler;
