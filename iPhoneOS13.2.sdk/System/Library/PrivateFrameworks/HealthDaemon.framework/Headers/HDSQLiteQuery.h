...
- (_Bool)enumerateProperties:(id)arg1 error:(id *)arg2 enumerationHandler:(id /* block */)arg3;
- (_Bool)enumeratePersistentIDsAndProperties:(id)arg1 error:(id *)arg2 enumerationHandler:(id /* block */)arg3;
