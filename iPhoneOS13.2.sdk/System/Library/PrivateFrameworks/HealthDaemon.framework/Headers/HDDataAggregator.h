...
- (_Bool)persistForCollector:(id)arg1 usedDatums:(id)arg2 source:(id)arg3 device:(id)arg4 error:(id *)arg5 persistenceHandler:(id /* block */)arg6;
...
- (void)requestAggregationThroughDate:(id)arg1 mode:(long long)arg2 freezeSeries:(_Bool)arg3 completion:(id /* block */)arg4;
- (void)resume;
