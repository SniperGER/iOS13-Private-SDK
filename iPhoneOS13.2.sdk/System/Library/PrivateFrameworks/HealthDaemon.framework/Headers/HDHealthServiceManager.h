...
- (void)writeCharacteristic:(id)arg1 onSession:(unsigned long long)arg2 expectResponse:(_Bool)arg3 completion:(id /* block */)arg4;
...
- (unsigned long long)discoverHealthServicesWithType:(long long)arg1 timeout:(unsigned long long)arg2 alwaysNotify:(_Bool)arg3 handler:(id /* block */)arg4 error:(id *)arg5;
