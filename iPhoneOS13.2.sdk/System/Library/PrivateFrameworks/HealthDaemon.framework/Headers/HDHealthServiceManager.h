...
@class CBCentralManager, CBUUID, HDDataCollectionManager, HDIdentifierTable, HDProfile, NSLock, NSMutableDictionary, NSSet;
...
- (NSUInteger)connectHealthService:(id)arg1 connectionOptions:(NSUInteger)arg2 sessionHandler:(CDUnknownBlockType)arg3 dataHandler:(CDUnknownBlockType)arg4 mfaSuccessHandler:(CDUnknownBlockType)arg5 autoPairData:(id)arg6 error:(id )arg7;
- (NSUInteger)connectHealthService:(id)arg1 sessionHandler:(CDUnknownBlockType)arg2 dataHandler:(CDUnknownBlockType)arg3 error:(id )arg4;
...
- (void)writeCharacteristic:(id)arg1 onSession:(NSUInteger)arg2 expectResponse:(BOOL)arg3 completion:(CDUnknownBlockType)arg4;
- (void)performOperation:(id)arg1 onSession:(NSUInteger)arg2 withParameters:(id)arg3 completion:(CDUnknownBlockType)arg4;
- (void)getProperty:(id)arg1 forSession:(NSUInteger)arg2 withHandler:(CDUnknownBlockType)arg3;
...
- (void)_removeConnectedPeripheral:(NSUInteger)arg1 withError:(id)arg2;
- (void)_createConnectionTimeoutForConnectionInfo:(id)arg1;
- (NSUInteger)_addConnectedPeripheral:(id)arg1 service:(id)arg2 connectionInfo:(id)arg3;
...
- (void)disconnectHealthService:(NSUInteger)arg1;
- (NSUInteger)_connectHealthService:(id)arg1 connectionInfo:(id)arg2 error:(id )arg3;
- (NSUInteger)connectHealthService:(id)arg1 sessionHandler:(CDUnknownBlockType)arg2 dataHandler:(CDUnknownBlockType)arg3 characteristicsHandler:(CDUnknownBlockType)arg4 error:(id )arg5;
...
- (id)_createDiscoveryTimeout:(NSUInteger)arg1 forIdentifier:(NSUInteger)arg2;
- (void)stopDiscoveryWithIdentifier:(NSUInteger)arg1;
- (NSUInteger)discoverHealthServicesWithType:(long long)arg1 timeout:(NSUInteger)arg2 alwaysNotify:(BOOL)arg3 handler:(CDUnknownBlockType)arg4 error:(id )arg5;
