...
- (void)_setAuthorizationStatusesEntitled:(id)arg1 authorizationModes:(id)arg2 forBundleIdentifier:(id)arg3 options:(NSUInteger)arg4 completion:(CDUnknownBlockType)arg5;
