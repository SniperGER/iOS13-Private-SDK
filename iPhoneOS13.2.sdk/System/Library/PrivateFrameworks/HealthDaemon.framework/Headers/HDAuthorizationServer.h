...
- (void)_performIfAuthorizedForTypes:(id)arg1 sharing:(_Bool)arg2 onQueue:(id)arg3 usingBlock:(id /* block */)arg4 errorHandler:(id /* block */)arg5;
- (void)handleObjectAuthorizationRequestsWithPromptHandler:(id /* block */)arg1 completion:(id /* block */)arg2;
- (void)enqueueObjectAuthorizationRequestForSamples:(id)arg1 promptIfNeeded:(_Bool)arg2 authorizationNeededHandler:(id /* block */)arg3 completion:(id /* block */)arg4;
