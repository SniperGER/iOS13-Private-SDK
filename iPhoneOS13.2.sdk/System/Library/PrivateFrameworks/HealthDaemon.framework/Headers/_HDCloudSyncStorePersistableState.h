...
@property(readonly, nonatomic) NSUInteger baselineEpoch; // @synthesize baselineEpoch=_baselineEpoch;
...
- (id)stateWithBaselineEpoch:(NSUInteger)arg1;
...
- (id)initWithServerChangeToken:(id)arg1 baselineEpoch:(NSUInteger)arg2 rebaseDeadline:(id)arg3 lastSyncDate:(id)arg4 emptyZones:(id)arg5 lastCheckDate:(id)arg6 ownerIdentifier:(id)arg7 containerIdentifier:(id)arg8 syncProtocolVersion:(int)arg9;
