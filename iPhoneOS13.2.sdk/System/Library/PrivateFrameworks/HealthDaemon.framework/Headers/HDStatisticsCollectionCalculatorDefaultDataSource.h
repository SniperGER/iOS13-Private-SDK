...
+ (_Bool)_enumerateSampleTypeWithProfile:(id)arg1 quantityType:(id)arg2 predicate:(id)arg3 error:(id *)arg4 block:(id /* block */)arg5;
+ (_Bool)_enumerateWithProfile:(id)arg1 quantityType:(id)arg2 predicate:(id)arg3 filter:(id)arg4 isQuantityType:(_Bool)arg5 includeUnfrozenSeries:(_Bool)arg6 error:(id *)arg7 block:(id /* block */)arg8;
@property(copy, nonatomic) id /* block */ shouldContinueHandler; // @synthesize shouldContinueHandler=_shouldContinueHandler;
...
- (_Bool)collectionCalculator:(id)arg1 queryForInterval:(id)arg2 error:(id *)arg3 sampleHandler:(id /* block */)arg4;
