...
+ (_Bool)enumerateLocationDataInDatabase:(id)arg1 HFDKey:(id)arg2 error:(id *)arg3 handler:(id /* block */)arg4;
...
- (_Bool)enumerateLocationDataInDatabase:(id)arg1 error:(id *)arg2 handler:(id /* block */)arg3;
- (_Bool)enumerateLocationDataFromTimestamp:(double)arg1 toTimestamp:(double)arg2 database:(id)arg3 error:(id *)arg4 handler:(id /* block */)arg5;
