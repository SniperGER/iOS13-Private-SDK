...
@interface HDTTRPromptController : NSObject
{
    ...
    // Error parsing type: AB, name: _isPresenting
...
@property(copy, nonatomic) id /* block */ unitTest_willPresentTTRAlertHandler; // @synthesize unitTest_willPresentTTRAlertHandler=_unitTest_willPresentTTRAlertHandler;
