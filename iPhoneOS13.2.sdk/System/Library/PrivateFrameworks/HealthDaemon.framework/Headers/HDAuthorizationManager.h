...
- (id)enqueueObjectAuthorizationRequestForBundleIdentifier:(id)arg1 samples:(id)arg2 promptIfNeeded:(_Bool)arg3 authorizationNeededHandler:(id /* block */)arg4 completion:(id /* block */)arg5;
