...
@class HDProfile, NSMutableArray, NSMutableDictionary, _HDAuthorizationRequestGroup;
...
- (void)_queue_setAuthorizationStatuses:(id)arg1 authorizationModes:(id)arg2 forBundleIdentifier:(id)arg3 options:(NSUInteger)arg4 completion:(CDUnknownBlockType)arg5;
...
- (void)setAuthorizationStatuses:(id)arg1 authorizationModes:(id)arg2 forBundleIdentifier:(id)arg3 options:(NSUInteger)arg4 completion:(CDUnknownBlockType)arg5;
- (void)dealloc;
