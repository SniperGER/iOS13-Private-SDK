...
@property(copy, nonatomic) id /* block */ promptHandler; // @synthesize promptHandler=_promptHandler;
...
- (_Bool)promptIfNecessaryWithTimeout:(double)arg1 completion:(id /* block */)arg2;
