...
//  (void)_addSample:(struct HDActivityCacheStatisticsBuilderSample)arg1 toSourceTotals:(map_c63dce6d )arg2 fromWorkout:(BOOL)arg3;
- (void)_addSamples:(const vector_7eaa0458 )arg1 toSourceTotals:(map_c63dce6d )arg2 fromWorkout:(BOOL)arg3;
- (double)_maxTimestampInSourceTotals:(const map_c63dce6d )arg1;
- (double)_minTimestampInSourceTotals:(const map_c63dce6d )arg1;
- (BOOL)_sourceMapIsEmpty:(const map_c63dce6d )arg1;
