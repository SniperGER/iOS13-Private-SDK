...
@interface HDDemoDataPerson : NSObject
{
    ...
    NSUInteger _numSleepInterruptions;
...
@property(nonatomic) NSUInteger insulinTherapy; // @synthesize insulinTherapy=_insulinTherapy;
...
@property(nonatomic) NSUInteger numSleepInterruptions; // @synthesize numSleepInterruptions=_numSleepInterruptions;
...
@property(nonatomic) BOOL sexualActivityIsTryingToConceive; // @synthesize sexualActivityIsTryingToConceive=_sexualActivityIsTryingToConceive;
