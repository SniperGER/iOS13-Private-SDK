...
+ (id)databaseTable;
+ (id)databaseName;
+ (_Bool)updateProperties:(id)arg1 predicate:(id)arg2 database:(id)arg3 error:(id *)arg4 bindingHandler:(id /* block */)arg5;
+ (id)insertOrReplaceEntity:(_Bool)arg1 database:(id)arg2 properties:(id)arg3 error:(id *)arg4 bindingHandler:(id /* block */)arg5;
...
+ (_Bool)enumerateQueryResultsFromColumns:(id)arg1 properties:(id)arg2 predicate:(id)arg3 groupBy:(id)arg4 orderingTerms:(id)arg5 limit:(long long)arg6 database:(id)arg7 error:(id *)arg8 enumerationHandler:(id /* block */)arg9;
+ (_Bool)enumerateEntitiesInDatabase:(id)arg1 predicate:(id)arg2 error:(id *)arg3 enumerationHandler:(id /* block */)arg4;
...
- (_Bool)getValuesForProperties:(id)arg1 database:(id)arg2 error:(id *)arg3 handler:(id /* block */)arg4;
- (_Bool)getValuesForProperties:(id)arg1 database:(id)arg2 handler:(id /* block */)arg3;
- (_Bool)existsInDatabase:(id)arg1;
- (void)willDeleteFromDatabase:(id)arg1;
- (_Bool)deleteFromDatabase:(id)arg1 error:(id *)arg2;
- (_Bool)updateProperties:(id)arg1 database:(id)arg2 error:(id *)arg3 bindingHandler:(id /* block */)arg4;
