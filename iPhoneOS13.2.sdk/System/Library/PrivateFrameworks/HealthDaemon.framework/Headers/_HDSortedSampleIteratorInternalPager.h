...
+ (void)getSamplesWithSampleQueryDescription:(id)arg1 sortDescriptors:(id)arg2 anchor:(id)arg3 limit:(NSUInteger)arg4 profile:(id)arg5 resultsHandler:(CDUnknownBlockType)arg6;
