...
+ (_Bool)enumerateAllAlarmEventsWithTransaction:(id)arg1 predicate:(id)arg2 error:(id *)arg3 enumerationHandler:(id /* block */)arg4;
+ (_Bool)enumerateAllAlarmEventsWithTransaction:(id)arg1 error:(id *)arg2 enumerationHandler:(id /* block */)arg3;
+ (_Bool)enumerateAllAlarmEventsWithClientIdentifier:(id)arg1 transaction:(id)arg2 error:(id *)arg3 enumerationHandler:(id /* block */)arg4;
