...
- (void)_perRecordCompletionForOperation:(id)arg1 record:(id)arg2 recordID:(id)arg3 recordAssetContentInMemory:(_Bool)arg4 error:(id)arg5 errorCompletion:(id /* block */)arg6;
