...
- (_Bool)enumerateDataSourcesForProfile:(id)arg1 error:(id *)arg2 block:(id /* block */)arg3;
...
- (_Bool)enumerateStatisticsInTransaction:(id)arg1 error:(id *)arg2 block:(id /* block */)arg3;
...
- (_Bool)_enumerateAssociatedSamplePropertiesInTransaction:(id)arg1 error:(id *)arg2 handler:(id /* block */)arg3;
- (_Bool)pruneAssociatedSamplesToDateInterval:(id)arg1 transaction:(id)arg2 error:(id *)arg3;
- (_Bool)_setupForEnumerationOfType:(id)arg1 interval:(id)arg2 profile:(id)arg3 error:(id *)arg4 handler:(id /* block */)arg5;
- (_Bool)_setupForEnumerationOfType:(id)arg1 interval:(id)arg2 transaction:(id)arg3 error:(id *)arg4 handler:(id /* block */)arg5;
...
- (_Bool)enumerateAssociatedSamplesOfType:(id)arg1 interval:(id)arg2 profile:(id)arg3 error:(id *)arg4 sampleHandler:(id /* block */)arg5;
- (_Bool)enumerateAssociatedSampleValuesOfType:(id)arg1 interval:(id)arg2 profile:(id)arg3 error:(id *)arg4 sampleHandler:(id /* block */)arg5;
- (_Bool)enumerateAssociatedUUIDsWithTransaction:(id)arg1 error:(id *)arg2 block:(id /* block */)arg3;
