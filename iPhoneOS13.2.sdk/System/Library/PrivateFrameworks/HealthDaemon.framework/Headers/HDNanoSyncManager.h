...
- (void)_queue_syncImmediatelyWithReason:(id)arg1 options:(NSUInteger)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)_queue_synchronizeWithOptions:(NSUInteger)arg1 restoreMessagesSentHandler:(CDUnknownBlockType)arg2 targetSyncStore:(id)arg3 reason:(id)arg4 completion:(CDUnknownBlockType)arg5;
...
- (void)syncHealthDataWithOptions:(NSUInteger)arg1 reason:(id)arg2 completion:(CDUnknownBlockType)arg3;
- (void)syncHealthDataWithOptions:(NSUInteger)arg1 completion:(CDUnknownBlockType)arg2;
