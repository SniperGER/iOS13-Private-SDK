...
@property(nonatomic) BOOL didGenerateHeadphoneAudioExposureSamples; // @synthesize didGenerateHeadphoneAudioExposureSamples=_didGenerateHeadphoneAudioExposureSamples;
...
@property(nonatomic) BOOL didGenerateEnvironmentalAudioExposureSamples; // @synthesize didGenerateEnvironmentalAudioExposureSamples=_didGenerateEnvironmentalAudioExposureSamples;
...
- (id)_makeNormallyDistributedAudioExposureLevelsWithCount:(NSUInteger)arg1 headphones:(BOOL)arg2;
- (id)_makeEvenlyDistributedAudioExposureLevelsWithCount:(NSUInteger)arg1 headphones:(BOOL)arg2;
