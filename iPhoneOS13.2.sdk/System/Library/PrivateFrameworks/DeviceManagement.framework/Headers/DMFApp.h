...
+ (id)stringForInstallationState:(NSUInteger)arg1;
...
@property(nonatomic) NSUInteger installationState; // @synthesize installationState=_installationState;
