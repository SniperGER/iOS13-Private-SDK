...
- (void)_reloadDataAnimated:(_Bool)arg1 heightChange:(id /* block */)arg2 animation:(id /* block */)arg3 completion:(id /* block */)arg4;
- (void)_reloadDataAnimated:(_Bool)arg1 heightChange:(id /* block */)arg2 animation:(id /* block */)arg3;
- (void)_reloadDataAnimated:(_Bool)arg1 heightChange:(id /* block */)arg2;
