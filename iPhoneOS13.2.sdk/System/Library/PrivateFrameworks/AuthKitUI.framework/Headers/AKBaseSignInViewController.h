...
- (void)_beginAuthenticationIfPossibleWithOption:(NSUInteger)arg1 withUsername:(id)arg2 password:(id)arg3;
- (BOOL)_canBeginAuthenticationWithOption:(NSUInteger)arg1;
