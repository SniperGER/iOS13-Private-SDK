...
+ (void)_updateTime:(double)arg1 forGuidancePriority:(NSUInteger)arg2;
...
- (void)dealloc;
- (id)_initWithAbsoluteTime:(double)arg1 serviceIdentifier:(id)arg2 guidancePriority:(NSUInteger)arg3 target:(id)arg4 selector:(SEL)arg5 userInfo:(id)arg6 triggerOnGMTChange:(BOOL)arg7;
- (id)initWithTimeInterval:(double)arg1 serviceIdentifier:(id)arg2 guidancePriority:(NSUInteger)arg3 target:(id)arg4 selector:(SEL)arg5 userInfo:(id)arg6;
