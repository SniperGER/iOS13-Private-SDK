...
@property(nonatomic) _Bool shouldPerformRankingComparison; // @synthesize shouldPerformRankingComparison=_shouldPerformRankingComparison;
@property(retain, nonatomic) NSError *error; // @synthesize error=_error;
@property(retain, nonatomic) NSMutableArray *results; // @synthesize results=_results;
@property(copy, nonatomic) id /* block */ foundItemsHandler; // @synthesize foundItemsHandler=_foundItemsHandler;
- (void)cancel;
