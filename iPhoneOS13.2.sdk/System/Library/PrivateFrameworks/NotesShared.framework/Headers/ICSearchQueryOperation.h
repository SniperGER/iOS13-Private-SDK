...
@interface ICSearchQueryOperation : NSOperation
{
    ...
    id /* CDUnknownBlockType */ _foundItemsHandler;
...
+ (id)queryFields;
+ (void)initialize;
@property(nonatomic) NSUInteger rankingStrategy; // @synthesize rankingStrategy=_rankingStrategy;
...
@property(retain, nonatomic) NSMutableDictionary *rankComparison; // @synthesize rankComparison=_rankComparison;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ foundItemsHandler; // @synthesize foundItemsHandler=_foundItemsHandler;
// - (void).cxx_destruct;
- (void)cancel;
- (id)rankComparisonForSearchableItem:(id)arg1;
- (NSUInteger)relevanceBitFieldForSearchableItem:(id)arg1;
- (NSUInteger)matchedFieldForSearchableItem:(id)arg1;
