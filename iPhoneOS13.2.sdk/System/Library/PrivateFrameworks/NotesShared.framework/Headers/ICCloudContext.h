...
- (void)_addModifyRecordsOperationsWithCloudObjectsToSave:(id)arg1 delete:(id)arg2 accountID:(id)arg3 operationGroupName:(id)arg4 waitForDependencies:(_Bool)arg5 completionHandler:(id /* block */)arg6;
- (void)addModifyRecordsOperationsWithCloudObjectsToSave:(id)arg1 delete:(id)arg2 accountID:(id)arg3 operationGroupName:(id)arg4 waitForDependencies:(_Bool)arg5 completionHandler:(id /* block */)arg6;
...
- (void)deleteRecordZonesWithZoneIDs:(id)arg1 accountID:(id)arg2 markZonesAsUserPurged:(_Bool)arg3 completionHandler:(id /* block */)arg4;
...
- (void)syncWithReason:(id)arg1 onlyIfReachable:(_Bool)arg2 completionHandler:(id /* block */)arg3;
