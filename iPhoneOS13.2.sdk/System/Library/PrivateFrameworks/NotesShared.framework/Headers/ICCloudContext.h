...
+ (void)batchRecordsToSave:(id)arg1 delete:(id)arg2 maxRecordCountPerBatch:(NSUInteger)arg3 maxRecordSizePerBatch:(NSUInteger)arg4 withBlock:(CDUnknownBlockType)arg5;
