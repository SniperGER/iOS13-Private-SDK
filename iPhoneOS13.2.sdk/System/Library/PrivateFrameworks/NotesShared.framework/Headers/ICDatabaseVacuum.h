...
@property(copy, nonatomic) id /* block */ postVacuumHandler; // @synthesize postVacuumHandler=_postVacuumHandler;
@property(copy, nonatomic) id /* block */ preVacuumHandler; // @synthesize preVacuumHandler=_preVacuumHandler;
