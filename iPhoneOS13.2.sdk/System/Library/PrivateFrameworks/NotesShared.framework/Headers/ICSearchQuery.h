...
@interface ICSearchQuery : NSObject
{
    ...
    NSUInteger _rankingInterpretation;
...
@property(nonatomic) NSUInteger rankingInterpretation; // @synthesize rankingInterpretation=_rankingInterpretation;
...
- (BOOL)run:(id )arg1;
- (void)setup;
- (id)initWithQueryString:(id)arg1 rankingQueries:(id)arg2 rankingInterpretation:(NSUInteger)arg3 highlightString:(id)arg4 modernResultsOnly:(BOOL)arg5;
