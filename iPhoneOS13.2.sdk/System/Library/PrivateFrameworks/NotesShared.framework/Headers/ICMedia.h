...
- (_Bool)writeDataWithBlock:(id /* block */)arg1 error:(id *)arg2;
...
- (id)data;
- (void)writeDataFromItemProvider:(id)arg1 checkForMarkupData:(_Bool)arg2 completionBlock:(id /* block */)arg3;
