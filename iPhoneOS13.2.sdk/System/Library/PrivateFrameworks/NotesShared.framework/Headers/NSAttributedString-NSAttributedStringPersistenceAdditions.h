...
- (void)enumerateAttachmentsInContext:(id)arg1 range:(struct _NSRange)arg2 options:(unsigned long long)arg3 usingBlock:(id /* block */)arg4;
- (void)enumerateAttachmentsInContext:(id)arg1 range:(struct _NSRange)arg2 usingBlock:(id /* block */)arg3;
- (void)enumerateAttachmentsInContext:(id)arg1 usingBlock:(id /* block */)arg2;
- (void)enumerateUnclampedAttribute:(id)arg1 inRange:(struct _NSRange)arg2 options:(unsigned long long)arg3 usingBlock:(id /* block */)arg4;
- (void)enumerateClampedAttribute:(id)arg1 inRange:(struct _NSRange)arg2 options:(unsigned long long)arg3 usingBlock:(id /* block */)arg4;
