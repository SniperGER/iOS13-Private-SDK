...
- (id)member:(id)arg1;
- (id)initWithCRCoder:(id)arg1 set:(const struct Dictionary *)arg2 elementValueDecoder:(id /* block */)arg3;
- (id)initWithCRCoder:(id)arg1 set:(const struct Dictionary *)arg2;
- (id)initWithCRCoder:(id)arg1;
- (void)encodeWithCRCoder:(id)arg1 set:(struct Dictionary *)arg2 elementValueCoder:(id /* block */)arg3;
