...
- (void)_submitFetchRecordsOperation:(id)arg1 withPriority:(NSUInteger)arg2 changeToken:(id)arg3 completionHandler:(CDUnknownBlockType)arg4 retryCount:(NSUInteger)arg5;
- (void)fetchRecordsWithPriority:(NSUInteger)arg1 changeToken:(id)arg2 completionHandler:(CDUnknownBlockType)arg3 retryCount:(NSUInteger)arg4;
- (void)fetchRecordsWithPriority:(NSUInteger)arg1 changeToken:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;
- (void)copyFieldsFromRecord:(id)arg1 toRecord:(id)arg2;
- (id)resolveConflicts:(id)arg1;
- (void)updateRecords:(id)arg1 deleteRecordIDs:(id)arg2 withPriority:(NSUInteger)arg3 completionHandler:(CDUnknownBlockType)arg4 retryCount:(NSUInteger)arg5;
- (void)updateRecords:(id)arg1 deleteRecordIDs:(id)arg2 withPriority:(NSUInteger)arg3 completionHandler:(CDUnknownBlockType)arg4;
...
- (void)resetZoneWithDelete:(NSUInteger)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;
- (void)setupRecordZoneWithCompletionHandler:(CDUnknownBlockType)arg1 ignoreDefaults:(BOOL)arg2;
- (void)_checkAccountStatusWithCompletionHandler:(CDUnknownBlockType)arg1 withRetryCount:(NSUInteger)arg2;
