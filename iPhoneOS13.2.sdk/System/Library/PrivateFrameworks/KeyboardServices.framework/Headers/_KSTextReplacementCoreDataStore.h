...
- (id)queryManagedObjectsWithPredicate:(id)arg1 limit:(NSUInteger)arg2;
- (id)queryEntriesWithPredicate:(id)arg1 limit:(NSUInteger)arg2;
- (NSUInteger)countEntriesWithPredicate:(id)arg1;
- (id)textReplacementEntriesWithLimit:(NSUInteger)arg1;
