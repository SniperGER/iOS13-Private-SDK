...
+ (id)generateKeyWithSize:(NSUInteger)arg1;
// - (void).cxx_destruct;
...
- (void)readFilesWithRecordIDs:(id)arg1 forColumns:(id)arg2 priority:(NSUInteger)arg3 withCompletionHandler:(CDUnknownBlockType)arg4;
