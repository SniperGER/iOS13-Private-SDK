...
- (_Bool)enumerateAggregatedMeasurementsMatchingNullableFilter:(id)arg1 ignoringVariables:(id)arg2 error:(id *)arg3 usingBlock:(id /* block */)arg4;
- (_Bool)enumerateAggregatedMeasurementsIgnoringVariables:(id)arg1 error:(id *)arg2 usingBlock:(id /* block */)arg3;
- (_Bool)enumerateAggregatedMeasurementsMatchingFilter:(id)arg1 ignoringVariables:(id)arg2 error:(id *)arg3 usingBlock:(id /* block */)arg4;
- (_Bool)enumerateMeasurementsMatchingNullableFilter:(id)arg1 error:(id *)arg2 usingBlock:(id /* block */)arg3;
- (_Bool)enumerateMeasurementsMatchingFilter:(id)arg1 error:(id *)arg2 usingBlock:(id /* block */)arg3;
- (_Bool)enumerateMeasurementsWithError:(id *)arg1 usingBlock:(id /* block */)arg2;
