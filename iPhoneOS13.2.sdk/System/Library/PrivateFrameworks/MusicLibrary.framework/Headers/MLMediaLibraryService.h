...
- (void)cancelImportOperation:(NSUInteger)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (void)performImport:(id)arg1 fromSource:(NSUInteger)arg2 withProgressBlock:(CDUnknownBlockType)arg3 completionHandler:(CDUnknownBlockType)arg4;
- (void)setOptions:(id)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;
- (void)performDatabaseOperation:(NSUInteger)arg1 withAttributes:(id)arg2 options:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;
...
- (void)beginTransactionForDatabaseAtPath:(id)arg1 withPriorityLevel:(NSUInteger)arg2 options:(NSUInteger)arg3 completionHandler:(CDUnknownBlockType)arg4;
