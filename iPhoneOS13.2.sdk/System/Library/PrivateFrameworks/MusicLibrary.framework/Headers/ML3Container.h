...
+ (id)nextFilepathForPlaylistType:(int)arg1 withPersistentID:(NSUInteger)arg2 inLibrary:(id)arg3;
...
- (BOOL)moveTrackFromIndex:(NSUInteger)arg1 toIndex:(NSUInteger)arg2;
