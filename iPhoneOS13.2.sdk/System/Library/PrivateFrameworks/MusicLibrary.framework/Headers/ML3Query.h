...
- (void)enumeratePersistentIDsAndProperties:(id)arg1 ordered:(_Bool)arg2 sectionProperty:(id)arg3 cancelBlock:(id /* block */)arg4 usingBlock:(id /* block */)arg5;
- (void)enumeratePersistentIDsAndProperties:(id)arg1 ordered:(_Bool)arg2 cancelBlock:(id /* block */)arg3 usingBlock:(id /* block */)arg4;
- (void)enumeratePersistentIDsAndProperties:(id)arg1 ordered:(_Bool)arg2 usingBlock:(id /* block */)arg3;
...
- (void)loadNamesFromLibrary:(id)arg1 onConnection:(id)arg2 forPredicate:(id)arg3 loadAllNames:(_Bool)arg4 cancelHandler:(id /* block */)arg5;
