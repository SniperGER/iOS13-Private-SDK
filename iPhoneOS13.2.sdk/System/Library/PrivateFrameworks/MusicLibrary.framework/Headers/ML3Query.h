...
- (id)selectSQLWithColumns:(id)arg1 groupBy:(id)arg2 orderingTerms:(id)arg3 directionality:(id)arg4 usingLowerBound:(BOOL)arg5 distinct:(BOOL)arg6 limit:(NSUInteger)arg7;
...
- (id)selectSQLWithColumns:(id)arg1 groupBy:(id)arg2 orderingTerms:(id)arg3 limit:(NSUInteger)arg4;
...
- (id)selectSQLWithColumns:(id)arg1 orderingTerms:(id)arg2 limit:(NSUInteger)arg3;
