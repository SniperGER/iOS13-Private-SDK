...
- (_Bool)registerFunctionName:(id)arg1 argumentCount:(int)arg2 block:(id /* block */)arg3;
- (void)enqueueBlockForTransactionCommit:(id /* block */)arg1;
- (_Bool)performTransactionWithBlock:(id /* block */)arg1 usingBehaviorType:(unsigned long long)arg2;
- (_Bool)performTransactionWithBlock:(id /* block */)arg1;
