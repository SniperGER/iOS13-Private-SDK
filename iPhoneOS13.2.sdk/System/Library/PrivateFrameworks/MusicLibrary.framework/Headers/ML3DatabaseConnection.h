...
- (BOOL)registerFunctionName:(id)arg1 argumentCount:(int)arg2 functionPointer:(/* void * CDUnknownFunctionPointerType */)arg3 userData:(void )arg4;
- (BOOL)registerFunctionName:(id)arg1 argumentCount:(int)arg2 functionPointer:(/* void * CDUnknownFunctionPointerType */)arg3;
...
- (BOOL)performTransactionWithBlock:(CDUnknownBlockType)arg1 usingBehaviorType:(NSUInteger)arg2;
