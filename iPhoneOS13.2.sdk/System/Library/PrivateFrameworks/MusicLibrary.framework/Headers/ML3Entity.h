...
+ (BOOL)removeFromMyLibrary:(id)arg1 deletionType:(int)arg2 persistentIDs:(const long long )arg3 count:(NSUInteger)arg4;
...
+ (BOOL)deleteFromLibrary:(id)arg1 deletionType:(int)arg2 persistentIDs:(const long long )arg3 count:(NSUInteger)arg4;
+ (BOOL)_deleteRowForPersistentIDs:(const long long )arg1 count:(NSUInteger)arg2 library:(id)arg3 table:(id)arg4 usingColumn:(id)arg5 usingConnection:(id)arg6;
...
+ (id)entityURLScheme;
+ (id)newSelectSQLForProperties:(const id )arg1 count:(NSUInteger)arg2 predicate:(id)arg3;
+ (id)newSelectAllEntitiesSQLForProperties:(const id )arg1 count:(NSUInteger)arg2 predicate:(id)arg3;
+ (id)subselectPropertyForProperty:(id)arg1;
+ (id)subselectStatementForProperty:(id)arg1;
+ (void)enumeratePersistentIDsInLibrary:(id)arg1 matchingPredicate:(id)arg2 orderingTerms:(id)arg3 persistentIDs:(const long long )arg4 count:(NSUInteger)arg5 options:(long long)arg6 usingBlock:(CDUnknownBlockType)arg7;
...
+ (BOOL)incrementRevisionForRevisionTypeContentWithConnection:(id)arg1 deletionType:(int)arg2 persistentIDs:(const long long )arg3 count:(NSUInteger)arg4;
...
- (BOOL)setValues:(const id )arg1 forProperties:(const id )arg2 count:(NSUInteger)arg3;
- (id)valueForProperty:(id)arg1;
- (id)getValuesForProperties:(id)arg1;
- (void)getValues:(id )arg1 forProperties:(const id )arg2 count:(NSUInteger)arg3;
- (id)URL;
