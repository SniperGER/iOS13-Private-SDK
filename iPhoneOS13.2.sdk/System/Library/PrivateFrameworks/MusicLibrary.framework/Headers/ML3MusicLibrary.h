...
- (void)enumeratePersistentIDsAfterRevision:(long long)arg1 revisionTrackingCode:(unsigned long long)arg2 maximumRevisionType:(int)arg3 forMediaTypes:(id)arg4 inUsersLibrary:(_Bool)arg5 usingBlock:(id /* block */)arg6;
- (_Bool)updateSortMap;
...
- (void)databaseConnectionAllowingWrites:(_Bool)arg1 withBlock:(id /* block */)arg2;
...
- (id)initWithPath:(id)arg1 readOnly:(_Bool)arg2 populateUnitTestTablesBlock:(id /* block */)arg3;
...
- (void)_enumeratePurgeableTracksForUrgency:(unsigned long long)arg1 includeAutoFilledTracks:(_Bool)arg2 includeCloudAssets:(_Bool)arg3 usingBlock:(id /* block */)arg4;
