...
- (void)enumeratePersistentIDsAfterRevision:(long long)arg1 revisionTrackingCode:(NSUInteger)arg2 maximumRevisionType:(int)arg3 usingBlock:(CDUnknownBlockType)arg4;
- (void)enumeratePersistentIDsAfterRevision:(long long)arg1 revisionTrackingCode:(NSUInteger)arg2 maximumRevisionType:(int)arg3 forMediaTypes:(id)arg4 inUsersLibrary:(BOOL)arg5 usingBlock:(CDUnknownBlockType)arg6;
- (BOOL)updateSortMap;
...
- (void)_enumeratePurgeableTracksForUrgency:(NSUInteger)arg1 includeAutoFilledTracks:(BOOL)arg2 includeCloudAssets:(BOOL)arg3 usingBlock:(CDUnknownBlockType)arg4;
- (long long)_purgeableTracksTotalSizeWithUrgency:(NSUInteger)arg1 includeAutoFilledTracks:(BOOL)arg2;
- (void)_enumeratePurgeablePodcastEpisodesForUrgency:(NSUInteger)arg1 usingBlock:(CDUnknownBlockType)arg2;
- (void)_enumeratePurgeableAlbumTracksForUrgency:(NSUInteger)arg1 usingBlock:(CDUnknownBlockType)arg2;
- (void)_enumeratePurgeableStreamedTracksForUrgency:(NSUInteger)arg1 usingBlock:(CDUnknownBlockType)arg2;
