...
@property(copy, nonatomic) id /* block */ sideSwipeHintingHideAnimationBlock; // @synthesize sideSwipeHintingHideAnimationBlock=_sideSwipeHintingHideAnimationBlock;
...
- (void)_resetNotificationCellPositionAnimated:(_Bool)arg1 completion:(id /* block */)arg2;
- (void)_setNotificationCellPosition:(double)arg1 withVelocity:(double)arg2 animated:(_Bool)arg3 completion:(id /* block */)arg4;
