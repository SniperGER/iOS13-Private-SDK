...
@property(copy, nonatomic, getter=_dismissalCompletion, setter=_setDismissalCompletion:) id /* block */ dismissalCompletion; // @synthesize dismissalCompletion=_dismissalCompletion;
...
@property(copy, nonatomic, getter=_pendingPresentationTransitionDidEndBlock, setter=_setPendingPresentationTransitionDidEndBlock:) id /* block */ pendingPresentationTransitionDidEndBlock; // @synthesize pendingPresentationTransitionDidEndBlock=_pendingPresentationTransitionDidEndBlock;
