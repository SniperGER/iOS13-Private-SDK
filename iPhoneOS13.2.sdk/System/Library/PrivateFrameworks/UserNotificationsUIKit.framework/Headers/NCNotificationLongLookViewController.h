...
+ (void)initialize;
@property(copy, nonatomic, getter=_notificationTapBlock, setter=_setNotificationTapBlock:) id /* block */ notificationTapBlock; // @synthesize notificationTapBlock=_notificationTapBlock;
