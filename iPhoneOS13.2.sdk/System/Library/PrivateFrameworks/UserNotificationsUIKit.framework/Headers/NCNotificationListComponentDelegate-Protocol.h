...
- (void)notificationListComponent:(id <NCNotificationListComponent>)arg1 requestsPresentingManagementViewForNotificationRequest:(NCNotificationRequest *)arg2 managementViewType:(NSUInteger)arg3 withPresentingView:(UIView *)arg4 completion:(void (^)(BOOL))arg5;
...
- (void)notificationListComponent:(id <NCNotificationListComponent>)arg1 requestsAuthenticationAndPerformBlock:(void (^)(BOOL))arg2;
...
- (void)notificationListComponent:(id <NCNotificationListComponent>)arg1 requestPermissionToExecuteAction:(NCNotificationAction *)arg2 forNotificationRequest:(NCNotificationRequest *)arg3 withParameters:(NSDictionary *)arg4 completion:(void (^)(BOOL))arg5;
- (void)notificationListComponent:(id <NCNotificationListComponent>)arg1 requestsExecuteAction:(NCNotificationAction *)arg2 forNotificationRequest:(NCNotificationRequest *)arg3 requestAuthentication:(BOOL)arg4 withParameters:(NSDictionary *)arg5 completion:(void (^)(BOOL))arg6;
@end
