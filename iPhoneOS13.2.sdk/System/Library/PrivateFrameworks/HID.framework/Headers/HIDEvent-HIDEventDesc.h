...
+ (id)vendorDefinedEvent:(NSUInteger)arg1 usagePage:(unsigned short)arg2 usage:(unsigned short)arg3 version:(unsigned int)arg4 data:(char )arg5 length:(unsigned int)arg6 options:(unsigned int)arg7;
+ (id)temperatureEvent:(NSUInteger)arg1 level:(double)arg2 options:(unsigned int)arg3;
+ (id)accelerometerEvent:(NSUInteger)arg1 x:(double)arg2 y:(double)arg3 z:(double)arg4 options:(unsigned int)arg5;
+ (id)genericGestureEvent:(NSUInteger)arg1 gestureType:(unsigned int)arg2 options:(unsigned int)arg3;
+ (id)ambientLightSensorEvent:(NSUInteger)arg1 level:(unsigned int)arg2 options:(unsigned int)arg3;
+ (id)forceEvent:(NSUInteger)arg1 behavior:(unsigned int)arg2 progress:(double)arg3 stage:(unsigned int)arg4 stageProgress:(double)arg5 options:(unsigned int)arg6;
+ (id)motionGestureEvent:(NSUInteger)arg1 gestureType:(unsigned int)arg2 progress:(double)arg3 options:(unsigned int)arg4;
+ (id)gameControllerEvent:(NSUInteger)arg1 controllerType:(unsigned int)arg2 options:(unsigned int)arg3;
+ (id)qualityDigitizerEvent:(NSUInteger)arg1 quality:(double)arg2 density:(double)arg3 irregularity:(double)arg4 majorRadius:(double)arg5 minorRadius:(double)arg6 accuracy:(double)arg7 options:(unsigned int)arg8;
+ (id)polarDigitizerEvent:(NSUInteger)arg1 altitude:(double)arg2 azimuth:(double)arg3 quality:(double)arg4 density:(double)arg5 majorRadius:(double)arg6 minorRadius:(double)arg7 options:(unsigned int)arg8;
+ (id)tiltDigitizerEvent:(NSUInteger)arg1 x:(double)arg2 y:(double)arg3 options:(unsigned int)arg4;
+ (id)digitizerEvent:(NSUInteger)arg1 transducerType:(unsigned int)arg2 x:(double)arg3 y:(double)arg4 z:(double)arg5 options:(unsigned int)arg6;
+ (id)compassEvent:(NSUInteger)arg1 x:(double)arg2 y:(double)arg3 z:(double)arg4 options:(unsigned int)arg5;
+ (id)motionActivityEvent:(NSUInteger)arg1 activityType:(unsigned int)arg2 confidence:(double)arg3 options:(unsigned int)arg4;
+ (id)brightnessEvent:(NSUInteger)arg1 currentBrightness:(double)arg2 targetBrightness:(double)arg3 transitionTime:(NSUInteger)arg4 options:(unsigned int)arg5;
+ (id)gyroEvent:(NSUInteger)arg1 x:(double)arg2 y:(double)arg3 z:(double)arg4 options:(unsigned int)arg5;
+ (id)buttonEvent:(NSUInteger)arg1 buttonMask:(unsigned int)arg2 options:(unsigned int)arg3;
+ (id)atmosphericPressureEvent:(NSUInteger)arg1 level:(double)arg2 sequence:(unsigned int)arg3 options:(unsigned int)arg4;
+ (id)scrollEvent:(NSUInteger)arg1 x:(double)arg2 y:(double)arg3 z:(double)arg4 options:(unsigned int)arg5;
+ (id)biometricEvent:(NSUInteger)arg1 eventType:(unsigned int)arg2 level:(double)arg3 options:(unsigned int)arg4;
+ (id)lEDEvent:(NSUInteger)arg1 ledMask:(unsigned int)arg2 number:(unsigned char)arg3 state:(unsigned int)arg4 options:(unsigned int)arg5;
+ (id)tiltOrientationEvent:(NSUInteger)arg1 x:(double)arg2 y:(double)arg3 z:(double)arg4 options:(unsigned int)arg5;
+ (id)quaternionOrientationEvent:(NSUInteger)arg1 w:(double)arg2 x:(double)arg3 y:(double)arg4 z:(double)arg5 options:(unsigned int)arg6;
+ (id)polarOrientationEvent:(NSUInteger)arg1 radius:(double)arg2 azimuth:(double)arg3 altitude:(double)arg4 options:(unsigned int)arg5;
+ (id)proximityEvent:(NSUInteger)arg1 detectionMask:(unsigned int)arg2 options:(unsigned int)arg3;
+ (id)keyboardEvent:(NSUInteger)arg1 usagePage:(unsigned short)arg2 usage:(unsigned short)arg3 down:(unsigned int)arg4 options:(unsigned int)arg5;
+ (id)pointerEvent:(NSUInteger)arg1 x:(double)arg2 y:(double)arg3 z:(double)arg4 buttonMask:(unsigned int)arg5 options:(unsigned int)arg6;
...
@property(readonly) NSUInteger senderID;
...
- (id)initWithType:(unsigned int)arg1 timestamp:(NSUInteger)arg2 senderID:(NSUInteger)arg3;
...
- (void)setTransitionTime:(NSUInteger)arg1;
- (NSUInteger)transitionTime;
