...
- (void)enumerateBodiesAlongRayStart:(struct CGPoint)arg1 end:(struct CGPoint)arg2 usingBlock:(id /* block */)arg3;
- (void)enumerateBodiesInRect:(struct CGRect)arg1 usingBlock:(id /* block */)arg2;
- (void)enumerateBodiesAtPoint:(struct CGPoint)arg1 usingBlock:(id /* block */)arg2;
