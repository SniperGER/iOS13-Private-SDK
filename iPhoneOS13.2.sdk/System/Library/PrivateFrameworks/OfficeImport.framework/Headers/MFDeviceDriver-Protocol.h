...
- (int)stretchBlt:(MFDeviceContext *)arg1 in_xDest:(int)arg2 in_yDest:(int)arg3 in_widthDest:(int)arg4 in_heightDest:(int)arg5 in_sourceImage:(MFBitmap *)arg6 in_xSrc:(int)arg7 in_ySrc:(int)arg8 in_widthSrc:(int)arg9 in_heightSrc:(int)arg10 in_rop:(unsigned int)arg11 in_xform:(CGAffineTransform )arg12 in_colour:(unsigned int)arg13;
- (int)bitBlt:(MFDeviceContext *)arg1 in_xDest:(int)arg2 in_yDest:(int)arg3 in_widthDest:(int)arg4 in_heightDest:(int)arg5 in_sourceImage:(MFBitmap *)arg6 in_xSrc:(int)arg7 in_ySrc:(int)arg8 in_rop:(unsigned int)arg9 in_xform:(CGAffineTransform )arg10 in_colour:(unsigned int)arg11;
...
- (int)polyPolygon:(MFDeviceContext *)arg1 in_points:(CGPoint )arg2 in_polyCounts:(int )arg3 in_count:(int)arg4;
- (int)polygon:(MFDeviceContext *)arg1 in_points:(CGPoint )arg2 in_count:(int)arg3;
- (int)polyPolyline:(MFDeviceContext *)arg1 in_points:(CGPoint )arg2 in_polyCounts:(int )arg3 in_count:(int)arg4;
- (int)polyline:(MFDeviceContext *)arg1 in_points:(CGPoint )arg2 in_count:(int)arg3;
