...
@interface OAXDrawingState : OCXReadState
{
    ...
    id mDocumentState;
    id /* CDUnknownBlockType */ _clientChartGraphicPropertyDefaultsBlock;
}

@property(copy, nonatomic) id /* CDUnknownBlockType */ clientChartGraphicPropertyDefaultsBlock; // @synthesize clientChartGraphicPropertyDefaultsBlock=_clientChartGraphicPropertyDefaultsBlock;
