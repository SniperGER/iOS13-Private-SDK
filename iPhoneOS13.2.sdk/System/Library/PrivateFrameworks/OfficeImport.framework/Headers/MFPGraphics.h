...
- (void)beginContainerWithId:(unsigned int)arg1 boundsInParent:(CGRect)arg2 bounds:(CGRect)arg3 boundsUnit:(int)arg4;
- (void)beginContainerNoParamsWithId:(unsigned int)arg1;
- (void)beginContainerWithId:(unsigned int)arg1 containerTransform:(CGAffineTransform)arg2;
