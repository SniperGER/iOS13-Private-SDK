...
- (NSUInteger)flattenFillIndex:(NSUInteger)arg1 differentialFill:(id)arg2;
- (id)copyFlattenBorder:(int)arg1 borders:(id)arg2 differentialBorders:(id)arg3 flag:(BOOL)arg4 precedence:(NSUInteger)arg5 row:(int)arg6 column:(int)arg7;
- (id)copyFlattenBorders:(id)arg1 differentialBorders:(id)arg2 borderFlags:(int)arg3 precedence:(NSUInteger)arg4 row:(int)arg5 column:(int)arg6;
// - (void)applyDifferentialStyle:(id)arg1 borderFlags:(int)arg2 precedence:(NSUInteger)arg3 toCell:(struct EDCellHeader )arg4 row:(int)arg5 column:(int)arg6;
