...
struct ChVector<NSRange *> {
    NSRange * _field1;
    NSRange * _field2;
    struct __compressed_pair<NSRange * *, ChAllocator<NSRange *>> {
        NSRange * _field1;
    } _field3;
};
...
struct XlBinaryReader {
    ...
    BOOL _field73;
    /* void * CDUnknownFunctionPointerType _field74 */;
...
struct XlChartBinaryReader {
    ...
    BOOL _field109;
    BOOL _field110;
    /* void * CDUnknownFunctionPointerType _field111 */;
...
typedef struct ChVector<NSRange *> {
    NSRange * _field1;
    NSRange * _field2;
    struct __compressed_pair<NSRange * *, ChAllocator<NSRange *>> {
        NSRange * _field1;
