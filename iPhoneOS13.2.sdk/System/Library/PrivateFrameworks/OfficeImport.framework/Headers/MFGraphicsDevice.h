...
- (int)plgBlt:(CGPoint )arg1 in_sourceImage:(id)arg2 in_xSrc:(int)arg3 in_ySrc:(int)arg4 in_widthSrc:(int)arg5 in_heightSrc:(int)arg6 in_maskImage:(id)arg7 in_xMask:(int)arg8 in_yMask:(int)arg9 in_xform:(CGAffineTransform )arg10 in_colour:(unsigned int)arg11;
- (int)maskBlt:(int)arg1 in_yDest:(int)arg2 in_widthDest:(int)arg3 in_heightDest:(int)arg4 in_sourceImage:(id)arg5 in_xSrc:(int)arg6 in_ySrc:(int)arg7 in_maskImage:(id)arg8 in_xMask:(int)arg9 in_yMask:(int)arg10 in_rop:(unsigned int)arg11 in_xform:(CGAffineTransform )arg12 in_colour:(unsigned int)arg13;
...
- (int)stretchBlt:(int)arg1 in_yDest:(int)arg2 in_widthDest:(int)arg3 in_heightDest:(int)arg4 in_sourceImage:(id)arg5 in_xSrc:(int)arg6 in_ySrc:(int)arg7 in_widthSrc:(int)arg8 in_heightSrc:(int)arg9 in_rop:(unsigned int)arg10 in_xform:(CGAffineTransform )arg11 in_colour:(unsigned int)arg12 usePaletteForBilevel:(BOOL)arg13;
- (int)stretchBlt:(int)arg1 in_yDest:(int)arg2 in_widthDest:(int)arg3 in_heightDest:(int)arg4 in_sourceImage:(id)arg5 in_xSrc:(int)arg6 in_ySrc:(int)arg7 in_widthSrc:(int)arg8 in_heightSrc:(int)arg9 in_rop:(unsigned int)arg10 in_xform:(CGAffineTransform )arg11 in_colour:(unsigned int)arg12;
- (int)bitBlt:(int)arg1 in_yDest:(int)arg2 in_widthDest:(int)arg3 in_heightDest:(int)arg4 in_sourceImage:(id)arg5 in_xSrc:(int)arg6 in_ySrc:(int)arg7 in_rop:(unsigned int)arg8 in_xform:(CGAffineTransform )arg9 in_colour:(unsigned int)arg10;
...
- (void)applyDCAtIndexToCurrentContext:(NSUInteger)arg1;
- (void)applyClippingOfDCAtIndexToCurrentContext:(NSUInteger)arg1;
- (void)addClippingPathToCurrentContext:(id)arg1 dc:(id)arg2;
- (id)clipEverythingClippingPath;
- (id)implicitClippingPath;
- (void)applyNonClippingOfDCAtIndexToCurrentContext:(NSUInteger)arg1;
