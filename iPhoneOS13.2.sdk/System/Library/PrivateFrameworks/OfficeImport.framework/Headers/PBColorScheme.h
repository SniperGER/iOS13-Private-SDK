...
//  (void)addColorWithIndex:(int)arg1 fromScheme:(struct PptColorSchemeAtom )arg2 colorTransform:(/* void * CDUnknownFunctionPointerType */)arg3 atIndex:(int)arg4 inScheme:(id)arg5;
