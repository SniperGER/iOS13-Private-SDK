...
//  (id)oadGraphicPropertiesFromXlMarkerStyle:(const struct XlChartMarkerStyle )arg1 complex:(BOOL)arg2 state:(id)arg3;
...
//  (id)mapFillStyleForMarker:(const struct XlChartMarkerStyle )arg1 complex:(BOOL)arg2 state:(id)arg3;
