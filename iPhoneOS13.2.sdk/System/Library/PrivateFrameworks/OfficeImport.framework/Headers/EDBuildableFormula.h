...
- (BOOL)insertName:(NSUInteger)arg1 link:(NSUInteger)arg2 external:(BOOL)arg3 atIndex:(unsigned int)arg4;
- (BOOL)makeArrayForLastToken:(NSUInteger)arg1;
...
- (void)removeTokenAtIndex:(NSUInteger)arg1;
- (void)replaceStringInStringTokenAtIndex:(NSUInteger)arg1 content:(id)arg2;
- (id)stringFromStringTokenAtIndex:(NSUInteger)arg1;
- (int)tokenTypeAtIndex:(NSUInteger)arg1;
- (void)dealloc;
// - (BOOL)shrinkSpanningRef:(struct EDBuildablePtg )arg1;
// - (BOOL)fixTableOfConstantsRef:(struct EDBuildablePtg )arg1;
// - (struct EDBuildablePtg )tokenAtIndex:(NSUInteger)arg1 previousToken:(struct EDBuildablePtg )arg2;
// - (struct EDBuildablePtg )tokenAtIndex:(NSUInteger)arg1;
