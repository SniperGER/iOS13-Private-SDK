...
@class ACDAccessPluginManager, ACDAccountNotifier, ACDAuthenticationDialogManager, ACDAuthenticationPluginManager, ACDClient, ACDClientAuthorizationManager, ACDDatabaseBackupActivity, ACDDatabaseConnection, ACDDataclassOwnersManager, ACDFakeRemoteAccountStoreSession, ACRemoteDeviceProxy, NSMutableArray;
...
- (id)_predicateForFetchingAccountsWithManagedAccountTypeID:(id)arg1 options:(NSUInteger)arg2;
- (id)_accountsWithAccountType:(id)arg1 options:(NSUInteger)arg2 error:(id )arg3;
- (id)_accountsWithAcountType:(id)arg1 error:(id )arg2;
- (void)accountsWithAccountType:(id)arg1 options:(NSUInteger)arg2 completion:(CDUnknownBlockType)arg3;
