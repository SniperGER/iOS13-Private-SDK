...
- (void)scheduleBackupIfNonexistent:(void (^)(BOOL, NSError *))arg1;
...
- (void)accountsWithAccountType:(ACAccountType *)arg1 options:(NSUInteger)arg2 completion:(void (^)(NSArray *, NSError *))arg3;
