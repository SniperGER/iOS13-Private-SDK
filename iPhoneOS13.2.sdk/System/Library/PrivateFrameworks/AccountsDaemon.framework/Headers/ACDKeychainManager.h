...
+ (_Bool)_dataclassSyncItemExistsForServiceName:(id)arg1 username:(id)arg2;
+ (_Bool)_accountSyncItemExistsForServiceName:(id)arg1 hostname:(id)arg2;
+ (_Bool)_accountSyncItemExistsForServiceName:(id)arg1 username:(id)arg2;
+ (_Bool)_setAccountSyncMigrateItem:(id)arg1 username:(id)arg2 accessGroup:(id)arg3 accessibility:(id)arg4 options:(id)arg5 error:(id *)arg6;
+ (_Bool)_setDataclassSyncItem:(id)arg1 username:(id)arg2 accessGroup:(id)arg3 accessibility:(id)arg4 options:(id)arg5 error:(id *)arg6;
+ (_Bool)_setAccountSyncItem:(id)arg1 hostname:(id)arg2 accessGroup:(id)arg3 accessibility:(id)arg4 options:(id)arg5 error:(id *)arg6;
+ (_Bool)_setAccountSyncItem:(id)arg1 username:(id)arg2 accessGroup:(id)arg3 accessibility:(id)arg4 options:(id)arg5 error:(id *)arg6;
...
+ (_Bool)removeAccountSyncItemForAccount:(id)arg1 clientID:(id)arg2 properties:(id)arg3 error:(id *)arg4;
+ (void)createDataclassAccountSyncItemForAccount:(id)arg1 withDataclassActions:(id)arg2;
+ (_Bool)createAccountSyncMigratedItemWithError:(id *)arg1;
+ (_Bool)createAccountSyncItemForAccount:(id)arg1 clientID:(id)arg2 properties:(id)arg3 error:(id *)arg4;
+ (void)_fallbackToUnsyncedOAuthTokens:(id)arg1;
+ (void)_createNoSyncOAuthTokens:(id)arg1 account:(id)arg2 clientID:(id)arg3;
+ (_Bool)_keychainLock_removeItemForService:(id)arg1 username:(id)arg2 accessGroup:(id)arg3 options:(id)arg4 error:(id *)arg5;
+ (_Bool)_removeItemForService:(id)arg1 username:(id)arg2 accessGroup:(id)arg3 options:(id)arg4 error:(id *)arg5;
+ (void)_keychainLock_addItem:(id)arg1 forServiceName:(id)arg2 username:(id)arg3 accessGroup:(id)arg4 accessibility:(id)arg5 syncable:(_Bool)arg6 requiresTouchID:(_Bool)arg7 error:(id *)arg8;
...
+ (id)_credentialForAccountWithID:(id)arg1 accountTypeID:(id)arg2 credentialType:(id)arg3 clientID:(id)arg4 allowAdditionalAccountTypeSegment:(_Bool)arg5 options:(id)arg6 error:(id *)arg7;
