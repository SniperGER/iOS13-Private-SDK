...
@property(nonatomic, readonly) NSUInteger trendingStyle;
...
@property(nonatomic, readonly) NSUInteger bestOfBundleFeedGroupKind;
@property(nonatomic, readonly) NSUInteger likeDislikeBehavior;
