...
- (void)navigationSession:(MNNavigationSession *)arg1 displayManeuverAlertForAnnouncementStage:(NSUInteger)arg2;
- (void)navigationSession:(MNNavigationSession *)arg1 displayPrimaryStep:(GEOStep *)arg2 instructions:(NSArray *)arg3 shieldType:(int)arg4 shieldText:(NSString *)arg5 drivingSide:(int)arg6 maneuverStepIndex:(NSUInteger)arg7 isSynthetic:(BOOL)arg8;
- (void)navigationSession:(MNNavigationSession *)arg1 triggerHaptics:(int)arg2;
- (void)navigationSession:(MNNavigationSession *)arg1 didAnnounce:(NSString *)arg2 stage:(NSUInteger)arg3;
- (void)navigationSession:(MNNavigationSession *)arg1 willAnnounce:(NSUInteger)arg2 inSeconds:(double)arg3;
- (void)navigationSession:(MNNavigationSession *)arg1 currentStepIndex:(NSUInteger)arg2 didUpdateDistanceUntilManeuver:(double)arg3 timeUntilManeuver:(double)arg4;
- (void)navigationSession:(MNNavigationSession *)arg1 currentStepIndex:(NSUInteger)arg2 didUpdateDistanceUntilSign:(double)arg3 timeUntilSign:(double)arg4;
- (void)navigationSession:(MNNavigationSession *)arg1 proceedToRouteDistance:(double)arg2 displayString:(NSString *)arg3 closestStepIndex:(NSUInteger)arg4;
...
- (void)navigationSession:(MNNavigationSession *)arg1 didUpdateMotionType:(NSUInteger)arg2 confidence:(NSUInteger)arg3;
...
- (void)navigationSession:(MNNavigationSession *)arg1 didUpdateDisplayETA:(NSDate *)arg2 displayRemainingMinutes:(NSUInteger)arg3 forRoute:(MNActiveRouteInfo *)arg4;
...
- (void)navigationSession:(MNNavigationSession *)arg1 matchedToStepIndex:(NSUInteger)arg2 legIndex:(NSUInteger)arg3;
