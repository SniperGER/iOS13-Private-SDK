...
+ (id)sharedService;
+ (NSUInteger)_hashForProtocol:(id)arg1;
...
- (NSUInteger)alternateRouteIndexForRoute:(id)arg1;
- (NSUInteger)displayRemainingMinutesForRoute:(id)arg1;
...
- (void)vibrateForPrompt:(NSUInteger)arg1 completion:(CDUnknownBlockType)arg2;
