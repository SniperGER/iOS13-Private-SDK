...
+ (id)_navigation_spokenStringWithMinutes:(NSUInteger)arg1 andAbbreviationType:(NSUInteger)arg2;
+ (id)_navigation_spokenStringWithSeconds:(NSUInteger)arg1 andAbbreviationType:(NSUInteger)arg2;
+ (id)_navigation_spokenStringWithSeconds:(NSUInteger)arg1 abbreviated:(BOOL)arg2;
+ (id)_navigation_stringWithMinutes:(NSUInteger)arg1 andAbbreviationType:(NSUInteger)arg2;
+ (id)_navigation_stringWithSeconds:(NSUInteger)arg1 andAbbreviationType:(NSUInteger)arg2;
+ (id)_navigation_stringWithSeconds:(NSUInteger)arg1 abbreviated:(BOOL)arg2;
+ (id)_navigation_stringForDistance:(double)arg1 formatter:(id)arg2 locale:(id)arg3;
+ (id)_navigation_localizedStringForDistance:(double)arg1 detail:(long long)arg2 unitFormat:(long long)arg3 locale:(id)arg4 useMetric:(NSUInteger)arg5 useYards:(NSUInteger)arg6;
...
- (NSUInteger)_navigation_distanceLevenshtein:(id)arg1;
