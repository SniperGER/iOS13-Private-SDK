...
@class GEONavigationMapMatcher, MNArrivalUpdater, MNLocation, NSData, NSDate, NSMutableArray, NSTimer;
...
- (void)_reroute:(id)arg1 rerouteReason:(NSUInteger)arg2 request:(id)arg3 response:(id)arg4;
...
- (id)_rerouteTicketForLocation:(id)arg1 transportType:(int)arg2 stepIndex:(NSUInteger)arg3;
