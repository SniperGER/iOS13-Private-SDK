...
@property(nonatomic) NSUInteger speedLimit; // @synthesize speedLimit=_speedLimit;
...
- (id)initWithRawLocation:(id)arg1 locationMatchType:(NSUInteger)arg2;
- (id)initWithRoadMatch:(id)arg1 rawLocation:(id)arg2 locationMatchType:(NSUInteger)arg3;
- (id)initWithRouteMatch:(id)arg1 rawLocation:(id)arg2 locationMatchType:(NSUInteger)arg3;
