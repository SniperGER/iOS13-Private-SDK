...
@interface MNClassicGuidanceManager : NSObject <MNGuidanceManager>
{
    ...
    NSUInteger _pointIndexForCurrentRoadInfo;
...
//     CDStruct_61a83fd4 _currentInstructionOptions;
    ...
    NSUInteger _countLocationUpdates;
}
...
- (void)_notifyAnnounceManeuverForStep:(id)arg1 withDistance:(double)arg2 withCombinedGuidance:(int)arg3 playShortPrompt:(BOOL)arg4 isRepeat:(BOOL)arg5 stage:(NSUInteger)arg6 timeLimit:(double)arg7;
...
- (double)_timeUntilNextAnnouncement:(id)arg1 location:(id)arg2 upcomingStage:(out NSUInteger )arg3;
...
- (NSUInteger)_currentAnnouncementStage;
...
@property(readonly, nonatomic) NSUInteger maneuverStepIndex;
- (NSUInteger)_maneuverStepIndex;
@property(readonly, nonatomic) BOOL proceedingToRoute;
- (id)_getStepAtIndex:(NSUInteger)arg1 clampIndexToRange:(BOOL)arg2;
- (id)_getStepAtIndex:(NSUInteger)arg1;
