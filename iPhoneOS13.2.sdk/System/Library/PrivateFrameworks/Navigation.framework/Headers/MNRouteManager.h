...
- (void)updateForReroute:(id)arg1 rerouteReason:(NSUInteger)arg2 request:(id)arg3 response:(id)arg4;
- (void)updateWithStartNavigationDetails:(id)arg1;
- (void)updateWithPreviewRoutes:(id)arg1 selectedRouteIndex:(NSUInteger)arg2;
