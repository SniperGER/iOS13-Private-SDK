...
@class GEOComposedGuidanceEvent, MNAnnouncementPlanEvent, MNGuidanceSignInfo, MNJunctionViewImageLoader, MNLocation, MNNavigationSession, NSArray, NSDictionary, NSMutableArray, NSMutableDictionary, NSMutableSet, NSUUID;
...
- (id)_selectAnnouncementForEvent:(id)arg1 withTimeRemaining:(double)arg2 withMinIndex:(NSUInteger)arg3 selectedIndex:(out NSUInteger )arg4;
- (double)_timeRemainingForEvent:(id)arg1;
- (void)_notifySpeechEvent:(id)arg1 variant:(NSUInteger)arg2 ignorePromptStyle:(BOOL)arg3;
...
- (double)durationOfEvent:(id)arg1 announcementIndex:(NSUInteger)arg2 distance:(double)arg3;
