...
@property(copy, nonatomic) id /* block */ timeSinceRecordingBeganHandler; // @synthesize timeSinceRecordingBeganHandler=_timeSinceRecordingBeganHandler;
...
- (void)cancelTrace;
- (void)saveTrace;
- (void)startWritingTraceToFileAtPath:(id)arg1 shouldPrepareStatements:(_Bool)arg2 completion:(id /* block */)arg3;
...
- (void)dealloc;
- (id)initWithPath:(id)arg1 clMapMatching:(_Bool)arg2 errorHandler:(id /* block */)arg3;
