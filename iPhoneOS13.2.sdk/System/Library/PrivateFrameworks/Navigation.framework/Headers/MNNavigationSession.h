...
- (void)tracePlayer:(id)arg1 didUpdateMotion:(NSUInteger)arg2 exitType:(NSUInteger)arg3 confidence:(NSUInteger)arg4;
...
- (void)timeAndDistanceUpdater:(id)arg1 didUpdateDisplayETA:(id)arg2 displayRemainingMinutes:(NSUInteger)arg3 forRoute:(id)arg4;
- (void)timeAndDistanceUpdater:(id)arg1 currentStepIndex:(NSUInteger)arg2 didUpdateDistanceUntilManeuver:(double)arg3 timeUntilManeuver:(double)arg4;
...
- (void)guidanceManager:(id)arg1 announce:(id)arg2 shortPromptType:(NSUInteger)arg3 ignorePromptStyle:(BOOL)arg4 stage:(NSUInteger)arg5 hasSecondaryManeuver:(BOOL)arg6 completionBlock:(CDUnknownBlockType)arg7;
- (void)guidanceManager:(id)arg1 willAnnounce:(NSUInteger)arg2 inSeconds:(double)arg3;
...
- (void)guidanceManager:(id)arg1 displayManeuverAlertForAnnouncementStage:(NSUInteger)arg2;
- (void)guidanceManager:(id)arg1 displayPrimaryStep:(id)arg2 instructions:(id)arg3 shieldType:(int)arg4 shieldText:(id)arg5 drivingSide:(int)arg6 maneuverStepIndex:(NSUInteger)arg7 isSynthetic:(BOOL)arg8;
- (void)guidanceManagerDidUpdateProgress:(id)arg1 currentStepIndex:(NSUInteger)arg2 distanceUntilSign:(double)arg3 timeUntilSign:(double)arg4;
- (void)guidanceManagerProceedingToRoute:(id)arg1 proceedToRouteDistance:(double)arg2 displayString:(id)arg3 closestStepIndex:(NSUInteger)arg4;
...
- (void)locationTracker:(id)arg1 matchedToStepIndex:(NSUInteger)arg2 legIndex:(NSUInteger)arg3;
