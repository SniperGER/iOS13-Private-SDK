...
- (void)navigationSessionManager:(MNNavigationSessionManager *)arg1 didChangeVolume:(NSUInteger)arg2;
- (void)navigationSessionManager:(MNNavigationSessionManager *)arg1 didStartUsingVoiceLanguage:(NSString *)arg2;
- (void)navigationSessionManager:(MNNavigationSessionManager *)arg1 didUpdateAudioRouteSelection:(NSUInteger)arg2;
...
- (void)navigationSessionManager:(MNNavigationSessionManager *)arg1 displayManeuverAlertForAnnouncementStage:(NSUInteger)arg2;
- (void)navigationSessionManager:(MNNavigationSessionManager *)arg1 displayPrimaryStep:(GEOStep *)arg2 instructions:(NSArray *)arg3 shieldType:(int)arg4 shieldText:(NSString *)arg5 drivingSide:(int)arg6 maneuverStepIndex:(NSUInteger)arg7 isSynthetic:(BOOL)arg8;
- (void)navigationSessionManager:(MNNavigationSessionManager *)arg1 willAnnounce:(NSUInteger)arg2 inSeconds:(double)arg3;
- (void)navigationSessionManager:(MNNavigationSessionManager *)arg1 currentStepIndex:(NSUInteger)arg2 didUpdateDistanceUntilManeuver:(double)arg3 timeUntilManeuver:(double)arg4;
- (void)navigationSessionManager:(MNNavigationSessionManager *)arg1 currentStepIndex:(NSUInteger)arg2 didUpdateDistanceUntilSign:(double)arg3 timeUntilSign:(double)arg4;
- (void)navigationSessionManager:(MNNavigationSessionManager *)arg1 proceedToRouteDistance:(double)arg2 displayString:(NSString *)arg3 closestStepIndex:(NSUInteger)arg4;
...
- (void)navigationSessionManager:(MNNavigationSessionManager *)arg1 didUpdatePreviewRoutes:(NSArray *)arg2 withSelectedRouteIndex:(NSUInteger)arg3;
- (void)navigationSessionManager:(MNNavigationSessionManager *)arg1 didUpdateMotionType:(NSUInteger)arg2 confidence:(NSUInteger)arg3;
...
- (void)navigationSessionManager:(MNNavigationSessionManager *)arg1 didUpdateDisplayETA:(NSDate *)arg2 displayRemainingMinutes:(NSUInteger)arg3 forRoute:(MNActiveRouteInfo *)arg4;
...
- (void)navigationSessionManager:(MNNavigationSessionManager *)arg1 didUpdateStepIndex:(NSUInteger)arg2 legIndex:(NSUInteger)arg3;
