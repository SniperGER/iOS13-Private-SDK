...
+ (id)eventWithText:(id)arg1 fallbackPrompt:(NSUInteger)arg2 options:(NSUInteger)arg3 completion:(CDUnknownBlockType)arg4;
...
- (id)description;
- (id)initWithText:(id)arg1 fallbackPrompt:(NSUInteger)arg2 options:(NSUInteger)arg3 completion:(CDUnknownBlockType)arg4;
