...
@interface MPCModelGenericAVItemAssetLoadResult : NSObject
{
    ...
    id _suzeLeaseID;
    id /* CDUnknownBlockType */ _willBecomeActivePlayerItemHandler;
}

+ (id)assetLoadResultWithStoreAssetPlaybackResponse:(id)arg1 assetLoadProperties:(id)arg2 error:(id )arg3;
@property(copy, nonatomic) id /* CDUnknownBlockType */ willBecomeActivePlayerItemHandler; // @synthesize willBecomeActivePlayerItemHandler=_willBecomeActivePlayerItemHandler;
