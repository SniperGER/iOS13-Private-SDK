...
- (NSProgress *)nowPlayingInfoCenter:(MPNowPlayingInfoCenter *)arg1 artworkForContentItem:(MPNowPlayingContentItem *)arg2 size:(CGSize)arg3 completion:(void (^)(UIImage *, NSError *))arg4;
