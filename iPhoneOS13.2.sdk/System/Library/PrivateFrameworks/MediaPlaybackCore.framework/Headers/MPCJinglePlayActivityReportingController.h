...
- (void)completePendingPlayActivityEvents:(id)arg1 forSessionToken:(NSUInteger)arg2 withResult:(NSUInteger)arg3 completionHandler:(CDUnknownBlockType)arg4;
- (void)acquirePendingPlayActivityEventsForStoreAccountID:(NSUInteger)arg1 completionHandler:(CDUnknownBlockType)arg2;
