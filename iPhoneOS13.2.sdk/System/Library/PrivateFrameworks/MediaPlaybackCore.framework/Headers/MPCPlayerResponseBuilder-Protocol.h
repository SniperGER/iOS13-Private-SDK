...
- (NSUInteger)playerNumberOfItems:(NSUInteger)arg1 inSection:(NSUInteger)arg2 chain:(MPMiddlewareChain *)arg3;
- (NSUInteger)playerNumberOfSections:(NSUInteger)arg1 chain:(MPMiddlewareChain *)arg2;
