...
@interface MPCPlaybackEngine : NSObject <MPCExplicitContentAuthorizationDelegate>
{
    ...
    NSUInteger _audioSessionOptions;
}
...
@property(nonatomic) NSUInteger audioSessionOptions; // @synthesize audioSessionOptions=_audioSessionOptions;
...
- (void)becomeActive;
- (void)start;
- (id)initWithPlayerID:(id)arg1 options:(NSUInteger)arg2;
