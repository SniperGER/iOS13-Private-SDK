...
- (void)resolveWithQueue:(id)arg1 routeIdentifiers:(id)arg2 localPlaybackPermitted:(_Bool)arg3 audioRoutingInfo:(CDStruct_8024420c)arg4 completion:(id /* block */)arg5;
- (void)resolveWithQueue:(id)arg1 routeIdentifiers:(id)arg2 localPlaybackPermitted:(_Bool)arg3 completion:(id /* block */)arg4;
- (void)resolveWithQueue:(id)arg1 hashedRouteIdentifiers:(id)arg2 localPlaybackPermitted:(_Bool)arg3 audioRoutingInfo:(CDStruct_8024420c)arg4 completion:(id /* block */)arg5;
- (void)resolveWithQueue:(id)arg1 hashedRouteIdentifiers:(id)arg2 localPlaybackPermitted:(_Bool)arg3 completion:(id /* block */)arg4;
- (void)resolveWithRouteIdentifiers:(id)arg1 audioRoutingInfo:(CDStruct_8024420c)arg2 completion:(id /* block */)arg3;
- (void)resolveWithRouteIdentifiers:(id)arg1 completion:(id /* block */)arg2;
- (void)resolveWithHashedRouteIdentifiers:(id)arg1 audioRoutingInfo:(CDStruct_8024420c)arg2 completion:(id /* block */)arg3;
