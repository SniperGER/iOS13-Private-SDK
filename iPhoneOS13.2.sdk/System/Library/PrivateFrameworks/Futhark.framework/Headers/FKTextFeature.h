...
- (void)dealloc;
//  (id)initWithType:(long long)arg1 boundingBox:(CGRect )arg2 corners:(id)arg3 featureID:(long long)arg4 session:(struct FKSession )arg5 backingIndex:(CDUnion_a5814135)arg6 scale:(int)arg7;
