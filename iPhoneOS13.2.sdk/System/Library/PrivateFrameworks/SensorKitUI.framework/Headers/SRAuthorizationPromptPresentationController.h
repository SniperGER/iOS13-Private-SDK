...
- (void)presentPendingAuthorizationPromptViewController:(id)arg1 withDesiredServices:(id)arg2 bundlePath:(id)arg3 completionHandler:(id /* block */)arg4;
...
- (_Bool)presentAnyViewController:(id)arg1 completionHandler:(id /* block */)arg2;
- (void)dealloc;
