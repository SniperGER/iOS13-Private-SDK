...
- (_Bool)canSaveWithAccountProvider:(id /* block */)arg1;
- (_Bool)preflightSaveWithAccountProvider:(id /* block */)arg1;
...
- (void)performUsingAccountPersona:(id /* block */)arg1;
...
- (void)dealloc;
- (_Bool)handleTrustChallenge:(id)arg1 completionHandler:(id /* block */)arg2;
...
- (void)webLoginRequestedAtURL:(id)arg1 reasonString:(id)arg2 inQueue:(id)arg3 completionBlock:(id /* block */)arg4;
- (void)_webLoginRequestedAtURL:(id)arg1 reasonString:(id)arg2 inQueue:(id)arg3 completionBlock:(id /* block */)arg4;
- (void)dropAssertionsAndRenewCredentialsInQueue:(id)arg1 withHandler:(id /* block */)arg2;
