...
- (void)_extractTrainingSamplesForQuery:(id)arg1 withIndexOfEngagedItem:(NSUInteger)arg2 withItems:(id)arg3 withCEPData:(id)arg4 forClientBundle:(id)arg5 debugInfoEnabled:(BOOL)arg6 keyboardPrimaryLanguage:(id)arg7;
// - (void)_writeResult:(struct json_writer )arg1 item:(id)arg2;
- (void)extractTrainingDataWithItemAtIndex:(NSUInteger)arg1 withItems:(id)arg2 forQuery:(id)arg3 dataCollectAllowed:(BOOL)arg4 forClientBundle:(id)arg5 keyboardPrimaryLanguage:(id)arg6;
- (void)extractTrainingDataWithItemAtIndex:(NSUInteger)arg1 withItems:(id)arg2 forQuery:(id)arg3 dataCollectAllowed:(BOOL)arg4 queryID:(id)arg5 withCEPData:(id)arg6 forClientBundle:(id)arg7 debugInfoEnabled:(BOOL)arg8 keyboardPrimaryLanguage:(id)arg9;
...
- (id)_abandonedItemsFromItems:(id)arg1 withIndexOfEngagedItem:(NSUInteger)arg2;
