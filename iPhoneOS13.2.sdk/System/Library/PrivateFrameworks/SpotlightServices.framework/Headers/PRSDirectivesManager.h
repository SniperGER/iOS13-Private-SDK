...
//     struct fan_out_value directive_fan_out;
    struct _local_resultset_id_values_mapping {
        NSUInteger start_idx;
        NSUInteger end_idx;
//         struct __CFDictionary mapping;
        NSUInteger numPRSRankingBundleFeatures;
        NSUInteger PRSRankingBundleFeatureOrder;
        id /* CDUnknownBlockType */ PRSRankingBundleFeaturePickers;
        float score_vector;
        NSUInteger mapSize;
...
- (NSUInteger)getDirectiveTypeFromString:(id)arg1;
- (void)dealloc;
- (id)init;
