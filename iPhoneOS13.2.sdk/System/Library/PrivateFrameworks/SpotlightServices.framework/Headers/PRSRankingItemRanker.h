...
@property NSUInteger queryTermCount; // @synthesize queryTermCount=_queryTermCount;
...
- (void)relevantResultSetPRSL2FeaturesFromBundleFeature:(NSUInteger)arg1 absRankFeatureOut:(unsigned short )arg2 relRankFeatureOut:(unsigned short )arg3;
...
- (void)deactivate;
- (void)activate;
- (id)rankingConfigurationWithMeContact:(id)arg1 emailAddresses:(id)arg2 phoneFavorites:(id)arg3 vipList:(id)arg4 clientBundle:(id)arg5 isScopedSearch:(BOOL)arg6 spotlightQuery:(id)arg7 userQuery:(id)arg8 whyQuery:(NSUInteger)arg9 isPeopleSearch:(BOOL)arg10;
