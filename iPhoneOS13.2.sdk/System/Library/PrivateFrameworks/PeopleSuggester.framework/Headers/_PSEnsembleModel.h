...
- (id)rankedContactSuggestionsWithPredictionContext:(id)arg1 contactsOnly:(BOOL)arg2 maxSuggestions:(NSUInteger)arg3;
- (id)suggestZKWMessagesSuggestionsWithPredictionContext:(id)arg1 maxSuggestions:(NSUInteger)arg2;
...
- (id)predictWithMapsPredictionContext:(id)arg1 maxSuggestions:(NSUInteger)arg2;
- (id)suggestionsFromSuggestionProxies:(id)arg1 supportedBundleIDs:(id)arg2 contactKeysToFetch:(id)arg3 meContactIdentifier:(id)arg4 maxSuggestions:(NSUInteger)arg5;
- (id)predictWithPredictionContext:(id)arg1 maxSuggestions:(NSUInteger)arg2 contactKeysToFetch:(id)arg3;
- (id)predictWithPredictionContext:(id)arg1 maxSuggestions:(NSUInteger)arg2;
