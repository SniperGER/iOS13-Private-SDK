...
@property(readonly, nonatomic) NSUInteger k; // @synthesize k=_k;
// - (void).cxx_destruct;
...
- (id)mapsShareEtaDefaultKnnSuggestions:(id)arg1 maxSuggestions:(NSUInteger)arg2;
- (id)rankedMapsShareEtaSuggestions:(id)arg1 maxSuggestions:(NSUInteger)arg2;
- (NSUInteger)indexToInsertNeighbor:(id)arg1 array:(id)arg2;
- (id)neighborsFromTrainingData:(id)arg1 k:(NSUInteger)arg2 queryPoint:(id)arg3;
- (id)sliceStart:(NSUInteger)arg1 end:(NSUInteger)arg2 ofArray:(id)arg3;
...
- (id)filterShareInteractions:(id)arg1 minimumOccurences:(NSUInteger)arg2;
...
- (id)rankedGlobalSuggestionsWithPredictionContext:(id)arg1 maxSuggestions:(NSUInteger)arg2 contactsOnly:(BOOL)arg3 interactions:(id)arg4 contactIdsCurrentlyInStore:(id)arg5;
- (id)normalizedStringFromString:(id)arg1;
- (id)rankedNameSuggestionsWithPredictionContext:(id)arg1 forName:(id)arg2;
- (id)rankedMessagesZkwSuggestionsWithPredictionContext:(id)arg1 bundleId:(id)arg2 maxSuggestions:(NSUInteger)arg3 frequencyOnly:(BOOL)arg4 interactions:(id)arg5;
- (id)rankedZkwSuggestionsWithPredictionContext:(id)arg1 maxSuggestions:(NSUInteger)arg2;
...
- (id)initWithK:(NSUInteger)arg1 interactionStore:(id)arg2 filterByBundleIds:(id)arg3 knowledgeStore:(id)arg4 contactResolver:(id)arg5 messageInteractionCache:(id)arg6 shareInteractionCache:(id)arg7;
