...
- (void)SPIQueryMessagesForSenders:(id)arg1 onlyUnread:(_Bool)arg2 limit:(long long)arg3 completion:(id /* block */)arg4;
...
- (void)SPIQueryMessagesForChatsWithIdentifiers:(id)arg1 services:(id)arg2 onlyUnread:(_Bool)arg3 limit:(long long)arg4 completion:(id /* block */)arg5;
- (void)SPIQueryMessagesForChats:(id)arg1 onlyUnread:(_Bool)arg2 limit:(long long)arg3 completion:(id /* block */)arg4;
- (id)allIMHandlesForHandle:(id)arg1;
- (id)resolveDateTimeRange:(id)arg1;
- (_Bool)resolvePersons:(id)arg1 forIntent:(id)arg2 completionHandler:(id /* block */)arg3;
