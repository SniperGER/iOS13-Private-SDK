...
- (unsigned long long)clearAndRenderStrokes:(id)arg1 clippedToStrokeSpaceRect:(struct CGRect)arg2 strokeTransform:(struct CGAffineTransform)arg3 stopBlock:(id /* block */)arg4;
- (unsigned long long)_renderStrokes:(id)arg1 clippedToStrokeSpaceRect:(struct CGRect)arg2 strokeTransform:(struct CGAffineTransform)arg3 stopBlock:(id /* block */)arg4;
...
-     // Error parsing type: @64@0:8{_PKStrokePointSlice={__wrap_iter<const _PKStrokePoint *>=^{_PKStrokePoint}}{__wrap_iter<const _PKStrokePoint *>=^{_PKStrokePoint}}}16^{AnimatingStroke=@@B{unique_ptr<PKBSplineFilter, std::__1::default_delete<PKBSplineFilter> >={__compressed_pair<PKBSplineFilter *, std::__1::default_delete<PKBSplineFilter> >=^{PKBSplineFilter}}}{unique_ptr<PKOutputTimeFilter, std::__1::default_delete<PKOutputTimeFilter> >={__compressed_pair<PKOutputTimeFilter *, std::__1::default_delete<PKOutputTimeFilter> >=^{PKOutputTimeFilter}}}{unique_ptr<PKMetalInputProvider, std::__1::default_delete<PKMetalInputProvider> >={__compressed_pair<PKMetalInputProvider *, std::__1::default_delete<PKMetalInputProvider> >=^{PKMetalInputProvider}}}{CGAffineTransform=dddddd}qB{CGRect={CGPoint=dd}{CGSize=dd}}{CGRect={CGPoint=dd}{CGSize=dd}}dIBB@?}32r^{vector<int, std::__1::allocator<int> >=^i^i{__compressed_pair<int *, std::__1::allocator<int> >=^i}}40r^48f56f60, name: generatePaintCacheForStroke:animatingStroke:segmentSteps:liveStrokePoints:liveStrokeStartTime:strokeInterval:
...
- (unsigned long long)renderStrokes:(id)arg1 clippedToStrokeSpaceRect:(struct CGRect)arg2 strokeTransform:(struct CGAffineTransform)arg3 stopBlock:(id /* block */)arg4;
