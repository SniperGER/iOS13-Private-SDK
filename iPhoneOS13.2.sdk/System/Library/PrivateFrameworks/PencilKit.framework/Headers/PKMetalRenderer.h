...
@property(nonatomic) CGColorRef liveRenderingOverrideColor; // @synthesize liveRenderingOverrideColor=_liveRenderingOverrideColor;
@property(nonatomic) CGColorRef backgroundColor; // @synthesize backgroundColor=_backgroundColor;
...
- (NSUInteger)clearAndRenderStrokes:(id)arg1 clippedToStrokeSpaceRect:(CGRect)arg2 strokeTransform:(CGAffineTransform)arg3 stopBlock:(CDUnknownBlockType)arg4;
- (NSUInteger)_renderStrokes:(id)arg1 clippedToStrokeSpaceRect:(CGRect)arg2 strokeTransform:(CGAffineTransform)arg3 stopBlock:(CDUnknownBlockType)arg4;
...
- (NSUInteger)renderStrokes:(id)arg1 stopBlock:(CDUnknownBlockType)arg2;
- (NSUInteger)renderStrokes:(id)arg1 clippedToStrokeSpaceRect:(CGRect)arg2 strokeTransform:(CGAffineTransform)arg3 stopBlock:(CDUnknownBlockType)arg4;
