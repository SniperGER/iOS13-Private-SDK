...
+ (BOOL)vector:(const vector_e1abc270 )arg1 containsPoint:(CGPoint)arg2;
//  (BOOL)edge:(struct Edge)arg1 intersectsEdge:(struct Edge)arg2;
//  (BOOL)newEdgeWithPoint:(CGPoint)arg1 betweenEdge:(struct Edge)arg2 intersectsOtherEdgesInHull:(const vector_e1abc270 )arg3;
...
//  (CGPoint)pointWithMinAngleForEdge:(struct Edge)arg1 fromPoints:(const vector_e1abc270 )arg2 minAngle:(double )arg3;
