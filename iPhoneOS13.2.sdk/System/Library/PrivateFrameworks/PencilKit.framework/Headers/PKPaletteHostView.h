...
- (void)_performAnimated:(_Bool)arg1 tracking:(_Bool)arg2 animations:(id /* block */)arg3 completion:(id /* block */)arg4;
...
- (void)setPaletteVisible:(_Bool)arg1 animated:(_Bool)arg2 completion:(id /* block */)arg3;
