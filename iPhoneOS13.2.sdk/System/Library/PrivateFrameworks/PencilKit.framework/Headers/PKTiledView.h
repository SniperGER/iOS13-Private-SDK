...
@class NSArray, NSMutableArray, NSObject, NSUUID, PKAttachmentView, PKController, PKDrawing, PKInk, PKLinedPaper, PKRulerController, PKSelectionController, PKTiledCanvasView, PKVectorTimestamp, UIDropInteraction, UIImage, UIScrollView, UITapGestureRecognizer, UITouch;
...
@interface PKTiledView : UIView <UIScrollViewDelegate, _UIScrollViewScrollObserver, _UIScrollViewLayoutObserver, UIDropInteractionDelegate_Private, UIGestureRecognizerDelegate, PKRulerDelegate, PKRulerHostingDelegate, PKDrawableView, PKTiledCanvasViewDelegate>
{
    ...
    id /* CDUnknownBlockType */ _didScrollBlock;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ didScrollBlock; // @synthesize didScrollBlock=_didScrollBlock;
...
@property(nonatomic) CGPoint liveStrokeContentOffset; // @synthesize liveStrokeContentOffset=_liveStrokeContentOffset;
