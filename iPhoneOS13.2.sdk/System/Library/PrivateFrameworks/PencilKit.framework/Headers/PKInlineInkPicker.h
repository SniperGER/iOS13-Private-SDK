...
- (void)_showInkAttributesPickerFromView:(id)arg1 frame:(CGRect)arg2 displayMode:(NSUInteger)arg3 shouldHideArrow:(BOOL)arg4 completion:(CDUnknownBlockType)arg5;
