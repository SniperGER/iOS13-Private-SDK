...
+ (id)inkWithIdentifier:(id)arg1 color:(id)arg2 version:(NSUInteger)arg3 variant:(id)arg4;
...
- (NSUInteger)hashValueForFloat:(double)arg1;
- (BOOL)isEqual:(id)arg1;
// - (id)copyWithZone:(_NSZone )arg1;
- (id)initWithIdentifier:(id)arg1 color:(id)arg2 version:(NSUInteger)arg3 variant:(id)arg4 behavior:(id)arg5;
- (id)initWithIdentifier:(id)arg1 color:(id)arg2 version:(NSUInteger)arg3 variant:(id)arg4 weight:(double)arg5;
- (id)initWithIdentifier:(id)arg1 color:(id)arg2 version:(NSUInteger)arg3 variant:(id)arg4;
- (id)init;
- (id)properties;
- (void)saveToV1Archive:(Ink_7b169424 )arg1;
- (id)initWithV1Archive:(const Ink_7b169424 )arg1 serializationVersion:(NSUInteger)arg2;
