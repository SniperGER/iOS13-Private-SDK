...
- (void)resume;
- (void)cancel;
- (void)renderStrokes:(id)arg1 clippedToStrokeSpaceRect:(CGRect)arg2 scale:(double)arg3 completion:(CDUnknownBlockType)arg4;
- (void)renderCGStrokes:(id)arg1 clippedToStrokeSpaceRect:(CGRect)arg2 scale:(double)arg3 completion:(CDUnknownBlockType)arg4;
- (void)renderDrawing:(id)arg1 clippedToStrokeSpaceRect:(CGRect)arg2 scale:(double)arg3 completion:(CDUnknownBlockType)arg4;
