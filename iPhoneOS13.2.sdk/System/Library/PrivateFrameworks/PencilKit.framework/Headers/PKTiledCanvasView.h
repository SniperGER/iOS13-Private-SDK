...
@property(copy, nonatomic) id /* block */ generateOnscreenVisibleStrokesBlock; // @synthesize generateOnscreenVisibleStrokesBlock=_generateOnscreenVisibleStrokesBlock;
...
@property(copy, nonatomic) id /* block */ purgeResourcesBlock; // @synthesize purgeResourcesBlock=_purgeResourcesBlock;
...
- (void)findOnscreenVisibleStrokesForFrame:(struct CGRect)arg1 inDrawing:(id)arg2 completion:(id /* block */)arg3;
...
- (void)_setDrawing:(id)arg1 tiles:(id)arg2 tileTransform:(struct CGAffineTransform)arg3 setupComplete:(id /* block */)arg4 completionBlock:(id /* block */)arg5;
