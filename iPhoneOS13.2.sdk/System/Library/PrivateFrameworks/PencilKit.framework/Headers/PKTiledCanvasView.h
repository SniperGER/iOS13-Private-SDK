...
- (void)findOnscreenVisibleStrokesForFrame:(CGRect)arg1 inDrawing:(id)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)_setDrawing:(id)arg1 tiles:(id)arg2 tileTransform:(CGAffineTransform)arg3 setupComplete:(CDUnknownBlockType)arg4 completionBlock:(CDUnknownBlockType)arg5;
