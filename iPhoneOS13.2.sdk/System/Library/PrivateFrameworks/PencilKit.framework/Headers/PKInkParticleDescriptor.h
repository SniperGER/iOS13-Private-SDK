...
+ (id)particleDescriptorWithName:(id)arg1 texture:(CGImageRef)arg2 particleSpacing:(double)arg3 particleCount:(long long)arg4 particleSize:(CGSize)arg5 particleRotation:(NSUInteger)arg6;
...
@property(retain, nonatomic) CGImageRef textureImage; // @synthesize textureImage=_textureImage;
