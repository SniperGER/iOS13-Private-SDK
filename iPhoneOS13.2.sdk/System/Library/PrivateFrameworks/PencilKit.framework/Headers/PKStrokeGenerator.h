...
+ (vector_58517711)inputPointsFromPath:(CGPathRef)arg1 velocityForDistanceFunction:(CDUnknownBlockType)arg2;
...
- (id)strokeFromPath:(CGPathRef)arg1 ink:(id)arg2 inputScale:(double)arg3 velocityForDistanceFunction:(CDUnknownBlockType)arg4;
