...
@property(nonatomic) CGAffineTransform accumulatedTransform; // @synthesize accumulatedTransform=_accumulatedTransform;
...
@property(nonatomic) NSUInteger allowedPanEdges; // @synthesize allowedPanEdges=_allowedPanEdges;
