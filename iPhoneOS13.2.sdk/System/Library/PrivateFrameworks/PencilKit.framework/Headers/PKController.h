...
- (void)_renderAllStrokes:(id)arg1 clipRect:(CGRect)arg2 completion:(CDUnknownBlockType)arg3;
- (void)_renderAllInStrokeSpaceRect:(CGRect)arg1 completion:(CDUnknownBlockType)arg2;
- (void)_renderStrokes:(id)arg1 clippedToStrokeSpaceRect:(CGRect)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)renderTiles:(id)arg1 tileTransform:(CGAffineTransform)arg2 completion:(CDUnknownBlockType)arg3;
- (void)renderStrokes:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (void)renderImage:(CGImageRef)arg1 andMask:(CGImageRef)arg2 forRenderedStrokes:(id)arg3 thenRenderStrokes:(id)arg4 completion:(CDUnknownBlockType)arg5;
- (void)renderImage:(CGImageRef)arg1 andMask:(CGImageRef)arg2 forRenderedStrokes:(id)arg3 thenRenderStrokes:(id)arg4 inStrokeSpaceClipRect:(CGRect)arg5 completion:(CDUnknownBlockType)arg6;
...
- (void)_setDrawing:(id)arg1 initialDrawing:(id)arg2 withImage:(CGImageRef)arg3 andMask:(CGImageRef)arg4 setupComplete:(CDUnknownBlockType)arg5 completion:(CDUnknownBlockType)arg6;
- (void)setDrawing:(id)arg1 initialDrawing:(id)arg2 withImage:(CGImageRef)arg3 andMask:(CGImageRef)arg4 setupComplete:(CDUnknownBlockType)arg5 completion:(CDUnknownBlockType)arg6;
- (void)setDrawing:(id)arg1 tiles:(id)arg2 tileTransform:(CGAffineTransform)arg3 setupComplete:(CDUnknownBlockType)arg4 completionBlock:(CDUnknownBlockType)arg5;
