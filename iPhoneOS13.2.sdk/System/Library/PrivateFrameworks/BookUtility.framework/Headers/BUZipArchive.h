...
- (void)readCentralDirectoryData:(id)arg1 entryCount:(NSUInteger)arg2 completion:(CDUnknownBlockType)arg3;
- (void)readCentralDirectoryWithEntryCount:(NSUInteger)arg1 offset:(long long)arg2 size:(NSUInteger)arg3 channel:(id)arg4 completion:(CDUnknownBlockType)arg5;
