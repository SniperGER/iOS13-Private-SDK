...
- (void)dealloc;
- (id)initWithType:(NSUInteger)arg1 descriptor:(int)arg2 queue:(id)arg3 cleanupHandler:(CDUnknownBlockType)arg4;
...
- (id)initWithType:(NSUInteger)arg1 URL:(id)arg2 oflag:(int)arg3 mode:(unsigned short)arg4 error:(id )arg5 cleanupHandler:(CDUnknownBlockType)arg6;
