...
@property(copy, nonatomic) id /* block */ streamReadChannelBlock; // @synthesize streamReadChannelBlock=_streamReadChannelBlock;
...
@property(copy, nonatomic) id /* block */ streamReadChannelSourceHandler; // @synthesize streamReadChannelSourceHandler=_streamReadChannelSourceHandler;
