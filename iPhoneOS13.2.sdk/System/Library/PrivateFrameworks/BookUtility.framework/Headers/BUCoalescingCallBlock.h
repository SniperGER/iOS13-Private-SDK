...
@property(copy, nonatomic) id /* block */ notifyTimeoutBlock; // @synthesize notifyTimeoutBlock=_notifyTimeoutBlock;
@property(copy, nonatomic) id /* block */ notifyBlock; // @synthesize notifyBlock=_notifyBlock;
