...
- (_Bool)_areAllConfigurationResourcesInvalid:(id)arg1 allowedToReachEndpoint:(_Bool)arg2 useBackgroundRefreshRate:(_Bool)arg3 requestKeys:(id)arg4;
- (_Bool)_areAllConfigurationResourcesAvailable:(id)arg1 requestKeys:(id)arg2;
