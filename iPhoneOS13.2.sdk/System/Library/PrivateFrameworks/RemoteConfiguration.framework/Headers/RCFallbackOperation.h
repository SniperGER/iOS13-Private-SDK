...
@property(copy, nonatomic) id /* block */ configurationCompletionHandler; // @synthesize configurationCompletionHandler=_configurationCompletionHandler;
...
- (void)_parseFallbackResponse:(id)arg1 fallbackURL:(id)arg2 requestKey:(id)arg3 enableExtraLogs:(_Bool)arg4 maxAge:(id)arg5 etag:(id)arg6 lastModifiedString:(id)arg7 completion:(id /* block */)arg8;
