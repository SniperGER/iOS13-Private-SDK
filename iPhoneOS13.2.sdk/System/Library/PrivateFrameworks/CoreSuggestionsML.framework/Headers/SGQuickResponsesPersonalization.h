...
+ (id)deduplicatedReplyTextsForReplyPositions:(id)arg1 semanticClass:(NSUInteger)arg2 responseCount:(NSUInteger)arg3 config:(id)arg4;
// - (void).cxx_destruct;
...
- (id)sortedReplyPositionsForSemanticClass:(NSUInteger)arg1 config:(id)arg2;
- (id)replyTextsForSemanticClass:(NSUInteger)arg1 responseCount:(NSUInteger)arg2 config:(id)arg3;
