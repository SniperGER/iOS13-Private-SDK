...
@interface SGQuickResponsesPredictionParameters : NSObject
{
    ...
    NSUInteger _defaultResponsesToReturn;
    NSUInteger _responsesToShowAtTopForDiversity;
...
@property(readonly, nonatomic) NSUInteger responsesToShowAtTopForDiversity; // @synthesize responsesToShowAtTopForDiversity=_responsesToShowAtTopForDiversity;
@property(readonly, nonatomic) NSUInteger defaultResponsesToReturn; // @synthesize defaultResponsesToReturn=_defaultResponsesToReturn;
