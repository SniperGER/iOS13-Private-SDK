...
// - (void).cxx_destruct;
- (id)initWithText:(id)arg1 lang:(id)arg2 replyTextId:(NSUInteger)arg3 styleGroupId:(NSUInteger)arg4 semanticClassId:(NSUInteger)arg5 modelId:(NSUInteger)arg6 categoryId:(NSUInteger)arg7;
