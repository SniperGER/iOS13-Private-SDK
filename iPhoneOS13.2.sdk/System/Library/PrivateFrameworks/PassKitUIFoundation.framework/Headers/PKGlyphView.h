...
@property(readonly, nonatomic) CGImageRef customImage; // @synthesize customImage=_customImage;
...
- (void)_setRecognizedIfNecessaryWithTransitionIndex:(NSUInteger)arg1 completion:(CDUnknownBlockType)arg2;
