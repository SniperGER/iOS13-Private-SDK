...
- (void)_appendDoubleValue:(double)arg1 timestamp:(NSUInteger)arg2;
- (void)_appendAttribute:(id)arg1;
- (void)_prepareUnderlyingBufferSizeWithAdditionalBytes:(NSUInteger)arg1;
- (void)dealloc;
...
- (id)sampleWithIndex:(NSUInteger)arg1;
- (id)initWithTime:(id)arg1 tag:(id)arg2 unit:(id)arg3 attributes:(id)arg4 values:(void )arg5 length:(NSUInteger)arg6 valueSize:(NSUInteger)arg7;
- (id)initWithTime:(id)arg1 tag:(id)arg2 unit:(id)arg3 attributes:(id)arg4 doubleValues:(double )arg5 length:(NSUInteger)arg6;
