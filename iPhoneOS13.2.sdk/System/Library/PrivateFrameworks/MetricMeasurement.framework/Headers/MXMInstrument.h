...
- (id)measureAutomatically:(NSUInteger)arg1 options:(id)arg2 block:(CDUnknownBlockType)arg3;
- (id)measureAutomatically:(NSUInteger)arg1 block:(CDUnknownBlockType)arg2;
