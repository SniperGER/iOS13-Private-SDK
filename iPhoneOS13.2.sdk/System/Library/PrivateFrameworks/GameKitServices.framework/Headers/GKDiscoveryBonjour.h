...
@property(copy, nonatomic) id /* block */ serviceNameCollisionCallback; // @synthesize serviceNameCollisionCallback=_serviceNameCollisionCallback;
...
@property(copy, nonatomic) id /* block */ connectionCallback; // @synthesize connectionCallback=_connectionCallback;
@property(copy, nonatomic) id /* block */ browseCallback; // @synthesize browseCallback=_browseCallback;
