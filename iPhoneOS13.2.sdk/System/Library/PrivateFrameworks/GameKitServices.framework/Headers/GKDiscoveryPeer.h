...
@interface GKDiscoveryPeer : NSObject <GKSimpleTimerDelegate>
{
    ...
    id /* CDUnknownBlockType */ _resolveTimeoutHandler;
    NSObject<OS_dispatch_queue> *_syncQueue;
    int _state;
    double _discoveryTimeStamp;
}

@property(copy, nonatomic) id /* CDUnknownBlockType */ resolveTimeoutHandler; // @synthesize resolveTimeoutHandler=_resolveTimeoutHandler;
