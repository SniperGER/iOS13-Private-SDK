...
{
    id /* CDUnknownBlockType */ _playerFoundHandler;
    id /* CDUnknownBlockType */ _playerLostHandler;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ receiveDataHandler; // @synthesize receiveDataHandler=_receiveDataHandler;
@property(copy, nonatomic) id /* CDUnknownBlockType */ playerLostHandler; // @synthesize playerLostHandler=_playerLostHandler;
@property(copy, nonatomic) id /* CDUnknownBlockType */ playerFoundHandler; // @synthesize playerFoundHandler=_playerFoundHandler;
