...
@property(copy, nonatomic) id /* block */ receiveDataHandler; // @synthesize receiveDataHandler=_receiveDataHandler;
@property(copy, nonatomic) id /* block */ playerLostHandler; // @synthesize playerLostHandler=_playerLostHandler;
@property(copy, nonatomic) id /* block */ playerFoundHandler; // @synthesize playerFoundHandler=_playerFoundHandler;
