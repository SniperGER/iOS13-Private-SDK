...
- (_Bool)_performDestinationOperationForRequest:(id)arg1 block:(id /* block */)arg2;
...
- (void)destination:(id)arg1 executeAction:(id)arg2 forNotificationRequest:(id)arg3 requestAuthentication:(_Bool)arg4 withParameters:(id)arg5 completion:(id /* block */)arg6;
