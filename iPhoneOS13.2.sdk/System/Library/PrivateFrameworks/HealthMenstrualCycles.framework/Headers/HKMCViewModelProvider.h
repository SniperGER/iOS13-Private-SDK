...
@class HKMCAnalysis, HKMCAnalysisProvider, HKMCViewModelProviderDataSource, NSHashTable, NSMutableDictionary, NSMutableIndexSet, NSNumber;
...
- (NSUInteger)_fertileWindowLevelWithDayIndex:(long long)arg1;
- (NSUInteger)_menstruationLevelWithDayIndex:(long long)arg1 menstrualFlow:(long long)arg2;
