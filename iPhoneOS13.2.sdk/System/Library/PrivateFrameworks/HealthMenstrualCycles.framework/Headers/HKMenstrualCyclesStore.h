...
- (void)saveLastMenstrualPeriodWithDayIndexRange:(CDStruct_ef5fcbe6)arg1 completion:(id /* block */)arg2;
- (void)saveMenstrualFlowByDayIndex:(id)arg1 completion:(id /* block */)arg2;
- (void)saveMenstrualFlow:(long long)arg1 dayIndex:(long long)arg2 updateAdjacentDays:(_Bool)arg3 completion:(id /* block */)arg4;
