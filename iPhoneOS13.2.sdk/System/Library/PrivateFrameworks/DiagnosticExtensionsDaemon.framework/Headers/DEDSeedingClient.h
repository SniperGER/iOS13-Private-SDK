...
- (void)performHTTPMethod:(id)arg1 toURL:(id)arg2 parameters:(id)arg3 encoding:(NSUInteger)arg4 success:(CDUnknownBlockType)arg5 error:(CDUnknownBlockType)arg6;
- (void)deleteResourceAtURL:(id)arg1 success:(CDUnknownBlockType)arg2 error:(CDUnknownBlockType)arg3;
- (void)putToURL:(id)arg1 parameters:(id)arg2 encoding:(NSUInteger)arg3 success:(CDUnknownBlockType)arg4 error:(CDUnknownBlockType)arg5;
- (void)postToURL:(id)arg1 parameters:(id)arg2 encoding:(NSUInteger)arg3 success:(CDUnknownBlockType)arg4 error:(CDUnknownBlockType)arg5;
