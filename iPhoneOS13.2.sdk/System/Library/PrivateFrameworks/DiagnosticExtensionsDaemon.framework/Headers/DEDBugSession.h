...
@property(copy) id /* block */ syncCompletionBlock; // @synthesize syncCompletionBlock=_syncCompletionBlock;
@property(copy) id /* block */ statusCompletionBlock; // @synthesize statusCompletionBlock=_statusCompletionBlock;
...
@property(copy) id /* block */ pingHandler; // @synthesize pingHandler=_pingHandler;
