...
- (void)dealloc;
- (id)initAsFragment:(_Bool)arg1 storage:(id)arg2 uuid:(id)arg3 context:(id)arg4;
...
- (_Bool)hasDeltaTo:(id)arg1 compareElements:(id /* block */)arg2;
- (void)_deltaTo:(id)arg1 added:(id /* block */)arg2 deleted:(id /* block */)arg3;
- (void)deltaTo:(id)arg1 added:(id /* block */)arg2 deleted:(id /* block */)arg3;
- (void)deltaTo:(id)arg1 edited:(id /* block */)arg2;
