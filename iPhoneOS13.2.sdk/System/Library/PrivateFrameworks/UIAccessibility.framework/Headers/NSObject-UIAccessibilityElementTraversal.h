...
- (_Bool)_accessibilityEnumerateSiblingsWithParent:(id *)arg1 options:(id)arg2 usingBlock:(id /* block */)arg3;
...
- (void)_accessibilityEnumerateSiblingsFromOrderedChildrenContainer:(id)arg1 fromChildAtIndex:(long long)arg2 headerIndex:(long long)arg3 footerIndex:(long long)arg4 isMovingForward:(_Bool)arg5 usingBlock:(id /* block */)arg6;
...
- (id)_accessibilityFindAncestor:(id /* block */)arg1 startWithSelf:(_Bool)arg2;
...
- (id)_accessibilityFindViewAncestor:(id /* block */)arg1 startWithSelf:(_Bool)arg2;
...
- (_Bool)_accessibilityIterateParentsForTestBlock:(id /* block */)arg1;
...
- (void)_accessibilityIterateScrollParentsUsingBlock:(id /* block */)arg1 includeSelf:(_Bool)arg2;
