...
+ (void)loadActualAccessibilityBundle:(id)arg1 didLoadCallback:(id /* block */)arg2 loadSubbundles:(_Bool)arg3;
+ (void)loadAccessibilityBundle:(id)arg1 didLoadCallback:(id /* block */)arg2 force:(_Bool)arg3 loadAllAccessibilityInfo:(_Bool)arg4;
...
+ (void)loadAccessibilityBundle:(id)arg1 didLoadCallback:(id /* block */)arg2 loadSubbundles:(_Bool)arg3;
+ (void)loadAccessibilityBundleForBundle:(id)arg1 didLoadCallback:(id /* block */)arg2 forceLoad:(_Bool)arg3 loadSubbundles:(_Bool)arg4 loadAllAccessibilityInfo:(_Bool)arg5;
+ (void)loadAccessibilityBundleForBundle:(id)arg1 didLoadCallback:(id /* block */)arg2 force:(_Bool)arg3 loadAllAccessibilityInfo:(_Bool)arg4;
