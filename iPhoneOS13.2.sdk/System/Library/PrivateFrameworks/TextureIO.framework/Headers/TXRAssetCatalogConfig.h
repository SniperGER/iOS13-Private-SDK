...
// - (void).cxx_destruct;
- (void)addFileAttributesForLevel:(NSUInteger)arg1 face:(NSUInteger)arg2 fileFormat:(NSUInteger)arg3 colorSpace:(CGColorSpaceRef)arg4 exifOrientation:(unsigned char)arg5;
- (void)addFileAttributesForLevel:(NSUInteger)arg1 fileFormat:(NSUInteger)arg2 colorSpace:(CGColorSpaceRef)arg3 exifOrientation:(unsigned char)arg4;
