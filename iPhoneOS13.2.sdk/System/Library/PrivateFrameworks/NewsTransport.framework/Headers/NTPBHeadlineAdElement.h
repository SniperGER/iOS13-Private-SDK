...
- (id)description;
- (id)articleIAdKeywordsAtIndex:(NSUInteger)arg1;
- (NSUInteger)articleIAdKeywordsCount;
- (void)addArticleIAdKeywords:(id)arg1;
- (void)clearArticleIAdKeywords;
@property(nonatomic) BOOL hasChannelContentProviderID;
- (id)channelIAdCategoriesAtIndex:(NSUInteger)arg1;
- (NSUInteger)channelIAdCategoriesCount;
...
- (id)channelIAdKeywordsAtIndex:(NSUInteger)arg1;
- (NSUInteger)channelIAdKeywordsCount;
- (void)addChannelIAdKeywords:(id)arg1;
- (void)clearChannelIAdKeywords;
- (id)articleIAdSectionIDsAtIndex:(NSUInteger)arg1;
- (NSUInteger)articleIAdSectionIDsCount;
...
- (id)articleIAdCategoriesAtIndex:(NSUInteger)arg1;
- (NSUInteger)articleIAdCategoriesCount;
