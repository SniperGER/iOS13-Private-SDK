...
- (id)description;
- (id)bundleFeaturedArticleIDsAtIndex:(NSUInteger)arg1;
- (NSUInteger)bundleFeaturedArticleIDsCount;
...
- (id)topicTagIDsAtIndex:(NSUInteger)arg1;
- (NSUInteger)topicTagIDsCount;
...
- (id)allArticleIDsAtIndex:(NSUInteger)arg1;
- (NSUInteger)allArticleIDsCount;
