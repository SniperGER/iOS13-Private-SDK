...
@interface NTPBTagRecord : PBCodable <NSCopying>
{
    ...
    NSUInteger _nameImageBaselineShift;
...
@property(nonatomic) NSUInteger nameImageBaselineShift; // @synthesize nameImageBaselineShift=_nameImageBaselineShift;
...
- (id)latestIssueIDsAtIndex:(NSUInteger)arg1;
- (NSUInteger)latestIssueIDsCount;
...
- (id)purchaseOfferableConfigurationAtIndex:(NSUInteger)arg1;
- (NSUInteger)purchaseOfferableConfigurationsCount;
- (void)addPurchaseOfferableConfiguration:(id)arg1;
- (void)clearPurchaseOfferableConfigurations;
- (id)publisherPaidBundlePurchaseIDsAtIndex:(NSUInteger)arg1;
- (NSUInteger)publisherPaidBundlePurchaseIDsCount;
- (void)addPublisherPaidBundlePurchaseIDs:(id)arg1;
- (void)clearPublisherPaidBundlePurchaseIDs;
- (id)publisherPaidFeldsparablePurchaseIDsAtIndex:(NSUInteger)arg1;
- (NSUInteger)publisherPaidFeldsparablePurchaseIDsCount;
...
- (id)channelSectionFeedConfigurationsAtIndex:(NSUInteger)arg1;
- (NSUInteger)channelSectionFeedConfigurationsCount;
...
- (id)channelSectionIDsAtIndex:(NSUInteger)arg1;
- (NSUInteger)channelSectionIDsCount;
