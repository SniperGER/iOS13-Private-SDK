...
- (void)setSurfacedByTagIDsRefs:(int )arg1 count:(NSUInteger)arg2;
- (int)surfacedByTagIDsRefsAtIndex:(NSUInteger)arg1;
- (void)addSurfacedByTagIDsRefs:(int)arg1;
- (void)clearSurfacedByTagIDsRefs;
@property(readonly, nonatomic) int surfacedByTagIDsRefs;
@property(readonly, nonatomic) NSUInteger surfacedByTagIDsRefsCount;
