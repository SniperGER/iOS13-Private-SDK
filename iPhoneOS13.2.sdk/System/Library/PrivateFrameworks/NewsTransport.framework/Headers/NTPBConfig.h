...
- (void)setTopStoriesPublishTimeIntervals:(long long )arg1 count:(NSUInteger)arg2;
- (long long)topStoriesPublishTimeIntervalsAtIndex:(NSUInteger)arg1;
...
- (id)externalAnalyticsConfigAtIndex:(NSUInteger)arg1;
- (NSUInteger)externalAnalyticsConfigsCount;
...
- (id)endpointConfigsAtIndex:(NSUInteger)arg1;
- (NSUInteger)endpointConfigsCount;
