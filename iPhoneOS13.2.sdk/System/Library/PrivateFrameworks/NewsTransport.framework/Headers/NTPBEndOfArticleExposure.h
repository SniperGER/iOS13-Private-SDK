...
- (id)referencedRecommendedArticleIdsAtIndex:(NSUInteger)arg1;
- (NSUInteger)referencedRecommendedArticleIdsCount;
- (void)addReferencedRecommendedArticleIds:(id)arg1;
- (void)clearReferencedRecommendedArticleIds;
- (id)recommendedArticleIdAtIndex:(NSUInteger)arg1;
- (NSUInteger)recommendedArticleIdsCount;
