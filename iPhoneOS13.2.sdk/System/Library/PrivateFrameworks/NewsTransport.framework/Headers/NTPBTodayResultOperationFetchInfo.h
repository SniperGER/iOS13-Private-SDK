...
- (void)setUserSegmentationTreatmentIds:(long long )arg1 count:(NSUInteger)arg2;
- (long long)userSegmentationTreatmentIdsAtIndex:(NSUInteger)arg1;
...
- (void)setUserSegmentationSegmentSetIds:(int )arg1 count:(NSUInteger)arg2;
- (int)userSegmentationSegmentSetIdsAtIndex:(NSUInteger)arg1;
