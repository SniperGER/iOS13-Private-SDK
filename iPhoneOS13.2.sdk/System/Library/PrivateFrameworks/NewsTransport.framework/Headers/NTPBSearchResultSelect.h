...
- (id)articleResultArticleIdsAtIndex:(NSUInteger)arg1;
- (NSUInteger)articleResultArticleIdsCount;
...
- (id)channelResultFeedIdsAtIndex:(NSUInteger)arg1;
- (NSUInteger)channelResultFeedIdsCount;
- (void)addChannelResultFeedIds:(id)arg1;
- (void)clearChannelResultFeedIds;
- (id)topicResultFeedIdsAtIndex:(NSUInteger)arg1;
- (NSUInteger)topicResultFeedIdsCount;
- (void)addTopicResultFeedIds:(id)arg1;
- (void)clearTopicResultFeedIds;
@property(readonly, nonatomic) BOOL hasTopResultFeedId;
- (id)searchResultsAtIndex:(NSUInteger)arg1;
- (NSUInteger)searchResultsCount;
- (void)addSearchResults:(id)arg1;
- (void)clearSearchResults;
@property(nonatomic) BOOL hasDidSelectResult;
- (id)nonSelectedResultFeedIdAtIndex:(NSUInteger)arg1;
- (NSUInteger)nonSelectedResultFeedIdsCount;
