...
- (id)mediaSharingBlacklistedChannelIdsAtIndex:(NSUInteger)arg1;
- (NSUInteger)mediaSharingBlacklistedChannelIdsCount;
...
- (id)recommendedNotificationChannelsAtIndex:(NSUInteger)arg1;
- (NSUInteger)recommendedNotificationChannelsCount;
- (void)addRecommendedNotificationChannels:(id)arg1;
- (void)clearRecommendedNotificationChannels;
- (id)preSubscribedNotificationsChannelIdsAtIndex:(NSUInteger)arg1;
- (NSUInteger)preSubscribedNotificationsChannelIdsCount;
...
- (id)onboardingTagIdsAtIndex:(NSUInteger)arg1;
- (NSUInteger)onboardingTagIdsCount;
- (void)addOnboardingTagIds:(id)arg1;
- (void)clearOnboardingTagIds;
- (id)preSubscribedFeedIdsAtIndex:(NSUInteger)arg1;
- (NSUInteger)preSubscribedFeedIdsCount;
