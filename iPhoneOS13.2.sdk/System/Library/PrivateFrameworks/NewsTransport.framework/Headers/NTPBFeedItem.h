...
@interface NTPBFeedItem : PBCodable <NSCopying>
{
    ...
    NSUInteger _feedHalfLifeMilliseconds;
    double _globalUserFeedback;
    long long _minimumNewsVersion;
    NSUInteger _order;
    NSUInteger _publishDateMilliseconds;
...
@property(nonatomic) NSUInteger feedHalfLifeMilliseconds; // @synthesize feedHalfLifeMilliseconds=_feedHalfLifeMilliseconds;
@property(nonatomic) NSUInteger publishDateMilliseconds; // @synthesize publishDateMilliseconds=_publishDateMilliseconds;
...
- (id)topicIDsAtIndex:(NSUInteger)arg1;
