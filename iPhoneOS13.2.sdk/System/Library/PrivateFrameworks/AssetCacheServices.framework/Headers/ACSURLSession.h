...
- (void)_onqueue_task:(id)arg1 willUseCachingServer:(_Bool)arg2 newRequest:(id)arg3 completionHandler:(id /* block */)arg4;
- (void)_locateCachingServerForURL:(id)arg1 isUpload:(_Bool)arg2 completionHandler:(id /* block */)arg3;
