...
- (void)_invokeBlockWithPlatterViewsVisibleInRect:(struct CGRect)arg1 block:(id /* block */)arg2;
...
- (void)resizeWidgetWrapperView:(id)arg1 toSize:(struct CGSize)arg2 withTransitionContext:(id)arg3 completion:(id /* block */)arg4;
...
- (id /* block */)_insert:(_Bool)arg1 listItem:(id)arg2 withOrderedIdentifiers:(id)arg3 animated:(_Bool)arg4;
- (void)_didUpdateStackViewArrangedSubviews;
- (id /* block */)_beginInsertion:(_Bool)arg1 ofListItem:(id)arg2 withOrderedIdentifiers:(id)arg3 removingViewIfPossible:(_Bool)arg4;
