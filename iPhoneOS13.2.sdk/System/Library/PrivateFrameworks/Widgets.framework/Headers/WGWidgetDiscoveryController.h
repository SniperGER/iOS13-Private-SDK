...
- (_Bool)widgetListEditViewControllerShouldShowFavorites:(id)arg1;
...
- (_Bool)widgetListEditViewController:(id)arg1 isItemWithIdentifierFavorited:(id)arg2;
...
- (void)dismissWidgetListEditViewController:(id)arg1 animated:(_Bool)arg2 withCompletion:(id /* block */)arg3;
...
- (void)dismissWidgetListEditViewControllerAnimated:(_Bool)arg1 completion:(id /* block */)arg2;
- (void)presentWidgetListEditViewControllerFromViewController:(id)arg1 animated:(_Bool)arg2 completion:(id /* block */)arg3;
...
- (_Bool)_isElementWithIdentifierFavorited:(id)arg1;
