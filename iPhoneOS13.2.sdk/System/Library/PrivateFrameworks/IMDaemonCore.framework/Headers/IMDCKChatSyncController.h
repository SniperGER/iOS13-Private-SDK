...
- (void)_processFetchRecordChangesCompleted:(id)arg1 completion:(id /* block */)arg2 isUsingStingRay:(_Bool)arg3 syncType:(long long)arg4;
- (void)_kickOffWriteIfNeededForSyncType:(long long)arg1 completion:(id /* block */)arg2 isUsingStingRay:(_Bool)arg3;
- (void)_kickOffWriteOnCKQueueWithCompletion:(id /* block */)arg1 isUsingStingRay:(_Bool)arg2;
...
- (void)_writeDirtyChatsToCloudKitWithCompletion:(id /* block */)arg1 isUsingStingRay:(_Bool)arg2;
...
- (void)_writeCKRecordsToChatZone:(id)arg1 isUsingStingRay:(_Bool)arg2 withCompletion:(id /* block */)arg3;
