...
- (id)copyMessagesThatNeedToBeDeletedInCloudKitWithLimit:(NSUInteger)arg1;
- (void)markAllMessagesAsNeedingCloudKitSync;
- (id)messagesThatNeedSyncWithCloudKitWithLimit:(long long)arg1;
- (id)_messagesThatNeedSyncWithCloudKitWithLimit:(long long)arg1 attemptCount:(NSUInteger)arg2;
...
- (void)_deleteMessagesWithGUIDs:(id)arg1 chatIdentifiers:(id)arg2 style:(unsigned char)arg3 onServices:(id)arg4 batchNumber:(NSUInteger)arg5 completion:(CDUnknownBlockType)arg6;
...
- (id)frequentRepliesForForChatIdentifiers:(id)arg1 onServices:(id)arg2 limit:(NSUInteger)arg3;
...
- (id)unreadMessagesWithRoomNames:(id)arg1 onServices:(id)arg2 limit:(NSUInteger)arg3 fallbackGUID:(id)arg4;
- (id)unreadMessagesWithHandles:(id)arg1 onServices:(id)arg2 limit:(NSUInteger)arg3 fallbackGUID:(id)arg4;
- (id)lastMessageWithHandles:(id)arg1 onServices:(id)arg2;
- (id)messagesWithHandlesBeforeAndAfterGUID:(id)arg1 handles:(id)arg2 onServices:(id)arg3 numberOfMessagesBefore:(NSUInteger)arg4 numberOfMessagesAfter:(NSUInteger)arg5;
- (id)messagesWithRoomNames:(id)arg1 onServices:(id)arg2 messageGUID:(id)arg3 limit:(NSUInteger)arg4;
- (id)messagesWithRoomNames:(id)arg1 onServices:(id)arg2 limit:(NSUInteger)arg3;
- (id)messagesWithHandles:(id)arg1 onServices:(id)arg2 messageGUID:(id)arg3 limit:(NSUInteger)arg4;
- (id)messagesWithHandles:(id)arg1 onServices:(id)arg2 limit:(NSUInteger)arg3;
...
- (id)_unreadMessagesWithRoomNames:(id)arg1 onServices:(id)arg2 limit:(NSUInteger)arg3 fallbackGUID:(id)arg4;
- (id)_unreadMessagesWithHandles:(id)arg1 onServices:(id)arg2 limit:(NSUInteger)arg3 fallbackGUID:(id)arg4;
- (id)_messagesWithHandlesBeforeAndAfterGUID:(id)arg1 handles:(id)arg2 onServices:(id)arg3 numberOfMessagesBefore:(NSUInteger)arg4 numberOfMessagesAfter:(NSUInteger)arg5;
- (id)_messagesWithRoomNames:(id)arg1 onServices:(id)arg2 messageGUID:(id)arg3 limit:(NSUInteger)arg4 onlyMessages:(BOOL)arg5;
- (id)_messagesWithHandles:(id)arg1 onServices:(id)arg2 messageGUID:(id)arg3 limit:(NSUInteger)arg4 onlyMessages:(BOOL)arg5;
...
- (id)storeMessage:(id)arg1 forceReplace:(BOOL)arg2 modifyError:(BOOL)arg3 modifyFlags:(BOOL)arg4 flagMask:(NSUInteger)arg5 updateMessageCache:(BOOL)arg6 calculateUnreadCount:(BOOL)arg7 reindexMessage:(BOOL)arg8;
- (id)storeMessage:(id)arg1 forceReplace:(BOOL)arg2 modifyError:(BOOL)arg3 modifyFlags:(BOOL)arg4 flagMask:(NSUInteger)arg5 updateMessageCache:(BOOL)arg6 calculateUnreadCount:(BOOL)arg7;
- (id)storeMessage:(id)arg1 forceReplace:(BOOL)arg2 modifyError:(BOOL)arg3 modifyFlags:(BOOL)arg4 flagMask:(NSUInteger)arg5;
