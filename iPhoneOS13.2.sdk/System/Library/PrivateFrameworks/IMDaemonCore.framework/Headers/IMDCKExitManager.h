...
- (void)submitCloudKitAnalyticWithDictionary:(id)arg1 operationGroupName:(id)arg2 useManatee:(_Bool)arg3 completion:(id /* block */)arg4;
- (void)submitCloudKitMetricWithData:(id)arg1 operationGroupName:(id)arg2 useManatee:(_Bool)arg3 completion:(id /* block */)arg4;
- (_Bool)_canSubmitCloudKitAnalytic;
- (_Bool)_canSubmitCloudKitMetric;
- (void)_submitCloudKitMetricWithOperationGroupName:(id)arg1 record:(id)arg2 useManatee:(_Bool)arg3 ignoreZoneNotFoundError:(_Bool)arg4 completion:(id /* block */)arg5;
...
- (void)writeSyncCompletedRecordWithDate:(id)arg1 useManatee:(_Bool)arg2 completion:(id /* block */)arg3;
