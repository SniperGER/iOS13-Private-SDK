...
- (void)didReceiveMessageSavedForMessageID:(id)arg1 ofType:(long long)arg2 forChat:(id)arg3 fromHandle:(id)arg4 fromMe:(_Bool)arg5 date:(id)arg6 useMessageSuppression:(_Bool)arg7 account:(id)arg8 completionBlock:(id /* block */)arg9;
- (void)didReceiveMessageSavedForMessageID:(id)arg1 ofType:(long long)arg2 forChat:(id)arg3 fromHandle:(id)arg4 fromMe:(_Bool)arg5 date:(id)arg6 completionBlock:(id /* block */)arg7;
- (void)_didReceiveMessageSavedForMessageID:(id)arg1 ofType:(long long)arg2 forChat:(id)arg3 fromHandle:(id)arg4 fromMe:(_Bool)arg5 date:(id)arg6 attempts:(long long)arg7 useMessageSuppression:(_Bool)arg8 account:(id)arg9 completionBlock:(id /* block */)arg10;
...
- (void)didReceiveMessagePlayedForMessageID:(id)arg1 date:(id)arg2 useMessageSuppression:(_Bool)arg3 completionBlock:(id /* block */)arg4;
- (void)didReceiveMessagePlayedForMessageID:(id)arg1 date:(id)arg2 completionBlock:(id /* block */)arg3;
- (void)_didReceiveMessagePlayedForMessageID:(id)arg1 date:(id)arg2 attempts:(long long)arg3 useMessageSuppression:(_Bool)arg4 completionBlock:(id /* block */)arg5;
...
- (void)didReceiveMessageReadForMessageID:(id)arg1 date:(id)arg2 useMessageSuppression:(_Bool)arg3 completionBlock:(id /* block */)arg4;
- (void)didReceiveMessageReadForMessageID:(id)arg1 date:(id)arg2 completionBlock:(id /* block */)arg3;
- (void)_didReceiveMessageReadForMessageID:(id)arg1 date:(id)arg2 attempts:(long long)arg3 useMessageSuppression:(_Bool)arg4 completionBlock:(id /* block */)arg5;
...
- (void)processMessageForSending:(id)arg1 toChat:(id)arg2 style:(unsigned char)arg3 allowWatchdog:(_Bool)arg4 account:(id)arg5 completionBlock:(id /* block */)arg6;
- (void)processMessageForSending:(id)arg1 toChat:(id)arg2 style:(unsigned char)arg3 allowWatchdog:(_Bool)arg4 completionBlock:(id /* block */)arg5;
...
- (void)_IMDStoreMessage:(id)arg1 inMessage:(id)arg2 forceReplace:(_Bool)arg3 modifyError:(_Bool)arg4 modifyFlags:(_Bool)arg5 calculateUnreadCount:(_Bool)arg6 flagMask:(unsigned long long)arg7 shouldStoreBlock:(id /* block */)arg8 didStoreBlock:(id /* block */)arg9 block:(id /* block */)arg10;
...
- (void)sendLogDumpMessageAtFilePath:(id)arg1 toRecipient:(id)arg2 shouldDeleteFile:(_Bool)arg3 withCompletion:(id /* block */)arg4;
