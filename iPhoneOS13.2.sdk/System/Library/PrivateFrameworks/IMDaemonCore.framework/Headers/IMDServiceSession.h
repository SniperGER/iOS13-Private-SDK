...
@interface IMDServiceSession : NSObject <IMSystemMonitorListener, IMConnectionMonitorDelegate, IMServiceSessionProtocol>
{
    ...
    NSUInteger _pendingReadReceiptFromStorageCount;
    IMTimingCollection *_timingComingBackFromStorage;
    NSUInteger _messagesProcessedComingBackFromStorage;
...
- (void)setPendingReadReceiptFromStorageCount:(NSUInteger)arg1;
...
- (void)_IMDStoreMessage:(id)arg1 inMessage:(id)arg2 forceReplace:(BOOL)arg3 modifyError:(BOOL)arg4 modifyFlags:(BOOL)arg5 calculateUnreadCount:(BOOL)arg6 flagMask:(NSUInteger)arg7 shouldStoreBlock:(CDUnknownBlockType)arg8 didStoreBlock:(CDUnknownBlockType)arg9 block:(CDUnknownBlockType)arg10;
...
- (id)server;
- (BOOL)hasCapability:(NSUInteger)arg1;
