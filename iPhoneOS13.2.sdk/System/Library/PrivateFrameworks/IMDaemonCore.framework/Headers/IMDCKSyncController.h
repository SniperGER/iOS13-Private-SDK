...
- (void)_ifCloudKitAbleToSyncIsFullSync:(_Bool)arg1 activity:(id)arg2 callBlock:(id /* block */)arg3;
...
- (void)_beginPeriodicSyncWithActivity:(id)arg1 deviceConditionsToCheck:(unsigned long long)arg2 attemptCount:(unsigned long long)arg3 useStingRay:(_Bool)arg4 syncChatsCompletionBlock:(id /* block */)arg5;
