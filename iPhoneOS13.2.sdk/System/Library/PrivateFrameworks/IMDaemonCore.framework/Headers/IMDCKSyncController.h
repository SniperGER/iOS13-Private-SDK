...
- (void)_beginPeriodicSyncWithActivity:(id)arg1 deviceConditionsToCheck:(NSUInteger)arg2 attemptCount:(NSUInteger)arg3 useStingRay:(BOOL)arg4 syncChatsCompletionBlock:(CDUnknownBlockType)arg5;
- (void)syncAttachmentMetadataFirstSyncWithActivity:(id)arg1 deviceConditionsToCheck:(NSUInteger)arg2 completionBlock:(CDUnknownBlockType)arg3;
