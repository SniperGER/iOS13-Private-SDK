...
- (BOOL)_populateNicknameDictionary:(id)arg1 forKVStore:(id)arg2 limitToLoad:(NSUInteger)arg3;
...
- (void)_newDeviceDidSignIntoiMessageWithRetryCount:(NSUInteger)arg1;
- (void)_retryPeerRequestWithRetry:(NSUInteger)arg1;
- (void)newDeviceDidSignIntoiMessage;
- (void)reuploadProfileIfNeeded;
- (void)_tryToReuploadPersonalNicknameWithRetryCount:(NSUInteger)arg1 reuploadVersion:(NSUInteger)arg2;
