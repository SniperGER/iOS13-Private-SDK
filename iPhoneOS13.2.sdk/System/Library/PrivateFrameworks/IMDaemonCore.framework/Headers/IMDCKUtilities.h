...
@class FTDeviceSupport, IDSServerBag, IMDCKSyncState, IMDefaults, IMLockdownManager;
...
- (void)_metricForPCSReportManateeStatusWithReason:(id)arg1 linkedFunction:(/* void * CDUnknownFunctionPointerType */)arg2 timeoutInSec:(double)arg3 completion:(CDUnknownBlockType)arg4;
...
- (void)reportCompletionForSyncType:(long long)arg1 isCoreDuetSync:(BOOL)arg2 onAttempt:(NSUInteger)arg3 wasSuccessful:(BOOL)arg4;
...
- (NSUInteger)_mocEnabledStateFromAccountStatus:(long long)arg1;
...
- (BOOL)shouldRepairAccountWithDeviceAccountSecurityLevel:(NSUInteger)arg1 serverAccountStatus:(long long)arg2;
