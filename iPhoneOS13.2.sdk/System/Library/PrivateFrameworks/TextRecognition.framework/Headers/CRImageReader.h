...
- (void)cancel;
- (id)textResultsForImage:(id)arg1 roi:(struct CGRect)arg2 options:(id)arg3 error:(id *)arg4 withProgressHandler:(id /* block */)arg5 title:(id *)arg6;
...
- (id)resultsForPixelBuffer:(struct __CVBuffer *)arg1 roi:(struct CGRect)arg2 options:(id)arg3 error:(id *)arg4 withProgressHandler:(id /* block */)arg5;
