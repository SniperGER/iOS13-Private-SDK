...
// - (void).cxx_destruct;
- (void)cancel;
- (id)textResultsForImage:(id)arg1 roi:(CGRect)arg2 options:(id)arg3 error:(id )arg4 withProgressHandler:(CDUnknownBlockType)arg5 title:(id )arg6;
...
//  (id)resultsForPixelBuffer:(struct __CVBuffer )arg1 roi:(CGRect)arg2 options:(id)arg3 error:(id )arg4 withProgressHandler:(CDUnknownBlockType)arg5;
//  (id)resultsForPixelBuffer:(struct __CVBuffer )arg1 roi:(CGRect)arg2 options:(id)arg3 error:(id )arg4;
...
- (void)rotatePolygon:(vector_e1abc270 )arg1 center:(CGPoint)arg2 angle:(float)arg3 dest:(vector_e1abc270 )arg4;
- (id)combinedLineFeature:(id)arg1 lineFeature:(id)arg2;
- (vector_8f06c10f)converMLMultiArraytoArray:(id)arg1 targetSize:(CGSize)arg2;
...
//  (void)extractGeomap:(id)arg1 toImages:(struct vImage_Buffer [5])arg2 targetSize:(CGSize)arg3;
//  (struct vImage_Buffer)extractImageMap:(id)arg1 targetSize:(CGSize)arg2;
//  (id)genPolyResults:(struct vImage_Buffer )arg1 geoMap:(struct vImage_Buffer )arg2 targetSize:(CGSize)arg3 scale:(CGSize)arg4;
//  (void)aggregateScoreAndGeoMap:(id)arg1 inputGeo:(id)arg2 targetSize:(CGSize)arg3 outputScoreMap:(struct vImage_Buffer )arg4 outputGeoMap:(struct vImage_Buffer [5])arg5 outputOrigin:(CGPoint)arg6 withScale:(CGSize)arg7;
...
//  (struct __CVBuffer )createCroppedRegion:(CGRect)arg1 fromPixelBuffer:(struct __CVBuffer )arg2;
//  (struct __CVBuffer )createScaledBufferOfSize:(CGSize)arg1 fromPixelBuffer:(struct __CVBuffer )arg2;
//  (struct __CVBuffer )cvPixelBufferForImageAtPath:(id)arg1 withScale:(float)arg2;
//  (struct __CVBuffer )pixelBufferFromCGImage:(CGImageRef)arg1 withScale:(double)arg2 paddedToSize:(CGSize)arg3;
//  (struct __CVBuffer )pixelBufferFromCGImage:(CGImageRef)arg1 withScale:(float)arg2;
//  (struct __CVBuffer )grayscalePixelBufferFromCGImage:(CGImageRef)arg1 withScale:(float)arg2;
...
//  (struct __CVBuffer )fkcrGrayscalePixelBufferFromCGImage:(CGImageRef)arg1 withScale:(float)arg2;
