...
+ (NSUInteger)channelsForColorSpace:(int)arg1;
+ (NSUInteger)bytesPerPixelForColorSpace:(int)arg1;
//  (struct vImage_Buffer)allocateVImageBufferWithWidth:(NSUInteger)arg1 height:(NSUInteger)arg2 colorSpace:(int)arg3;
//  (struct vImage_Buffer)allocateVImageBufferWithWidth:(NSUInteger)arg1 height:(NSUInteger)arg2 bytesPerPixel:(int)arg3;
@property(nonatomic) BOOL vImageDataIsCopy; // @synthesize vImageDataIsCopy=_vImageDataIsCopy;
@property(nonatomic) CGImageRef cgImage; // @synthesize cgImage=_cgImage;
...
- (id)imageByCroppingRectangle:(CGRect)arg1 toHeight:(NSUInteger)arg2 andWidth:(NSUInteger)arg3 withRotationAngle:(float)arg4;
...
- (id)initWithWidth:(NSUInteger)arg1 height:(NSUInteger)arg2 colorSpace:(int)arg3;
- (NSUInteger)numChannels;
- (NSUInteger)bytesPerPixel;
- (id)imageByApplyingBinaryMask:(id)arg1;
- (id)imageByDilating;
- (id)imageByPaddingX:(NSUInteger)arg1 paddingY:(NSUInteger)arg2;
- (id)imageByPaddingToRatioAndScalingToWidth:(NSUInteger)arg1 height:(NSUInteger)arg2 alignCenter:(BOOL)arg3;
- (id)imageByPaddingToRatioAndScalingToWidth:(NSUInteger)arg1 height:(NSUInteger)arg2;
- (id)imageByScalingToWidth:(NSUInteger)arg1 height:(NSUInteger)arg2;
...
//  (struct __CVBuffer )pixelBufferWithScale:(double)arg1 paddedToSize:(CGSize)arg2 adjustedToSize:(CGSize )arg3 mask:(CGImageRef)arg4;
//  (struct __CVBuffer )pixelBufferWithScale:(double)arg1 paddedToSize:(CGSize)arg2 adjustedToSize:(CGSize )arg3;
//  (struct __CVBuffer )pixelBufferWithScale:(double)arg1 paddedToSize:(CGSize)arg2;
