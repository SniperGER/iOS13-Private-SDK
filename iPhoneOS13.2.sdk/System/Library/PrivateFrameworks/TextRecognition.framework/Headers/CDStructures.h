...
struct PyramidNMS<unsigned short, float, unsigned char> {
    /* void * CDUnknownFunctionPointerType _vptr$PyramidNMS */;
...
struct PyramidNMSConfig {
    /* void * CDUnknownFunctionPointerType _vptr$PyramidNMSConfig */;
    NSUInteger method;
    NSUInteger ipuNumSamples;
    ...
    BOOL ipuUseNumChars;
    NSUInteger ipuNumCharsUpperClip;
    ...
    NSUInteger containmentNumLowerLevelDatumCompetingMinThreshold;
...
struct PyramidTokenizer<unsigned short, float> {
    /* void * CDUnknownFunctionPointerType _vptr$PyramidTokenizer */;
    struct deque<nms::RectForest<unsigned short, float>, std::__1::allocator<nms::RectForest<unsigned short, float>>> pForests;
    struct PyramidTokenizerConfig config;
};

struct PyramidTokenizerConfig {
    /* void * CDUnknownFunctionPointerType _vptr$PyramidTokenizerConfig */;
    BOOL isRecursive;
    ...
    NSUInteger adpativeSpacingRatioMultiplierMinNumRects;
    double adaptiveSpacingRatioMultiplierMinVariationThreshold;
    double adaptiveSpacingRatioMultiplierLowerBound;
    NSUInteger singleTokenNumCharsMaxThreshold;
    NSUInteger singleTokenNumCutpointCandidatesMaxThreshold;
};
