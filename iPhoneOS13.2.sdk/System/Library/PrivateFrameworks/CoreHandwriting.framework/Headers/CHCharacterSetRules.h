...
+ (NSUInteger)characterTypeFromString:(id)arg1;
+ (NSUInteger)characterType:(unsigned int)arg1;
+ (NSUInteger)expectedMaxDotCount:(unsigned int)arg1;
+ (NSUInteger)expectedMinStrokeCount:(unsigned int)arg1;
+ (NSUInteger)expectedMaxStrokeCount:(unsigned int)arg1;
...
- (id).cxx_construct;
// - (void).cxx_destruct;
- (NSUInteger)_expectedMaxDotCount:(unsigned int)arg1;
- (NSUInteger)_characterType:(unsigned int)arg1;
- (NSUInteger)_expectedMinStrokeCount:(unsigned int)arg1;
- (NSUInteger)_expectedMaxStrokeCount:(unsigned int)arg1;
- (void)dealloc;
- (id)init;
