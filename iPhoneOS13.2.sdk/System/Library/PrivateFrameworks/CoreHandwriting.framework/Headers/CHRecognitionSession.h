...
@class CHRecognitionSessionResult, NSArray, NSData, NSMutableArray, NSMutableDictionary;
...
@interface CHRecognitionSession : NSObject <CHRecognitionSessionTaskDelegate>
{
    ...
    NSUInteger __changeCoalescingIndex;
...
@property(nonatomic) NSUInteger _changeCoalescingIndex; // @synthesize _changeCoalescingIndex=__changeCoalescingIndex;
