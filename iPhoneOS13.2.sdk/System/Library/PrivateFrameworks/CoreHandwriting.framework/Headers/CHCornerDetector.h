...
@interface CHCornerDetector : NSObject
{
    ...
    NSUInteger _directionChangeCount;
    NSUInteger _highestDirectionChangeCount;
    NSUInteger __strawSize;
...
@property(readonly, nonatomic) NSUInteger _strawSize; // @synthesize _strawSize=__strawSize;
@property(readonly, nonatomic) NSUInteger highestDirectionChangeCount; // @synthesize highestDirectionChangeCount=_highestDirectionChangeCount;
@property(readonly, nonatomic) NSUInteger directionChangeCount; // @synthesize directionChangeCount=_directionChangeCount;
...
- (void)_detectCorners;
- (NSUInteger)_detectDirectionalChanges;
