...
@property(readonly, nonatomic) CGRect rotatedBounds; // @synthesize rotatedBounds=_rotatedBounds;
@property(readonly, nonatomic) CGRect enlargedBounds; // @synthesize enlargedBounds=_enlargedBounds;
