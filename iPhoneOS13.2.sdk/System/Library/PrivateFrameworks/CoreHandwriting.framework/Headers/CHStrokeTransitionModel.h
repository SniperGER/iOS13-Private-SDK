...
- (BOOL)classifyStrokesInDrawing:(id)arg1 minimumDrawingSize:(CGSize)arg2 outDelayedStrokeProbabilities:(vector_8f06c10f )arg3 outSpaceProbabilities:(vector_8f06c10f )arg4 outCharBoundaryProbabilities:(vector_8f06c10f )arg5;
