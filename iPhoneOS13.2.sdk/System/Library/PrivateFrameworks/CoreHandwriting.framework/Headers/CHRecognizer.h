...
- (struct Network)_candidateNetworkFromSegmentationNetwork:(struct Network *)arg1 segmentGroup:(id)arg2 drawing:(id)arg3 boundsAtNode:(vector_ea45b3ba *)arg4 matchingStrokeRange:(struct _NSRange)arg5 sortedSegmentIndexes:(vector_afed86a5)arg6 shouldCancel:(id /* block */)arg7;
- (long long)_classifyEdgeDrawingsFromContexts:(id)arg1 allEdges:(vector_6acbd301 *)arg2 segmentationNetwork:(struct Network *)arg3 candidateNetwork:(struct Network *)arg4 cachedEdgeSet:(set_aa516436 *)arg5 completeDrawing:(id)arg6 allowSmallerFinalBatch:(_Bool)arg7 shouldCancel:(id /* block */)arg8;
...
- (unsigned int *)_createNetworkTruncatedPrefixStringUsingPrefix:(id)arg1 fullHistoryStringLength:(long long)arg2 hasLexiconCursor:(_Bool)arg3 prefixStringLength:(unsigned long long *)arg4 hasComplexChars:(_Bool *)arg5 activeHistoryRange:(struct _NSRange *)arg6;
