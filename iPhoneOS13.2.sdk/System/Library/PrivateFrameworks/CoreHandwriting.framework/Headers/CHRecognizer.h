...
//  (struct Network)_candidateNetworkFromSegmentationNetwork:(struct Network )arg1 segmentGroup:(id)arg2 drawing:(id)arg3 boundsAtNode:(vector_ea45b3ba )arg4 matchingStrokeRange:(NSRange *)arg5 sortedSegmentIndexes:(vector_afed86a5)arg6 shouldCancel:(CDUnknownBlockType)arg7;
