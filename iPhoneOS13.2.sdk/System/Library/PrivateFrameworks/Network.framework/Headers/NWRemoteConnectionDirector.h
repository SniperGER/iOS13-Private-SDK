...
{
    NSUInteger _maximumDataChunkSize;
...
@property(nonatomic) NSUInteger maximumDataChunkSize; // @synthesize maximumDataChunkSize=_maximumDataChunkSize;
// - (void).cxx_destruct;
- (void)receiveData:(id)arg1 forClient:(id)arg2;
// - (void)setOutputProtocolHandler:(struct nw_protocol )arg1 forFlowID:(id)arg2 dataMode:(NSUInteger)arg3;
// - (void)setDefaultOutputProtocolHandler:(struct nw_protocol )arg1;
// - (struct nw_protocol )outputHandlerForFlowID:(id)arg1;
- (NSUInteger)dataModeForFlowID:(id)arg1;
