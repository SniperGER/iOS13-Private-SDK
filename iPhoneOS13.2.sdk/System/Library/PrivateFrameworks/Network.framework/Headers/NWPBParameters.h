...
- (id)preferredAgentsAtIndex:(NSUInteger)arg1;
- (NSUInteger)preferredAgentsCount;
- (void)addPreferredAgents:(id)arg1;
- (void)clearPreferredAgents;
- (id)requiredAgentsAtIndex:(NSUInteger)arg1;
- (NSUInteger)requiredAgentsCount;
- (void)addRequiredAgents:(id)arg1;
- (void)clearRequiredAgents;
- (id)prohibitedAgentsAtIndex:(NSUInteger)arg1;
- (NSUInteger)prohibitedAgentsCount;
- (void)addProhibitedAgents:(id)arg1;
- (void)clearProhibitedAgents;
- (id)prohibitedInterfacesAtIndex:(NSUInteger)arg1;
- (NSUInteger)prohibitedInterfacesCount;
...
- (void)setProhibitedInterfaceSubTypes:(int )arg1 count:(NSUInteger)arg2;
- (int)prohibitedInterfaceSubTypesAtIndex:(NSUInteger)arg1;
...
- (void)setProhibitedInterfaceTypes:(int )arg1 count:(NSUInteger)arg2;
- (int)prohibitedInterfaceTypesAtIndex:(NSUInteger)arg1;
