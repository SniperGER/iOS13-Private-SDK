...
- (void)readMinimumLength:(NSUInteger)arg1 maximumLength:(NSUInteger)arg2 completionHandler:(CDUnknownBlockType)arg3;
- (void)readLength:(NSUInteger)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (void)cancel;
