...
@property(copy, nonatomic) id /* block */ circleJoinCompletion; // @synthesize circleJoinCompletion=_circleJoinCompletion;
@property(copy, nonatomic) id /* block */ resetCompletion; // @synthesize resetCompletion=_resetCompletion;
@property(copy, nonatomic) id /* block */ changeSecurityCodeCompletion; // @synthesize changeSecurityCodeCompletion=_changeSecurityCodeCompletion;
@property(copy, nonatomic) id /* block */ passwordPromptCompletion; // @synthesize passwordPromptCompletion=_passwordPromptCompletion;
...
- (void)joinCircleAfterRecovery:(_Bool)arg1 withCompletion:(id /* block */)arg2;
...
- (void)_disableKeychainSyncOverController:(id)arg1 deletingSafariPasswords:(_Bool)arg2 withCompletion:(id /* block */)arg3;
- (void)_disableCDPKeychainSyncOverController:(id)arg1 deletingSafariPasswords:(_Bool)arg2 withCompletion:(id /* block */)arg3;
...
- (void)_showResetFlowOverController:(id)arg1 withEnableBackupText:(_Bool)arg2 withCompletion:(id /* block */)arg3;
