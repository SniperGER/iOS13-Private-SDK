...
@property(copy, nonatomic) id /* block */ urlHandlingCompletion; // @synthesize urlHandlingCompletion=_urlHandlingCompletion;
...
- (_Bool)prepareHandlingURLForSpecifierID:(id)arg1 resourceDictionary:(id)arg2 animatePush:(_Bool *)arg3 withCompletion:(id /* block */)arg4;
- (void)showController:(id)arg1;
- (void)pushController:(id)arg1 animate:(_Bool)arg2;
- (void)dismissPopoverAnimated:(_Bool)arg1 completion:(id /* block */)arg2;
