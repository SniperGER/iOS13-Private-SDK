...
- (void)enumerateContentLineRangesInRange:(struct _NSRange)arg1 usingBlock:(id /* block */)arg2;
- (void)enumerateParagraphsInRange:(struct _NSRange)arg1 usingBlock:(id /* block */)arg2;
