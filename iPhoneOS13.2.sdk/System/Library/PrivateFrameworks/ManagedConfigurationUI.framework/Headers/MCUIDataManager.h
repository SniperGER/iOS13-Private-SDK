...
- (void)_reloadQueueReloadDataInBackgroundIncludingProfiles:(_Bool)arg1 appSigners:(_Bool)arg2 blockedApplications:(_Bool)arg3 completion:(id /* block */)arg4;
- (void)reloadDataInBackgroundIncludingProfiles:(_Bool)arg1 appSigners:(_Bool)arg2 blockedApplications:(_Bool)arg3 completion:(id /* block */)arg4;
