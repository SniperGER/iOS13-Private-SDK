...
@property(copy, nonatomic) id /* block */ signInCompletionHandler; // @synthesize signInCompletionHandler=_signInCompletionHandler;
...
- (void)_showCPLFinalInstallationWarning:(id /* block */)arg1 withMDMWarning:(_Bool)arg2;
