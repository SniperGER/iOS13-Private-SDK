...
@property(copy, nonatomic) id /* block */ runShortcutCompletionHandler; // @synthesize runShortcutCompletionHandler=_runShortcutCompletionHandler;
...
- (void)describeSyncStateIncludingDeleted:(_Bool)arg1 completion:(id /* block */)arg2;
