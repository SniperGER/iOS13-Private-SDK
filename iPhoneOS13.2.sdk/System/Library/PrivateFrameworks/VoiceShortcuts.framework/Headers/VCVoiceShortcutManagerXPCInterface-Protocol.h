...
- (void)getShortcutSuggestionsForAllAppsWithLimit:(NSUInteger)arg1 completion:(void (^)(NSDictionary *, NSError *))arg2;
...
- (void)getNumberOfVoiceShortcutsWithCompletion:(void (^)(NSUInteger, NSError *))arg1;
@end
