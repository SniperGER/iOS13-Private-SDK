...
- (void)showPasswordEntrySheetWithIntent:(unsigned long long)arg1 note:(id)arg2 displayWindow:(struct UIWindow *)arg3 failedAttemptHandler:(id /* block */)arg4 completionHandler:(id /* block */)arg5;
- (void)showPasswordSetUpSheetForAccount:(id)arg1 displayWindow:(struct UIWindow *)arg2 completionHandler:(id /* block */)arg3;
- (void)authenticateUsingAlternateMethodForDeletingNotes:(id)arg1 displayWindow:(struct UIWindow *)arg2 completionHandler:(id /* block */)arg3;
- (void)authenticatePasswordForDeletingNotes:(id)arg1 displayWindow:(struct UIWindow *)arg2 completionHandler:(id /* block */)arg3;
- (void)authenticateForDeletingNotes:(id)arg1 displayWindow:(struct UIWindow *)arg2 completionHandler:(id /* block */)arg3;
- (void)authenticateIfNecessaryForDeletingNotes:(id)arg1 displayWindow:(struct UIWindow *)arg2 completionHandler:(id /* block */)arg3;
- (void)_recursivelyAuthenticateForNotes:(id)arg1 intent:(unsigned long long)arg2 displayWindow:(struct UIWindow *)arg3 completionHandler:(id /* block */)arg4;
- (void)authenticateForNotes:(id)arg1 intent:(unsigned long long)arg2 displayWindow:(struct UIWindow *)arg3 completionHandler:(id /* block */)arg4;
- (void)_authenticateForNote:(id)arg1 intent:(unsigned long long)arg2 displayWindow:(struct UIWindow *)arg3 failedAttemptHandler:(id /* block */)arg4 completionHandler:(id /* block */)arg5;
- (void)authenticateForNote:(id)arg1 intent:(unsigned long long)arg2 displayWindow:(struct UIWindow *)arg3 failedAttemptHandler:(id /* block */)arg4 completionHandler:(id /* block */)arg5;
