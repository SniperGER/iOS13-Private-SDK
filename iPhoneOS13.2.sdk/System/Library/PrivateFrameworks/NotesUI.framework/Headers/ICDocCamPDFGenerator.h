...
+ (void)generatePDFsIfNecessaryForGalleryAttachments:(id)arg1 displayWindow:(UIWindow )arg2 presentingViewController:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;
