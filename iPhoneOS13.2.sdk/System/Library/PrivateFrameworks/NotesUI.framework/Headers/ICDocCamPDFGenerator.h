...
+ (void)generatePDFsIfNecessaryForGalleryAttachments:(id)arg1 displayWindow:(struct UIWindow *)arg2 presentingViewController:(id)arg3 completionHandler:(id /* block */)arg4;
