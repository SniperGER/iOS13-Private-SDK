...
- (void)performThrowawayConversionIfNeededWithCompletion:(id /* block */)arg1;
- (void)convertDrawingsInNote:(id)arg1 inWindow:(struct UIWindow *)arg2 message:(id)arg3 completion:(id /* block */)arg4;
