...
- (void)purge;
- (id)imageWithCacheName:(id)arg1 tintColor:(id)arg2 addAlignmentInsets:(_Bool)arg3 appearanceInfo:(id)arg4 version:(unsigned long long)arg5 imageCreationBlock:(id /* block */)arg6;
