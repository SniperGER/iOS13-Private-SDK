...
// - (void).cxx_destruct;
- (void)purge;
- (id)imageWithCacheName:(id)arg1 tintColor:(id)arg2 addAlignmentInsets:(BOOL)arg3 appearanceInfo:(id)arg4 version:(NSUInteger)arg5 imageCreationBlock:(CDUnknownBlockType)arg6;
