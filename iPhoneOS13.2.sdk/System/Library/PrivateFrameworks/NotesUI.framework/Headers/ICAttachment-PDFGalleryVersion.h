...
- (_Bool)fetchThumbnailImageWithMinSize:(struct CGSize)arg1 scale:(double)arg2 appearanceInfo:(id)arg3 cache:(id)arg4 cacheKey:(id)arg5 processingBlock:(id /* block */)arg6 completionBlock:(id /* block */)arg7 fallbackBlock:(id /* block */)arg8 aboutToLoadHandler:(id /* block */)arg9;
...
- (id /* block */)loadImage:(id /* block */)arg1 aboutToLoadHandler:(id /* block */)arg2 forceFullSizeImage:(_Bool)arg3;
