...
- (void)main;
- (void)removeCompletionHandler:(id /* block */)arg1 cancelIfNoneLeft:(_Bool)arg2;
- (id /* block */)addCompletionHandler:(id /* block */)arg1;
- (id)initWithCache:(struct NSCache *)arg1 attachment:(id)arg2 attachmentType:(short)arg3 forceFullSizeImage:(_Bool)arg4 completionHandler:(id /* block */)arg5;
