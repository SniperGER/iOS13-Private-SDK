...
@property(copy, nonatomic) id /* block */ passwordEntryFailedAttemptHandler; // @synthesize passwordEntryFailedAttemptHandler=_passwordEntryFailedAttemptHandler;
@property(copy, nonatomic) id /* block */ passwordEntryCompletionHandler; // @synthesize passwordEntryCompletionHandler=_passwordEntryCompletionHandler;
