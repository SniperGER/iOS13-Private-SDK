...
@property(copy, nonatomic) id /* block */ processingBlock; // @synthesize processingBlock=_processingBlock;
@property(copy, nonatomic) id /* block */ fallbackBlock; // @synthesize fallbackBlock=_fallbackBlock;
...
- (id)initWithAttachment:(id)arg1 size:(struct CGSize)arg2 scale:(double)arg3 appearanceInfo:(id)arg4 cache:(id)arg5 cacheKey:(id)arg6 processingBlock:(id /* block */)arg7 completionBlock:(id /* block */)arg8 fallbackBlock:(id /* block */)arg9 queue:(id)arg10;
