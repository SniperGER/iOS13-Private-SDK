...
- (void)_authenticatePasswordWithIntent:(unsigned long long)arg1 note:(id)arg2 incorrectAttempts:(long long)arg3 passwordDiverged:(_Bool)arg4 wrongAccountName:(id)arg5 displayWindow:(id)arg6 failedAttemptHandler:(id /* block */)arg7 completionHandler:(id /* block */)arg8;
