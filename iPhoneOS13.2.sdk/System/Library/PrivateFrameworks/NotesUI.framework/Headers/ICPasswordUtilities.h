...
- (void)authenticateWithBiometricIDWithReason:(id)arg1 intent:(NSUInteger)arg2 note:(id)arg3 displayWindow:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;
...
- (void)_authenticatePasswordWithIntent:(NSUInteger)arg1 note:(id)arg2 incorrectAttempts:(long long)arg3 passwordDiverged:(BOOL)arg4 wrongAccountName:(id)arg5 displayWindow:(id)arg6 failedAttemptHandler:(CDUnknownBlockType)arg7 completionHandler:(CDUnknownBlockType)arg8;
- (void)authenticatePasswordWithIntent:(NSUInteger)arg1 note:(id)arg2 displayWindow:(id)arg3 failedAttemptHandler:(CDUnknownBlockType)arg4 completionHandler:(CDUnknownBlockType)arg5;
- (void)showPasswordSetUpSheetForAccount:(id)arg1 displayWindow:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;
- (void)showPasswordEntrySheetWithIntent:(NSUInteger)arg1 note:(id)arg2 displayWindow:(id)arg3 failedAttemptHandler:(CDUnknownBlockType)arg4 completionHandler:(CDUnknownBlockType)arg5;
