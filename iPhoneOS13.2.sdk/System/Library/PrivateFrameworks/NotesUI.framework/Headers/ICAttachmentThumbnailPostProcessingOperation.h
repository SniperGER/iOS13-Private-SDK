...
- (id)initWithSize:(struct CGSize)arg1 scale:(double)arg2 appearanceInfo:(id)arg3 cache:(id)arg4 cacheKey:(id)arg5 processingBlock:(id /* block */)arg6 completionBlocks:(id)arg7 fallbackBlock:(id /* block */)arg8;
