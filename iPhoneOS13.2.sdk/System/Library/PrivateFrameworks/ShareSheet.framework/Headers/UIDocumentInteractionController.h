...
@property(copy, nonatomic, getter=_completionWithItemsHandler, setter=_setCompletionWithItemsHandler:) id /* block */ _completionWithItemsHandler; // @synthesize _completionWithItemsHandler;
...
- (_Bool)_presentOpenInMenuAnimated:(_Bool)arg1 willPresentBlock:(id /* block */)arg2;
...
- (_Bool)_presentOptionsMenuAnimated:(_Bool)arg1 willPresentBlock:(id /* block */)arg2;
