...
@property(copy, nonatomic) id /* block */ extensionRequestCleanupCompletion; // @synthesize extensionRequestCleanupCompletion=_extensionRequestCleanupCompletion;
...
@property(copy, nonatomic) id /* block */ presenterCompletion; // @synthesize presenterCompletion=_presenterCompletion;
