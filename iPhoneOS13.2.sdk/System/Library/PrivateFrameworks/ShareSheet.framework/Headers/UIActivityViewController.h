...
@property(copy, nonatomic) id /* block */ preCompletionHandler; // @synthesize preCompletionHandler=_preCompletionHandler;
@property(copy, nonatomic, getter=_shareSheetReadyToInteractHandler, setter=_setShareSheetReadyToInteractHandler:) id /* block */ shareSheetReadyToInteractHandler; // @synthesize shareSheetReadyToInteractHandler=_shareSheetReadyToInteractHandler;
...
@property(copy, nonatomic, getter=_activityPresentationCompletionHandler, setter=_setActivityPresentationCompletionHandler:) id /* block */ activityPresentationCompletionHandler; // @synthesize activityPresentationCompletionHandler=_activityPresentationCompletionHandler;
...
@property(copy, nonatomic) id /* block */ _popoverDismissalAction; // @synthesize _popoverDismissalAction=__popoverDismissalAction;
...
@property(copy, nonatomic) id /* block */ completionWithItemsHandler; // @synthesize completionWithItemsHandler=_completionWithItemsHandler;
...
- (void)_clearActivity;
- (void)_performDismissWithSuccess:(_Bool)arg1 completionHandler:(id /* block */)arg2;
