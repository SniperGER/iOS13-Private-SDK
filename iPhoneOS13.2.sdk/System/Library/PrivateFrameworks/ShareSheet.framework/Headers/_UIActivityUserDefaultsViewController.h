...
@class NSArray, NSDictionary, NSDiffableDataSourceSnapshot, NSMutableDictionary, UIImage, UITableView, UIVisualEffectView, _UIActivityUserDefaults, _UIActivityUserDefaultsDataSource;
