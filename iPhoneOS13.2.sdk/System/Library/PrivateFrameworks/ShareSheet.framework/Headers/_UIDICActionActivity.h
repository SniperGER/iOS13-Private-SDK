...
@property(copy, nonatomic) id /* block */ activityFinishedPerformingHandler; // @synthesize activityFinishedPerformingHandler=_activityFinishedPerformingHandler;
@property(copy, nonatomic) id /* block */ activityPerformingHandler; // @synthesize activityPerformingHandler=_activityPerformingHandler;
- (void)_cleanup;
