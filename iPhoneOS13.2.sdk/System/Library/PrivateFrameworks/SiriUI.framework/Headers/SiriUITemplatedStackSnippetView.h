...
- (void)_triggerLayoutAnimated:(_Bool)arg1 completion:(id /* block */)arg2;
- (void)reloadData;
- (double)desiredHeight;
- (void)adjustAuxiliaryViewHeight:(double)arg1 animated:(_Bool)arg2 completion:(id /* block */)arg3;
- (void)setAuxiliaryView:(id)arg1 atIndex:(unsigned long long)arg2 initialHeight:(double)arg3 animated:(_Bool)arg4 completion:(id /* block */)arg5;
- (void)layoutSubviews;
