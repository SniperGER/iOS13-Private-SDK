...
@class CRKCardPresentation, NSMutableDictionary, NSObject, NSTimer, SACardSnippet, SiriUIModalContainerViewController, UIViewController, _SiriUICardLoader;
...
@interface SiriUICardSnippetViewController : SiriUISnippetViewController <_SiriUICardLoaderDelegate, SiriUICardLoadingObserver, SiriUIModalContainerViewControllerDelegate, CRKCardPresentationDelegate, SiriUICardSnippetViewDataSource, SiriUICardSnippetViewDelegate, CRKCardViewControllerDelegate>
{
    ...
    id /* CDUnknownBlockType */ _cardLoadingCompletionhandler;
...
- (NSUInteger)navigationIndexOfCardViewController:(id)arg1;
...
- (void)_forwardProgressEvent:(NSUInteger)arg1 toCardViewController:(id)arg2 animated:(BOOL)arg3;
- (void)_forwardProgressEventToCardViewController:(NSUInteger)arg1;
- (void)willConfirm;
