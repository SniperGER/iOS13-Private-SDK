...
- (BOOL)scrollToPageAtIndex:(NSUInteger)arg1 withAnimationSettings:(id)arg2 withCompletion:(CDUnknownBlockType)arg3;
- (BOOL)scrollToPageAtIndex:(NSUInteger)arg1 animated:(BOOL)arg2 withCompletion:(CDUnknownBlockType)arg3;
