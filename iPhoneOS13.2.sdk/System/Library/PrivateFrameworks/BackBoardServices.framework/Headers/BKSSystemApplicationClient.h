...
// - (void).cxx_destruct;
- (void)_sendMessageOfType:(long long)arg1 packer:(CDUnknownBlockType)arg2 replyHandler:(CDUnknownBlockType)arg3 waitForReply:(BOOL)arg4 waitDuration:(NSUInteger)arg5;
