...
- (void)recentLocationsBatch:(id)arg1 isLast:(BOOL)arg2 error:(id)arg3 queryId:(NSUInteger)arg4 completion:(CDUnknownBlockType)arg5;
- (BOOL)recentLocationsForConsumer:(NSUInteger)arg1 criteria:(id)arg2 limit:(NSUInteger)arg3 explanationSet:(id)arg4 client:(id)arg5 error:(id )arg6 handleBatch:(CDUnknownBlockType)arg7;
