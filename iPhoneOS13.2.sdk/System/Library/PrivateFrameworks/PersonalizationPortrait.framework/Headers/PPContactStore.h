...
- (_Bool)iterContactNameRecordsForClient:(id)arg1 error:(id *)arg2 block:(id /* block */)arg3;
- (_Bool)iterRankedContactsWithQuery:(id)arg1 error:(id *)arg2 block:(id /* block */)arg3;
- (id)init;
