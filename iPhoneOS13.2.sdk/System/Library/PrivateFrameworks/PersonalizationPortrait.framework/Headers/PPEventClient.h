...
- (void)interactionSummaryMetricsBatch:(id)arg1 isLast:(BOOL)arg2 error:(id)arg3 queryId:(NSUInteger)arg4 completion:(CDUnknownBlockType)arg5;
...
- (void)eventHighlightsBatch:(id)arg1 isLast:(BOOL)arg2 error:(id)arg3 queryId:(NSUInteger)arg4 completion:(CDUnknownBlockType)arg5;
- (BOOL)eventHighlightsFrom:(id)arg1 to:(id)arg2 options:(int)arg3 error:(id )arg4 handleBatch:(CDUnknownBlockType)arg5;
- (void)eventNameRecordChangesBatch:(id)arg1 isLast:(BOOL)arg2 error:(id)arg3 queryId:(NSUInteger)arg4 completion:(CDUnknownBlockType)arg5;
- (BOOL)resolveEventNameRecordChanges:(id)arg1 client:(id)arg2 error:(id )arg3 handleBatch:(CDUnknownBlockType)arg4;
- (void)eventNameRecordBatch:(id)arg1 isLast:(BOOL)arg2 error:(id)arg3 queryId:(NSUInteger)arg4 completion:(CDUnknownBlockType)arg5;
