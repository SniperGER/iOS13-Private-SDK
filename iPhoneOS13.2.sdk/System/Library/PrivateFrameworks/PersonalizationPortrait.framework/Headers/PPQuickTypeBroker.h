...
@class PPClientFeedbackHelper, PPXPCClientHelper;
...
- (void)quickTypeItemsWithLanguageModelingTokens:(id)arg1 localeIdentifier:(id)arg2 recipients:(id)arg3 bundleIdentifier:(id)arg4 limit:(NSUInteger)arg5 completion:(CDUnknownBlockType)arg6;
- (void)quickTypeItemsWithQuery:(id)arg1 limit:(NSUInteger)arg2 completion:(CDUnknownBlockType)arg3;
