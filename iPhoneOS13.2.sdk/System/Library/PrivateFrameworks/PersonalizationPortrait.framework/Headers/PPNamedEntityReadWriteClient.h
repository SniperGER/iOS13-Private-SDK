...
- (_Bool)_doDeletionSyncCallWithError:(id *)arg1 deletedCount:(unsigned long long *)arg2 syncCall:(id /* block */)arg3;
- (_Bool)_doSyncCallWithError:(id *)arg1 syncCall:(id /* block */)arg2;
