...
@property(nonatomic) NSUInteger certificateType; // @synthesize certificateType=_certificateType;
...
- (void)evaluateTrustWithOptions:(NSUInteger)arg1;
...
- (void)dealloc;
//  (id)initWithTrust:(struct __SecTrust )arg1 certificateType:(NSUInteger)arg2 sender:(id)arg3;
