...
@property(readonly, copy, nonatomic) id /* block */ reattemptHandler; // @synthesize reattemptHandler=_reattemptHandler;
...
- (id)initWithRemoteInterface:(id)arg1 synchronous:(_Bool)arg2 reattemptHandler:(id /* block */)arg3;
