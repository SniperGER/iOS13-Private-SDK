...
- (void)_filterAndTransformObjectIDs:(id)arg1 before:(_Bool)arg2 existingObjectID:(id)arg3 batchBlock:(id /* block */)arg4;
...
- (id)iterateItemIDsStartingAtItemID:(id)arg1 inReverse:(_Bool)arg2 withBlock:(id /* block */)arg3;
