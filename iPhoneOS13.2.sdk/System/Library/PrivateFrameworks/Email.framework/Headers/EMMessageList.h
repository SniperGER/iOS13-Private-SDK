...
@class EFLazyCache, EMMailboxScope, EMMessageListChangeObserverHelper, EMMessageRepository, EMThreadScope, NSMapTable, NSMutableDictionary, NSObject, NSSet, NSString;
