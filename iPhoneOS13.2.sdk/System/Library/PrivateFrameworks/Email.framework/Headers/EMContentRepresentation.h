...
@interface EMContentRepresentation : NSObject <NSSecureCoding, EFLoggable, EFPubliclyDescribable>
{
    ...
    id /* CDUnknownBlockType */ _requestMoreContentBlock;
}
...
+ (id)log;
@property(copy, nonatomic) id /* CDUnknownBlockType */ requestMoreContentBlock; // @synthesize requestMoreContentBlock=_requestMoreContentBlock;
