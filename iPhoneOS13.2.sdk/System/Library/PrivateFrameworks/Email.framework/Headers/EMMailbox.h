...
- (void)_commonInitName:(id)arg1 accountIdentifier:(id)arg2 type:(long long)arg3 canContainMessages:(_Bool)arg4 children:(id)arg5 parentID:(id)arg6 builder:(id /* block */)arg7;
