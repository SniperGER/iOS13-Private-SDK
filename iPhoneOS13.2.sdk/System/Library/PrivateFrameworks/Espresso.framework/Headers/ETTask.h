...
- (_Bool)runInference:(id)arg1 outputNames:(id)arg2 batchCallback:(id /* block */)arg3;
- (_Bool)fit:(id)arg1 numberOfEpochs:(int)arg2 outputNames:(id)arg3 batchCallback:(id /* block */)arg4;
- (_Bool)fit:(id)arg1 numberOfBatches:(unsigned int)arg2 outputNames:(id)arg3 batchCallback:(id /* block */)arg4;
- (_Bool)runBatches:(id)arg1 numberOfBatches:(unsigned int)arg2 outputNames:(id)arg3 batchCallback:(id /* block */)arg4;
- (id)evaluate:(id)arg1;
