...
- (void)_mainQueue_presentSpinnerPageWithDataclassActions:(struct NSDictionary *)arg1 completion:(id /* block */)arg2;
- (void)_mainQueue_continueSignOutWithDataclassActions:(struct NSDictionary *)arg1;
- (void)_mainQueue_promptForConfirmationInViewController:(id)arg1 simplified:(_Bool)arg2 withCompletion:(id /* block */)arg3;
