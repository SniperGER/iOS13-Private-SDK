...
@property(copy, nonatomic) id /* block */ completed; // @synthesize completed=_completed;
@property(copy, nonatomic) id /* block */ willCapturePhotoAnimation; // @synthesize willCapturePhotoAnimation=_willCapturePhotoAnimation;
