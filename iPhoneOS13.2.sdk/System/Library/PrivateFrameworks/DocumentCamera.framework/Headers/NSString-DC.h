...
- (void)dc_enumerateContentLineRangesInRange:(struct _NSRange)arg1 usingBlock:(id /* block */)arg2;
- (void)dc_enumerateParagraphsInRange:(struct _NSRange)arg1 usingBlock:(id /* block */)arg2;
