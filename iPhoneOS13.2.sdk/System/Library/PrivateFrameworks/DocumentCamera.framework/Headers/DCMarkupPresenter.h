...
+ (void)cleanupMarkup;
+ (void)markupDocumentInfo:(id)arg1 imageCache:(id)arg2 fromView:(id)arg3 presentingViewController:(id)arg4 inkStyle:(NSUInteger)arg5 frameBlock:(CDUnknownBlockType)arg6 startPresentBlock:(CDUnknownBlockType)arg7 completionBlock:(CDUnknownBlockType)arg8 dismissCompletionBlock:(CDUnknownBlockType)arg9;
