...
+ (void)generatePDFsIfNecessaryForDocumentInfoCollection:(id)arg1 imageCache:(id)arg2 displayWindow:(struct UIWindow *)arg3 presentingViewController:(id)arg4 completionHandler:(id /* block */)arg5;
