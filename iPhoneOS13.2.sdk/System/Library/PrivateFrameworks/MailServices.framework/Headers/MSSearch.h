...
+ (id)findMessageData:(id)arg1 matchingCriterion:(id)arg2 options:(NSUInteger)arg3 delegate:(id)arg4;
...
- (void)_findMessageData:(id)arg1 matchingCriterion:(id)arg2 options:(NSUInteger)arg3;
