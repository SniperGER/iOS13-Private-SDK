...
+ (_Bool)canSendMail;
+ (void)accountValuesForKeys:(id)arg1 originatingBundleID:(id)arg2 sourceAccountManagement:(int)arg3 launchMobileMail:(_Bool)arg4 completionBlock:(id /* block */)arg5;
+ (void)accountValuesForKeys:(id)arg1 launchMobileMail:(_Bool)arg2 completionBlock:(id /* block */)arg3;
