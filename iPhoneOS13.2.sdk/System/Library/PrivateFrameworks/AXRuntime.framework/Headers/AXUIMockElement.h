...
@property(copy, nonatomic) id /* block */ cacheUpdatedCallback; // @synthesize cacheUpdatedCallback=_cacheUpdatedCallback;
@property(copy, nonatomic) id /* block */ handleActionBlock; // @synthesize handleActionBlock=_handleActionBlock;
