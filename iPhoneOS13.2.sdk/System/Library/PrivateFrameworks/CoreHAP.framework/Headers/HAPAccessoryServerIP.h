...
//     struct PairingSessionPrivate _pairingSession;
    ...
    id /* CDUnknownBlockType */ _netServiceResolveCompletionBlock;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ netServiceResolveCompletionBlock; // @synthesize netServiceResolveCompletionBlock=_netServiceResolveCompletionBlock;
...
- (void)_handleListPairingsResponseObject:(id)arg1 type:(NSUInteger)arg2 httpStatus:(int)arg3 httpError:(id)arg4 completionQueue:(id)arg5 completionHandler:(CDUnknownBlockType)arg6;
...
- (void)_handlePairingsResponseObject:(id)arg1 type:(NSUInteger)arg2 httpStatus:(int)arg3 httpError:(id)arg4 removeRequest:(BOOL)arg5 completionQueue:(id)arg6 completionBlock:(CDUnknownBlockType)arg7;
...
- (void)_handleEventResponseObject:(id)arg1 type:(NSUInteger)arg2 httpStatus:(int)arg3 error:(id)arg4 characteristics:(id)arg5 requestedEventState:(BOOL)arg6 completion:(CDUnknownBlockType)arg7 queue:(id)arg8;
...
- (void)_handleWriteResponseObject:(id)arg1 type:(NSUInteger)arg2 httpStatus:(int)arg3 error:(id)arg4 requestTuples:(id)arg5 queue:(id)arg6 completion:(CDUnknownBlockType)arg7;
- (void)_handlePrepareWriteResponseObject:(id)arg1 type:(NSUInteger)arg2 prepareIdentifier:(id)arg3 httpStatus:(int)arg4 error:(id)arg5 requestTuples:(id)arg6 timeout:(double)arg7 queue:(id)arg8 completion:(CDUnknownBlockType)arg9;
...
- (void)_handleReadResponseObject:(id)arg1 type:(NSUInteger)arg2 httpStatus:(int)arg3 error:(id)arg4 characteristics:(id)arg5 queue:(id)arg6 completion:(CDUnknownBlockType)arg7;
