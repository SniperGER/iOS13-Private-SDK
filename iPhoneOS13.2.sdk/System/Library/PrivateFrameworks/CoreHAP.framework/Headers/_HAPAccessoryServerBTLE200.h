...
@interface _HAPAccessoryServerBTLE200 : HAPAccessoryServerBTLE <CBPeripheralDelegate, HAPBTLEControlOutputStreamDelegate, HAPPairSetupSessionClientDelegate, HAPSecuritySessionDelegate, HMFTimerDelegate, HAPAuthSessionDelegate, HMFLogging>
{
    ...
    id /* CDUnknownBlockType */ _connectionCompletionHandler;
    ...
    id /* CDUnknownBlockType */ _setupCodeCompletionHandler;
...
+ (id)configurationRequestForCharacteristic:(id)arg1 isBroadcasted:(BOOL)arg2 interval:(NSUInteger)arg3 error:(id )arg4;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ setupCodeCompletionHandler; // @synthesize setupCodeCompletionHandler=_setupCodeCompletionHandler;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ connectionCompletionHandler; // @synthesize connectionCompletionHandler=_connectionCompletionHandler;
...
- (NSUInteger)_maximumControlWriteLengthForRequest:(id)arg1;
...
- (BOOL)_parsePairingFeaturesCharacteristic:(id)arg1 authMethod:(NSUInteger )arg2 error:(id )arg3;
...
- (void)_enableBroadcastEvent:(BOOL)arg1 interval:(NSUInteger)arg2 forCharacteristic:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;
...
- (id)_serviceCacheFromHAPService:(id)arg1 serviceOrder:(NSUInteger)arg2;
- (id)_hapServicesFromCache;
- (id)_getCachedService:(id)arg1;
- (id)_getCBService:(id)arg1 instanceOrder:(NSUInteger)arg2;
