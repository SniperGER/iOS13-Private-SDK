...
@property(copy, nonatomic) id /* block */ setupCodeCompletionHandler; // @synthesize setupCodeCompletionHandler=_setupCodeCompletionHandler;
...
@property(copy, nonatomic) id /* block */ connectionCompletionHandler; // @synthesize connectionCompletionHandler=_connectionCompletionHandler;
...
- (void)_enableBroadcastEvent:(_Bool)arg1 interval:(unsigned long long)arg2 forCharacteristic:(id)arg3 completionHandler:(id /* block */)arg4;
...
- (void)_enableEvent:(_Bool)arg1 toCharacteristic:(id)arg2 completionHandler:(id /* block */)arg3;
- (void)_performEnableEvent:(_Bool)arg1 toCharacteristic:(id)arg2 completionHandler:(id /* block */)arg3;
