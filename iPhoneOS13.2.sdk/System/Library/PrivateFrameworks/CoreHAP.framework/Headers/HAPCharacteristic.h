...
- (id)initWithType:(id)arg1 instanceID:(id)arg2 value:(id)arg3 stateNumber:(id)arg4 properties:(NSUInteger)arg5 eventNotificationsEnabled:(BOOL)arg6 metadata:(id)arg7;
