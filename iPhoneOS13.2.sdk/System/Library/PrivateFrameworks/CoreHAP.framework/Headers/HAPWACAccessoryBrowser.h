...
@interface HAPWACAccessoryBrowser : HAPAccessoryServerBrowser <HMFTimerDelegate, HMFLogging>
{
    ...
    id /* CDUnknownBlockType */ _found2Pt4Completion;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ found2Pt4Completion; // @synthesize found2Pt4Completion=_found2Pt4Completion;
