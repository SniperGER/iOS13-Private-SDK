...
@class CBCentralManager, CBConnectionsObserver, HAPAccessoryServerBrowserWiProxBTLE, NSMapTable, NSMutableArray, NSMutableOrderedSet, NSMutableSet, NSObject;
...
@interface HAPAccessoryServerBrowserBTLE : HAPAccessoryServerBrowser <CBCentralManagerDelegate, HAPAccessoryServerBrowserWiProxBTLEDelegate, HMFLogging>
{
    ...
    id /* CDUnknownBlockType */ _reachabilityCompletion;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ reachabilityCompletion; // @synthesize reachabilityCompletion=_reachabilityCompletion;
...
@property(nonatomic) NSUInteger qosLimits; // @synthesize qosLimits=_qosLimits;
// - (void).cxx_destruct;
- (void)_handleTargetedScanTimeout;
- (void)_updateTargetedScanTimer;
- (BOOL)_shouldCreateHAPAccessoryServerWithIdentifier:(id)arg1 statusFlags:(id)arg2 stateNumber:(id)arg3 category:(id)arg4 configNumber:(id)arg5 forPeripheral:(id)arg6 advertisementFormat:(NSUInteger)arg7 setupHash:(id)arg8 stateChanged:(BOOL )arg9 connectReason:(unsigned char )arg10;
...
- (void)_createHAPAccessoryAndNotifyDelegateWithPeripheral:(id)arg1 name:(id)arg2 pairingUsername:(id)arg3 statusFlags:(id)arg4 stateNumber:(id)arg5 stateChanged:(BOOL)arg6 connectReason:(unsigned char)arg7 configNumber:(id)arg8 category:(id)arg9 connectionIdleTime:(unsigned char)arg10 format:(NSUInteger)arg11 setupHash:(id)arg12 encryptedPayload:(id)arg13;
...
- (void)accessoryServerBrowserBTLE:(id)arg1 didDiscoverHAPPeripheral:(id)arg2 accessoryName:(id)arg3 pairingIdentifier:(id)arg4 advertisementFormat:(NSUInteger)arg5 statusFlags:(id)arg6 stateNumber:(id)arg7 category:(id)arg8 configurationNumber:(id)arg9 setupHash:(id)arg10 encryptedPayload:(id)arg11;
...
- (void)_didDiscoverPeripheral:(id)arg1 accessoryName:(id)arg2 pairingIdentifier:(id)arg3 format:(NSUInteger)arg4 statusFlags:(id)arg5 stateNumber:(id)arg6 category:(id)arg7 configNumber:(id)arg8 setupHash:(id)arg9 encryptedPayload:(id)arg10;
...
- (void)configureBTLEQoSLimits:(NSUInteger)arg1;
...
- (void)configureAccessoryWithIdentifier:(id)arg1 trackState:(BOOL)arg2 connectionPriority:(NSUInteger)arg3;
...
- (BOOL)_hasPairedAccessoriesOfType:(NSUInteger)arg1;
...
- (NSUInteger)_parseAdvertisementData:(id)arg1 forPeripheral:(id)arg2 name:(id )arg3 pairingUsername:(id )arg4 statusFlags:(id )arg5 stateNumber:(id )arg6 category:(id )arg7 configNumber:(id )arg8 setupHash:(id )arg9;
