...
+ (id)bulletinForAccessMode:(NSUInteger)arg1 camera:(id)arg2 home:(id)arg3 changeReason:(NSUInteger)arg4 changeDate:(id)arg5;
+ (id)localizedMessageForCameraAccessModeChange:(NSUInteger)arg1 changeReason:(NSUInteger)arg2 camera:(id)arg3;
