...
@interface HMDCameraProfile : HMDAccessoryProfile <HMDCameraSettingProactiveReaderDelegate, HMDCameraProfileSettingsManagerDelegate, HMDCameraClipManagerDelegate>
{
    ...
    id /* CDUnknownBlockType */ _recordingManagerFactory;
...
@property(readonly) id /* CDUnknownBlockType */ recordingManagerFactory; // @synthesize recordingManagerFactory=_recordingManagerFactory;
