...
- (id)_insertRequestWithTitle:(id)arg1 snapshotData:(id)arg2 message:(id)arg3 requestIdentifier:(id)arg4 bulletinType:(NSUInteger)arg5 actionURL:(id)arg6 bulletinContext:(NSDictionary )arg7 actionContext:(NSDictionary )arg8;
