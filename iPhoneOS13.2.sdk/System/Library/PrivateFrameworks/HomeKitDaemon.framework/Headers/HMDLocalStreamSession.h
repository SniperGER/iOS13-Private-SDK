...
@class HMDCameraNetworkConfig, HMDCameraParameterSelection;
...
- (void)dealloc;
- (id)initWithSessionID:(id)arg1 reachabilityPath:(NSUInteger)arg2 streamSender:(id)arg3 remoteCapabilities:(id)arg4 localNetworkConfig:(id)arg5 streamPreference:(id)arg6;
