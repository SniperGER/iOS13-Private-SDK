...
- (void)_userResponse:(NSUInteger)arg1 device:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;
- (void)userResponse:(NSUInteger)arg1 device:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;
