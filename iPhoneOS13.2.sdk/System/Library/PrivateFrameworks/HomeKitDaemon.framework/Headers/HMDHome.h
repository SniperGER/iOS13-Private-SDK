...
- (void)_handleWriteMediaProperties:(struct NSDictionary *)arg1 source:(unsigned long long)arg2 requestMessage:(id)arg3 completionHandler:(id /* block */)arg4;
...
- (void)_handleReadMediaProperties:(struct NSDictionary *)arg1 source:(unsigned long long)arg2 message:(id)arg3 completionHandler:(id /* block */)arg4;
...
- (void)_handleUpdatedCharacteristics:(id)arg1 accessoryServer:(id)arg2 stateNumber:(id)arg3 broadcast:(_Bool)arg4;
...
- (void)accessoryBrowser:(id)arg1 didFindAccessoryServer:(id)arg2 stateChanged:(_Bool)arg3 stateNumber:(id)arg4 completion:(id /* block */)arg5;
...
- (void)_handlePendingResponserTimerFired:(_Bool)arg1;
...
- (void)readCharacteristicValues:(id)arg1 identifier:(id)arg2 isSPIEntitled:(_Bool)arg3 source:(unsigned long long)arg4 withCompletionHandler:(id /* block */)arg5;
...
- (void)_notifyChangedCharacteristics:(id)arg1 identifier:(id)arg2 multiPartResponse:(_Bool)arg3 moreMessagesInMultipart:(_Bool)arg4 requestMessage:(id)arg5 withCompletionHandler:(id /* block */)arg6;
- (void)_sendClientCharacteristicsChangedNotification:(id)arg1 identifier:(id)arg2 entitledClientsOnly:(_Bool)arg3 multiPartResponse:(_Bool)arg4 moreMessagesInMultipart:(_Bool)arg5 withCompletionHandler:(id /* block */)arg6;
...
- (_Bool)_shouldSendToDestination:(id)arg1;
...
- (void)_notifyClientsOfAccessoryInfoUpdatedForAccessories:(id)arg1 shouldRefreshBadge:(_Bool)arg2 withCompletion:(id /* block */)arg3;
- (void)notifyClientsOfAccessoryInfoUpdatedForAccessories:(id)arg1;
- (void)_removeAllHomeContentsAndAccessoryPairings:(_Bool)arg1 queue:(id)arg2 completionHandler:(id /* block */)arg3;
...
- (void)_getRunTimeStateUpdateWithOptions:(unsigned long long)arg1 includeMediaAccessoryState:(_Bool)arg2 includeResidentDeviceState:(_Bool)arg3 completion:(id /* block */)arg4;
- (id)residentDevicesIncludingRemoteGateways;
- (void)getRunTimeStateUpdateWithOptions:(unsigned long long)arg1 includeMediaAccessoryState:(_Bool)arg2 includeResidentDeviceState:(_Bool)arg3 completion:(id /* block */)arg4;
...
- (void)removeAllHomeContentsAndAccessoryPairings:(_Bool)arg1 queue:(id)arg2 completionHandler:(id /* block */)arg3;
...
- (void)saveWithReason:(id)arg1 information:(id)arg2 postSyncNotification:(_Bool)arg3 objectChange:(id)arg4 incrementGenerationCounter:(_Bool)arg5;
- (_Bool)_shouldIncrementGenerationCounterForReason:(id)arg1;
- (void)saveWithReason:(id)arg1 information:(id)arg2 postSyncNotification:(_Bool)arg3;
- (void)saveWithReason:(id)arg1 postSyncNotification:(_Bool)arg2 objectChange:(id)arg3;
...
- (id)_notificationPayloadsForRemoteGateway:(_Bool)arg1;
...
- (_Bool)configure:(id)arg1 accessoriesPresent:(id)arg2 source:(unsigned long long)arg3;
