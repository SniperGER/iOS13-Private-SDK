...
@interface HMDHome : HMFObject <HMDBulletinIdentifiers, HMDResidentDeviceManagerDelegate, HMFLogging, HMDAccessoryBrowserDelegate, HMDHomeMessageReceiver, HMDRelayManagerDelegate, HMFTimerDelegate, HMFDumpState, HMDUserManagementOperationDelegate, HMDMediaActionRouterDataSource, NSSecureCoding, HMDBackingStoreObjectProtocol>
{
    ...
    NSUInteger _networkRouterSupport;
    NSUInteger _networkRouterSupportDisableReason;
    NSString *_name;
...
@property(nonatomic) NSUInteger stateHandle; // @synthesize stateHandle=_stateHandle;
...
@property(nonatomic) NSUInteger homeHubState; // @synthesize homeHubState=_homeHubState;
...
- (void)_handleWriteMediaProperties:(NSDictionary )arg1 source:(NSUInteger)arg2 requestMessage:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;
...
- (void)_handleReadMediaProperties:(NSDictionary )arg1 source:(NSUInteger)arg2 message:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;
...
- (id)homeConfigurationModelObjectWithChangeType:(NSUInteger)arg1;
...
- (void)__encodeAccessoriesWithCoder:(id)arg1 options:(NSUInteger)arg2;
...
- (void)_configureConfiguredResident:(id)arg1 desiredConfigState:(NSUInteger)arg2 message:(id)arg3;
...
- (void)_configureUnconfiguredResident:(id)arg1 desiredConfigState:(NSUInteger)arg2;
- (void)_updateConfigurationStateForResidentDevice:(id)arg1 desiredConfigState:(NSUInteger)arg2 message:(id)arg3;
...
- (void)_readCharacteristicValues:(id)arg1 requestMessage:(id)arg2 source:(NSUInteger)arg3 withCompletionHandler:(CDUnknownBlockType)arg4;
- (void)readCharacteristicValues:(id)arg1 requestMessage:(id)arg2 source:(NSUInteger)arg3 withCompletionHandler:(CDUnknownBlockType)arg4;
...
- (id)_getLogEventsForOperation:(BOOL)arg1 accessories:(id)arg2 requestMap:(id)arg3 identifier:(id)arg4 source:(NSUInteger)arg5;
- (void)readCharacteristicValues:(id)arg1 identifier:(id)arg2 isSPIEntitled:(BOOL)arg3 source:(NSUInteger)arg4 withCompletionHandler:(CDUnknownBlockType)arg5;
...
- (void)_writeCharacteristicValues:(id)arg1 requestMessage:(id)arg2 source:(NSUInteger)arg3 withCompletionHandler:(CDUnknownBlockType)arg4;
- (void)_redispatchWriteForAccessories:(id)arg1 dispatchGroup:(id)arg2 requestMap:(id)arg3 requestMessage:(id)arg4 source:(NSUInteger)arg5 responseTuples:(id)arg6;
- (void)_loadBalancedRedispatchForAccessories:(id)arg1 source:(NSUInteger)arg2 dispatchGroup:(id)arg3 writeRequestMap:(id)arg4 requestMessage:(id)arg5 responseTuples:(id)arg6;
...
- (void)_writeCharacteristicValuesForAccessories:(id)arg1 writeRequestMap:(id)arg2 responseTuples:(id)arg3 requestMessage:(id)arg4 viaDevice:(id)arg5 source:(NSUInteger)arg6 completionHandler:(CDUnknownBlockType)arg7;
- (id)_applyDeviceLockCheck:(id)arg1 forSource:(NSUInteger)arg2;
- (void)writeCharacteristicValues:(id)arg1 source:(NSUInteger)arg2 identifier:(id)arg3 withCompletionHandler:(CDUnknownBlockType)arg4;
...
- (id)prepareUserManagementOperationForUser:(id)arg1 accessory:(id)arg2 type:(NSUInteger)arg3 model:(id)arg4 error:(id )arg5;
- (id)prepareUserManagementOperationForUser:(id)arg1 accessories:(id)arg2 type:(NSUInteger)arg3 error:(id )arg4;
...
- (void)getReachableIPAccessories:(NSUInteger )arg1 btleAccessories:(NSUInteger )arg2 mediaAccessories:(NSUInteger )arg3;
- (NSUInteger)reachableIPAccessories;
...
- (NSUInteger)accessoryCountForRoom:(id)arg1;
...
- (void)notifyOfRemovedAccessory:(id)arg1 source:(NSUInteger)arg2;
...
- (id)getTransactionFromHAPAccessory:(id)arg1 hmdAccessory:(id)arg2 uuid:(id)arg3 bridgeUUID:(id)arg4 configurationAppIdentifier:(id)arg5 objectChangeType:(NSUInteger)arg6;
- (id)getServiceTransaction:(id)arg1 parentUUID:(id)arg2 changeType:(NSUInteger)arg3;
...
- (void)_getRunTimeStateUpdateWithOptions:(NSUInteger)arg1 includeMediaAccessoryState:(BOOL)arg2 includeResidentDeviceState:(BOOL)arg3 completion:(CDUnknownBlockType)arg4;
- (id)residentDevicesIncludingRemoteGateways;
- (void)getRunTimeStateUpdateWithOptions:(NSUInteger)arg1 includeMediaAccessoryState:(BOOL)arg2 includeResidentDeviceState:(BOOL)arg3 completion:(CDUnknownBlockType)arg4;
- (void)handleBackgroundTaskAgentJob:(id)arg1;
- (void)checkTimerTriggers;
- (id)migrateOwnedTriggers;
- (void)writeCharacteristicValues:(id)arg1 source:(NSUInteger)arg2 transactionId:(id)arg3 withCompletionHandler:(CDUnknownBlockType)arg4;
...
- (BOOL)configure:(id)arg1 accessoriesPresent:(id)arg2 source:(NSUInteger)arg3;
...
@property NSUInteger networkRouterSupport; // @synthesize networkRouterSupport=_networkRouterSupport;
@property NSUInteger networkRouterSupportDisableReason; // @synthesize networkRouterSupportDisableReason=_networkRouterSupportDisableReason;
...
- (BOOL)checkForNetworkRouterSupport:(NSUInteger)arg1 error:(id )arg2;
...
- (NSUInteger)deriveNetworkRouterSupport:(NSUInteger)arg1;
