...
@class BKSApplicationStateMonitor, HMDApplicationRegistry, HMFTimer, NSMutableSet, NSObject, NSSet;
...
- (NSUInteger)_translateApplicationState:(unsigned int)arg1;
...
- (NSUInteger)translateApplicationStateForInfo:(id)arg1 processInfo:(id)arg2;
