...
+ (id)decryptDataWithControllerKey:(id)arg1 totalKeysFound:(NSUInteger )arg2 deleteExtraKeys:(BOOL)arg3 allowControllerIdentifierToChange:(BOOL)arg4 controllerIdentifierChanged:(BOOL )arg5 successfulKeyUserName:(id )arg6 error:(id )arg7;
