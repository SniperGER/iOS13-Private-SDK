...
@class HMDAccessory, HMDCameraStreamMetrics, HMDCameraStreamSessionID, HMDCameraStreamSnapshotHandler, HMDService, NSNumber, NSObject;
...
- (void)_callStreamFirstFrameReceived:(NSUInteger)arg1 aspectRatio:(id)arg2 slotIdentifier:(id)arg3;
