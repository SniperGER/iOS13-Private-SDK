...
@class HMDHomeManager, HMFMessageDispatcher, HMFTimer, NSDate, NSObject, NSUUID;
...
- (BOOL)_cloudSyncinProgressCheck:(id)arg1 supressPopup:(BOOL)arg2 sendCanceledError:(BOOL )arg3 dataSyncState:(NSUInteger )arg4;
- (BOOL)dataSyncInProgressWithState:(NSUInteger )arg1 withMessage:(id)arg2;
...
- (void)_postNotificationForDataSyncInProgress:(BOOL)arg1 dataSyncState:(NSUInteger)arg2 forcePost:(BOOL)arg3;
