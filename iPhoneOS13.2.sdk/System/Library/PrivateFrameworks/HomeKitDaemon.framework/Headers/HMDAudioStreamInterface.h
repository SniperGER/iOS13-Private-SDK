...
@interface HMDAudioStreamInterface : HMDStreamInterface <AVCAudioStreamDelegate>
{
    ...
    NSUInteger _audioStreamSetting;
...
@property(nonatomic) NSUInteger audioStreamSetting; // @synthesize audioStreamSetting=_audioStreamSetting;
...
- (void)_updateAudioSetting:(NSUInteger)arg1;
