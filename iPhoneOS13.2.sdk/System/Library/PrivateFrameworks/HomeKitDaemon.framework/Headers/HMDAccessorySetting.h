...
- (_Bool)_shouldTurnOffPersonalRequestsOnLanguageChangeFrom:(id)arg1 toValue:(id)arg2;
- (_Bool)_shouldBlockSettingUpdateMessage:(id)arg1;
...
- (void)sendReflectedNotification:(_Bool)arg1;
