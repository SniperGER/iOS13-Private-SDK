...
@property(copy, nonatomic) id /* block */ expirationHandler; // @synthesize expirationHandler=_expirationHandler;
@property(copy, nonatomic) id /* block */ resolutionHandler; // @synthesize resolutionHandler=_resolutionHandler;
