...
@property(copy, nonatomic) id /* block */ resultHandler; // @synthesize resultHandler=_resultHandler;
@property(retain, nonatomic) HMDBackingStoreLocal *store; // @synthesize store=_store;
- (void)main;
- (id)initWithStore:(id)arg1 clearCloud:(_Bool)arg2 resultHandler:(id /* block */)arg3;
