...
- (void)displayExecutionErrorOfTrigger:(id)arg1 partialSuccess:(_Bool)arg2 context:(id)arg3 completionQueue:(id)arg4 completionHandler:(id /* block */)arg5;
...
- (void)dismissPendingDialogDueToPeerDeviceSelection:(_Bool)arg1 context:(id)arg2 queue:(id)arg3 completionHandler:(id /* block */)arg4;
