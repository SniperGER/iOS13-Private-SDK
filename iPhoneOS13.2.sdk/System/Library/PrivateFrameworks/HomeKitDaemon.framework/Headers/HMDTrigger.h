...
- (void)userDidConfirmExecute:(_Bool)arg1 completionHandler:(id /* block */)arg2;
- (void)_executeActionSets:(id)arg1 captureCurrentState:(_Bool)arg2 completionHandler:(id /* block */)arg3;
...
- (void)_activate:(_Bool)arg1 completionHandler:(id /* block */)arg2;
