...
- (_Bool)_parseManufacturersList:(id)arg1 collectionsByManufacturer:(struct NSDictionary **)arg2 entriesByProductData:(struct NSDictionary **)arg3;
...
- (_Bool)_parseDatabaseFromDictionary:(id)arg1 dataVersion:(long long *)arg2 collectionsByManufacturer:(struct NSDictionary **)arg3 entriesByProductData:(struct NSDictionary **)arg4;
