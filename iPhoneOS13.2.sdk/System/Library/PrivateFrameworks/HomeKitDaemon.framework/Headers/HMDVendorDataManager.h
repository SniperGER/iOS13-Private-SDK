...
@class HMFTimer, NSDictionary, NSObject, NSURL, NSURLSession;
...
- (BOOL)_parseManufacturersList:(id)arg1 collectionsByManufacturer:(NSDictionary )arg2 entriesByProductData:(NSDictionary )arg3;
...
- (BOOL)_parseDatabaseFromDictionary:(id)arg1 dataVersion:(long long )arg2 collectionsByManufacturer:(NSDictionary )arg3 entriesByProductData:(NSDictionary )arg4;
