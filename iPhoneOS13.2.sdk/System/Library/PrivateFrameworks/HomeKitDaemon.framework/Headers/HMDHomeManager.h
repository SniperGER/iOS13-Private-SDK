...
@interface HMDHomeManager : HMFObject <HMDDeviceSetupSessionDelegate, HMDMobileAssetManagerDelegate, HMFMessageReceiver, HMDAccessoryBrowserManagerDelegate, HMFTimerDelegate, HAPFragmentationStreamDelegate, HMDPairedSyncDelegate, HMDUserManagementOperationDelegate, HMDBackingStoreObjectProtocol>
{
    ...
    NSUInteger _assistantGenerationCounter;
...
//    struct __SCNetworkReachability _reachability;
    ...
    NSUInteger _cloudOperationRetryCount;
    NSObject<OS_dispatch_source> *_cloudOperationRetryTimer;
    NSUInteger _homeDatabaseSize;
    ...
    NSUInteger _siriSyncNotificationTime;
...
@property(nonatomic) NSUInteger siriSyncNotificationTime; // @synthesize siriSyncNotificationTime=_siriSyncNotificationTime;
...
@property(nonatomic) NSUInteger homeDatabaseSize; // @synthesize homeDatabaseSize=_homeDatabaseSize;
...
@property(nonatomic) NSUInteger cloudOperationRetryCount; // @synthesize cloudOperationRetryCount=_cloudOperationRetryCount;
...
@property(nonatomic) NSUInteger assistantGenerationCounter; // @synthesize assistantGenerationCounter=_assistantGenerationCounter;
...
@property(nonatomic) NSUInteger generationCounter; // @synthesize generationCounter=_generationCounter;
...
- (NSUInteger)statusForMessage:(id)arg1;
...
- (void)_electRemoteAccessDeviceForHome:(id)arg1 retryCount:(NSUInteger)arg2;
- (void)_electRemoteAccessPeerForHome:(id)arg1 retryCount:(NSUInteger)arg2;
...
- (void)_getRuntimeStateUpdateForHomeManager:(BOOL)arg1 includeMediaAccessoryState:(BOOL)arg2 options:(NSUInteger)arg3 includeResidentDeviceState:(BOOL)arg4 completion:(CDUnknownBlockType)arg5;
- (id)_runtimeState;
...
- (BOOL)_preferLocalHomesOverCloudHomes:(id)arg1 migrationOptions:(NSUInteger)arg2;
- (void)_transactionalizeAndApplyHomeData:(id)arg1 cachedHomeData:(id)arg2 syncCompletion:(CDUnknownBlockType)arg3;
- (void)_transactionalizeAndApplyCloudHomeData:(id)arg1 cachedHomeData:(id)arg2 version:(long long)arg3 migrationOptions:(NSUInteger)arg4 dataWasMerged:(BOOL )arg5 syncCompletion:(CDUnknownBlockType)arg6;
...
- (NSUInteger)getDataMigrationOptions;
- (void)_setDataMigrationOptions:(id)arg1;
- (void)_setUniqueDeviceIdSalt:(id)arg1;
- (void)setHomekitLastSyncedAssistantConfigurationVersion:(NSUInteger)arg1;
- (void)_setHomekitAssistantConfigurationVersion:(NSUInteger)arg1;
...
- (id)checkConflictInHomeNamespaceWithName:(id)arg1 options:(NSUInteger)arg2 namespaceUUID:(id)arg3;
...
- (void)_updateModelChangesAsPushed:(id)arg1 home:(id)arg2 pushMask:(NSUInteger)arg3 completion:(CDUnknownBlockType)arg4;
...
- (void)_updateHomeManagerModelChangesAsPushed:(id)arg1 pushMask:(NSUInteger)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)_processRemoveHomeModels:(id)arg1 processIndex:(NSUInteger)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)_startCloudOperationRetryWithTimeout:(NSUInteger)arg1 completionHandler:(CDUnknownBlockType)arg2;
...
- (void)_saveWithReason:(id)arg1 information:(id)arg2 saveOptions:(NSUInteger)arg3;
- (void)saveWithReason:(id)arg1 information:(id)arg2 saveOptions:(NSUInteger)arg3;
...
- (void)_sendFragmentedMessage:(id)arg1 messageIndex:(NSUInteger)arg2 messageIdentity:(id)arg3 userID:(id)arg4 destination:(id)arg5 completionHandler:(CDUnknownBlockType)arg6;
