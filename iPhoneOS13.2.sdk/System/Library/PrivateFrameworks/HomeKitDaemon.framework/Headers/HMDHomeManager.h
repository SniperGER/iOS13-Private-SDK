...
- (void)pingDevice:(id)arg1 secure:(_Bool)arg2 completionHandler:(id /* block */)arg3;
...
- (void)_eraseLocalHomeConfigurationAndDeleteMetadata:(_Bool)arg1 completionQueue:(id)arg2 completion:(id /* block */)arg3;
- (void)_eraseLocalHomeConfigurationAfterSignout;
- (void)_eraseLocalHomeConfiguration;
- (void)_eraseLocalHomeConfigurationCommon;
- (void)_eraseConfiguration:(_Bool)arg1 completionHandler:(id /* block */)arg2;
...
- (void)_sendUserRemoved:(id)arg1 fromHome:(id)arg2 pairingUsername:(id)arg3 pushToCloud:(_Bool)arg4 completionHandler:(id /* block */)arg5;
...
- (void)_getRuntimeStateUpdateForHomeManager:(_Bool)arg1 includeMediaAccessoryState:(_Bool)arg2 options:(unsigned long long)arg3 includeResidentDeviceState:(_Bool)arg4 completion:(id /* block */)arg5;
- (id)_runtimeState;
...
- (void)_transactionalizeAndApplyCloudHomeData:(id)arg1 cachedHomeData:(id)arg2 version:(long long)arg3 migrationOptions:(unsigned long long)arg4 dataWasMerged:(_Bool *)arg5 syncCompletion:(id /* block */)arg6;
...
- (void)_updateCloudDataSyncWithAccountState:(_Bool)arg1 completion:(id /* block */)arg2;
- (void)_updateCloudDataSyncWithAccountState:(_Bool)arg1;
- (void)forceCloudFetch;
- (void)_requestHomeDataSync;
- (void)_runFetchHomeDataFromCloudWithCloudConflict:(_Bool)arg1 forceFetch:(_Bool)arg2 accountCompletion:(id /* block */)arg3 syncCompletion:(id /* block */)arg4;
- (void)_fetchHomeDataFromCloudWithCloudConflict:(_Bool)arg1 forceFetch:(_Bool)arg2 withDelay:(double)arg3 accountCompletion:(id /* block */)arg4;
...
- (void)_handleTransactionsFetched:(id)arg1 stagedTransaction:(id)arg2 mustReplay:(id)arg3 zoneID:(id)arg4 cloudConflict:(_Bool)arg5 transactionError:(id)arg6 syncCompletion:(id /* block */)arg7;
- (void)_handleFetchObjectChange:(id)arg1 home:(id)arg2 isLegacyTransaction:(_Bool)arg3 completion:(id /* block */)arg4;
- (void)_handleFetchModifyHome:(id)arg1 isLegacyTransaction:(_Bool)arg2 completion:(id /* block */)arg3;
- (void)_runFetchHomeFromCloudZone:(id)arg1 cloudConflict:(_Bool)arg2 syncCompletion:(id /* block */)arg3;
...
- (void)_loadHomeModelChanges:(id)arg1 mustReplay:(id)arg2 legacyPush:(_Bool)arg3 home:(id)arg4 completion:(id /* block */)arg5;
- (void)_loadHomeManagerHomeModelChanges:(id)arg1 mustReplay:(id)arg2 legacyPush:(_Bool)arg3 home:(id)arg4 completion:(id /* block */)arg5;
...
- (void)_handleHomeManagerTransactionsFetched:(id)arg1 stagedTransaction:(id)arg2 mustReplay:(id)arg3 cloudConflict:(_Bool)arg4 transactionError:(id)arg5 syncCompletion:(id /* block */)arg6;
- (void)_runFetchHomeManagerCloudConflict:(_Bool)arg1 syncCompletion:(id /* block */)arg2;
...
- (void)_loadHomeManagerTransactionsToPush:(id)arg1 mustReplay:(id)arg2 forLegacyPush:(_Bool)arg3 includeAllChanges:(_Bool)arg4 completion:(id /* block */)arg5;
...
- (void)sendUserRemoved:(id)arg1 fromHome:(id)arg2 pairingUsername:(id)arg3 pushToCloud:(_Bool)arg4 completionHandler:(id /* block */)arg5;
- (void)sendUserAdded:(id)arg1 destination:(id)arg2 toHome:(id)arg3;
- (void)_postCloudSyncNotificationWithSuccess:(_Bool)arg1;
- (void)_handleAccountStatusDeterminedWithError:(id)arg1 homeDataRecordExists:(_Bool)arg2 metadataRecordExists:(_Bool)arg3 completion:(id /* block */)arg4;
...
- (void)_runUploadHomeConfigToCloud:(id)arg1 rowIDs:(id)arg2 forcePush:(_Bool)arg3 syncCompletion:(id /* block */)arg4;
- (void)_runUploadHomeConfigToCloudForcePush:(_Bool)arg1 syncCompletion:(id /* block */)arg2;
