...
- (_Bool)sendMessage:(id)arg1 payload:(id)arg2 device:(id)arg3 target:(id)arg4 responseHandler:(id /* block */)arg5;
- (_Bool)sendMessage:(id)arg1 payload:(id)arg2 device:(id)arg3 responseHandler:(id /* block */)arg4;
- (_Bool)sendResidentMessage:(id)arg1 payload:(id)arg2 responseHandler:(id /* block */)arg3;
