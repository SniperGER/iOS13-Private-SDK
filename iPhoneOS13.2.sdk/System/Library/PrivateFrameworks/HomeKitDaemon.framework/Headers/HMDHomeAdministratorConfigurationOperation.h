...
+ (id)logCategory;
+ (double)timeout;
@property(copy) id /* block */ responseHandler; // @synthesize responseHandler=_responseHandler;
@property(copy) id /* block */ sendCompletionBlock; // @synthesize sendCompletionBlock=_sendCompletionBlock;
