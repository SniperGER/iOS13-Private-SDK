...
@property(copy, nonatomic) id /* block */ activeReadHandler; // @synthesize activeReadHandler=_activeReadHandler;
...
- (void)asyncHandleIncomingPackets:(id)arg1 isEof:(_Bool)arg2;
