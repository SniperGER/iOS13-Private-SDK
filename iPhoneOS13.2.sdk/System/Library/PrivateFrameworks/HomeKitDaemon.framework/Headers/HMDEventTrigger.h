...
@class HMDEventTriggerExecutionSession, HMDEventTriggerUserConfirmationSession, HMDPredicateUtilities, NSArray, NSMutableArray, NSPredicate;
...
+ (id)logCategory;
@property(nonatomic) NSUInteger activationState; // @synthesize activationState=_activationState;
