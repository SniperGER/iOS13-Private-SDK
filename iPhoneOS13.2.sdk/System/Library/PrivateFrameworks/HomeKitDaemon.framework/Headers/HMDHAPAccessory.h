...
@interface HMDHAPAccessory : HMDAccessory <HMDAccessoryMinimumUserPrivilegeCapable, HMDServiceOwner, HAPRelayAccessoryDelegate, HMDTimeInformationMonitorDelegate, HMFTimerDelegate, HMDAccessoryIdentify, HMDAccessoryUserManagement>
{
    ...
    NSUInteger _currentRelayAccessoryState;
    ...
    NSUInteger _activationAttempts;
    NSUInteger _pairingAttempts;
...
+ (NSUInteger)getAWDTransportTypeWithLinkType:(long long)arg1;
...
@property(nonatomic) NSUInteger pairingAttempts; // @synthesize pairingAttempts=_pairingAttempts;
@property(nonatomic) NSUInteger activationAttempts; // @synthesize activationAttempts=_activationAttempts;
...
- (void)accessory:(id)arg1 didUpdateRelayState:(NSUInteger)arg2;
...
- (void)_readCharacteristicValues:(id)arg1 hapAccessory:(id)arg2 source:(NSUInteger)arg3 queue:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;
- (void)_writeCharacteristicValues:(id)arg1 hapAccessory:(id)arg2 source:(NSUInteger)arg3 queue:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;
...
- (void)_readCharacteristicValues:(id)arg1 localOperationRequired:(BOOL)arg2 source:(NSUInteger)arg3 queue:(id)arg4 completionHandler:(CDUnknownBlockType)arg5 errorBlock:(CDUnknownBlockType)arg6;
- (void)autoUpdateCachedCountDownCharacteristics:(id)arg1;
- (void)readCharacteristicValues:(id)arg1 source:(NSUInteger)arg2 queue:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;
- (id)_getResponseTuple:(id)arg1 error:(id)arg2 source:(NSUInteger)arg3 suspended:(BOOL)arg4;
- (id)getFullError:(id)arg1 source:(NSUInteger)arg2 suspended:(BOOL)arg3;
- (void)_writeCharacteristicValues:(id)arg1 localOperationRequired:(BOOL)arg2 source:(NSUInteger)arg3 queue:(id)arg4 completionHandler:(CDUnknownBlockType)arg5 errorBlock:(CDUnknownBlockType)arg6;
- (void)writeCharacteristicValues:(id)arg1 source:(NSUInteger)arg2 queue:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;
...
- (id)relayAccessory;
- (void)_setCurrentRelayAccessoryState:(NSUInteger)arg1;
- (NSUInteger)_currentRelayAccessoryState;
@property(readonly, nonatomic) NSUInteger currentRelayAccessoryState; // @synthesize currentRelayAccessoryState=_currentRelayAccessoryState;
