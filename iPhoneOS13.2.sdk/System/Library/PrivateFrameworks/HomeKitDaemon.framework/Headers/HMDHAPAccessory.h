...
- (void)_enableNotification:(_Bool)arg1 forCharacteristics:(id)arg2 hapAccessory:(id)arg3 completion:(id /* block */)arg4;
...
- (void)_readCharacteristicValues:(id)arg1 localOperationRequired:(_Bool)arg2 source:(unsigned long long)arg3 queue:(id)arg4 completionHandler:(id /* block */)arg5 errorBlock:(id /* block */)arg6;
...
- (void)_writeCharacteristicValues:(id)arg1 localOperationRequired:(_Bool)arg2 source:(unsigned long long)arg3 queue:(id)arg4 completionHandler:(id /* block */)arg5 errorBlock:(id /* block */)arg6;
...
- (void)unconfigure;
- (void)configureWithAccessory:(id)arg1 homeNotificationsEnabled:(_Bool)arg2 queue:(id)arg3 completion:(id /* block */)arg4;
...
- (_Bool)initiateScan:(id /* block */)arg1;
