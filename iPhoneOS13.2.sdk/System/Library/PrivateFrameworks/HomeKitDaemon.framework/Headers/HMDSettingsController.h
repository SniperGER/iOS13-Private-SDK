...
- (void)handleAddedConstraintModel:(id)arg1 shouldNotify:(_Bool)arg2 completion:(id /* block */)arg3;
...
- (void)handleAddedSettingModel:(id)arg1 shouldNotify:(_Bool)arg2 completion:(id /* block */)arg3;
- (void)handleAddedSettingModel:(id)arg1 completion:(id /* block */)arg2;
- (void)handleAddedGroupModel:(id)arg1 shouldNotify:(_Bool)arg2 completion:(id /* block */)arg3;
