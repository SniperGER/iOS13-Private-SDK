...
- (void)accessoryServer:(id)arg1 promptUserForPasswordWithType:(NSUInteger)arg2;
...
- (void)_callProgressOrErrorOut:(id)arg1 pairingInfo:(id)arg2 accessoryInfo:(id)arg3 unpairedAccessory:(id)arg4 progress:(long long)arg5 certStatus:(NSUInteger)arg6;
