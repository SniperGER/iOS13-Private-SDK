...
@class HMBCloudZone, HMBLocalZone, HMDCameraClipsQuotaManager, HMDDatabaseZoneManager, HMFMessageDispatcher, HMFTimer, NSHashTable, NSObject, NSUUID;
...
@interface HMDCameraClipManager : HMFObject <HMBLocalZoneModelObserver, HMFLogging, HMFMessageReceiver, HMFTimerDelegate, HMDCloudShareParticipantsManagerDataSource, HMDDatabaseZoneManagerDelegate>
{
    ...
    NSUInteger _fetchClipsBatchLimit;
    id /* CDUnknownBlockType */ _cloudFetchTimerFactory;
}

+ (id)logCategory;
+ (double)maximumClipDuration;
@property(copy) id /* CDUnknownBlockType */ cloudFetchTimerFactory; // @synthesize cloudFetchTimerFactory=_cloudFetchTimerFactory;
@property NSUInteger fetchClipsBatchLimit; // @synthesize fetchClipsBatchLimit=_fetchClipsBatchLimit;
