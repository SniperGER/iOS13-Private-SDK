...
@property(nonatomic, getter=isReprovisionBrowsingAllowed) _Bool reprovisionBrowsingAllowed; // @synthesize reprovisionBrowsingAllowed=_reprovisionBrowsingAllowed;
