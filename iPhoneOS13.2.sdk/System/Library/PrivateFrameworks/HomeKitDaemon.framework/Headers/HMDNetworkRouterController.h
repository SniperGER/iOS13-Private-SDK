...
- (void)_writeValue:(id)arg1 characteristicType:(id)arg2 operationName:(id)arg3 completion:(id /* block */)arg4;
...
- (void)setManagedNetworkEnable:(_Bool)arg1 completion:(id /* block */)arg2;
