...
- (BOOL)_supportsFeature:(NSUInteger)arg1 forCapabilitiesKey:(id)arg2;
- (BOOL)supportsRequestedFeature:(NSUInteger)arg1;
- (BOOL)supportsRequiredFeature:(NSUInteger)arg1;
...
@property(readonly, nonatomic) NSUInteger remoteRestriction;
