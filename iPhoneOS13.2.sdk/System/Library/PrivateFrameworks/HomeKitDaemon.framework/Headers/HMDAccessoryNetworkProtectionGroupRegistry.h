...
- (_Bool)updateTargetProtectionModeForGroupWithUUID:(id)arg1 protectionMode:(long long)arg2 error:(id *)arg3 requestMessage:(id)arg4;
- (_Bool)updateTargetProtectionModeForGroupWithUUID:(id)arg1 protectionMode:(long long)arg2 error:(id *)arg3;
...
- (void)configure;
- (void)addActiveSurrogateGroupForAccessory:(id)arg1 shouldNotifyChange:(_Bool)arg2;
- (void)notifyClientsOfRemovedGroup:(id)arg1;
- (void)notifyClientsOfAddedGroup:(id)arg1;
- (_Bool)_updateGroupWithUUID:(id)arg1 active:(_Bool)arg2;
- (_Bool)_evaluateActiveStatusForGroupWithUUID:(id)arg1;
- (void)_setupProtectionGroupForAccessory:(id)arg1 shouldNotifyChange:(_Bool)arg2;
...
- (id)logIdentifier;
- (id)markGroupWithUUID:(id)arg1 active:(_Bool)arg2;
- (id)removeGroupWithUUID:(id)arg1;
- (_Bool)addActiveSurrogateGroup:(id)arg1;
