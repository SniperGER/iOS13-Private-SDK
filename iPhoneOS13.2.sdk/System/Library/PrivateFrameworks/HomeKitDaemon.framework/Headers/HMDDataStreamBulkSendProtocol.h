...
+ (id)logCategory;
+ (id)protocolName;
@property(readonly) id /* block */ bulkSendSessionContextFactory; // @synthesize bulkSendSessionContextFactory=_bulkSendSessionContextFactory;
...
- (void)_startSessionForFileType:(id)arg1 queue:(id)arg2 callback:(id /* block */)arg3;
- (void)startSessionForFileType:(id)arg1 queue:(id)arg2 callback:(id /* block */)arg3;
