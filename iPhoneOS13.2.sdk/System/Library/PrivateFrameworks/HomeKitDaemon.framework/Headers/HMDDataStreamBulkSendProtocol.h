...
@interface HMDDataStreamBulkSendProtocol : NSObject <HMFLogging, HMDDataStreamProtocol, HMFTimerDelegate>
{
    ...
    id /* CDUnknownBlockType */ _bulkSendSessionContextFactory;
}

+ (id)logCategory;
+ (id)protocolName;
@property(readonly) id /* CDUnknownBlockType */ bulkSendSessionContextFactory; // @synthesize bulkSendSessionContextFactory=_bulkSendSessionContextFactory;
