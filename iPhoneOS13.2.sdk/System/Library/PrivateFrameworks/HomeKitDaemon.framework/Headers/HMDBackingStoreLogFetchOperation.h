...
- (id)initWithSentinal:(id)arg1 alreadyPushedTo:(NSUInteger)arg2 fetchResult:(CDUnknownBlockType)arg3;
- (id)initWithAlreadyPushedTo:(NSUInteger)arg1 result:(CDUnknownBlockType)arg2;
- (id)initWithSentinal:(id)arg1 needsPushTo:(NSUInteger)arg2 fetchResult:(CDUnknownBlockType)arg3;
