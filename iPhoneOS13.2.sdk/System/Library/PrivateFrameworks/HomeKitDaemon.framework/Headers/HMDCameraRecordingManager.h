...
- (void)_startRecordingSessionForTrigger:(NSUInteger)arg1 presenceByPairingIdentity:(id)arg2 reason:(id)arg3 completionCallback:(CDUnknownBlockType)arg4;
- (BOOL)_canAnyDeviceStartRecordingSession;
- (void)handleStartRecordingSessionRequest:(id)arg1;
- (void)_startCameraRecordingSessionForTrigger:(NSUInteger)arg1 reason:(id)arg2;
- (void)_createRecordingSessionForTrigger:(NSUInteger)arg1 presenceByPairingIdentity:(id)arg2;
- (void)_forwardRecordingSession:(NSUInteger)arg1 withSortedDevices:(id)arg2 withRetries:(long long)arg3;
@property(readonly) NSDictionary *homePresenceByPairingIdentity;
- (void)_coordinateRecordingSessionForAccessory:(NSUInteger)arg1;
...
- (void)notificationTrigger:(id)arg1 didObserveTriggerType:(NSUInteger)arg2 changeToActive:(BOOL)arg3;
- (void)shutDown;
- (void)start;
- (void)dealloc;
