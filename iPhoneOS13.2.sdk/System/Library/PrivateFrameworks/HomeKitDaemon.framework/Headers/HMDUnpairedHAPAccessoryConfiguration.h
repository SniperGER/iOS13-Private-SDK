...
@property(readonly) id /* block */ setupCodeProvider; // @synthesize setupCodeProvider=_setupCodeProvider;
...
- (id)initWithHomeName:(id)arg1 setupCode:(id)arg2 setupCodeProvider:(id /* block */)arg3 requiresUserConsent:(_Bool)arg4 networkCredential:(id)arg5 country:(id)arg6;
