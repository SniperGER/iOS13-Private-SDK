...
- (void)sendMediaActionMessageToDevice:(id)arg1 sessionData:(id)arg2 encodePlaybackArchive:(_Bool)arg3 completion:(id /* block */)arg4;
- (void)routeSessionDataForExecution:(id)arg1 encodePlaybackArchive:(_Bool)arg2 completion:(id /* block */)arg3;
- (void)routeMediaActionForExecution:(id)arg1 completion:(id /* block */)arg2;
