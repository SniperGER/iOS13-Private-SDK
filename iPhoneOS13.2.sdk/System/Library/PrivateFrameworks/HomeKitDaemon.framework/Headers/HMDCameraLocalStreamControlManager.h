...
@class HMDCameraMediaConfigGenerator, HMDCameraSupportedConfigurationCache, HMDLocalStreamSession;
...
- (void)streamingManagerDidReceiveFirstFrame:(id)arg1 audioStreamSetting:(NSUInteger)arg2 aspectRatio:(id)arg3 slotIdentifier:(id)arg4;
...
- (void)dealloc;
- (id)initWithSessionID:(id)arg1 workQueue:(id)arg2 streamSnapshotHandler:(id)arg3 reachabilityPath:(NSUInteger)arg4 device:(id)arg5 delegate:(id)arg6 delegateQueue:(id)arg7 accessory:(id)arg8 streamManagementService:(id)arg9 remoteCapabilities:(id)arg10 supportedConfigCache:(id)arg11 streamPreference:(id)arg12;
