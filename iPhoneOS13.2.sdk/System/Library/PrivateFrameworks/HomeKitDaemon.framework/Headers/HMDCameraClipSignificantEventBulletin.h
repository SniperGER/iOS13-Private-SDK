...
+ (id)localizedMessageForSignificantEvent:(NSUInteger)arg1 cameraName:(id)arg2;
...
- (id)initWithNotificationUUIDs:(id)arg1 previewImageFilePathURL:(id)arg2 significantEvent:(NSUInteger)arg3 dateOfOccurrence:(id)arg4 camera:(id)arg5 home:(id)arg6 accessory:(id)arg7 recordingService:(id)arg8 clipUUID:(id)arg9 shouldShowProvideFeedbackButton:(BOOL)arg10;
