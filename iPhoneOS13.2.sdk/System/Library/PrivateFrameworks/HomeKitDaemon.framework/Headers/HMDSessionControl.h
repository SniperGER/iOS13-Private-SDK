...
{
    NSUInteger _controlCommand;
    NSUUID *_sessionID;
}

+ (BOOL)supportsSecureCoding;
@property(readonly, copy, nonatomic) NSUUID *sessionID; // @synthesize sessionID=_sessionID;
@property(readonly, nonatomic) NSUInteger controlCommand; // @synthesize controlCommand=_controlCommand;
// - (void).cxx_destruct;
...
- (id)initWithCommand:(NSUInteger)arg1 sessionIdentifier:(id)arg2;
