...
@class HMDApplicationData, HMDHome, HMFMessage, HMFMessageDispatcher, HMFTimer, NSArray, NSDate, NSDictionary, NSMutableArray, NSObject, NSString, NSUUID;
...
- (id)_generateOverallError:(id)arg1 forSource:(NSUInteger)arg2;
