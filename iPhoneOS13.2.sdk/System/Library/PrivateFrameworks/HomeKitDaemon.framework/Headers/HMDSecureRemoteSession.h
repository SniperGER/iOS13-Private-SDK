...
@class HMDAccountRegistry, HMDDevice, HMDRemoteDeviceMonitor, NSMutableArray, NSObject;
...
@interface HMDSecureRemoteSession : HMFMessageTransport <HMDSecureRemoteStreamDelegate, HMFLogging, HMFTimerDelegate, HMFDumpState>
{
    ...
    NSUInteger _maximumRemoteStreams;
...
@property(nonatomic) NSUInteger maximumRemoteStreams; // @synthesize maximumRemoteStreams=_maximumRemoteStreams;
