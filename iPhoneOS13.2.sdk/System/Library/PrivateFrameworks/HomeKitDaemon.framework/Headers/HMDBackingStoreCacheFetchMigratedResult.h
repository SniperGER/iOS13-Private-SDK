...
- (id)initWithGroup:(id)arg1 update:(_Bool)arg2 migration:(_Bool)arg3 fetchResult:(id /* block */)arg4;
- (id)initWithShareGroup:(id)arg1 update:(_Bool)arg2 migration:(_Bool)arg3 fetchResult:(id /* block */)arg4;
