...
@interface HMDCameraProfileSettingsManager : HMFObject <HMFLogging, HMBLocalZoneDelegate, HMBCloudZoneDelegate, HMBLocalZoneModelObserver, HMDCloudShareParticipantsManagerDataSource, HMDDatabaseZoneManagerDelegate, HMFTimerDelegate, HMFMessageReceiver>
{
    ...
    id /* CDUnknownBlockType */ _timerFactory;
...
@property(copy) id /* CDUnknownBlockType */ timerFactory; // @synthesize timerFactory=_timerFactory;
...
@property(readonly) NSUInteger currentAccessMode; // @synthesize currentAccessMode=_currentAccessMode;
// - (void).cxx_destruct;
- (void)dealloc;
- (id)logIdentifier;
...
- (BOOL)_shouldQueryCanDisableRecordingForAccessMode:(NSUInteger)arg1 isAtHome:(BOOL)arg2 currentSettings:(id)arg3;
- (BOOL)_shouldQueryCanEnableRecordingForAccessMode:(NSUInteger)arg1 currentSettings:(id)arg2;
- (void)_addRecordingAudioEnabledWriteRequestToArray:(id)arg1 recordingAudioEnabled:(BOOL)arg2;
- (void)_addAccessModeCharacteristicWriteRequestsToArray:(id)arg1 currentAccessMode:(NSUInteger)arg2;
- (void)_addHomeKitCameraActiveCharacteristicWriteRequestToArray:(id)arg1 currentAccessMode:(NSUInteger)arg2;
