...
@property(copy) id /* block */ timerFactory; // @synthesize timerFactory=_timerFactory;
...
- (void)_updateCurrentAccessModeForSettings:(id)arg1 userInitiated:(_Bool)arg2 withDescription:(id)arg3;
