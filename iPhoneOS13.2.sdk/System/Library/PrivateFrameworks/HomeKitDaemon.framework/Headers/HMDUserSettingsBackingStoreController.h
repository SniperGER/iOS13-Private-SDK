...
- (void)runTransaction:(id)arg1 waitForCloudPush:(_Bool)arg2 completion:(id /* block */)arg3;
- (id)settingTransactionWithName:(id)arg1;
- (void)runSettingTransaction:(id)arg1 waitForCloudPush:(_Bool)arg2 completion:(id /* block */)arg3;
...
- (id)loadUserSettings;
- (void)_didFetchZonesWithResult:(id)arg1 isOwnedZone:(_Bool)arg2 error:(id)arg3;
