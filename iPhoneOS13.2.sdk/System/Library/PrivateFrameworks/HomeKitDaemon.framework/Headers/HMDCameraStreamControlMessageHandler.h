...
@interface HMDCameraStreamControlMessageHandler : HMFObject <HMFTimerDelegate, HMDCameraStreamControlManagerDelegate, HMFLogging>
{
    ...
    id /* CDUnknownBlockType */ _messageSender;
...
@property(readonly, nonatomic) id /* CDUnknownBlockType */ messageSender; // @synthesize messageSender=_messageSender;
...
- (void)streamControlManagerDidReceiveFirstFrame:(id)arg1 audioStreamSetting:(NSUInteger)arg2 aspectRatio:(id)arg3 slotIdentifier:(id)arg4;
