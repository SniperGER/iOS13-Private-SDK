...
@class HMFOperationBudget, IDSService, NSMutableArray, NSMutableDictionary, NSObject;
...
- (void)_restartPendingResponseTimerFor:(id)arg1 withReducedFactor:(NSUInteger)arg2;
- (id)sendMessage:(id)arg1 fromHandle:(id)arg2 destination:(id)arg3 priority:(long long)arg4 timeout:(double)arg5 options:(NSUInteger)arg6 error:(id )arg7;
