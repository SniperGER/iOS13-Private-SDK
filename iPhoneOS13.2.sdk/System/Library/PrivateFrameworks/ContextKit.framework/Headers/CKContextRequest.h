...
+ (void)warmUpForRequestType:(NSUInteger)arg1 withReply:(CDUnknownBlockType)arg2;
+ (void)runOffMainThread:(CDUnknownBlockType)arg1;
+ (void)findResultsForText:(id)arg1 languageTag:(id)arg2 requestType:(NSUInteger)arg3 withReply:(CDUnknownBlockType)arg4;
