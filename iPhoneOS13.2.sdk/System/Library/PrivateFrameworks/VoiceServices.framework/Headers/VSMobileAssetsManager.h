...
- (void)downloadVoiceResource:(id)arg1 discretionary:(_Bool)arg2 completion:(id /* block */)arg3;
- (void)removeVoiceAsset:(id)arg1 completion:(id /* block */)arg2;
- (void)cancelDownload:(id)arg1 completion:(id /* block */)arg2;
- (void)downloadVoiceAsset:(id)arg1 discretionary:(_Bool)arg2 useBattery:(_Bool)arg3 progressUpdateHandler:(id /* block */)arg4;
- (void)downloadVoiceAsset:(id)arg1 discretionary:(_Bool)arg2 progressUpdateHandler:(id /* block */)arg3;
- (void)downloadVoiceAsset:(id)arg1 useBattery:(_Bool)arg2 progressUpdateHandler:(id /* block */)arg3;
- (id)selectVoiceForLang:(id)arg1 type:(long long)arg2 gender:(long long)arg3 footprint:(long long)arg4;
- (id)installedVoiceResources;
- (id)installedAssetsForType:(long long)arg1 voicename:(id)arg2 language:(id)arg3 gender:(long long)arg4 footprint:(long long)arg5;
- (void)resetCache;
