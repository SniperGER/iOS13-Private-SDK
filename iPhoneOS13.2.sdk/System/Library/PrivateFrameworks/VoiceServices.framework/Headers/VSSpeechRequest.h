...
@property(copy, nonatomic) id /* block */ pauseHandler; // @synthesize pauseHandler=_pauseHandler;
@property(copy, nonatomic) id /* block */ stopHandler; // @synthesize stopHandler=_stopHandler;
