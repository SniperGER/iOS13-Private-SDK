...
- (id)initWithPresentingViewController:(id)arg1 detailViewController:(id)arg2 shouldPlayFlipInAnimation:(BOOL)arg3 initialBadgeFrame:(CGRect)arg4 conversionView:(id)arg5 presentAlongsideBlock:(CDUnknownBlockType)arg6 dismissAlongsideBlock:(CDUnknownBlockType)arg7 completionBlock:(CDUnknownBlockType)arg8;
