...
@property(copy, nonatomic) id /* block */ dismissBlock; // @synthesize dismissBlock=_dismissBlock;
@property(copy, nonatomic) id /* block */ presentBlock; // @synthesize presentBlock=_presentBlock;
...
- (id)initWithPresentingViewController:(id)arg1 detailViewController:(id)arg2 shouldPlayFlipInAnimation:(_Bool)arg3 initialBadgeFrame:(struct CGRect)arg4 conversionView:(id)arg5 presentAlongsideBlock:(id /* block */)arg6 dismissAlongsideBlock:(id /* block */)arg7 completionBlock:(id /* block */)arg8;
