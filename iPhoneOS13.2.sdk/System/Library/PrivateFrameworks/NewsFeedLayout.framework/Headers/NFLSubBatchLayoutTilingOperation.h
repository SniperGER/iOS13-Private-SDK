...
@interface NFLSubBatchLayoutTilingOperation : FCOperation
{
    ...
    id /* CDUnknownBlockType */ _tilingCompletionBlock;
...
@property(copy) id /* CDUnknownBlockType */ tilingCompletionBlock; // @synthesize tilingCompletionBlock=_tilingCompletionBlock;
// - (void).cxx_destruct;
- (BOOL)isReliable;
