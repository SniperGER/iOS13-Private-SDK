...
@property(readonly) id /* CDUnknownBlockType */ latencyComparator;
...
- (void)startProbingEdges:(id)arg1 atIndex:(NSUInteger)arg2 doneCount:(NSUInteger)arg3 sampleCount:(NSUInteger)arg4 completionHandler:(CDUnknownBlockType)arg5;
- (BOOL)reprocessWithNewRTT:(NSUInteger)arg1 reProbe:(BOOL )arg2;
- (long long)getFallbackReasonForLatencies:(id)arg1;
- (void)reprocessLatencies:(id)arg1 sampleCount:(NSUInteger)arg2 completionHandler:(CDUnknownBlockType)arg3;
- (id)createEdgeLatenciesToProbeWithEdgeIndex:(NSUInteger)arg1 startSampleCount:(NSUInteger )arg2;
...
- (void)reprocessEdgeAtIndex:(NSUInteger)arg1 networkSignature:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;
- (void)reprocessAdHocWithEdgeIndex:(NSUInteger)arg1 completionHandler:(CDUnknownBlockType)arg2;
...
- (void)updateMetaDataNeedProbe:(BOOL)arg1 refresh:(BOOL)arg2 push:(BOOL)arg3 minRTT:(NSUInteger)arg4;
