...
@interface NPTunnelFlow : NSObject
{
    ...
    NSDate *_startDate;
    void _window;
    NSUInteger _initialBytesLeftOver;
...
@property(nonatomic) NSUInteger initialBytesLeftOver; // @synthesize initialBytesLeftOver=_initialBytesLeftOver;
...
@property(readonly, nonatomic) NSUInteger hashKey; // @synthesize hashKey=_hashKey;
// - (void).cxx_destruct;
...
- (void)increaseWindowSize:(NSUInteger)arg1;
...
- (void)dealloc;
- (id)initWithTunnel:(id)arg1 appRule:(id)arg2 hashKey:(NSUInteger)arg3 extraFlowProperties:(id)arg4;
