...
@property(copy, nonatomic) id /* block */ pendingCancellationHandler; // @synthesize pendingCancellationHandler=_pendingCancellationHandler;
...
@property(copy, nonatomic) id /* block */ tunnelConnectedHandler; // @synthesize tunnelConnectedHandler=_tunnelConnectedHandler;
@property(copy, nonatomic) id /* block */ connectionInfoSetHandler; // @synthesize connectionInfoSetHandler=_connectionInfoSetHandler;
@property(copy, nonatomic) id /* block */ changeHandler; // @synthesize changeHandler=_changeHandler;
...
- (_Bool)useTestDaypass;
- (_Bool)useTestLatencyMap;
- (unsigned long long)getTestLatencyRTT:(id)arg1 parameters:(struct networkParameters *)arg2;
- (void)ingestTestLatencyMap:(id)arg1 local:(_Bool)arg2 completionHandler:(id /* block */)arg3;
- (id)buildTestLatencyMap:(id)arg1;
- (_Bool)shouldSetConfigurationToAppRule:(id)arg1 edgeSet:(id)arg2;
