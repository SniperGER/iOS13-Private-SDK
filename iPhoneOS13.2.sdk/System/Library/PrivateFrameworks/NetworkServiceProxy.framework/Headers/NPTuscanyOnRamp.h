...
@property(readonly) NSUInteger rtt; // @synthesize rtt=_rtt;
@property long long TFOStatus; // @synthesize TFOStatus=_TFOStatus;
@property(readonly) NSUInteger maxFrameSize; // @synthesize maxFrameSize=_maxFrameSize;
