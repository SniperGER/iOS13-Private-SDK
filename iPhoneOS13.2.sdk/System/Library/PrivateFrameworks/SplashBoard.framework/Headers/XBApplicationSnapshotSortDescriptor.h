...
+ (id)sortDescriptorWithKey:(NSUInteger)arg1 ascending:(BOOL)arg2 comparator:(CDUnknownBlockType)arg3;
...
- (id)initWithKey:(NSUInteger)arg1 ascending:(BOOL)arg2 comparator:(CDUnknownBlockType)arg3;
