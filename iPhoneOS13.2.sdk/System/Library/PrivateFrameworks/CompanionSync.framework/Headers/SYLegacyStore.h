...
@property(copy, nonatomic) id /* block */ nextBatchStep; // @synthesize nextBatchStep=_nextBatchStep;
...
- (void)_handleObjectChanges:(id)arg1 contextInfo:(id)arg2 idsOptions:(id)arg3 blockUntilSent:(_Bool)arg4 reportError:(id /* block */)arg5 notifyingTransaction:(id)arg6;
- (void)handleObjectChanges:(id)arg1 contextInfo:(id)arg2 idsOptions:(id)arg3 blockUntilSent:(_Bool)arg4 reportError:(id /* block */)arg5;
...
- (void)_transaction:(id /* block */)arg1 context:(id)arg2 idsOptions:(id)arg3 blockUntilSent:(_Bool)arg4 reportError:(id /* block */)arg5;
- (id)newMessageHeader;
