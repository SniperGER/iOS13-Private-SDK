...
//    struct __CFString _loggingFacility;
    ...
    NSUInteger _maxMessagesInFlight;
    NSUInteger _minMessagesInFlight;
    NSUInteger _maxBytesInFlight;
...
@property(nonatomic) NSUInteger maxBytesInFlight; // @synthesize maxBytesInFlight=_maxBytesInFlight;
@property(nonatomic) NSUInteger minMessagesInFlight; // @synthesize minMessagesInFlight=_minMessagesInFlight;
@property(nonatomic) NSUInteger maxMessagesInFlight; // @synthesize maxMessagesInFlight=_maxMessagesInFlight;
