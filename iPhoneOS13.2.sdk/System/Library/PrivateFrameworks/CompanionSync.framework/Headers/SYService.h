...
- (void)dataStreamWithMetadata:(id)arg1 options:(NSDictionary )arg2 completion:(CDUnknownBlockType)arg3;
- (BOOL)sendData:(id)arg1 options:(NSDictionary )arg2 identifier:(id )arg3 error:(id )arg4;
- (void)sendData:(id)arg1 options:(NSDictionary )arg2 completion:(CDUnknownBlockType)arg3;
