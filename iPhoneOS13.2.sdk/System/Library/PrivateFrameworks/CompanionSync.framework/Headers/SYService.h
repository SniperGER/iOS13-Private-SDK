...
- (_Bool)_request:(id)arg1 hasValidSessionIDForSession:(id)arg2 response:(id)arg3 completion:(id /* block */)arg4;
...
- (void)dataStreamWithMetadata:(id)arg1 options:(struct NSDictionary *)arg2 completion:(id /* block */)arg3;
- (_Bool)sendData:(id)arg1 options:(struct NSDictionary *)arg2 identifier:(id *)arg3 error:(id *)arg4;
- (void)sendData:(id)arg1 options:(struct NSDictionary *)arg2 completion:(id /* block */)arg3;
