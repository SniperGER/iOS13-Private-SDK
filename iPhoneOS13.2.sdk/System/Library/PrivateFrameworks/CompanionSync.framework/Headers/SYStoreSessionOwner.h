...
@property(copy, nonatomic) id /* block */ onComplete; // @synthesize onComplete=_onComplete;
@property(copy, nonatomic) id /* block */ errorCallback; // @synthesize errorCallback=_errorCallback;
...
- (void)syncSession:(id)arg1 applyChanges:(struct NSArray *)arg2 completion:(id /* block */)arg3;
