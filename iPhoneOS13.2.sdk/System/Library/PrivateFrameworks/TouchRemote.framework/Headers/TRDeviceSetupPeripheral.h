...
@property(copy) id /* block */ pendingSendDataHandler; // @synthesize pendingSendDataHandler=_pendingSendDataHandler;
...
- (_Bool)_sendAction:(id)arg1 sendDataHandler:(id /* block */)arg2 error:(id *)arg3;
