...
@property(copy, nonatomic) id /* block */ activationStageStartedHandler; // @synthesize activationStageStartedHandler=_activationStageStartedHandler;
@property(copy, nonatomic) id /* block */ networkStageStartedHandler; // @synthesize networkStageStartedHandler=_networkStageStartedHandler;
@property(copy, nonatomic) id /* block */ configurationStageStartedHandler; // @synthesize configurationStageStartedHandler=_configurationStageStartedHandler;
