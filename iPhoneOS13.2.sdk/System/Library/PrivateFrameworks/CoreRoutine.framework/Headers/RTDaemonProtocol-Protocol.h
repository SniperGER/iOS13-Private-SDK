...
- (void)userInteractionWithPredictedLocationOfInterest:(RTPredictedLocationOfInterest *)arg1 interaction:(NSUInteger)arg2 feedback:(NSString *)arg3 geoMapItem:(GEOMapItemStorage *)arg4 reply:(void (^)(NSError *))arg5;
...
- (void)fetchMonitoredScenarioTriggerTypesWithReply:(void (^)(NSUInteger, NSError *))arg1;
- (void)stopMonitoringScenarioTriggerOfType:(NSUInteger)arg1 reply:(void (^)(NSError *))arg2;
- (void)startMonitoringScenarioTriggerOfType:(NSUInteger)arg1 reply:(void (^)(NSError *))arg2;
