...
- (void)userInteractionWithPredictedLocationOfInterest:(id)arg1 interaction:(NSUInteger)arg2 feedback:(id)arg3 geoMapItem:(id)arg4 handler:(CDUnknownBlockType)arg5;
...
- (void)startMonitoringScenarioTriggerOfType:(NSUInteger)arg1 withHandler:(CDUnknownBlockType)arg2;
