...
- (void)_exportVideoToURLFull:(id)arg1 composition:(id)arg2 options:(id)arg3 metadata:(id)arg4 progress:(id)arg5 completion:(id /* block */)arg6;
- (void)_exportVideoToURL:(id)arg1 composition:(id)arg2 options:(id)arg3 metadata:(id)arg4 progress:(id)arg5 completion:(id /* block */)arg6;
...
- (void)_prepareToExportVideo:(id)arg1 options:(id)arg2 completion:(id /* block */)arg3;
...
- (id)exportComposition:(id)arg1 toPrimaryURL:(id)arg2 videoComplementURL:(id)arg3 videoPosterFrameURL:(id)arg4 completionQueue:(id)arg5 completion:(id /* block */)arg6;
