...
- (void )bytes;
- (void)dealloc;
- (id)initWithData:(id)arg1 width:(NSUInteger)arg2 height:(NSUInteger)arg3 bytesPerRow:(long long)arg4 bytesPerComponent:(NSUInteger)arg5 format:(int)arg6 colorspace:(CGColorSpaceRef)arg7;
- (id)initWithBytes:(void )arg1 width:(NSUInteger)arg2 height:(NSUInteger)arg3 bytesPerRow:(long long)arg4 bytesPerComponent:(NSUInteger)arg5 format:(int)arg6 colorspace:(CGColorSpaceRef)arg7;
