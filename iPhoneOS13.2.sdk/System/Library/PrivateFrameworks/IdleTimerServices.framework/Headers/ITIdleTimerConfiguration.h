...
@property(copy, nonatomic, getter=_idleEventHandlerBlock, setter=_setIdleEventHandlerBlock:) id /* block */ idleEventHandlerBlock; // @synthesize idleEventHandlerBlock=_idleEventHandlerBlock;
