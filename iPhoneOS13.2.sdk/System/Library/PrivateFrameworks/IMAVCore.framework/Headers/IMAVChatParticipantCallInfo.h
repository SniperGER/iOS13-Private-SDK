...
@interface IMAVChatParticipantCallInfo : NSObject
{
    ...
    BOOL _isVideoPaused;
    BOOL _isReinitiate;
    NSUInteger _localConnectionType;
    NSUInteger _remoteConnectionType;
...
@property(nonatomic) NSUInteger remoteConnectionType; // @synthesize remoteConnectionType=_remoteConnectionType;
@property(nonatomic) NSUInteger localConnectionType; // @synthesize localConnectionType=_localConnectionType;
