...
@property(nonatomic, setter=_setRemoteLandscapeContentRect:) CGRect _remoteLandscapeContentRect; // @synthesize _remoteLandscapeContentRect;
@property(nonatomic, setter=_setRemotePortraitContentRect:) CGRect _remotePortraitContentRect; // @synthesize _remotePortraitContentRect;
@property(nonatomic, setter=_setRemotePIPLandscapeOrientation:) CGSize _remotePIPLandscapeOrientation; // @synthesize _remotePIPLandscapeOrientation;
@property(nonatomic, setter=_setRemotePIPPortraitOrientation:) CGSize _remotePIPPortraitOrientation; // @synthesize _remotePIPPortraitOrientation;
...
@property(nonatomic, setter=_setRemoteLandscapeOrientation:) CGSize _remoteLandscapeOrientation; // @synthesize _remoteLandscapeOrientation;
@property(nonatomic, setter=_setRemotePortraitOrientation:) CGSize _remotePortraitOrientation; // @synthesize _remotePortraitOrientation;
...
- (CGSize)aspectRatioForCameraOrientation:(unsigned int)arg1 cameraType:(unsigned int)arg2;
- (CGRect)contentRectForCameraOrientation:(unsigned int)arg1 cameraType:(unsigned int)arg2;
