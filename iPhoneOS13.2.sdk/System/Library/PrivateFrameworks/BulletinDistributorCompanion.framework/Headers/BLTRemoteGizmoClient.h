...
@class BLTBulletinSendQueuePassthrough, BLTGizmoLegacyMap, NSMutableDictionary;
...
- (void)_pingPairedDeviceWithRetry:(NSUInteger)arg1;
- (void)_pingPairedDevice;
- (void)setLastKnownConnectionStatus:(NSUInteger)arg1;
...
- (void)cancelBulletinWithPublisherMatchID:(id)arg1 universalSectionID:(id)arg2 feed:(NSUInteger)arg3 withTimeout:(id)arg4;
- (void)cancelBulletinWithPublisherMatchID:(id)arg1 universalSectionID:(id)arg2 feed:(NSUInteger)arg3 transmissionDate:(id)arg4 receptionDate:(id)arg5;
- (void)addBulletinSummary:(id)arg1;
- (void)addBulletin:(id)arg1 playLightsAndSirens:(BOOL)arg2 updateType:(NSUInteger)arg3 withTimeout:(id)arg4 completion:(CDUnknownBlockType)arg5;
- (void)addBulletin:(id)arg1 playLightsAndSirens:(BOOL)arg2 updateType:(NSUInteger)arg3 transmissionDate:(id)arg4 receptionDate:(id)arg5;
