...
- (void)sendSectionInfosWithSectionIDs:(id)arg1 completion:(id /* block */)arg2 spoolToFile:(_Bool)arg3;
- (id)_overriddenSectionInfoForSectionID:(id)arg1;
- (void)sendOverrideOnly:(id)arg1 sectionID:(id)arg2 spoolToFile:(_Bool)arg3;
- (void)_updateAllBBSectionsWithCompletion:(id /* block */)arg1 withProgress:(id /* block */)arg2 spoolToFile:(_Bool)arg3;
- (id)_filteredAlertingSectionIDs:(id)arg1;
- (void)_sendSectionSubtypeParameterIcons:(id)arg1 sectionID:(id)arg2 waitForAcknowledgement:(_Bool)arg3 spoolToFile:(_Bool)arg4 andCompletion:(id /* block */)arg5;
