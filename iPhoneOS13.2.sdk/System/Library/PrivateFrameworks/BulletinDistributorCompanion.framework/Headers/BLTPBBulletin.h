...
+ (void)_addAttachmentsFromBBBulletin:(id)arg1 toBLTPBBulletin:(id)arg2 observer:(id)arg3 attachOption:(NSUInteger)arg4 completion:(CDUnknownBlockType)arg5;
+ (void)_attachmentFromBBAttachmentMetadata:(id)arg1 bulletin:(id)arg2 observer:(id)arg3 fileOption:(NSUInteger)arg4 attachNoData:(BOOL)arg5 completion:(CDUnknownBlockType)arg6;
+ (void)bulletinWithBBBulletin:(id)arg1 sockPuppetAppBundleID:(id)arg2 observer:(id)arg3 feed:(NSUInteger)arg4 teamID:(id)arg5 universalSectionID:(id)arg6 shouldUseExpirationDate:(BOOL)arg7 replyToken:(id)arg8 gizmoLegacyPublisherBulletinID:(id)arg9 gizmoLegacyCategoryID:(id)arg10 gizmoSectionID:(id)arg11 gizmoSectionSubtype:(id)arg12 useUserInfoForContext:(BOOL)arg13 removeSubtitleForOlderWatches:(BOOL)arg14 attachOption:(NSUInteger)arg15 completion:(CDUnknownBlockType)arg16;
