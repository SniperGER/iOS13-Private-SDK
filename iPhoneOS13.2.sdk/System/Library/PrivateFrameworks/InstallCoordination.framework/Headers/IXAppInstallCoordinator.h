...
+ (void)setRemovability:(NSUInteger)arg1 forAppWithBundleID:(id)arg2 completion:(CDUnknownBlockType)arg3;
...
+ (void)cancelCoordinatorsForAppsWithBundleIDs:(id)arg1 withReason:(id)arg2 client:(NSUInteger)arg3 completion:(CDUnknownBlockType)arg4;
+ (BOOL)cancelCoordinatorsForAppsWithBundleIDs:(id)arg1 withReason:(id)arg2 client:(NSUInteger)arg3 error:(id )arg4;
+ (void)cancelCoordinatorForAppWithBundleID:(id)arg1 withReason:(id)arg2 client:(NSUInteger)arg3 completion:(CDUnknownBlockType)arg4;
+ (BOOL)cancelCoordinatorForAppWithBundleID:(id)arg1 withReason:(id)arg2 client:(NSUInteger)arg3 error:(id )arg4;
+ (BOOL)_synchronouslyEnumerateCoordinatorsForIntent:(NSUInteger)arg1 error:(id )arg2 usingBlock:(CDUnknownBlockType)arg3;
+ (void)_asynchronouslyEnumerateCoordinatorsForIntent:(NSUInteger)arg1 usingBlock:(CDUnknownBlockType)arg2;
...
+ (void)demoteAppToPlaceholderWithBundleID:(id)arg1 forReason:(NSUInteger)arg2 waitForDeletion:(BOOL)arg3 completion:(CDUnknownBlockType)arg4;
...
+ (void)_demoteAppToPlaceholderWithBundleID:(id)arg1 forReason:(NSUInteger)arg2 waitForDeletion:(BOOL)arg3 completion:(CDUnknownBlockType)arg4;
