...
+ (void)uninstallAppWithBundleID:(id)arg1 requestUserConfirmation:(_Bool)arg2 waitForDeletion:(_Bool)arg3 completion:(id /* block */)arg4;
+ (void)uninstallAppWithBundleID:(id)arg1 requestUserConfirmation:(_Bool)arg2 completion:(id /* block */)arg3;
...
+ (_Bool)_synchronouslyEnumerateCoordinatorsForIntent:(unsigned long long)arg1 error:(id *)arg2 usingBlock:(id /* block */)arg3;
...
+ (_Bool)enumerateCoordinatorsWithError:(id *)arg1 usingBlock:(id /* block */)arg2;
+ (_Bool)enumerateCoordinatorsWithBlock:(id /* block */)arg1 error:(id *)arg2;
...
+ (void)installApplication:(id)arg1 consumeSource:(_Bool)arg2 options:(id)arg3 completion:(id /* block */)arg4;
+ (void)_beginInstallForURL:(id)arg1 consumeSource:(_Bool)arg2 options:(id)arg3 completion:(id /* block */)arg4;
+ (void)demoteAppToPlaceholderWithBundleID:(id)arg1 forReason:(unsigned long long)arg2 waitForDeletion:(_Bool)arg3 completion:(id /* block */)arg4;
...
+ (void)_demoteAppToPlaceholderWithBundleID:(id)arg1 forReason:(unsigned long long)arg2 waitForDeletion:(_Bool)arg3 completion:(id /* block */)arg4;
