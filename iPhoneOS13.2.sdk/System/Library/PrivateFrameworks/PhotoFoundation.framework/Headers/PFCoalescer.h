...
@property(copy) id /* block */ action; // @synthesize action=_action;
@property(copy) id /* block */ snapshotAndDrainHandler; // @synthesize snapshotAndDrainHandler=_snapshotAndDrainHandler;
