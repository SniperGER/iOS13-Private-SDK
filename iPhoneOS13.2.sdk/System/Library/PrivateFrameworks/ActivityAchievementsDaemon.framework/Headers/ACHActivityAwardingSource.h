...
@interface ACHActivityAwardingSource : NSObject <HDHealthDaemonReadyObserver, HDCurrentActivitySummaryHelperObserver, ACHDataStorePropertyProviding, ACHEarnedInstanceAwarding, ACHAchievementProgressProviding>
{
    ...
    id /* CDUnknownBlockType */ _incrementalUpdateCompletionHandler;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ incrementalUpdateCompletionHandler; // @synthesize incrementalUpdateCompletionHandler=_incrementalUpdateCompletionHandler;
...
- (id)_queue_evaluateTriggers:(NSUInteger)arg1 activitySummary:(id)arg2 templates:(id)arg3 shouldLog:(BOOL)arg4;
- (NSUInteger)_queue_triggersWithChangedSummaryFields:(NSUInteger)arg1 dataProvider:(id)arg2;
- (void)_runIncrementallyForChangedSummaryFields:(NSUInteger)arg1;
