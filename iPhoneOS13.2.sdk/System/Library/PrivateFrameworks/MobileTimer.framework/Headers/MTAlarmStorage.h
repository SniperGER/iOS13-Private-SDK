...
- (void)_queue_dismissAlarmWithIdentifier:(id)arg1 dismissDate:(id)arg2 dismissAction:(NSUInteger)arg3 withCompletion:(CDUnknownBlockType)arg4 source:(id)arg5;
- (void)_queue_dismissMutableAlarm:(id)arg1 dismissDate:(id)arg2 dismissAction:(NSUInteger)arg3;
- (void)_queue_snoozeAlarmWithIdentifier:(id)arg1 snoozeDate:(id)arg2 snoozeAction:(NSUInteger)arg3 withCompletion:(CDUnknownBlockType)arg4 source:(id)arg5;
...
- (void)dismissAlarmWithIdentifier:(id)arg1 dismissDate:(id)arg2 dismissAction:(NSUInteger)arg3 withCompletion:(CDUnknownBlockType)arg4 source:(id)arg5;
- (void)dismissAlarmWithIdentifier:(id)arg1 dismissAction:(NSUInteger)arg2 withCompletion:(CDUnknownBlockType)arg3 source:(id)arg4;
- (void)snoozeAlarmWithIdentifier:(id)arg1 snoozeDate:(id)arg2 snoozeAction:(NSUInteger)arg3 withCompletion:(CDUnknownBlockType)arg4 source:(id)arg5;
- (void)snoozeAlarmWithIdentifier:(id)arg1 snoozeAction:(NSUInteger)arg2 withCompletion:(CDUnknownBlockType)arg3 source:(id)arg4;
