...
+ (id)_timerTimeForState:(NSUInteger)arg1 remainingTime:(double)arg2 currentDateProvider:(CDUnknownBlockType)arg3;
+ (BOOL)supportsSecureCoding;
+ (BOOL)stateChangeIsAllowableFromState:(NSUInteger)arg1 toState:(NSUInteger)arg2;
...
- (id)timerByUpdatingWithState:(NSUInteger)arg1;
...
- (id)initWithState:(NSUInteger)arg1 duration:(double)arg2 currentDateProvider:(CDUnknownBlockType)arg3;
- (id)initWithState:(NSUInteger)arg1 duration:(double)arg2;
