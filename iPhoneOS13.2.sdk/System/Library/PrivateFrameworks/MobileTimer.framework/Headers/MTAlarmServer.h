...
- (void)dismissAlarmWithIdentifier:(id)arg1 dismissAction:(NSUInteger)arg2 withCompletion:(CDUnknownBlockType)arg3;
- (void)snoozeAlarmWithIdentifier:(id)arg1 snoozeAction:(NSUInteger)arg2 withCompletion:(CDUnknownBlockType)arg3;
