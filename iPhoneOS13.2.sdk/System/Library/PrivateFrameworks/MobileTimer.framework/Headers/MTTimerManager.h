...
- (BOOL)_updateCurrentTimerWithStateSync:(NSUInteger)arg1;
...
- (id)stopCurrentTimer;
- (id)_updateCurrentTimerWithState:(NSUInteger)arg1;
- (id)currentTimer;
...
- (id)addTimer:(id)arg1;
- (id)nextTimersForDate:(id)arg1 maxCount:(NSUInteger)arg2;
- (id)timersSync;
- (id)nextTimer;
- (id)timers;
