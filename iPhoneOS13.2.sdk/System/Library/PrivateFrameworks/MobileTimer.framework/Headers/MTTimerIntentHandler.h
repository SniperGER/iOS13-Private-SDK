...
- (void)_genericallyResolveTargetTimer:(id)arg1 multiple:(_Bool)arg2 allowedTimerStatesForFollowup:(id)arg3 completion:(id /* block */)arg4;
- (void)_matchTimersFromIntentsTimer:(id)arg1 excludeStoppedTimers:(_Bool)arg2 completion:(id /* block */)arg3;
- (id)_timerManager;
