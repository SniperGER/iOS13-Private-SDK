...
+ (BOOL)_installInternalResourcesForExistingAsset:(id)arg1 assumeNoExistingResources:(BOOL)arg2 referencedResourceURLs:(id)arg3 includeLegacyCloudResources:(BOOL)arg4 outResourcesStoreCount:(NSUInteger )arg5 error:(id )arg6;
...
+ (BOOL)recoverSupplementalResourcesForAsset:(id)arg1 usingSidecarFinder:(id)arg2 outResourcesStoreCount:(NSUInteger )arg3 error:(id )arg4;
...
+ (NSUInteger)_getURLDataLength:(id)arg1;
...
+ (unsigned int)resourceVersionFromCPLType:(NSUInteger)arg1 fromAdjustedSet:(BOOL)arg2;
+ (BOOL)isValidCPLResourceTypeForPersistence:(NSUInteger)arg1;
+ (id)_validatedExternalResourceFromExternalResourceCloudAttributes:(id)arg1 cplType:(NSUInteger)arg2 assetType:(short)arg3 uti:(id)arg4 originalOrientation:(unsigned int)arg5 orientation:(unsigned int)arg6 originalColorSpace:(id)arg7 resourceWidth:(NSUInteger)arg8 resourceHeight:(NSUInteger)arg9 assetWidth:(NSUInteger)arg10 assetHeight:(NSUInteger)arg11 resourceFingerprint:(id)arg12 resourceSize:(NSUInteger)arg13 isAvailable:(BOOL)arg14 fromAdjustedSet:(BOOL)arg15 resourceURL:(id)arg16 cloudMaster:(id)arg17 isForMigration:(BOOL)arg18 context:(id)arg19;
...
+ (unsigned int)resourceTypeFromCPLType:(NSUInteger)arg1 assetType:(short)arg2;
+ (void)_recipeAndDerivativeStateFromCPLResourceType:(NSUInteger)arg1 fromAdjustedSet:(BOOL)arg2 assetType:(short)arg3 recipeID:(unsigned int )arg4;
+ (BOOL)_isPenultimateVersionFromCPLType:(NSUInteger)arg1;
+ (unsigned int)recipeIDFromCPLResourceType:(NSUInteger)arg1 assetType:(short)arg2 fromAdjustedSet:(BOOL)arg3;
+ (NSUInteger)nonDerivativeCPLTypeFromResourceType:(unsigned int)arg1 version:(unsigned int)arg2 uniformTypeIdentifier:(id)arg3;
+ (NSUInteger)derivativeCPLTypeFromRecipeID:(unsigned int)arg1 version:(unsigned int)arg2;
