...
- (void)_getWarningTitle:(id )arg1 message:(id )arg2 buttonTitle:(id )arg3 forItemSuffix:(id)arg4 count:(NSUInteger)arg5 operation:(long long)arg6 clientName:(id)arg7;
