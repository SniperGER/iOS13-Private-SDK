...
- (void)cancel;
- (void)main;
- (id)initWithRequestID:(int)arg1 library:(id)arg2 queue:(id)arg3 cloudResourceType:(NSUInteger)arg4 managedObjectID:(id)arg5 progressHandler:(CDUnknownBlockType)arg6;
