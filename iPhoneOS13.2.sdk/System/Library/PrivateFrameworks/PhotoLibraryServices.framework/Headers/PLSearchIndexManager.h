...
@interface PLSearchIndexManager : NSObject
{
    ...
    BOOL __indexing;
    id /* CDUnknownBlockType */ __inqAfterIndexingDidIterate;
...
@property(copy, nonatomic, setter=_setInqAfterIndexingDidIterate:) id /* CDUnknownBlockType */ _inqAfterIndexingDidIterate; // @synthesize _inqAfterIndexingDidIterate=__inqAfterIndexingDidIterate;
...
- (NSUInteger)_inqEnqueuedUUIDsCountForceLoad:(BOOL)arg1;
