...
- (id)updatedObjects;
- (id)insertedObjects;
- (void)performDataTransaction:(id /* block */)arg1 synchronously:(_Bool)arg2 priority:(long long)arg3 completionHandler:(id /* block */)arg4;
- (void)performDataTransaction:(id /* block */)arg1 synchronously:(_Bool)arg2 completionHandler:(id /* block */)arg3;
- (void)performBlock:(id /* block */)arg1 synchronously:(_Bool)arg2 priority:(long long)arg3 completionHandler:(id /* block */)arg4;
- (void)performBlock:(id /* block */)arg1 synchronously:(_Bool)arg2 completionHandler:(id /* block */)arg3;
