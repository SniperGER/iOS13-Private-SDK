...
- (void)fetchNextAssetUUIDs:(BOOL)arg1 collectionResults:(BOOL)arg2 assetCountLimit:(NSUInteger)arg3 collectionCountLimit:(NSUInteger)arg4 completionHandler:(CDUnknownBlockType)arg5;
- (void)fetchNextAssetUUIDs:(BOOL)arg1 collectionResults:(BOOL)arg2 count:(NSUInteger)arg3 completionHandler:(CDUnknownBlockType)arg4;
- (void)fetchNextAssetUUIDs:(NSUInteger)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (id)_prepareForFetchWithAssetCountLimit:(NSUInteger)arg1 collectionCountLimit:(NSUInteger)arg2 outAssetRange:(NSRange * )arg3 outCollectionRange:(NSRange * )arg4 outFetchOwningContentString:(BOOL )arg5;
