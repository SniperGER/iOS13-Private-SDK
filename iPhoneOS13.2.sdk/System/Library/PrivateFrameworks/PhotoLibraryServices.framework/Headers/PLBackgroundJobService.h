...
@class NSDictionary, PFCoalescer, PLBackgroundJobCameraWatcher, PLBackgroundJobLibraryCoordinator, PLForegroundMonitor;
...
+ (id)_activityIdentifierForPriority:(NSUInteger)arg1;
+ (id)_criteriaForActivityPriority:(NSUInteger)arg1;
...
- (void)libraryCoordinatorFinishedJobsOnSubmittedBundle:(id)arg1 priority:(NSUInteger)arg2;
- (id)_getBundleRecordsFromProcessingSetForAllPriorites;
- (id)_getBundleRecordsFromProcessingSetForPriority:(NSUInteger)arg1;
- (void)_removeAllBundlesFromProcessingSet;
- (void)_removeBundleRecordFromProcessingSet:(id)arg1 priority:(NSUInteger)arg2;
- (void)_appendBundleRecordsToProcessingSet:(id)arg1 priority:(NSUInteger)arg2;
...
- (void)_startRunningBackgroundJobsWithPriority:(NSUInteger)arg1;
...
- (void)_registerActivityWithPriority:(NSUInteger)arg1;
...
- (void)_verifyStateTransitionFromState:(NSUInteger)arg1 toState:(NSUInteger)arg2;
- (void)_setServiceStateAlreadyLocked:(NSUInteger)arg1;
- (void)_setServiceState:(NSUInteger)arg1;
