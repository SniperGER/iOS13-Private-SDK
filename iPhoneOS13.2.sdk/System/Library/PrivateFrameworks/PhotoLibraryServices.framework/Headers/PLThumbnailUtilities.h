...
// + (BOOL)_performSWDownscaleTo5551OnSourceImage:(CGImageRef)arg1 withSourceDimensions:(CDStruct_1ef3fb1f)arg2 withSpecification:(id)arg3 destinationData:(id)arg4 imageRect:(CGRect )arg5 bytesPerRow:(int )arg6;
