...
- (BOOL)enumerateAssetsWithCount:(NSUInteger)arg1 fetchOffset:(NSUInteger)arg2 usingBlock:(CDUnknownBlockType)arg3;
- (void)enumerateDictionariesWithCount:(NSUInteger)arg1 fetchOffset:(NSUInteger)arg2 usingBlock:(CDUnknownBlockType)arg3;
