...
+ (BOOL)enumerateObjectsWithIncrementalSaveDefaultBatchSizeFetchRequest:(id)arg1 managedObjectContext:(id)arg2 count:(NSUInteger )arg3 error:(id )arg4 block:(CDUnknownBlockType)arg5;
...
- (BOOL)_saveChangesToPhotoIrisInStore:(id)arg1 matchingPredicate:(id)arg2 countChanged:(NSUInteger )arg3 error:(id )arg4 changeBlock:(CDUnknownBlockType)arg5;
...
- (BOOL)_performChangesOnBatchFetchedObjects:(id)arg1 inMOC:(id)arg2 batchSize:(NSUInteger)arg3 objectHandler:(CDUnknownBlockType)arg4 error:(id )arg5;
...
- (id)managedObjectContextForMigrationInStore:(id)arg1 name:(const char )arg2 concurrencyType:(NSUInteger)arg3;
- (id)managedObjectContextForMigrationWithName:(const char )arg1 persistentStoreCoordinator:(id)arg2 concurrencyType:(NSUInteger)arg3;
...
- (BOOL)faceQualityResetRequiredForPreviousStoreVersion:(NSUInteger)arg1;
...
- (long long)faceMigrationResetLevelRequiredForPreviousStoreVersion:(NSUInteger)arg1;
- (BOOL)graphPersonResetRequiredForPreviousStoreVersion:(NSUInteger)arg1;
- (BOOL)sceneStepRequiredForPreviousStoreVersion:(NSUInteger)arg1;
