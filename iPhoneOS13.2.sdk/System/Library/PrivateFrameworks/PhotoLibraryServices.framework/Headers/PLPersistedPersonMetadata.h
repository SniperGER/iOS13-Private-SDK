...
+ (void)performPostImportMigrationFromVersion:(NSUInteger)arg1 fromDataInManagedObjectContext:(id)arg2;
...
+ (id)_fetchFacesWithPredicate:(id)arg1 resultType:(NSUInteger)arg2 managedObjectContext:(id)arg3 error:(id )arg4;
