...
@class CLLocation, NSArray, NSData, NSDate, NSDictionary, NSError, NSNumber, NSObject, NSSet, NSString, NSURL, PLFaceCrop, PLManagedAssetID, PLRevGeoLocationInfo, PLRevGeoPlaceAnnotation;
...
+ (NSUInteger)localResourceOptionFromResourceType:(NSUInteger)arg1 useMaster:(BOOL)arg2;
...
+ (id)eventInfoForPTP;
+ (id)newImagePropertiesFromImageSource:(CGImageSource )arg1;
...
+ (NSUInteger)countUsedAssetsWithKind:(short)arg1 excludeTrashed:(BOOL)arg2 excludeInvisible:(BOOL)arg3 excludeCloudShared:(BOOL)arg4 excludePhotoStream:(BOOL)arg5 inManagedObjectContext:(id)arg6;
...
+ (NSUInteger)countForAssetsWithUUIDs:(id)arg1 includePendingChanges:(BOOL)arg2 inManagedObjectContext:(id)arg3 error:(id )arg4;
+ (id)assetsWithUUIDs:(id)arg1 options:(NSUInteger)arg2 inManagedObjectContext:(id)arg3;
+ (id)assetsWithUUIDs:(id)arg1 options:(NSUInteger)arg2 inLibrary:(id)arg3;
...
+ (void)createThumbnailImage:(NSObject )arg1 previewImage:(NSObject )arg2 withToBeReleasedImageSource:(CGImageSource )arg3;
...
+ (id)assetsToRetryInLibrary:(id)arg1 limit:(NSUInteger)arg2;
+ (id)_notPushedAssetsToUploadInitiallyInManagedObjectContext:(id)arg1 withSavedAssetTypePredicate:(id)arg2 shouldSort:(BOOL)arg3 limit:(NSUInteger)arg4;
+ (id)assetsToUploadInitiallyInManagedObjectContext:(id)arg1 limit:(NSUInteger)arg2;
+ (id)_syncablePredicate;
+ (NSUInteger)totalSizeOfUnpushedOriginalsInPhotoLibrary:(id)arg1 outMasterList:(id)arg2;
...
+ (id)_assetsWithCloudAssetUUIDs:(id)arg1 inMomentShare:(id)arg2 inLibrary:(id)arg3 fetchLimit:(NSUInteger)arg4;
...
+ (void)countOfAssetsWithRequiredResourcesNotLocallyAvailableInLibrary:(id)arg1 outCount:(NSUInteger )arg2 photoCount:(NSUInteger )arg3 videoCount:(NSUInteger )arg4;
+ (NSUInteger)CPLAssetHDRTypeFromPLPhotoHDRType:(short)arg1;
...
//  (NSObject )newFullScreenImage:(const struct __CFDictionary )arg1;
- (NSObject )indexSheetImage;
//  (NSObject )imageWithFormat:(unsigned short)arg1 outImageProperties:(const struct __CFDictionary )arg2;
...
- (void)_generateDeferredAdjustmentWithImageConversionClient:(id)arg1 videoConversionClient:(id)arg2 retryNumber:(NSUInteger)arg3 completion:(CDUnknownBlockType)arg4;
...
- (void)_asyncGenerateRenderImageFileWithSize:(CGSize)arg1 formatIdentifier:(id)arg2 formatVersion:(id)arg3 adjustmentDataBlob:(id)arg4 originalImageFilePath:(id)arg5 originalImageEXIFOrientation:(long long)arg6 renderedImageFilePath:(id)arg7 completionHandler:(CDUnknownBlockType)arg8;
...
- (void)getFileURL:(id )arg1 originalFilename:(id )arg2 uti:(id )arg3 fileSize:(NSUInteger )arg4 forSidecarMatchingUTI:(id)arg5 requireExactMatch:(BOOL)arg6;
...
- (BOOL)isResourceAvailableForResourceType:(NSUInteger)arg1;
- (BOOL)_isResourceAvailableForResourceType:(NSUInteger)arg1 outResource:(id )arg2;
- (BOOL)_isAdjustedResourceAvailableForResourceType:(NSUInteger)arg1;
- (BOOL)_isAdjustedResourceAvailableForResourceType:(NSUInteger)arg1 outResource:(id )arg2;
- (BOOL)_isMasterResourceAvailableForResourceType:(NSUInteger)arg1;
- (BOOL)_isMasterResourceAvailableForResourceType:(NSUInteger)arg1 outResource:(id )arg2;
- (NSUInteger)CPLResourceTypeFromVideoFormat:(unsigned short)arg1;
...
- (void)setFaceRegionsFromImageMetadata:(CGImageMetadata )arg1;
- (void)setFaceRegionsFromCGImageProperties:(id)arg1;
- (void)generateAndUpdateThumbnailsWithPreviewImage:(NSObject )arg1 thumbnailImage:(NSObject )arg2 fromImageSource:(CGImageSource )arg3 imageData:(id)arg4 updateExistingLargePreview:(BOOL)arg5 forceSRGBConversion:(BOOL)arg6 saveCameraPreviewWellImage:(BOOL)arg7;
- (void)generateAndUpdateThumbnailsWithPreviewImage:(NSObject )arg1 thumbnailImage:(NSObject )arg2 fromImageSource:(CGImageSource )arg3 imageData:(id)arg4 updateExistingLargePreview:(BOOL)arg5 forceSRGBConversion:(BOOL)arg6;
...
- (BOOL)setImageInfoFromImageSource:(CGImageSource )arg1 overwriteOriginalProperties:(BOOL)arg2 metadata:(id)arg3;
...
- (id)imageProperties;
- (BOOL)setAttributesFromMainFileURL:(id)arg1 savedAssetType:(short)arg2 isPlaceholder:(BOOL)arg3 placeholderFileURL:(id)arg4 imageSource:(CGImageSource )arg5 imageData:(id )arg6;
...
- (BOOL)setTrashedState:(short)arg1 forResourceType:(NSUInteger)arg2;
...
// - (BOOL)becomePhotoIrisWithMediaGroupUUID:(id)arg1 videoURL:(id)arg2 spatialOverCaptureURL:(id)arg3 videoDuration:(CDStruct_198678f7)arg4 stillDisplayTime:(CDStruct_198678f7)arg5 options:(NSUInteger)arg6;
// - (BOOL)becomePhotoIrisWithMediaGroupUUID:(id)arg1 videoURL:(id)arg2 videoDuration:(CDStruct_198678f7)arg3 stillDisplayTime:(CDStruct_198678f7)arg4 options:(NSUInteger)arg5;
...
- (void)_appendPublicEventStrings:(id)arg1 toAsset:(id)arg2 forSearchIndexCategory:(NSUInteger)arg3;
...
- (void)generateThumbnailsWithImageSource:(CGImageSource )arg1 imageData:(id)arg2 updateExistingLargePreview:(BOOL)arg3 allowMediumPreview:(BOOL)arg4 forceSRGBConversion:(BOOL)arg5 outSmallThumbnail:(NSObject )arg6 outLargeThumbnail:(NSObject )arg7;
...
- (id)legacyCloudResourceForResourceType:(NSUInteger)arg1;
...
- (id)adjustedPathForCPLResourceType:(NSUInteger)arg1;
- (id)nonAdjustedPathForCPLResourceType:(NSUInteger)arg1;
- (id)pathForCPLResourceType:(NSUInteger)arg1 adjusted:(BOOL)arg2;
...
- (BOOL)_isResourceType:(NSUInteger)arg1 inResources:(id)arg2;
- (void)markAsUnavailableCloudResourceOfType:(NSUInteger)arg1;
- (long long)_plAdjustmentBaseVersionFromCPLAdjustmentSourceType:(NSUInteger)arg1;
...
- (id)localResourcePathForMasterResourceWithCPLType:(NSUInteger)arg1 andUTI:(id)arg2;
- (id)localResourcePathForMasterResource:(id)arg1;
- (CGSize)_targetSizeForInputSize:(CGSize)arg1 maxPixelSize:(NSUInteger)arg2;
- (CGSize)targetSizeForInputSize:(CGSize)arg1 maxPixelSize:(NSUInteger)arg2;
- (id)_cplRelationsForAssetInLibrary:(id)arg1;
- (void)_updateAssetSubtypeForCPLAssetChange:(id)arg1;
- (NSUInteger)cplAssetSubtypeFromPLAssetSubtype:(short)arg1;
- (void)_updateAssetSubtypeFromCPLAssetSubtype:(NSUInteger)arg1;
- (int)_avalancheTypeFromCplBurstFlags:(NSUInteger)arg1;
- (NSUInteger)cplBurstFlagsFromPLAvalancheType:(int)arg1;
...
- (id)cplAssetChangeWithMasterScopedIdentifier:(id)arg1 withChangeType:(NSUInteger)arg2 shouldGenerateDerivatives:(BOOL)arg3 inLibrary:(id)arg4;
- (id)cplFullRecord;
...
- (void)_applyResourceChangeToCPLAsset:(id)arg1 forChangeType:(NSUInteger)arg2 shouldGenerateDerivatives:(BOOL)arg3 inLibrary:(id)arg4;
...
- (id)_createVideoResourceFromVideoURL:(id)arg1 withResourceType:(NSUInteger)arg2 scopedIdentifier:(id)arg3 applyVideoAdjustments:(BOOL)arg4 forMaster:(BOOL)arg5 forPhotoIris:(BOOL)arg6;
- (id)_createCPLResourceFromResourcePath:(id)arg1 withResourceType:(NSUInteger)arg2 uniformTypeIdentifier:(id)arg3 scopedIdentifier:(id)arg4;
- (id)_createImageResourceForResourceType:(NSUInteger)arg1 withPreviewImagePath:(id)arg2 scopedIdentifier:(id)arg3 forMaster:(BOOL)arg4;
- (void)_promptForNilScopeIdentifierRadar;
- (id)scopedIdentifier;
- (id)_generatePosterFrameForVideoAtURL:(id)arg1 withResourceType:(NSUInteger)arg2 scopedIdentifier:(id)arg3 forMaster:(BOOL)arg4;
...
- (void)setOriginalResourceChoice:(NSUInteger)arg1;
...
- (BOOL)addSidecarFileAtIndex:(NSUInteger)arg1 sidecarURL:(id)arg2 withFilename:(id)arg3 compressedSize:(id)arg4 captureDate:(id)arg5 modificationDate:(id)arg6 uniformTypeIdentifier:(id)arg7 pathManager:(id)arg8;
- (BOOL)addSidecarFileInfo:(id)arg1 pathManager:(id)arg2 atIndex:(NSUInteger)arg3;
...
- (NSUInteger)masterResourceTypeForAdjustedAssetResourceType:(NSUInteger)arg1 sourceAsset:(id)arg2 flattenLivePhoto:(BOOL)arg3;
...
- (id)rm_cplMasterResourceForResourceType:(NSUInteger)arg1;
- (id)rm_cplResourceForResourceType:(NSUInteger)arg1;
...
- (id)assetResourceForCPLType:(NSUInteger)arg1;
- (id)masterResourceForCPLType:(NSUInteger)arg1;
- (id)resourceForCPLType:(NSUInteger)arg1 version:(unsigned int)arg2;
