...
- (id)attemptReframeWithImageConversionClient:(id)arg1 videoConversionClient:(id)arg2 isOnDemand:(_Bool)arg3 completionHandler:(id /* block */)arg4;
- (void)synchronouslyGenerateFullsizeRenderImageIfNecessaryAtPath:(id)arg1 withCompletionHandler:(id /* block */)arg2;
- (void)_asyncGenerateRenderImageFileWithSize:(struct CGSize)arg1 formatIdentifier:(id)arg2 formatVersion:(id)arg3 adjustmentDataBlob:(id)arg4 originalImageFilePath:(id)arg5 originalImageEXIFOrientation:(long long)arg6 renderedImageFilePath:(id)arg7 completionHandler:(id /* block */)arg8;
...
- (_Bool)checkAllResourcesRequiredForCPLDisableWithReachableBlock:(id /* block */)arg1;
...
- (id)fetchResourceWithIdentity:(id)arg1 createIfNeeded:(_Bool)arg2 fetchConfigurationBlock:(id /* block */)arg3 error:(id *)arg4;
