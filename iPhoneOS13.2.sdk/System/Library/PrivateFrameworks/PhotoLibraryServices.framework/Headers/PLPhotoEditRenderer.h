...
- (void)applySourceChangesToCompositionController:(id)arg1 source:(id)arg2 withBlock:(id /* block */)arg3;
...
- (void)renderVideoWithTargetSize:(struct CGSize)arg1 contentMode:(long long)arg2 completion:(id /* block */)arg3;
- (void)renderImageWithTargetSize:(struct CGSize)arg1 contentMode:(long long)arg2 renderMode:(long long)arg3 renderTime:(CDStruct_198678f7)arg4 completion:(id /* block */)arg5;
- (void)renderImageWithTargetSize:(struct CGSize)arg1 contentMode:(long long)arg2 renderMode:(long long)arg3 completion:(id /* block */)arg4;
- (void)renderImageWithTargetSize:(struct CGSize)arg1 contentMode:(long long)arg2 completion:(id /* block */)arg3;
