...
- (void)renderVideoWithTargetSize:(CGSize)arg1 contentMode:(long long)arg2 completion:(CDUnknownBlockType)arg3;
// - (void)renderImageWithTargetSize:(CGSize)arg1 contentMode:(long long)arg2 renderMode:(long long)arg3 renderTime:(CDStruct_198678f7)arg4 completion:(CDUnknownBlockType)arg5;
- (void)renderImageWithTargetSize:(CGSize)arg1 contentMode:(long long)arg2 renderMode:(long long)arg3 completion:(CDUnknownBlockType)arg4;
- (void)renderImageWithTargetSize:(CGSize)arg1 contentMode:(long long)arg2 completion:(CDUnknownBlockType)arg3;
