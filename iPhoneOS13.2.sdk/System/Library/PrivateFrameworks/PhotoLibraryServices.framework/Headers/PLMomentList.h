...
- (void)_performMutation:(NSUInteger)arg1 withMoments:(id)arg2 forMomentListLevel:(short)arg3;
...
- (void)_performMomentChangesForKey:(id)arg1 mutation:(NSUInteger)arg2 primitiveMoments:(id)arg3 changedMoments:(id)arg4;
- (void)_performMomentChangesForKey:(id)arg1 mutation:(NSUInteger)arg2 primitiveMoments:(id)arg3 changedMoment:(id)arg4;
