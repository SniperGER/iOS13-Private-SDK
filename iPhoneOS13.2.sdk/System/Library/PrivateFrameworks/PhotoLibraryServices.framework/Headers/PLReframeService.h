...
- (id)enqueueReframeRequestForAssetUUID:(id)arg1 imageConversionClient:(id)arg2 videoConversionClient:(id)arg3 isOnDemand:(_Bool)arg4 completionHandler:(id /* block */)arg5;
- (id)photoLibrary;
