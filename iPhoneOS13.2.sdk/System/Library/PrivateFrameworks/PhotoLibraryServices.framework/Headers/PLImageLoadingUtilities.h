...
+ (void)imageForAsset:(id)arg1 withFormat:(unsigned short)arg2 allowPlaceholder:(_Bool)arg3 optimalSourcePixelSize:(struct CGSize)arg4 networkAccessAllowed:(_Bool)arg5 networkAccessForced:(_Bool)arg6 trackCPLDownload:(_Bool)arg7 isCanceledHandler:(id /* block */)arg8 completion:(id /* block */)arg9 sync:(_Bool)arg10;
+ (void)_assetsdImageForAsset:(id)arg1 withFormat:(id)arg2 allowPlaceholder:(_Bool)arg3 optimalSourcePixelSize:(struct CGSize)arg4 networkAccessAllowed:(_Bool)arg5 trackCPLDownload:(_Bool)arg6 sync:(_Bool)arg7 isCanceledHandler:(id /* block */)arg8 completion:(id /* block */)arg9;
