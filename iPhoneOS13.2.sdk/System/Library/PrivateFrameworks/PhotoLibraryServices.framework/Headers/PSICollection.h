...
@property(readonly) NSUInteger numberOfAssets; // @synthesize numberOfAssets=_numberOfAssets;
...
- (id)initWithUUID:(id)arg1 startDate:(id)arg2 endDate:(id)arg3 title:(id)arg4 subtitle:(id)arg5 keyAsset:(id)arg6 type:(NSUInteger)arg7 numberOfAssets:(NSUInteger)arg8 sortDate:(id)arg9;
