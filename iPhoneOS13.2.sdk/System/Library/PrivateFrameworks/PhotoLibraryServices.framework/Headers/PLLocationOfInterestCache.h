...
@interface PLLocationOfInterestCache : NSObject
{
    ...
    NSUInteger _numberOfLocationsOfInterestVisits;
    NSDate *_earliestVisitStartDate;
    PLLocationOfInterestVisit *_lastLocationOfInterestVisit;
    NSUInteger _numberOfLocationsOfInterestTransitions;
}

@property(readonly) NSUInteger numberOfLocationsOfInterestTransitions; // @synthesize numberOfLocationsOfInterestTransitions=_numberOfLocationsOfInterestTransitions;
...
@property(readonly) NSUInteger numberOfLocationsOfInterestVisits; // @synthesize numberOfLocationsOfInterestVisits=_numberOfLocationsOfInterestVisits;
