...
+ (id)stringFromStartDate:(id)arg1 endDate:(id)arg2 type:(NSUInteger)arg3 showLongMonthFormatIfNeeded:(BOOL)arg4;
+ (id)stringFromStartDate:(id)arg1 endDate:(id)arg2 type:(NSUInteger)arg3;
+ (id)_dateFormatForDateFormatterType:(NSUInteger)arg1 displayYear:(BOOL)arg2 displayLongMonth:(BOOL)arg3;
