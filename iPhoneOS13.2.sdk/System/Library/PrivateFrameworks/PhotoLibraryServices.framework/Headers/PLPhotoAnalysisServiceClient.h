...
- (id)faceClusteringInformation:(NSUInteger)arg1 error:(id )arg2;
...
- (void)requestSnapshotServiceForRelatedDebugInfoBetweenMomentForLocalIdentifier:(id)arg1 andRelatedResultsForLocalIdentifiers:(id)arg2 precision:(NSUInteger)arg3 relatedType:(NSUInteger)arg4 additionalSnapshotSummaryInfo:(id)arg5 reply:(CDUnknownBlockType)arg6;
- (void)requestSnapshotServiceForRelatedDebugInfoBetweenAssetForLocalIdentifier:(id)arg1 andRelatedResultsForLocalIdentifiers:(id)arg2 precision:(NSUInteger)arg3 relatedType:(NSUInteger)arg4 reply:(CDUnknownBlockType)arg5;
...
- (id)requestRelatedDebugInformationBetweenReferenceAssetCollectionForLocalIdentifier:(id)arg1 andRelatedAssetCollectionForLocalIdentifier:(id)arg2 options:(id)arg3 precision:(NSUInteger)arg4 relatedType:(NSUInteger)arg5 error:(id )arg6;
- (id)requestRelatedDebugInformationBetweenAssetForLocalIdentifier:(id)arg1 andRelatedAssetCollectionForLocalIdentifier:(id)arg2 options:(id)arg3 precision:(NSUInteger)arg4 relatedType:(NSUInteger)arg5 error:(id )arg6;
- (id)requestSearchableAssetUUIDsBySocialGroupForAssetCollectionUUIDs:(id)arg1 ofType:(NSUInteger)arg2 isFullAnalysis:(BOOL)arg3 withOptions:(id)arg4 error:(id )arg5;
- (id)requestAssetSearchKeywordsForAssetCollectionUUIDs:(id)arg1 ofType:(NSUInteger)arg2 withOptions:(id)arg3 error:(id )arg4;
- (id)requestSearchIndexKeywordsForAssetCollectionUUIDs:(id)arg1 ofType:(NSUInteger)arg2 withOptions:(id)arg3 error:(id )arg4;
...
- (id)requestCuratedAssetsForAssetCollectionWithLocalIdentifier:(id)arg1 duration:(NSUInteger)arg2 precision:(NSUInteger)arg3 options:(id)arg4 error:(id )arg5;
- (id)requestCuratedAssetForAssetCollectionWithLocalIdentifier:(id)arg1 referenceAssetLocalIdentifier:(id)arg2 precision:(NSUInteger)arg3 options:(id)arg4 error:(id )arg5;
