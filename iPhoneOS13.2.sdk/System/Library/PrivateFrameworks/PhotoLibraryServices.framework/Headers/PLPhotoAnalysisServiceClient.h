...
- (long long)updateKeyFacesOfPersonsWithLocalIdentifiers:(id)arg1 forceUpdate:(_Bool)arg2 completion:(id /* block */)arg3;
...
- (void)enrichDataModelWithProgress:(id)arg1 reply:(id /* block */)arg2;
...
- (void)generateQuestionsWithOptions:(id)arg1 reply:(id /* block */)arg2;
