...
//  (struct __CFSet )_inqNewGroupIdsForCollectionId:(NSUInteger)arg1;
- (id)_inqAssetIdsByGroupIdForAssetIds:(id)arg1;
//  (struct __CFSet )_inqNewGroupIdsForAssetIds:(struct __CFSet )arg1;
//  (struct __CFSet )_inqNewGroupIdsForAssetId:(NSUInteger)arg1;
//  (struct __CFArray )_inqNewCollectionIdsForGroupId:(NSUInteger)arg1 dateFilter:(id)arg2;
//  (struct __CFArray )_inqNewCollectionIdsWithDateFilter:(id)arg1;
//  (struct __CFArray )_inqNewAssetIdsForGroupId:(NSUInteger)arg1 dateFilter:(id)arg2;
...
- (id)_inqGroupWithMatchingGroupId:(NSUInteger)arg1 dateFilter:(id)arg2;
- (void)_inqUpdateGCTableWithGroupId:(NSUInteger)arg1 collectionId:(NSUInteger)arg2;
- (void)_inqUpdateGATableWithGroupId:(NSUInteger)arg1 assetId:(NSUInteger)arg2;
- (void)_inqDeleteFromLookupTableWithGroupId:(NSUInteger)arg1;
- (void)_inqAddToLookupTableWithGroupId:(NSUInteger)arg1 text:(id)arg2 category:(short)arg3;
//  (NSUInteger)_inqGroupIdForCategory:(short)arg1 owningGroupId:(NSUInteger)arg2 contentString:(id)arg3 normalizedString:(id)arg4 identifier:(id)arg5 insertIfNeeded:(BOOL)arg6 tokenOutput:(const struct tokenOutput_t )arg7 shouldUpdateOwningGroupId:(BOOL)arg8 didUpdateGroup:(out BOOL )arg9;
- (NSUInteger)_inqCollectionIdWithCollection:(id)arg1;
- (NSUInteger)_inqCollectionIdForUUID:(id)arg1;
- (NSUInteger)_inqCollectionIdForUUID:(id)arg1 uuid_0:(NSUInteger )arg2 uuid_1:(NSUInteger )arg3;
- (NSUInteger)_inqAssetIdWithAsset:(id)arg1;
- (NSUInteger)_inqAssetIdForUUID:(id)arg1;
- (NSUInteger)_inqAssetIdForUUID:(id)arg1 uuid_0:(NSUInteger )arg2 uuid_1:(NSUInteger )arg3;
- (void)_inqUpdateSearchTermsWithSearchableTermsByGroupIds:(id)arg1;
- (void)_inqRemoveUnusedGroups;
- (void)_inqRemoveUUID:(id)arg1 objectType:(NSUInteger)arg2 isInBatch:(BOOL)arg3;
- (NSUInteger)_inqUpdateGroupForText:(id)arg1 normalizedText:(id)arg2 identifier:(id)arg3 category:(short)arg4 owningGroupId:(NSUInteger)arg5 shouldUpdateOwningGroupId:(BOOL)arg6 didUpdateGroup:(out BOOL )arg7;
- (NSUInteger)_inqUpdateGroupForText:(id)arg1 identifier:(id)arg2 category:(short)arg3 owningGroupId:(NSUInteger)arg4 didUpdateGroup:(out BOOL )arg5;
...
- (id)_inqDequeueGroupObjectWithId:(NSUInteger)arg1 isCachedGroup:(BOOL )arg2;
...
- (NSUInteger)_inqNumberOfCollectionsMatchingGroupWithId:(NSUInteger)arg1;
- (id)_inqNumberOfAssetsByGroupIdMatchingGroupsWithIds:(id)arg1;
- (NSUInteger)_inqNumberOfAssetsMatchingGroupWithId:(NSUInteger)arg1;
...
//  (id)_inqGroupWithStatement:(struct sqlite3_stmt )arg1 dateFilter:(id)arg2 includeObjects:(BOOL)arg3 isFilenameStatement:(BOOL)arg4 excludingGroupId:(NSUInteger)arg5;
//  (id)_inqGroupWithStatement:(struct sqlite3_stmt )arg1 dateFilter:(id)arg2 includeObjects:(BOOL)arg3;
//  (id)_inqGroupWithFilenameStatement:(struct sqlite3_stmt )arg1 dateFilter:(id)arg2 excludingGroupId:(NSUInteger)arg3;
...
- (id)_inqContentStringForGroupId:(NSUInteger)arg1;
//  (id)_inqCollectionResultsForCollectionIds:(struct __CFArray )arg1 range:(NSRange *)arg2;
//  (id)_inqAssetUUIDsForAssetIds:(struct __CFSet )arg1;
//  (id)_inqAssetUUIDsForAssetIds:(struct __CFArray )arg1 range:(NSRange *)arg2 creationDateSorted:(BOOL)arg3;
...
- (id)allCollectionUUIDsWithCollectionType:(NSUInteger)arg1;
- (void)_removeUUIDs:(id)arg1 objectType:(NSUInteger)arg2 completion:(CDUnknownBlockType)arg3;
...
//  (void)bindMatchingIds:(struct __CFArray )arg1 range:(NSRange *)arg2;
...
- (void)group:(id)arg1 fetchOwningContentString:(BOOL)arg2 assetIdRange:(NSRange *)arg3 collectionIdRange:(NSRange *)arg4 completionHandler:(CDUnknownBlockType)arg5;
...
- (id)groupWithMatchingGroupId:(NSUInteger)arg1 dateFilter:(id)arg2;
...
- (NSUInteger)updateGroupForText:(id)arg1 identifier:(id)arg2 category:(short)arg3 owningGroupId:(NSUInteger)arg4 didUpdateGroup:(out BOOL )arg5;
- (void)deleteFromLookupTableWithGroupId:(NSUInteger)arg1;
