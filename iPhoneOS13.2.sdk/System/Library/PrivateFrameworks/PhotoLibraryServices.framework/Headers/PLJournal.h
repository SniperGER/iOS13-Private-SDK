...
- (_Bool)enumerateEntriesUsingBlock:(id /* block */)arg1 decodePayload:(_Bool)arg2 error:(id *)arg3;
- (unsigned long long)currentPayloadVersionWithError:(id *)arg1;
- (unsigned long long)countOfInsertEntriesWithError:(id *)arg1;
- (_Bool)enumeratePayloadsUsingBlock:(id /* block */)arg1 error:(id *)arg2;
...
- (_Bool)createSnapshotUsingNextPayloadBlock:(id /* block */)arg1 error:(id *)arg2;
