...
+ (void)getInsertedAssetCount:(NSUInteger )arg1 deletedAssetCount:(NSUInteger )arg2 updatedAssets:(id)arg3 fromContextDidChangeNotification:(id)arg4;
...
- (void)_enqueueNotification:(id)arg1 object:(id)arg2 userInfoWithObjects:(const id )arg3 forKeys:(const id )arg4 count:(NSUInteger)arg5;
