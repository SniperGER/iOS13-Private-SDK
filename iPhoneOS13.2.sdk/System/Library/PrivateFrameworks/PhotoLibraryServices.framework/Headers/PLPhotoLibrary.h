...
- (id)libraryID;
- (void)_withDispatchGroup:(id)arg1 synchronously:(_Bool)arg2 name:(id)arg3 shouldSave:(_Bool)arg4 performTransaction:(id /* block */)arg5 completionHandler:(id /* block */)arg6;
...
- (void)performBlockAndWait:(id /* block */)arg1 forceSave:(_Bool)arg2;
