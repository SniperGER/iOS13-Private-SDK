...
@property(copy, nonatomic) id /* block */ processResultsBlock; // @synthesize processResultsBlock=_processResultsBlock;
...
- (id)initWithName:(id)arg1 fetchRequest:(id)arg2 context:(id)arg3 modelMigrator:(id)arg4 concurrent:(_Bool)arg5 processResultBlock:(id /* block */)arg6;
