...
@interface PLMigrationEnumerateAndSaveController : NSObject
{
    ...
    id /* CDUnknownBlockType */ _processResultsBlock;
    NSError *_firstError;
}
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ processResultsBlock; // @synthesize processResultsBlock=_processResultsBlock;
