...
+ (id)personsMatchingPredicate:(id)arg1 fetchLimit:(NSUInteger)arg2 sortDescriptors:(id)arg3 relationshipKeyPathsForPrefetching:(id)arg4 inManagedObjectContext:(id)arg5;
