...
@class NSDictionary, NSMutableDictionary, PAImageConversionServiceClient, PAVideoConversionServiceClient, PLCloudPhotoLibraryManager, PLPrimaryResourceDataStoreKeyHelper;
...
- (void)requestStreamingURLForResource:(id)arg1 asset:(id)arg2 intent:(NSUInteger)arg3 inContext:(id)arg4 completion:(CDUnknownBlockType)arg5;
...
- (NSUInteger)requestLocalAvailabilityChange:(short)arg1 forResource:(id)arg2 asset:(id)arg3 inContext:(id)arg4 options:(id)arg5 completion:(CDUnknownBlockType)arg6;
...
- (NSUInteger)_makeResourceLocallyAvailable:(id)arg1 asset:(id)arg2 inContext:(id)arg3 options:(id)arg4 completion:(CDUnknownBlockType)arg5;
- (id)_videoConversionServiceClient;
- (id)_imageConversionServiceClient;
- (NSUInteger)_pruneResource:(id)arg1 asset:(id)arg2 inContext:(id)arg3 completion:(CDUnknownBlockType)arg4;
