...
+ (_Bool)enumerateDatedParsesWithParse:(id)arg1 currentTokenIndex:(unsigned long long)arg2 potentialComboAttributes:(id)arg3 usingBlock:(id /* block */)arg4;
...
- (_Bool)_enumerateImplicitlyTokenizedParsesWithBaseParse:(id)arg1 usingBlock:(id /* block */)arg2;
