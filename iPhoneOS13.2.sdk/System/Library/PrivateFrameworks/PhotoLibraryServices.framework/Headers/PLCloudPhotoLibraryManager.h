...
- (void)rampingRequestForResourceType:(NSUInteger)arg1 numRequested:(NSUInteger)arg2 completionHandler:(CDUnknownBlockType)arg3;
...
- (void)downloadResourceInMemoryForAsset:(id)arg1 resourceType:(NSUInteger)arg2 masterResourceOnly:(BOOL)arg3 proposedTaskIdentifier:(id)arg4 taskDidBeginHandler:(CDUnknownBlockType)arg5 completionHandler:(CDUnknownBlockType)arg6;
- (void)downloadAsset:(id)arg1 resourceType:(NSUInteger)arg2 masterResourceOnly:(BOOL)arg3 highPriority:(BOOL)arg4 clientBundleID:(id)arg5 proposedTaskIdentifier:(id)arg6 taskDidBeginHandler:(CDUnknownBlockType)arg7 progressBlock:(CDUnknownBlockType)arg8 completionHandler:(CDUnknownBlockType)arg9;
...
- (void)getStreamingURLForAsset:(id)arg1 resourceType:(NSUInteger)arg2 intent:(NSUInteger)arg3 hints:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;
