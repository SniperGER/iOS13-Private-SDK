...
- (void)importFilesWithMasterPath:(id)arg1 sidecarFileInfo:(id)arg2 importSessionIdentifier:(id)arg3 importedBy:(short)arg4 alternateImportImageDate:(id)arg5 isPhotoStreamsPublishCandidate:(_Bool)arg6 avalancheUUID:(id)arg7 destinationAlbumUUID:(id)arg8 completionHandler:(id /* block */)arg9;
...
- (void)savePhotoStreamImage:(struct NSObject *)arg1 imageData:(id)arg2 properties:(id)arg3 completionBlock:(id /* block */)arg4;
...
- (void)saveImage:(struct NSObject *)arg1 properties:(id)arg2 completionBlock:(id /* block */)arg3;
...
- (void)_saveImage:(struct NSObject *)arg1 imageData:(id)arg2 properties:(id)arg3 completionBlock:(id /* block */)arg4;
- (id /* block */)_createWriteVideoCompletionBlockWithVideoPath:(id)arg1 target:(id)arg2 selector:(SEL)arg3 contextInfo:(void *)arg4;
- (id /* block */)_createWriteImageCompletionBlockWithImage:(struct NSObject *)arg1 target:(id)arg2 selector:(SEL)arg3 contextInfo:(void *)arg4;
...
- (void)saveCameraVideoAtPath:(id)arg1 withMetadata:(id)arg2 thumbnailImage:(struct NSObject *)arg3 createPreviewWellImage:(_Bool)arg4 progressStack:(id)arg5 isSlalom:(_Bool)arg6 assetAdjustments:(id)arg7 videoHandler:(id /* block */)arg8 requestEnqueuedBlock:(id /* block */)arg9 completionBlock:(id /* block */)arg10;
...
- (id)_addCameraAssetToLibraryWithPath:(id)arg1 thumbnailImage:(struct NSObject *)arg2 assetUUID:(id)arg3 metadata:(id)arg4 assetType:(short)arg5 kind:(short)arg6 kindSubtype:(short)arg7 avalancheUUID:(id)arg8 completionHandler:(id /* block */)arg9;
- (void)_queueJobDictionary:(id)arg1 completionBlock:(id /* block */)arg2;
- (void)_queueJobDictionary:(id)arg1 asset:(id)arg2 requestEnqueuedBlock:(id /* block */)arg3 completionBlock:(id /* block */)arg4 imageSurface:(struct __IOSurface *)arg5 previewImageSurface:(struct __IOSurface *)arg6;
- (void)queuePhotoStreamJobDictionary:(id)arg1;
- (id)_saveIsolationQueue;
- (void)_setIsTakingPhoto:(_Bool)arg1;
- (void)requestAsynchronousImageForAssetOID:(id)arg1 withFormat:(int)arg2 allowPlaceholder:(_Bool)arg3 wantURLOnly:(_Bool)arg4 networkAccessAllowed:(_Bool)arg5 trackCPLDownload:(_Bool)arg6 completionBlock:(id /* block */)arg7;
