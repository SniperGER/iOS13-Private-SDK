...
- (void)runPeriodicMaintenanceTasks:(NSUInteger)arg1 withTransaction:(PLXPCTransaction *)arg2;
...
- (void)enumerateAssetsWithIDs:(NSArray *)arg1 usingBlock:(void (^)(id <PLMomentAssetData>, NSUInteger, BOOL ))arg2;
