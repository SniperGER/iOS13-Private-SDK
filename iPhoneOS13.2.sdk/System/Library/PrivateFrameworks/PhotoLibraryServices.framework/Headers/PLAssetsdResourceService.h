...
@class NSObject, PLAssetsdCPLResourceDownloader, PLAssetsdConnectionAuthorization;
...
- (void)asynchronousVideoURLForAsset:(id)arg1 format:(unsigned short)arg2 intent:(NSUInteger)arg3 networkAccessAllowed:(BOOL)arg4 streamingAllowed:(BOOL)arg5 trackCPLDownload:(BOOL)arg6 restrictToPlayable:(BOOL)arg7 reply:(CDUnknownBlockType)arg8;
