...
- (unsigned long long)pl_indexOfLastObjectInRange:(struct _NSRange)arg1 passingTest:(id /* block */)arg2;
- (unsigned long long)pl_indexOfLastObjectPassingTest:(id /* block */)arg1;
- (unsigned long long)pl_indexOfFirstObjectInRange:(struct _NSRange)arg1 passingTest:(id /* block */)arg2;
