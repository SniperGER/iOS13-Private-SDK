...
- (void)setupDatabase;
- (void)openDatabase;
- (void)enumeratePersistedDidSaveEventsInRange:(struct _NSRange)arg1 withBlock:(id /* block */)arg2;
...
- (_Bool)getInMemoryEventsSinceIndex:(unsigned long long)arg1 filteredBy:(id /* block */)arg2 onQueue:(id)arg3 withBlock:(id /* block */)arg4;
