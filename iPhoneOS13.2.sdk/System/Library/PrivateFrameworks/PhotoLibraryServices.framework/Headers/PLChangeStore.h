...
- (void)setupDatabase;
- (void)openDatabase;
- (void)enumeratePersistedDidSaveEventsInRange:(NSRange *)arg1 withBlock:(CDUnknownBlockType)arg2;
- (void)getOnDiskEventsSinceIndex:(NSUInteger)arg1 filteredBy:(CDUnknownBlockType)arg2 onQueue:(id)arg3 withBlock:(CDUnknownBlockType)arg4;
- (id)newArrayWithEventsSince:(NSUInteger)arg1 filteredBy:(CDUnknownBlockType)arg2 lastEventIndex:(NSUInteger )arg3;
- (BOOL)getInMemoryEventsSinceIndex:(NSUInteger)arg1 filteredBy:(CDUnknownBlockType)arg2 onQueue:(id)arg3 withBlock:(CDUnknownBlockType)arg4;
@property(readonly, nonatomic) NSUInteger firstOnDiskEventIndex;
- (NSUInteger)lastIndex;
- (void)clearStore:(CDUnknownBlockType)arg1;
- (void)getEventsSinceIndex:(NSUInteger)arg1 filteredBy:(CDUnknownBlockType)arg2 onQueue:(id)arg3 withBlock:(CDUnknownBlockType)arg4;
- (void)dealloc;
