...
- (void)overrideSystemBudgetsForSyncSession:(BOOL)arg1 systemBudgets:(NSUInteger)arg2 reply:(CDUnknownBlockType)arg3;
- (void)getSystemBudgetsWithReply:(CDUnknownBlockType)arg1;
- (void)getCurrentTransferProgress:(CDUnknownBlockType)arg1;
- (void)rampingRequestForResourceType:(NSUInteger)arg1 numRequested:(NSUInteger)arg2 reply:(CDUnknownBlockType)arg3;
...
- (void)cloudSharingSpaceManagementRequestWithType:(NSUInteger)arg1 optionalBytesToPurge:(NSUInteger)arg2 reply:(CDUnknownBlockType)arg3;
