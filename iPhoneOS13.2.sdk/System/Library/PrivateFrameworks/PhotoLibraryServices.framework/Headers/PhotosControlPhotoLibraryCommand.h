...
- (int)runOnPhotoKitAssetArgumentsAllowAll:(_Bool)arg1 propertySets:(id)arg2 additionalPredicate:(id)arg3 block:(id /* block */)arg4;
...
- (int)runOnAssetArgumentsAllowAll:(_Bool)arg1 additionalPredicate:(id)arg2 block:(id /* block */)arg3;
- (int)runOnManagedObjectArgumentsWithEntityName:(id)arg1 identifierPropertyKey:(id)arg2 allowAll:(_Bool)arg3 additionalPredicate:(id)arg4 sortDescriptors:(id)arg5 block:(id /* block */)arg6;
