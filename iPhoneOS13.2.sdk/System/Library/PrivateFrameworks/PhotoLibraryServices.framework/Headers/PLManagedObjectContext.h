...
+ (id)relationshipNamesForIndexValues:(NSUInteger)arg1 entity:(id)arg2;
+ (NSUInteger)indexValueForRelationshipNames:(id)arg1 entity:(id)arg2;
+ (id)attributeNamesForIndexValues:(NSUInteger)arg1 entity:(id)arg2;
+ (NSUInteger)indexValueForAttributeNames:(id)arg1 entity:(id)arg2;
+ (id)_propertyNamesForIndexValues:(NSUInteger)arg1 entity:(id)arg2 propertyNamesByIndexByEntityNames:(id)arg3;
+ (NSUInteger)_indexValueForPropertyNames:(id)arg1 entityName:(id)arg2 indexesByPropertyNamesByEntityNames:(id)arg3;
...
- (BOOL)_tooManyAssetChangesToHandle:(NSUInteger)arg1;
...
- (void)performWithOptions:(NSUInteger)arg1 andBlock:(CDUnknownBlockType)arg2;
...
- (void)dealloc;
- (id)initWithConcurrencyType:(NSUInteger)arg1 pathManager:(id)arg2 changeHandlingContainer:(id)arg3 coordinator:(id)arg4;
- (id)initWithConcurrencyType:(NSUInteger)arg1 libraryBundle:(id)arg2;
