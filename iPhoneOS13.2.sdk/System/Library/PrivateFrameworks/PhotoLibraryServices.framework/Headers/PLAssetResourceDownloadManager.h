...
- (int)requestCloudResourceType:(NSUInteger)arg1 assetObjectID:(id)arg2 library:(id)arg3 progressHandler:(CDUnknownBlockType)arg4 completionHandler:(CDUnknownBlockType)arg5;
