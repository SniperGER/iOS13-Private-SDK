...
@property(nonatomic) NSUInteger sourceCplType; // @synthesize sourceCplType=_sourceCplType;
@property(nonatomic) NSUInteger cplType; // @synthesize cplType=_cplType;
// - (void).cxx_destruct;
