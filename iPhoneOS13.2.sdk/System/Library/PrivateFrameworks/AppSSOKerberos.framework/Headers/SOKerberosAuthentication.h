...
// - (void).cxx_destruct;
- (NSUInteger)mapErrorToKnownError:(id)arg1;
// - (NSUInteger)findExistingCredentialUsingContext:(id)arg1 returningCredential:(struct gss_cred_id_t_desc_struct )arg2 orError:(id )arg3;
// - (NSUInteger)createNewCredentialUsingContext:(id)arg1 returningCredential:(struct gss_cred_id_t_desc_struct )arg2 orError:(id )arg3;
...
- (NSUInteger)attemptKerberosWithContext:(id)arg1 returningToken:(id )arg2 orError:(id )arg3;
