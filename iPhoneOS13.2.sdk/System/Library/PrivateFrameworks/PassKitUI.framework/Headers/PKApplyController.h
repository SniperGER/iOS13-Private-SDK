...
- (void)_deviceMetadataFields:(NSUInteger)arg1 completion:(CDUnknownBlockType)arg2;
...
- (id)initWithFeature:(NSUInteger)arg1 setupDelegate:(id)arg2 context:(long long)arg3 provisioningController:(id)arg4;
