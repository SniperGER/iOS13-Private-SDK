...
@property(copy, nonatomic) id /* block */ continueActionHandler; // @synthesize continueActionHandler=_continueActionHandler;
...
- (void)performPasscodeUpgradeIfNeeded:(_Bool)arg1 completion:(id /* block */)arg2;
...
- (void)handleNextActionError:(id)arg1 shouldContinue:(_Bool)arg2 withCompletion:(id /* block */)arg3;
