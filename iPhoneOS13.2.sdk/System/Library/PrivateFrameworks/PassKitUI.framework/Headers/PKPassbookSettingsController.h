...
- (void)_presentPeerPaymentSetupFlowWithAmount:(id)arg1 flowState:(NSUInteger)arg2 senderAddress:(id)arg3 completion:(CDUnknownBlockType)arg4;
...
- (void)openPeerPaymentSetupWithCurrenyAmount:(id)arg1 state:(NSUInteger)arg2 senderAddress:(id)arg3;
