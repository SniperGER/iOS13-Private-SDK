...
@interface PKPaymentCredentialsViewController : PKPaymentSetupTableViewController <PKPaymentSetupHideSetupLaterButtonProtocol, PKPaymentProvisioningControllerDelegate, PKPaymentSetupPresentationProtocol>
{
    ...
    NSUInteger _maximumNumberOfSelectableCredentials;
...
- (void)_presentSecurityCapabilitiesFlowWithFeature:(NSUInteger)arg1 completion:(CDUnknownBlockType)arg2;
- (void)performSecurityCheckForCredentials:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (void)_queue_updatePassSnapshot:(id)arg1 paymentCredential:(id)arg2 credentialSection:(NSUInteger)arg3 credentialsInCache:(id)arg4;
...
- (long long)_sectionForCredentialSection:(NSUInteger)arg1;
- (NSUInteger)_credentialSectionForPaymentCredential:(id)arg1;
- (NSUInteger)_credentialSectionForSection:(long long)arg1;
