...
- (void)_resetToRootAnimated:(_Bool)arg1 completion:(id /* block */)arg2;
- (void)dismissPresentedVCsWithRequirements:(unsigned long long)arg1 animated:(_Bool)arg2 performAction:(id /* block */)arg3;
...
- (void)presentPeerPaymentPassAnimated:(_Bool)arg1 completion:(id /* block */)arg2;
- (void)presentDiscoveryArticleForItemWithIdentifier:(id)arg1 referrerIdentifier:(id)arg2 animated:(_Bool)arg3 completion:(id /* block */)arg4;
- (void)presentDailyCashForPassUniqueIdentifier:(id)arg1 dateComponents:(id)arg2 animated:(_Bool)arg3 completion:(id /* block */)arg4;
- (void)showStatementForIdentifier:(id)arg1 passUniqueIdentifier:(id)arg2 animated:(_Bool)arg3 completion:(id /* block */)arg4;
- (void)presentBalanceDetailsForPassUniqueIdentifier:(id)arg1 animated:(_Bool)arg2 completion:(id /* block */)arg3;
- (void)presentSpendingSummaryForPassUniqueIdentifier:(id)arg1 type:(unsigned long long)arg2 unit:(unsigned long long)arg3 animated:(_Bool)arg4 completion:(id /* block */)arg5;
- (void)presentAccountServicePaymentWithReferenceIdentifier:(id)arg1 forPassWithUniqueID:(id)arg2;
- (void)presentPassDetailsAssociatedWithVirtualCardID:(id)arg1 animated:(_Bool)arg2 completion:(id /* block */)arg3;
- (void)presentCreditPassAnimated:(_Bool)arg1 completion:(id /* block */)arg2;
...
- (void)presentExpressUpgradeDetailForPassUniqueID:(id)arg1 marketIdentifier:(id)arg2 animated:(_Bool)arg3 completionHandler:(id /* block */)arg4;
- (void)presentPassDetailsWithUniqueID:(id)arg1 animated:(_Bool)arg2 completionHandler:(id /* block */)arg3;
- (void)presentPassWithUniqueID:(id)arg1 animated:(_Bool)arg2 completionHandler:(id /* block */)arg3;
...
- (void)presentOffscreenAnimated:(_Bool)arg1 split:(_Bool)arg2 withCompletionHandler:(id /* block */)arg3;
- (void)presentOffscreenAnimated:(_Bool)arg1 withCompletionHandler:(id /* block */)arg2;
- (void)presentOnscreen:(_Bool)arg1 withCompletionHandler:(id /* block */)arg2;
...
- (void)presentPassWithFieldProperties:(id)arg1 fieldPassUniqueIdentifiers:(id)arg2 animated:(_Bool)arg3 completionHandler:(id /* block */)arg4;
- (void)presentPassWithFieldProperties:(id)arg1 animated:(_Bool)arg2 completionHandler:(id /* block */)arg3;
- (void)presentPassWithUpdateUserNotificationIdentifier:(id)arg1;
- (void)presentDefaultPaymentPassAnimated:(_Bool)arg1 completionHandler:(id /* block */)arg2;
- (void)forcePayment;
