...
- (void)_presentPeerPaymentAction:(NSUInteger)arg1 withCompletion:(CDUnknownBlockType)arg2;
...
- (void)_presentFlowForAccountResolution:(NSUInteger)arg1 manuallyTriggered:(BOOL)arg2 userInfo:(id)arg3 completion:(CDUnknownBlockType)arg4;
- (void)presentFlowForAccountResolution:(NSUInteger)arg1 manuallyTriggered:(BOOL)arg2 userInfo:(id)arg3 completion:(CDUnknownBlockType)arg4;
- (void)presentFlowForAccountResolution:(NSUInteger)arg1 userInfo:(id)arg2 completion:(CDUnknownBlockType)arg3;
- (void)presentFlowForAccountResolution:(NSUInteger)arg1 manuallyTriggered:(BOOL)arg2 completion:(CDUnknownBlockType)arg3;
- (void)presentFlowForAccountResolution:(NSUInteger)arg1 completion:(CDUnknownBlockType)arg2;
