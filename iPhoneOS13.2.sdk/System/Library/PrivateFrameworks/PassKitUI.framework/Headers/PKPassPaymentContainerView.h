...
- (void)_setVASInfoViewHidden:(_Bool)arg1 animated:(_Bool)arg2 completion:(id /* block */)arg3;
...
- (void)_stopBiometricRecognitionAnimationWithSuccess:(_Bool)arg1 completion:(id /* block */)arg2;
...
- (void)_setGlyphState:(long long)arg1 animated:(_Bool)arg2 withCompletionHandler:(id /* block */)arg3;
...
- (void)_transitionToState:(long long)arg1 withTextOverride:(id)arg2 animated:(_Bool)arg3 completionHandler:(id /* block */)arg4;
...
- (void)_applyPayState:(long long)arg1 withTextOverride:(id)arg2 animated:(_Bool)arg3 completionHandler:(id /* block */)arg4;
