...
- (void)_imageOfSize:(CGSize)arg1 forPass:(id)arg2 fullPass:(BOOL)arg3 stacked:(BOOL)arg4 synchronously:(BOOL)arg5 preemptive:(BOOL)arg6 placeholder:(CDUnknownBlockType)arg7 completion:(CDUnknownBlockType)arg8;
