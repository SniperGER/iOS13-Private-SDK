...
- (void)_imageOfSize:(struct CGSize)arg1 forPass:(id)arg2 fullPass:(_Bool)arg3 stacked:(_Bool)arg4 synchronously:(_Bool)arg5 preemptive:(_Bool)arg6 placeholder:(id /* block */)arg7 completion:(id /* block */)arg8;
...
- (void)imageForPass:(id)arg1 stacked:(_Bool)arg2 synchronously:(_Bool)arg3 placeholder:(id /* block */)arg4 completion:(id /* block */)arg5;
