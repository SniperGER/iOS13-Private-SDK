...
- (_Bool)canPerformPaymentForGroupAtIndex:(unsigned long long)arg1;
...
- (void)_updateGroupStateForGroupViewInModalPresentation:(id)arg1 withState:(long long)arg2 animated:(_Bool)arg3;
...
- (double)_yForModallyPresentedGroupForExternalPresentation:(_Bool)arg1 ignoringCompactState:(_Bool)arg2;
...
- (void)_showPassFooterView:(_Bool)arg1 forPassView:(id)arg2 context:(id)arg3 delay:(double)arg4 completion:(id /* block */)arg5;
- (void)_showPassFooterView:(_Bool)arg1 forPassView:(id)arg2 animated:(_Bool)arg3 delay:(double)arg4 completion:(id /* block */)arg5;
...
- (void)_presentPassIngestionWithAnimation:(_Bool)arg1 withCompletionHandler:(id /* block */)arg2;
...
- (void)_presentGroupStackViewWithAnimation:(_Bool)arg1 priorBounds:(struct CGRect)arg2 completionHandler:(id /* block */)arg3;
- (void)_presentModalGroupViewPostAnimationActions;
- (void)_presentModalGroupView:(id)arg1 withState:(long long)arg2 animated:(_Bool)arg3 context:(id)arg4 completion:(id /* block */)arg5;
- (void)_presentOffscreenAnimated:(_Bool)arg1 split:(_Bool)arg2 withCompletionHandler:(id /* block */)arg3;
...
- (void)setPresentationState:(long long)arg1 animated:(_Bool)arg2 withCompletionHandler:(id /* block */)arg3;
