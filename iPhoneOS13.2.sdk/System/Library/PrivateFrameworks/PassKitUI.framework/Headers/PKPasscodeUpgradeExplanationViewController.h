...
@property(copy, nonatomic) id /* block */ setupLaterHandler; // @synthesize setupLaterHandler=_setupLaterHandler;
@property(copy, nonatomic) id /* block */ continuationHandler; // @synthesize continuationHandler=_continuationHandler;
