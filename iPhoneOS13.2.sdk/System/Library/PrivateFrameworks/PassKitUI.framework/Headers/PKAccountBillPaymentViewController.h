...
+ (void)_billPaymentViewControllerForAccount:(id)arg1 paymentPass:(id)arg2 configuration:(id)arg3 withCompletion:(id /* block */)arg4;
+ (void)billPaymentViewControllerForAccount:(id)arg1 paymentPass:(id)arg2 configuration:(id)arg3 withCompletion:(id /* block */)arg4;
+ (id)backgroundColor;
