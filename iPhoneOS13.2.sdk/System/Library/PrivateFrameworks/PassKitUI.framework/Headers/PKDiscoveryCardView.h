...
@property(copy, nonatomic) id /* block */ dismissAction; // @synthesize dismissAction=_dismissAction;
@property(copy, nonatomic) id /* block */ callToActionTappedOverride; // @synthesize callToActionTappedOverride=_callToActionTappedOverride;
