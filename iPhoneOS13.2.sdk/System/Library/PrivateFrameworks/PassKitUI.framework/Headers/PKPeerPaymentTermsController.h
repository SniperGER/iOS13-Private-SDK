...
@property(copy, nonatomic) id /* block */ customPresentationHandler; // @synthesize customPresentationHandler=_customPresentationHandler;
...
- (void)presentTermsOverController:(id)arg1 showInterstitialViewController:(_Bool)arg2 withCompletionHandler:(id /* block */)arg3;
