...
- (id)_iconForTransaction:(id)arg1 merchant:(id)arg2 size:(CGSize)arg3 requestType:(NSUInteger)arg4 iconHandler:(CDUnknownBlockType)arg5;
- (id)iconForMerchant:(id)arg1 size:(CGSize)arg2 requestType:(NSUInteger)arg3 iconHandler:(CDUnknownBlockType)arg4;
- (id)iconForTransaction:(id)arg1 size:(CGSize)arg2 requestType:(NSUInteger)arg3 iconHandler:(CDUnknownBlockType)arg4;
