...
- (id)_iconForTransaction:(id)arg1 merchant:(id)arg2 size:(struct CGSize)arg3 requestType:(unsigned long long)arg4 iconHandler:(id /* block */)arg5;
- (id)iconForMerchant:(id)arg1 size:(struct CGSize)arg2 requestType:(unsigned long long)arg3 iconHandler:(id /* block */)arg4;
- (id)iconForTransaction:(id)arg1 size:(struct CGSize)arg2 requestType:(unsigned long long)arg3 iconHandler:(id /* block */)arg4;
