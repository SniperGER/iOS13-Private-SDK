...
- (void)_applyStatePreservingGlyphState:(_Bool)arg1 overridingText:(id)arg2 animated:(_Bool)arg3 completionHandler:(id /* block */)arg4;
- (void)setState:(long long)arg1 animated:(_Bool)arg2 withOverrideText:(id)arg3 preserveGlyphState:(_Bool)arg4 completionHandler:(id /* block */)arg5;
- (void)setState:(long long)arg1 animated:(_Bool)arg2 withCompletionHandler:(id /* block */)arg3;
