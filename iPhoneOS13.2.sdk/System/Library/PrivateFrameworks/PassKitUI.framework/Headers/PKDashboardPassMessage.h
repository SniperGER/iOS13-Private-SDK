...
@property(copy, nonatomic) id /* block */ actionOnDismiss; // @synthesize actionOnDismiss=_actionOnDismiss;
@property(nonatomic) _Bool isDestructiveAction; // @synthesize isDestructiveAction=_isDestructiveAction;
@property(copy, nonatomic) id /* block */ actionOnButtonPress; // @synthesize actionOnButtonPress=_actionOnButtonPress;
@property(copy, nonatomic) NSString *buttonTitle; // @synthesize buttonTitle=_buttonTitle;
@property(copy, nonatomic) id /* block */ actionOnMessagePress; // @synthesize actionOnMessagePress=_actionOnMessagePress;
