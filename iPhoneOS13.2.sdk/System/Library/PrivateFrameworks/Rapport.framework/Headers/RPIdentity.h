...
@property(nonatomic) NSUInteger featureFlags; // @synthesize featureFlags=_featureFlags;
...
// - (void).cxx_destruct;
- (BOOL)verifySignaturePtr:(const void *)arg1 signatureLen:(NSUInteger)arg2 dataPtr:(const void *)arg3 dataLen:(NSUInteger)arg4 error:(id )arg5;
- (BOOL)verifySignature:(id)arg1 data:(id)arg2 error:(id )arg3;
- (BOOL)signDataPtr:(const void *)arg1 dataLen:(NSUInteger)arg2 signatureBytes:(unsigned char [64])arg3 error:(id )arg4;
- (id)signData:(id)arg1 error:(id )arg2;
- (BOOL)verifyAuthTagPtr:(const void *)arg1 authTagLen:(NSUInteger)arg2 dataPtr:(const void *)arg3 dataLen:(NSUInteger)arg4 type:(int)arg5 error:(id )arg6;
