...
//    struct LogCategory _ucat;
    ...
    id /* CDUnknownBlockType */ _flowControlWriteChangedHandler;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ sessionStartHandler; // @synthesize sessionStartHandler=_sessionStartHandler;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ peerUpdatedHandler; // @synthesize peerUpdatedHandler=_peerUpdatedHandler;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ pairVerifyCompletion; // @synthesize pairVerifyCompletion=_pairVerifyCompletion;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ flowControlWriteChangedHandler; // @synthesize flowControlWriteChangedHandler=_flowControlWriteChangedHandler;
