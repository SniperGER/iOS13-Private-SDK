...
@property(copy, nonatomic) id /* block */ sessionStartHandler; // @synthesize sessionStartHandler=_sessionStartHandler;
...
@property(copy, nonatomic) id /* block */ peerUpdatedHandler; // @synthesize peerUpdatedHandler=_peerUpdatedHandler;
...
@property(copy, nonatomic) id /* block */ pairVerifyCompletion; // @synthesize pairVerifyCompletion=_pairVerifyCompletion;
...
@property(copy, nonatomic) id /* block */ flowControlWriteChangedHandler; // @synthesize flowControlWriteChangedHandler=_flowControlWriteChangedHandler;
