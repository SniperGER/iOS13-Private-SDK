...
@property(copy, nonatomic) id /* block */ receivedItemsHandler; // @synthesize receivedItemsHandler=_receivedItemsHandler;
@property(copy, nonatomic) id /* block */ receivedItemHandler; // @synthesize receivedItemHandler=_receivedItemHandler;
...
- (void)_largeFileReceiveTaskRespond:(id)arg1 error:(id)arg2 complete:(_Bool)arg3 responseHandler:(id /* block */)arg4;
...
- (_Bool)_smallFilesReceiveTaskFileItem:(id)arg1 error:(id *)arg2;
...
- (void)_scheduleItems;
- (_Bool)_prepareItem:(id)arg1 error:(id *)arg2;
...
- (void)_invalidate;
- (void)invalidate;
- (_Bool)_activateAndReturnError:(id *)arg1;
- (void)activate;
- (_Bool)prepareTemplateAndReturnError:(id *)arg1;
