...
//    struct LogCategory _ucat;
    ...
    NSUInteger _metricFileSizeBuckets[8];
    ...
    id /* CDUnknownBlockType */ _flowControlChangedHandler;
    NSString *_label;
    NSData *_peerPublicKey;
    RPFileTransferProgress *_progressCurrent;
    id /* CDUnknownBlockType */ _progressHandler;
    id /* CDUnknownBlockType */ _receivedItemHandler;
    id /* CDUnknownBlockType */ _receivedItemsHandler;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ receivedItemsHandler; // @synthesize receivedItemsHandler=_receivedItemsHandler;
@property(copy, nonatomic) id /* CDUnknownBlockType */ receivedItemHandler; // @synthesize receivedItemHandler=_receivedItemHandler;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ flowControlChangedHandler; // @synthesize flowControlChangedHandler=_flowControlChangedHandler;
@property(nonatomic) unsigned int flags; // @synthesize flags=_flags;
@property(retain, nonatomic) NSObject<OS_dispatch_queue> *dispatchQueue; // @synthesize dispatchQueue=_dispatchQueue;
@property(nonatomic) NSUInteger debugFlags; // @synthesize debugFlags=_debugFlags;
@property(copy, nonatomic) id /* CDUnknownBlockType */ completionHandler; // @synthesize completionHandler=_completionHandler;
// - (void).cxx_destruct;
- (BOOL)_writeFD:(int)arg1 buffer:(const char )arg2 size:(NSUInteger)arg3 error:(id )arg4;
- (BOOL)_readFD:(int)arg1 buffer:(char )arg2 size:(NSUInteger)arg3 error:(id )arg4;
- (id)_readFD:(int)arg1 size:(NSUInteger)arg2 error:(id )arg3;
- (id)_readPath:(const char )arg1 size:(NSUInteger)arg2 error:(id )arg3;
...
- (id)_ioQueueDequeue;
- (id)_decompressAndDecodeData:(id)arg1 originalSize:(NSUInteger)arg2 error:(id )arg3;
- (id)_encodeAndCompressObject:(id)arg1 originalSize:(NSUInteger )arg2 error:(id )arg3;
- (id)_decompressData:(id)arg1 originalSize:(NSUInteger)arg2 error:(id )arg3;
