...
- (BOOL)setFloatValue:(float)arg1 fromCurrentValue:(float)arg2 forRingPropertyType:(NSUInteger)arg3 ofRingAtIndex:(long long)arg4 animated:(BOOL)arg5 duration:(double)arg6 completion:(CDUnknownBlockType)arg7;
