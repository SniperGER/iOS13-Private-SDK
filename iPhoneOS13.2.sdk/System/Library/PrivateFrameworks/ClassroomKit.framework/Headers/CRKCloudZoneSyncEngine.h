...
@property(nonatomic) _Bool startScheduled; // @synthesize startScheduled=_startScheduled;
...
@property(nonatomic) _Bool reachabilityScheduled; // @synthesize reachabilityScheduled=_reachabilityScheduled;
