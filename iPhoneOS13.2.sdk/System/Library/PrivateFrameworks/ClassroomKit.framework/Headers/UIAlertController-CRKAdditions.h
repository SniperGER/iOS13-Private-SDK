...
+ (id)crk_alertWithTitle:(id)arg1 message:(id)arg2 cancelButtonTitle:(id)arg3 confirmButtonTitle:(id)arg4 destructiveTitle:(_Bool)arg5 confirmBlock:(id /* block */)arg6;
