...
+ (id)stringForType:(NSUInteger)arg1;
+ (id)new;
...
@property(nonatomic) NSUInteger courseColorType; // @synthesize courseColorType=_courseColorType;
@property(nonatomic) NSUInteger courseMascotType; // @synthesize courseMascotType=_courseMascotType;
