...
+ (id)sharedInstance;
@property(retain, nonatomic) id suggestionsService; // @synthesize suggestionsService=_suggestionsService;
...
//  (id)_generateNotificationRequestForMessageRecord:(struct _IMDMessageRecordStruct )arg1 isUrgentMessage:(BOOL)arg2 downTimeEnabled:(BOOL)arg3 isCarouselUITriggered:(BOOL)arg4 isMostActive:(BOOL)arg5 shouldAdvanceLastAlertedMessageDate:(BOOL )arg6;
...
- (void)_setMessagesSpokenWhitelistLevelInPreferences:(NSUInteger)arg1;
- (NSUInteger)_getMessagesSpokenWhitelistLevel:(BOOL )arg1;
...
- (void)_setSpokenMessageWhitelistLevelVersion:(NSUInteger)arg1;
- (NSUInteger)_getSpokenMessageWhitelistLevelVersion;
