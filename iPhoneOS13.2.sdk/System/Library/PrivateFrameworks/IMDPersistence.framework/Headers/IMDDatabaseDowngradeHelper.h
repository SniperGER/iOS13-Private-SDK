...
- (_Bool)close:(id /* block */)arg1;
- (_Bool)open:(id /* block */)arg1;
- (id)errorFromResult:(int)arg1 query:(id)arg2;
- (_Bool)importDataFromWhitetailDatabaseWithSqlOperation:(struct IMDSqlOperation *)arg1 resultBlock:(id /* block */)arg2;
- (_Bool)cloneTableContents:(id)arg1 withOperation:(struct IMDSqlOperation *)arg2 resultBlock:(id /* block */)arg3;
- (_Bool)writeDatabaseVersion:(long long)arg1 resultBlock:(id /* block */)arg2;
- (_Bool)revertTransaction:(id /* block */)arg1;
- (_Bool)commitTransaction:(id /* block */)arg1;
- (_Bool)beginTransaction:(id /* block */)arg1;
@property(readonly, nonatomic) _Bool isOpen;
- (_Bool)createTriggers:(id /* block */)arg1;
- (_Bool)createIndexes:(id /* block */)arg1;
- (_Bool)createTables:(id /* block */)arg1;
- (_Bool)runArrayOfQueries:(id)arg1 resultBlock:(id /* block */)arg2;
- (_Bool)runSimpleQuery:(id)arg1 resultBlock:(id /* block */)arg2;
- (void)dealloc;
...
- (_Bool)readRowCountForTable:(id)arg1 resultBlock:(id /* block */)arg2;
- (_Bool)readDatabaseVersion:(id /* block */)arg1;
- (_Bool)_readIntegerFromQuery:(id)arg1 resultBlock:(id /* block */)arg2;
