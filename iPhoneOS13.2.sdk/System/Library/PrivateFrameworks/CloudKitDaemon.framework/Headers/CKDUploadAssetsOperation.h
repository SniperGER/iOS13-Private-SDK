...
@interface CKDUploadAssetsOperation : CKDDatabaseOperation
{
    BOOL _atomic;
    BOOL _temporary;
    id /* CDUnknownBlockType */ _uploadPreparationBlock;
    id /* CDUnknownBlockType */ _uploadProgressBlock;
    id /* CDUnknownBlockType */ _uploadCompletionBlock;
    ...
    NSUInteger _maxPackageUploadsPerBatch;
...
@property(nonatomic) NSUInteger maxPackageUploadsPerBatch; // @synthesize maxPackageUploadsPerBatch=_maxPackageUploadsPerBatch;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ uploadCompletionBlock; // @synthesize uploadCompletionBlock=_uploadCompletionBlock;
@property(copy, nonatomic) id /* CDUnknownBlockType */ uploadProgressBlock; // @synthesize uploadProgressBlock=_uploadProgressBlock;
@property(copy, nonatomic) id /* CDUnknownBlockType */ uploadPreparationBlock; // @synthesize uploadPreparationBlock=_uploadPreparationBlock;
// - (void).cxx_destruct;
- (void)main;
