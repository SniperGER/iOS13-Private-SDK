...
- (id)invitedKeyToRemoveAtIndex:(NSUInteger)arg1;
- (NSUInteger)invitedKeyToRemovesCount;
- (void)addInvitedKeyToRemove:(id)arg1;
- (void)clearInvitedKeyToRemoves;
- (id)potentialMatchAtIndex:(NSUInteger)arg1;
- (NSUInteger)potentialMatchsCount;
- (void)addPotentialMatch:(id)arg1;
- (void)clearPotentialMatchs;
@property(readonly, nonatomic) BOOL hasShortTokenRoutingKey;
- (id)participantAtIndex:(NSUInteger)arg1;
