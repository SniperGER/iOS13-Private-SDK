...
@class NSData, NSFileHandle, NSInputStream, NSMutableArray, NSOutputStream;
...
//    struct z_stream_s _zlibStream;
    ...
    id /* CDUnknownBlockType */ _logRequestObjectBlock;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ logRequestObjectBlock; // @synthesize logRequestObjectBlock=_logRequestObjectBlock;
