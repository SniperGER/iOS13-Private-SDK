...
- (void)renewiCloudAuthTokenWithReason:(id)arg1 shouldForce:(_Bool)arg2 accessProvider:(id)arg3 failedToken:(id)arg4 completionHandler:(id /* block */)arg5;
...
- (void)renewCloudKitAuthTokenWithReason:(id)arg1 shouldForce:(_Bool)arg2 accessProvider:(id)arg3 failedToken:(id)arg4 completionHandler:(id /* block */)arg5;
- (void)_lockedRenewTokenWithReason:(id)arg1 shouldForce:(_Bool)arg2 accountAccessProvider:(id)arg3 tokenFetchBlock:(id /* block */)arg4 completionHandler:(id /* block */)arg5;
