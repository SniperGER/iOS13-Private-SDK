...
@property(copy, nonatomic) id /* block */ zonePurgedBlock; // @synthesize zonePurgedBlock=_zonePurgedBlock;
@property(copy, nonatomic) id /* block */ zoneDeletedBlock; // @synthesize zoneDeletedBlock=_zoneDeletedBlock;
@property(copy, nonatomic) id /* block */ zoneChangedBlock; // @synthesize zoneChangedBlock=_zoneChangedBlock;
