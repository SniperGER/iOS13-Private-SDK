...
@interface CKDMMCSItemGroupContext : NSObject <CKDCancelling, CKDMMCSItemReaderWriterDelegateProtocol>
{
    ...
    id /* CDUnknownBlockType */ _commandBlock;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ commandBlock; // @synthesize commandBlock=_commandBlock;
...
// - (void).cxx_destruct;
- (BOOL)didReadFromItemReaderWriter:(id)arg1 offset:(NSUInteger)arg2 bytes:(char )arg3 length:(NSUInteger)arg4 bytesRead:(NSUInteger )arg5 error:(id )arg6;
- (BOOL)willReadFromItemReaderWriter:(id)arg1 offset:(NSUInteger)arg2 bytes:(char )arg3 length:(NSUInteger)arg4 bytesRead:(NSUInteger )arg5 error:(id )arg6;
...
//  (struct MMCSItemReaderWriter )getMMCSItemReaderForItemID:(NSUInteger)arg1 error:(id )arg2;
- (id)conformingOperation;
- (void)didGetMetricsForRequest:(id)arg1;
- (void)didPutSectionWithSignature:(id)arg1 results:(id)arg2;
- (void)didPutItemID:(NSUInteger)arg1 signature:(id)arg2 results:(id)arg3;
- (void)didGetItemID:(NSUInteger)arg1 signature:(id)arg2 path:(id)arg3 error:(id)arg4 results:(id)arg5;
- (void)handleCommand:(id)arg1 forItem:(id)arg2;
- (void)updateProgressForItemID:(NSUInteger)arg1 state:(int)arg2 progress:(double)arg3 error:(id)arg4;
- (void)updateProgressForPackageSectionState:(int)arg1 progress:(double)arg2 results:(id)arg3;
- (void)updateProgressForItemID:(NSUInteger)arg1 state:(int)arg2 progress:(double)arg3 results:(id)arg4;
...
- (id)findTrackedMMCSItemByItemID:(NSUInteger)arg1;
