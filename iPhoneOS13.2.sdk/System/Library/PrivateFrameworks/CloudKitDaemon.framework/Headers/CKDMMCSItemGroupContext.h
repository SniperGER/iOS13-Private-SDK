...
@property(copy, nonatomic) id /* block */ startBlock; // @synthesize startBlock=_startBlock;
@property(copy, nonatomic) id /* block */ commandBlock; // @synthesize commandBlock=_commandBlock;
