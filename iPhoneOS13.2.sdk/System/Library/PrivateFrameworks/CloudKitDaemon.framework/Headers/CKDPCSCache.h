...
- (void)fetchPCSForShareWithID:(id)arg1 forOperation:(id)arg2 options:(NSUInteger)arg3 withCompletionHandler:(CDUnknownBlockType)arg4;
- (void)fetchPCSForZoneWithID:(id)arg1 forOperation:(id)arg2 options:(NSUInteger)arg3 withCompletionHandler:(CDUnknownBlockType)arg4;
- (void)fetchPCSForRecordWithID:(id)arg1 forOperation:(id)arg2 options:(NSUInteger)arg3 withCompletionHandler:(CDUnknownBlockType)arg4;
- (void)_lockedFetchPCSForItem:(id)arg1 memoryCache:(id)arg2 forOperation:(id)arg3 options:(NSUInteger)arg4 fetchCreator:(CDUnknownBlockType)arg5 withCompletionHandler:(CDUnknownBlockType)arg6;
- (void)_lockedCreatePCSCacheFetchOfItem:(id)arg1 forOperation:(id)arg2 options:(NSUInteger)arg3 fetchCreator:(CDUnknownBlockType)arg4 withCompletionHandler:(CDUnknownBlockType)arg5;
...
- (void)_lockedHandleMemoryFetchOfItem:(id)arg1 pcsData:(id)arg2 forOperation:(id)arg3 options:(NSUInteger)arg4 fetchCreator:(CDUnknownBlockType)arg5 withCompletionHandler:(CDUnknownBlockType)arg6;
