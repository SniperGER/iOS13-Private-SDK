...
// - (void).cxx_destruct;
- (id)PCSServiceStringFromCKServiceType:(NSUInteger)arg1;
...
//  (id)_copyPublicKeyDataForIdentitySet:(struct _PCSIdentitySetData )arg1 withService:(NSUInteger)arg2 withError:(id )arg3;
//  (id)_copyPublicKeyDataForAllIdentitiesInSet:(struct _PCSIdentitySetData )arg1 withService:(NSUInteger)arg2;
...
- (id)copyDiversifiedPublicKeyForService:(NSUInteger)arg1 userIDEntropy:(id)arg2 withError:(id )arg3;
//  (struct _PCSPublicIdentityData )copyDiversifiedIdentityForService:(NSUInteger)arg1 userIDEntropy:(id)arg2 withError:(id )arg3;
- (id)liverpoolPublicKey;
//  (struct _PCSIdentitySetData )createFullKeychainIdentitySetWithError:(id )arg1;
//  (struct _PCSIdentitySetData )copyIdentitySetWithType:(NSUInteger)arg1 options:(NSUInteger)arg2 error:(id )arg3;
