...
@interface CKDModifyRecordsURLRequest : CKDURLRequest
{
    ...
    id /* CDUnknownBlockType */ _recordPostedBlock;
    NSArray *_records;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ recordPostedBlock; // @synthesize recordPostedBlock=_recordPostedBlock;
