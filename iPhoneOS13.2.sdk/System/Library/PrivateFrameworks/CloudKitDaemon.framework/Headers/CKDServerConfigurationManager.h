...
- (void)containerInfoForOperation:(id)arg1 requireUserIDs:(_Bool)arg2 completionHandler:(id /* block */)arg3;
- (void)configurationForOperation:(id)arg1 completionHandler:(id /* block */)arg2;
- (void)_fetchContainerSpecificInfoForOperation:(id)arg1 requireUserIDs:(_Bool)arg2 completionHandler:(id /* block */)arg3;
