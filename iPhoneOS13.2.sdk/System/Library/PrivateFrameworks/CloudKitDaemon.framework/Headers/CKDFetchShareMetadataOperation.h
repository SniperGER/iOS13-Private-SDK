...
@interface CKDFetchShareMetadataOperation : CKDOperation
{
    ...
    id /* CDUnknownBlockType */ _shareMetadataFetchedBlock;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ shareMetadataFetchedBlock; // @synthesize shareMetadataFetchedBlock=_shareMetadataFetchedBlock;
