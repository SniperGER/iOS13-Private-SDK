...
@property(copy, nonatomic) id /* block */ recordDeletedBlock; // @synthesize recordDeletedBlock=_recordDeletedBlock;
@property(copy, nonatomic) id /* block */ recordsChangedBlock; // @synthesize recordsChangedBlock=_recordsChangedBlock;
