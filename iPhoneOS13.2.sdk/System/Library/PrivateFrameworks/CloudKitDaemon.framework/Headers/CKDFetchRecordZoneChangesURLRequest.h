...
@interface CKDFetchRecordZoneChangesURLRequest : CKDURLRequest <CKDURLRequestPipelining>
{
    ...
    id /* CDUnknownBlockType */ _recordsChangedBlock;
    id /* CDUnknownBlockType */ _recordDeletedBlock;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ recordDeletedBlock; // @synthesize recordDeletedBlock=_recordDeletedBlock;
@property(copy, nonatomic) id /* CDUnknownBlockType */ recordsChangedBlock; // @synthesize recordsChangedBlock=_recordsChangedBlock;
