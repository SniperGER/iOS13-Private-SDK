...
@property(copy, nonatomic) id /* block */ notificationMarkedReadProgressBlock; // @synthesize notificationMarkedReadProgressBlock=_notificationMarkedReadProgressBlock;
- (id)zoneIDsToLock;
