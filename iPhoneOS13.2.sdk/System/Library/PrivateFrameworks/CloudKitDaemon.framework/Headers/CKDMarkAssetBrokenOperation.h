...
@interface CKDMarkAssetBrokenOperation : CKDDatabaseOperation
{
    ...
    id /* CDUnknownBlockType */ _assetOrPackageMarkedBrokenBlock;
    ...
    CKRecord *_record;
    NSUInteger _numMarkAssetBrokenFailures;
...
@property(nonatomic) NSUInteger numMarkAssetBrokenFailures; // @synthesize numMarkAssetBrokenFailures=_numMarkAssetBrokenFailures;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ assetOrPackageMarkedBrokenBlock; // @synthesize assetOrPackageMarkedBrokenBlock=_assetOrPackageMarkedBrokenBlock;
// - (void).cxx_destruct;
