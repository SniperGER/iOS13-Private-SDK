...
@property(nonatomic) NSUInteger operationGroupQuantity; // @synthesize operationGroupQuantity=_operationGroupQuantity;
...
@property(nonatomic) NSUInteger deviceProtocolVersion; // @synthesize deviceProtocolVersion=_deviceProtocolVersion;
...
@property(nonatomic) NSUInteger deviceFlowControlBudgetCap; // @synthesize deviceFlowControlBudgetCap=_deviceFlowControlBudgetCap;
@property(nonatomic) NSUInteger deviceFlowControlBudget; // @synthesize deviceFlowControlBudget=_deviceFlowControlBudget;
...
@property(nonatomic) NSUInteger globalConfigVersion; // @synthesize globalConfigVersion=_globalConfigVersion;
@property(nonatomic) NSUInteger applicationConfigVersion; // @synthesize applicationConfigVersion=_applicationConfigVersion;
...
- (id)serviceIdentityKeyIDsAtIndex:(NSUInteger)arg1;
- (NSUInteger)serviceIdentityKeyIDsCount;
