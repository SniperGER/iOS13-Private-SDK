...
@interface CKDModifyRecordZonesURLRequest : CKDURLRequest
{
    ...
    id /* CDUnknownBlockType */ _recordZoneModifiedBlock;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ recordZoneModifiedBlock; // @synthesize recordZoneModifiedBlock=_recordZoneModifiedBlock;
