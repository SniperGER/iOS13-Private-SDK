...
@interface CKDURLRequest : NSObject <C2RequestDelegate, CKDZoneGatekeeperWaiter, CKDFlowControllable>
{
    ...
    id /* CDUnknownBlockType */ _requestProgressBlock;
    id /* CDUnknownBlockType */ _responseProgressBlock;
    ...
    NSString *_deviceID;
    NSUInteger _numDownloadedElements;
...
@property(nonatomic) NSUInteger numDownloadedElements; // @synthesize numDownloadedElements=_numDownloadedElements;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ responseProgressBlock; // @synthesize responseProgressBlock=_responseProgressBlock;
@property(copy, nonatomic) id /* CDUnknownBlockType */ requestProgressBlock; // @synthesize requestProgressBlock=_requestProgressBlock;
