...
+ (BOOL)isTrackingItemID:(NSUInteger)arg1;
...
- (BOOL)registeredItemCount:(NSUInteger )arg1 error:(id )arg2;
- (BOOL)_getRegisteredItemsGreaterThan:(NSUInteger)arg1 itemIds:(NSUInteger )arg2 itemCount:(NSUInteger )arg3 error:(id )arg4;
...
- (id)registerItemGroupSet:(id)arg1 operation:(id)arg2 options:(NSUInteger)arg3 completionHandler:(CDUnknownBlockType)arg4;
- (id)_contextToRegisterItemGroup:(id)arg1 operation:(id)arg2 options:(NSUInteger)arg3 completionHandler:(CDUnknownBlockType)arg4;
