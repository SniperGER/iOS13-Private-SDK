...
@interface CKDPCSMemoryCache : NSObject
{
    ...
    id  _memoryCacheEvictNotificationObserver;
...
@property(retain, nonatomic) id  memoryCacheEvictNotificationObserver; // @synthesize memoryCacheEvictNotificationObserver=_memoryCacheEvictNotificationObserver;
