...
- (void)synchronizeUserKeyRegistryForServiceType:(unsigned long long)arg1 shouldThrottle:(_Bool)arg2 completionHandler:(id /* block */)arg3;
...
- (void)_locked_pcsDataFromFetchedShare:(id)arg1 withPublicSharingKey:(id)arg2 withServiceType:(unsigned long long)arg3 completionHandler:(id /* block */)arg4;
- (void)pcsDataFromFetchedShare:(id)arg1 withPublicSharingKey:(id)arg2 withServiceType:(unsigned long long)arg3 completionHandler:(id /* block */)arg4;
- (void)pcsDataFromFetchedShare:(id)arg1 withServiceType:(unsigned long long)arg2 completionHandler:(id /* block */)arg3;
- (void)pcsDataFromFetchedShare:(id)arg1 completionHandler:(id /* block */)arg2;
- (void)_locked_decryptPCSDataOnSharePCS:(id)arg1 withPublicSharingKey:(id)arg2 completionHandler:(id /* block */)arg3;
- (void)_locked_decryptCurrentPerParticipantPCSDataOnSharePCS:(id)arg1 completionHandler:(id /* block */)arg2;
- (void)decryptPCSDataOnSharePCS:(id)arg1 completionHandler:(id /* block */)arg2;
...
- (void)preflightIdentitiesForService:(unsigned long long)arg1 withSyncKeyRegistryRetry:(_Bool)arg2 completionHandler:(id /* block */)arg3;
- (void)_locked_preflightIdentitiesForService:(unsigned long long)arg1 withSyncKeyRegistryRetry:(_Bool)arg2 completionHandler:(id /* block */)arg3;
- (_Bool)availableIdentityForService:(unsigned long long)arg1 error:(id *)arg2;
- (void)createIngestedPPPCSDataFromInvitationData:(id)arg1 completionHandler:(id /* block */)arg2;
- (void)createZonePCSFromData:(id)arg1 usingServiceIdentityWithType:(unsigned long long)arg2 completionHandler:(id /* block */)arg3;
- (void)_createPCSFromData:(id)arg1 ofType:(unsigned long long)arg2 usingPCSServiceType:(unsigned long long)arg3 withSyncKeyRegistryRetry:(_Bool)arg4 completionHandler:(id /* block */)arg5;
- (void)_triggerAutobugCaptureForLostManateeIdentityError;
- (void)_locked_createPCSFromData:(id)arg1 ofType:(unsigned long long)arg2 usingPCSServiceType:(unsigned long long)arg3 withSyncKeyRegistryRetry:(_Bool)arg4 completionHandler:(id /* block */)arg5;
...
- (void)createZonePCSWithSyncKeyRegistryRetry:(_Bool)arg1 completionHandler:(id /* block */)arg2;
- (void)_locked_createZonePCSWithSyncKeyRegistryRetry:(_Bool)arg1 completionHandler:(id /* block */)arg2;
