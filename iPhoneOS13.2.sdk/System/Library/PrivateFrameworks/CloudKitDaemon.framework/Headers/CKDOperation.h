...
@interface CKDOperation : NSOperation <CKDURLRequestMetricsDelegate, CKDURLRequestAuthRetryDelegate, CKDFlowControllable>
{
    ...
    id /* CDUnknownBlockType */ _requestCompletedBlock;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ requestCompletedBlock; // @synthesize requestCompletedBlock=_requestCompletedBlock;
