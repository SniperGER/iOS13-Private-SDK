...
@property(retain, nonatomic) id  powerAssertion; // @synthesize powerAssertion=_powerAssertion;
...
@property(copy, nonatomic) id /* block */ requestCompletedBlock; // @synthesize requestCompletedBlock=_requestCompletedBlock;
