...
- (void)clearCachesWithSetupInfo:(id)arg1 options:(NSUInteger)arg2 databaseScope:(long long)arg3 completionHandler:(CDUnknownBlockType)arg4;
...
- (void)statusGroupsForApplicationPermission:(NSUInteger)arg1 setupInfo:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;
- (void)setApplicationPermission:(NSUInteger)arg1 enabled:(BOOL)arg2 setupInfo:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;
...
- (id)readBytesOfInMemoryAssetContentWithUUID:(id)arg1 offset:(NSUInteger)arg2 length:(NSUInteger)arg3 error:(id )arg4;
...
- (void)requestApplicationPermission:(NSUInteger)arg1 setupInfo:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;
- (void)_setApplicationPermission:(NSUInteger)arg1 enabled:(BOOL)arg2 setupInfo:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;
- (void)_globalStatusForApplicationPermission:(NSUInteger)arg1 setupInfo:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;
- (void)statusForApplicationPermission:(NSUInteger)arg1 setupInfo:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;
...
@property(readonly, nonatomic) NSUInteger _outstandingOperationCount;
