...
@interface CKDClientProxy : NSObject <CKDSystemAvailabilityWatcher>
{
    ...
    id  _TCCDatabaseChangedNotificationObserver;
...
@property(retain, nonatomic) id  TCCDatabaseChangedNotificationObserver; // @synthesize TCCDatabaseChangedNotificationObserver=_TCCDatabaseChangedNotificationObserver;
...
- (void)submitClientEventMetric:(id)arg1 withSetupInfo:(id)arg2 completeWhenQueued:(_Bool)arg3 completionHandler:(id /* block */)arg4;
...
- (void)requestClientSyncWithOperationInfo:(id)arg1 withBlock:(id /* block */)arg2;
...
- (void)getBehaviorOptionForKey:(id)arg1 isContainerOption:(_Bool)arg2 completionHandler:(id /* block */)arg3;
...
- (void)setApplicationPermission:(unsigned long long)arg1 enabled:(_Bool)arg2 setupInfo:(id)arg3 completionHandler:(id /* block */)arg4;
...
- (void)performMarkAssetBrokenOperation:(id)arg1 withBlock:(id /* block */)arg2;
- (void)performRepairAssetsOperation:(id)arg1 withBlock:(id /* block */)arg2;
...
- (void)_setApplicationPermission:(unsigned long long)arg1 enabled:(_Bool)arg2 setupInfo:(id)arg3 completionHandler:(id /* block */)arg4;
