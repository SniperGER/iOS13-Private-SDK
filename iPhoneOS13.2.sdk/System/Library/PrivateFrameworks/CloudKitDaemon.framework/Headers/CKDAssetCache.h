...
- (NSUInteger)predictedEvictedSizeForAllFilesForced:(BOOL)arg1;
- (NSUInteger)evictAllFilesForced:(BOOL)arg1;
- (NSUInteger)_evictWithEvictionInfo:(id)arg1;
- (NSUInteger)_evictDownloadedFilesWithDatabase:(id)arg1 evictionInfo:(id)arg2;
- (NSUInteger)_evictDownloadedFilesEvictionInfo:(id)arg1;
...
- (id)findAssetHandleForItemID:(NSUInteger)arg1 error:(id )arg2;
...
- (NSUInteger)clearForced:(BOOL)arg1;
- (NSUInteger)_clearForced:(BOOL)arg1 group:(id)arg2;
