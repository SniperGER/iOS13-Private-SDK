...
@interface CKDAssetCache : NSObject
{
    ...
    id  _assetHandleExpirationNotificationObserver;
...
@property(retain, nonatomic) id  assetHandleExpirationNotificationObserver; // @synthesize assetHandleExpirationNotificationObserver=_assetHandleExpirationNotificationObserver;
