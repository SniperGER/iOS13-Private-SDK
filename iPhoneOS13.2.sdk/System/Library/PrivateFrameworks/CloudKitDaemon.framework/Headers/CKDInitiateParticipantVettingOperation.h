...
{
    id /* CDUnknownBlockType */ _participantVettingProgressBlock;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ participantVettingProgressBlock; // @synthesize participantVettingProgressBlock=_participantVettingProgressBlock;
// - (void).cxx_destruct;
