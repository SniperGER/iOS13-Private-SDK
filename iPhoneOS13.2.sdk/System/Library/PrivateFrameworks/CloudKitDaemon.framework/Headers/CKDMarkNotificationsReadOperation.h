...
{
    id /* CDUnknownBlockType */ _notificationMarkedRead;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ notificationMarkedRead; // @synthesize notificationMarkedRead=_notificationMarkedRead;
// - (void).cxx_destruct;
