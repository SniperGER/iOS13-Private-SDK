...
@interface CKDFetchRecordZonesOperation : CKDDatabaseOperation
{
    ...
    id /* CDUnknownBlockType */ _recordZoneFetchedProgressBlock;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ recordZoneFetchedProgressBlock; // @synthesize recordZoneFetchedProgressBlock=_recordZoneFetchedProgressBlock;
// - (void).cxx_destruct;
