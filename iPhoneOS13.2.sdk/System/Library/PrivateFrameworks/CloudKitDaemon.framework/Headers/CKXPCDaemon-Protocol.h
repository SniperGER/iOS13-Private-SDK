...
- (void)statusGroupsForApplicationPermission:(NSUInteger)arg1 setupInfo:(CKContainerSetupInfo *)arg2 completionHandler:(void (^)(NSArray *, NSError *))arg3;
- (void)resetAllApplicationPermissionsWithSetupInfo:(CKContainerSetupInfo *)arg1 completionHandler:(void (^)(NSError *))arg2;
- (void)setApplicationPermission:(NSUInteger)arg1 enabled:(BOOL)arg2 setupInfo:(CKContainerSetupInfo *)arg3 completionHandler:(void (^)(long long, NSError *))arg4;
...
- (void)getOutstandingOperationCountWithSetupInfo:(CKContainerSetupInfo *)arg1 completionHandler:(void (^)(NSUInteger, NSError *))arg2;
...
- (void)clearCachesWithSetupInfo:(CKContainerSetupInfo *)arg1 options:(NSUInteger)arg2 databaseScope:(long long)arg3 completionHandler:(void (^)(NSError *))arg4;
...
- (void)countAssetCacheItemsWithSetupInfo:(CKContainerSetupInfo *)arg1 databaseScope:(long long)arg2 completionHandler:(void (^)(NSUInteger, NSError *))arg3;
...
- (void)requestApplicationPermission:(NSUInteger)arg1 setupInfo:(CKContainerSetupInfo *)arg2 completionHandler:(void (^)(long long, NSError *))arg3;
- (void)statusForApplicationPermission:(NSUInteger)arg1 setupInfo:(CKContainerSetupInfo *)arg2 completionHandler:(void (^)(long long, NSError *))arg3;
