...
{
    id /* CDUnknownBlockType */ _assetOrPackageRepairedBlock;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ assetOrPackageRepairedBlock; // @synthesize assetOrPackageRepairedBlock=_assetOrPackageRepairedBlock;
// - (void).cxx_destruct;
