...
- (void)syncUserKeysForService:(id)arg1 serviceIsManatee:(_Bool)arg2 account:(id)arg3 shouldThrottle:(_Bool)arg4 testOverrideProvider:(id)arg5 completionHandler:(id /* block */)arg6;
- (void)performKeySyncWithSyncTracker:(id)arg1 testableSyncConfig:(unsigned long long)arg2 shouldThrottle:(_Bool)arg3 completionHandler:(id /* block */)arg4;
