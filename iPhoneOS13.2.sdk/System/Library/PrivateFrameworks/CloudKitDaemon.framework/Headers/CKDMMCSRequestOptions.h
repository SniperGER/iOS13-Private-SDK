...
@interface CKDMMCSRequestOptions : NSObject
{
    ...
    NSUInteger _resolvedDiscretionaryNetworkBehavior;
...
@property(nonatomic) NSUInteger networkServiceType; // @synthesize networkServiceType=_networkServiceType;
...
@property(nonatomic) NSUInteger resolvedDiscretionaryNetworkBehavior; // @synthesize resolvedDiscretionaryNetworkBehavior=_resolvedDiscretionaryNetworkBehavior;
