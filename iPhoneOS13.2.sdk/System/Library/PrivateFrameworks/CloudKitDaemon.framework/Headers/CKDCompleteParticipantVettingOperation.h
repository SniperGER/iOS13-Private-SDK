...
{
    id /* CDUnknownBlockType */ _verifyProgressURLReconstructedBlock;
    id /* CDUnknownBlockType */ _verifyProgressShareMetadataFetchedBlock;
    id /* CDUnknownBlockType */ _verifyCompletionBlock;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ verifyCompletionBlock; // @synthesize verifyCompletionBlock=_verifyCompletionBlock;
@property(copy, nonatomic) id /* CDUnknownBlockType */ verifyProgressShareMetadataFetchedBlock; // @synthesize verifyProgressShareMetadataFetchedBlock=_verifyProgressShareMetadataFetchedBlock;
@property(copy, nonatomic) id /* CDUnknownBlockType */ verifyProgressURLReconstructedBlock; // @synthesize verifyProgressURLReconstructedBlock=_verifyProgressURLReconstructedBlock;
// - (void).cxx_destruct;
