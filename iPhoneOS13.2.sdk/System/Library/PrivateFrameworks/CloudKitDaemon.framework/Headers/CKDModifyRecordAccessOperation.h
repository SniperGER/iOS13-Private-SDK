...
@property(copy, nonatomic) id /* block */ accessWasRevokedBlock; // @synthesize accessWasRevokedBlock=_accessWasRevokedBlock;
@property(copy, nonatomic) id /* block */ accessWasGrantedBlock; // @synthesize accessWasGrantedBlock=_accessWasGrantedBlock;
