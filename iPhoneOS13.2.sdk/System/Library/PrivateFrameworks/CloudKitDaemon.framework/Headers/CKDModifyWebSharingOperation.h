...
@property(copy, nonatomic) id /* block */ recordWebUnsharedBlock; // @synthesize recordWebUnsharedBlock=_recordWebUnsharedBlock;
@property(copy, nonatomic) id /* block */ recordWebSharedBlock; // @synthesize recordWebSharedBlock=_recordWebSharedBlock;
