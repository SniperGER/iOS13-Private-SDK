...
- (void)_prepPCSDataWithContext:(id)arg1 databaseScope:(long long)arg2 publicSharingKey:(id)arg3 removeServerSpecifiedKeys:(_Bool)arg4 containerIdentifier:(id)arg5 sharedRecordZone:(id)arg6 completionHandler:(id /* block */)arg7;
- (void)_prepPCSDataUsingPreDecryptedPCSOnlyWithContext:(id)arg1 databaseScope:(long long)arg2;
- (void)_prepPCSDataWithContext:(id)arg1 databaseScope:(long long)arg2 publicSharingKey:(id)arg3 removeServerSpecifiedKeys:(_Bool)arg4 containerIdentifier:(id)arg5 completionHandler:(id /* block */)arg6;
