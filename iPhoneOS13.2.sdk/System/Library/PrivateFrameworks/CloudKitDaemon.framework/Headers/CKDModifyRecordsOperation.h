...
@property(copy, nonatomic) id /* block */ recordsInFlightBlock; // @synthesize recordsInFlightBlock=_recordsInFlightBlock;
@property(copy, nonatomic) id /* block */ uploadCompletionBlock; // @synthesize uploadCompletionBlock=_uploadCompletionBlock;
@property(copy, nonatomic) id /* block */ deleteCompletionBlock; // @synthesize deleteCompletionBlock=_deleteCompletionBlock;
@property(copy, nonatomic) id /* block */ saveCompletionBlock; // @synthesize saveCompletionBlock=_saveCompletionBlock;
@property(copy, nonatomic) id /* block */ saveProgressBlock; // @synthesize saveProgressBlock=_saveProgressBlock;
