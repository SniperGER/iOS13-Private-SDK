...
@interface CKDModifyRecordsOperation : CKDDatabaseOperation
{
    ...
    id /* CDUnknownBlockType */ _saveProgressBlock;
    ...
    id /* CDUnknownBlockType */ _recordsInFlightBlock;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ recordsInFlightBlock; // @synthesize recordsInFlightBlock=_recordsInFlightBlock;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ saveProgressBlock; // @synthesize saveProgressBlock=_saveProgressBlock;
...
- (void)_enumerateHandlersInState:(NSUInteger)arg1 withBlock:(CDUnknownBlockType)arg2;
- (BOOL)_hasHandlerInState:(NSUInteger)arg1;
- (id)activityCreate;
