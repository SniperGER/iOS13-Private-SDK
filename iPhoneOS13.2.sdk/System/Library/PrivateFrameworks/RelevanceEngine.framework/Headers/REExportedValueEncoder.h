...
- (void)_writeCollection:(id)arg1 toStream:(id)arg2 startBlock:(id /* block */)arg3 writerBlock:(id /* block */)arg4 endBlock:(id /* block */)arg5 wantsHeader:(_Bool)arg6 depth:(unsigned long long)arg7;
