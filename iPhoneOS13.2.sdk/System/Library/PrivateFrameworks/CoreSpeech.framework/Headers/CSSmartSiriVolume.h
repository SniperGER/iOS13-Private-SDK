...
@class CSAsset, CSAudioStream, CSSmartSiriVolumeEnablePolicy, NSUserDefaults;
...
- (void)prepareSoundLevelBufferFromSamples:(id)arg1 soundType:(long long)arg2 firedVoiceTriggerEvent:(BOOL)arg3 triggerStartTimeSampleOffset:(NSUInteger)arg4 triggerEndTimeSampleOffset:(NSUInteger)arg5;
