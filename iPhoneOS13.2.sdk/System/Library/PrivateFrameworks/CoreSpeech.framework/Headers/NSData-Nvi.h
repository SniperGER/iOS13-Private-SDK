...
- (void)splitAudioDataToReachSampleCount:(NSUInteger)arg1 currSampleCount:(NSUInteger)arg2 numBytesPerSample:(NSUInteger)arg3 completionHandler:(CDUnknownBlockType)arg4;
