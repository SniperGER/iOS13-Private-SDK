...
{
    NSUInteger _numberOfBaseProfileUtterancesToUpload;
}

+ (id)sharedInstance;
@property(readonly, nonatomic) NSUInteger numberOfBaseProfileUtterancesToUpload; // @synthesize numberOfBaseProfileUtterancesToUpload=_numberOfBaseProfileUtterancesToUpload;
...
- (BOOL)checkIfVoiceProfile:(id)arg1 needsUpdatedWith:(id)arg2 withCategory:(NSUInteger)arg3;
