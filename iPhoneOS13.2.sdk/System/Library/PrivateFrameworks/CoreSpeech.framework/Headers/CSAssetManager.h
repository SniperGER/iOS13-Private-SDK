...
- (void)installedAssetForCurrentLanguageOfType:(NSUInteger)arg1 completion:(CDUnknownBlockType)arg2;
- (id)installedAssetForCurrentLanguageOfType:(NSUInteger)arg1;
- (void)assetForCurrentLanguageOfType:(NSUInteger)arg1 completion:(CDUnknownBlockType)arg2;
