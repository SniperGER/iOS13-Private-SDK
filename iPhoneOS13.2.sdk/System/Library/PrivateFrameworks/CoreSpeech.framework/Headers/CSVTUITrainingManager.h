...
- (void)closeSessionBeforeStartWithStatus:(int)arg1 successfully:(_Bool)arg2 withCompletion:(id /* block */)arg3;
- (_Bool)cancelTrainingForID:(long long)arg1;
- (void)reset;
- (long long)trainUtterance:(long long)arg1 shouldUseASR:(_Bool)arg2 completion:(id /* block */)arg3;
