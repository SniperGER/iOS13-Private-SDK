...
// + (void)streamAudioFromFileUrl:(id)arg1 audioStreamBasicDescriptor:(struct AudioStreamBasicDescription)arg2 samplesPerStreamChunk:(NSUInteger)arg3 audioDataAvailableHandler:(CDUnknownBlockType)arg4;
...
+ (void)iterateBitset:(NSUInteger)arg1 block:(CDUnknownBlockType)arg2;
