...
{
    NSUInteger _currentDeviceCategory;
...
@property(nonatomic) NSUInteger currentDeviceCategory; // @synthesize currentDeviceCategory=_currentDeviceCategory;
// - (void).cxx_destruct;
...
- (id)_getUserVoiceProfileDownloadCacheDirectoryForProfileId:(id)arg1 forDeviceCategory:(NSUInteger)arg2 forVoiceProfileVersion:(NSUInteger)arg3;
...
- (id)_enrollVoiceProfileForSiriProfileId:(id)arg1 fromCacheDirectoryPath:(id)arg2 withCategoryType:(NSUInteger)arg3;
- (void)_downloadVoiceProfileForProfileId:(id)arg1 forDeviceCategory:(NSUInteger)arg2 withDownloadTriggerBlock:(CDUnknownBlockType)arg3 withCompletion:(CDUnknownBlockType)arg4;
