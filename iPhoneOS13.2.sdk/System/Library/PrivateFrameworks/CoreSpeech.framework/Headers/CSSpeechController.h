...
@interface CSSpeechController : NSObject <CSAudioConverterDelegate, CSSpIdSpeakerRecognizerDelegate, CSSmartSiriVolumeControllerDelegate, CSAudioSessionProvidingDelegate, CSAudioStreamProvidingDelegate, CSAudioAlertProvidingDelegate, CSAudioSessionControllerDelegate, CSXPCClientDelegate, CSSpeechManagerDelegate, CSContinuousVoiceTriggerDelegate>
{
    ...
    id /* CDUnknownBlockType */ _pendingAudioSessionActivationCompletion;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ pendingAudioSessionActivationCompletion; // @synthesize pendingAudioSessionActivationCompletion=_pendingAudioSessionActivationCompletion;
...
- (void)endWaitingForMyriadWithDecision:(NSUInteger)arg1;
...
- (void)audioConverterDidConvertPackets:(id)arg1 packets:(id)arg2 durationInSec:(float)arg3 timestamp:(NSUInteger)arg4;
- (BOOL)_setupAudioConverter:(BOOL)arg1 isNarrowBand:(BOOL)arg2;
- (void)_setupDownsamplerIfNeeded;
- (void)smartSiriVolumeControllerDetectedSystemVolumeChange:(id)arg1 withVolume:(float)arg2 forReason:(NSUInteger)arg3;
...
- (id)recordSettings;
- (void)releaseAudioSession:(NSUInteger)arg1;
