...
@class CSAudioRecorder, CSFallbackAudioSessionReleaseProvider, CSOpportuneSpeakListnerTestService, CSSmartSiriVolume, CSSpIdImplicitTraining, NSMutableDictionary;
...
- (void)audioProviderInvalidated:(id)arg1 streamHandleId:(NSUInteger)arg2;
- (id)_getAudioRecorderWithError:(id )arg1;
- (id)fetchFallbackAudioSessionReleaseProvider;
- (id)audioProviderWithStreamID:(NSUInteger)arg1;
