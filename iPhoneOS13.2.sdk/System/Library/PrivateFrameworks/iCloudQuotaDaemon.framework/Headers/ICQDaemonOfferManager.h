...
- (void)_reconsiderOffersForAccount:(id)arg1 isForBuddy:(_Bool)arg2 choiceHandler:(id /* block */)arg3 completion:(id /* block */)arg4;
...
- (void)_fetchDaemonOfferStubsForAccount:(id)arg1 isForBuddy:(_Bool)arg2 completion:(id /* block */)arg3;
...
- (void)_daemonOfferStubsDictionaryForAccount:(id)arg1 isForBuddy:(_Bool)arg2 completion:(id /* block */)arg3;
