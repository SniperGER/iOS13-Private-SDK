...
- (oneway void)speechRecordingDidChangeAVRecordRoute:(id)arg1 isDucking:(_Bool)arg2 isTwoShot:(_Bool)arg3 speechEndHostTime:(unsigned long long)arg4 reply:(id /* block */)arg5;
