...
- (void)_handleFailureCallbackForEvents:(id)arg1 error:(id)arg2 numberOfRetries:(NSUInteger)arg3 completion:(CDUnknownBlockType)arg4;
- (void)_sendEvents:(id)arg1 numberOfRetries:(NSUInteger)arg2 completion:(CDUnknownBlockType)arg3;
- (oneway void)boostQueuedEvents:(CDUnknownBlockType)arg1;
- (oneway void)flushStagedEventsWithReply:(CDUnknownBlockType)arg1;
- (oneway void)logInstrumentationOfType:(id)arg1 machAbsoluteTime:(NSUInteger)arg2 turnIdentifier:(id)arg3;
