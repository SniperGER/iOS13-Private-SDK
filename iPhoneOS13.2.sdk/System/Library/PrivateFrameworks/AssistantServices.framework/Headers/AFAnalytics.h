...
- (void)logEventWithType:(long long)arg1 machAbsoluteTime:(NSUInteger)arg2 contextResolver:(CDUnknownBlockType)arg3;
- (void)logEventWithType:(long long)arg1 machAbsoluteTime:(NSUInteger)arg2 contextProvider:(CDUnknownBlockType)arg3 contextProvidingQueue:(id)arg4;
