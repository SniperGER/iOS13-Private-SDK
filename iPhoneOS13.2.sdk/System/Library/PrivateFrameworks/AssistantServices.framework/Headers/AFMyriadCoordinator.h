...
- (void)_advertise:(id)arg1 afterDelay:(float)arg2 maxInterval:(float)arg3 andMoveTo:(NSUInteger)arg4;
- (void)_advertise:(id)arg1 andMoveTo:(NSUInteger)arg2;
...
- (void)_duringNextWindowEnterState:(NSUInteger)arg1;
...
- (void)preheatWiProx;
- (void)resetReplies;
- (id)_stateAsString:(NSUInteger)arg1;
- (id)_stateAsString;
- (void)enterState:(NSUInteger)arg1;
- (void)_enterState:(NSUInteger)arg1;
- (void)_cancelOverallTimeout;
- (void)_setOverallTimeout;
- (void)_cancelTimer;
- (void)_startTimer:(id)arg1 for:(float)arg2 thenEnterState:(NSUInteger)arg3;
...
- (double)_targetDelayAfterTrigger:(NSUInteger)arg1;
