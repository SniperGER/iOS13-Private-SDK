...
- (void)setSiriDesignModeEnabled:(_Bool)arg1 completion:(id /* block */)arg2;
...
- (void)setSiriDataSharingOptInAlertPresented:(_Bool)arg1 completion:(id /* block */)arg2;
...
- (void)setSiriGradingEnabled:(_Bool)arg1 completion:(id /* block */)arg2;
...
- (void)addMultiUserUser:(id)arg1 sharedId:(id)arg2 loggableSharedId:(id)arg3 enrollmentName:(id)arg4 isPrimary:(_Bool)arg5 completion:(id /* block */)arg6;
...
- (void)setNanoSiriDataSharingOptInStatus:(long long)arg1 withCompletion:(id /* block */)arg2;
- (void)setNanoCrownActivationEnabled:(_Bool)arg1 withCompletion:(id /* block */)arg2;
...
- (void)setNanoRaiseToSpeakEnabled:(_Bool)arg1 withCompletion:(id /* block */)arg2;
- (void)setNanoPhraseSpotterEnabled:(_Bool)arg1 withCompletion:(id /* block */)arg2;
- (void)setNanoDictationEnabled:(_Bool)arg1 withCompletion:(id /* block */)arg2;
- (void)setNanoAssistantEnabled:(_Bool)arg1 withCompletion:(id /* block */)arg2;
...
- (void)getAvailableVoicesForLanguage:(id)arg1 includeAssetInfo:(_Bool)arg2 completion:(id /* block */)arg3;
...
- (void)getAvailableVoicesForRecognitionLanguage:(id)arg1 includeAssetInfo:(_Bool)arg2 completion:(id /* block */)arg3;
- (void)getAvailableVoicesForRecognitionLanguage:(id)arg1 completion:(id /* block */)arg2;
- (void)_updateVoicesIncludingAssetInfo:(_Bool)arg1 completion:(id /* block */)arg2;
- (id)_filterVoices:(id)arg1 forLanguage:(id)arg2;
- (id)_voices;
- (void)_setVoices:(id)arg1;
- (void)homeOnboardingFlowInvoked:(_Bool)arg1 completion:(id /* block */)arg2;
...
- (void)forceMultiUserSync:(_Bool)arg1 download:(_Bool)arg2 completion:(id /* block */)arg3;
...
- (void)_getSharedUserID:(id /* block */)arg1;
- (void)_updateMultiUserInfoForUser:(id)arg1 score:(id)arg2 companionId:(id)arg3 companionSpeechId:(id)arg4 idsIdentifier:(id)arg5 reset:(_Bool)arg6 completion:(id /* block */)arg7;
- (void)_getSharedCompanionInfo:(id /* block */)arg1;
- (void)_runServiceMaintenance;
- (void)_startDeepSyncVerificationForKeys:(id)arg1;
- (void)_setSyncVerificationNeededAndFullReportNeeded:(_Bool)arg1 shouldPostNotification:(_Bool)arg2 completion:(id /* block */)arg3;
- (void)_fetchPeerData:(id /* block */)arg1;
- (void)_syncDataWithAnchorKeys:(id)arg1 forceReset:(_Bool)arg2 reason:(id)arg3 completion:(id /* block */)arg4;
