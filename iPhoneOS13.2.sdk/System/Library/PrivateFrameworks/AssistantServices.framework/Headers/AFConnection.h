...
- (void)startAudioPlaybackRequest:(id)arg1 options:(NSUInteger)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)sendGenericAceCommand:(id)arg1 turnIdentifier:(NSUUID )arg2 conflictHandler:(CDUnknownBlockType)arg3;
...
- (void)forceAudioSessionInactiveWithOptions:(NSUInteger)arg1 completion:(CDUnknownBlockType)arg2;
- (void)forceAudioSessionInactive;
- (void)forceAudioSessionActiveWithOptions:(NSUInteger)arg1 reason:(long long)arg2 speechRequestOptions:(id)arg3 completion:(CDUnknownBlockType)arg4;
- (void)forceAudioSessionActiveWithOptions:(NSUInteger)arg1 reason:(long long)arg2 completion:(CDUnknownBlockType)arg3;
- (void)forceAudioSessionActiveWithOptions:(NSUInteger)arg1 completion:(CDUnknownBlockType)arg2;
...
- (void)_updateSpeechEndHostTime:(NSUInteger)arg1;
