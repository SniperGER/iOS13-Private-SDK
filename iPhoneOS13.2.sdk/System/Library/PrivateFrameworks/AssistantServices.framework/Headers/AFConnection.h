...
- (void)sendGenericAceCommand:(id)arg1 turnIdentifier:(struct NSUUID *)arg2 conflictHandler:(id /* block */)arg3;
...
- (void)_willStartRequestWithSpeech:(_Bool)arg1 speechRequestOptions:(id)arg2 requestInfo:(id)arg3 analyticsEventProvider:(id /* block */)arg4;
...
- (void)_dispatchCommand:(id)arg1 isInterstitial:(_Bool)arg2 reply:(id /* block */)arg3;
- (void)_handleCommand:(id)arg1 reply:(id /* block */)arg2;
- (void)_startUIRequestWithText:(id)arg1 completion:(id /* block */)arg2;
- (void)_requestDidEnd;
- (void)_requestWillBeginWithRequestClass:(id)arg1 isSpeechRequest:(_Bool)arg2 speechRequestOptions:(id)arg3 requestInfo:(id)arg4 isBackgroundRequest:(_Bool)arg5 analyticsEventProvider:(id /* block */)arg6;
- (void)_requestWillBeginWithRequestClass:(id)arg1 isSpeechRequest:(_Bool)arg2 speechRequestOptions:(id)arg3 requestInfo:(id)arg4 analyticsEventProvider:(id /* block */)arg5;
