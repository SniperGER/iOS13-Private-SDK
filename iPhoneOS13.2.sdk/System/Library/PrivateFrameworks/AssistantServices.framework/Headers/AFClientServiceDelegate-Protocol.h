...
- (oneway void)speechRecordingDidChangeAVRecordRoute:(NSString *)arg1 isDucking:(BOOL)arg2 isTwoShot:(BOOL)arg3 speechEndHostTime:(NSUInteger)arg4 reply:(void (^)(void))arg5;
