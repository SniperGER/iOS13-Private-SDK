...
- (oneway void)startAudioPlaybackRequest:(AFAudioPlaybackRequest *)arg1 options:(NSUInteger)arg2 reply:(void (^)(NSError *))arg3;
...
- (oneway void)continuePendingSpeechRequestWithId:(NSUInteger)arg1 fromTimestamp:(double)arg2;
...
- (oneway void)startRecordingForPendingSpeechRequestWithOptions:(AFSpeechRequestOptions *)arg1 requestId:(NSUInteger)arg2 completion:(void (^)(NSError *))arg3;
...
- (oneway void)forceAudioSessionInactiveWithOptions:(NSUInteger)arg1 completion:(void (^)(void))arg2;
- (oneway void)forceAudioSessionActiveWithOptions:(NSUInteger)arg1 reason:(long long)arg2 speechRequestOptions:(AFSpeechRequestOptions *)arg3 completion:(void (^)(unsigned int, NSError *))arg4;
