...
+ (id)nameForFeatureType:(NSUInteger)arg1;
...
+ (id)unitTestingFeatureWithType:(NSUInteger)arg1 canvasSize:(CGSize)arg2 frame:(CGRect)arg3 value:(id)arg4 barcodeType:(id)arg5 ocrFeatureType:(long long)arg6 subFeatures:(id)arg7;
...
@property(readonly, nonatomic) CGRect unpaddedDetectedFaceRect; // @synthesize unpaddedDetectedFaceRect=_unpaddedDetectedFaceRect;
// - (void).cxx_destruct;
