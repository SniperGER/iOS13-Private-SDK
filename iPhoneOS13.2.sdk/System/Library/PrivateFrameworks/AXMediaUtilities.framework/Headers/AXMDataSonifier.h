...
//     CDStruct_79de6ffd _yData;
    ...
    id /* CDUnknownBlockType */ _trendlineFunction;
    ...
    NSUInteger _playbackSampleCount;
}

+ (id)sharedInstance;
@property(readonly, nonatomic) NSUInteger playbackSampleCount; // @synthesize playbackSampleCount=_playbackSampleCount;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ trendlineFunction; // @synthesize trendlineFunction=_trendlineFunction;
...
@property(nonatomic) NSUInteger toneWaveform; // @synthesize toneWaveform=_toneWaveform;
...
- (void)_peakNormalizeBuffer:(vector_3203cf93 )arg1 length:(NSUInteger)arg2 level:(double)arg3;
...
- (NSUInteger)sampleIndexForTimeOffset:(double)arg1;
- (NSUInteger)sampleIndexForXAxisValue:(double)arg1;
...
- (void)loadDataAndRenderAudioForXAxis:(double )arg1 yAxis:(double )arg2 numValues:(NSUInteger)arg3 axisMinimumX:(double)arg4 axisMaximumX:(double)arg5 axisMinimumY:(double)arg6 axisMaximumY:(double)arg7 interpolationMode:(int)arg8 trendline:(CDUnknownBlockType)arg9;
- (void)scrubToPlaybackFrame:(NSUInteger)arg1;
- (void)stopScrubbing;
- (void)endScrubbing;
- (void)beginScrubbing;
