...
- (void)triggerWithScreenCaptureRegion:(struct CGRect)arg1 interfaceOrientation:(long long)arg2 options:(id)arg3 cacheKey:(id)arg4 resultHandler:(id /* block */)arg5;
