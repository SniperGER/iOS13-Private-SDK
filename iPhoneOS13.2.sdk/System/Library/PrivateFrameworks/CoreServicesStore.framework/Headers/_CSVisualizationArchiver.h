...
+ (void)provideVisualizerToConnection:(void *)arg1 fileHandle:(struct __sFILE *)arg2 providerBlock:(id /* block */)arg3;
+ (void)processCommandFromConnection:(void *)arg1 fileHandle:(struct __sFILE *)arg2 providerBlock:(id /* block */)arg3;
