...
//    struct OpaqueIOPSPowerSourceID _rightPowerSourceID;
    ...
    NSUInteger leftLoadedProperties;
    NSUInteger rightLoadedProperties;
    ...
    NSUInteger leftWriteRequestProperties;
    NSUInteger rightWriteRequestProperties;
    NSUInteger _leftWriteResponseProperties;
    NSUInteger _rightWriteResponseProperties;
...
@property(nonatomic) NSUInteger rightWriteResponseProperties; // @synthesize rightWriteResponseProperties=_rightWriteResponseProperties;
@property(nonatomic) NSUInteger leftWriteResponseProperties; // @synthesize leftWriteResponseProperties=_leftWriteResponseProperties;
...
@property(nonatomic) NSUInteger rightWriteRequestProperties; // @synthesize rightWriteRequestProperties;
@property(nonatomic) NSUInteger leftWriteRequestProperties; // @synthesize leftWriteRequestProperties;
...
@property(nonatomic) NSUInteger rightLoadedProperties; // @synthesize rightLoadedProperties;
@property(nonatomic) NSUInteger leftLoadedProperties; // @synthesize leftLoadedProperties;
...
- (unsigned char)volumeValueForProperty:(NSUInteger)arg1 andPeripheral:(id)arg2;
- (BOOL)signedValueForProperty:(NSUInteger)arg1 andPeripheral:(id)arg2;
- (id)selectedProgramIndexes;
- (id)selectedPrograms;
- (void)selectProgram:(id)arg1 forEar:(int)arg2;
- (void)readProperty:(NSUInteger)arg1 fromPeripheral:(id)arg2;
...
- (void)delayWriteProperty:(NSUInteger)arg1 forPeripheral:(id)arg2;
- (void)_sendDelayedWrites;
- (void)writeValueForProperty:(NSUInteger)arg1;
...
- (void)loadProperties:(NSUInteger)arg1 forPeripheral:(id)arg2 withRetryPeriod:(double)arg3;
...
- (id)peripheral:(id)arg1 characteristicForProperty:(NSUInteger)arg2;
- (NSUInteger)peripheral:(id)arg1 propertyForCharacteristic:(id)arg2;
- (id)programs;
- (int)connectedEars;
- (BOOL)hasConnection;
- (BOOL)isConnected;
...
- (BOOL)peripheral:(id)arg1 didLoadProperty:(NSUInteger)arg2;
