...
- (void)registerListener:(id)arg1 forLiveDosimetryUpdates:(_Bool)arg2 withDoseHandler:(id /* block */)arg3;
- (void)stopLiveListen;
...
- (void)_registerListener:(id)arg1 forAvailableDeviceHandler:(id /* block */)arg2 beginSearching:(_Bool)arg3;
