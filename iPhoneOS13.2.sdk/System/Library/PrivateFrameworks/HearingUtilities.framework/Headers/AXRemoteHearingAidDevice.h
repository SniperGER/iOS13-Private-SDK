...
@interface AXRemoteHearingAidDevice : NSObject <AXHADeviceProtocol>
{
    ...
    NSUInteger _requiredProperties;
    NSUInteger _loadedProperties;
    NSUInteger _pendingPropertyWrites;
    NSUInteger _leftAvailableProperties;
    NSUInteger _rightAvailableProperties;
}

@property(nonatomic) NSUInteger rightAvailableProperties; // @synthesize rightAvailableProperties=_rightAvailableProperties;
@property(nonatomic) NSUInteger leftAvailableProperties; // @synthesize leftAvailableProperties=_leftAvailableProperties;
@property(nonatomic) NSUInteger pendingPropertyWrites; // @synthesize pendingPropertyWrites=_pendingPropertyWrites;
@property(nonatomic) NSUInteger loadedProperties; // @synthesize loadedProperties=_loadedProperties;
@property(nonatomic) NSUInteger requiredProperties; // @synthesize requiredProperties=_requiredProperties;
...
- (double)combinedVolumeForProperty:(NSUInteger)arg1;
- (id)valueForProperty:(NSUInteger)arg1;
- (id)_valueForProperty:(NSUInteger)arg1;
...
- (BOOL)shouldOnlyShowIndividualVolumesForProperty:(NSUInteger)arg1;
- (BOOL)shouldDisplayCombinedVolume;
- (BOOL)supportsCombinedVolumesForProperty:(NSUInteger)arg1;
- (id)programAtIndex:(unsigned char)arg1 forEar:(int)arg2;
- (void)writeVolumesForProperty:(NSUInteger)arg1;
- (void)_delayWriteProperties;
- (BOOL)propertyIsAvailable:(NSUInteger)arg1 forEar:(int)arg2;
- (void)loadRequiredProperties;
- (BOOL)checkDidLoadProperties:(NSUInteger)arg1;
- (BOOL)didLoadRequiredProperties;
- (BOOL)didLoadRequiredPeerProperties;
- (BOOL)didLoadBasicProperties;
- (BOOL)didLoadProperty:(NSUInteger)arg1;
