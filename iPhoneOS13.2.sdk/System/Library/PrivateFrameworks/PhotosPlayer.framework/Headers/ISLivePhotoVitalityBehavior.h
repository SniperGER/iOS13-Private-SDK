...
@property(readonly, nonatomic) NSUInteger assetOptions; // @synthesize assetOptions=_assetOptions;
...
// - (id)initWithInitialLayoutInfo:(id)arg1 playbackEndTime:(CDStruct_1b6d18a9)arg2 playDuration:(CDStruct_1b6d18a9)arg3 playRate:(float)arg4 photoTransitionDuration:(double)arg5 pauseDuringTransition:(BOOL)arg6 assetOptions:(NSUInteger)arg7;
- (void)dealloc;
