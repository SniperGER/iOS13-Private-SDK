...
- (void)_renderVideoToURL:(id)arg1 fileType:(id)arg2 targetSize:(struct CGSize)arg3 volume:(float)arg4 completionHandler:(id /* block */)arg5;
- (id)_outputImageProperties;
- (double)_targetScaleForTargetSize:(struct CGSize)arg1;
- (void)_renderImageWithTargetSize:(struct CGSize)arg1 completionHandler:(id /* block */)arg2;
- (void)_renderImageToURL:(id)arg1 fileType:(id)arg2 targetSize:(struct CGSize)arg3 completionHandler:(id /* block */)arg4;
- (_Bool)_canRenderAtPlaybackTime;
- (void)_prepareForPlaybackWithTargetSize:(struct CGSize)arg1 options:(id)arg2 completionHandler:(id /* block */)arg3;
- (void)_cancelCurrentExportIfNeeded;
- (void)prepareForPlaybackWithTargetSize:(struct CGSize)arg1 options:(id)arg2 completionHandler:(id /* block */)arg3;
