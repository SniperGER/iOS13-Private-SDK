...
- (void)_renderVideoToURL:(id)arg1 fileType:(id)arg2 targetSize:(CGSize)arg3 volume:(float)arg4 completionHandler:(CDUnknownBlockType)arg5;
- (id)_outputImageProperties;
- (double)_targetScaleForTargetSize:(CGSize)arg1;
- (void)_renderImageWithTargetSize:(CGSize)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (void)_renderImageToURL:(id)arg1 fileType:(id)arg2 targetSize:(CGSize)arg3 completionHandler:(CDUnknownBlockType)arg4;
- (BOOL)_canRenderAtPlaybackTime;
- (void)_prepareForPlaybackWithTargetSize:(CGSize)arg1 options:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;
- (void)_cancelCurrentExportIfNeeded;
- (void)prepareForPlaybackWithTargetSize:(CGSize)arg1 options:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;
