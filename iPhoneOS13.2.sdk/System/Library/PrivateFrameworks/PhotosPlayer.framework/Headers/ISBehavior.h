...
- (_Bool)prerollVideoAtRate:(float)arg1 completionHandler:(id /* block */)arg2;
- (_Bool)seekVideoPlayerToTime:(CDStruct_1b6d18a9)arg1 toleranceBefore:(CDStruct_1b6d18a9)arg2 toleranceAfter:(CDStruct_1b6d18a9)arg3 completionHandler:(id /* block */)arg4;
- (_Bool)seekVideoPlayerToTime:(CDStruct_1b6d18a9)arg1 completionHandler:(id /* block */)arg2;
