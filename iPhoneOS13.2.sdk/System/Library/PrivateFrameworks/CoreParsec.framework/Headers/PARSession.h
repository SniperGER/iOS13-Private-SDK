...
@class GEOSearchFoundationFeedbackListener, NSFileManager, NSSet, NSXPCConnection, PARBag, PARSearchClient, PARSessionConfiguration;
...
- (void)sendCBAEngagementFeedback:(id)arg1 query:(NSUInteger)arg2;
- (void)reportFeedback:(id)arg1 queryId:(NSUInteger)arg2;
