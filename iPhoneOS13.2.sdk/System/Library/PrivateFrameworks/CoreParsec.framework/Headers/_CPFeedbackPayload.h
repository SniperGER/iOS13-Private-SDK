...
@interface _CPFeedbackPayload : PBCodable <_CPFeedbackPayload, NSSecureCoding>
{
    ...
    NSUInteger _queryId;
    NSUInteger _whichContained_Feedback;
}

@property(readonly, nonatomic) NSUInteger whichContained_Feedback; // @synthesize whichContained_Feedback=_whichContained_Feedback;
