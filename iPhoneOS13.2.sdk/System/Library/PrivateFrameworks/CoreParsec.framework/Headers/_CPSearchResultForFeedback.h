...
@interface _CPSearchResultForFeedback : PBCodable <_CPSearchResultForFeedback, NSSecureCoding>
{
    ...
    NSString *_userInput;
    NSUInteger _blockId;
    NSUInteger _hashedIdentifier;
    NSString *_resultBundleId;
    NSString *_sectionBundleIdentifier;
    NSString *_applicationBundleIdentifier;
    NSData *_entityData;
    NSUInteger _whichResultbundleidentifier;
    NSUInteger _whichSectionbundleid;
    NSUInteger _whichApplicationbundleid;
}

@property(readonly, nonatomic) NSUInteger whichApplicationbundleid; // @synthesize whichApplicationbundleid=_whichApplicationbundleid;
@property(readonly, nonatomic) NSUInteger whichSectionbundleid; // @synthesize whichSectionbundleid=_whichSectionbundleid;
@property(readonly, nonatomic) NSUInteger whichResultbundleidentifier; // @synthesize whichResultbundleidentifier=_whichResultbundleidentifier;
@property(copy, nonatomic) NSData *entityData; // @synthesize entityData=_entityData;
@property(nonatomic) NSUInteger hashedIdentifier; // @synthesize hashedIdentifier=_hashedIdentifier;
