...
- (void)setEjectable:(_Bool)arg1 completionHandler:(id /* block */)arg2;
- (void)setConnected:(_Bool)arg1 completionHandler:(id /* block */)arg2;
...
- (id)_connection;
- (void)fetchRemoteFileProviderSynchronously:(_Bool)arg1 completionHandler:(id /* block */)arg2;
