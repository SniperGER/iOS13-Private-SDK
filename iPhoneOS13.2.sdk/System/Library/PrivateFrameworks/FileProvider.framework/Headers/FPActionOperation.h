...
@property(copy, nonatomic) id /* block */ errorRecoveryHandler; // @synthesize errorRecoveryHandler=_errorRecoveryHandler;
...
@property(copy, nonatomic) id /* block */ placeholdersCreationBlock; // @synthesize placeholdersCreationBlock=_placeholdersCreationBlock;
