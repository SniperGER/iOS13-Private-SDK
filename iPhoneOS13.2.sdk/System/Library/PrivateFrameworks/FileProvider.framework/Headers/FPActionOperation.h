...
@interface FPActionOperation : FPOperation <NSProgressReporting>
{
    ...
    BOOL _havePreflight;
    BOOL _haveStitching;
    id /* CDUnknownBlockType */ _placeholdersCreationBlock;
    id /* CDUnknownBlockType */ _actionCompletionBlock;
    NSProgress *_progress;
    id /* CDUnknownBlockType */ _errorRecoveryHandler;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ errorRecoveryHandler; // @synthesize errorRecoveryHandler=_errorRecoveryHandler;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ placeholdersCreationBlock; // @synthesize placeholdersCreationBlock=_placeholdersCreationBlock;
