...
@interface FPMoveOperation : FPActionOperation <FPDaemonActionOperationClient>
{
    ...
    NSUInteger __lastUsedDatePolicy;
    ...
    id /* CDUnknownBlockType */ __t_remoteOperationWasScheduled;
    id /* CDUnknownBlockType */ __t_rootCompleted;
}

@property(copy, nonatomic) id /* CDUnknownBlockType */ _t_rootCompleted; // @synthesize _t_rootCompleted=__t_rootCompleted;
@property(copy, nonatomic) id /* CDUnknownBlockType */ _t_remoteOperationWasScheduled; // @synthesize _t_remoteOperationWasScheduled=__t_remoteOperationWasScheduled;
...
@property(nonatomic) NSUInteger lastUsageUpdatePolicy; // @synthesize lastUsageUpdatePolicy=__lastUsedDatePolicy;
...
- (void)_recoverFromCollisionError:(id)arg1 withPolicy:(NSUInteger)arg2;
