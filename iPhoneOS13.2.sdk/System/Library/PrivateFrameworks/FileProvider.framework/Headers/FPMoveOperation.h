...
@property(copy, nonatomic) id /* block */ _t_rootCompleted; // @synthesize _t_rootCompleted=__t_rootCompleted;
@property(copy, nonatomic) id /* block */ _t_remoteOperationWasScheduled; // @synthesize _t_remoteOperationWasScheduled=__t_remoteOperationWasScheduled;
@property(copy, nonatomic) id /* block */ _t_patchActionOperationInfo; // @synthesize _t_patchActionOperationInfo=__t_patchActionOperationInfo;
