...
- (id)archiveItemsWithURLs:(id)arg1 compressionFormat:(NSUInteger)arg2 destinationFolderURL:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;
- (id)archiveItemsWithURLs:(id)arg1 compressionFormat:(NSUInteger)arg2 completionHandler:(CDUnknownBlockType)arg3;
