...
+ (id)placeholderWithCopyOfExistingItem:(id)arg1 lastUsageUpdatePolicy:(NSUInteger)arg2 underParent:(id)arg3 inProviderDomainID:(id)arg4;
...
@property(nonatomic) NSUInteger enumerationOrigin; // @synthesize enumerationOrigin=_enumerationOrigin;
@property(nonatomic) NSUInteger capabilities; // @synthesize capabilities=_capabilities;
...
- (id)initWithVendorItem:(id)arg1 provider:(id)arg2 domain:(id)arg3 extensionCapabilities:(NSUInteger)arg4 useFPFS:(BOOL)arg5;
