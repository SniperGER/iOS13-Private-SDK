...
- (BOOL)fp_moveUnderFolder:(id)arg1 withNewName:(id)arg2 coordinationOptions:(NSUInteger)arg3 allowBounce:(BOOL)arg4 moveHandler:(CDUnknownBlockType)arg5 completionHandler:(CDUnknownBlockType)arg6;
- (BOOL)fp_moveUnderFolder:(id)arg1 withNewName:(id)arg2 coordinationOptions:(NSUInteger)arg3 allowBounce:(BOOL)arg4 completionHandler:(CDUnknownBlockType)arg5;
...
- (id)fp_copyToTempFolderWithFilename:(id)arg1 queue:(id)arg2 precomputedItemSize:(NSUInteger)arg3 completion:(CDUnknownBlockType)arg4;
- (id)fp_copyToURL:(id)arg1 queue:(id)arg2 precomputedItemSize:(NSUInteger)arg3 replacePlaceholder:(BOOL)arg4 completion:(CDUnknownBlockType)arg5;
