...
@property(copy, nonatomic) id /* block */ unarchiveCompletionBlock; // @synthesize unarchiveCompletionBlock=_unarchiveCompletionBlock;
@property(copy, nonatomic) id /* block */ passphraseRequestBlock; // @synthesize passphraseRequestBlock=_passphraseRequestBlock;
