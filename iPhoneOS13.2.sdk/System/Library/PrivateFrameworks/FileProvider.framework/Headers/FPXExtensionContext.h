...
- (void)attemptRecoveryFromError:(id)arg1 optionIndex:(NSUInteger)arg2 completionHandler:(CDUnknownBlockType)arg3;
...
- (id)disconnectDomainID:(id)arg1 options:(NSUInteger)arg2 completionHandler:(CDUnknownBlockType)arg3;
...
- (void)_createItemBasedOnTemplate:(id)arg1 fields:(NSUInteger)arg2 contents:(id)arg3 options:(NSUInteger)arg4 targetName:(id)arg5 bounce:(BOOL)arg6 bounceNumber:(id)arg7 completionHandler:(CDUnknownBlockType)arg8;
- (void)createItemBasedOnTemplate:(id)arg1 fields:(NSUInteger)arg2 contents:(id)arg3 options:(NSUInteger)arg4 bounce:(BOOL)arg5 completionHandler:(CDUnknownBlockType)arg6;
- (void)deleteItemsWithIDs:(id)arg1 baseVersions:(id)arg2 options:(NSUInteger)arg3 reply:(CDUnknownBlockType)arg4;
- (void)preflightReparentItemID:(id)arg1 underParentID:(id)arg2 reply:(CDUnknownBlockType)arg3;
- (void)_reparentItem:(id)arg1 underParent:(id)arg2 withNewName:(id)arg3 shouldBounce:(BOOL)arg4 bounceIndex:(NSUInteger)arg5 reply:(CDUnknownBlockType)arg6;
...
- (void)startOperation:(id)arg1 toFetchThumbnailsForItemIdentifiers:(id)arg2 size:(CGSize)arg3 completionHandler:(CDUnknownBlockType)arg4;
...
- (void)bulkItemChanges:(id)arg1 changedFields:(NSUInteger)arg2 completionHandler:(CDUnknownBlockType)arg3;
- (void)_singleItemChange:(id)arg1 changedFields:(NSUInteger)arg2 bounce:(BOOL)arg3 bounceIndex:(NSUInteger)arg4 completionHandler:(CDUnknownBlockType)arg5;
- (void)singleItemChange:(id)arg1 changedFields:(NSUInteger)arg2 bounce:(BOOL)arg3 completionHandler:(CDUnknownBlockType)arg4;
- (void)changeItem:(id)arg1 baseVersion:(id)arg2 changedFields:(NSUInteger)arg3 contents:(id)arg4 options:(NSUInteger)arg5 completionHandler:(CDUnknownBlockType)arg6;
...
- (void)startProvidingItemAtURL:(id)arg1 readingOptions:(NSUInteger)arg2 completionHandler:(CDUnknownBlockType)arg3;
...
- (void)applyFieldChangesToItem:(id)arg1 baseVersion:(id)arg2 changedFields:(NSUInteger)arg3 contents:(id)arg4 lastKnownVendorItem:(id)arg5 extensionInstance:(id)arg6 completionHandler:(CDUnknownBlockType)arg7;
