...
- (void)fetchServicesForItemAtURL:(id)arg1 synchronously:(_Bool)arg2 handler:(id /* block */)arg3;
...
- (void)fetchParentsForItemID:(id)arg1 recursively:(_Bool)arg2 completionHandler:(id /* block */)arg3;
...
- (void)_fetchHierarchyForItemID:(id)arg1 recursively:(_Bool)arg2 depth:(unsigned long long)arg3 completionHandler:(id /* block */)arg4;
- (void)_fetchHierarchyForItemID:(id)arg1 recursively:(_Bool)arg2 completionHandler:(id /* block */)arg3;
- (void)_fetchParentsForItemID:(id)arg1 recursively:(_Bool)arg2 completionHandler:(id /* block */)arg3;
- (void)extendBookmarkForItem:(id)arg1 receivingBundleID:(id)arg2 completionHandler:(id /* block */)arg3;
- (void)fetchFSItemsForItemIdentifiers:(id)arg1 providerIdentifier:(id)arg2 domainIdentifier:(id)arg3 materializingIfNeeded:(_Bool)arg4 completionHandler:(id /* block */)arg5;
- (id)itemForURL:(id)arg1 error:(id *)arg2;
- (void)fetchItemForURL:(id)arg1 completionHandler:(id /* block */)arg2;
- (void)_fetchItemForURL:(id)arg1 synchronously:(_Bool)arg2 completionHandler:(id /* block */)arg3;
...
- (void)_fetchURLForItemID:(id)arg1 creatingPlaceholderIfMissing:(_Bool)arg2 completionHandler:(id /* block */)arg3;
...
- (void)fetchURLForItem:(id)arg1 creatingPlaceholderIfMissing:(_Bool)arg2 completionHandler:(id /* block */)arg3;
