...
+ (id)predicateForContactsMatchingMultivalueProperty:(int)arg1 values:(id)arg2 groupIdentifiers:(id)arg3 containerIdentifiers:(id)arg4 limitToOneResult:(_Bool)arg5 map:(id)arg6;
...
@property(copy, nonatomic) id /* block */ matchInfoProvider; // @synthesize matchInfoProvider=_matchInfoProvider;
@property(copy, nonatomic) id /* block */ bindBlock; // @synthesize bindBlock=_bindBlock;
- (void)dealloc;
