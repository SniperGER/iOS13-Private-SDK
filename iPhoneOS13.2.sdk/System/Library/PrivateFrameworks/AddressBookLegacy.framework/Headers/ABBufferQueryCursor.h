...
//    struct sqlite3_blob _incompleteBlob;
    NSUInteger _blobBytesWritten;
    NSUInteger _blobLength;
    long long _currentMultivalue;
    long long _resumeToken;
    NSUInteger _maxBufferSize;
    NSUInteger _maxContactsPerBatch;
    NSUInteger _countOfContactsInBuffer;
...
@property(nonatomic) NSUInteger countOfContactsInBuffer; // @synthesize countOfContactsInBuffer=_countOfContactsInBuffer;
@property(nonatomic) NSUInteger maxContactsPerBatch; // @synthesize maxContactsPerBatch=_maxContactsPerBatch;
@property(nonatomic) NSUInteger maxBufferSize; // @synthesize maxBufferSize=_maxBufferSize;
...
@property(nonatomic) NSUInteger blobLength; // @synthesize blobLength=_blobLength;
@property(nonatomic) NSUInteger blobBytesWritten; // @synthesize blobBytesWritten=_blobBytesWritten;
...
- (id)initWithQuery:(id)arg1 batchSize:(NSUInteger)arg2 managedConfiguration:(id)arg3;
//  (id)initWithAddressBook:(void )arg1 predicate:(id)arg2 propertyIdentifierSet:(struct __CFSet )arg3 includeLinkedContacts:(BOOL)arg4 sortOrder:(unsigned int)arg5 suggestedContactsPerBatch:(NSUInteger)arg6 managedConfiguration:(id)arg7;
