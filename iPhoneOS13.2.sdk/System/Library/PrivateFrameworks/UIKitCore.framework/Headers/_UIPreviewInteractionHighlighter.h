...
@interface _UIPreviewInteractionHighlighter : NSObject <UIInteractionEffect>
{
    ...
    NSUInteger _clickEffectPhase;
    id /* CDUnknownBlockType */ _privateCompletionBlock;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ privateCompletionBlock; // @synthesize privateCompletionBlock=_privateCompletionBlock;
@property(nonatomic) NSUInteger clickEffectPhase; // @synthesize clickEffectPhase=_clickEffectPhase;
