...
- (void)_performLayoutCalculation:(id /* block */)arg1 inSize:(struct CGSize)arg2;
...
- (void)_setFrameOrBounds:(struct CGRect)arg1 fromOldRect:(struct CGRect)arg2 settingAction:(id /* block */)arg3;
