...
- (void)_dismissViewControllerAnimated:(_Bool)arg1 completion:(id /* block */)arg2;
- (_Bool)_presentViewController:(id)arg1 animated:(_Bool)arg2 completion:(id /* block */)arg3;
