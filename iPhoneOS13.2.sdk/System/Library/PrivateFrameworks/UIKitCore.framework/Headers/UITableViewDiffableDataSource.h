...
- (void)_applySnapshot:(id)arg1 animatingDifferences:(_Bool)arg2 completion:(id /* block */)arg3;
...
- (void)applySnapshot:(id)arg1 animatingDifferences:(_Bool)arg2 completion:(id /* block */)arg3;
