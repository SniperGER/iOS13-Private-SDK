...
@property(nonatomic) CGPoint startingContentOffsetForObservedScrollView; // @synthesize startingContentOffsetForObservedScrollView=_startingContentOffsetForObservedScrollView;
...
- (void)_animateFromBottomPaletteAtEdge:(NSUInteger)arg1;
- (void)_prepareToBottomPaletteAtEdge:(NSUInteger)arg1;
- (void)prepare;
