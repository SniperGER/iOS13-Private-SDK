...
- (void)updateLayout;
- (void)resetSwipedItemAnimated:(_Bool)arg1 completion:(id /* block */)arg2;
- (void)swipeItemAtIndexPath:(id)arg1 configuration:(id)arg2 direction:(unsigned long long)arg3 animated:(_Bool)arg4 completion:(id /* block */)arg5;
