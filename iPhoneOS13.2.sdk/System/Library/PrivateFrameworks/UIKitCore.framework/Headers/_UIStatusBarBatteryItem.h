...
@property(nonatomic) _Bool disableAlwaysShowPercentageWhenExpanded; // @synthesize disableAlwaysShowPercentageWhenExpanded=_disableAlwaysShowPercentageWhenExpanded;
