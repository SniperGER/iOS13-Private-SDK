...
- (void)__viewServiceInstrinsicContentSizeDidChange:(CGSize)arg1 fence:(BKSAnimationFenceHandle *)arg2;
- (void)__viewServicePreferredContentSizeDidChange:(CGSize)arg1 fence:(BKSAnimationFenceHandle *)arg2;
- (void)__viewServicePopoverDidSetUseToolbarShine:(BOOL)arg1;
- (void)__viewServicePopoverDidChangeContentSize:(CGSize)arg1 animated:(BOOL)arg2 fence:(BKSAnimationFenceHandle *)arg3 withReplyHandler:(void (^)(CGSize))arg4;
