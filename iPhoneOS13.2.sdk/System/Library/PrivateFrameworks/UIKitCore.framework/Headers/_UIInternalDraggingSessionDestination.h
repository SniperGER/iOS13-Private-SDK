...
@class NSArray, NSMutableSet, NSPointerArray, NSProgress, PBItemCollection, UIDragEvent, UIView, UIWindow, UIWindowScene, _DUIPotentialDrop, _UIApplicationModalProgressController, _UIDataTransferMonitor, _UIDragSetDownAnimation, _UIDropSessionImpl, _UIInternalDraggingSessionSource;
...
@interface _UIInternalDraggingSessionDestination : _UIDraggingImageSlotOwner <_UIDataTransferMonitorDelegate, NSProgressReporting, _UIDraggingInfo>
{
    ...
    id /* CDUnknownBlockType */ _dropCompletionBlock;
    id /* CDUnknownBlockType */ _postDropAnimationCompletionBlock;
...
- (NSUInteger)actualDragOperationForProposedDragOperation:(NSUInteger)arg1 destinationDataOwner:(long long)arg2 forbidden:(BOOL )arg3;
...
- (void)requestDropOnView:(id)arg1 withOperation:(NSUInteger)arg2 perform:(CDUnknownBlockType)arg3 completion:(CDUnknownBlockType)arg4;
