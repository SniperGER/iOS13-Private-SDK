...
- (_Bool)dragDriver:(id)arg1 prepareToLiftWithCompletion:(id /* block */)arg2;
- (_Bool)dragDriver:(id)arg1 shouldBeginAtLocation:(struct CGPoint)arg2;
- (void)didMoveToView:(id)arg1;
- (void)willMoveToView:(id)arg1;
- (void)_sessionDidTransferItems:(id)arg1;
- (_Bool)_session:(id)arg1 item:(id)arg2 shouldDelaySetDownAnimationWithCompletion:(id /* block */)arg3;
...
- (_Bool)_prepareForLiftAtPoint:(struct CGPoint)arg1 invocationType:(long long)arg2 completion:(id /* block */)arg3;
- (_Bool)_accessibilityAddItemsToDragSessionAtPoint:(struct CGPoint)arg1;
- (_Bool)_accessibilityCanAddItemsToDragSession;
- (void)_accessibilityPrepareForDragAtPoint:(struct CGPoint)arg1 completion:(id /* block */)arg2;
...
- (_Bool)_queryDelegate:(id)arg1 forItemsForAddingToSession:(id)arg2 atPoint:(struct CGPoint)arg3 completion:(id /* block */)arg4;
