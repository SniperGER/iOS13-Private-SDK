...
@class NSArray, NSLayoutConstraint, UIColor, UIFocusContainerGuide, UIView, UIVisualEffectView, _CarTitleView, _UIBarButtonItemAppearanceStorage, _UIButtonBar, _UIButtonBarButton;
...
- (void)_updateContentAnimated:(BOOL)arg1 completion:(CDUnknownBlockType)arg2 direction:(NSUInteger)arg3;
- (void)_updateContentForTopItem:(id)arg1 backItem:(id)arg2 animated:(BOOL)arg3 direction:(NSUInteger)arg4;
