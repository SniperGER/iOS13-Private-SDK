...
@interface _UIFallbackPresentationViewController : UIApplicationRotationFollowingController
{
    ...
    id /* CDUnknownBlockType */ _presentationPreparationBlock;
}
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ presentationPreparationBlock; // @synthesize presentationPreparationBlock=_presentationPreparationBlock;
