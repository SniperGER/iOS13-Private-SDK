...
@class NSCalendar, NSDate, NSDateComponents, NSLocale, NSTimeZone, UIDatePicker, UIFont, UILabel, _UIDatePickerChineseCalendar, _UIDatePickerMode;
...
- (void)_fadeLabelForCalendarUnit:(NSUInteger)arg1 toText:(id)arg2 animated:(BOOL)arg3;
...
- (void)_positionLabel:(id)arg1 forCalendarUnit:(NSUInteger)arg2 relativeTo:(id)arg3 order:(long long)arg4;
- (void)_setLabel:(id)arg1 forCalendarUnit:(NSUInteger)arg2 animated:(BOOL)arg3;
- (id)_labelForCalendarUnit:(NSUInteger)arg1 createIfNecessary:(BOOL)arg2;
...
- (id)_existingLabelForCalendarUnit:(NSUInteger)arg1;
- (id)_labelTextForCalendarUnit:(NSUInteger)arg1;
- (id)_selectedTextForCalendarUnit:(NSUInteger)arg1;
