...
@property(copy, nonatomic, setter=__setQueuedOrientationChange:) id /* block */ __queuedOrientationChange; // @synthesize __queuedOrientationChange=___queuedOrientationChange;
...
- (void)_performRefreshForUIScene:(id)arg1 disposeAfter:(_Bool)arg2 completion:(id /* block */)arg3;
...
- (_Bool)setKeepAliveTimeout:(double)arg1 handler:(id /* block */)arg2;
...
- (void)_updateStateRestorationArchiveForBackgroundEvent:(id /* block */)arg1 saveState:(_Bool)arg2 exitIfCouldNotRestoreState:(_Bool)arg3 updateSnapshot:(_Bool)arg4 windowScene:(id)arg5;
...
- (void)_cancelTouchesOrPresses:(id)arg1 withEvent:(id)arg2 includingGestures:(_Bool)arg3 notificationBlock:(id /* block */)arg4;
...
- (void)installNotificationObserverForNotificationName:(id)arg1 forOneNotification:(_Bool)arg2 usingBlock:(id /* block */)arg3;
...
- (void)finishedTest:(id)arg1 waitForCommit:(_Bool)arg2 extraResults:(id)arg3 withTeardownBlock:(id /* block */)arg4;
...
- (void)finishedIPTest:(id)arg1 waitForCommit:(_Bool)arg2 extraResults:(id)arg3 withTeardownBlock:(id /* block */)arg4;
