...
@class NSArray, UIView, _UIDragInteractionDriverStateMachine;
...
@property(nonatomic) CGPoint initialLocationInWindow; // @synthesize initialLocationInWindow=_initialLocationInWindow;
