...
@interface _UICollectionCompositionalLayoutSolver : NSObject <_UICollectionLayoutAuxillaryHosting, _UIDynamicReferenceSystem>
{
    ...
    id /* CDUnknownBlockType */ _dynamicsConfigurationHandler;
    ...
    id /* CDUnknownBlockType */ _sectionProvider;
...
@property(nonatomic) CGSize actualContentSize; // @synthesize actualContentSize=_actualContentSize;
@property(nonatomic) BOOL layoutRTL; // @synthesize layoutRTL=_layoutRTL;
@property(copy, nonatomic) id /* CDUnknownBlockType */ sectionProvider; // @synthesize sectionProvider=_sectionProvider;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ dynamicsConfigurationHandler; // @synthesize dynamicsConfigurationHandler=_dynamicsConfigurationHandler;
...
- (void)_layoutAttributesForElementsInRect:(CGRect)arg1 handler:(CDUnknownBlockType)arg2;
