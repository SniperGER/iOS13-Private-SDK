...
@property(copy, nonatomic) id /* block */ sectionProvider; // @synthesize sectionProvider=_sectionProvider;
...
@property(copy, nonatomic) id /* block */ dynamicsConfigurationHandler; // @synthesize dynamicsConfigurationHandler=_dynamicsConfigurationHandler;
...
@property(nonatomic) _Bool hasOrthogonalSrollingSections; // @synthesize hasOrthogonalSrollingSections=_hasOrthogonalSrollingSections;
...
- (void)_layoutAttributesForElementsInRect:(struct CGRect)arg1 handler:(id /* block */)arg2;
...
- (id)initWithContainer:(id)arg1 traitCollection:(id)arg2 layoutAxis:(int)arg3 dataSourceSnapshot:(id)arg4 options:(id)arg5 sectionProvider:(id /* block */)arg6;
