...
+ (id)extraView:(id)arg1 withAlignment:(int)arg2 animation:(id /* block */)arg3 onSnapshot:(_Bool)arg4;
@property(copy, nonatomic) id /* block */ animation; // @synthesize animation=_animation;
