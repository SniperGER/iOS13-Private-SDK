...
@property(copy, nonatomic, setter=_setUpdateNavigationBarHandler:) id /* block */ _updateNavigationBarHandler; // @synthesize _updateNavigationBarHandler=__updateNavigationBarHandler;
...
- (void)_executeNavigationHandler:(id /* block */)arg1 deferred:(_Bool)arg2;
