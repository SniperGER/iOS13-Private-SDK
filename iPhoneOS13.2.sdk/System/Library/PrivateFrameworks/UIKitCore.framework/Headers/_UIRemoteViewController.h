...
- (void)__viewServicePopoverDidChangeContentSize:(CGSize)arg1 animated:(BOOL)arg2 fence:(id)arg3 withReplyHandler:(CDUnknownBlockType)arg4;
...
- (void)_scrollToTopFromTouchAtViewLocation:(CGPoint)arg1 resultHandler:(CDUnknownBlockType)arg2;
