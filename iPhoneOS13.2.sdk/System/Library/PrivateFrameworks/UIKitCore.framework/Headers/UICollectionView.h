...
@property(copy, nonatomic, getter=_navigationCompletion, setter=_setNavigationCompletion:) id /* block */ navigationCompletion; // @synthesize navigationCompletion=_navigationCompletion;
...
- (void)_performBatchUpdates:(id /* block */)arg1 completion:(id /* block */)arg2 invalidationContext:(id)arg3 tentativelyForReordering:(_Bool)arg4 animator:(id)arg5;
- (void)_performBatchUpdates:(id /* block */)arg1 completion:(id /* block */)arg2 invalidationContext:(id)arg3 tentativelyForReordering:(_Bool)arg4;
...
- (void)_setCollectionViewLayout:(id)arg1 animated:(_Bool)arg2 isInteractive:(_Bool)arg3 completion:(id /* block */)arg4 animator:(id)arg5;
- (void)_setCollectionViewLayout:(id)arg1 animated:(_Bool)arg2 isInteractive:(_Bool)arg3 completion:(id /* block */)arg4;
- (void)setCollectionViewLayout:(id)arg1 withAnimator:(id)arg2;
- (void)setCollectionViewLayout:(id)arg1 animated:(_Bool)arg2 completion:(id /* block */)arg3;
...
- (id)_doubleSidedAnimationsForView:(id)arg1 withStartingLayoutAttributes:(id)arg2 startingLayout:(id)arg3 endingLayoutAttributes:(id)arg4 endingLayout:(id)arg5 withAnimationSetup:(id /* block */)arg6 animationCompletion:(id /* block */)arg7 enableCustomAnimations:(_Bool)arg8 customAnimationsType:(unsigned long long)arg9;
