...
- (_Bool)_readItemsWithShouldVisitBlock:(id /* block */)arg1 visitorBlock:(id /* block */)arg2 error:(id *)arg3;
- (_Bool)readLogicalItemsWithBlock:(id /* block */)arg1 error:(id *)arg2;
- (_Bool)readAllItemsWithBlock:(id /* block */)arg1 error:(id *)arg2;
- (void)close;
- (_Bool)open;
