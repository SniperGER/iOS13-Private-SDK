...
@property(copy, nonatomic) id /* block */ backgroundEffectApplyBlock; // @synthesize backgroundEffectApplyBlock=_backgroundEffectApplyBlock;
...
- (void)reset;
- (void)setHidden:(_Bool)arg1 animated:(_Bool)arg2 completion:(id /* block */)arg3;
...
- (void)applyBackgroundEffectWithMagnitude:(double)arg1 interactive:(_Bool)arg2 completion:(id /* block */)arg3;
