...
- (void)_internal_playFeedbackData:(id)arg1 atTime:(double)arg2 feedback:(id)arg3 effectiveFeedbackType:(NSUInteger)arg4 existingPlayer:(id)arg5 withCompletionBlock:(CDUnknownBlockType)arg6;
