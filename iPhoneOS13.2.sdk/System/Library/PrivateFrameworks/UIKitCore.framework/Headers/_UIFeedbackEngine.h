...
- (void)_internal_prewarm:(_Bool)arg1 andPerformWhenPrewarmed:(id /* block */)arg2;
- (void)_prewarm:(_Bool)arg1 andPerformWhenPrewarmed:(id /* block */)arg2;
...
- (void)_internal_activate:(_Bool)arg1 andPerformWhenRunning:(id /* block */)arg2;
- (void)_activate:(_Bool)arg1 andPerformWhenRunning:(id /* block */)arg2;
