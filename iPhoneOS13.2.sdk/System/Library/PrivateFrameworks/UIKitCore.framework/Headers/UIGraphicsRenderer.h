...
- (_Bool)runDrawingActions:(id /* block */)arg1 completionActions:(id /* block */)arg2 format:(id)arg3 error:(id *)arg4;
- (_Bool)runDrawingActions:(id /* block */)arg1 completionActions:(id /* block */)arg2 error:(id *)arg3;
