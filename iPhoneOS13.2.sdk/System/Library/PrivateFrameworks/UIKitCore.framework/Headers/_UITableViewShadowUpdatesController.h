...
@class NSMutableArray, UITableView, _UIDataSourceSnapshotter, _UIDataSourceUpdateMap;
...
- (id)_tableView:(id)arg1 sectionIndexTitlesTrimmedToCount:(NSUInteger)arg2;
...
- (BOOL)tableView:(id)arg1 shouldUpdateFocusFromRowAtIndexPath:(id)arg2 toView:(id)arg3 heading:(NSUInteger)arg4;
