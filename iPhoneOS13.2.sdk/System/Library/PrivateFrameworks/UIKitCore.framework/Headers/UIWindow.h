...
+ (void)_enumerateWindowsIncludingInternalWindows:(_Bool)arg1 onlyVisibleWindows:(_Bool)arg2 allowMutation:(_Bool)arg3 withBlock:(id /* block */)arg4;
...
@property(copy, nonatomic, setter=_setShouldPreventRotationHook:) id /* block */ _shouldPreventRotationHook; // @synthesize _shouldPreventRotationHook=__shouldPreventRotationHook;
...
@property(copy, nonatomic, setter=_setDeferredLaunchBlock:) id /* block */ _deferredLaunchBlock; // @synthesize _deferredLaunchBlock;
...
- (void)_scrollToTopViewsUnderScreenPointIfNecessary:(struct CGPoint)arg1 resultHandler:(id /* block */)arg2;
...
- (void)_updateLayerOrderingAndSetLayerHidden:(_Bool)arg1 actionBlock:(id /* block */)arg2;
