...
@property(copy, nonatomic) id /* block */ persistentSelectedIndex; // @synthesize persistentSelectedIndex=_persistentSelectedIndex;
...
@property(copy, nonatomic) id /* block */ switchToggleBlock; // @synthesize switchToggleBlock=_switchToggleBlock;
@property(copy, nonatomic) id /* block */ switchIsOnBlock; // @synthesize switchIsOnBlock=_switchIsOnBlock;
