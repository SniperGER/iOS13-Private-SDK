...
@class UITargetedPreview, UIView, UIViewController, _UIClickPresentation;
...
// - (void).cxx_destruct;
- (void)_animateUsingFluidSpringWithType:(NSUInteger)arg1 animations:(CDUnknownBlockType)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)_nonAnimatedDismissalWithReason:(NSUInteger)arg1 actions:(CDUnknownBlockType)arg2 completion:(CDUnknownBlockType)arg3;
- (void)_animateDismissalWithReason:(NSUInteger)arg1 actions:(CDUnknownBlockType)arg2 completion:(CDUnknownBlockType)arg3;
