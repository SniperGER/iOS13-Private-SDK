...
@property(copy, nonatomic) id /* block */ externalTask; // @synthesize externalTask=m_externalTask;
...
- (void)smartSelectionForTextInDocument:(id)arg1 inRange:(struct _NSRange)arg2 options:(unsigned long long)arg3 completion:(id /* block */)arg4;
