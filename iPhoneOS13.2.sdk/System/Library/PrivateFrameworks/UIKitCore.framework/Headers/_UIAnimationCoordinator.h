...
@property(copy, nonatomic) id /* block */ animator; // @synthesize animator=_animator;
@property(copy, nonatomic) id /* block */ preperation; // @synthesize preperation=_preperation;
