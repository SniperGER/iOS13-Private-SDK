...
@property(nonatomic, setter=_setDismissSourceFrame:) CGRect _dismissSourceFrame; // @synthesize _dismissSourceFrame=__dismissSourceFrame;
...
@property(nonatomic, setter=_setKeyboardFrame:) CGRect _keyboardFrame; // @synthesize _keyboardFrame=__keyboardFrame;
@property(nonatomic, setter=_setSourceFrame:) CGRect _sourceFrame; // @synthesize _sourceFrame=__sourceFrame;
...
@property(nonatomic, setter=_setContainerSafeAreaInsets:) UIEdgeInsets _containerSafeAreaInsets; // @synthesize _containerSafeAreaInsets=__containerSafeAreaInsets;
@property(nonatomic, setter=_setContainerBounds:) CGRect _containerBounds; // @synthesize _containerBounds=__containerBounds;
...
@property(readonly, nonatomic) CGAffineTransform _transform; // @synthesize _transform=__transform;
@property(readonly, nonatomic) UIRectCornerRadii _cornerRadii; // @synthesize _cornerRadii=__cornerRadii;
@property(readonly, nonatomic) CGRect _untransformedFrame; // @synthesize _untransformedFrame=__untransformedFrame;
...
@property(readonly, nonatomic) CGRect _stackAlignmentFrame; // @synthesize _stackAlignmentFrame=__stackAlignmentFrame;
@property(readonly, nonatomic) CGRect _fullHeightUntransformedFrame; // @synthesize _fullHeightUntransformedFrame=__fullHeightUntransformedFrame;
@property(readonly, nonatomic) CGRect _bottomAttachedUntransformedFrame; // @synthesize _bottomAttachedUntransformedFrame=__bottomAttachedUntransformedFrame;
@property(readonly, nonatomic) CGRect _floatingUntransformedFrame; // @synthesize _floatingUntransformedFrame=__floatingUntransformedFrame;
@property(readonly, nonatomic) CGRect _effectiveKeyboardFrame; // @synthesize _effectiveKeyboardFrame=__effectiveKeyboardFrame;
...
@property(readonly, nonatomic) CGSize _preferredSize; // @synthesize _preferredSize=__preferredSize;
