...
+ (long long)_userInterfaceIdiomForDeviceClass:(NSUInteger)arg1;
+ (void)_convertTraitCollection:(id)arg1 toCUIScale:(double )arg2 CUIIdiom:(long long )arg3 UIKitIdiom:(long long )arg4 UIKitUserInterfaceStyle:(long long )arg5 subtype:(NSUInteger )arg6 CUIDisplayGamut:(long long )arg7 UIKitLayoutDirection:(long long )arg8 CUILayoutDirection:(NSUInteger )arg9;
...
- (id)imageNamed:(id)arg1 idiom:(long long)arg2 subtype:(NSUInteger)arg3;
- (id)imageNamed:(id)arg1 scale:(double)arg2 idiom:(long long)arg3 subtype:(NSUInteger)arg4;
- (id)imageNamed:(id)arg1 configuration:(id)arg2 cachingOptions:(NSUInteger)arg3 attachCatalogImage:(BOOL)arg4;
