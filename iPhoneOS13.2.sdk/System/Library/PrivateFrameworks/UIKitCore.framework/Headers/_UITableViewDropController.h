...
@class NSIndexPath, NSMapTable, UIDropInteraction, UITableView, UITableViewDropProposal;
...
@interface _UITableViewDropController : NSObject <UIDropInteractionDelegate_Private, _UITableViewDropCoordinatorDelegate>
{
    ...
    NSUInteger _defaultDropOperation;
...
@property(nonatomic) NSUInteger defaultDropOperation; // @synthesize defaultDropOperation=_defaultDropOperation;
