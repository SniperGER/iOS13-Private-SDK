...
- (void)setStateChangeObserver:(NSUInteger)arg1 observer:(CDUnknownBlockType)arg2;
- (void)setStaticTransitionFromState:(NSUInteger)arg1 withEvent:(NSUInteger)arg2 toState:(NSUInteger)arg3;
- (void)setTransitionHandlerForState:(NSUInteger)arg1 withEvent:(NSUInteger)arg2 transitionHandler:(CDUnknownBlockType)arg3 postTransitionHandler:(CDUnknownBlockType)arg4;
- (void)setTransitionHandlerForState:(NSUInteger)arg1 withEvent:(NSUInteger)arg2 transitionHandler:(CDUnknownBlockType)arg3;
- (void)dealloc;
