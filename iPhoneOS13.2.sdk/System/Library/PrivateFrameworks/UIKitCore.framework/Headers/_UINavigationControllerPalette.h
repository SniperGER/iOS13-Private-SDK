...
@class NSArray, UINavigationController, UIViewController, _UIBarBackground, _UIBarBackgroundLayoutLegacy;
...
@property(nonatomic, setter=_setSize:) CGSize _size; // @synthesize _size=__size;
...
@property(readonly, nonatomic) NSUInteger boundaryEdge; // @synthesize boundaryEdge=_boundaryEdge;
