...
@class NSArray, NSLayoutConstraint, NSMutableArray, UIAlertAction, UIAlertController, UIAlertControllerVisualStyle, UILabel, UIVisualEffectView, _UIAlertControllerActionViewMetrics, _UIAlertControllerInterfaceActionGroupView, _UIFlexibleConstantConstraintSet, _UIKeyboardLayoutAlignmentView;
...
@property(nonatomic, getter=_layoutSize, setter=_setLayoutSize:) CGSize layoutSize; // @synthesize layoutSize=_layoutSize;
