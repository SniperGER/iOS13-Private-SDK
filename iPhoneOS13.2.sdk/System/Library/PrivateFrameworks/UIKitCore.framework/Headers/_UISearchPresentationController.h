...
@class NSMapTable, UIView, _UISearchPresentationAssistant;
...
@property(readonly, nonatomic) CGRect finalFrameForContainerView; // @synthesize finalFrameForContainerView=_finalFrameForContainerView;
