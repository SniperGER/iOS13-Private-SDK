...
- (void)__scrollToTopFromTouchAtViewLocation:(CGPoint)arg1 resultHandler:(void (^)(BOOL, NSError *))arg2;
...
- (void)__hostViewWillTransitionToSize:(CGSize)arg1 withContextDescription:(_UIViewControllerTransitionCoordinatorContextDescription *)arg2 boundingPath:(_UIBoundingPath *)arg3 statusBarHeight:(double)arg4 underlapsStatusBar:(BOOL)arg5 fence:(BKSAnimationFenceHandle *)arg6 whenDone:(void (^)(CGSize, double))arg7;
...
- (void)__setContentSize:(CGSize)arg1 boundingPath:(_UIBoundingPath *)arg2 withFence:(BKSAnimationFenceHandle *)arg3;
- (void)__setContentSize:(CGSize)arg1 boundingPath:(_UIBoundingPath *)arg2;
...
- (void)__hostViewWillAppear:(BOOL)arg1 inInterfaceOrientation:(long long)arg2 traitCollection:(UITraitCollection *)arg3 statusBarHeight:(double)arg4 underlapsStatusBar:(BOOL)arg5 completionHandler:(void (^)(CGSize))arg6;
