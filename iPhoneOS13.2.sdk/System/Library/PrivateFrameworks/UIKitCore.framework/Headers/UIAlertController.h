...
- (void)_childViewController:(id)arg1 willTransitionToSize:(struct CGSize)arg2 withAnimations:(id /* block */)arg3;
- (void)_contentViewControllerWillTransitionToSize:(struct CGSize)arg1 withAnimations:(id /* block */)arg2;
- (void)_headerContentViewControllerWillTransitionToSize:(struct CGSize)arg1 withAnimations:(id /* block */)arg2;
...
- (void)_dismissAnimated:(_Bool)arg1 triggeringAction:(id)arg2 triggeredByPopoverDimmingView:(_Bool)arg3 dismissCompletion:(id /* block */)arg4;
