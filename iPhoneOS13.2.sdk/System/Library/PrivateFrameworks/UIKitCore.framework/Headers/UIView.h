...
+ (void)modifyTrackedAnimations:(id)arg1 removeOnCompletion:(_Bool)arg2 animationFactory:(id /* block */)arg3 block:(id /* block */)arg4;
+ (void)modifyTrackedAnimations:(id)arg1 removeOnCompletion:(_Bool)arg2 copyAnimation:(_Bool)arg3 block:(id /* block */)arg4;
...
+ (void)_updateModelValuesForAnimationWithUUID:(id)arg1 useInitialValues:(_Bool)arg2 animatable:(_Bool)arg3 stateBlock:(id /* block */)arg4 animationBlock:(id /* block */)arg5;
...
+ (_Bool)_addCompletionWithPosition:(id /* block */)arg1;
+ (_Bool)_addCompletion:(id /* block */)arg1;
...
+ (void)conditionallyAnimate:(_Bool)arg1 withAnimation:(id /* block */)arg2 layout:(id /* block */)arg3 completion:(id /* block */)arg4;
...
+ (void)modifyAnimationsWithRepeatCount:(double)arg1 autoreverses:(_Bool)arg2 animations:(id /* block */)arg3;
...
+ (void)_animateUsingSpringWithDampingRatio:(double)arg1 response:(double)arg2 tracking:(_Bool)arg3 dampingRatioSmoothing:(double)arg4 responseSmoothing:(double)arg5 targetSmoothing:(double)arg6 projectionDeceleration:(double)arg7 retargetImpulse:(double)arg8 animations:(id /* block */)arg9 completion:(id /* block */)arg10;
+ (void)_animateUsingSpringWithDampingRatio:(double)arg1 response:(double)arg2 tracking:(_Bool)arg3 dampingRatioSmoothing:(double)arg4 responseSmoothing:(double)arg5 targetSmoothing:(double)arg6 projectionDeceleration:(double)arg7 animations:(id /* block */)arg8 completion:(id /* block */)arg9;
...
+ (void)_animateUsingSpringBehavior:(id)arg1 tracking:(_Bool)arg2 animations:(id /* block */)arg3 completion:(id /* block */)arg4;
+ (void)_animateUsingSpringWithTension:(double)arg1 friction:(double)arg2 interactive:(_Bool)arg3 animations:(id /* block */)arg4 completion:(id /* block */)arg5;
+ (void)_animateUsingSpringInteractive:(_Bool)arg1 animations:(id /* block */)arg2 completion:(id /* block */)arg3;
...
- (void)_setSpringLoaded:(_Bool)arg1 interactionInitializer:(id /* block */)arg2;
...
- (void)_accessibilityBeginDragAtPoint:(struct CGPoint)arg1 endpoint:(id)arg2 completion:(id /* block */)arg3;
...
- (void)_measureViewWithSize:(struct CGSize)arg1 temporaryConstraints:(id)arg2 suspendingSystemConstraints:(_Bool)arg3 withOptimizedEngineBlock:(id /* block */)arg4;
- (id)textInputView;
