...
- (void)setPressed:(_Bool)arg1 animated:(_Bool)arg2 completion:(id /* block */)arg3;
- (void)setPressed:(_Bool)arg1 animated:(_Bool)arg2;
@property(nonatomic, getter=isPressed) _Bool pressed;
- (void)_setControlState:(unsigned long long)arg1 animated:(_Bool)arg2 focusAnimationCoordinator:(id)arg3 completion:(id /* block */)arg4;
