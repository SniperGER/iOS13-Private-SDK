...
@interface _UIPreviewInteractionViewControllerPresentation : NSObject
{
    ...
    id /* CDUnknownBlockType */ _privatePresentationBlock;
    id /* CDUnknownBlockType */ _privatePresentationCompletionBlock;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ privatePresentationCompletionBlock; // @synthesize privatePresentationCompletionBlock=_privatePresentationCompletionBlock;
@property(copy, nonatomic) id /* CDUnknownBlockType */ privatePresentationBlock; // @synthesize privatePresentationBlock=_privatePresentationBlock;
