...
- (void)userSelectedSceneWithToken:(id)arg1 onCompletion:(id /* block */)arg2;
- (void)userSelectedProcessIdentifier:(int)arg1 sceneDeferringToken:(id)arg2 onCompletion:(id /* block */)arg3;
- (void)userSelectedApp:(id)arg1 onCompletion:(id /* block */)arg2;
- (void)forceKeyboardAway;
- (void)queue_setKeyboardDisabled:(_Bool)arg1 withCompletion:(id /* block */)arg2;
...
- (void)queue_keyboardSuppressed:(_Bool)arg1 withCompletion:(id /* block */)arg2;
