...
@property(readonly, nonatomic, getter=_hasAmbiguousIndexPath) _Bool hasAmbiguousIndexPath; // @synthesize hasAmbiguousIndexPath=_hasAmbiguousIndexPath;
...
- (void)updateLayout;
- (void)_resetItemWithSwipeInfo:(CDStruct_9b6dff2a)arg1 animated:(_Bool)arg2 deletion:(_Bool)arg3 completion:(id /* block */)arg4;
- (void)resetAnimated:(_Bool)arg1 completion:(id /* block */)arg2;
- (void)_moveItemWithSwipeInfo:(CDStruct_9b6dff2a)arg1 completion:(id /* block */)arg2;
- (struct CGRect)swipedViewRestingFrame;
- (void)updateOffsetWithSwipeInfo:(CDStruct_9b6dff2a)arg1 isTracking:(_Bool)arg2 completion:(id /* block */)arg3;
- (void)endSwipe;
- (void)_forceTeardown;
- (void)beginSwipe;
