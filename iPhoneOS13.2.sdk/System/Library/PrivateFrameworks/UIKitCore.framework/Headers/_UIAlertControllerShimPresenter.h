...
- (void)_dismissAlertControllerAnimated:(_Bool)arg1 completion:(id /* block */)arg2;
- (void)_presentAlertControllerFromRect:(struct CGRect)arg1 inView:(id)arg2 direction:(unsigned long long)arg3 animated:(_Bool)arg4 completion:(id /* block */)arg5;
- (void)_presentAlertControllerFromBarButtonItem:(id)arg1 animated:(_Bool)arg2 completion:(id /* block */)arg3;
- (void)_presentAlertControllerAnimated:(_Bool)arg1 completion:(id /* block */)arg2;
- (void)_presentAlertControllerAnimated:(_Bool)arg1 hostingScene:(id)arg2 completion:(id /* block */)arg3;
