...
@property(copy, nonatomic, setter=_setPostInteractiveCompletionHandler:) id /* block */ _postInteractiveCompletionHandler; // @synthesize _postInteractiveCompletionHandler=__postInteractiveCompletionHandler;
@property(copy, nonatomic, setter=_setInteractiveUpdateHandler:) id /* block */ _interactiveUpdateHandler; // @synthesize _interactiveUpdateHandler=__interactiveUpdateHandler;
...
@property(copy, nonatomic, setter=_setDidCompleteHandler:) id /* block */ _didCompleteHandler; // @synthesize _didCompleteHandler=__didCompleteHandler;
...
@property(copy, nonatomic, setter=_setWillCompleteHandler:) id /* block */ _willCompleteHandler; // @synthesize _willCompleteHandler=__willCompleteHandler;
