...
@property(copy, nonatomic) id /* block */ enqueuedTask; // @synthesize enqueuedTask=_enqueuedTask;
...
@property(readonly, nonatomic) id /* block */ task; // @synthesize task=_task;
- (void)resetTimer;
- (void)invalidate;
- (_Bool)isValid;
...
- (id)initWithTaskQueue:(id)arg1 timeInterval:(double)arg2 repeats:(_Bool)arg3 task:(id /* block */)arg4;
- (void)dealloc;
