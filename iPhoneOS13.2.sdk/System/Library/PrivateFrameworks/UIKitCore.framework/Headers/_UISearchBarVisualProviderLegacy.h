...
@property(nonatomic) UIEdgeInsets minimumContentInset; // @synthesize minimumContentInset=_minimumContentInsetPrivate;
...
- (void)setUpSearchNavigationItemWithSizingOption:(NSUInteger)arg1;
