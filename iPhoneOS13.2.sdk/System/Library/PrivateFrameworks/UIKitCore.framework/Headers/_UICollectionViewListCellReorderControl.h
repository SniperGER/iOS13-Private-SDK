...
@property(copy, nonatomic) id /* block */ grabberImageProvider; // @synthesize grabberImageProvider=_grabberImageProvider;
...
- (void)layoutSubviews;
- (id)initWithFrame:(struct CGRect)arg1 grabberImageProvider:(id /* block */)arg2;
