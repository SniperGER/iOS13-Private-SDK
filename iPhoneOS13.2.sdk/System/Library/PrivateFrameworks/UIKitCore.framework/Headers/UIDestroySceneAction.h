...
- (id)initWithPersistedIdentifiers:(id)arg1 preferredAnimationType:(unsigned long long)arg2 forDestroyingSession:(_Bool)arg3 callbackQueue:(id)arg4 completion:(id /* block */)arg5;
