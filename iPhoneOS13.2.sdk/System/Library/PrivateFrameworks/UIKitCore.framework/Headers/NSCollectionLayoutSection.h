...
@property(copy, nonatomic) id /* block */ visibleItemsInvalidationHandler; // @synthesize visibleItemsInvalidationHandler=_visibleItemsInvalidationHandler;
...
- (id)initWithGroup:(id)arg1 contentInsets:(struct NSDirectionalEdgeInsets)arg2 supplementaryItems:(id)arg3 boundarySupplementartItems:(id)arg4 pinnedSupplementaryItemIndexes:(id)arg5 interGroupSpacing:(double)arg6 visibleItemsInvalidationHandler:(id /* block */)arg7 supplementariesFollowInsets:(_Bool)arg8 decorationItems:(id)arg9 orthogonalScrollingBehavior:(long long)arg10 isEmptySection:(_Bool)arg11 prefersListSolver:(_Bool)arg12;
