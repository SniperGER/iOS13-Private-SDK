...
- (void)dealloc;
- (id)initWithPageCurl:(id)arg1 andCurlType:(long long)arg2 fromLocation:(CGPoint)arg3 withRef erenceLocation:(CGPoint)arg4 inDirection:(long long)arg5 withView:(id)arg6 revealingView:(id)arg7 completion:(CDUnknownBlockType)arg8 finally:(CDUnknownBlockType)arg9;
