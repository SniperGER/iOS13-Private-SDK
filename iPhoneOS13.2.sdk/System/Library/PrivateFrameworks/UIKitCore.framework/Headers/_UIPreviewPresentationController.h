...
@class NSArray, NSLayoutConstraint, UIGestureRecognizer, UIImageView, UIInteractionProgress, UIPreviewAction, UIPreviewForceInteractionProgress, UIPreviewInteractionController, UIScrollView, UITapGestureRecognizer, UIView, UIWindow, _UIPlatterMenuDynamicsController, _UIPreviewActionSheetView, _UIPreviewPresentationAnimator, _UIPreviewPresentationContainerView, _UIPreviewPresentationEffectView, _UIPreviewQuickActionView, _UIStatesFeedbackGenerator, _UIVelocityIntegrator;
...
@interface _UIPreviewPresentationController : UIPreviewPresentationController <UIInteractionProgressObserver, _UIPreviewActionSheetViewDelegate, _UIPlatterMenuDynamicsControllerDelegate, UIForcePresentationController>
{
    ...
    NSUInteger _currentPresentationPhase;
...
@property(nonatomic) NSUInteger currentPresentationPhase; // @synthesize currentPresentationPhase=_currentPresentationPhase;
