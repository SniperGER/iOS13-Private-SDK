...
@interface _UIStackedImageConfiguration : NSObject <NSCopying>
{
    ...
    NSUInteger _maximumParallaxImages;
...
@property(nonatomic) CGPoint translationOffset; // @synthesize translationOffset=_translationOffset;
...
@property(nonatomic) NSUInteger maximumParallaxImages; // @synthesize maximumParallaxImages=_maximumParallaxImages;
// - (void).cxx_destruct;
