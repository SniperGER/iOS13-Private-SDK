...
@property(copy, nonatomic) id /* block */ collectionViewCellConfigurationHandler; // @synthesize collectionViewCellConfigurationHandler=_collectionViewCellConfigurationHandler;
@property(copy, nonatomic) id /* block */ reuseIdentifierProvider; // @synthesize reuseIdentifierProvider=_reuseIdentifierProvider;
@property(copy, nonatomic) id /* block */ tableViewCellConfigurationHandler; // @synthesize tableViewCellConfigurationHandler=_tableViewCellConfigurationHandler;
@property(copy, nonatomic) id /* block */ collectionViewCellProvider; // @synthesize collectionViewCellProvider=_collectionViewCellProvider;
@property(copy, nonatomic) id /* block */ supplementaryViewConfigurationHandler; // @synthesize supplementaryViewConfigurationHandler=_supplementaryViewConfigurationHandler;
@property(copy, nonatomic) id /* block */ supplementaryReuseIdentifierProvider; // @synthesize supplementaryReuseIdentifierProvider=_supplementaryReuseIdentifierProvider;
@property(copy, nonatomic) id /* block */ supplementaryViewProvider; // @synthesize supplementaryViewProvider=_supplementaryViewProvider;
@property(copy, nonatomic) id /* block */ tableViewCellProvider; // @synthesize tableViewCellProvider=_tableViewCellProvider;
...
- (void)applyDifferencesFromSnapshot:(id)arg1 animatingDifferences:(_Bool)arg2 completion:(id /* block */)arg3;
