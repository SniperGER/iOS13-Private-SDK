...
@class NSArray, NSHashTable, NSMapTable, NSMutableArray, NSMutableSet, NSSet, UIDragInteraction, _UIInternalDraggingSessionSource;
...
- (void)draggingSessionDidEnd:(id)arg1 withOperation:(NSUInteger)arg2;
- (void)draggingSessionWillEnd:(id)arg1 withOperation:(NSUInteger)arg2;
...
- (NSUInteger)draggingSession:(id)arg1 sourceOperationMaskForDraggingWithinApp:(BOOL)arg2;
