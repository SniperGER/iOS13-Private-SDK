...
- (void)_endInteractionDidComplete:(_Bool)arg1 completion:(id /* block */)arg2;
...
- (void)_beginDragIfPossibleWithTouch:(id)arg1 previewProvider:(id /* block */)arg2 fenceHandler:(id /* block */)arg3;
...
- (void)_clickInteraction:(id)arg1 shouldBegin:(id /* block */)arg2;
