...
+ (_Bool)_allViewControllersInArray:(id)arg1 allowAutorotationToInterfaceOrientation:(long long)arg2 predicate:(id /* block */)arg3;
...
+ (void)_performWithoutDeferringTransitionsAllowingAnimation:(_Bool)arg1 actions:(id /* block */)arg2;
...
+ (void)_withDisabledAppearanceTransitions:(_Bool)arg1 forDescendantsOf:(id)arg2 visibleOnly:(_Bool)arg3 perform:(id /* block */)arg4;
...
- (_Bool)__withSupportedInterfaceOrientation:(long long)arg1 apply:(id /* block */)arg2;
...
- (void)_performCoordinatedPresentOrDismiss:(id /* block */)arg1 animated:(_Bool)arg2;
- (void)presentViewController:(id)arg1 animated:(_Bool)arg2 completion:(id /* block */)arg3;
- (void)_presentViewController:(id)arg1 animated:(_Bool)arg2 completion:(id /* block */)arg3;
...
- (_Bool)_doesSelfOrAncestorPassPredicate:(id /* block */)arg1;
...
@property(copy, nonatomic) id /* block */ afterAppearanceBlock; // @synthesize afterAppearanceBlock=_afterAppearance;
- (void)_addDescendantsToArray:(id)arg1 visibleOnly:(_Bool)arg2;
@property(nonatomic) _Bool appearanceTransitionsAreDisabled;
- (_Bool)_endAppearanceTransition:(id /* block */)arg1;
...
- (void)_enumerateVisibleChildControllers:(_Bool)arg1 includePresentedChildren:(_Bool)arg2 usingBlock:(id /* block */)arg3;
- (id)_barBackdropGroupNameForAncestorViewController:(id *)arg1;
- (void)_enumerateAncestorViewControllersUntilStop:(_Bool *)arg1 usingBlock:(id /* block */)arg2;
