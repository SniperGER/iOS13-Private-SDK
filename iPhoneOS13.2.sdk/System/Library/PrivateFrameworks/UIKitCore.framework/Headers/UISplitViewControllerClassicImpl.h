...
@property(copy, nonatomic, setter=_setClearPreventRotationHook:) id /* block */ _clearPreventRotationHook; // @synthesize _clearPreventRotationHook=__clearPreventRotationHook;
