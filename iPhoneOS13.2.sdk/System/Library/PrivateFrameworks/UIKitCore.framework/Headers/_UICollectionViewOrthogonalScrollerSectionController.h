...
@class NSHashTable, NSIndexSet, NSMapTable, UICollectionView, UIScrollView;
...
- (void)_scrollToItemAtIndexPath:(id)arg1 atScrollPosition:(NSUInteger)arg2 animated:(BOOL)arg3;
