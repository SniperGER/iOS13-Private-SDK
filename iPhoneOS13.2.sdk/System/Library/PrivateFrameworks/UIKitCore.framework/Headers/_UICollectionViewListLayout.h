...
@property(nonatomic) UIEdgeInsets separatorInset; // @synthesize separatorInset=_separatorInset;
...
- (CGPoint)_contentOffsetFromProposedContentOffset:(CGPoint)arg1 forScrollingToItemAtIndexPath:(id)arg2 atScrollPosition:(NSUInteger)arg3;
