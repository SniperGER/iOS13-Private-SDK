...
@interface _UICollectionViewDropCoordinatorItem : NSObject <UIDragAnimating>
{
    ...
    id /* CDUnknownBlockType */ _previewParametersProvider;
}

@property(copy, nonatomic) id /* CDUnknownBlockType */ previewParametersProvider; // @synthesize previewParametersProvider=_previewParametersProvider;
