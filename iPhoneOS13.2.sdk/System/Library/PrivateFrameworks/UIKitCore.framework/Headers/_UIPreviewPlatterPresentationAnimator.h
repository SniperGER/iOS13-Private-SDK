...
@property(copy, nonatomic) id /* block */ accessoryAnimationBlock; // @synthesize accessoryAnimationBlock=_accessoryAnimationBlock;
@property(copy, nonatomic) id /* block */ backgroundAnimationBlock; // @synthesize backgroundAnimationBlock=_backgroundAnimationBlock;
@property(copy, nonatomic) id /* block */ reparentingAnimationBlock; // @synthesize reparentingAnimationBlock=_reparentingAnimationBlock;
