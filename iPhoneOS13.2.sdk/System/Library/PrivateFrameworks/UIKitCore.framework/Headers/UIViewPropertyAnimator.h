...
- (id)initWithMass:(double)arg1 stiffness:(double)arg2 damping:(double)arg3 initialVelocity:(struct CGVector)arg4 animations:(id /* block */)arg5;
- (id)initWithDuration:(double)arg1 dampingRatio:(double)arg2 animations:(id /* block */)arg3;
- (id)initWithDuration:(double)arg1 controlPoint1:(struct CGPoint)arg2 controlPoint2:(struct CGPoint)arg3 animations:(id /* block */)arg4;
