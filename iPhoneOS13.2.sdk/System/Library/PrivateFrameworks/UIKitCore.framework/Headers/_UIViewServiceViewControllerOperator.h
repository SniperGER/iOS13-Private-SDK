...
- (void)__hostViewWillTransitionToSize:(CGSize)arg1 withContextDescription:(id)arg2 boundingPath:(id)arg3 statusBarHeight:(double)arg4 underlapsStatusBar:(BOOL)arg5 fence:(id)arg6 whenDone:(CDUnknownBlockType)arg7;
...
- (void)__scrollToTopFromTouchAtViewLocation:(CGPoint)arg1 resultHandler:(CDUnknownBlockType)arg2;
