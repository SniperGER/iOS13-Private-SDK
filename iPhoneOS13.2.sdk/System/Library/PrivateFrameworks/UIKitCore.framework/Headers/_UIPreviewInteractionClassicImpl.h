...
@class CADisplayLink, UIPreviewInteraction, UIView, _UIDeepPressAnalyzer, _UIPreviewInteractionHighlighter, _UIPreviewInteractionStateRecognizer, _UIPreviewInteractionViewControllerHelper, _UIStatesFeedbackGenerator;
...
@interface _UIPreviewInteractionClassicImpl : NSObject <_UIPreviewInteractionImpl>
{
    ...
    CGPoint _sceneRef erenceLocationFromLatestUpdate;
