...
@class UISearchBarTextField, UIView, _UISearchBarPromptContainerView, _UISearchBarScopeContainerLayout, _UISearchBarScopeContainerView, _UISearchBarSearchContainerLayout, _UISearchBarSearchContainerView;
...
@property(readonly, nonatomic) CGRect separatorLayoutFrame; // @synthesize separatorLayoutFrame=_separatorLayoutFrame;
@property(readonly, nonatomic) CGRect searchBarBackgroundLayoutFrame; // @synthesize searchBarBackgroundLayoutFrame=_searchBarBackgroundLayoutFrame;
@property(readonly, nonatomic) CGRect scopeBarContainerLayoutFrame; // @synthesize scopeBarContainerLayoutFrame=_scopeBarContainerLayoutFrame;
@property(readonly, nonatomic) CGRect searchFieldContainerLayoutFrame; // @synthesize searchFieldContainerLayoutFrame=_searchFieldContainerLayoutFrame;
@property(readonly, nonatomic) CGRect promptContainerLayoutFrame; // @synthesize promptContainerLayoutFrame=_promptContainerLayoutFrame;
