...
@interface _UIDragSetDownItemAnimation : NSObject
{
    ...
    id /* CDUnknownBlockType */ _positionHandler;
    id /* CDUnknownBlockType */ _morphHandler;
    id /* CDUnknownBlockType */ _midpointHandler;
    id /* CDUnknownBlockType */ _nonAnimatedMidpointHandler;
    id /* CDUnknownBlockType */ _nearCompletionHandler;
    CGPoint _center;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ nearCompletionHandler; // @synthesize nearCompletionHandler=_nearCompletionHandler;
@property(copy, nonatomic) id /* CDUnknownBlockType */ nonAnimatedMidpointHandler; // @synthesize nonAnimatedMidpointHandler=_nonAnimatedMidpointHandler;
@property(copy, nonatomic) id /* CDUnknownBlockType */ midpointHandler; // @synthesize midpointHandler=_midpointHandler;
@property(copy, nonatomic) id /* CDUnknownBlockType */ morphHandler; // @synthesize morphHandler=_morphHandler;
@property(copy, nonatomic) id /* CDUnknownBlockType */ positionHandler; // @synthesize positionHandler=_positionHandler;
...
@property(nonatomic) CGPoint initialTargetVelocity; // @synthesize initialTargetVelocity=_initialTargetVelocity;
@property(nonatomic) CGPoint initialVelocity; // @synthesize initialVelocity=_initialVelocity;
...
@property(nonatomic) CGRect targetFrame; // @synthesize targetFrame=_targetFrame;
