...
- (void)_simulateScrollWithTranslation:(struct CGPoint)arg1 duration:(double)arg2 willBeginDragging:(id /* block */)arg3 didEndDragging:(id /* block */)arg4 willBeginDecelerating:(id /* block */)arg5 didEndDecelerating:(id /* block */)arg6;
