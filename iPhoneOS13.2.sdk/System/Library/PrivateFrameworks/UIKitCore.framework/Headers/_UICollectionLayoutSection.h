...
@property(copy, nonatomic) id /* block */ visibleItemsTransformer; // @synthesize visibleItemsTransformer=_visibleItemsTransformer;
...
- (id)initWithLayoutGroup:(id)arg1 contentInsets:(struct NSDirectionalEdgeInsets)arg2 interGroupSpacing:(double)arg3 orthogonalScrollingBehavior:(long long)arg4 boundarySupplementaryItems:(id)arg5 supplementariesFollowContentInsets:(_Bool)arg6 visibleItemsTransformer:(id /* block */)arg7 decorationItems:(id)arg8 supplementaryItems:(id)arg9 pinnedSupplementaryItemIndexes:(id)arg10;
