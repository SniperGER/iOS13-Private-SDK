...
@class NSArray, NSMutableArray, NSMutableDictionary, TIMobileAssetTimer, TIRequestedInputModes;
...
@interface TIAssetManager : NSObject <TIAssetManaging>
{
    ...
    id /* CDUnknownBlockType */ _enabledInputModeIdentifiersProviderBlock;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ enabledInputModeIdentifiersProviderBlock; // @synthesize enabledInputModeIdentifiersProviderBlock=_enabledInputModeIdentifiersProviderBlock;
// - (void).cxx_destruct;
