...
@interface TIWordSearchOperationGetCandidates : TIWordSearchOperation
{
    ...
    id _target;
    SEL _action;
    NSUInteger _segmentBreakIndex;
    NSUInteger _autocapitalizationType;
...
@property(readonly, nonatomic) NSUInteger autocapitalizationType; // @synthesize autocapitalizationType=_autocapitalizationType;
...
@property(nonatomic) NSUInteger segmentBreakIndex; // @synthesize segmentBreakIndex=_segmentBreakIndex;
...
- (void)dealloc;
- (id)initWithWordSearch:(id)arg1 inputString:(id)arg2 keyboardInput:(id)arg3 segmentBreakIndex:(NSUInteger)arg4 predictionEnabled:(BOOL)arg5 reanalysisMode:(BOOL)arg6 autocapitalizationType:(NSUInteger)arg7 target:(id)arg8 action:(SEL)arg9 geometryModelData:(id)arg10 hardwareKeyboardMode:(BOOL)arg11 logger:(id)arg12;
