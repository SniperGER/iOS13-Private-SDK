...
- (void)trackSelectedWithSource:(unsigned char)arg1 position:(NSUInteger)arg2 categories:(id)arg3 locale:(id)arg4 fieldType:(id)arg5;
...
- (void)trackSuggestedWithSource:(unsigned char)arg1 count:(NSUInteger)arg2 categories:(id)arg3 locale:(id)arg4 fieldType:(id)arg5;
