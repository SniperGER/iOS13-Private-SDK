...
@property(nonatomic) NSUInteger sensorKitWordsThreshold; // @synthesize sensorKitWordsThreshold=_sensorKitWordsThreshold;
...
@property(nonatomic) NSUInteger maxWordsPerPrediction; // @synthesize maxWordsPerPrediction=_maxWordsPerPrediction;
