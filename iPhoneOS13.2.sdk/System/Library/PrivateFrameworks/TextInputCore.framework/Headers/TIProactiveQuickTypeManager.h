...
- (BOOL)isEnabled;
- (void)reset;
- (NSUInteger)matchProactiveCandidateToUserInput:(id)arg1 userInput:(id)arg2;
- (void)loggingProactiveEngagementMetric:(NSUInteger)arg1 withLocale:(id)arg2 fieldType:(id)arg3;
