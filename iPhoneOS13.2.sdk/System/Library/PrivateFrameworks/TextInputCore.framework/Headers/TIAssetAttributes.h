...
+ (_Bool)_anyDictionaryIn:(id)arg1 matches:(id)arg2 shouldLenientlyMatch:(id /* block */)arg3;
...
- (_Bool)containMatchingRegionIn:(id)arg1 shouldLenientlyMatchRegion:(id /* block */)arg2;
