...
+ (void)_drawLineFromCellAtIndex:(NSUInteger)arg1 ofResponse:(id)arg2 atYCoordinate:(double)arg3 inContext:(CGContextRef )arg4 withAvailableWidth:(double)arg5;
...
+ (double)_totalWidthForCell:(NSUInteger)arg1 fromTextRunResponses:(id)arg2;
+ (id)requestLayoutForTextRuns:(id)arg1 inWidthGroups:(id)arg2 steps:(NSUInteger)arg3;
+ (id)_requestLayoutForSimplifiedTextRuns:(id)arg1 inWidthGroups:(id)arg2 steps:(NSUInteger)arg3;
+ (void)_handleEllipsisTruncationForTextRuns:(id)arg1 textRunResponses:(id)arg2 inAvailableWidth:(double)arg3;
//  (struct __CFAttributedString )_newAttributedStringWithText:(id)arg1 font:(struct __CTFont )arg2 color:(CGColorRef)arg3;
