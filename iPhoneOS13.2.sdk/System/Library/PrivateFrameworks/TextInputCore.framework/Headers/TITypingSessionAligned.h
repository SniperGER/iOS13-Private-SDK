...
@interface TITypingSessionAligned : NSObject <NSSecureCoding>
{
    ...
    NSUInteger _firstCPEntryIndex;
}

+ (id)alignedPathTouchesForWord:(id)arg1;
+ (id)alignedEntryForWord:(id)arg1;
+ (BOOL)supportsSecureCoding;
@property(nonatomic) NSUInteger firstCPEntryIndex; // @synthesize firstCPEntryIndex=_firstCPEntryIndex;
...
- (id)textToAppendForEntry:(id)arg1 sessionIndx:(NSUInteger)arg2;
- (void)getAlignedTextAndConfidence;
- (BOOL)compareForConfidenceContextA:(id)arg1 contextB:(id)arg2;
- (id)initWithSession:(id)arg1;
- (id)restrictedAlignedSessionWithWordLimit:(NSUInteger)arg1;
