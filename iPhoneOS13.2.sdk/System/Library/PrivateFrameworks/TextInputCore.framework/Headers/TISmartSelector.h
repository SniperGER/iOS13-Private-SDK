...
@property(copy) id /* block */ dataChangedHandler; // @synthesize dataChangedHandler=_dataChangedHandler;
...
- (struct _NSRange)longestRangeEncapsulatingSubstringInDocument:(id)arg1 containingRange:(struct _NSRange)arg2 tokenizedRanges:(id)arg3 meetingCondition:(id /* block */)arg4;
