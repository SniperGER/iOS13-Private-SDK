...
- (void)generateResponseKitSuggestionsForString:(NSString *)arg1 withLanguage:(NSString *)arg2 withClientID:(NSString *)arg3 withRecipientID:(NSString *)arg4 withAdditionalPredictions:(TIAutocorrectionList *)arg5 desiredCandidateCount:(NSUInteger)arg6 shouldDisableAutoCaps:(BOOL)arg7 stringIsBlacklisted:(BOOL)arg8 async:(BOOL)arg9 completionHandler:(void (^)(TIAutocorrectionList *))arg10;
@end
