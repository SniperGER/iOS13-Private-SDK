...
- (id)initWithDownload:(id)arg1 autoInstallOperation:(id)arg2 forInstallTonight:(_Bool)arg3 canDeferInstallation:(_Bool)arg4 completionQueue:(id)arg5 completionBlock:(id /* block */)arg6;
