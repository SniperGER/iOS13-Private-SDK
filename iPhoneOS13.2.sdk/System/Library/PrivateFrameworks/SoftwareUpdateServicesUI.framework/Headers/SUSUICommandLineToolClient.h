...
- (void)showEmergencyCallUIWithOptions:(NSUInteger)arg1 result:(CDUnknownBlockType)arg2;
- (void)showAuthenticationUIWithOptions:(NSUInteger)arg1 result:(CDUnknownBlockType)arg2;
