...
@property(copy, nonatomic) id /* block */ cancellationBlock; // @synthesize cancellationBlock=_cancellationBlock;
@property(copy, nonatomic) id /* block */ progressBlock; // @synthesize progressBlock=_progressBlock;
@property(copy, nonatomic) id /* block */ executionBlock; // @synthesize executionBlock=_executionBlock;
