...
- (int)authenticateAuditToken:(CDStruct_6ad76789 *)arg1 forEntitlement:(id)arg2 withResult:(id /* block */)arg3;
- (int)authenticateClient:(id)arg1 withResult:(id /* block */)arg2;
- (int)authenticateAuditToken:(CDStruct_6ad76789 *)arg1 withResult:(id /* block */)arg2;
