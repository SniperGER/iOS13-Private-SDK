...
- (void)_reallyActivateApplication:(id)arg1 requestID:(id)arg2 options:(id)arg3 source:(id)arg4 originalSource:(id)arg5 isTrusted:(BOOL)arg6 sequenceNumber:(NSUInteger)arg7 cacheGUID:(id)arg8 ourSequenceNumber:(NSUInteger)arg9 ourCacheGUID:(id)arg10 withResult:(CDUnknownBlockType)arg11;
