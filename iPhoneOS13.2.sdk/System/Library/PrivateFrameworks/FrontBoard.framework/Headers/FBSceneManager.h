...
- (void)_enqueueObserverCalloutsForScene:(id)arg1 eventName:(id)arg2 preferInternal:(_Bool)arg3 sceneObserverBlock:(id /* block */)arg4 sceneManagerObserverBlock:(id /* block */)arg5;
...
- (id)_createSceneWithDefinition:(id)arg1 initialParameters:(id)arg2 clientProvider:(id)arg3 transitionContext:(id)arg4 completion:(id /* block */)arg5;
