...
// - (void).cxx_destruct;
- (void)_observableAtIndex:(NSUInteger)arg1 didFailWithError:(id)arg2 observer:(id)arg3;
- (void)_observableAtIndex:(NSUInteger)arg1 didCompleteForObserver:(id)arg2;
- (void)_observableAtIndex:(NSUInteger)arg1 receivedResult:(id)arg2 observer:(id)arg3;
