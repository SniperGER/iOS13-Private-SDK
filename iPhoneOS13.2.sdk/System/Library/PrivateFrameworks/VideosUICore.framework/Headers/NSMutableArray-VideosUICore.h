...
- (_Bool)vui_applyChangeSet:(id)arg1 destinationObjectsBlock:(id /* block */)arg2 updateObjectBlock:(id /* block */)arg3;
- (_Bool)vui_applyChangeSet:(id)arg1 destinationObjectsBlock:(id /* block */)arg2;
- (_Bool)vui_applyChangeSet:(id)arg1 destinationObjects:(id)arg2 updateObjectBlock:(id /* block */)arg3;
