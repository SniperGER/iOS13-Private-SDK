...
- (void)dd_makeLinksForResultsInAttributesOfType:(unsigned long long)arg1 usingURLificationBlock:(id /* block */)arg2 context:(id)arg3 range:(struct _NSRange)arg4;
- (_Bool)dd_urlifyClientRange:(struct _NSRange)arg1 index:(unsigned long long)arg2 context:(id)arg3;
- (_Bool)dd_urlifyResult:(id)arg1 withBlock:(id /* block */)arg2 referenceDate:(id)arg3 context:(id)arg4;
