...
- (id)attributedTitleForResultAtIndex:(NSUInteger)arg1 ofStorage:(id)arg2 updaterBlock:(CDUnknownBlockType)arg3;
...
- (id)_applyBlock:(CDUnknownBlockType)arg1 withResultsAtIndex:(NSUInteger)arg2 ofStorage:(id)arg3 context:(id)arg4;
...
- (id)_resultForLinkAtIndex:(NSUInteger)arg1 inTextStorage:(id)arg2 subResult:(id )arg3 url:(id )arg4 effectiveRange:(NSRange * )arg5;
