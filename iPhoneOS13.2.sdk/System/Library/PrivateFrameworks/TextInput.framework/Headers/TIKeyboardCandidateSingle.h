...
+ (int)type;
+ (id)secureCandidateForInput:(id)arg1 slotID:(unsigned int)arg2 customInfoType:(NSUInteger)arg3;
...
+ (id)candidateWithCandidate:(id)arg1 forInput:(id)arg2 customInfoType:(NSUInteger)arg3;
