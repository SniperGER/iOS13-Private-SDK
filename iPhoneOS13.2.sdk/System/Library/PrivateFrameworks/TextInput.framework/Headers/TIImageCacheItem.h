...
+ (id)cacheItemWithSize:(struct CGSize)arg1 format:(unsigned char)arg2 formatColor:(struct CGColor *)arg3 scale:(double)arg4 data:(id)arg5 dataReleaseHandler:(id /* block */)arg6;
...
@property(copy, nonatomic) id /* block */ dataReleaseHandler; // @synthesize dataReleaseHandler=_dataReleaseHandler;
