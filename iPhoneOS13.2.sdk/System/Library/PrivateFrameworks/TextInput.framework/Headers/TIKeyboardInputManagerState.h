...
@interface TIKeyboardInputManagerState : NSObject <NSCopying, NSSecureCoding>
{
    ...
    NSUInteger _initialCandidateBatchCount;
...
@property(nonatomic) NSUInteger initialCandidateBatchCount; // @synthesize initialCandidateBatchCount=_initialCandidateBatchCount;
...
@property(nonatomic) NSUInteger inputIndex; // @synthesize inputIndex=_inputIndex;
@property(nonatomic) NSUInteger inputCount; // @synthesize inputCount=_inputCount;
