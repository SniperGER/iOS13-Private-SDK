...
- (void)_reverseEnumerateLongCharactersInRange:(NSRange *)arg1 usingBlock:(CDUnknownBlockType)arg2;
- (void)_enumerateLongCharactersInRange:(NSRange *)arg1 usingBlock:(CDUnknownBlockType)arg2;
