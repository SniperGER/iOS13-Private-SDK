...
- (id)_stringByComposingDiacriticsLogicalOrder:(_Bool)arg1 allowedCharacters:(id /* block */)arg2;
...
- (void)_reverseEnumerateLongCharactersInRange:(struct _NSRange)arg1 usingBlock:(id /* block */)arg2;
- (void)_enumerateLongCharactersInRange:(struct _NSRange)arg1 usingBlock:(id /* block */)arg2;
