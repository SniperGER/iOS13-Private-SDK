...
- (void)smartSelectionForTextInDocument:(id)arg1 inRange:(NSRange *)arg2 language:(id)arg3 tokenizedRanges:(id)arg4 options:(NSUInteger)arg5 completion:(CDUnknownBlockType)arg6;
...
- (void)generateAutocorrectionsWithKeyboardState:(id)arg1 candidateRange:(NSRange *)arg2 requestToken:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;
- (void)generateAutocorrectionsWithKeyboardState:(id)arg1 candidateRange:(NSRange *)arg2 completionHandler:(CDUnknownBlockType)arg3;
