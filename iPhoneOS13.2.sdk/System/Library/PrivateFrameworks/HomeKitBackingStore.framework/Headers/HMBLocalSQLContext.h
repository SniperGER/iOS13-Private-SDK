...
- (id)flush:(_Bool)arg1;
- (_Bool)_deleteIndexSentinelsWithZoneRow:(unsigned long long)arg1 error:(id *)arg2;
...
- (_Bool)_insertIndexSentinelWithZoneRow:(unsigned long long)arg1 modelType:(id)arg2 error:(id *)arg3;
- (_Bool)_deleteNullItemsWithZoneRow:(unsigned long long)arg1 error:(id *)arg2;
- (_Bool)_deleteNullItemsWithZoneRow:(unsigned long long)arg1 type:(unsigned long long)arg2 error:(id *)arg3;
...
- (_Bool)_deleteItemWithZoneRow:(unsigned long long)arg1 type:(unsigned long long)arg2 externalID:(id)arg3 error:(id *)arg4;
- (_Bool)_deleteItemWithZoneRow:(unsigned long long)arg1 error:(id *)arg2;
- (_Bool)_deleteItemsWithBlockRow:(unsigned long long)arg1 error:(id *)arg2;
- (_Bool)_deleteItemWithRow:(unsigned long long)arg1 error:(id *)arg2;
- (_Bool)_updateItemWithZoneRow:(unsigned long long)arg1 blockRow:(unsigned long long)arg2 type:(unsigned long long)arg3 externalID:(id)arg4 externalData:(id)arg5 modelEncoding:(unsigned long long)arg6 modelData:(id)arg7 error:(id *)arg8;
...
- (_Bool)_deleteNullBlocksWithZoneRow:(unsigned long long)arg1 error:(id *)arg2;
...
- (_Bool)_updateBlockWithRow:(unsigned long long)arg1 options:(id)arg2 error:(id *)arg3;
- (_Bool)_deleteBlocksWithZoneRow:(unsigned long long)arg1 error:(id *)arg2;
- (_Bool)_deleteBlockWithRow:(unsigned long long)arg1 error:(id *)arg2;
- (unsigned long long)_insertBlockWithZoneRow:(unsigned long long)arg1 type:(unsigned long long)arg2 error:(id *)arg3;
- (_Bool)_updateZoneWithRow:(unsigned long long)arg1 replication:(id)arg2 error:(id *)arg3;
- (id)_selectZoneWithRow:(unsigned long long)arg1 error:(id *)arg2;
- (id)_fetchAllZones:(id *)arg1;
- (_Bool)_deleteZoneWithRow:(unsigned long long)arg1 error:(id *)arg2;
...
- (id)initialize;
- (id)prepare;
- (_Bool)sqlTransactionWithActivity:(id)arg1 error:(id *)arg2 block:(id /* block */)arg3;
- (_Bool)sqlBlockWithActivity:(id)arg1 error:(id *)arg2 block:(id /* block */)arg3;
...
- (_Bool)_resetOutputForRecordsWithBlockRow:(unsigned long long)arg1 error:(id *)arg2;
...
- (_Bool)_selectRecordsWithZoneRow:(unsigned long long)arg1 modelType:(id)arg2 returning:(unsigned long long)arg3 error:(id *)arg4 handler:(id /* block */)arg5;
...
- (_Bool)_deleteZombieRecordsWithZoneRow:(unsigned long long)arg1 error:(id *)arg2;
- (_Bool)_deleteRecordsWithZoneRow:(unsigned long long)arg1 error:(id *)arg2;
...
- (_Bool)_deleteRecordWithRow:(unsigned long long)arg1 error:(id *)arg2;
- (_Bool)_deleteRecordWithZoneRow:(unsigned long long)arg1 externalID:(id)arg2 error:(id *)arg3;
- (_Bool)_deleteRecordWithZoneRow:(unsigned long long)arg1 modelID:(id)arg2 error:(id *)arg3;
- (_Bool)_updateRecordWithRow:(unsigned long long)arg1 modelType:(id)arg2 modelSchema:(id)arg3 error:(id *)arg4;
- (_Bool)_updateRecordWithRow:(unsigned long long)arg1 pushBlockRow:(unsigned long long)arg2 pushData:(id)arg3 pushEncoding:(unsigned long long)arg4 error:(id *)arg5;
- (_Bool)_updateRecordWithRow:(unsigned long long)arg1 modelEncoding:(unsigned long long)arg2 modelData:(id)arg3 modelSchema:(id)arg4 error:(id *)arg5;
- (_Bool)_updateRecordsClearPushWithPushBlockRow:(unsigned long long)arg1 error:(id *)arg2;
- (_Bool)_updateRecordWithZoneRow:(unsigned long long)arg1 modelID:(id)arg2 pushEncoding:(unsigned long long)arg3 pushData:(id)arg4 pushBlockRow:(unsigned long long)arg5 error:(id *)arg6;
- (_Bool)_updateRecordWithZoneRow:(unsigned long long)arg1 modelID:(id)arg2 externalData:(id)arg3 error:(id *)arg4;
- (_Bool)_updateRecordWithZoneRow:(unsigned long long)arg1 externalID:(id)arg2 externalData:(id)arg3 error:(id *)arg4;
- (_Bool)_updateRecordWithRow:(unsigned long long)arg1 externalID:(id)arg2 externalData:(id)arg3 error:(id *)arg4;
