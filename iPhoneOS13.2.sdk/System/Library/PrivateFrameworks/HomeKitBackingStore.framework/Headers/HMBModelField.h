...
@property(copy, nonatomic) id /* block */ decodeBlock; // @synthesize decodeBlock=_decodeBlock;
@property(copy, nonatomic) id /* block */ encodeBlock; // @synthesize encodeBlock=_encodeBlock;
