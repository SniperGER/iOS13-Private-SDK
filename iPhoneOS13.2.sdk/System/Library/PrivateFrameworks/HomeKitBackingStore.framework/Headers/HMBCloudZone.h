...
- (id)decodeManateeCloudFrom:(id)arg1 recordSource:(NSUInteger)arg2 error:(id )arg3;
...
- (id)_triggerOutputForOutputRow:(NSUInteger)arg1 options:(id)arg2;
...
- (id)cloudFieldForEncoding:(NSUInteger)arg1;
- (id)cloudMetadataForModel:(id)arg1 usingEncoding:(NSUInteger)arg2;
- (BOOL)populateV4CloudRecord:(id)arg1 withModel:(id)arg2 metadataFieldData:(id)arg3 startEncoding:(NSUInteger)arg4 endEncoding:(NSUInteger)arg5 error:(id )arg6;
