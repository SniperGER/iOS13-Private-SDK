...
- (_Bool)removeOutputBlockWithRow:(unsigned long long)arg1 error:(id *)arg2;
...
- (_Bool)fetchModelsAndChildModelsOfType:(Class)arg1 error:(id *)arg2 handler:(id /* block */)arg3;
