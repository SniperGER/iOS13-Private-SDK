...
- (_Bool)fetchSQLite3One:(struct sqlite3_stmt *)arg1 error:(id *)arg2 block:(id /* block */)arg3;
- (_Bool)fetchSQLite3:(struct sqlite3_stmt *)arg1 limit:(unsigned long long)arg2 error:(id *)arg3 block:(id /* block */)arg4;
- (_Bool)fetchSQLite3:(struct sqlite3_stmt *)arg1 error:(id *)arg2 block:(id /* block */)arg3;
