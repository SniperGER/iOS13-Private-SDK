...
- (void)validateStoreLoadTransition:(id)arg1 atIndex:(NSUInteger)arg2 renderTargetArrayLength:(NSUInteger)arg3;
...
- (void)trackUseResources:(const id )arg1 count:(NSUInteger)arg2 usage:(NSUInteger)arg3;
- (void)trackUseResource:(id)arg1 usage:(NSUInteger)arg2;
