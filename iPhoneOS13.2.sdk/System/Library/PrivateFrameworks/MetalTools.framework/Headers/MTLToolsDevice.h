...
- (id)newBufferWithBytesNoCopy:(void )arg1 length:(NSUInteger)arg2 options:(NSUInteger)arg3 atResourceIndex:(NSUInteger)arg4 deallocator:(CDUnknownBlockType)arg5;
