...
- (void)useRenderPipelineStates:(const id )arg1 count:(NSUInteger)arg2;
...
- (void)setColorResolveTexture:(id)arg1 slice:(NSUInteger)arg2 depthPlane:(NSUInteger)arg3 level:(NSUInteger)arg4 atIndex:(NSUInteger)arg5 yInvert:(BOOL)arg6;
