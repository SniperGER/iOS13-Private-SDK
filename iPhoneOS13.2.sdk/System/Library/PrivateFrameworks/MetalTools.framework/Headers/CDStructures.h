...
struct AppendBuffer {
    /* void * CDUnknownFunctionPointerType _vptr$AppendBuffer */;
...
struct MTLGPUDebugBufferArgumentData {
    BOOL needsFlush;
    id buffers[31];
    NSUInteger offsets[31];
    unsigned int lengths[31];
    NSUInteger gpu_address[31][2];
};
...
typedef struct {
    ...
    NSUInteger threadgroupMemoryOffset;
    BOOL hasLodClamp;
    float lodMinClamp;
    float lodMaxClamp;
} CDStruct_0f4bf8df;
