...
{
    NSUInteger _maxThreadPositionInGrid[3];
    NSUInteger _maxThreadsPerGrid[3];
    NSUInteger _maxThreadPositionInThreadgroup[3];
    NSUInteger _maxThreadIndexInThreadgroup[3];
    NSUInteger _maxThreadsPerThreadgroup[3];
    NSUInteger _maxThreadgroupPositionInGrid[3];
    NSUInteger _maxThreadgroupsPerGrid[3];
    NSUInteger _maxStageInGridSize[3];
    NSUInteger _maxStageInGridOrigin[3];
