...
@property(readonly) id /* block */ clearHandler; // @synthesize clearHandler=_clearHandler;
...
- (id)initWithObject:(id)arg1 delay:(double)arg2 holdTransaction:(_Bool)arg3 clearHandler:(id /* block */)arg4;
