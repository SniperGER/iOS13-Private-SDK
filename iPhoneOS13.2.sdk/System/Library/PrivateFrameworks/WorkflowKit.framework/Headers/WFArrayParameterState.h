...
- (void)processWithVariableSource:(id)arg1 parameter:(id)arg2 userInputRequiredHandler:(id /* block */)arg3 valueHandler:(id /* block */)arg4 processSingleVariableStringsAsContentItems:(_Bool)arg5;
