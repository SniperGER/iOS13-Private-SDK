...
@property(copy, nonatomic) id /* block */ viewControllerCompletionHandler; // @synthesize viewControllerCompletionHandler=_viewControllerCompletionHandler;
...
- (void)intentExecutor:(id)arg1 showConfirmationForInteraction:(id)arg2 confirmationRequired:(_Bool)arg3 authenticationRequired:(_Bool)arg4 completionHandler:(id /* block */)arg5;
...
- (void)showInteraction:(id)arg1 fromViewController:(id)arg2 sourceView:(id)arg3 requiringConfirmation:(_Bool)arg4 completionHandler:(id /* block */)arg5;
- (id)createIntentViewControllerWithInteraction:(id)arg1 requiresConfirmation:(_Bool)arg2;
- (void)showInteractionIfNeeded:(id)arg1 inUserInterface:(id)arg2 requiringConfirmation:(_Bool)arg3 requiringAuthentication:(_Bool)arg4 executionStage:(long long)arg5 completionHandler:(id /* block */)arg6;
