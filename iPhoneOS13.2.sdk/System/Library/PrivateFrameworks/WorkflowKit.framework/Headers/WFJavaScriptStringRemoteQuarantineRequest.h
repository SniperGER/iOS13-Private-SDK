...
@property(nonatomic) NSUInteger runtimeType; // @synthesize runtimeType=_runtimeType;
// - (void).cxx_destruct;
...
- (id)initWithWorkflow:(id)arg1 runtimeType:(NSUInteger)arg2 targetURL:(id)arg3 preRuntimeVariableString:(id)arg4 runtimeString:(id)arg5;
