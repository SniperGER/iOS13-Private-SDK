...
- (void)uploadWorkflow:(id)arg1 withName:(id)arg2 shortDescription:(id)arg3 longDescription:(id)arg4 private:(_Bool)arg5 completionHandler:(id /* block */)arg6;
...
- (void)unshareSharedShortcut:(id)arg1 completionHandler:(id /* block */)arg2;
