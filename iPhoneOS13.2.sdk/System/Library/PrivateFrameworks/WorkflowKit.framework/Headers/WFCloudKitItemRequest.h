...
- (id)fetchItemsWithPredicate:(id)arg1 itemType:(Class)arg2 properties:(id)arg3 sortDescriptors:(id)arg4 resultsLimit:(NSUInteger)arg5 completionHandler:(CDUnknownBlockType)arg6;
