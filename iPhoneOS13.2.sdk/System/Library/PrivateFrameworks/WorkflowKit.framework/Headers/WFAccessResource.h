...
@interface WFAccessResource : WFResource <WFWorkflowReferencingResource>
{
    ...
    id  _resourceAvailabilityChangedNotificationObserver;
}

+ (Class)perWorkflowStateClass;
+ (_Bool)isSystemResource;
+ (id)accessResourceFromDatabaseState:(id)arg1;
@property(readonly, nonatomic) id  resourceAvailabilityChangedNotificationObserver; // @synthesize resourceAvailabilityChangedNotificationObserver=_resourceAvailabilityChangedNotificationObserver;
