...
- (void)attemptRecoveryFromWorkflowLevelErrorWithOptionIndex:(NSUInteger)arg1 userInterface:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;
...
- (void)makeAvailableAtLevel:(NSUInteger)arg1 withUserInterface:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;
