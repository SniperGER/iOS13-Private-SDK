...
@property(readonly, nonatomic) NSUInteger syntaxHighlightingType; // @synthesize syntaxHighlightingType=_syntaxHighlightingType;
@property(readonly, nonatomic) NSUInteger hintDisplayMode; // @synthesize hintDisplayMode=_hintDisplayMode;
