...
@property(copy, nonatomic) id /* block */ shouldCompactOnLaunch; // @synthesize shouldCompactOnLaunch=_shouldCompactOnLaunch;
@property(copy, nonatomic) id /* block */ migrationBlock; // @synthesize migrationBlock=_migrationBlock;
- (id).cxx_construct;
