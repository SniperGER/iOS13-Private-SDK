...
- (void)_processParameterStates:(id)arg1 withInput:(id)arg2 skippingHiddenParameters:(_Bool)arg3 askForValuesIfNecessary:(_Bool)arg4 completionHandler:(id /* block */)arg5;
- (void)processParametersWithoutAskingForValuesWithInput:(id)arg1 completionHandler:(id /* block */)arg2;
- (void)processParameterStates:(id)arg1 withInput:(id)arg2 skippingHiddenParameters:(_Bool)arg3 askForValuesIfNecessary:(_Bool)arg4 completionHandler:(id /* block */)arg5;
...
- (_Bool)getInputContentFromVariablesInParameterState:(id)arg1 completionHandler:(id /* block */)arg2;
- (id)previousAction;
