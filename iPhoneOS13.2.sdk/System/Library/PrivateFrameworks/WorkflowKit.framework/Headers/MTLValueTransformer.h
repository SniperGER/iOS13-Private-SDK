...
@property(readonly, copy, nonatomic) id /* block */ reverseBlock; // @synthesize reverseBlock=_reverseBlock;
@property(readonly, copy, nonatomic) id /* block */ forwardBlock; // @synthesize forwardBlock=_forwardBlock;
