...
- (void)enumerateActionsInScopeAtIndex:(NSUInteger)arg1 usingBlock:(CDUnknownBlockType)arg2;
- (BOOL)isVariableAvailableAtIndex:(NSUInteger)arg1 withActionTest:(CDUnknownBlockType)arg2;
