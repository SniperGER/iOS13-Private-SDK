...
- (void)processIntoStringsAndAttachmentsWithVariableSource:(id)arg1 completionHandler:(id /* block */)arg2;
- (void)processIntoContentItemsWithVariableSource:(id)arg1 completionHandler:(id /* block */)arg2;
- (void)processWithVariableSource:(id)arg1 completionHandler:(id /* block */)arg2;
