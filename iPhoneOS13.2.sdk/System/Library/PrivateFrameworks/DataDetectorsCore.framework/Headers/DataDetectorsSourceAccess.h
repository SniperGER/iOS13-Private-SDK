...
- (void)filesForSourceRead:(id)arg1 resourceType:(NSUInteger)arg2 withReply:(CDUnknownBlockType)arg3;
- (void)fileForSourceRead:(id)arg1 resourceType:(NSUInteger)arg2 withReply:(CDUnknownBlockType)arg3;
