...
- (void)_logEventForSelector:(SEL)arg1 metadata:(id)arg2 formatArgs:(_Bool)arg3 arg0:(id)arg4 arg1:(id)arg5 arg2:(id)arg6 arg3:(id)arg7;
- (void)_logEventForSelector:(SEL)arg1 metadata:(id)arg2 formatArgs:(_Bool)arg3 arg0:(id)arg4 arg1:(id)arg5 arg2:(id)arg6;
- (void)_logEventForSelector:(SEL)arg1 metadata:(id)arg2 formatArgs:(_Bool)arg3 arg0:(id)arg4 arg1:(id)arg5;
- (void)_logEventForSelector:(SEL)arg1 metadata:(id)arg2 formatArgs:(_Bool)arg3 arg0:(id)arg4;
- (void)_logEventForSelector:(SEL)arg1 metadata:(id)arg2;
- (id)_descriptionForArgument:(id)arg1 index:(unsigned long long)arg2 format:(_Bool)arg3 metadata:(id)arg4;
