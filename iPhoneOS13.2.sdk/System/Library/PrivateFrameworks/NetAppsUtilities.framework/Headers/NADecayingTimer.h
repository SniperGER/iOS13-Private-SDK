...
+ (id)scheduledTimerWithReferenceDate:(id)arg1 minimumUnit:(NSUInteger)arg2 block:(CDUnknownBlockType)arg3;
...
- (void)invalidate;
- (void)dealloc;
- (id)initWithReferenceDate:(id)arg1 minimumUnit:(NSUInteger)arg2 block:(CDUnknownBlockType)arg3;
