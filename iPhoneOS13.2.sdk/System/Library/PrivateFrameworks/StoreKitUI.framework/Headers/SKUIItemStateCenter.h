...
@class ASDJobManager, ASDSoftwareUpdatesStore, NSCountedSet, NSDate, NSHashTable, NSMutableArray, NSMutableDictionary, SKUIStoreItemRelationshipCounsellor, SSAppPurchaseHistoryDatabase, SSDownloadManager, SSSoftwareUpdatesStore;
...
- (id)_setStateFlag:(NSUInteger)arg1 forOnlyItemsWithIdentifiers:(id)arg2 sendNotification:(BOOL)arg3;
- (id)_setStateFlag:(NSUInteger)arg1 forItemsWithIdentifiers:(id)arg2 sendNotification:(BOOL)arg3;
...
- (id)_removeState:(NSUInteger)arg1 forItemIdentifier:(id)arg2;
...
- (id)_addState:(NSUInteger)arg1 forItemIdentifier:(id)arg2;
