...
- (void)removeCirclesInIndexSet:(id)arg1 byAnimatingToPoint:(struct CGPoint)arg2 delay:(double)arg3 completionBlock:(id /* block */)arg4;
- (void)removeCirclesInIndexSet:(id)arg1 animated:(_Bool)arg2 completionBlock:(id /* block */)arg3;
- (void)removeCircleAtIndex:(long long)arg1 animated:(_Bool)arg2 completionBlock:(id /* block */)arg3;
- (void)removeAllRepellors;
- (void)removeAllCirclesAnimated:(_Bool)arg1 completionBlock:(id /* block */)arg2;
- (void)reloadData;
