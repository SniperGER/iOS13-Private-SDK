...
- (void)_setViewControllers:(id)arg1 collectionViewsUpdateHandler:(id /* block */)arg2 forFinalTearDown:(_Bool)arg3;
...
- (void)detachTabBarPalette:(id)arg1 animated:(_Bool)arg2 completion:(id /* block */)arg3;
- (void)detachTabBarPalette:(id)arg1;
- (void)attachTabBarPalette:(id)arg1 animated:(_Bool)arg2 completion:(id /* block */)arg3;
