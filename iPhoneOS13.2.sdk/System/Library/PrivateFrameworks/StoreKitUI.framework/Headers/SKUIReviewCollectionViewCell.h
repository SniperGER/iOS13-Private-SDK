...
@property(copy, nonatomic) id /* block */ responseDescriptionTapAction; // @synthesize responseDescriptionTapAction=_responseDescriptionTapAction;
@property(copy, nonatomic) id /* block */ descriptionTapAction; // @synthesize descriptionTapAction=_descriptionTapAction;
