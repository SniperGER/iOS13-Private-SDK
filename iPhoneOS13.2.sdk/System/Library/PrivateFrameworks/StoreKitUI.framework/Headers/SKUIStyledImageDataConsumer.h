...
// - (void).cxx_destruct;
- (id)_leftToRightGradient:(CGRect)arg1 contentRect:(CGRect)arg2 drawBlock:(CDUnknownBlockType)arg3;
- (id)_uberImageWithBounds:(CGRect)arg1 inputSize:(CGSize)arg2 backgroundColor:(id)arg3 drawBlock:(CDUnknownBlockType)arg4;
- (id)_dynamicUberImageWithBounds:(CGRect)arg1 inputSize:(CGSize)arg2 drawBlock:(CDUnknownBlockType)arg3;
- (id)_uberBannerImageWithBounds:(CGRect)arg1 inputSize:(CGSize)arg2 drawBlock:(CDUnknownBlockType)arg3;
- (id)_roundedBorderWithBounds:(CGRect)arg1 contentRect:(CGRect)arg2 drawBlock:(CDUnknownBlockType)arg3;
- (id)_radialBlurImageWithBounds:(CGRect)arg1 contentRect:(CGRect)arg2 drawBlock:(CDUnknownBlockType)arg3;
- (id)_scaledImageWithBounds:(CGRect)arg1 contentRect:(CGRect)arg2 drawBlock:(CDUnknownBlockType)arg3;
- (id)_arcRoundedImageWithBounds:(CGRect)arg1 contentRect:(CGRect)arg2 cornerRadius:(double)arg3 drawBlock:(CDUnknownBlockType)arg4;
- (id)_imageWithSize:(CGSize)arg1 isOpaque:(BOOL)arg2 drawBlock:(CDUnknownBlockType)arg3;
- (id)_outputImageWithInputSize:(CGSize)arg1 outputSize:(CGSize)arg2 drawBlock:(CDUnknownBlockType)arg3;
