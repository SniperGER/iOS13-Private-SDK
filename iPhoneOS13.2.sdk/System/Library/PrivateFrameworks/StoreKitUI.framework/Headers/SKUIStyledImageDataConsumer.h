...
- (id)_leftToRightGradient:(struct CGRect)arg1 contentRect:(struct CGRect)arg2 drawBlock:(id /* block */)arg3;
- (id)_uberImageWithBounds:(struct CGRect)arg1 inputSize:(struct CGSize)arg2 backgroundColor:(id)arg3 drawBlock:(id /* block */)arg4;
- (id)_dynamicUberImageWithBounds:(struct CGRect)arg1 inputSize:(struct CGSize)arg2 drawBlock:(id /* block */)arg3;
- (id)_uberBannerImageWithBounds:(struct CGRect)arg1 inputSize:(struct CGSize)arg2 drawBlock:(id /* block */)arg3;
- (id)_roundedBorderWithBounds:(struct CGRect)arg1 contentRect:(struct CGRect)arg2 drawBlock:(id /* block */)arg3;
- (id)_radialBlurImageWithBounds:(struct CGRect)arg1 contentRect:(struct CGRect)arg2 drawBlock:(id /* block */)arg3;
- (id)_scaledImageWithBounds:(struct CGRect)arg1 contentRect:(struct CGRect)arg2 drawBlock:(id /* block */)arg3;
- (id)_arcRoundedImageWithBounds:(struct CGRect)arg1 contentRect:(struct CGRect)arg2 cornerRadius:(double)arg3 drawBlock:(id /* block */)arg4;
- (id)_imageWithSize:(struct CGSize)arg1 isOpaque:(_Bool)arg2 drawBlock:(id /* block */)arg3;
- (id)_outputImageWithInputSize:(struct CGSize)arg1 outputSize:(struct CGSize)arg2 drawBlock:(id /* block */)arg3;
