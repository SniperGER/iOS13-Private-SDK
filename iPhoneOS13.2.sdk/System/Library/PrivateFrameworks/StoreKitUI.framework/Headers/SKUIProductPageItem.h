...
@interface SKUIProductPageItem : SKUIItem
{
    ...
    NSUInteger _supportedGameCenterFeatures;
...
@property(readonly, nonatomic) NSUInteger supportedGameCenterFeatures; // @synthesize supportedGameCenterFeatures=_supportedGameCenterFeatures;
