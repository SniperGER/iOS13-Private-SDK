...
@interface SKUIInteractiveSegmentedControl : UIControl
{
    ...
    id /* CDUnknownBlockType */ _dividerCreationBlock;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ dividerCreationBlock; // @synthesize dividerCreationBlock=_dividerCreationBlock;
// - (void).cxx_destruct;
