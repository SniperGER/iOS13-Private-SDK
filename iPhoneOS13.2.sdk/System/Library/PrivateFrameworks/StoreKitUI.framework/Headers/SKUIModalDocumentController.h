...
- (void)_popPopoverStackItem:(id)arg1 animated:(_Bool)arg2 completion:(id /* block */)arg3;
- (void)_popOverlayStackItem:(id)arg1 animated:(_Bool)arg2 completion:(id /* block */)arg3;
- (_Bool)_popoverController:(id)arg1 containsStackItem:(id)arg2;
- (void)_popDocument:(_Bool)arg1 completion:(id /* block */)arg2;
