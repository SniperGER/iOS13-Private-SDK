...
@interface TSCellularPlanManagerCache : NSObject
{
    ...
    NSArray *_planItems;
    NSUInteger _supportedFlowTypes;
    NSArray *_danglingPlanItems;
}

+ (id)sharedInstance;
@property(retain) NSArray *danglingPlanItems; // @synthesize danglingPlanItems=_danglingPlanItems;
@property(nonatomic) NSUInteger supportedFlowTypes; // @synthesize supportedFlowTypes=_supportedFlowTypes;
...
- (void)sendUserResponse:(NSUInteger)arg1 confirmationCode:(id)arg2;
