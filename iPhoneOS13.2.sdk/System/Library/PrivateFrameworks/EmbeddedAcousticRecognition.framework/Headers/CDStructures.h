...
struct BasicTextSanitizer {
    /* void * CDUnknownFunctionPointerType _vptr$TextSanitizer */;
...
struct EARCSpeechRecognitionResultStream {
    void ctx;
    /* void * CDUnknownFunctionPointerType DisposeContext */;
    /* void * CDUnknownFunctionPointerType DidRecognizePartialResultTokens */;
    /* void * CDUnknownFunctionPointerType DidFinishRecognitionWithError */;
    /* void * CDUnknownFunctionPointerType DidRecognizeFinalResults */;
    /* void * CDUnknownFunctionPointerType DidProcessAudioDuration */;
};
...
struct SystemConfig {
    /* void * CDUnknownFunctionPointerType _vptr$OptionsItf */;
