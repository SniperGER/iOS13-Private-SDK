...
@property(copy, nonatomic) id /* block */ sendFrameHandler; // @synthesize sendFrameHandler=_sendFrameHandler;
...
@property(copy, nonatomic) id /* block */ receivedFrameHandler; // @synthesize receivedFrameHandler=_receivedFrameHandler;
...
- (_Bool)_sessionReceivedRequest:(id)arg1 flags:(unsigned int)arg2 responseHandler:(id /* block */)arg3;
