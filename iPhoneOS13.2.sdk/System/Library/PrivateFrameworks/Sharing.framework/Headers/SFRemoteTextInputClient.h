...
@property(copy, nonatomic) id /* block */ textInputDidEnd; // @synthesize textInputDidEnd=_textInputDidEnd;
@property(copy, nonatomic) id /* block */ textInputDidBegin; // @synthesize textInputDidBegin=_textInputDidBegin;
