...
@property(copy, nonatomic) id /* block */ speechStartHandler; // @synthesize speechStartHandler=_speechStartHandler;
@property(retain, nonatomic) VSSpeechRequest *speechRequest; // @synthesize speechRequest=_speechRequest;
@property(copy, nonatomic) id /* block */ speechCompletion; // @synthesize speechCompletion=_speechCompletion;
