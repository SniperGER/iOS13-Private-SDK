...
@property(copy, nonatomic) id /* block */ powerSourcesChangedHandler; // @synthesize powerSourcesChangedHandler=_powerSourcesChangedHandler;
@property(copy, nonatomic) id /* block */ powerSourcesLostHandler; // @synthesize powerSourcesLostHandler=_powerSourcesLostHandler;
@property(copy, nonatomic) id /* block */ powerSourcesFoundHandler; // @synthesize powerSourcesFoundHandler=_powerSourcesFoundHandler;
