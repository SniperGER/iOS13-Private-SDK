...
@property(copy, nonatomic) id /* block */ dictionaryResponseHandler; // @synthesize dictionaryResponseHandler=_dictionaryResponseHandler;
@property(copy, nonatomic) id /* block */ textResponseHandler; // @synthesize textResponseHandler=_textResponseHandler;
