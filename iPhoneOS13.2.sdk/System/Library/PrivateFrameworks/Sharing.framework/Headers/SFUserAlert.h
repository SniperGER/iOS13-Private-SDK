...
//    struct __CFRunLoopSource _runLoopSrc;
    ...
    id /* CDUnknownBlockType */ _textResponseHandler;
    id /* CDUnknownBlockType */ _dictionaryResponseHandler;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ dictionaryResponseHandler; // @synthesize dictionaryResponseHandler=_dictionaryResponseHandler;
@property(copy, nonatomic) id /* CDUnknownBlockType */ textResponseHandler; // @synthesize textResponseHandler=_textResponseHandler;
...
//  (void)_handleResponseForNotification:(struct __CFUserNotification )arg1 flags:(NSUInteger)arg2;
- (void)_present;
- (void)present;
- (void)invalidate;
- (void)dealloc;
