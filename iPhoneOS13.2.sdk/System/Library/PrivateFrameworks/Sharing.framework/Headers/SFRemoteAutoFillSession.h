...
//    struct PairingSubstate _pairSubstate;
    ...
    id /* CDUnknownBlockType */ _pairingFinishedHandler;
    id /* CDUnknownBlockType */ _promptForPINHandler;
    id /* CDUnknownBlockType */ _promptForPickerHandler;
}

@property(copy, nonatomic) id /* CDUnknownBlockType */ promptForPickerHandler; // @synthesize promptForPickerHandler=_promptForPickerHandler;
@property(copy, nonatomic) id /* CDUnknownBlockType */ promptForPINHandler; // @synthesize promptForPINHandler=_promptForPINHandler;
@property(copy, nonatomic) id /* CDUnknownBlockType */ pairingFinishedHandler; // @synthesize pairingFinishedHandler=_pairingFinishedHandler;
