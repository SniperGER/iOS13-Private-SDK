...
@property(copy, nonatomic) id /* block */ promptForPickerHandler; // @synthesize promptForPickerHandler=_promptForPickerHandler;
@property(copy, nonatomic) id /* block */ promptForPINHandler; // @synthesize promptForPINHandler=_promptForPINHandler;
@property(copy, nonatomic) id /* block */ pairingFinishedHandler; // @synthesize pairingFinishedHandler=_pairingFinishedHandler;
