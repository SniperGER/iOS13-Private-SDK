...
- (id)callPassingTest:(CDUnknownBlockType)arg1 withOptions:(NSUInteger)arg2;
...
- (void)enumerateCallsWithOptions:(NSUInteger)arg1 invokingBlock:(CDUnknownBlockType)arg2 forCallsPassingTest:(CDUnknownBlockType)arg3;
