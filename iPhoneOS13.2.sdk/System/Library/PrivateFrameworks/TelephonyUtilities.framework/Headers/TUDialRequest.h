...
@interface TUDialRequest : NSObject <TUCallRequest, TUVideoRequest, TUFilteredRequest, NSSecureCoding, NSCopying>
{
    ...
    id /* CDUnknownBlockType */ _isEmergencyNumberBlock;
    id /* CDUnknownBlockType */ _isEmergencyNumberOrIsWhitelistedBlock;
    NSDate *_dateDialed;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ isEmergencyNumberOrIsWhitelistedBlock; // @synthesize isEmergencyNumberOrIsWhitelistedBlock=_isEmergencyNumberOrIsWhitelistedBlock;
@property(copy, nonatomic) id /* CDUnknownBlockType */ isEmergencyNumberBlock; // @synthesize isEmergencyNumberBlock=_isEmergencyNumberBlock;
...
@property(nonatomic) CGSize localLandscapeAspectRatio; // @synthesize localLandscapeAspectRatio=_localLandscapeAspectRatio;
@property(nonatomic) CGSize localPortraitAspectRatio; // @synthesize localPortraitAspectRatio=_localPortraitAspectRatio;
