...
- (void)stop;
- (void)beginRepeatingAction:(CDUnknownBlockType)arg1 iterations:(NSUInteger)arg2 pauseDurationBetweenIterations:(double)arg3 completion:(CDUnknownBlockType)arg4;
- (void)beginRepeatingAction:(CDUnknownBlockType)arg1 iterations:(NSUInteger)arg2 completion:(CDUnknownBlockType)arg3;
- (id)init;
