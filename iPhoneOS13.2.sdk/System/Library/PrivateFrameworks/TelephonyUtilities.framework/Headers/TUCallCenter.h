...
@property(copy, nonatomic) id /* block */ disconnectCallPreflight; // @synthesize disconnectCallPreflight=_disconnectCallPreflight;
...
- (_Bool)allCallsPassTest:(id /* block */)arg1;
- (_Bool)anyCallPassesTest:(id /* block */)arg1;
