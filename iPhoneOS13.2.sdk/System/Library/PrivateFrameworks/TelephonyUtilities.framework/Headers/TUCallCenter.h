...
@interface TUCallCenter : NSObject <TUCallContainer>
{
    ...
    id /* CDUnknownBlockType */ _disconnectCallPreflight;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ disconnectCallPreflight; // @synthesize disconnectCallPreflight=_disconnectCallPreflight;
...
// - (void).cxx_destruct;
- (NSUInteger)_callGroupCountForCall:(id)arg1 withCall:(id)arg2;
...
- (NSUInteger)countOfCallsPassingTest:(CDUnknownBlockType)arg1;
