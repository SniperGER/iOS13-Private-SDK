...
+ (id)flightViewForStyle:(NSUInteger)arg1 compact:(BOOL)arg2;
...
- (void)setFlight:(id)arg1 legIndex:(NSUInteger)arg2 multiFlights:(BOOL)arg3 spotlightMode:(BOOL)arg4;
...
- (void)setupLabelStylesWithStyle:(NSUInteger)arg1;
