...
- (_Bool)classifyContactsWithProgress:(id)arg1 extendTimeoutBlock:(id /* block */)arg2;
...
- (void)generateFaceIDModelShouldForce:(_Bool)arg1 progress:(id)arg2 extendTimeoutBlock:(id /* block */)arg3;
...
- (id)performSocialGroupsIdentifiersWithPersonClusterManager:(id)arg1 forPersons:(id)arg2 overTheYearsComputation:(_Bool)arg3 updateBlock:(id /* block */)arg4;
...
- (void)updateKeyFacesOfPersonsWithLocalIdentifiers:(id)arg1 forceUpdate:(_Bool)arg2 context:(id)arg3 reply:(id /* block */)arg4;
...
- (void)shutdown;
- (_Bool)performPersonBuildingWithCanceler:(id)arg1 extendTimeoutBlock:(id /* block */)arg2 error:(id *)arg3;
...
- (_Bool)performFaceClusteringWithCompletion:(id /* block */)arg1 error:(id *)arg2;
