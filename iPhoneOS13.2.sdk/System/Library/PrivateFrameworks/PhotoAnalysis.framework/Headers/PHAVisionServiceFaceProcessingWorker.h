...
- (id)densityClusteringForObjects:(id)arg1 maximumDistance:(double)arg2 minimumNumberOfObjects:(NSUInteger)arg3 withDistanceBlock:(CDUnknownBlockType)arg4;
...
- (NSUInteger)_analyzeAsset:(id)arg1 withAttributes:(id)arg2 usingPVImageProvidedByBlock:(CDUnknownBlockType)arg3 error:(id )arg4;
