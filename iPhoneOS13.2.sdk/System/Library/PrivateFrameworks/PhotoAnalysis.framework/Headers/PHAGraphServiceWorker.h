...
- (void)rebuildGraphWithOptions:(id)arg1 context:(id)arg2 isRequestedRebuild:(_Bool)arg3 progressHandler:(id /* block */)arg4 completionHandler:(id /* block */)arg5;
...
- (void)enrichDataModelWithOptions:(id)arg1 isBackgroundEnrichmentJob:(_Bool)arg2 context:(id)arg3 progressHandler:(id /* block */)arg4 completionHandler:(id /* block */)arg5;
