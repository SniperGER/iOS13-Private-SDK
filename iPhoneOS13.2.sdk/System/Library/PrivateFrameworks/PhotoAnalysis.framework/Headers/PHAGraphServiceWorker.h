...
- (void)requestSnapshotServiceForRelatedDebugInfoBetweenMomentForLocalIdentifier:(id)arg1 andRelatedResultsForLocalIdentifiers:(id)arg2 precision:(NSUInteger)arg3 relatedType:(NSUInteger)arg4 additionalSnapshotSummaryInfo:(id)arg5 context:(id)arg6 reply:(CDUnknownBlockType)arg7;
- (void)requestSnapshotServiceForRelatedDebugInfoBetweenAssetForLocalIdentifier:(id)arg1 andRelatedResultsForLocalIdentifiers:(id)arg2 precision:(NSUInteger)arg3 relatedType:(NSUInteger)arg4 context:(id)arg5 reply:(CDUnknownBlockType)arg6;
...
- (void)requestRelatedDebugInformationBetweenAssetForLocalIdentifier:(id)arg1 andRelatedAssetCollectionForLocalIdentifier:(id)arg2 options:(id)arg3 precision:(NSUInteger)arg4 relatedType:(NSUInteger)arg5 context:(id)arg6 reply:(CDUnknownBlockType)arg7;
- (void)requestRelatedMomentsForPersonIdentifiers:(id)arg1 context:(id)arg2 reply:(CDUnknownBlockType)arg3;
- (void)requestRelatedDebugInformationBetweenReferenceAssetCollectionForLocalIdentifier:(id)arg1 andRelatedAssetCollectionForLocalIdentifier:(id)arg2 options:(id)arg3 precision:(NSUInteger)arg4 relatedType:(NSUInteger)arg5 context:(id)arg6 reply:(CDUnknownBlockType)arg7;
...
- (void)requestCuratedAssetsForAssetCollectionWithLocalIdentifier:(id)arg1 duration:(NSUInteger)arg2 precision:(NSUInteger)arg3 options:(id)arg4 context:(id)arg5 reply:(CDUnknownBlockType)arg6;
- (void)requestCuratedAssetForAssetCollectionWithLocalIdentifier:(id)arg1 referenceAssetLocalIdentifier:(id)arg2 precision:(NSUInteger)arg3 options:(id)arg4 context:(id)arg5 reply:(CDUnknownBlockType)arg6;
...
- (id)metricReportingJobWithScenario:(NSUInteger)arg1 completionHandler:(CDUnknownBlockType)arg2;
...
- (id)graphProcessHistoricalChangeJobWithScenario:(NSUInteger)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (id)graphRebuildJobWithScenario:(NSUInteger)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (id)dataModelEnrichmentJobWithScenario:(NSUInteger)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (id)backgroundMemoryGenerationJobWithScenario:(NSUInteger)arg1 completionHandler:(CDUnknownBlockType)arg2;
