...
- (NSMutableArray *)groupedClusterSequenceNumbersOfFacesInFaceGroupsOfMinimumSize:(NSUInteger)arg1 error:(id )arg2;
...
- (NSArray *)dirtyFaceCropsWithLimit:(NSUInteger)arg1;
...
- (BOOL)ungroupFaceClusterSequenceNumbers:(NSArray *)arg1 batchSizeForUnclusteringFaces:(NSUInteger)arg2 canceler:(PVCanceler *)arg3 error:(id )arg4;
