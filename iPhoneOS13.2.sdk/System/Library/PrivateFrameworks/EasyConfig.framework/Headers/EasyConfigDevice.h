...
@property(nonatomic) NSUInteger features; // @synthesize features=_features;
@property(retain, nonatomic) NSObject<OS_dispatch_queue> *dispatchQueue; // @synthesize dispatchQueue=_userQueue;
@property(nonatomic) NSUInteger deviceIdentifier; // @synthesize deviceIdentifier=_deviceIdentifier;
