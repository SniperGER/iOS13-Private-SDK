...
- (BOOL)_findString:(id)arg1 options:(NSUInteger)arg2;
- (id)rectsForTextMatches;
- (void)unmarkAllTextMatches;
- (BOOL)markedTextMatchesAreHighlighted;
- (void)setMarkedTextMatchesAreHighlighted:(BOOL)arg1;
- (NSUInteger)countMatchesForText:(id)arg1 inDOMRange:(id)arg2 options:(NSUInteger)arg3 limit:(NSUInteger)arg4 markMatches:(BOOL)arg5;
