...
+ (id)sharedUIDelegate;
- (NSUInteger)webView:(id)arg1 dragDestinationActionMaskForSession:(id)arg2;
...
- (void)webView:(id)arg1 exceededApplicationCacheOriginQuotaForSecurityOrigin:(id)arg2 totalSpaceNeeded:(NSUInteger)arg3;
