...
+ (void)_setCurrentNetworkLoaderSessionCookieAcceptPolicy:(NSUInteger)arg1;
...
- (void)_setUnsignedLongLongValue:(NSUInteger)arg1 forKey:(id)arg2;
- (NSUInteger)_unsignedLongLongValueForKey:(id)arg1;
