...
- (void)showModalWebViewWithLinkURL:(id)arg1 scaleToFit:(_Bool)arg2 loadCompletion:(id /* block */)arg3 doneHandler:(id /* block */)arg4;
...
- (void)presentPage:(id)arg1 inViewController:(id)arg2 animated:(_Bool)arg3 completion:(id /* block */)arg4;
- (void)presentInParentViewController:(id)arg1 animated:(_Bool)arg2;
- (void)presentInParentViewController:(id)arg1 animated:(_Bool)arg2 completion:(id /* block */)arg3;
