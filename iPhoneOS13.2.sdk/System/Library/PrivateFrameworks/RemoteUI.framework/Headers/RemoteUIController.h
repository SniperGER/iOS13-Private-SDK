...
@property(copy, nonatomic) id /* block */ loadCompletion; // @synthesize loadCompletion=_loadCompletion;
...
- (id)dismissObjectModelsAnimated:(_Bool)arg1 completion:(id /* block */)arg2;
