...
//     struct cf_ptr<CGContextRef *> _context;
//     struct ContextDelegate _delegate;
    BOOL _linearColors;
    CGRect _contentRect;
}

+ (id)displayListForCGContextRef:(CGContextRef )arg1 alpha:(float )arg2 blendMode:(int )arg3;
...
- (void)endCGContextRef;
- (CGContextRef )beginCGContextRefWithAlpha:(float)arg1;
