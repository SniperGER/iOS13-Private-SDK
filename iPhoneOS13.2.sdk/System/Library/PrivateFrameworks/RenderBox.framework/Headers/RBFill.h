...
// - (void)set9PartImage:(CGImageRef)arg1 transform:(CGAffineTransform)arg2 destinationRect:(CGRect)arg3 capInsets:(CDStruct_d2b197d1)arg4 repeat:(BOOL)arg5 interpolation:(int)arg6 tintColor:(CDStruct_0b1c536a)arg7 flags:(unsigned int)arg8;
...
// - (void)setTiledImage:(CGImageRef)arg1 transform:(CGAffineTransform)arg2 sourceRect:(CGRect)arg3 interpolation:(int)arg4 tintColor:(CDStruct_0b1c536a)arg5 flags:(unsigned int)arg6;
...
// - (void)setImage:(CGImageRef)arg1 transform:(CGAffineTransform)arg2 interpolation:(int)arg3 tintColor:(CDStruct_0b1c536a)arg4 flags:(unsigned int)arg5;
