...
@property(readonly, nonatomic) NSUInteger originatingAttributePath; // @synthesize originatingAttributePath=_originatingAttributePath;
...
- (NSObject )endowment;
- (id)_initWithNamespace:(id)arg1 environment:(id)arg2 encodedEndowment:(id)arg3 originatingIdentifier:(id)arg4 attributePath:(NSUInteger)arg5;
- (id)init;
