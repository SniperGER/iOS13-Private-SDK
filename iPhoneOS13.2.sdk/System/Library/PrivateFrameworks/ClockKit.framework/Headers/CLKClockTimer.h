...
- (struct NSNumber *)_nextTokenWithIdentificationLog:(id /* block */)arg1;
- (void)stopDisplayNativeUpdatesForToken:(struct NSNumber *)arg1;
- (struct NSNumber *)startDisplayNativeUpdatesWithHandler:(id /* block */)arg1 identificationLog:(id /* block */)arg2;
- (void)stop30fpsUpdatesForToken:(struct NSNumber *)arg1;
- (struct NSNumber *)start30fpsUpdatesWithHandler:(id /* block */)arg1 identificationLog:(id /* block */)arg2;
- (void)stopSubsecondUpdatesForToken:(id)arg1;
- (struct NSNumber *)startSubsecondUpdatesWithHandler:(id /* block */)arg1 identificationLog:(id /* block */)arg2;
- (struct NSNumber *)startSubsecondUpdatesWithHandler:(id /* block */)arg1;
- (void)stopSecondUpdatesForToken:(struct NSNumber *)arg1;
- (struct NSNumber *)startSecondUpdatesWithHandler:(id /* block */)arg1 identificationLog:(id /* block */)arg2;
- (struct NSNumber *)startSecondUpdatesWithHandler:(id /* block */)arg1;
- (void)stopMinuteUpdatesForToken:(struct NSNumber *)arg1;
- (struct NSNumber *)startMinuteUpdatesWithHandler:(id /* block */)arg1 identificationLog:(id /* block */)arg2;
- (struct NSNumber *)startMinuteUpdatesWithHandler:(id /* block */)arg1;
- (void)dealloc;
- (id)init;
