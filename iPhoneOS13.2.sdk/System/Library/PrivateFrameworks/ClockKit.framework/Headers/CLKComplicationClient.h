...
- (void)getTimelineEntriesForComplication:(id)arg1 afterDate:(id)arg2 limit:(NSUInteger)arg3 withHandler:(CDUnknownBlockType)arg4;
- (void)getTimelineEntriesForComplication:(id)arg1 beforeDate:(id)arg2 limit:(NSUInteger)arg3 withHandler:(CDUnknownBlockType)arg4;
