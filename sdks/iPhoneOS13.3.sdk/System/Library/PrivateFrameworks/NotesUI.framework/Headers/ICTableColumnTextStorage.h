...
// - (void).cxx_destruct;
- (void)tableCellWasEditedAtColumnID:(id)arg1 rowID:(id)arg2 edited:(NSUInteger)arg3 range:(NSRange)arg4 changeInLength:(long long)arg5;
...
- (id)rowAtIndex:(NSUInteger)arg1 rowRange:(out NSRange )arg2;
