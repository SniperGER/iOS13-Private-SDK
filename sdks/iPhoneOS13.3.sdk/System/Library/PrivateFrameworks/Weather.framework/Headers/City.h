...
@property(nonatomic) NSUInteger lastUpdateStatus; // @synthesize lastUpdateStatus=_lastUpdateStatus;
...
@property(nonatomic, setter=setUVIndex:) NSUInteger uvIndex; // @synthesize uvIndex=_uvIndex;
@property(nonatomic) NSUInteger moonPhase; // @synthesize moonPhase=_moonPhase;
@property(nonatomic) NSUInteger sunriseTime; // @synthesize sunriseTime=_sunriseTime;
@property(nonatomic) NSUInteger sunsetTime; // @synthesize sunsetTime=_sunsetTime;
...
- (void)clearForecasts;
- (void)updateTimeZoneWithCompletionBlock:(id /* CDUnknownBlockType */)arg1;
