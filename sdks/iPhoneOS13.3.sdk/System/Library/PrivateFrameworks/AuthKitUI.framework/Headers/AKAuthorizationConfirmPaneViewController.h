...
- (void)_paneDelegate_authorizationPaneViewControllerDidRequestAuthorizationWithUserProvidedInformation:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
...
- (void)_performAuthorizationWithRawPassword:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
...
- (void)_reloadDataAnimated:(BOOL)arg1 heightChange:(id /* CDUnknownBlockType */)arg2 animation:(id /* CDUnknownBlockType */)arg3 completion:(id /* CDUnknownBlockType */)arg4;
- (void)_reloadDataAnimated:(BOOL)arg1 heightChange:(id /* CDUnknownBlockType */)arg2 animation:(id /* CDUnknownBlockType */)arg3;
- (void)_reloadDataAnimated:(BOOL)arg1 heightChange:(id /* CDUnknownBlockType */)arg2;
