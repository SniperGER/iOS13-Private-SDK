...
- (void)p_drawTextInLayer:(id)arg1 context:(CGContext )arg2 limitSelection:(id)arg3 rubyGlyphRange:(NSRange)arg4 renderMode:(int)arg5 suppressInvisibles:(BOOL)arg6;
...
- (CGPath )p_newSelectionPathForRange:(NSRange)arg1 headKnobRect:(CGRect )arg2 tailKnobRect:(CGRect )arg3 selectionType:(int)arg4 selection:(id)arg5;
...
- (void)setSecondaryHighlightRange:(NSRange)arg1 color:(CGColor )arg2 pathStyle:(int)arg3;
...
- (id)overlayLayers;
- (void)drawRubyInContext:(CGContext )arg1 rubyFieldStart:(NSUInteger)arg2 rubyGlyphRange:(NSRange)arg3;
