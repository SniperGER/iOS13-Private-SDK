...
@class NSArray, NSMutableDictionary, NSMutableIndexSet, NSObject, RCWaveformDataSource;
...
@interface RCWaveformRenderer : UIViewController <RCWaveformDataSourceObserver, RCDisplayLinkObserver, CAAnimationDelegate>
{
    ...
    id /* CDUnknownBlockType */ _nextRenderBlock;
...
@property(copy) id /* CDUnknownBlockType */ nextRenderBlock; // @synthesize nextRenderBlock=_nextRenderBlock;
...
- (id).cxx_construct;
// - (void).cxx_destruct;
- (void)_performOrDispatchToMainThread:(id /* CDUnknownBlockType */)arg1;
...
- (id)rasterizeTimeRange:(CDStruct_73a5d3ca)arg1 imageSize:(CGSize)arg2;
