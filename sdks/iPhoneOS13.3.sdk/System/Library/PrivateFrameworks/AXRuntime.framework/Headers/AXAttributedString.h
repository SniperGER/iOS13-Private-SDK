...
- (void)enumerateAttribute:(id)arg1 inRange:(NSRange)arg2 options:(NSUInteger)arg3 usingBlock:(id /* CDUnknownBlockType */)arg4;
...
- (id)stringByReplacingOccurrencesOfString:(id)arg1 withString:(id)arg2 options:(NSUInteger)arg3 range:(NSRange)arg4;
