...
// - (void).cxx_destruct;
- (NSRange)nextCursorRangeInDirection:(NSUInteger)arg1 unit:(NSUInteger)arg2 outputRange:(NSRange )arg3 currentCursorRange:(NSRange)arg4;
- (NSRange)nextCursorRangeInDirection:(NSUInteger)arg1 unit:(NSUInteger)arg2 outputRange:(NSRange )arg3;
- (NSRange)_lineRangeForPosition:(NSUInteger)arg1;
