...
- (struct Network)_candidateNetworkFromSegmentationNetwork:(struct Network )arg1 segmentGroup:(id)arg2 drawing:(id)arg3 boundsAtNode:(vector_ea45b3ba )arg4 matchingStrokeRange:(NSRange)arg5 sortedSegmentIndexes:(vector_afed86a5)arg6 shouldCancel:(id /* CDUnknownBlockType */)arg7;
...
- (unsigned int )_createNetworkTruncatedPrefixStringUsingPrefix:(id)arg1 fullHistoryStringLength:(long long)arg2 hasLexiconCursor:(BOOL)arg3 prefixStringLength:(NSUInteger )arg4 hasComplexChars:(BOOL )arg5 activeHistoryRange:(NSRange )arg6;
- (void)_filterNonHumanFriendlyCandidates:(id)arg1;
- (void)_adjustResultsForConfusableCharacters:(id)arg1;
- (id)tokenizedTextResultForRomanSingleWordLatticePaths:(const vector_7a3f6ffc )arg1 history:(id)arg2 activeHistoryRange:(NSRange)arg3 startNode:(long long)arg4 segmentGroup:(id)arg5;
- (id)_addAlternativeCandidatesForTokenizedResult:(id)arg1;
- (id)_spellCheckerCorrectionsForToken:(id)arg1;
- (id)_lexiconCorrectionsForToken:(id)arg1 withLexicon:(struct _LXLexicon )arg2 textReplacements:(id)arg3 consumableStrokesSet:(id)arg4 minimumTokenScore:(double)arg5 activeHistoryRange:(NSRange)arg6 outBestTokenScore:(double )arg7 shouldCapitalizeWord:(BOOL)arg8;
...
- (id)tokenizedTextResultForRomanMultiWordsLatticePaths:(const vector_7a3f6ffc )arg1 maximumResultCount:(NSUInteger)arg2 history:(id)arg3 activeHistoryRange:(NSRange)arg4 startNode:(long long)arg5 segmentGroup:(id)arg6 precedingSpaceBehavior:(long long)arg7;
- (id)tokenizedTextResultForRomanNoSpaceLatticePaths:(const vector_7a3f6ffc )arg1 maximumResultCount:(NSUInteger)arg2 activeHistoryRange:(NSRange)arg3 precedingSpaceBehavior:(long long)arg4 totalStrokeCount:(long long)arg5 totalSubstrokeCount:(long long)arg6;
