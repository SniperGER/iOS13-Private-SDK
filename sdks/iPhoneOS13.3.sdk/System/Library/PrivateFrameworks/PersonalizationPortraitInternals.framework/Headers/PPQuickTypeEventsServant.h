...
- (id)_quickTypeItemsForEvents:(id)arg1 fields:(unsigned int)arg2 limit:(NSUInteger)arg3 formatter:(id)arg4 explanationSet:(id)arg5;
- (id)_fuzzyNextEvents:(id)arg1 minimumCount:(NSUInteger)arg2;
