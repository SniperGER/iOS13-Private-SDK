...
@class IMDCKUtilities, IMDChatStore, IMDMessageHistorySyncController, IMDMessageProcessingController, NSArray, NSData, NSMutableDictionary, NSRecursiveLock, TUConversationManager;
...
- (void)_chatGUIDsThatNeedRemergingWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
...
- (void)_updateCurrentAliasToCNIDDictionaryAndHistoryTokenWithCompletionHandler:(id /* CDUnknownBlockType */)arg1;
- (id)aliasToCNIDMap;
- (id)_aliasToCNIDMapForAliases:(id)arg1;
- (void)_updateCachedAliasToCNIDMap:(id)arg1 withHistoryToken:(id)arg2 completionHandler:(id /* CDUnknownBlockType */)arg3;
...
- (void)_addItemToParentChatIfNotLocationItem:(id)arg1 parentChat:(id)arg2 updatedLastMessageCount:(NSUInteger)arg3;
- (id)_parentChatIDFromCKRecord:(id)arg1;
- (id)_itemFromCKRecord:(id)arg1;
- (id)_lookupChatUsingID:(id)arg1;
- (id)messagesToUploadToCloudKitWithLimit:(NSUInteger)arg1;
- (void)__removeChatFromGroupIDChatIndex:(id)arg1;
- (void)__addChatToGroupIDChatIndex:(id)arg1;
- (void)_updateSyncStatisticsForMessage:(id)arg1 incrementTotalCount:(NSUInteger)arg2;
- (void)_updateSyncStatisticsForChat:(id)arg1 incrementTotalCount:(NSUInteger)arg2;
...
- (id)chatsToUploadToCloudKitWithLimit:(NSUInteger)arg1 isUsingStingRay:(BOOL)arg2;
...
- (BOOL)loadChatsWithCompletionBlock:(id /* CDUnknownBlockType */)arg1;
