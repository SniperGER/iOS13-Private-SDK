...
@class ICAccount, ICFolder, ICMergableDictionary, NSArray, NSData, NSMutableArray, NSUUID, TTMergeableStringVersionedDocument, TTVectorMultiTimestamp;
...
+ (NSUInteger)countOfNotesMatchingPredicate:(id)arg1 context:(id)arg2;
+ (id)notesMatchingPredicate:(id)arg1 context:(id)arg2;
+ (NSUInteger)countOfVisibleNotesInContext:(id)arg1;
+ (id)visibleNotesInContext:(id)arg1;
+ (NSUInteger)countOfAllNotesInContext:(id)arg1;
...
- (BOOL)attachmentExceedsMaxSizeAllowed:(NSUInteger)arg1;
- (BOOL)canAddAttachments:(NSUInteger)arg1;
- (BOOL)canAddAttachment;
- (void)updateChangeCount;
- (void)unmarkForDeletion;
- (void)markForDeletion;
- (BOOL)requiresLegacyTombstoneAfterDeletion;
- (BOOL)allowsNewTextLength:(NSUInteger)arg1;
- (BOOL)isSharable;
- (BOOL)isPinnable;
- (BOOL)isMovable;
- (BOOL)isLockable;
...
- (void)addMediaToAttachment:(id)arg1 withBlock:(id /* CDUnknownBlockType */)arg2;
