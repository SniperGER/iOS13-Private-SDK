...
@class AVAsset, ICAttachmentModel, ICNote, NSData, NSDictionary, NSString, NSURL;
...
- (void)dealloc;
- (NSUInteger)approximateArchiveSizeIncludingPreviews:(BOOL)arg1;
...
- (id)recordZoneName;
- (id)recordType;
- (void)updatePlaceInLocationIfNeededHandler:(id /* CDUnknownBlockType */)arg1;
...
- (id)galleryModel;
- (id)drawingModel;
- (id)attachmentPreviewImageWithMinSize:(CGSize)arg1 scale:(double)arg2 appearanceType:(NSUInteger)arg3 matchScale:(BOOL)arg4 matchAppearance:(BOOL)arg5;
- (id)attachmentPreviewImageWithMinSize:(CGSize)arg1 scale:(double)arg2 appearanceType:(NSUInteger)arg3 requireAppearance:(BOOL)arg4;
- (id)attachmentPreviewImageWithMinSize:(CGSize)arg1 scale:(double)arg2 appearanceType:(NSUInteger)arg3;
- (id)attachmentPreviewImageWithMinSize:(CGSize)arg1 scale:(double)arg2;
- (id)attachmentPreviewImageCreatingIfNecessaryWithWidth:(double)arg1 height:(double)arg2 scale:(double)arg3 appearanceType:(NSUInteger)arg4 scaleWhenDrawing:(BOOL)arg5 metadata:(id)arg6;
- (id)updateAttachmentPreviewImageWithImageSrc:(CGImageSource )arg1 maxDimension:(double)arg2 scale:(double)arg3 appearanceType:(NSUInteger)arg4 scaleWhenDrawing:(BOOL)arg5 metadata:(id)arg6 sendNotification:(BOOL)arg7;
- (id)updateAttachmentPreviewImageWithImageData:(id)arg1 size:(CGSize)arg2 scale:(double)arg3 appearanceType:(NSUInteger)arg4 scaleWhenDrawing:(BOOL)arg5 metadata:(id)arg6 sendNotification:(BOOL)arg7;
