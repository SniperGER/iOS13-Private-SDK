...
+ (void)load;
- (id)fp_prettyDescription:(NSUInteger)arg1;
...
- (id)fp_recoverableErrorWithBlock:(id /* CDUnknownBlockType */)arg1;
...
- (id)fp_internalErrorForVendorErrorWithItemCreationBlock:(id /* CDUnknownBlockType */)arg1;
- (id)fp_strippedError;
