...
- (void)generateCannedResponseCandidatesAsyncForString:(id)arg1 completionHandler:(id /* CDUnknownBlockType */)arg2;
...
- (void)generateAndRenderProactiveSuggestionsWithTriggers:(id)arg1 withAdditionalPredictions:(id)arg2 withInput:(id)arg3 async:(BOOL)arg4 completionHandler:(id /* CDUnknownBlockType */)arg5;
