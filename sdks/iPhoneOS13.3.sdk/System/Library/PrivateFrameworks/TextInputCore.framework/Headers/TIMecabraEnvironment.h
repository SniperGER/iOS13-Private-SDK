...
+ (void)loadMobileAssetContentsForInputModes:(id)arg1 onQueue:(id)arg2 withCompletionBlock:(id /* CDUnknownBlockType */)arg3;
...
- (BOOL)predictionAnalyzeWithOptions:(NSUInteger)arg1 maxNumberOfCandidates:(NSUInteger)arg2;
...
- (void)insertCandidateWithString:(id)arg1 intoArray:(id)arg2 atIndex:(NSUInteger)arg3;
