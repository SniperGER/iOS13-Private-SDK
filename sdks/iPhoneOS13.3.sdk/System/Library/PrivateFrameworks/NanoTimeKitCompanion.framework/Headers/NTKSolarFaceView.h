...
@class NSDateFormatter, NSDictionary, NSMutableSet, NSTimer, NTKBezierPathView, NTKColorCurve, NTKComplicationController, NTKDateComplicationLabel, NTKDigitalTimeLabelStyle, NTKDigitialUtilitarianFaceViewComplicationFactory, NTKFloatCurve, NTKLayoutRule, NTKSolarDiskView, NTKSolarPath, NTKSolarTimeModel, UIImageView, UILabel, UITapGestureRecognizer, UIView;
...
@interface NTKSolarFaceView : NTKDigitalFaceView <NTKTimeView, PUICCrownInputSequencerDelegate, UIGestureRecognizerDelegate>
{
    ...
    id /* CDUnknownBlockType */ _waypointSettleAnimationBlock;
...
- (void)_setViewMode:(long long)arg1 animated:(BOOL)arg2 completion:(id /* CDUnknownBlockType */)arg3;
