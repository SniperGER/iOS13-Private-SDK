...
@class NSDate, PXGadgetSpec, PXInboxAggregateDataSource, PXInboxAggregateDataSourceManager, PXInboxTableViewCellLayoutCoordinator, PXPhotoKitUIMediaProvider, UITableView;
...
// - (void).cxx_destruct;
- (void)ppt_performBlockAfterLoadingCompletes:(id /* CDUnknownBlockType */)arg1;
