...
- (void)enumerateSublayoutGeometriesInRange:(NSRange)arg1 options:(NSUInteger)arg2 usingBlock:(id /* CDUnknownBlockType */)arg3;
...
- (void)enumerateSublayoutsInRange:(NSRange)arg1 options:(NSUInteger)arg2 usingBlock:(id /* CDUnknownBlockType */)arg3;
