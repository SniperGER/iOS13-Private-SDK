...
@class NSArray, NSMapTable, NSMutableDictionary, NSMutableIndexSet, NSObject, PXGAssetImageCache, PXGImageRequestQueue, PXGThumbnailRequestQueue, PXMediaProvider;
...
+ (id /* CDUnknownBlockType */)defaultMediaVersionHandlerWithDataSourceBeforeChanges:(id)arg1 dataSourceAfterChanges:(id)arg2;
...
- (void)_workQueue_provideCGImage:(CGImage )arg1 orientation:(unsigned int)arg2 forRequestID:(int)arg3;
- (void)_workQueue_handleCGImageResult:(CGImage )arg1 orientation:(unsigned int)arg2 info:(id)arg3 shouldCache:(BOOL)arg4 textureRequestID:(int)arg5;
- (void)_workQueue_handleResult:(CGImage )arg1 orientation:(long long)arg2 info:(id)arg3 targetSize:(CGSize)arg4 screenScale:(double)arg5 mediaRequest:(id)arg6 textureRequestID:(int)arg7;
- (void)_workQueue_performDeferredImageRequest:(id)arg1 targetSize:(CGSize)arg2 contentMode:(long long)arg3 options:(id)arg4 resultHandler:(id /* CDUnknownBlockType */)arg5 textureRequestID:(int)arg6;
