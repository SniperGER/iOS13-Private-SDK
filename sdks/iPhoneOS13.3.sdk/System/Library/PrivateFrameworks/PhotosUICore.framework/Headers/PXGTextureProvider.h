...
@class NSIndexSet, NSMutableIndexSet, PXGViewEnvironment;
...
- (void)providePixelBuffer:(struct __CVBuffer )arg1 orientationTransform:(CGAffineTransform)arg2 forRequestID:(int)arg3;
- (void)provideImageData:(id)arg1 withSpecAtIndex:(long long)arg2 bytesPerRow:(NSUInteger)arg3 contentsRect:(CGRect)arg4 forRequestID:(int)arg5;
- (void)provideCGImage:(CGImage )arg1 forRequestID:(int)arg2;
- (void)provideCGImage:(CGImage )arg1 orientation:(unsigned int)arg2 forRequestID:(int)arg3;
