...
+ (NSRange)charRangeForPencilAnnotationStartPoint:(CGPoint)arg1 toEndPoint:(CGPoint)arg2 inLayoutTarget:(id)arg3 onSingleLineFragment:(BOOL)arg4;
...
- (void)renderWithRenderer:(id)arg1 currentSelection:(id)arg2 limitSelection:(id)arg3 listRange:(NSRange)arg4 rubyGlyphRange:(NSRange)arg5 isCanvasInteractive:(BOOL)arg6 isInDrawingMode:(BOOL)arg7 suppressedMisspellingRange:(NSRange)arg8 blackAndWhite:(BOOL)arg9 dictationInterpretations:(id)arg10 autocorrections:(id)arg11 markedRange:(NSRange)arg12 markedText:(id)arg13 renderMode:(int)arg14 pageCount:(NSUInteger)arg15 suppressInvisibles:(BOOL)arg16 suppressFontSmoothing:(BOOL)arg17 currentCanvasSelection:(id)arg18;
...
- (unsigned int)fontTraitsForRange:(NSRange)arg1 includingLabel:(BOOL)arg2;
...
- (void)makeEmpty:(NSUInteger)arg1 anchoredRange:(NSRange)arg2 layoutResultFlags:(NSUInteger)arg3;
