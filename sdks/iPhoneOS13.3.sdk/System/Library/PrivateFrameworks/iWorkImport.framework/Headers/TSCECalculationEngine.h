...
+ (void)splitRandomSeed:(NSUInteger)arg1 intoLo:(int )arg2 hi:(int )arg3;
+ (NSUInteger)randomSeedFromRandomLo:(int)arg1 hi:(int)arg2;
...
- (NSUInteger)numFormulaCellsInOwner:(const UUIDData_5fbc143e )arg1;
...
- (void)executeBlockWhileCalculationEngineIsNotWriting:(id /* CDUnknownBlockType */)arg1;
...
- (NSUInteger)dirtyCellCount;
- (NSUInteger)dirtyCellCountInOwner:(const UUIDData_5fbc143e )arg1;
...
- (void)enumerateFormulaOwnersUsingBlock:(id /* CDUnknownBlockType */)arg1;
