...
- (id)tileStartingAtOrAfterRowIndex:(unsigned int)arg1 outTileRange:(NSRange )arg2;
- (id)tileStartingAtOrBeforeRowIndex:(unsigned int)arg1 outTileRange:(NSRange )arg2;
- (id)tileForWritingAtRowIndex:(unsigned int)arg1 outTileRange:(NSRange )arg2;
- (id)rowInfoAtIndex:(unsigned int)arg1;
- (void)enumerateRowByRowInRange:(NSRange)arg1 withBlock:(id /* CDUnknownBlockType */)arg2;
- (void)enumerateRowsInRange:(NSRange)arg1 withBlock:(id /* CDUnknownBlockType */)arg2;
