...
+ (id)regionFromCellMap:(id)arg1 withTableInfo:(id)arg2 passingTest:(id /* CDUnknownBlockType */)arg3;
...
@property(nonatomic) NSUInteger cellCount; // @synthesize cellCount=_cellCount;
...
- (vector_e87daf7b)subRangesOfCellCount:(NSUInteger)arg1;
- (void)enumerateGridRowsUsingBlock:(id /* CDUnknownBlockType */)arg1;
- (void)enumerateGridColumnsUsingBlock:(id /* CDUnknownBlockType */)arg1;
- (void)enumerateMissingColumnsIntersectingCellRange:(struct TSUCellRect)arg1 usingBlock:(id /* CDUnknownBlockType */)arg2;
- (void)enumerateColumnsIntersectingCellRange:(struct TSUCellRect)arg1 usingBlock:(id /* CDUnknownBlockType */)arg2;
- (void)enumerateMissingRowsIntersectingCellRange:(struct TSUCellRect)arg1 usingBlock:(id /* CDUnknownBlockType */)arg2;
- (void)enumerateRowsIntersectingCellRange:(struct TSUCellRect)arg1 usingBlock:(id /* CDUnknownBlockType */)arg2;
- (void)enumerateColumnRangesInReverseUsingBlock:(id /* CDUnknownBlockType */)arg1;
- (void)enumerateColumnRangesUsingBlock:(id /* CDUnknownBlockType */)arg1;
- (void)enumerateRowRangesInReverseUsingBlock:(id /* CDUnknownBlockType */)arg1;
- (void)enumerateRowRangesUsingBlock:(id /* CDUnknownBlockType */)arg1;
- (void)enumerateInDirection:(long long)arg1 usingBlock:(id /* CDUnknownBlockType */)arg2;
- (void)enumerateRowsInReverseUsingBlock:(id /* CDUnknownBlockType */)arg1;
- (void)enumerateRowsUsingBlock:(id /* CDUnknownBlockType */)arg1;
- (void)enumerateColumnsInReverseUsingBlock:(id /* CDUnknownBlockType */)arg1;
...
- (id)prunedCellRegionAgainstTable:(id)arg1 behavior:(NSUInteger)arg2 usingBlock:(id /* CDUnknownBlockType */)arg3;
- (id)prunedCellRegionAgainstTable:(id)arg1 behavior:(NSUInteger)arg2;
...
- (void)enumerateModelCellRectsUsingBlock:(id /* CDUnknownBlockType */)arg1;
