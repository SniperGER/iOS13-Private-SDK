...
- (id)i_tileStartingAtOrAfterRowIndex:(unsigned int)arg1 outTileRange:(NSRange )arg2;
- (id)i_tileStartingAtOrBeforeRowIndex:(unsigned int)arg1 outTileRange:(NSRange )arg2;
