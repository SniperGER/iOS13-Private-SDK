...
@class NSArray, TSCECoordMapper, TSTColumnRowUIDMap, TSTTableInfo, TSTTableModel;
...
- (NSUInteger)tableAreaForColumn:(struct TSUViewColumnIndex)arg1;
- (NSUInteger)tableAreaForRow:(struct TSUViewRowIndex)arg1;
- (NSUInteger)tableAreaForDroppingRowAtIndex:(struct TSUViewRowIndex)arg1;
- (NSUInteger)tableAreaForCellID:(struct TSUViewCellCoord)arg1;
- (struct TSUViewCellRect)cellRangeForTableArea:(NSUInteger)arg1;
