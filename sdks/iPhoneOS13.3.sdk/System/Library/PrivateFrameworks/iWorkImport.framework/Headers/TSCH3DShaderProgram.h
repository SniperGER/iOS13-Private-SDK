...
- (NSUInteger)vertexAttributeLocationForVariable:(id)arg1;
...
- (id)p_boundArgumentDeclarationForLinkedVariable:(id)arg1 variableType:(id)arg2 variableName:(id)arg3 bindingType:(id)arg4 bufferIndex:(NSUInteger)arg5;
- (id)p_boundBufferArgumentDeclarationForLinkedVariable:(id)arg1 variableType:(id)arg2 variableName:(id)arg3 bufferIndex:(NSUInteger)arg4;
- (id)p_boundSamplerArgumentDeclarationForLinkedVariable:(id)arg1 bufferIndex:(NSUInteger)arg2;
- (id)p_boundTextureArgumentDeclarationForLinkedVariable:(id)arg1 bufferIndex:(NSUInteger)arg2;
...
- (void)link;
- (NSUInteger)processSection:(id)arg1 accumulate:(id)arg2 conclusions:(id)arg3;
...
- (NSUInteger)p_countOfAttributeBindingsForType:(struct TSCH3DShaderType)arg1;
- (NSUInteger)p_fragmentAttributeBindingsCount;
- (NSUInteger)p_vertexAttributeBindingsCount;
