...
@interface KNAnimatedSlideModel : NSObject
{
    ...
    BOOL _isMetalSlide;
    NSUInteger _numberOfAddedEvents;
...
@property(nonatomic) NSUInteger numberOfAddedEvents; // @synthesize numberOfAddedEvents=_numberOfAddedEvents;
...
- (void)enumerateAnimatedBuildsAndTimeRangesAtIndex:(NSUInteger)arg1 ignoreInitialDelay:(BOOL)arg2 usingBlock:(id /* CDUnknownBlockType */)arg3;
- (void)enumerateAnimatedBuildsAndTimeRangesAtIndex:(NSUInteger)arg1 usingBlock:(id /* CDUnknownBlockType */)arg2;
- (id)eventsAtIndex:(NSUInteger)arg1;
- (NSUInteger)buildEventCount;
- (id)description;
- (void)dealloc;
- (id)init;
