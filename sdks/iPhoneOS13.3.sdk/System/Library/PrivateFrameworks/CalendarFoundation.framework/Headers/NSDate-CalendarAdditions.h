...
- (void)_performBlockBehindDispatchSync:(id /* CDUnknownBlockType */)arg1 inTimeZone:(id)arg2;
- (id)dateWithoutTimeComponentsInTimeZone:(id)arg1;
- (id)dateAtHour:(NSUInteger)arg1 minute:(NSUInteger)arg2 second:(NSUInteger)arg3 inTimeZone:(id)arg4;
...
- (id)localizedYear;
- (id)dateRemovingComponents:(NSUInteger)arg1 inCalendar:(id)arg2;
