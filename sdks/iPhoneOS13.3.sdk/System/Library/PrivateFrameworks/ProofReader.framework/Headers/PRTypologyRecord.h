...
- (void)dealloc;
- (id)initWithString:(id)arg1 offset:(NSUInteger)arg2 range:(NSRange)arg3 language:(id)arg4 languages:(id)arg5 topLanguages:(id)arg6 autocorrect:(BOOL)arg7 initialCapitalize:(BOOL)arg8 autocapitalize:(BOOL)arg9 keyEventArray:(id)arg10 appIdentifier:(id)arg11 selectedRangeValue:(id)arg12;
