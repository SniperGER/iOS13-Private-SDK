...
+ (void)getVoiceInfoForLanguageCode:(id)arg1 footprint:(long long)arg2 gender:(long long)arg3 type:(long long)arg4 reply:(id /* CDUnknownBlockType */)arg5;
+ (void)getVoiceInfoForLanguageCode:(id)arg1 footprint:(long long)arg2 gender:(long long)arg3 custom:(BOOL)arg4 reply:(id /* CDUnknownBlockType */)arg5;
+ (void)getAutoDownloadedVoiceAssets:(id /* CDUnknownBlockType */)arg1;
+ (void)setAutoDownloadedVoiceAssets:(id)arg1;
+ (void)getVoiceResourceForLanguage:(id)arg1 reply:(id /* CDUnknownBlockType */)arg2;
+ (void)getLocalVoiceResources:(id /* CDUnknownBlockType */)arg1;
+ (void)getLocalVoiceAssets:(id /* CDUnknownBlockType */)arg1;
+ (void)getAllVoiceAssets:(id /* CDUnknownBlockType */)arg1;
+ (BOOL)isSystemSpeaking;
+ (id)availableFootprintsForVoice:(id)arg1 languageCode:(id)arg2;
+ (id)availableLanguageCodes;
+ (id)availableVoicesForLanguageCode:(id)arg1;
+ (id)availableVoices;
+ (void)getLogToFile:(id /* CDUnknownBlockType */)arg1;
...
- (void)getLocalVoiceResources:(id /* CDUnknownBlockType */)arg1;
- (void)getLocalVoiceAssets:(id /* CDUnknownBlockType */)arg1;
- (void)cleanUnusedAssets:(id /* CDUnknownBlockType */)arg1;
- (void)endAudioPowerUpdate;
- (void)beginAudioPowerUpdateWithReply:(id /* CDUnknownBlockType */)arg1;
- (void)killDaemon;
- (void)forwardStreamObject:(id)arg1;
- (void)getTTSServerVoicesWithFilter:(id)arg1 reply:(id /* CDUnknownBlockType */)arg2;
...
- (void)estimateDurationOfRequest:(id)arg1 completion:(id /* CDUnknownBlockType */)arg2;
