...
@interface AXValidationManager : NSObject
{
    ...
    NSUInteger _numberOfValidationErrors;
    ...
    NSUInteger _numberOfValidations;
    NSUInteger _numberOfValidationWarnings;
...
@property(nonatomic) NSUInteger numberOfValidationWarnings; // @synthesize numberOfValidationWarnings=_numberOfValidationWarnings;
@property(nonatomic) NSUInteger numberOfValidations; // @synthesize numberOfValidations=_numberOfValidations;
@property(nonatomic) BOOL shouldPerformValidationChecks; // @synthesize shouldPerformValidationChecks=_shouldPerformValidationChecks;
...
@property(nonatomic) NSUInteger numberOfValidationErrors; // @synthesize numberOfValidationErrors=_numberOfValidationErrors;
...
- (void)_iterateMethodsOfType:(int)arg1 onClass:(Class)arg2 block:(id /* CDUnknownBlockType */)arg3;
...
- (void)_clearState;
- (void)_resetState;
- (void)installSafeCategories:(id /* CDUnknownBlockType */)arg1 afterDelay:(double)arg2 validationTargetName:(id)arg3 overrideProcessName:(id)arg4;
- (void)performValidations:(id /* CDUnknownBlockType */)arg1 withPreValidationHandler:(id /* CDUnknownBlockType */)arg2 postValidationHandler:(id /* CDUnknownBlockType */)arg3 safeCategoryInstallationHandler:(id /* CDUnknownBlockType */)arg4;
- (void)performValidations:(id /* CDUnknownBlockType */)arg1 withPreValidationHandler:(id /* CDUnknownBlockType */)arg2 postValidationHandler:(id /* CDUnknownBlockType */)arg3;
- (id)init;
