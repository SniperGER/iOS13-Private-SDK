...
- (void)_handleIncomingMessage:(id)arg1 securityToken:(CDStruct_52eb0d21)arg2 auditToken:(CDStruct_4c969caf)arg3 clientPort:(unsigned int)arg4 completion:(id /* CDUnknownBlockType */)arg5;
...
@property(copy, nonatomic) id /* CDUnknownBlockType */ clientInvalidationCallback;
@property(copy, nonatomic) id /* CDUnknownBlockType */ defaultHandler;
